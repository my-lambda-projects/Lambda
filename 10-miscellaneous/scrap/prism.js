...
const _self = "undefined" != typeof window ? window : "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope ? self : {},
      Prism = (u => {
        ...
        const M = {
            ...
            clone: function r( e, t ) {
              ...
              switch ( t = t || {}, M.util.type( e ) ) {
                case "Object":
                  ...
                  for ( const i in (a = {}, t[ n ] = a, e) ) e.hasOwnProperty( i ) && ( a[ i ] = r( e[ i ], t ) );
                  return a;
                case "Array":
                  return n = M.util.objId( e ), t[ n ] ? t[ n ] : ( a = [], t[ n ] = a, e.forEach( (e, n) => {
                    a[ n ] = r( e, t )
                  } ), a );
                default:
                  return e
          ...
          languages: {
            extend(e, n) {
              const r = M.util.clone( M.languages[ e ] );
              for ( const t in n ) r[ t ] = n[ t ];
              return r
            },
            insertBefore(r, e, n, t) {
              const a = ( t = t || M.languages )[ r ], i = {};
              for ( const l in a )
          ...
          highlightAllUnder(e, n, r) {
            ...
            for ( let a, i = 0; a = t.elements[ i++ ]; ) M.highlightElement( a, !0 === n, t.callback )
          },
          highlightElement(e, n, r) {
            const t = M.util.getLanguage( e ), a = M.languages[ t ];
              ...
              for ( const o in t )
                if ( t.hasOwnProperty( o ) && t[ o ] ) {
                  ...
                  for ( let u = 0; u < s.length; ++u ) {
                    ...
                    const c = s[ u ], g = c.inside, f = !!c.lookbehind, h = !!c.greedy, d = c.alias;
                    if ( h && !c.pattern.global ) {
                      const v = c.pattern.toString().match( /[imsuy]*$/ )[ 0 ];
                      c.pattern = RegExp( c.pattern.source, v + "g" )
                    }
                    for ( let p = c.pattern || c, m = a.next, y = i; m !== r.tail && !( l && y >= l.reach ); y += m.value.length, m = m.next ) {
                      let k = m.value;
                      ...
                      if ( !( k instanceof W ) ) {
                        ...
                        if ( h ) {
                          ...
                          var w = b.index;
                          const A = b.index + b[ 0 ].length;
                          let P = y;
                          for ( P += m.value.length; P <= w; ) m = m.next, P += m.value.length;
                          if ( P -= m.value.length, y = P, m.value instanceof W ) continue;
                          for ( let S = m; S !== r.tail && ( P < A || "string" == typeof S.value ); S = S.next ) x++, P += S.value.length;
                          x--, k = n.slice( y, P ), b.index -= y
                        } else if ( !( b = z( p, 0, k, f ) ) ) continue;
                        const w = b.index, E = b[ 0 ], O = k.slice( 0, w ), L = k.slice( w + E.length ), N = y + k.length;
                        l && N > l.reach && ( l.reach = N );
                        let j = m.prev;
                        O && ( j = I( r, j, O ), y += O.length ), q( r, j, x );
                        const C = new W( o, g ? M.tokenize( E, g ) : E, d, E );
          ...
          hooks: {
            ...
            run(e, n) {
              const r = M.hooks.all[ e ];
              if ( r && r.length )
                for ( let t, a = 0; t = r[ a++ ]; ) t( n )
            }
          },
          Token: W
        };
        ...
        if ( u.Prism = M, W.stringify = function n( e, r ) {
            ...
            let l = "";
            for ( const o in a.attributes ) l += " " + o + '="' + ( a.attributes[ o ] || "" ).replace( /"/g, "&quot;" ) + '"';
            return "<" + a.tag + ' class="' + a.classes.join( " " ) + '"' + l + ">" + a.content + "</" + a.tag + ">"
          }, !u.document ) return u.addEventListener && ( M.disableWorkerMessageHandler || u.addEventListener( "message", e => {
          const n = JSON.parse( e.data ), r = n.language, t = n.code, a = n.immediateClose;
...
Prism.languages.markup = {
...
}, Prism.languages.markup.tag.inside[ "attr-value" ].inside.entity = Prism.languages.markup.entity, Prism.languages.markup.doctype.inside[ "internal-subset" ].inside = Prism.languages.markup, Prism.hooks.add( "wrap", a => {
  ...
  value(a, e) {
    ...
    const t = {};
    t[ a ] = {
      pattern: RegExp( "(<__[^>]*>)(?:<!\\[CDATA\\[(?:[^\\]]|\\](?!\\]>))*\\]\\]>|(?!<!\\[CDATA\\[)[^])*?(?=</__>)".replace( /__/g, () => {
        return a
      } ), "i" ),
      lookbehind: !0,
      greedy: !0,
...
!(e => {
  ...
  for ( let s = [ "comment", "function-name", "for-or-select", "assign-left", "string", "environment", "function", "keyword", "builtin", "boolean", "file-descriptor", "operator", "punctuation", "number" ], i = a.variable[ 1 ].inside, o = 0; o < s.length; o++ ) i[ s[ o ] ] = e.languages.bash[ s[ o ] ];
...
!(e => {
  const r = "(?:[ \t]+(?![ \t])(?:<SP_BS>)?|<SP_BS>)".replace( /<SP_BS>/g, () => {
            return "\\\\[\r\n](?:\\s|\\\\[\r\n]|#.*(?!.))*(?![\\s#]|\\\\[\r\n])"
          } ),
        n = "\"(?:[^\"\\\\\r\n]|\\\\(?:\r\n|[^]))*\"|'(?:[^'\\\\\r\n]|\\\\(?:\r\n|[^]))*'",
...
!(t => {
  ...
  for ( const p in r )
    if ( r[ p ] ) {
      a = a || {};
      const o = i[ p ] ? ( void 0, s = ( e = p ).replace( /^[a-z]+\//, "" ), "(?:" + e + "|\\w+/(?:[\\w.-]+\\+)+" + s + "(?![+\\w.-]))" ) : p;
      a[ p.replace( /\//g, "-" ) ] = {
...
!(u => {
  const e = u.languages.javascript[ "template-string" ], n = e.pattern.source, a = e.inside.interpolation, i = a.inside[ "interpolation-punctuation" ], r = a.pattern.source;
      ...
      function e( t ) {
        for ( let n = 0; n < t.length; n++ ) {
          ...
          if ( "string" == typeof r || "string" == typeof r.content ) {
            const a = v[ f ], i = "string" == typeof r ? r : r.content, o = i.indexOf( a );
            if ( -1 !== o ) {
              ++f;
              const s = i.substring( 0, o ), p = d( y[ a ] ), l = i.substring( o + a.length ), g = [];
          ...
          if ( Array.isArray( i ) )
            if ( "template-string" === a.type ) {
              ...
              if ( 3 === i.length && "string" != typeof o && "embedded-code" === o.type ) {
                const s = f( o ), p = o.alias, l = Array.isArray( p ) ? p[ 0 ] : p, g = u.languages[ l ];
                if ( !g ) continue;
                i[ 1 ] = c( s, g, l )
              }
            } else e( i );
  ...
  u.languages.markdown = u.languages.extend( "markup", {} ), u.languages.insertBefore( "markdown", "prolog", {
    ...
    if ( "code-block" === n.type ) {
      for ( var e = "", t = 0, a = n.classes.length; t < a; t++ ) {
        const i = n.classes[ t ], r = /language-(.+)/.exec( i );
        if ( r ) {
          e = r[ 1 ];
          break
        }
      ...
      if ( o ) {
        ...
        const d = "md-" + ( new Date ).valueOf() + "-" + Math.floor( 1e16 * Math.random() );
        n.attributes.id = d, u.plugins.autoloader.loadLanguages( e, () => {
          ...
          ! function e( n ) {
            for ( let t = 0; t < n.length && !( m >= d.length ); t++ ) {
              ...
              if ( "string" == typeof a || a.content && "string" == typeof a.content ) {
                const r = d[ m ], o = p.tokenStack[ r ], c = "string" == typeof a ? a : a.content, i = v( k, r ), u = c.indexOf( i );
                if ( -1 < u ) {
                  ++m;
                  const g = c.substring( 0, u ), l = new h.Token( k, h.tokenize( o, p.grammar ), "language-" + k, o ), s = c.substring( u + i.length ), f = [];
...
Prism.languages.scheme = {
  ...
  number: {
    pattern: RegExp((r => {
      for ( var e in r ) r[ e ] = r[ e ].replace( /<[\w\s]+>/g, e => {
        return "(?:" + r[ e ].trim() + ")"
      } );
      return r[ e ]
    })({
...
Prism.languages.racket = Prism.languages.extend( "scheme", {
  ...
  if ( "RegExp" === Prism.util.type( a ) ) {
    const r = a.source.replace( /\\(.)|\[\^?((?:\\.|[^\\\]])*)\]/g, (e, a, r) => {
      if ( a ) {
        if ( "(" === a ) return "[([]";
        if ( ")" === a ) return "[)\\]]"
      }
      return r ? ( "^" === e[ 1 ] ? "[^" : "[" ) + r.replace( /\\(.)|[()]/g, (e, a) => {
        return "(" === e || "(" === a ? "([" : ")" === e || ")" === a ? ")\\]" : e
      } ) + "]" : e;
    } );
...
!(o => {
  const t = o.util.clone( o.languages.javascript );
  let e = "(?:\\{<S>*\\.{3}(?:[^{}]|<BRACES>)*\\})";
...
!(e => {
  ...
  const n = e.languages.extend( "typescript", {} );
...
!(a => {
  const e = a.util.clone( a.languages.typescript );
  a.languages.tsx = a.languages.extend( "jsx", e );
  const t = a.languages.tsx.tag;
...
!(e => {
  for ( var a = "/\\*(?:[^*/]|\\*(?!/)|/(?!\\*)|<self>)*\\*/", t = 0; t < 2; t++ ) a = a.replace( /<self>/g, () => {
    return a
  } );
  a = a.replace( /<self>/g, () => {
    return "[^\\s\\S]"
...
!(e => {
  const t = "(?:\"(?:\"\"|[^\"])*\"(?!\")|'(?:''|[^'])*'(?!'))",
        ...
        y = {
          pattern: RegExp( "(^|\\s)(?:action\\s+)?(?:<act>)\\.[a-z]+\\b[^;]+".replace( /<act>/g, () => {
            return k
          } ), "i" ),
          lookbehind: !0,
          inside: {
            keyword: RegExp( "(?:<act>)\\.[a-z]+\\b".replace( /<act>/g, () => {
              return k
            } ), "i" ),
            action: {
              pattern: /(?:action)/i,
  ...
  e.languages.sas = {
    ...
    "proc-sql": {
      ...
      inside: {
        sql: {
          pattern: RegExp( "^[ \t]*(?:select|alter\\s+table|(?:create|describe|drop)\\s+(?:index|table(?:\\s+constraints)?|view)|create\\s+unique\\s+index|insert\\s+into|update)(?:<str>|[^;\"'])+;".replace( /<str>/g, () => {
            return t
          } ), "im" ),
          alias: "language-sql",
    ...
    "proc-args": {
      pattern: RegExp( "(^proc\\s+\\w+\\s+)(?!\\s)(?:[^;\"']|<str>)+;".replace( /<str>/g, () => {
        return t
      } ), "im" ),
      lookbehind: !0,
      inside: p
...
!(n => {
  ...
  const e = n.languages.markup.tag,
        t = {
          pattern: /\/\/\/.*/,
          greedy: !0,
          alias: "comment",
...
!(e => {
  const n = /[*&][^\s[\]{},]+/,
        ...
        a = "(?:[^\\s\\x00-\\x08\\x0e-\\x1f!\"#%&'*,\\-:>?@[\\]`{|}\\x7f-\\x84\\x86-\\x9f\\ud800-\\udfff\\ufffe\\uffff]|[?:-]<PLAIN>)(?:[ \t]*(?:(?![#:])<PLAIN>|:<PLAIN>))*".replace( /<PLAIN>/g, () => {
...
!(() => {
  if ( "undefined" != typeof self && self.Prism && self.document && document.querySelector ) {
    ...
    Prism.hooks.add( "before-sanity-check", e => {
      ...
      if ( c( n ) ) {
        clearTimeout( u );
        const i = Prism.plugins.lineNumbers, r = t.plugins && t.plugins.lineNumbers;
        if ( b( n, o ) && i && !r ) Prism.hooks.add( "line-numbers", e );
        else d( n )(), u = setTimeout( f, 1 )
      }
    } ), window.addEventListener( "hashchange", f ), window.addEventListener( "resize", () => {
      v( "pre" ).filter( c ).map( e => {
        return d( e )
      } ).forEach( y )
    } )
  }
  ...
  function d( u, e, c ) {
    const t = ( e = "string" == typeof e ? e : u.getAttribute( "data-line" ) || "" ).replace( /\s+/g, "" ).split( "," ).filter( Boolean ),
          ...
          m = [],
          g = n && h != n ? ((e, t) => {
            const n = getComputedStyle( e ), i = getComputedStyle( t );
    ...
    t.forEach( e => {
      const t = e.split( "-" ), n = +t[ 0 ], i = +t[ 1 ] || n, r = u.querySelector( '.line-highlight[data-range="' + e + '"]' ) || document.createElement( "div" );
      if ( m.push( () => {
          r.setAttribute( "aria-hidden", "true" ), r.setAttribute( "data-range", e ), r.className = ( c || "" ) + " line-highlight"
        } ), p && Prism.plugins.lineNumbers ) {
        const o = Prism.plugins.lineNumbers.getLine( u, n ), s = Prism.plugins.lineNumbers.getLine( u, i );
        if ( o ) {
    ...
    if ( p && Prism.util.isActive( u, s ) && i ) {
      ...
      v( ".line-numbers-rows > span", u ).forEach( (e, t) => {
        const n = t + r;
        e.onclick = () => {
          const e = i + "." + n;
          l = !1, location.hash = e, setTimeout( () => {
            l = !0
          }, 1 )
        }
      } )
  ...
  function f() {
    ...
    v( ".temporary.line-highlight" ).forEach( e => {
      e.parentNode.removeChild( e )
    } );
    const t = ( e.match( /\.([\d,-]+)$/ ) || [ , "" ] )[ 1 ];
    if ( t && !document.getElementById( e ) ) {
      const n = e.slice( 0, e.lastIndexOf( "." ) ), i = document.getElementById( n );
...
!(() => {
  if ( "undefined" != typeof self && self.Prism && self.document ) {
    ...
    const e = Prism.plugins.lineNumbers = {
      getLine(e, n) {
        if ( "PRE" === e.tagName && e.classList.contains( o ) ) {
          ...
          if ( t ) {
            const i = parseInt( e.getAttribute( "data-start" ), 10 ) || 1, r = i + ( t.children.length - 1 );
            n < i && ( n = i ), r < n && ( n = r );
            const s = n - i;
            return t.children[ s ]
          }
    ...
    window.addEventListener( "resize", () => {
      ...
      if ( e.code ) {
        const n = e.element, t = n.parentNode;
  ...
  function u( e ) {
    if ( 0 != ( e = e.filter( e => {
      ...
      const n = e.map( e => {
        const n = e.querySelector( "code" ), t = e.querySelector( ".line-numbers-rows" );
        if ( n && t ) {
      ...
      n.forEach( e => {
        const i = e.sizer, n = e.lines, r = e.lineHeights, s = e.oneLinerHeight;
        r[ n.length - 1 ] = void 0, n.forEach( (e, n) => {
          if ( e && 1 < e.length ) {
        ...
        for ( let n = e.sizer, t = e.lineHeights, i = 0, r = 0; r < t.length; r++ ) void 0 === t[ r ] && ( t[ r ] = n.children[ i++ ].getBoundingClientRect().height )
      } ), n.forEach( e => {
        const n = e.sizer, t = e.element.querySelector( ".line-numbers-rows" );
        n.style.display = "none", n.innerHTML = "", e.lineHeights.forEach( (e, n) => {
...
!(() => {
  if ( ( "undefined" == typeof self || self.Prism ) && ( "undefined" == typeof global || global.Prism ) ) {
    const t = /\b([a-z]{3,7}:\/\/|tel:)[\w\-+%~/.:=&@]+(?:\?[\w\-+%~/.:=?&!$'()*,;@]*)?(?:#[\w\-+%~/.:#=?&!$'()*,;@]*)?/, r = /\b\S+@[\w.]+[a-z]{2}/, a = /\[([^\]]+)]\(([^)]+)\)/, l = [ "comment", "url", "attr-value", "string" ];
    ...
    }, Prism.hooks.add( "before-highlight", i => {
      Prism.plugins.autolinker.processGrammar( i.grammar )
    } ), Prism.hooks.add( "wrap", i => {
      if ( /-link$/.test( i.type ) ) {
        i.tag = "a";
        let n = i.content;
...
!(() => {
  if ( "undefined" != typeof self && self.Prism && self.document ) {
    ...
    const g = "data-src-status";
    const c = "loading";
    const u = "loaded";
    const p = "pre[data-src]:not([" + g + '="' + u + '"]):not([' + g + '="' + c + '"])';
    var i = /\blang(?:uage)?-([\w-]+)\b/i;
    r.hooks.add( "before-highlightall", e => {
      e.selector += ", " + p
    } ), r.hooks.add( "before-sanity-check", e => {
      const t = e.element;
      if ( t.matches( p ) ) {
        e.code = "", t.setAttribute( g, c );
        const n = t.appendChild( document.createElement( "CODE" ) );
        n.textContent = "Loading…";
        const i = t.getAttribute( "data-src" );
        let a = e.language;
        if ( "none" === a ) {
          const s = ( /\.(\w+)$/.exec( i ) || [ , "none" ] )[ 1 ];
          a = h[ s ] || s
        }
        d( n, a ), d( t, a );
        const l = r.plugins.autoloader;
        l && l.loadLanguages( a );
        const o = new XMLHttpRequest;
        o.open( "GET", i, !0 ), o.onreadystatechange = () => {
          4 == o.readyState && ( o.status < 400 && o.responseText ? ( t.setAttribute( g, u ), n.textContent = o.responseText, r.highlightElement( n ) ) : ( t.setAttribute( g, "failed" ), 400 <= o.status ? n.textContent = ((e, t) => {
            return "✖ Error " + e + " while fetching file: " + t
          })(o.status, o.statusText) : n.textContent = "✖ Error: File does not exist or is empty" ) )
        }, o.send( null )
      }
    } );
    let e = !( r.plugins.fileHighlight = {
      highlight(e) {
        for ( let t, n = ( e || document ).querySelectorAll( p ), i = 0; t = n[ i++ ]; ) r.highlightElement( t )
      }
    } );
...
!(() => {
  if ( "undefined" != typeof self && self.Prism && self.document ) {
    ...
    const e = Prism.plugins.toolbar.registerButton = (e, n) => {
              let t;
          ...
          t = Prism.plugins.toolbar.hook = a => {
...
!(() => {
  if ( "undefined" != typeof self && self.Prism && self.document )
    if ( Prism.plugins.toolbar ) {
      ...
      Prism.plugins.toolbar.registerButton( "show-language", e => {
        const a = e.element.parentNode;
        if ( a && /pre/i.test( a.nodeName ) ) {
          let t;
          const s = a.getAttribute( "data-language" ) || r[ e.language ] || ( ( t = e.language ) ? ( t.substring( 0, 1 ).toUpperCase() + t.substring( 1 ) ).replace( /s(?=cript)/, "S" ) : t );
          if ( s ) {
...
"undefined" != typeof self && !self.Prism || "undefined" != typeof global && !global.Prism || Prism.hooks.add( "wrap", e => {
  "keyword" === e.type && e.classes.push( "keyword-" + e.content )
} );
!(() => {
  if ( "undefined" != typeof self && "undefined" != typeof Prism && "undefined" != typeof document ) {
    const a = /<\/?(?!\d)[^\s>\/=$<%]+(?:\s(?:\s*[^\s>\/=]+(?:\s*=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+(?=[\s>]))|(?=[\s/>])))+)?\s*\/?>/g,
          c = /^#?((?:[\da-f]){3,4}|(?:[\da-f]{2}){3,4})$/i,
          f = [ n => {
            const r = c.exec( n );
            if ( r ) {
              for ( var o = 6 <= ( n = r[ 1 ] ).length ? 2 : 1, e = n.length / o, s = 1 == o ? 1 / 15 : 1 / 255, t = [], i = 0; i < e; i++ ) {
                const a = parseInt( n.substr( i * o, o ), 16 );
                t.push( a * s )
              }
              return 3 == e && t.push( 1 ), "rgba(" + t.slice( 0, 3 ).map( n => {
    ...
    Prism.hooks.add( "wrap", n => {
      if ( "color" === n.type || 0 <= n.classes.indexOf( "color" ) ) {
        ...
        if ( !r ) return;
        const i = '<span class="inline-color-wrapper"><span class="inline-color" style="background-color:' + r + ';"></span></span>';
        n.content = i + o
      }
    } )
  }
...
!(() => {
  if ( "undefined" != typeof self && self.Prism && self.document && document.createElement ) {
    ...
    var p = {};
    let e = "components/";
    const a = Prism.util.currentScript();
    if ( a ) {
      const r = /\bplugins\/autoloader\/prism-autoloader\.(?:min\.)?js(?:\?[^\r\n/]*)?$/i, s = /(^|\/)[\w-]+\.(?:min\.)?js(?:\?[^\r\n/]*)?$/i, t = a.getAttribute( "data-autoloader-path" );
    ...
    Prism.hooks.add( "complete", e => {
      const a = e.element, r = e.language;
      if ( a && r && "none" !== r ) {
        const s = (e => {
          let a = ( e.getAttribute( "data-dependencies" ) || "" ).trim();
          if ( !a ) {
        ...
        /^diff-./i.test( r ) ? ( s.push( "diff" ), s.push( r.substr( "diff-".length ) ) ) : s.push( r ), s.every( u ) || m( s, () => {
      ...
      !((a, r, s) => {
        ...
        function e() {
          ...
          e || ( e = p[ a ] = {
            ...
            success: r,
            error: s
          } ), !t && u( a ) ? k( a, "success" ) : !t && e.error ? k( a, "error" ) : !t && e.loading || ( e.loading = !0, e.error = !1, ((e, a, r) => {
    ...
    Prism.hooks.add( "before-highlight", e => {
      ...
      if ( !t.complete && e.code ) {
        ...
        if ( n && /pre/i.test( n.nodeName ) && ( f.test( n.className ) || f.test( e.element.className ) ) ) {
          const a = e.element.querySelector( "." + p );
          a && a.remove();
          const s = e.code.split( "\n" );
          t.numberOfLines = s.length;
          const o = t.outputLines = [], r = n.getAttribute( "data-output" ), i = n.getAttribute( "data-filter-output" );
          if ( null !== r ) r.split( "," ).forEach( e => {
            const t = e.split( "-" );
            let n = parseInt( t[ 0 ], 10 );
            let a = 2 === t.length ? parseInt( t[ 1 ], 10 ) : n;
            if ( !isNaN( n ) && !isNaN( a ) ) {
              n < 1 && ( n = 1 ), a > s.length && ( a = s.length ), a--;
              for ( let r = --n; r <= a; r++ ) o[ r ] = s[ r ], s[ r ] = ""
            }
          } );
          else if ( i )
            for ( let l = 0; l < s.length; l++ ) m( s[ l ], i ) && ( o[ l ] = s[ l ].slice( i.length ), s[ l ] = "" );
          e.code = s.join( "\n" )
        } else t.complete = !0
      } else t.complete = !0
      ...
      if ( !t.complete ) {
        ...
        const r = t.numberOfLines || 0, s = u( "data-prompt", "" );
        ...
        for ( let i = t.outputLines || [], l = 0, m = i.length; l < m; l++ )
...
!(() => {
  if ( "undefined" != typeof self && self.Prism && self.document )
    if ( Prism.plugins.toolbar ) {
      let c = window.ClipboardJS || void 0;
      c || "function" != typeof require || ( c = require( "clipboard" ) );
      const u = [];
      if ( !c ) {
        const t = document.createElement( "script" ), o = document.querySelector( "head" );
        t.onload = () => {
...
"undefined" != typeof self && self.Prism && self.document && document.querySelector && Prism.plugins.toolbar.registerButton( "download-file", t => {
  const e = t.element.parentNode;
  if ( e && /pre/i.test( e.nodeName ) && e.hasAttribute( "data-src" ) && e.hasAttribute( "data-download-link" ) ) {
    const a = e.getAttribute( "data-src" ), n = document.createElement( "a" );
...
!(() => {
  if ( "undefined" != typeof self && self.Prism && self.document ) {
    ...
    let h = 0;
    var n = /^(pair-\d+-)(open|close)$/;
    Prism.hooks.add( "complete", e => {
      const t = e.element, n = t.parentElement;
      if ( n && "PRE" == n.tagName ) {
        const c = [];
        if ( Prism.util.isActive( t, "match-braces" ) && c.push( "(", "[", "{" ), 0 != c.length ) {
          n.__listenerAdded || ( n.addEventListener( "mousedown", () => {
            ...
            Array.prototype.slice.call( e.querySelectorAll( ".brace-selected" ) ).forEach( e => {
              e.classList.remove( "brace-selected" )
            } )
          } ), Object.defineProperty( n, "__listenerAdded", {
            value: !0
          } ) );
          const o = Array.prototype.slice.call( t.querySelectorAll( "span.token.punctuation" ) ), l = [];
          c.forEach( e => {
            ...
            c.forEach( e => {
              const t = "pair-" + h++ + "-", n = o[ e[ 0 ] ], c = o[ e[ 1 ] ];
              n.id = t + "open", c.id = t + "close", [ n, c ].forEach( e => {
  ...
  function p() {
    Prism.util.isActive( this, "brace-hover", !0 ) && [ this, e( this ) ].forEach( e => {
      e.classList.add( "brace-hover" )
    } )
  }

  function v() {
    [ this, e( this ) ].forEach( e => {
      e.classList.remove( "brace-hover" )
    } )
  }

  function m() {
    Prism.util.isActive( this, "brace-select", !0 ) && [ this, e( this ) ].forEach( e => {
...
Prism.languages.treeview = {
  ...
  if ( "treeview" === e.language && "entry-name" === e.type ) {
    const t = e.classes, n = /(^|[^\\])\/\s*$/;
    if ( n.test( e.content ) ) e.content = e.content.replace( n, "$1" ), t.push( "dir" );
    else {
      e.content = e.content.replace( /(^|[^\\])[=*|]\s*$/, "$1" );
      for ( const a = e.content.toLowerCase().replace( /\s+/g, "" ).split( "." ); 1 < a.length; ) a.shift(), t.push( "ext-" + a.join( "-" ) )
    }
