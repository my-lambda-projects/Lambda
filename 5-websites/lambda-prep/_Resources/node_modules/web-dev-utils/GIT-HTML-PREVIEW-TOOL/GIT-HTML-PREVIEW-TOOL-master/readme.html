...
<html>
  ...
  <head>
    ...
    <link rel="stylesheet"
      href="file:///c:\Users\bryan\.vscode\extensions\shd101wyy.markdown-preview-enhanced-0.5.17\node_modules\@shd101wyy\mume\dependencies\katex\katex.min.css">
  ...
  <body for="html-export">
    <div class="mume markdown-preview  ">
      <div align="center">
        ...
        <h1><span
            style="color:#08067C; font-weight:1000;font-family: Impact,font-size:36; Haettenschweiler, &apos;Arial Narrow Bold&apos;, sans-serif;">
            <ins>GIT HTML PREVIEW TOOL </ins></span>.</h1>
        ...
        <p><strong>TOC</strong><br>
          ...
          &#x25CF; <a target="_blank" rel="noopener noreferrer" target="_blank" rel="noopener noreferrer"
            ...
            rel="noopener noreferrer" href="#how-it-works">How It
            Works</a> &#x25CF; <a target="_blank" rel="noopener noreferrer" target="_blank" rel="noopener noreferrer"
        ...
        <p><a target="_blank" rel="noopener noreferrer" target="_blank" rel="noopener noreferrer" href="#-"><img
              ...
              alt="-----------------------------------------------------"></a></p>
        <p><img alt="Git"
            src="https://img.shields.io/badge/git%20-%23F05033.svg?&amp;style=for-the-badge&amp;logo=git&amp;logoColor=white"><img
            alt="JavaScript"
            src="https://img.shields.io/badge/javascript%20-%23323330.svg?&amp;style=for-the-badge&amp;logo=javascript&amp;logoColor=%23F7DF1E"><img
            alt="NodeJS"
            src="https://img.shields.io/badge/node.js%20-%2343853D.svg?&amp;style=for-the-badge&amp;logo=node.js&amp;logoColor=white"><img
            alt="CSS3"
            ...
            alt="Bootstrap"
            src="https://img.shields.io/badge/bootstrap%20-%23563D7C.svg?&amp;style=for-the-badge&amp;logo=bootstrap&amp;logoColor=white"><img
            alt="Bitbucket"
        ...
        <p><a target="_blank" rel="noopener noreferrer" target="_blank" rel="noopener noreferrer" href="#-"><img
              ...
              alt="-----------------------------------------------------"></a></p>
        <h1>Usage:</h1>
        <p style="font-family: Impact, Haettenschweiler, &apos;Arial Narrow Bold&apos;, sans-serif;" # git html preview
          tool ## usage <p><strong>GIT HTML PREVIEW TOOL</strong> was tested under the latest Google Chrome and Mozilla
          Firefox.</p>
        <p><a target="_blank" rel="noopener noreferrer" target="_blank" rel="noopener noreferrer" href="#-"><img
              src="https://raw.githubusercontent.com/andreasbm/readme/master/7-assets/lines/colored.png"
              alt="-----------------------------------------------------"></a></p>
        ...
        <blockquote>
          <p>What it does is: load HTML using CORS proxy, then process all links, frames, scripts and styles, and load
            each of them using CORS proxy, so they can be evaluated by the browser.</p>
        </blockquote>
        <!-- WEBSITE LINK -->
        <h2>Live Deployment</h2>
        <p><a target="_blank" rel="noopener noreferrer" target="_blank" rel="noopener noreferrer"
            href="https://githtmlpreview.netlify.app/">[Live Website]</a>
        </p>
      ...
      <div align="center">
        <h2>&#x27A4; About</h2>
        <h4>Many GitHub repositories don&apos;t use GitHub Pages to host their HTML files. <strong>GIT HTML PREVIEW
            TOOL</strong> allows you to render those files without cloning or downloading whole repositories. It is a
          client-side solution using a CORS proxy to fetch assets.</h4>
        <h4>If you try to open raw version of any HTML, CSS or JS file in a web browser directly from GitHub, all you
          will see is a source code. GitHub forces them to use the &quot;text/plain&quot; content-type, so they cannot
          be interpreted. This script overrides it by using a CORS proxy.</h4>
        <hr>
        <blockquote>
          <p>Cross-Origin Resource Sharing (CORS) is a security mechanism that uses additional HTTP headers to tell
            browsers to give a web application running at one origin, access to selected resources from a different
            origin. A web application executes a cross-origin HTTP request when it requests a resource(Images, Scripts,
            CSS files, etc.)that has a different origin (domain, protocol, or port) from its own.</p>
        </blockquote>
        <blockquote>
          <p>Cross-origin requests, however, mean that servers must implement ways to handle requests from origins
            outside of their own. CORS allows servers to specify who (i.e., which origins) can access the assets on the
            server, among many other things.</p>
        </blockquote>
        <blockquote>
          <p>Access-Control-Allow-Origin Header<br>
            When Site A tries to fetch content from Site B, Site B can send an Access-Control-Allow-Origin response
            header to tell the browser that the content of this page is accessible to certain origins. (An origin is a
            domain, plus a scheme and port number.) By default, Site B&apos;s pages are not accessible to any other
            origin; using the Access-Control-Allow-Origin header opens a door for cross-origin access by specific
            requesting origins. The Access-Control-Allow-Origin header is critical to resource security.<br>
            You can find a description of each CORS header at the following: CORS Headers.<br>
            Pre-Flight Request<br>
            Most servers will allow GET requests but may block requests to modify resources on the server. Servers
            don&apos;t just blindly block such requests though; they have a process in place that first checks and then
            communicates to the client (your web browser) which requests are allowed.<br>
            When a request is made using any of the following HTTP request methods, a standard preflight request will be
            made before the original request.<br>
            PUT<br>
            DELETE<br>
            CONNECT<br>
            OPTIONS<br>
            TRACE<br>
            PATCH<br>
            Preflight requests use the OPTIONS header. The preflight request is sent before the original request, hence
            the term &quot;preflight.&quot; The purpose of the preflight request is to determine whether or not the
            original request is safe (for example, a DELETE request). The server will respond to the preflight request
            and indicate whether or not the original request is safe. If the server specifies that the original request
            is safe, it will allow the original request. Otherwise, it will block the original request.</p>
        </blockquote>
        <hr>
        <h2>&#x27A4; Development:</h2>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
        ...
        <p><em><strong>(Full-stack software developer)</strong></em><br>
          <a target="_blank" rel="noopener noreferrer" target="_blank" rel="noopener noreferrer"
            href="https://bgoonz.github.io"><img
              src="https://img.shields.io/badge/-%E2%9D%A4_Portfolio-f58?style=flat-square&amp;logo=a&amp;logoColor=white&amp;link=https://bgoonz.github.io/"
              alt="Portfolio"></a> <a
            ...
            download><img
              ...
              alt="Resume PDF"></a> <a target="_blank" rel="noopener noreferrer" target="_blank"
            rel="noopener noreferrer" href="mailto:bryan.guner@gmail.com"><img
              src="https://img.shields.io/badge/bryan.guner@gmail.com-f4b400?style=flat-square&amp;logo=gmail&amp;logoColor=black&amp;link=mailto:bryan.guner@gmail.com"
              alt="Bryan&apos;s email"></a> <a target="_blank" rel="noopener noreferrer" target="_blank"
            rel="noopener noreferrer" href="https://web-dev-hub.com/"><img
            ...
            href="https://github.com/bgoonz"><img
              src="https://img.shields.io/github/followers/bgoonz?label=follow&amp;style=social"
              alt="GitHub bgoonz"></a></p>
      </div>
      <br clear="both">
      <p><a target="_blank" rel="noopener noreferrer" target="_blank" rel="noopener noreferrer" href="#-"><img
            src="https://raw.githubusercontent.com/andreasbm/readme/master/7-assets/lines/colored.png"
    ...
    <a target="_blank" rel="noopener noreferrer" target="_blank" rel="noopener noreferrer" id="sidebar-toc-btn">≡</a>
