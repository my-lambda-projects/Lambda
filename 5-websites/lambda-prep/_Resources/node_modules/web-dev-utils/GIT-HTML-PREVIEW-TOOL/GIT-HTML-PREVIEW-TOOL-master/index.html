  ...
  <body>
    <form id="previewform" class="userInfoForm" onsubmit="location.href='/?'+this.file.value;return false">
      ...
      <p>
        ...
        <input type="url" id="file" class="userInfoForm" value=""
          placeholder="e.g. https://github.com/user/repo/blob/master/index.html" size="60" autofocus>
        <input type="submit" value="Preview">
      </p>

      <p>try </p>
      <pre><code>  <ul>
<a target="_blank" rel="noopener noreferrer"target="_blank" rel="noopener noreferrer"href="https://github.com/bgoonz/GIT-HTML-PREVIEW-TOOL/blob/master/readme.html">
<li></a>
