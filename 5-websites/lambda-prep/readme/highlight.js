...
var Highlight = (u => {
  ...
  var M = {
    manual: u.Highlight && u.Highlight.manual,
    disableWorkerMessageHandler: u.Highlight && u.Highlight.disableWorkerMessageHandler,
    util: {
      encode: function e( n ) {
        ...
        for ( var o in t )
          if ( t.hasOwnProperty( o ) && t[ o ] ) {
            ...
            for ( var u = 0; u < s.length; ++u ) {
              ...
              for (
                var p = c.pattern || c, m = a.next, y = i; m !== r.tail && !( l && y >= l.reach ); y += m.value.length, m = m.next
              ) {
                var k = m.value;
                ...
                if ( !( k instanceof W ) ) {
                  ...
                  if ( h ) {
                    ...
                    for (
                      var S = m; S !== r.tail &&
                      ( P < A || "string" == typeof S.value ); S = S.next
                    )
                      x++, ( P += S.value.length );
...
"undefined" != typeof module && module.exports && ( module.exports = Highlight ),
  "undefined" != typeof global && ( global.Highlight = Highlight );
...
( Highlight.languages.markup.tag.inside[ "attr-value" ].inside.entity =
  Highlight.languages.markup.entity ),
( Highlight.languages.markup.doctype.inside[ "internal-subset" ].inside =
  Highlight.languages.markup ),
Highlight.hooks.add( "wrap", a => {
    "entity" === a.type &&
      ( a.attributes.title = a.content.replace( /&amp;/, "&" ) );
  } ),
  Object.defineProperty( Highlight.languages.markup.tag, "addInlined", {
    value(a, e) {
      var s = {};
      ( s[ "language-" + e ] = {
        pattern: /(^<!\[CDATA\[)[\s\S]+?(?=\]\]>$)/i,
        lookbehind: !0,
        inside: Highlight.languages[ e ]
      } ),
      ( s.cdata = /^<!\[CDATA\[|\]\]>$/i );
      var n = {
        "included-cdata": {
      ...
      Highlight.languages.insertBefore( "markup", "cdata", t );
    }
  } ),
  ( Highlight.languages.html = Highlight.languages.markup ),
  ( Highlight.languages.mathml = Highlight.languages.markup ),
  ( Highlight.languages.svg = Highlight.languages.markup ),
  ( Highlight.languages.xml = Highlight.languages.extend( "markup", {} ) ),
  ( Highlight.languages.ssml = Highlight.languages.xml ),
  ( Highlight.languages.atom = Highlight.languages.xml ),
  ( Highlight.languages.rss = Highlight.languages.xml );
!(s => {
  var e = /("|')(?:\\(?:\r\n|[\s\S])|(?!\1)[^\\\r\n])*\1/;
  ( s.languages.css = {
    comment: /\/\*[\s\S]*?\*\//,
...
( Highlight.languages.javascript = Highlight.languages.extend( "clike", {
  "class-name": [
    Highlight.languages.clike[ "class-name" ],
    {
...
Highlight.languages.insertBefore( "javascript", "keyword", {
    regex: {
      ...
      inside: {
        "regex-source": {
          ...
          inside: Highlight.languages.regex
        },
        "regex-flags": /[a-z]+$/,
        "regex-delimiter": /^\/|\/$/
      }
  ...
  Highlight.languages.insertBefore( "javascript", "string", {
    "template-string": {
      pattern: /`(?:\\[\s\S]|\${(?:[^{}]|{(?:[^{}]|{[^}]*})*})+}|(?!\${)[^\\`])*`/,
      greedy: !0,
      inside: {
  ...
  Highlight.languages.markup &&
  Highlight.languages.markup.tag.addInlined( "script", "javascript" ),
  ...
  description: {
    ...
    inside: {
      "language-markdown": {
        pattern: /(^"(?:"")?)(?!\1)[\s\S]+(?=\1$)/,
        lookbehind: !0,
        inside: Highlight.languages.markdown
      }
    }
  },
  string: {
    ...
    if ( "groovy" === e.language && "string" === e.type ) {
      ...
      if ( "'" != t ) {
        ...
        "$" === t && ( n = /([^\$])(?:\$(?:\{.*?\}|[\w.]+))/ ),
          ...
          ( e.content = Highlight.highlight( e.content, {
            expression: {
              pattern: n,
              lookbehind: !0,
...
( Highlight.languages.webmanifest = Highlight.languages.json );
!(n => {
  var e = /("|')(?:\\(?:\r\n?|\n|.)|(?!\1)[^\\\r\n])*\1/;
...
( Highlight.languages.jsonp = Highlight.languages.extend( "json", {
  punctuation: /[{}[\]();,.]/
} ) ),
Highlight.languages.insertBefore( "jsonp", "punctuation", {
  function: /(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*\()/
} );
Highlight.languages.jsstacktrace = {
  "error-message": {
    pattern: /^\S.*/m,
    alias: "string"
  },
...
!(u => {
  ...
  var n = e.pattern.source;
  var a = e.inside.interpolation;
  var i = a.inside[ "interpolation-punctuation" ];
  var r = a.pattern.source;
  ...
  function d( e ) {
    ...
    if ( 3 === n.length ) {
      var r = [ 1, 1 ];
      r.push(...o( n[ 1 ], u.languages.javascript, "javascript" )),
        n.splice(...r);
    }
    ...
    ( function e( t ) {
      for ( var n = 0; n < t.length; n++ ) {
        ...
        if ( "string" == typeof r || "string" == typeof r.content ) {
          var a = v[ f ];
          var i = "string" == typeof r ? r : r.content;
          var o = i.indexOf( a );
    ...
    u.hooks.add( "wrap", n => {
      if ( "code-block" === n.type ) {
        ...
        if ( o ) {
          ...
          ( n.attributes.id = d ),
          u.plugins.autoloader.loadLanguages( e, () => {
...
!(a => {
  ...
  var i = /\b0b[01]+(?:_[01]+)*\b|\b0o[0-7]+(?:_[0-7]+)*\b|\b0x[\da-f]+(?:_[\da-f]+)*\b|(?:\b\d+(?:_\d+)*\.?(?:\d+(?:_\d+)*)?|\B\.\d+)(?:e[+-]?\d+)?/i;
  var n = /<?=>|\?\?=?|\.{3}|\??->|[!=]=?=?|::|\*\*=?|--|\+\+|&&|\|\||<<|>>|[?~]|[/^|%*&<>.+-]=?/;
  var s = /[{}\[\](),:;]/;
  a.languages.php = {
    delimiter: {
...
!(e => {
  var i = ( Highlight.languages.powershell = {
      comment: [ {
          pattern: /(^|[^`])<#[\s\S]*?#>/,
          lookbehind: !0
        },
...
( Highlight.languages.python[
  "string-interpolation"
].inside.interpolation.inside.rest = Highlight.languages.python ),
( Highlight.languages.py = Highlight.languages.python );
Highlight.languages.scheme = {
  comment: /;.*|#;\s*\((?:[^()]|\([^()]*\))*\)|#\|(?:[^#|]|#(?!\|)|\|(?!#)|#\|(?:[^#|]|#(?!\|)|\|(?!#))*\|#)*\|#/,
  string: {
    pattern: /"(?:[^"\\]|\\.)*"/,
    greedy: !0
  ...
  number: {
    pattern: RegExp((r => {
      for ( var e in r )
        r[ e ] = r[ e ].replace( /<[\w\s]+>/g, e => "(?:" + r[ e ].trim() + ")" );
...
( Highlight.languages.racket = Highlight.languages.extend( "scheme", {
  "lambda-parameter": {
    pattern: /(\(lambda\s+\()[^()'\s]+/,
    lookbehind: !0
  }
} ) ),
Highlight.languages.DFS( Highlight.languages.racket, function ( e, a ) {
    if ( "RegExp" === Highlight.util.type( a ) ) {
  ...
  Highlight.languages.insertBefore( "racket", "string", {
    lang: {
      pattern: /^#lang.+/m,
      greedy: !0,
      alias: "keyword"
  ...
  ( Highlight.languages.rkt = Highlight.languages.racket );
!(o => {
...
!(a => {
  ...
  var n = /\\(?:x[\da-fA-F]{2}|u[\da-fA-F]{4}|u\{[\da-fA-F]+\}|c[a-zA-Z]|0[0-7]{0,2}|[123][0-7]{2}|.)/;
  var t = "(?:[^\\\\-]|" + n.source + ")";
  var s = RegExp( t + "-" + t );
...
Highlight.languages.insertBefore( "scss", "atrule", {
  ...
  Highlight.languages.insertBefore( "scss", "important", {
    variable: /\$[-\w]+|#\{\$[-\w]+\}/
  } ),
  ...
  ( Highlight.languages.scss.atrule.inside.rest = Highlight.languages.scss );
Highlight.languages.sql = {
  comment: {
    pattern: /(^|[^\\])(?:\/\*[\s\S]*?\*\/|(?:--|\/\/|#).*)/,
    lookbehind: !0
  },
...
!(e => {
  ...
  var a = "(?:[^\\s\\x00-\\x08\\x0e-\\x1f!\"#%&'*,\\-:>?@[\\]`{|}\\x7f-\\x84\\x86-\\x9f\\ud800-\\udfff\\ufffe\\uffff]|[?:-]<PLAIN>)(?:[ \t]*(?:(?![#:])<PLAIN>|:<PLAIN>))*".replace(
    /<PLAIN>/g,
...
!(() => {
  if (
    ...
    Highlight.hooks.add( "before-sanity-check", e => {
      ...
      Highlight.hooks.add( "complete", function e( t ) {
        var n = t.element.parentElement;

        if ( c( n ) ) {
          clearTimeout( u );
          var i = Highlight.plugins.lineNumbers;
          var r = t.plugins && t.plugins.lineNumbers;
          if ( b( n, o ) && i && !r ) Highlight.hooks.add( "line-numbers", e );
  ...
  function c( e ) {
    return (
      ...
      ( !!e.hasAttribute( "data-line" ) ||
        !( !e.id || !Highlight.util.isActive( e, s ) ) )
    );
  }
  ...
  function d( u, e, c ) {
    ...
    var d = +u.getAttribute( "data-line-offset" ) || 0;
    var f = ( a() ? parseInt : parseFloat )( getComputedStyle( u ).lineHeight );
    var p = Highlight.util.isActive( u, o );
    var n = u.querySelector( "code" );
    var h = p ? u : n || u;
    var m = [];
    ...
    t.forEach( e => {
      ...
      if (
        ( m.push( () => {
          ...
          p && Highlight.plugins.lineNumbers )
      ) {
        var o = Highlight.plugins.lineNumbers.getLine( u, n );
        var s = Highlight.plugins.lineNumbers.getLine( u, i );
    ...
    if ( p && Highlight.util.isActive( u, s ) && i ) {
      b( u, s ) ||
        m.push( () => {
          u.classList.add( s );
        } );
...
!(() => {
  if ( "undefined" != typeof self && self.Highlight && self.document ) {
    var o = "line-numbers";
    var a = /\n(?!$)/g;

    var e = ( Highlight.plugins.lineNumbers = {
      getLine(e, n) {
    ...
    window.addEventListener( "resize", () => {
      ...
      Highlight.hooks.add( "complete", e => {
        if ( e.code ) {
          var n = e.element;
          var t = n.parentNode;
          ...
          if (
            ...
            Highlight.util.isActive( n, o )
          ) {
            n.classList.remove( o ), t.classList.add( o );
            var i;
            var r = e.code.match( a );
            var s = r ? r.length + 1 : 1;
            var l = new Array( s + 1 ).join( "<span></span>" );
            ( i = document.createElement( "span" ) ).setAttribute(
              ...
              u( [ t ] ),
              Highlight.hooks.run( "line-numbers", e );
          }
        }
      } ),
      Highlight.hooks.add( "line-numbers", e => {
  ...
  function u( e ) {
    if (
      ...
      n.forEach( e => {
        ...
        n.forEach( e => {
          for (
            var n = e.sizer, t = e.lineHeights, i = 0, r = 0; r < t.length; r++
          )
            void 0 === t[ r ] &&
        ...
        n.forEach( e => {
          var n = e.sizer;
          var t = e.element.querySelector( ".line-numbers-rows" );
...
!(() => {
  if (
    ( "undefined" == typeof self || self.Highlight ) &&
    ( "undefined" == typeof global || global.Highlight )
  ) {
    var t = /\b([a-z]{3,7}:\/\/|tel:)[\w\-+%~/.:=&@]+(?:\?[\w\-+%~/.:=?&!$'()*,;@]*)?(?:#[\w\-+%~/.:#=?&!$'()*,;@]*)?/;
    var r = /\b\S+@[\w.]+[a-z]{2}/;
    var a = /\[([^\]]+)]\(([^)]+)\)/;
    var l = [ "comment", "url", "attr-value", "string" ];
    ( Highlight.plugins.autolinker = {
      processGrammar(i) {
        i &&
          !i[ "url-link" ] &&
          ( Highlight.languages.DFS( i, function ( i, n, e ) {
              -1 < l.indexOf( e ) &&
                !Array.isArray( n ) &&
                ( n.pattern ||
                  ( n = this[ i ] = {
                  ...
                  "attr-value" == e ?
                  Highlight.languages.insertBefore(
                    "inside",
                    "punctuation", {
                      "url-link": t
                    },
    ...
    Highlight.hooks.add( "before-highlight", i => {
        Highlight.plugins.autolinker.processGrammar( i.grammar );
      } ),
      Highlight.hooks.add( "wrap", i => {
        if ( /-link$/.test( i.type ) ) {
          i.tag = "a";
          var n = i.content;
...
!(() => {
  if ( "undefined" != typeof self && self.Highlight && self.document ) {
              ...
              4 == o.readyState &&
                ( o.status < 400 && o.responseText ?
                  ...
                  ( t.setAttribute( g, "failed" ),
                    400 <= o.status ?
                    ( n.textContent = ((e, t) => "✖ Error " + e + " while fetching file: " + t)(o.status, o.statusText) ) :
                    ( n.textContent =
    ...
    r.fileHighlight = function(...args) {
      e ||
        ( console.warn(
            "Highlight.fileHighlight is deprecated. Use `Highlight.plugins.fileHighlight.highlight` instead."
          ),
          ( e = !0 ) ),
        r.plugins.fileHighlight.highlight.apply( this, args );
    };
  }
...
!(() => {
  if ( "undefined" != typeof self && self.Highlight && self.document ) {
    ...
    Highlight.plugins.toolbar = {};

    var e = ( Highlight.plugins.toolbar.registerButton = (e, n) => {
        var t;
        ( t =
          "function" == typeof n ?
          n :
    ...
    var t = ( Highlight.plugins.toolbar.hook = a => {
    ...
    e( "label", e => {
        ...
        if ( t && /pre/i.test( t.nodeName ) && t.hasAttribute( "data-label" ) ) {
          var n;
          var a;
          var r = t.getAttribute( "data-label" );
      ...
      Highlight.hooks.add( "complete", t );
  }
})();
!(() => {
  if ( "undefined" != typeof self && self.Highlight && self.document )
    if ( Highlight.plugins.toolbar ) {
      var r = {
        none: "Plain text",
        html: "HTML",
        xml: "XML",
      ...
      Highlight.plugins.toolbar.registerButton( "show-language", e => {
...
!(() => {
  if (
    "undefined" != typeof self &&
    "undefined" != typeof Highlight &&
    "undefined" != typeof document
  ) {
    var a = /<\/?(?!\d)[^\s>\/=$<%]+(?:\s(?:\s*[^\s>\/=]+(?:\s*=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+(?=[\s>]))|(?=[\s/>])))+)?\s*\/?>/g;
    var c = /^#?((?:[\da-f]){3,4}|(?:[\da-f]{2}){3,4})$/i;
    ...
    Highlight.hooks.add( "wrap", n => {
      if ( "color" === n.type || 0 <= n.classes.indexOf( "color" ) ) {
        for (
          var r, o = n.content, e = o.split( a ).join( "" ), s = 0, t = f.length; s < t && !r; s++
        )
          r = f[ s ]( e );
...
!(() => {
  if (
    ...
    var p = {};
    var e = "components/";
    var a = Highlight.util.currentScript();

    if ( a ) {
      var r = /\bplugins\/autoloader\/Highlight-autoloader\.(?:min\.)?js(?:\?[^\r\n/]*)?$/i;
      var s = /(^|\/)[\w-]+\.(?:min\.)?js(?:\?[^\r\n/]*)?$/i;
      var t = a.getAttribute( "data-autoloader-path" );
    ...
    var o = ( Highlight.plugins.autoloader = {
      languages_path: e,
      use_minified: !0,
      loadLanguages: m
    } );
  ...
  function u( e ) {
    ...
    if ( ( e = n[ e ] || e ) in Highlight.languages ) return !0;
    var a = p[ e ];
...
!(() => {
  if ( "undefined" != typeof self && self.Highlight && self.document ) {
    ...
    var p = "command-line-prompt";

    var m = "".startsWith ?
    (e, t) => e.startsWith( t ) :
    (e, t) => 0 === e.indexOf( t );

    Highlight.hooks.add( "before-highlight", e => {
        var t = h( e );
        ...
        if ( !t.complete && e.code ) {
          ...
          if (
            ...
            var i = n.getAttribute( "data-filter-output" );
            if ( null !== r )
              r.split( "," ).forEach( e => {
                var t = e.split( "-" );
                var n = parseInt( t[ 0 ], 10 );
                var a = 2 === t.length ? parseInt( t[ 1 ], 10 ) : n;
      ...
      Highlight.hooks.add( "before-insert", e => {
        var t = h( e );
...
!(() => {
  if ( "undefined" != typeof self && self.Highlight && self.document )
    if ( Highlight.plugins.toolbar ) {
      ...
      Highlight.plugins.toolbar.registerButton(
        "copy-to-clipboard",
        t => {
          var o = t.element;
          ...
          var e = (t => {
            ...
            for ( var e in o ) {
              for (
                var n = "data-Highlightjs-" + e, r = t; r && !r.hasAttribute( n );
...
"undefined" != typeof self &&
  ...
  self.document &&
  document.querySelector &&
  Highlight.plugins.toolbar.registerButton( "download-file", t => {
...
!(() => {
  if ( "undefined" != typeof self && self.Highlight && self.document ) {
    ...
    Highlight.hooks.add( "complete", e => {
      ...
      if ( n && "PRE" == n.tagName ) {
        ...
        if (
          ( Highlight.util.isActive( t, "match-braces" ) && c.push( "(", "[", "{" ),
            0 != c.length )
        ) {
          n.__listenerAdded ||
          ...
          c.forEach( e => {
            for (
              var t = d[ e ], n = u[ e ], c = [], r = [], s = 0; s < o.length; s++
            ) {
              var a = o[ s ];
  ...
  function p() {
    Highlight.util.isActive( this, "brace-hover", !0 ) && [ this, e( this ) ].forEach( e => {
  ...
  function m() {
    Highlight.util.isActive( this, "brace-select", !0 ) && [ this, e( this ) ].forEach( e => {
      e.classList.add( "brace-selected" );
    } );
  }
})();
( Highlight.languages.treeview = {
  "treeview-part": {
    pattern: /^.+/m,
    inside: {
      "entry-line": [ {
...
Highlight.hooks.add( "wrap", e => {
  if ( "treeview" === e.language && "entry-name" === e.type ) {
    ...
    if ( n.test( e.content ) )
      ...
      for (
        var a = e.content.toLowerCase().replace( /\s+/g, "" ).split( "." ); 1 < a.length;
