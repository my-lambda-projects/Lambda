...
function useDocsSearchVersionsHelpers() {
  ...
  const [ searchVersions, setSearchVersions ] = useState( () => {
    return Object.entries( allDocsData ).reduce( ( acc, [ pluginId,
      pluginData
    ] ) => {
      return {
        ...acc,
    ...
    div className = {
      ...
      versionedPluginEntries.map( ( [ pluginId, docsData ] ) => {
        ...
        return ( <
          ...
          defaultValue = {
            docsSearchVersionsHelpers.searchVersions[ pluginId ]
          }
          className = {
            styles.searchVersionInput
          } > {
...
function SearchPage() {
  ...
  const makeSearch = ( page = 0 ) => {
    algoliaHelper.addDisjunctiveFacetRefinement( 'docusaurus_tag',
    'default' );
  ...
  return ( <
    ...
    <
    div className = {
      clsx( 'col', styles.searchQueryColumn, {
...

    {
      docsSearchVersionsHelpers.versioningEnabled && ( <
        SearchVersionSelectList docsSearchVersionsHelpers = {
          docsSearchVersionsHelpers
        }
        />
      )
    ...
    <
    div className = {
      clsx( 'row', 'margin-vert--sm' )
    } >
    <
    div className = {
      clsx( 'col', 'col--8', styles.searchResultsColumn )
    } > {
    ...
    <
    div className = {
      clsx( 'col', 'col--4', styles.searchLogoColumn )
    } >
    <
    a target = "_blank"
    ...
    path fill = "#5468FF"
    d =
    "M78.988.938h16.594a2.968 2.968 0 0 1 2.966 2.966V20.5a2.967 2.967 0 0 1-2.966 2.964H78.988a2.967 2.967 0 0 1-2.966-2.964V3.897A2.961 2.961 0 0 1 78.988.938z" /
    >
    <
    path fill = "white"
    d =
    "M89.632 5.967v-.772a.978.978 0 0 0-.978-.977h-2.28a.978.978 0 0 0-.978.977v.793c0 .088.082.15.171.13a7.127 7.127 0 0 1 1.984-.28c.65 0 1.295.088 1.917.259.082.02.164-.04.164-.13m-6.248 1.01l-.39-.389a.977.977 0 0 0-1.382 0l-.465.465a.973.973 0 0 0 0 1.38l.383.383c.062.061.15.047.205-.014.226-.307.472-.601.746-.874.281-.28.568-.526.883-.751.068-.042.075-.137.02-.2m4.16 2.453v3.341c0 .096.104.165.192.117l2.97-1.537c.068-.034.089-.117.055-.184a3.695 3.695 0 0 0-3.08-1.866c-.068 0-.136.054-.136.13m0 8.048a4.489 4.489 0 0 1-4.49-4.482 4.488 4.488 0 0 1 4.49-4.482 4.488 4.488 0 0 1 4.489 4.482 4.484 4.484 0 0 1-4.49 4.482m0-10.85a6.363 6.363 0 1 0 0 12.729 6.37 6.37 0 0 0 6.372-6.368 6.358 6.358 0 0 0-6.371-6.36" /
    >
    <
    /g> <
    /svg> <
          ...
          searchResultState.items.map(
            ( {
                  ...
                  span className = {
                    ...
                    breadcrumbs.map( ( html, index ) => ( <
                      React.Fragment key = {
                        ...
                        index !== 0 && ( <
                          span className = {
                            styles.searchResultItemPathSeparator
                          } > ›
                          <
                          /span>
                        )
...

              {
                summary && ( <
                  p className = {
                    styles.searchResultItemSummary
                  }
                  // Developer provided the HTML, so assume it's safe.
                  // eslint-disable-next-line react/no-danger
                  dangerouslySetInnerHTML = {
