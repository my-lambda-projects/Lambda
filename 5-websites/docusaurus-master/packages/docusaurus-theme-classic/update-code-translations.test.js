...
const {
  extractThemeCodeMessages
} = require( './update-code-translations' );
...
describe( 'update-code-translations', () => {
  test(
    `to have base.json contain all the translations extracted from the theme. Please run "yarn workspace @docusaurus/theme-classic update-code-translations" to keep base.json up-to-date.`,
    async () => {
