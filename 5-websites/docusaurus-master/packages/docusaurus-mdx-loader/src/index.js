...
module.exports = async function docusaurusMdxLoader( fileString ) {
  ...
  const {
    content
  } = parseMarkdownContentTitle( contentWithTitle, {
  ...
  if ( options.metadataPath && typeof options.metadataPath ===
    'function' ) {
  ...
  if (
    ...
    if ( options.forbidFrontMatter( this.resourcePath ) &&
      hasFrontMatter ) {
      return callback( new Error(
        `Front matter is forbidden in this file` ) );
    }
  }
  const code = `
