...
function Versions( props ) {
  ...
  return ( <
    ...
    <
    a href = {
      `${siteConfig.baseUrl}${siteConfig.docsUrl}/${props.language}/installation`
    } >
    Documentation <
    /a> <
    /td> <
    ...
    <
    a href = {
      `${siteConfig.baseUrl}${siteConfig.docsUrl}/${props.language}/next/installation`
    } >
    Documentation <
    /a> <
    /td> <
    ...
    for previous versions of Docusaurus v1. <
    /p> <
    table className = "versions" >
    <
    tbody > {
      versions.map(
        ...
        version !== latestVersion && ( <
          ...
          <
          a href = {
            `${siteConfig.baseUrl}${siteConfig.docsUrl}/${props.language}/${version}/installation`
          } >
          Documentation <
          /a> <
          /td> <
