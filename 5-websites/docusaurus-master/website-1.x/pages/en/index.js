...
function HomeSplash( props ) {
  ...
  return ( <
    ...
    src = {
      `${siteConfig.baseUrl}img/docusaurus_keytar.svg`
    }
    /> {
      siteConfig.title
    }
    ...
    <
    a className = "button index-ctas-get-started-button"
    href = {
    ...
    <
    iframe src =
    "https://ghbtns.com/github-btn.html?user=facebook&amp;repo=docusaurus&amp;type=star&amp;count=true&amp;size=large"
    frameBorder = {
      0
    }
    scrolling = {
...
class Index extends React.Component {
  render() {
    ...
    return ( <
      ...
      div >
      <
      span className = "announcement-important" > IMPORTANT <
      /span>: this is
      the documentation of {
        ' '
      } <
      span className = "announcement-important" > Docusaurus v1 <
      /span>. <
      /div> <
      div >
      ...
      <
      translate >
      Docusaurus is building websites
      for these projects...
      <
      /translate> <
      /p> <
      Showcase users = {
        pinnedUsersToShowcase
      }
      /> <
      ...
      a className = "button"
      href = {
        `${siteConfig.baseUrl}${this.props.language}/users`
      } >
      <
      ...
      contents = {
        [ {
          ...
          {
            content: '*Open source contributions to the React Native docs have skyrocketed after our move to Docusaurus. The docs are now hosted on a small repo in plain markdown, with none of the clutter that a typical static site generator would require. Thanks Slash!*',
          ...
          {
            content: '*Docusaurus has been a great choice for the ReasonML family of projects. It makes our documentation consistent, i18n-friendly, easy to maintain, and friendly for new contributors.*',
