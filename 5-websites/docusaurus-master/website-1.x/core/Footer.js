...
function SocialFooter( props ) {
  const repoUrl =
    `https://github.com/${props.config.organizationName}/${props.config.projectName}`;
  return ( <
    ...
    <
    a className =
    "github-button" // part of the https://buttons.github.io/buttons.js script in siteConfig.js
    href = {
      repoUrl
    }
    data - count - href = {
    ...
    /div> {
      props.config.twitterUsername && ( <
        ...
        <
        a href = {
          `https://twitter.com/${props.config.twitterUsername}`
        }
...
class Footer extends React.Component {
  render() {
    ...
    return ( <
      ...
      h5 > Community < /h5> <
      a href = {
        `${this.props.config.baseUrl}${this.props.language}/help`
      } >
      Help <
      /a> <
      a href = {
        `${this.props.config.baseUrl}${this.props.language}/users`
      } >
      User Showcase <
      /a> <
      a href = {
        `${this.props.config.baseUrl}${this.props.language}/about-slash`
      } >
      About <
      /a> <
      /div> <
      ...
      <
      img src = {
        `${this.props.config.baseUrl}img/oss_logo.png`
      }
