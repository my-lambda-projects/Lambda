  ...
  [ 6 ], {
    ...
    BEYS: function ( e, t, a ) {
      ...
      function l( e ) {
        ...
        e.registerHelper( "log", ( function ( t, a ) {
          var n = a.data && null != a.data.level ? parseInt( a.data.level, 10 ) : 1
          e.log( n, t )
        } ) )
      }
      var f = {
    ...
    DfGn: function ( e, t, a ) {
      ...
      function v( e, t, a = f.a.clone( t ) ) {
        ...
        "birthdate" === t.type && f.a.defaults( t, {
          startYear: i - 1,
          endYear: i - 125,
          includeBlank: true
        } )
        ...
        const d = m()( "<span>" )
        for ( let n = 0, r = t.order.length, i = r >= 0; i ? n < r : n > r; i ? n++ : n-- ) {
          const r = t.order[ n ]
          const i = e.replace( /(\]?)$/, `(${s[r]}i)$1` )
          const _ = g[ r ]( t, Object( b[ "a" ] )( {
            name: i
          }, a ), o )
          d.append( _ )
          delete a.id
      ...
      S = {
        t: function () {
          ...
          return new M.SafeString( Object( h[ "a" ] )( r[ "default" ].t.apply( r[ "default" ], T.call( e ).concat( [ s ] ) ) ) )
        },
        ...
        contextSensitiveDatetimeTitle: function ( e, t ) {
          ...
          if ( ENV && ENV.CONTEXT_TIMEZONE && ENV.TIMEZONE !== ENV.CONTEXT_TIMEZONE ) {
            ...
            a = m.a.datetimeString( e, {
              timezone: ENV.CONTEXT_TIMEZONE
            } )
            i !== a && ( o = Object( h[ "a" ] )( s ) + ": " + Object( h[ "a" ] )( i ) + "<br>" + Object( h[ "a" ] )( n ) + ": " + Object( h[ "a" ] )( a ) )
          }
          return r ? new M.SafeString( o ) : new M.SafeString( 'data-tooltip data-html-tooltip-title="' + Object( h[ "a" ] )( o ) + '"' )
        },
        friendlyDatetime: function ( e, t ) {
          ...
          o = ""
          o = a && ENV && ENV.CONTEXT_TIMEZONE ? M.helpers.contextSensitiveDatetimeTitle( e, {
            hash: {
              justText: true
            }
        ...
        formattedDate: function ( e, t, a ) {
          ...
          if ( null == e ) return
          f.a.isDate( e ) || ( e = n[ "a" ].parse( e ) )
          return new M.SafeString( "<time data-tooltip title='" + m.a.datetimeString( e ) + "' datetime='" + e.toISOString() + "' " + m.a.raw( r ? "pubdate" : void 0 ) + ">" + Object( h[ "a" ] )( e.toString( t ) ) + "</time>" )
        },
        ...
        durationToString: function ( e ) {
          ...
          t = Math.floor( e / 60 )
          a = e % 60
          return t > 0 ? w.t( "Duration: %{hours} hours and %{minutes} minutes", {
            hours: t,
            minutes: a
          } ) : a > 1 ? w.t( "Duration: %{minutes} minutes", {
            minutes: a
          } ) : w.t( "Duration: 1 minute" )
        },
        addIcon: function ( e ) {
          return new M.SafeString( "<i role='presentation' class='icon-" + Object( h[ "a" ] )( e ) + "'></i>" )
        },
        ...
        tTimeHours: function ( e ) {
          null == e && ( e = "" )
          return 0 === e.getMinutes() && 0 === e.getSeconds() ? r[ "default" ].l( "time.formats.tiny_on_the_hour", e ) : r[ "default" ].l( "time.formats.tiny", e )
        },
        ...
        accessibleDateFormat: function ( e ) {
          null == e && ( e = "datetime" )
          return "date" === e ? w.t( "#helpers.accessible_date_only_format", "YYYY-MM-DD" ) : "time" === e ? w.t( "#helpers.accessible_time_only_format", "hh:mm" ) : w.t( "#helpers.accessible_date_format", "YYYY-MM-DD hh:mm" )
        },
        ...
        checkbox: function ( e, t ) {
          ...
          n = p[ 0 ] + f.a.chain( p ).rest().map( ( function ( e ) {
            return "[" + e + "]"
          } ) ).value().join( "" )
          o = f.a.extend( {
            type: "checkbox",
        ...
        checkedIf: function ( e, t, a ) {
          return 3 === arguments.length ? e === t ? "checked" : "" : e ? "checked" : ""
        },
        selectedIf: function ( e, t, a ) {
          return 3 === arguments.length ? e === t ? "selected" : "" : e ? "selected" : ""
        },
        ...
        truncate_left: function ( e, t ) {
          return M.Utils.escapeExpression( y[ "a" ].truncateText( e.split( "" ).reverse().join( "" ), {
            max: t
          } ).split( "" ).reverse().join( "" ) )
        },
        truncate: function ( e, t ) {
          return M.Utils.escapeExpression( y[ "a" ].truncateText( e, {
            max: t
          } ) )
        },
        ...
        addMasteryIcon: function ( e, t ) {
          ...
          return new M.SafeString( "<i aria-hidden='true' class='icon-" + Object( h[ "a" ] )( a ) + "'></i>" )
        },
    ...
    sTlx: function ( e, t, a ) {
      ...
      var c = Array.isArray || function ( e ) {
        return !( !e || "object" !== typeof e ) && "[object Array]" === _.call( e )
      }
      t.isArray = c
    ...
    "u/6C": function ( e, t, a ) {
      ...
      function u( e, t ) {
        if ( !e ) return `<span class="date-range date-range-no-date">\n  ${Object(_["a"])(i.t("no_date","No Date"))}\n</span>`
        const a = d[ "a" ].parse( e )
        const n = d[ "a" ].parse( t )
    ...
    vRmd: function ( e, t, a ) {
      ...
      function o( e ) {
        ...
        if ( t !== a ) {
          if ( t < a ) {
            var n = s[ a ],
              o = s[ t ]
            throw new r( "Template was precompiled with an older version of Handlebars than the current runtime. Please update your precompiler to a newer version (" + n + ") or downgrade your runtime to an older version (" + o + ")." )
          }
      ...
      function d( e, t ) {
        ...
        var a = function ( e, a, n, i, s, o ) {
          ...
          throw new r( "The partial " + a + " could not be compiled when running in runtime-only mode" )
        }
        var i = {
