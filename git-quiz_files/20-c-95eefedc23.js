  ...
  [ 20 ], {
    "21i1": function ( e, t, i ) {
      ...
      function c( e, t, i ) {
        ...
        const a = t.onFocus
        t.onFocus = ( ...e ) => {
          ENV.use_rce_enhancements || m.showSidebar()
          a instanceof Function && a( ...e )
        }
        r[ "a" ].loadOnTarget( e, t, ( t, r ) => {
          const a = b( e )
          const o = f( s()( t ) )
      ...
      function d( e ) {
        ...
        if ( t.parent().attr( "id" ) !== r ) return t.wrap( `<div id='${r}' style='visibility: hidden'></div>` )
      }

      function u() {
        s()( ".mce-resizehandle" ).attr( "aria-hidden", true )
      }
      let h = 0

      function _() {
        return "random_editor_id_" + h++
      }
      ...
      const p = "with the new RCE you don't need to call this method, it is a no op since there is no sidebar"
      const m = {
        preloadRemoteModule: ( e = ( () => {} ) ) => r[ "a" ].preload( e ),
        initSidebar: a( p, ( e = {} ) => {
          ENV.use_rce_enhancements || l.init( e )
        } ),
        showSidebar: a( p, () => {
          ENV.use_rce_enhancements || l.show()
        } ),
        hideSidebar: a( p, () => {
          ENV.use_rce_enhancements || l.hide()
        } ),
        loadNewEditor( e, t = {}, i ) {
          let r = b( e )
        ...
        closeRCE( e ) {
          window.ENV.use_rce_enhancements && this.callOnRCE( e, "RCEClosed" )
        },
        activateRCE( e ) {
          let t = b( e )
          t = this.freshNode( t )
    ...
    Cvk5: function ( e, t, i ) {
      ...
      class l {
        constructor( e ) {
          ...
          this.$el = s()( "#" + e.editorContainer.id )
        }
        accessiblize() {
          this._cacheElements()
          this._addTitles()
        ...
        _addLabels() {
          this.$el.attr( "aria-label", a.t( "Rich Content Editor" ) )
          ...
          this.$el.find( "div[aria-label='Background color'" ).attr( "aria-label", a.t( "accessibles.background_color", "Background Color, press down to select" ) )
        }
        _addTitles() {
          this.$iframe.attr( "title", a.t( "titles.rte_help", "Rich Text Area. Press ALT+F8 for help" ) )
        }
        _accessiblizeMenubar() {
          const e = this.$el.find( ".mce-menubar" )
          const t = e.find( ".mce-menubtn" ).first()
          e.hide()
          this.editor.addShortcut( "Alt+F9", "", () => {
            e.show()
            t.focus()
            this.editor.addShortcut( "Alt+F9", "", () => t.focus() )
          } )
        }
        _removeStatusbarFromTabindex() {
          const e = this.$el.find( ".mce-statusbar > .mce-container-body" )
          e.attr( "tabindex", -1 )
        }
      }
    },
    iklP: function ( e, t, i ) {
      ...
      function h( e, t ) {
        let i = s()( "#instructure_bookmark_search" )
        if ( !i.length ) {
          i = s()( "<div id='instructure_bookmark_search'/>" )
          ...
          i.find( "form" ).submit( t => {
            t.preventDefault()
            t.stopPropagation()
            const r = new Date
            if ( "diigo" == e && u && r - u < 15e3 ) {
              setTimeout( () => {
                i.find( "form" ).submit()
              }, 15e3 - ( r - u ) )
            ...
            i.find( ".results" ).empty().append( Object( l[ "a" ] )( a.t( "status.searching", "Searching..." ) ) )
            u = new Date
            const n = i.find( ".query" ).val()
            const o = s.a.replaceTags( i.data( "reference_url" ), "query", n )
            s.a.ajaxJSON( o, "GET", {}, e => {
              i.find( ".results" ).empty()
              e.length || i.find( ".results" ).append( Object( l[ "a" ] )( a.t( "no_results_found", "No Results Found" ) ) )
              for ( const t in e ) {
                e[ t ].short_title = e[ t ].title
                e[ t ].title == e[ t ].description && ( e[ t ].short_title = c[ "a" ].truncateText( e[ t ].description, {
                  max: 30
                } ) )
                s()( "<div class='bookmark'/>" ).appendTo( i.find( ".results" ) ).append( s()( '<a class="bookmark_link" style="font-weight: bold;"/>' ).attr( {
                  href: e[ t ].url,
                  title: e[ t ].title
                } ).text( e[ t ].short_title ) ).append( s()( "<div style='margin: 5px 10px; font-size: 0.8em;'/>" ).text( e[ t ].description || a.t( "no_description", "No description" ) ) )
              }
            }, () => {
              i.find( ".results" ).empty().append( Object( l[ "a" ] )( a.t( "errors.search_failed", "Search failed, please try again." ) ) )
            } )
          } )
          i.delegate( ".bookmark_link", "click", ( function ( e ) {
            e.preventDefault()
        ...
        i.find( ".search_button" ).text( "delicious" == e ? a.t( "buttons.search_by_tag", "Search by Tag" ) : a.t( "buttons.search", "Search" ) )
        ...
        i.dialog( {
          title: a.t( "titles.bookmark_search", "Bookmark Search: %{service_name}", {
            service_name: s.a.titleize( e )
          } ),
          open() {
            i.find( "input:visible:first" ).focus().select()
          },
          width: 400
        } )
      }
    ...
    rkWX: function ( e, t, i ) {
      ...
      function o( e ) {
        a[ "a" ].loadSidebarOnTarget( n()( "#editor_tabs" ).get( 0 ), e )
      }
      const s = {
        instance: void 0,
        pendingShow: false,
        ...
        show() {
          if ( this.instance ) {
            this.instance.show()
            this.subscriptions.show && this.subscriptions.show()
          } else this.pendingShow = true
        },
        hide() {
          if ( this.instance ) {
            this.instance.hide()
            this.subscriptions.hide && this.subscriptions.hide()
          } else this.pendingShow = false
        },
        reset() {
    ...
    yiTI: function ( e, t, i ) {
      ...
      function d( e ) {
        ...
        let i = null
        return e => {
          null === i && ( i = c[ "a" ].post( "/api/v1/jwts/refresh", {
            jwt: t
          } ).then( e => {
            i = null
            t = e.data.token
      ...
      class h {
        ...
        defaultConfig() {
          return {
            ...
            [ !window.ENV.use_rce_enhancements && "toolbar" ]: this.toolbar(),
            [ !window.ENV.use_rce_enhancements && "theme" ]: "modern",
            [ !window.ENV.use_rce_enhancements && "skin" ]: false,
            directionality: Object( u[ "b" ] )(),
            plugins: `autolink,media,paste,table,lists,${window.ENV.use_rce_enhancements?"hr,fullscreen,instructure-ui-icons,instructure_condensed_buttons,instructure_documents,instructure_html_view,instructure_media_embed":"textcolor"},link,directionality,a11y_checker,wordcount`,
            external_plugins: {
            ...
            init_instance_callback: e => {
              $( "#tinymce-parent-of-" + e.id ).css( "visibility", "visible" )
            },
        ...
        buildInstructureButtons() {
          let e = " instructure_image instructure_equation" + ( window.ENV.use_rce_enhancements ? " lti_tool_dropdown" : "" )
        ...
        balanceButtons( e ) {
          const t = "table media instructure_links unlink" + e
          let i = ""
          let r = ""
          let n = ""
          if ( this.viewportWidth < 359 && this.viewportWidth > 0 ) {
            i = this.formatBtnGroup
            r = `${this.positionBtnGroup} ${t}`
            n = this.fontBtnGroup
          } else if ( this.viewportWidth < 1200 ) {
            i = `${this.formatBtnGroup} ${this.positionBtnGroup}`
            r = `${t} ${this.fontBtnGroup}`
          } else i = `${this.formatBtnGroup} ${this.positionBtnGroup} ${t} ${this.fontBtnGroup}`
          return window.ENV.use_rce_enhancements ? [ i, r, n ] : [ i, r, n ].map( e => e.split( " " ).join( "," ) )
        }
        toolbar() {
          const e = this.buildInstructureButtons()
          return this.balanceButtons( e )
        }
      }

      function _( e, t, r ) {
        if ( void 0 == r ) var n = false
        else n = r
        return {
          auto_focus: t,
          setup( t ) {
            const r = o()( "#" + t.id )
            t.on( "keyup", e => {
              o()( document ).trigger( "editorKeyUp", [ e ] )
            } )
            t.on( "change", () => {
              r.trigger( "change" )
            } )
            t.on( "keyup keydown click mousedown", () => {
              n && t.selection && r.data( "last_bookmark", t.selection.getBookmark( 1 ) )
            } )
            ENV.use_rce_enhancements || t.on( "init", () => {
              const e = e => e.default ? e.default : e
              const r = e( i( "Cvk5" ) )
              new r( t ).accessiblize()
            } )
            t.on( "init", () => {
              o()( window ).triggerHandler( "resize" )
              o()( t.contentDocument ).bind( "DOMNodeInserted", t => {
                let i, r = t.target
                1 === r.nodeType && "IMG" === r.nodeName && ( i = o()( r ).data( "url" ) ) && o()( r ).attr( "src", e.activeEditor.documentBaseURI.toAbsolute( i ) )
              } )
              "onfocusout" in t.contentWindow || o()( t.contentWindow ).blur( e => {
      ...
      function f( e, t, i, n, a ) {
        const o = new h( a, g[ "a" ], e, t )
        const s = void 0
        return Object( r[ "a" ] )( Object( r[ "a" ] )( Object( r[ "a" ] )( {}, o.defaultConfig() ), _( a, s, n ) ), i.tinyOptions || {} )
      }
      var p = f
      var m = i( "An8g" )
      var b = i( "pQTu" )
      ...
      var y = i( "5Ky4" )
      o.a.fn.dropdownList = function ( e ) {
        if ( this.length ) {
          let i = o()( "#instructure_dropdown_list" )
          if ( "hide" == e || "remove" == e || i.data( "current_dropdown_initiator" ) == this[ 0 ] ) {
            i.remove().data( "current_dropdown_initiator", null )
            return
          }
          e = o.a.extend( {}, o.a.fn.dropdownList.defaults, e )
          var t = i.children( "div.list" )
          if ( !t.length ) {
            i = o()( "<div id='instructure_dropdown_list'><div class='list ui-widget-content'></div></div>" ).appendTo( "body" )
            o()( document ).mousedown( e => {
              i.data( "current_dropdown_initiator" ) && !o()( e.target ).closest( "#instructure_dropdown_list" ).length && i.hide().data( "current_dropdown_initiator", null )
            } ).mouseup( e => {
              if ( i.data( "current_dropdown_initiator" ) && !o()( e.target ).closest( "#instructure_dropdown_list" ).length ) {
                i.hide()
                setTimeout( () => {
                  i.data( "current_dropdown_initiator", null )
                }, 100 )
              }
            } ).add( this ).add( i ).keydown( e => {
              if ( i.data( "current_dropdown_initiator" ) ) {
                const t = i.find( ".ui-state-hover,.ui-state-active" )
                if ( 38 == e.keyCode ) {
                  t.length && t.prev().length ? t.removeClass( "ui-state-hover ui-state-active" ).addClass( "minimal" ).prev().addClass( "ui-state-hover" ).removeClass( "minimal" ).find( "span" ).focus() : $item.focus()
                  return false
                }
                if ( 40 == e.keyCode ) {
                  t.length ? t.next().length && t.removeClass( "ui-state-hover ui-state-active" ).addClass( "minimal" ).next().addClass( "ui-state-hover" ).removeClass( "minimal" ).find( "span" ).focus() : i.find( ".option:first" ).addClass( "ui-state-hover" ).removeClass( "minimal" ).find( "span" ).focus()
                  return false
                }
                if ( 13 == e.keyCode && t.length ) {
                  t.click()
                  return false
                }
                i.hide().data( "current_dropdown_initiator", null )
              }
            } )
            ...
            t = i.children( "div.list" )
          }
          i.data( "current_dropdown_initiator", this[ 0 ] )
          e.width && i.width( e.width )
          e.height && i.find( ".list" ).css( "maxHeight", e.height )
          t.empty()
          o.a.each( e.options, ( e, i ) => {
            const r = o()( "<div class='option minimal' style='cursor: pointer; padding: 2px 5px; overflow: hidden; white-space: nowrap;'>  <span tabindex='-1'>" + e + "</span></div>" ).appendTo( t )

            function n() {
              r.parent().find( "div.option" ).removeClass( "ui-state-hover ui-state-active" ).addClass( "minimal" )
            }
            o.a.isFunction( i ) ? r.addClass( "ui-state-default" ).bind( {
              mouseenter() {
                n()
                r.addClass( "ui-state-hover" ).removeClass( "minimal" )
              },
              mouseleave: n,
              mousedown( e ) {
                e.preventDefault()
                n()
                r.addClass( "ui-state-active" ).removeClass( "minimal" )
              },
              mouseup: n,
              click: i
            } ) : r.addClass( "ui-state-disabled" ).bind( {
              mousedown( e ) {
                e.preventDefault()
              }
            } )
          ...
          i.offset().left + i.width() > o()( window ).width() && i.css( {
            left: "",
            right: 0
          } )
        }
      ...
      var x = {
        buttonConfig( e, t ) {
          ...
          if ( ENV.use_rce_enhancements ) {
            i.id = e.id
            i.onAction = () => {
              t.execCommand( "instructureExternalButton" + e.id )
              this.updateMRUList( e.id )
              this.showHideButtons( t )
            }
            i.description = e.description
            i.favorite = e.favorite
          } else i.cmd = "instructureExternalButton" + e.id
        ...
        clumpedButtonMapping: ( e, t, i ) => e.reduce( ( e, r ) => {
          let n
        ...
        showHideButtons( e ) {
          ...
          if ( null !== ( t = window.localStorage ) && void 0 !== t && t.getItem( "ltimru" ) ) {
        ...
        updateMRUList( e ) {
          ...
          try {
            var i
            t = JSON.parse( ( null === ( i = window.localStorage ) || void 0 === i ? void 0 : i.getItem( "ltimru" ) ) || "[]" )
          } catch ( e ) {
            console.log( "Found bad LTI MRU data", e.message )
          } finally {
            Array.isArray( t ) || ( t = [] )
          }
          try {
            if ( !t.includes( e ) ) {
              ...
              t.unshift( e )
              t.splice( w, t.length )
              null === ( r = window.localStorage ) || void 0 === r || r.setItem( "ltimru", JSON.stringify( t ) )
            }
          } catch ( e ) {
            console.log( "Cannot save LTI MRU list", e.message )
          }
        }
      }
      var T = i( "mykf" )
      ...
      const C = function ( e, t ) {
        ...
        this.selectionDetails = {
          node: e.selection.getNode(),
          range: e.selection.getRng()
        }
        this.$editorEl = t
        this.getEditor = function () {
          if ( void 0 !== this.$editorEl ) return this.$editorEl
          return o()( "#" + this.id )
        }
        this.createLink = function ( e, t, i ) {
          Object( E[ "d" ] )( this.getEditor(), "create_link", {
            url: e,
            classes: t,
      ...
      class A {
        ...
        titleYouTubeText( e ) {
          const t = o.a.youTubeID( e.attr( "href" ) )
          this.fetchYouTubeTitle( t, ( i, r ) => {
            if ( r ) {
              console.error( `failed to get video title from youtube for "${t}":`, r.responseText )
              const i = ( +e.attr( "data-ytt-failcnt" ) || 0 ) + 1
              e.attr( "data-ytt-failcnt", i )
            } else {
              e.text( i )
      ...
      function L( e ) {
        const t = e.closest( "img" ).attr( "src" )
        return "<img src='" + Object( y[ "a" ] )( t ) + "'/>"
      }
      ...
      function P( e, t ) {
        let i = e.replace( /(auto_open|inline_disabled)/g, "" )
      ...
      function N( e, t, i, r ) {
        const n = e.find( "#instructure_link_prompt_form" )
        n.off( "submit" )
      ...
      function D( e ) {
        ...
        if ( 0 == r.length ) {
          ...
          Object( S[ "b" ] )( "BookmarkService", ( function ( e ) {
            const t = r.data( "editor" )
            const i = o()( "<div style='text-align: left; margin-left: 20px;'/>" )
            let a, s
            for ( const r in e ) {
              a = e[ r ].user_service
              if ( a ) {
                s = o()( "<a href='#' class='bookmark_service no-hover'/>" )
                ...
                s.click( ( function ( e ) {
                  ...
                  Object( S[ "a" ] )( o()( this ).data( "service" ).service, e => {
                    o()( "#instructure_link_prompt" ).dialog( "close" )
                    Object( E[ "d" ] )( t, "create_link", {
                      title: e.title,
                      url: e.url,
                      classes: n
                    } )
            ...
            r.find( "#instructure_link_prompt_form" ).after( i )
          } ) )
          ...
          r.find( ".disable_inline_content" ).change( ( function () {
            o()( this ).attr( "checked" ) && r.find( ".auto_show_inline_content" ).attr( "checked", false )
            r.find( ".auto_show" ).showIf( !o()( this ).attr( "checked" ) && r.hasClass( "for_inline_content_can_auto_show" ) )
          } ) )
          r.find( ".actions" ).delegate( ".embed_image_link", "click", e => {
            const t = r.data( "editor" )
            const i = o()( e.target )
            e.preventDefault()
          ...
          r.find( ".actions" ).delegate( ".embed_youtube_link", "click", e => {
            e.preventDefault()
            r.find( "#instructure_link_prompt_form" ).triggerHandler( "submit" )
          } )
          r.find( "#instructure_link_prompt_form .prompt" ).bind( "change keyup", ( function () {
            const e = r.find( ".inst-link-preview-alt" )
            e.hide()
            o()( "#instructure_link_prompt .actions" ).empty()
            const t = o()( this ).val()
            const i = r.data( "original_data" )
            if ( i && t == i.url ) {
              r.toggleClass( "for_inline_content", i.for_inline_content ).toggleClass( "for_inline_content_can_auto_show", i.for_inline_content_can_auto_show ).find( ".disable_enhancement" ).showIf( i.for_inline_content ).end().find( ".auto_show" ).showIf( i.for_inline_content_can_auto_show )
              n = i.prior_classes
            } else {
              r.removeClass( "for_inline_content" ).removeClass( "for_inline_content_can_auto_show" )
              const e = new RegExp( "(" + F.join( "|" ) + ")", "g" )
              n = n.replace( e, "" )
            }
            let a = !r.hasClass( "for_inline_content" )
            const s = !r.hasClass( "for_inline_content_can_auto_show" )
            if ( t.match( /\.(gif|png|jpg|jpeg)$/ ) ) {
              ...
              e.src = t
              var d = function () {
                e.complete ? ( e.height < 100 || e.height > 100 && e.height < 200 ) && c.height( e.height ) : setTimeout( d, 500 )
              }
              setTimeout( d, 500 )
              c.height( 100 )
              c.attr( "title", "Click to Embed the Image" )
              l.append( c )
              o()( "#instructure_link_prompt .actions" ).append( l )
            } else if ( t.match( INST.youTubeRegEx ) ) {
              e.show()
              const i = o.a.youTubeID( t )
              l = o()( document.createElement( "div" ) )
              l.css( "textAlign", "center" ) !r.find( ".disable_inline_content" ).attr( "checked" ) && r.hasClass( "for_inline_content_can_auto_show" ) && r.find( ".auto_show" ).show()
              a = false
            ...
            if ( a ) {
              r.find( ".disable_enhancement" ).hide()
              r.find( ".disable_inline_content" ).attr( "checked", false )
            }
            if ( s ) {
              r.find( ".auto_show" ).hide()
        ...
        if ( c ) {
          r.find( ".prompt" ).val( c.attr( "href" ) ).change()
          r.find( ".inst-link-preview-alt input" ).val( c.data( "preview-alt" ) )
          n = ( c.attr( "class" ) || "" ).replace( /youtube_link_to_box/, "" )
          var d = new RegExp( "(" + F.join( "|" ) + ")" );
          ( c.attr( "class" ) || "" ).match( d ) && r.addClass( "for_inline_content" ).find( ".disable_enhancement" ).show()
          d = new RegExp( "(" + j.join( "|" ) + ")" );
          ( c.attr( "class" ) || "" ).match( d ) && r.addClass( "for_inline_content_can_auto_show" ).find( ".auto_show" ).show()
          r.data( "original_data", {
            url: c.attr( "href" ),
            for_inline_content: r.hasClass( "for_inline_content" ),
            for_inline_content_can_auto_show: r.hasClass( "for_inline_content_can_auto_show" ),
            prior_classes: n,
            preview_alt: c.data( "preview-alt" )
          } )
          ...
          r.find( ".insert_button" ).text( "Update Link" )
        } else r.find( ".prompt" ).val( "" ).change()
        r.dialog( {
          width: 425,
          height: "auto",
          title: "Link to Website URL",
          open() {
            o()( this ).find( ".prompt" ).focus().select()
          }
        } )
      }

      function O( e, t ) {
        O.counter = O.counter || 0
        true == t && 0 != O.counter ? O.counter = ( O.counter + 1 ) % 5 : o()( e.getBody() ).find( "a" ).each( ( function () {
          const e = new A
          const t = o()( this )
          if ( !ENV.use_rce_enhancements && t.attr( "href" ) && !t.hasClass( "inline_disabled" ) && t.attr( "href" ).match( INST.youTubeRegEx ) ) {
            const i = +t.attr( "data-ytt-failcnt" ) || 0
            t.addClass( "youtube_link_to_box" )
            t.text() === t.attr( "href" ) && i < 1 && e.titleYouTubeText( t )
          }
        } ) )
      }

      function I( e ) {
        if ( B.get( e ) || void 0 === e.on ) return
        e.on( "PreProcess", ( function ( e ) {
          o()( e.node ).find( "a.youtube_link_to_box" ).removeClass( "youtube_link_to_box" )
          o()( e.node ).find( "img.iframe_placeholder" ).each( ( function () {
            const e = o()( this )
            const t = o()( "<iframe/>" )
            ...
            if ( !t[ 0 ].style.height.length ) {
              t.attr( "height", i )
              t.css( "height", i )
            }
            if ( !t[ 0 ].style.width.length ) {
              t.attr( "width", r )
              t.css( "width", r )
            }
            o()( this ).after( t )
      ...
      const H = {
        get more_external_tools() {
          return Object( y[ "a" ] )( v.t( "more_external_tools", "More External Tools" ) )
        }
      }
      const G = {
        init( e, t, r ) {
          ...
          let n = {
            open: ( ...e ) => setTimeout( () => n.open( ...e ), 50 )
          }
          Promise.all( [ i.e( 1 ), i.e( 3 ), i.e( 4 ), i.e( 16 ), i.e( 17 ), i.e( 631 ) ] ).then( i.bind( null, "/wcz" ) ).then( ( {
            default: t
          } ) => {
            const i = document.createElement( "div" )
            document.body.appendChild( i )
            M.a.render( Object( m[ "a" ] )( t, {
              win: window,
              editor: e,
              contextAssetString: ENV.context_asset_string,
              iframeAllowances: Object( T[ "a" ] )(),
              resourceSelectionUrl: o()( "#context_external_tool_resource_selection_url" ).attr( "href" ),
          ...
          const a = []
          const s = []
          for ( let t = 0; r.editorButtons && t < r.editorButtons.length; t++ ) {
            const i = r.editorButtons[ t ]
            const o = () => n.open( i )
            if ( ENV.use_rce_enhancements ) {
              s.push( x.buttonConfig( i, e ) )
              e.addCommand( "instructureExternalButton" + i.id, o )
            } else if ( r.editorButtons.length > r.maxVisibleEditorButtons && t >= r.maxVisibleEditorButtons - 1 ) a.push( i )
            else {
              e.addCommand( "instructureExternalButton" + i.id, o )
              e.addButton( "instructure_external_button_" + i.id, x.buttonConfig( i, e ) )
            }
          }
          if ( s.length && ENV.use_rce_enhancements ) {
            K( e, s )
            J( e, s )
            Y( e, s )
            U( e, s )
          ...
          if ( a.length ) {
            const t = function () {
              const t = x.clumpedButtonMapping( a, e, e => n.open( e ) )
              x.attachClumpedDropdown( o()( "#" + this._id ), t, e )
            }
            ENV.use_rce_enhancements ? e.ui.registry.addButton( "instructure_external_button_clump", {
              title: H.more_external_tools,
              image: "/images/downtick.png",
              onAction: t
            } ) : e.addButton( "instructure_external_button_clump", {
              title: H.more_external_tools,
              image: "/images/downtick.png",
              onkeyup( e ) {
      ...
      function W( e, t ) {
        if ( !t.iconSVG && t.image ) {
          ...
          t.icon = "lti_tool_" + t.id
        }
        t.iconSVG && e.ui.registry.addIcon( t.icon, t.iconSVG )
      }

      function U( e, t ) {
        t.length && e.ui.registry.addNestedMenuItem( "lti_tools_menuitem", {
          text: v.t( "Apps" ),
          icon: "lti",
          getSubmenuItems: () => Z( e, t )
        } )
      }

      function K( e, t ) {
        const i = v.t( "Apps" )
        e.ui.registry.addButton( "lti_tool_dropdown", {
          onAction: () => {
            const e = new CustomEvent( "tinyRCE/onExternalTools", {
              detail: {
                ltiButtons: t
              }
            } )
      ...
      function J( e, t ) {
        t.forEach( t => {
          ...
          W( e, t )
          e.ui.registry.addButton( "instructure_external_button_" + t.id, {
            onAction: t.onAction,
            tooltip: t.title,
            icon: t.icon,
            title: t.title
      ...
      function Y( e, t ) {
        const i = v.t( "Apps" )
        e.ui.registry.addMenuButton( "lti_mru_button", {
          tooltip: i,
          icon: "lti",
          fetch( i ) {
            i( Z( e, t ) )
      ...
      function Z( e, t ) {
        const i = []
        try {
          const r = JSON.parse( window.localStorage.getItem( "ltimru" ) )
          if ( r && Array.isArray( r ) && r.length ) {
            const n = t.filter( e => r.includes( e.id ) )
            n.forEach( t => {
              W( e, t )
            ...
            i.sort( ( e, t ) => e.text.localeCompare( t.text ) )
          }
        } catch ( e ) {
          console.log( "Failed building mru menu", e.message )
        } finally {
          i.push( {
            type: "menuitem",
            text: v.t( "View All" ),
      ...
      function X( e = {} ) {
        ...
        t.forEach( t => {
          void 0 === e[ t ] && ( e[ t ] = function () {} )
        } )
        document.addEventListener( "tinyRCE/initEquation", ( {
          detail: t
        } ) => {
          Promise.all( [ i.e( 6 ), i.e( 675 ) ] ).then( i.bind( null, "F+Bh" ) ).then( ( {
            default: i
          } ) => {
            const r = new i( t.ed )
            e.equationCB( r )
        ...
        document.addEventListener( "tinyRCE/initLinks", ( {
          detail: t
        } ) => {
          V.renderDialog( t.ed )
          e.linksCB()
        } )
        document.addEventListener( "tinyRCE/initImagePicker", t => {
          Promise.all( [ i.e( 1 ), i.e( 5 ), i.e( 6 ), i.e( 8 ), i.e( 9 ), i.e( 82 ), i.e( 93 ), i.e( 86 ), i.e( 637 ) ] ).then( i.bind( null, "Dwgn" ) ).then( ( {
            default: i
          } ) => {
            const r = new i( t.detail.ed, t.detail.selectedNode )
            e.imagePickerCB( r )
          } )
        } )
        document.addEventListener( "tinyRCE/initEquella", t => {
          i.e( 751 ).then( i.bind( null, "gg/z" ) ).then( ( {
            default: i
          } ) => {
            i( t.detail.ed )
            e.equellaCB()
        ...
        document.addEventListener( "tinyRCE/initExternalTools", t => {
          Q.init( t.detail.ed, t.detail.url, g[ "a" ] )
          e.externalToolCB()
        } )
        document.addEventListener( "tinyRCE/initRecord", t => {
          Promise.all( [ i.e( 42 ), i.e( 752 ) ] ).then( i.bind( null, "xR7n" ) ).then( ( {
            default: i
          } ) => {
      ...
      const ie = {
        wrapEditor( e ) {
          const t = Object( r[ "a" ] )( Object( r[ "a" ] )( {}, ee ), e )
          return Object.assign( e, t )
        },
        wrapSidebar( e ) {
          const t = Object( r[ "a" ] )( Object( r[ "a" ] )( {}, te ), e )
          return Object.assign( e, t )
        }
      }
      var re = ie
      ...
      function oe() {
        ...
        let e = Object( ne[ "a" ] )( ENV.context_asset_string, false ),
          t = Object( n[ "a" ] )( e, 2 ),
          i = t[ 0 ],
          r = t[ 1 ]
      ...
      const le = {
        ...
        loadOnTarget( e, t, i ) {
          ...
          this.loadRCE( e => {
            e.renderIntoDiv( n, a, e => {
              e.mceInstance().on( "init", () => i( r, re.wrapEditor( e ) ) )
            } )
          } )
        },
        loadSidebarOnTarget( e, t ) {
          if ( ENV.RICH_CONTENT_SKIP_SIDEBAR ) return
          const i = oe()
          this.loadRCE( r => {
            r.renderSidebarIntoDiv( e, i, e => {
              t( re.wrapSidebar( e ) )
            } )
          } )
        },
        ...
        RCE: null,
        loadRCE( e = ( () => {} ) ) {
          se || ( se = ( window.ENV.use_rce_enhancements ? Promise.all( [ i.e( 1 ), i.e( 3 ), i.e( 4 ), i.e( 5 ), i.e( 7 ), i.e( 9 ), i.e( 11 ), i.e( 12 ), i.e( 14 ), i.e( 19 ), i.e( 21 ), i.e( 26 ), i.e( 31 ), i.e( 34 ), i.e( 40 ), i.e( 51 ), i.e( 54 ), i.e( 97 ), i.e( 84 ), i.e( 104 ), i.e( 126 ), i.e( 132 ), i.e( 315 ) ] ).then( i.bind( null, "Idzl" ) ) : Promise.all( [ i.e( 1 ), i.e( 3 ), i.e( 4 ), i.e( 7 ), i.e( 12 ), i.e( 14 ), i.e( 19 ), i.e( 21 ), i.e( 26 ), i.e( 25 ), i.e( 40 ), i.e( 51 ), i.e( 54 ), i.e( 84 ), i.e( 104 ), i.e( 126 ), i.e( 316 ) ] ).then( i.bind( null, "66gZ" ) ) ).then( e => {
            this.RCE = e
            X()
            return e
          } ) )
        ...
        _attrsToMirror( e ) {
          const t = [ "name" ]
          const i = l.a.reduce( e.attributes, ( e, t ) => {
            e[ t.name ] = t.value
            return e
          }, {} )
          return l.a.pick( i, t )
        ...
        createRCEProps( e, t ) {
          ...
          o && ( t.tinyOptions = Object( r[ "a" ] )( {
            height: o
          }, t.tinyOptions || {} ) )
          const s = ENV.LOCALE
          const l = Object.keys( ae[ "a" ] ).map( e => ( {
            id: e,
            label: ae[ "a" ][ e ]
          } ) ).sort( ( e, t ) => e.id === s ? -1 : t.id === s ? 1 : e.label.localeCompare( t.label, s ) )
          const c = {
            enabled: ENV.use_rce_enhancements && ENV.rce_auto_save,
            rce_auto_save_max_age_ms: Number.isNaN( ENV.rce_auto_save_max_age_ms ) ? 36e5 : ENV.rce_auto_save_max_age_ms
          }
          return {
            defaultContent: e.value || t.defaultContent,
            editorOptions: p.bind( null, a, e.id, t, null ),
            language: ENV.LOCALE,
            ...
            use_rce_pretty_html_editor: !!( null !== ( i = window.ENV ) && void 0 !== i && null !== ( n = i.FEATURES ) && void 0 !== n && n.rce_pretty_html_editor )
          }
        }
      }
      t[ "a" ] = le
...
//# sourceMappingURL=20-c-95eefedc23.js.map
