  ...
  function k() {
    if ( this == e ) {
      ...
      if ( n.test( a ) ) {
        ...
        b.value = a = c
      } else b.value = "ERROR: invalid input", e.className = b.className = "invalid", a = ""
    } else e.className = b.className = "", a = b.value, c = btoa( unescape( encodeURIComponent( a ) ) ), e.value = c;
    p.hash = h( a );
    g && ( g.base64 = a )
  }
