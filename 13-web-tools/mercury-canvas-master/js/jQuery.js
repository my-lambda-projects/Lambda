/* eslint-disable */
/*! jQuery v2.1.1 -ajax,-ajax/jsonp,-ajax/load,-ajax/parseJSON,-ajax/parseXML,-ajax/script,-ajax/var/nonce,-ajax/var/rquery,-ajax/xhr,-manipulation/_evalUrl,-deprecated,-effects,-effects/Tween,-effects/animatedSelector,-css/hiddenVisibleSelectors | (c) 2005, 2014 jQuery Foundation, Inc. | jquery.org/license */
! function ( a, b ) {
  ...
  var c = [],
    ...
    k = {},
    l = a.document,
    m = "2.1.1 -ajax,-ajax/jsonp,-ajax/load,-ajax/parseJSON,-ajax/parseXML,-ajax/script,-ajax/var/nonce,-ajax/var/rquery,-ajax/xhr,-manipulation/_evalUrl,-deprecated,-effects,-effects/Tween,-effects/animatedSelector,-css/hiddenVisibleSelectors",
    n = function ( a, b ) {
  ...
  var Nb, Ob, Pb = n.expr.attrHandle;
  n.fn.extend( {
    attr: function ( a, b ) {
    ...
    attr: function ( a, b, c ) {
      ...
      if ( a && 3 !== f && 8 !== f && 2 !== f ) return typeof a.getAttribute === X ? n.prop( a, b, c ) : ( 1 === f && n.isXMLDoc( a ) || ( b = b.toLowerCase(), d = n.attrHooks[ b ] || ( n.expr.match.bool.test( b ) ? Ob : Nb ) ), void 0 === c ? d && "get" in d && null !== ( e = d.get( a, b ) ) ? e : ( e = n.find.attr( a, b ), null == e ? void 0 : e ) : null !== c ? d && "set" in d && void 0 !== ( e = d.set( a, c, b ) ) ? e : ( a.setAttribute( b, c + "" ), c ) : void n.removeAttr( a, b ) )
    },
  ...
  function Yb( a, b, c, d ) {
    ...
    if ( n.isArray( b ) ) n.each( b, function ( b, e ) {
      c || Ub.test( a ) ? d( a, e ) : Yb( a + "[" + ( "object" == typeof e ? b : "" ) + "]", e, c, d )
    } );
  ...
  n.param = function ( a, b ) {
    ...
    serializeArray: function () {
      return this.map( function () {
        ...
        var a = this.type;
        return this.name && !n( this ).is( ":disabled" ) && Xb.test( this.nodeName ) && !Wb.test( a ) && ( this.checked || !W.test( a ) )
      } ).map( function ( a, b ) {
        var c = n( this ).val();
  ...
  n.offset = {
    ...
    offset: function ( a ) {
      ...
      var b, c, d = this[ 0 ],
        ...
        f = d && d.ownerDocument;
      if ( f ) return b = f.documentElement, n.contains( b, d ) ? ( typeof d.getBoundingClientRect !== X && ( e = d.getBoundingClientRect() ), c = Zb( f ), {
  ...
  return n.noConflict = function ( b ) {
    return a.$ === n && ( a.$ = _b ), b && a.jQuery === n && ( a.jQuery = $b ), n
