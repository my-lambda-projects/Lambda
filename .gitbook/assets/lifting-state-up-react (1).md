...
## [](https://reactjs.org/docs/lifting-state-up.html#adding-a-second-input)Adding a Second Input
...
## [](https://reactjs.org/docs/lifting-state-up.html#writing-conversion-functions)Writing Conversion Functions
...
## [](https://reactjs.org/docs/lifting-state-up.html#lifting-state-up)Lifting State Up
...
## [](https://reactjs.org/docs/lifting-state-up.html#lessons-learned)Lessons Learned
