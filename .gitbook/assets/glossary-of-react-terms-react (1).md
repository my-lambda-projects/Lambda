## [](https://reactjs.org/docs/glossary.html#single-page-application)Single-page Application
...
## [](https://reactjs.org/docs/glossary.html#es6-es2015-es2016-etc)ES6, ES2015, ES2016, etc
...
## [](https://reactjs.org/docs/glossary.html#compilers)Compilers
...
## [](https://reactjs.org/docs/glossary.html#bundlers)Bundlers
...
## [](https://reactjs.org/docs/glossary.html#package-managers)Package Managers
...
## [](https://reactjs.org/docs/glossary.html#cdn)CDN

CDN stands for Content Delivery Network. CDNs deliver cached, static content from a network of servers across the globe.

## [](https://reactjs.org/docs/glossary.html#jsx)JSX
...
## [](https://reactjs.org/docs/glossary.html#elements)[Elements](https://reactjs.org/docs/rendering-elements.html)
...
## [](https://reactjs.org/docs/glossary.html#components)[Components](https://reactjs.org/docs/components-and-props.html)
...
### [](https://reactjs.org/docs/glossary.html#props)[`props`](https://reactjs.org/docs/components-and-props.html)
...
### [](https://reactjs.org/docs/glossary.html#propschildren)`props.children`
...
### [](https://reactjs.org/docs/glossary.html#state)[`state`](https://reactjs.org/docs/state-and-lifecycle.html#adding-local-state-to-a-class)
...
## [](https://reactjs.org/docs/glossary.html#lifecycle-methods)[Lifecycle Methods](https://reactjs.org/docs/state-and-lifecycle.html#adding-lifecycle-methods-to-a-class)
...
## [](https://reactjs.org/docs/glossary.html#controlled-vs-uncontrolled-components)[Controlled](https://reactjs.org/docs/forms.html#controlled-components) vs. [Uncontrolled Components](https://reactjs.org/docs/uncontrolled-components.html)
...
## [](https://reactjs.org/docs/glossary.html#keys)[Keys](https://reactjs.org/docs/lists-and-keys.html)
...
## [](https://reactjs.org/docs/glossary.html#refs)[Refs](https://reactjs.org/docs/refs-and-the-dom.html)
...
## [](https://reactjs.org/docs/glossary.html#events)[Events](https://reactjs.org/docs/handling-events.html)
