/***********************************************************************
Write a
recursive function called `fa
torial` that takes an integer, `num`,
and returns th factorial of `n
m`. Assume the value of `num` is
greater 
than or equal to 1.
...
A factorial is the number get when multiplying a number by itself minus one
  ...
  point, also s om et i mes called a "bang" in programming.
