...
#### **DESCRIPTION**
       ...
       **install**
           ...
           Fallback to regular expressions is deprecated in APT 2.0, has been removed in **[apt](chrome-extension://cjedbglnccaioiolemnfhjncicchinao/man8/apt.8.html)**(8),
...
#### **FILES**
       ...
       [/etc/apt/preferences.d/](file://etc/apt/preferences.d/)
