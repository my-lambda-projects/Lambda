...
* [:octocat: wooey](https://github.com/wooey/wooey) - :star: 1501 :fork_and_knife: 169 - A Django app which creates automatic web UIs for Python scripts.
...
* Audio
    ...
    * [:octocat: pydub](https://github.com/jiaaro/pydub) - :star: 4952 :fork_and_knife: 683 - Manipulate audio with a simple and easy high level interface.
...
* CLI Enhancements
    ...
    * [:octocat: litecli](https://github.com/dbcli/litecli) - :star: 1256 :fork_and_knife: 40 - SQLite CLI with autocompletion and syntax highlighting.
...
* NoSQL Databases
    * [:octocat: cassandra-driver](https://github.com/datastax/python-driver) - :star: 1196 :fork_and_knife: 447 - The Python Driver for Apache Cassandra.
...
* Tracing
    ...
    * [:octocat: python-hunter](https://github.com/ionelmc/python-hunter) - :star: 572 :fork_and_knife: 26 - A flexible code tracing toolkit.
* Profiler
...
* SSH-style Deployment
    * [:octocat: cuisine](https://github.com/sebastien/cuisine) - :star: 1239 :fork_and_knife: 162 - Chef-like functionality for Fabric.
...
* Office
    ...
    * [:octocat: unoconv](https://github.com/unoconv/unoconv) - :star: 2014 :fork_and_knife: 385 - Convert between any document format supported by LibreOffice/OpenOffice.
...
* [:octocat: daramatiq](https://github.com/Bogdanp/dramatiq) - :star: 2320 :fork_and_knife: 163 - A fast and reliable background task processing library for Python 3.
* [:octocat: huey](https://github.com/coleifer/huey) - :star: 3270 :fork_and_knife: 294 - Little multi-threaded task queue.
* [:octocat: mrq](https://github.com/pricingassistant/mrq) - :star: 825 :fork_and_knife: 112 - A distributed worker task queue in Python using Redis & gevent.
* [:octocat: rq](https://github.com/rq/rq) - :star: 7400 :fork_and_knife: 1181 - Simple job queues for Python.
...
* [:octocat: Jinja2](https://github.com/pallets/jinja) - :star: 7404 :fork_and_knife: 1354 - A modern and designer friendly templating language.
...
* Testing Frameworks
    * [:octocat: hypothesis](https://github.com/HypothesisWorks/hypothesis) - :star: 4822 :fork_and_knife: 443 - Hypothesis is an advanced Quickcheck style property based testing library.
    * [:octocat: nose2](https://github.com/nose-devs/nose2) - :star: 655 :fork_and_knife: 132 - The successor to `nose`, based on `unittest2.
    * [:earth_americas: pytest](https://docs.pytest.org/en/latest/) - A mature full-featured Python testing tool.
    * [:octocat: Robot Framework](https://github.com/robotframework/robotframework) - :star: 5310 :fork_and_knife: 1550 - A generic test automation framework.
    * [:earth_americas: unittest](https://docs.python.org/3/library/unittest.html) - (Python standard library) Unit testing framework.
* Test Runners
    * [:octocat: green](https://github.com/CleanCut/green) - :star: 675 :fork_and_knife: 73 - A clean, colorful test runner.
...
* GUI / Web Testing
    * [:octocat: locust](https://github.com/locustio/locust) - :star: 14497 :fork_and_knife: 1982 - Scalable user load testing tool written in Python.
    * [:octocat: PyAutoGUI](https://github.com/asweigart/pyautogui) - :star: 4526 :fork_and_knife: 636 - PyAutoGUI is a cross-platform GUI automation Python module for human beings.
    * [:octocat: Schemathesis](https://github.com/kiwicom/schemathesis) - :star: 671 :fork_and_knife: 50 - A tool for automatic property-based testing of web applications built with Open API / Swagger specifications.
    ...
    * [:octocat: splinter](https://github.com/cobrateam/splinter) - :star: 2322 :fork_and_knife: 481 - Open source tool for testing web applications.
* Mock
    * [:earth_americas: doublex](https://pypi.org/project/doublex/) - Powerful test doubles framework for Python.
    * [:octocat: freezegun](https://github.com/spulec/freezegun) - :star: 2671 :fork_and_knife: 191 - Travel through time by mocking the datetime module.
    * [:octocat: httmock](https://github.com/patrys/httmock) - :star: 415 :fork_and_knife: 52 - A mocking library for requests for Python 2.6+ and 3.2+.
    * [:octocat: httpretty](https://github.com/gabrielfalcao/HTTPretty) - :star: 1830 :fork_and_knife: 247 - HTTP request mock tool for Python.
    ...
    * [:octocat: responses](https://github.com/getsentry/responses) - :star: 3006 :fork_and_knife: 250 - A utility library for mocking out the requests Python library.
    * [:octocat: VCR.py](https://github.com/kevin1024/vcrpy) - :star: 1826 :fork_and_knife: 261 - Record and replay HTTP interactions on your tests.
* Object Factories
    * [:octocat: factory_boy](https://github.com/FactoryBoy/factory_boy) - :star: 2333 :fork_and_knife: 307 - A test fixtures replacement for Python.
    * [:octocat: mixer](https://github.com/klen/mixer) - :star: 714 :fork_and_knife: 80 - Another fixtures replacement. Supported Django, Flask, SQLAlchemy, Peewee and etc.
    * [:octocat: model_mommy](https://github.com/vandersonmota/model_mommy) - :star: 933 :fork_and_knife: 157 - Creating random fixtures for testing in Django.
* Code Coverage
    * [:earth_americas: coverage](https://pypi.org/project/coverage/) - Code coverage measurement.
* Fake Data
    * [:octocat: fake2db](https://github.com/emirozer/fake2db) - :star: 2039 :fork_and_knife: 115 - Fake database generator.
    * [:octocat: faker](https://github.com/joke2k/faker) - :star: 11685 :fork_and_knife: 1321 - A Python package that generates fake data.
    * [:octocat: mimesis](https://github.com/lk-geimfari/mimesis) - :star: 3162 :fork_and_knife: 269 - is a Python library that help you generate fake data.
...
* General
    * [:octocat: chardet](https://github.com/chardet/chardet) - :star: 1400 :fork_and_knife: 193 - Python 2/3 compatible character encoding detector.
    * [:earth_americas: difflib](https://docs.python.org/3/library/difflib.html) - (Python standard library) Helpers for computing deltas.
    * [:octocat: ftfy](https://github.com/LuminosoInsight/python-ftfy) - :star: 2856 :fork_and_knife: 100 - Makes Unicode text less broken and more consistent automagically.
    * [:octocat: fuzzywuzzy](https://github.com/seatgeek/fuzzywuzzy) - :star: 7648 :fork_and_knife: 797 - Fuzzy String Matching.
    * [:octocat: Levenshtein](https://github.com/ztane/python-Levenshtein/) - :star: 900 :fork_and_knife: 122 - Fast computation of Levenshtein distance and string similarity.
    * [:octocat: pangu.py](https://github.com/vinta/pangu.py) - :star: 158 :fork_and_knife: 22 - Paranoid text spacing.
    * [:octocat: pyfiglet](https://github.com/pwaller/pyfiglet) - :star: 730 :fork_and_knife: 81 - An implementation of figlet written in Python.
    * [:octocat: pypinyin](https://github.com/mozillazg/python-pinyin) - :star: 2990 :fork_and_knife: 477 - Convert Chinese hanzi (漢字) to pinyin (拼音).
    * [:octocat: textdistance](https://github.com/orsinium/textdistance) - :star: 1832 :fork_and_knife: 158 - Compute distance between sequences with 30+ algorithms.
    * [:earth_americas: unidecode](https://pypi.org/project/Unidecode/) - ASCII transliterations of Unicode text.
* Slugify
    * [:octocat: awesome-slugify](https://github.com/dimka665/awesome-slugify) - :star: 452 :fork_and_knife: 39 - A Python slugify library that can preserve unicode.
    * [:octocat: python-slugify](https://github.com/un33k/python-slugify) - :star: 942 :fork_and_knife: 80 - A Python slugify library that translates unicode to ASCII.
...
* Unique identifiers
    * [:octocat: hashids](https://github.com/davidaurelio/hashids-python) - :star: 1158 :fork_and_knife: 85 - Implementation of [hashids](http://hashids.org) in Python.
    * [:octocat: shortuuid](https://github.com/skorokithakis/shortuuid) - :star: 1371 :fork_and_knife: 86 - A generator library for concise, unambiguous and URL-safe UUIDs.
* Parser
    * [:octocat: ply](https://github.com/dabeaz/ply) - :star: 1799 :fork_and_knife: 312 - Implementation of lex and yacc parsing tools for Python.
    * [:earth_americas: pygments](http://pygments.org/) - A generic syntax highlighter.
    * [:octocat: pyparsing](https://github.com/pyparsing/pyparsing) - :star: 944 :fork_and_knife: 147 - A general purpose framework for generating parsers.
    * [:octocat: python-nameparser](https://github.com/derek73/python-nameparser) - :star: 440 :fork_and_knife: 78 - Parsing human names into their individual components.
    * [:octocat: python-phonenumbers](https://github.com/daviddrysdale/python-phonenumbers) - :star: 2585 :fork_and_knife: 323 - Parsing, formatting, storing and validating international phone numbers.
    * [:octocat: python-user-agents](https://github.com/selwin/python-user-agents) - :star: 1095 :fork_and_knife: 179 - Browser user agent parser.
    * [:octocat: sqlparse](https://github.com/andialbrecht/sqlparse) - :star: 2265 :fork_and_knife: 472 - A non-validating SQL parser.
...
* [:octocat: boto3](https://github.com/boto/boto3) - :star: 5971 :fork_and_knife: 1288 - Python interface to Amazon Web Services.
* [:octocat: django-wordpress](https://github.com/istrategylabs/django-wordpress) - :star: 314 :fork_and_knife: 85 - WordPress models and views for Django.
* [:octocat: facebook-sdk](https://github.com/mobolic/facebook-sdk) - :star: 2561 :fork_and_knife: 943 - Facebook Platform Python SDK.
* [:octocat: google-api-python-client](https://github.com/google/google-api-python-client) - :star: 4279 :fork_and_knife: 1782 - Google APIs Client Library for Python.
* [:octocat: gspread](https://github.com/burnash/gspread) - :star: 5061 :fork_and_knife: 772 - Google Spreadsheets Python API.
* [:octocat: twython](https://github.com/ryanmcgrath/twython) - :star: 1754 :fork_and_knife: 395 - A Python wrapper for the Twitter API.

## URL Manipulation

*Libraries for parsing URLs.*

* [:octocat: furl](https://github.com/gruns/furl) - :star: 1899 :fork_and_knife: 119 - A small Python library that makes parsing and manipulating URLs easy.
...
* [:octocat: pyshorteners](https://github.com/ellisonleao/pyshorteners) - :star: 278 :fork_and_knife: 51 - A pure Python URL shortening lib.
* [:octocat: webargs](https://github.com/marshmallow-code/webargs) - :star: 1098 :fork_and_knife: 139 - A friendly library for parsing HTTP request arguments with built-in support for popular web frameworks.
...
* [:octocat: vidgear](https://github.com/abhiTronix/vidgear) - :star: 1488 :fork_and_knife: 107 - Most Powerful multi-threaded Video Processing framework.

## Web Asset Management

*Tools for managing, compressing and minifying website assets.*

* [:octocat: django-compressor](https://github.com/django-compressor/django-compressor) - :star: 2394 :fork_and_knife: 560 - Compresses linked and inline JavaScript or CSS into a single cached file.
* [:octocat: django-pipeline](https://github.com/jazzband/django-pipeline) - :star: 1376 :fork_and_knife: 350 - An asset packaging library for Django.
* [:octocat: django-storages](https://github.com/jschneier/django-storages) - :star: 1749 :fork_and_knife: 669 - A collection of custom storage back ends for Django.
...
* [:octocat: webassets](https://github.com/miracle2k/webassets) - :star: 888 :fork_and_knife: 256 - Bundles, optimizes, and manages unique cache-busting URLs for static resources.

## Web Content Extracting

*Libraries for extracting web contents.*

* [:octocat: html2text](https://github.com/Alir3z4/html2text) - :star: 1023 :fork_and_knife: 179 - Convert HTML to Markdown-formatted text.
* [:octocat: lassie](https://github.com/michaelhelmick/lassie) - :star: 515 :fork_and_knife: 41 - Web Content Retrieval for Humans.
...
* [:octocat: newspaper](https://github.com/codelucas/newspaper) - :star: 10470 :fork_and_knife: 1728 - News extraction, article extraction and content curation in Python.
* [:octocat: python-readability](https://github.com/buriy/python-readability) - :star: 1891 :fork_and_knife: 319 - Fast Python port of arc90's readability tool.
* [:octocat: requests-html](https://github.com/psf/requests-html) - :star: 11311 :fork_and_knife: 763 - Pythonic HTML Parsing for Humans.
* [:octocat: sumy](https://github.com/miso-belica/sumy) - :star: 2438 :fork_and_knife: 438 - A module for automatic summarization of text documents and HTML pages.
* [:octocat: textract](https://github.com/deanmalmgren/textract) - :star: 2906 :fork_and_knife: 413 - Extract text from any document, Word, PowerPoint, PDFs, etc.
* [:octocat: toapi](https://github.com/gaojiuli/toapi) - :star: 3069 :fork_and_knife: 219 - Every web site provides APIs.

## Web Crawling

*Libraries to automate web scraping.*

* [:octocat: cola](https://github.com/chineking/cola) - :star: 1384 :fork_and_knife: 542 - A distributed crawling framework.
* [:earth_americas: feedparser](https://pythonhosted.org/feedparser/) - Universal feed parser.
* [:octocat: grab](https://github.com/lorien/grab) - :star: 2006 :fork_and_knife: 252 - Site scraping framework.
* [:octocat: MechanicalSoup](https://github.com/MechanicalSoup/MechanicalSoup) - :star: 3614 :fork_and_knife: 333 - A Python library for automating interaction with websites.
* [:octocat: portia](https://github.com/scrapinghub/portia) - :star: 7982 :fork_and_knife: 1294 - Visual scraping for Scrapy.
* [:octocat: pyspider](https://github.com/binux/pyspider) - :star: 14741 :fork_and_knife: 3551 - A powerful spider system.
* [:octocat: robobrowser](https://github.com/jmcarp/robobrowser) - :star: 3501 :fork_and_knife: 328 - A simple, Pythonic library for browsing the web without a standalone web browser.
...
* Synchronous
    * [:earth_americas: Django](https://www.djangoproject.com/) - The most popular web framework in Python.
        * [:octocat: awesome-django](https://github.com/shahraizali/awesome-django) - :star: 512 :fork_and_knife: 103
        * [:octocat: awesome-django](https://github.com/wsvincent/awesome-django) - :star: 3238 :fork_and_knife: 580
    * [:earth_americas: Flask](http://flask.pocoo.org/) - A microframework for Python.
        * [:octocat: awesome-flask](https://github.com/humiaozuzu/awesome-flask) - :star: 9405 :fork_and_knife: 1388
    * [:earth_americas: Pyramid](https://pylonsproject.org/) - A small, fast, down-to-earth, open source Python web framework.
        * [:octocat: awesome-pyramid](https://github.com/uralbash/awesome-pyramid) - :star: 494 :fork_and_knife: 54
    * [:octocat: Masonite](https://github.com/MasoniteFramework/masonite) - :star: 1503 :fork_and_knife: 94 - The modern and developer centric Python web framework.
* Asynchronous
...
* [:octocat: autobahn-python](https://github.com/crossbario/autobahn-python) - :star: 2229 :fork_and_knife: 625 - WebSocket & WAMP for Python on Twisted and [asyncio](https://docs.python.org/3/library/asyncio.html).
* [:octocat: channels](https://github.com/django/channels) - :star: 4667 :fork_and_knife: 647 - Developer-friendly asynchrony for Django.
* [:octocat: websockets](https://github.com/aaugustin/websockets) - :star: 3060 :fork_and_knife: 347 - A library for building WebSocket servers and clients with a focus on correctness and simplicity.

## WSGI Servers

*WSGI-compatible web servers.*

* [:octocat: bjoern](https://github.com/jonashaag/bjoern) - :star: 2472 :fork_and_knife: 180 - Asynchronous, very fast and written in C.
* [:octocat: gunicorn](https://github.com/benoitc/gunicorn) - :star: 7312 :fork_and_knife: 1371 - Pre-forked, partly written in C.
...
* [:octocat: waitress](https://github.com/Pylons/waitress) - :star: 874 :fork_and_knife: 120 - Multi-threaded, powers Pyramid.
* [:octocat: werkzeug](https://github.com/pallets/werkzeug) - :star: 5537 :fork_and_knife: 1500 - A WSGI utility library for Python that powers Flask and can easily be embedded into your own projects.
...
* Tutorials
    ...
    * [:octocat: Ultimate Python study guide](https://github.com/huangsam/ultimate-python) - :star: 2509 :fork_and_knife: 228
* Libraries
...
* Others
    ...
    * [:octocat: What the f*ck Python!](https://github.com/satwikkansal/wtfpython) - :star: 22748 :fork_and_knife: 2039
