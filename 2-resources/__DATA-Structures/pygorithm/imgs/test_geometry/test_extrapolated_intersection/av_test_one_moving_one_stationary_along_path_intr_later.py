...
def setup_fig01():
    fig, ax, renderer = create_newfig(
        "{}01".format(func_code), xlim=(-10, 15), ylim=(-1, 18)
    )
    create_moving_polygon(
        fig,
        ax,
        renderer,
        ((-5, 9), (-8, 7), (-9, 7), (-8, 11), (-8, 11), (-5, 10)),
        (15, 2),
    )
    create_still_polygon(
        fig,
        ax,
        renderer,
        ((4, 15.5, "right"), (5, 12.5, "botleft"), (0, 11.5), (1, 16.5, "top")),
        "left",
    )
...
def setup_fig02():
    fig, ax, renderer = create_newfig(
        "{}02".format(func_code), xlim=(-2, 21), ylim=(-7, 11)
    )
    create_moving_polygon(
        fig,
        ax,
        renderer,
        ((4.5, -0.5), (3.5, -2.5), (1.5, -3.5), (-0.5, 0.5), (-0.5, 1.5), (1.5, 2.5)),
        (13, 3),
    )
...
def setup_fig03():
    fig, ax, renderer = create_newfig(
        "{}03".format(func_code), xlim=(-3, 25), ylim=(-1, 21)
    )
    create_moving_polygon(
        fig,
        ax,
    ...
    create_still_polygon(
        fig, ax, renderer, ((14.5, 13), (14.5, 9), (12.5, 9), (11.5, 12), (12.5, 13))
    )
...
def setup_fig04():
    fig, ax, renderer = create_newfig(
        "{}04".format(func_code), xlim=(-10, 8), ylim=(-12, 6)
    )
    create_moving_polygon(
        fig,
        ax,
