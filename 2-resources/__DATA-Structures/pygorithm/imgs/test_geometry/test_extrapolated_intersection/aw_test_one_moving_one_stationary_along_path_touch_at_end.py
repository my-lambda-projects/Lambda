...
def setup_fig01():
    fig, ax, renderer = create_newfig(
        "{}01".format(func_code), xlim=(-5, 10), ylim=(-2, 5)
    )
    create_moving_polygon(
        fig, ax, renderer, ((-2, 0.5), (-3, -0.5), (-4, 0.5), (-3, 1.5)), (7, 1)
    )
    create_still_polygon(
        fig, ax, renderer, ((9, 0), (8, 0), (5, 1), (5, 3), (7, 4), (9, 4))
    )
...
def setup_fig02():
    fig, ax, renderer = create_newfig(
        "{}02".format(func_code), xlim=(-1, 20), ylim=(-7, 10)
    )
    create_moving_polygon(
        fig,
        ax,
...
def setup_fig03():
    fig, ax, renderer = create_newfig(
        "{}03".format(func_code), xlim=(-4, 7), ylim=(-1, 10)
    )
    create_moving_polygon(
        fig, ax, renderer, ((3, 0.5), (2, 1.5), (2, 2.5), (4, 2.5)), (-0.5, 5)
    )
    create_still_polygon(
        fig,
        ax,
...
def setup_fig04():
    fig, ax, renderer = create_newfig(
        "{}04".format(func_code), xlim=(-1, 19), ylim=(-10, 6)
    )
    create_moving_polygon(
        fig,
        ax,
