...
print(
    getProductsOfAllIntsExceptAtIndex([1, 2, 3, 4, 5])
)  # should print [120, 60, 40, 30, 24]
print(getProductsOfAllIntsExceptAtIndex([9, 90]))  # should print [90, 9]
print(
    getProductsOfAllIntsExceptAtIndex([50])
)  # should print 'Getting the product of numbers at other indices requires at least 2 numbers'
