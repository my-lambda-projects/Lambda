...
(Two numbers are coprime if thei##-------------------------------------------------------------------
"""
...
Primitive roots of certain number may or m##-------------------------------------------------------------------
"""
...
def alice_shared_key(b_pu_k, a_##-------------------------------------------------------------------
"""
...
def bob_shared_key(a_pu_k, b_pr_k, p):
    """ Bob calculate secret key shared##-------------------------------------------------------------------
"""
