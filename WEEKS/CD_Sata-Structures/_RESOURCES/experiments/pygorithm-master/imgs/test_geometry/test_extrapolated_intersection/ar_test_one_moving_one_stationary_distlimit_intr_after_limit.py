...
def setup_fig01():
    ...
    create_still_polygon(
        ...
        ax,
        renderer,
        ((5.5, 5.5, "topleft"), (6.5, 5.5), (6.5, 4.5), (5.5, 4.5)),
        "none",
    )
...
def setup_fig02():
    fig, ax, renderer = create_newfig(
        "{}02".format(func_code), xlim=(-1, 8), ylim=(-1, 7)
    )

    create_moving_polygon(
        fig, ax, renderer, ((4, 4), (5, 6), (4, 3)), (1.2, -0.9), "topright"
    )
...
def setup_fig03():
    ...
    create_moving_polygon(
        fig, ax, renderer, ((6, 3), (6, 2), (5, 1), (4, 3)), (-2.5, 0), "topright"
    )
    create_still_polygon(
        fig, ax, renderer, ((0, 3, "none"), (1, 3), (2, 1), (0, 1, "none"))
    )
...
def setup_fig04():
    ...
    create_moving_polygon(
        fig, ax, renderer, ((5, 0, "none"), (6, 1), (2, 1)), (0, 1.75), "topright"
    )
    create_still_polygon(
        fig, ax, renderer, ((3, 4, "top"), (4, 4), (4, 3), (3, 3)), "none"
    )
