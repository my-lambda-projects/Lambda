...
def setup_fig01():
    fig, ax, renderer = create_newfig(
        "{}01".format(func_code), xlim=(-1, 16), ylim=(-1, 11)
    )
    create_moving_polygon(
        fig, ax, renderer, ((3, 10), (2, 10), (1, 8), (2, 6), (5, 6), (7, 8)), (8, 0)
    )
    create_still_polygon(
        fig, ax, renderer, ((10, 5), (8, 6), (6, 5), (6, 4), (7, 2), (10, 4))
    )
...
def setup_fig02():
    fig, ax, renderer = create_newfig(
        "{}02".format(func_code), xlim=(-8, 7), ylim=(-2, 12)
    )
    create_moving_polygon(
        fig, ax, renderer, ((5, 5), (4, 5), (2, 0), (4, -1), (6, 0)), (-5, 0)
    )
...
def setup_fig03():
    fig, ax, renderer = create_newfig(
        "{}03".format(func_code), xlim=(-3, 12), ylim=(-5, 10)
    )
    create_moving_polygon(
        fig, ax, renderer, ((9.5, 8.5), (8.5, 7.5), (9.5, 5), (10.5, 7)), (-9, -9)
    )
...
def setup_fig04():
    fig, ax, renderer = create_newfig(
        "{}04".format(func_code), xlim=(-1, 14), ylim=(-3, 11)
    )
    create_moving_polygon(
        fig,
        ax,
