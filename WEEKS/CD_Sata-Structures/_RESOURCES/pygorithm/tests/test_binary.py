...
from pygorithm.binary import ascii, base2, base10, base16
...
class TestBase2(unittest.TestCase):
    def test_base2_to_ascii(self):
        ...
        self.assertEqual(
            base2.to_ascii(array), "The Quick Brown Fox Jumps Over the Lazy Dog"
        )
    ...
    def test_base2_to_base10(self):
        ...
        self.assertEqual(
            base2.to_base10(10011110110001100001010001100101000000110001),
            10910848929841,
        )
    ...
    def test_base2_to_base16(self):
        ...
        self.assertEqual(
            base2.to_base16(10011110110001100001010001100101000000110001), "9EC61465031"
        )
...
class TestBase16(unittest.TestCase):
    def test_base16_to_base2(self):
        ...
        self.assertEqual(
            base16.to_base2("FFFFFFFFFFFFFFF"),
    ...
    def test_base16_to_ascii(self):
        ...
        self.assertEqual(
            base16.to_ascii(array), "The Quick Brown Fox Jumps Over the Lazy Dog"
        )
...
class TestASCII(unittest.TestCase):
    def test_ascii_to_base16(self):
        ...
        self.assertEqual(
            ascii.to_base16("The Quick Brown Fox Jumps Over the Lazy Dog"), array
        )
    ...
    def test_ascii_to_base2(self):
        ...
        self.assertEqual(
            ascii.to_base2("The Quick Brown Fox Jumps Over the Lazy Dog"), array
        )
