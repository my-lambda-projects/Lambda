...
def setup_fig01():
    ...
    create_moving_polygon(
        fig, ax, renderer, ((0, 1), (1, 1), (1, 0), (0, 0)), (0, 2), "topright"
    )
...
def setup_fig02():
    ...
    create_moving_polygon(
        fig, ax, renderer, ((1, 1), (2, 2), (3, 1)), (-1, 1), "topright"
    )
    create_still_polygon(
        fig, ax, renderer, ((2.5, 0.5), (4, 0.5), (5, 1), (4.5, 2.5)), "botleft"
    )
...
def setup_fig04():
    ...
    create_moving_polygon(
        fig, ax, renderer, ((2, 0), (2, 2), (3, 1)), (-2, 0), "topright"
    )
    create_still_polygon(
        fig, ax, renderer, ((2.5, 0.5), (4, 0.5), (5, 1), (4.5, 2.5)), "botleft"
    )
