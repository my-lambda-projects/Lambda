...
def setup_fig01():
    fig, ax, renderer = create_newfig(
        "{}01".format(func_code), xlim=(-1, 10), ylim=(-1, 7)
    )

    create_moving_polygon(
        fig, ax, renderer, ((2, 2), (2, 3, "topleft"), (3, 3), (3, 2)), (5, 3), "none"
    )
    create_still_polygon(
        fig, ax, renderer, ((3, 5, "topleft"), (4, 5), (4, 4), (3, 4)), "none"
    )
...
def setup_fig02():
    fig, ax, renderer = create_newfig(
        "{}02".format(func_code), xlim=(-1, 10), ylim=(-1, 7)
    )

    create_moving_polygon(
        fig, ax, renderer, ((8, 5), (6, 3), (7, 3)), (-4, -3), "topright"
    )
...
def setup_fig03():
    ...
    create_moving_polygon(
        fig, ax, renderer, ((6, 3), (6, 2), (5, 1), (4, 3)), (-3, 0), "topright"
    )
    create_still_polygon(
        fig, ax, renderer, ((4, 1.25, "top"), (5, 0, "none"), (3, 0, "none"))
    )
...
def setup_fig04():
    ...
    create_moving_polygon(
        fig, ax, renderer, ((5, 0), (6, 1), (2, 1)), (0, 4), "topright"
    )
    create_still_polygon(
        fig, ax, renderer, ((3, 3, "top"), (4, 3), (4, 2), (3, 2)), "none"
    )
