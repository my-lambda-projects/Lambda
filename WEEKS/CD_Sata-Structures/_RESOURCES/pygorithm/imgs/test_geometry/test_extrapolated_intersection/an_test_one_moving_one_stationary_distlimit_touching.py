...
def setup_fig01():
    ...
    create_moving_polygon(
        fig, ax, renderer, ((0, 2), (0, 3), (1, 3), (1, 2)), (5, -1.25), "topright"
    )
...
def setup_fig02():
    ...
    create_moving_polygon(
        fig, ax, renderer, ((1, 2), (1, 3), (2, 3), (2, 2)), (4, 0), "topright"
    )
...
def setup_fig03():
    ...
    create_moving_polygon(
        fig, ax, renderer, ((2, 4), (3, 4), (3, 2), (1, 3)), (3, -2), "topright"
    )
    create_still_polygon(
        fig, ax, renderer, ((0, 1), (2.5, 2), (3, 0), (2, 0)), "botleft"
    )
...
def setup_fig04():
    ...
    create_moving_polygon(
        fig, ax, renderer, ((0, 0), (1, 2), (2, 1)), (3, 3), "topright"
    )
