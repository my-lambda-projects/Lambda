...
def setup_fig01():
    ...
    create_moving_polygon(
        fig, ax, renderer, ((3, 1), (3, 3), (4, 3), (4, 1)), (2, 0), "topright"
    )
...
def setup_fig02():
    ...
    create_moving_polygon(
        fig, ax, renderer, ((3, 1), (3, 3), (4, 3), (4, 1)), (2, -0.25), "topright"
    )
    create_still_polygon(fig, ax, renderer, ((3, 0), (3, 1), (4, 1), (4, 0)), "botleft")
...
def setup_fig03():
    ...
    create_moving_polygon(
        fig, ax, renderer, ((2, 4), (3, 4), (3, 2), (1, 1)), (-1, 2), "topright"
    )
    create_still_polygon(
...
def setup_fig04():
    ...
    create_moving_polygon(
        fig, ax, renderer, ((4, 0), (5, 2), (3, 2)), (0, 3), "topright"
    )
