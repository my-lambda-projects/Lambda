...
def setup_fig01():
    ...
    create_moving_polygon(
        ...
        ax,
        renderer,
        ((0, 1, "right"), (1, 2, "bot"), (2, 1, "left"), (1, 0, "top")),
        (0, 2),
    )
...
def setup_fig03():
    ...
    create_moving_polygon(
        fig, ax, renderer, ((4, 4), (5, 3.5), (5.5, 2.5), (4, 3)), (-2, 0), "topright"
    )
    create_still_polygon(fig, ax, renderer, ((3, 1), (3, 2), (4, 1)), "botleft")
...
def setup_fig04():
    ...
    create_moving_polygon(
        fig, ax, renderer, ((3, 1), (3, 2), (4, 1)), (2, 0), "botleft"
    )
    create_still_polygon(
        fig, ax, renderer, ((4, 4), (5, 3.5), (5.5, 2.5), (4, 3)), "topright"
    )
