...
var computerChoice;
if (randomComputerNum <= 0.33) {
  computerChoice = "rock";
} else if (randomComputerNum <= 0.66) {
...
function annoyingSong(startNum) {
  const y = `${startNum} bottles of soda on the wall, ${startNum} bottles of soda, take one down pass it around ${
    startNum - 1
  } bottles of soda on the wall`;
  if (startNum > 0) {
    annoyingSong(startNum - 1);
  }
  return y;
}
