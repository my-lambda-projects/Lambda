...
THREE.GLTF2Loader = (function () {
  ...
  function GLTFBinaryExtension(data) {
    ...
    if (this.header.magic !== BINARY_EXTENSION_HEADER_MAGIC) {
      ...
      throw new Error(
        "GLTF2Loader: Legacy binary file detected. Use GLTFLoader instead."
      );
    }
  ...
  GLTFParser.prototype.loadBuffers = function () {
    ...
    return _each(json.buffers, function (buffer, name) {
      if (buffer.type === "arraybuffer" || buffer.type === undefined) {
        ...
        console.warn(
          "THREE.GLTF2Loader: " + buffer.type + " buffer type is not supported"
        );
      }
    });
  };
            ...
            textureLoader.load(
              ...
              function (_texture) {
                ...
                if (
                  ...
                  console.warn(
                    "THREE.GLTF2Loader: Three.js doesn't support texture internalFormat which is different from texture format. " +
      ...
      return _each(json.materials, function (material) {
        ...
        if (materialExtensions[EXTENSIONS.KHR_MATERIALS_COMMON]) {
          ...
          if (metallicRoughness.baseColorTexture !== undefined) {
            ...
            var alphaMode =
              metallicRoughness.baseColorTexture.alphaMode ||
              ALPHA_MODES.OPAQUE;
        ...
        if (
          materialParams.opacity !== undefined &&
          materialParams.opacity < 1.0
        ) {
          materialParams.transparent = true;
        } else {
            ...
            if (primitive.targets !== undefined) {
              ...
              for (var i = 0, il = targets.length; i < il; i++) {
                ...
                if (target.POSITION !== undefined) {
                  ...
                  for (
                    var j = 0, jl = positionAttribute.array.length;
                    j < jl;
                    j++
                  ) {
                ...
                if (target.NORMAL !== undefined) {
                  ...
                  for (
                    var j = 0, jl = normalAttribute.array.length;
                    j < jl;
                    j++
                  ) {
        ...
        .then(function (dependencies) {
          return _each(__nodes, function (_node, nodeId) {
            ...
            if (node.mesh !== undefined) {
              ...
              console.warn(
                "GLTF2Loader: Legacy glTF file detected. Nodes may have no more than 1 mesh."
              );
            ...
            if (meshes !== undefined) {
              for (var meshId in meshes) {
                ...
                if (group === undefined) {
                  console.warn(
                    "GLTF2Loader: Couldn't find node \"" + mesh + '".'
                  );
                  continue;
                }
            ...
            if (
              ...
              var light =
                extensionLights[node.extensions[EXTENSIONS.KHR_LIGHTS].light];
