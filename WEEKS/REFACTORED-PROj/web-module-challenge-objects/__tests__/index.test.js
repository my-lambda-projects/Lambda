...
describe("createMenuItem", () => {
  it("createMenuItem returns object", () => {
    expect(functions.createMenuItem("taco", 8, "lunch")).toEqual({
      name: "taco",
      price: 8,
      category: "lunch",
    });
...
describe("getReviewByIndex", () => {
  it("getReviewByIndex returns a string", () => {
    expect(functions.getReviewByIndex(reviews, 0)).toBe(
      "Daniela gave the restaurant a 5 star review, and their feedback was: Beautiful atmosphere and wonderful vegan options!"
    );
  });
  it("getReviewByIndex returns a string", () => {
    expect(functions.getReviewByIndex(reviews, 2)).toBe(
      "Miranda gave the restaurant a 4 star review, and their feedback was: fun trivia and cool vibes"
    );
  });
});
...
describe("getLastReview", () => {
  it("getLastReview returns a string", () => {
    expect(functions.getLastReview(reviews)).toBe(
