            ...
            if (a.hasOwnProperty(c) && a[c]) {
              ...
              for (var d = 0; d < u.length; ++d) {
                ...
                for (var y = i, w = s; y < t.length; w += t[y].length, ++y) {
                  ...
                  if (!(k instanceof l)) {
                    if (f && y != t.length - 1) {
                      if (((g.lastIndex = w), !(_ = g.exec(e)))) break;
                      for (
                        var P = _.index + (m ? _[1].length : 0),
                    ...
                    if (_) {
                      ...
                      x = (P = _.index + h) + (_ = _[0].slice(h)).length;
                      var A = k.slice(0, P),
                        C = k.slice(x),
                        z = [y, j];
                      A && (++y, (w += A.length), z.push(A));
                      var N = new l(c, p ? n.tokenize(_, p) : _, b, _, f);
                      if (
                        (z.push(N),
                        C && z.push(C),
                        Array.prototype.splice.apply(t, z),
                        1 != j && n.matchGrammar(e, t, a, y, w, !0, c),
                        r)
                      )
                        break;
                    } else if (r) break;
                ...
                e.statlink &&
                  ...
                  (a +=
                    '\n                <div class="single-module single-module-'
                      ...
                      .concat(
                        e.statlink,
                        '">\n                      <img src="https://res.cloudinary.com/css-tricks/image/fetch/w_600,q_auto,f_auto/'
                      )
