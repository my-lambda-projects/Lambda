...
*/
  ...
  function va(a, b, c, d) {
    try {
      ...
      return (a.h.l = null), ra(a.h, g), wa(a);
    }
    a.h.l = null;
    d.call(a.h, f);
    return wa(a);
  ...
  function xa(a) {
    this.next = function (b) {
      qa(a.h);
      a.h.l ? (b = va(a, a.h.l.next, b, a.h.u)) : (a.h.u(b), (b = wa(a)));
      return b;
    };
    this.throw = function (b) {
      qa(a.h);
      a.h.l ? (b = va(a, a.h.l["throw"], b, a.h.u)) : (ra(a.h, b), (b = wa(a)));
      return b;
    };
      ...
      if (n && za(h.i, l))
        for (h = 0; h < n.length; h++) {
          ...
          if ((k !== k && p.key !== p.key) || k === p.key)
            return { id: l, list: n, index: h, G: p };
        }
      return { id: l, list: n, index: -1, G: void 0 };
    }
    function e(h) {
      this.i = {};
      this.h = b();
    ...
    e.prototype.delete = function (h) {
      ...
      return h.G && h.list
        ? (h.list.splice(h.index, 1),
          ...
          (h.G.previous.next = h.G.next),
          (h.G.next.previous = h.G.previous),
          (h.G.head = null),
          this.size--,
          !0)
        : !1;
  ...
  function Ca(a) {
    if (a && a != y) return Da(a.document);
    null === Ea && (Ea = Da(y.document));
    return Ea;
  }
  var Fa = /^[\w+/_-]+[=]{0,2}$/,
    Ea = null;
  ...
  function tb(a) {
    if (a instanceof rb && a.constructor === rb) return a.h;
    Ia(a);
    return "type_error:TrustedResourceUrl";
  }
  var sb = {};
  var ub = String.prototype.trim
    ? function (a) {
        return a.trim();
      }
    : function (a) {
  ...
  var Eb = {},
    Kb = new Db("about:invalid#zClosurez", Eb);
  var Lb;
  a: {
    var Mb = y.navigator;
    if (Mb) {
  ...
  function Rb(a, b) {
    b = b instanceof Db ? b : Jb(b);
    a.href = Fb(b);
  }
  function Sb(a, b) {
    a.src = tb(b);
    (b = Ca(a.ownerDocument && a.ownerDocument.defaultView)) &&
  ...
  var dc = I("Opera"),
    ...
    gc =
      I("Gecko") &&
      !(-1 != Lb.toLowerCase().indexOf("webkit") && !I("Edge")) &&
      !(I("Trident") || I("MSIE")) &&
      !I("Edge"),
    hc = -1 != Lb.toLowerCase().indexOf("webkit") && !I("Edge");
  function ic() {
    var a = y.document;
  ...
  function Rc() {
      ...
      for (q = 0; 80 > q; q++) {
        if (40 > q)
          if (20 > q) {
            var R = H ^ (A & (G ^ H));
            var M = 1518500249;
          } else (R = A ^ G ^ H), (M = 1859775393);
        else
          60 > q
            ? ((R = (A & G) | (H & (A | G))), (M = 2400959708))
            : ((R = A ^ G ^ H), (M = 3395469782));
        R =
          ((((p << 5) | (p >>> 27)) & 4294967295) + R + W + M + r[q]) &
          4294967295;
        W = H;
        H = G;
        G = ((A << 30) | (A >>> 2)) & 4294967295;
        A = p;
        p = R;
      }
    ...
    function c(p, r) {
      if ("string" === typeof p) {
        ...
        for (var q = [], A = 0, G = p.length; A < G; ++A)
          q.push(p.charCodeAt(A));
        p = q;
      }
      r || (r = p.length);
      q = 0;
    ...
    function d() {
      ...
      b(f);
      for (q = r = 0; 5 > q; q++)
        for (var A = 24; 0 <= A; A -= 8) p[r++] = (e[q] >> A) & 255;
      return p;
    }
  ...
  function Sc(a, b, c) {
    ...
    return d && a && b ? [b, Tc(Qc(d), a, c || null)].join(" ") : null;
  }
  function Tc(a, b, c) {
    var d = [],
      e = [];
  ...
  m.isEnabled = function () {
    ...
    this.set("TESTCOOKIESENABLED", "1", { ma: 60 });
  ...
  var Xc = new Wc("undefined" == typeof document ? null : document);
  function Yc(a) {
    return !!Vc.FPA_SAMESITE_PHASE2_MOD || !(void 0 === a || !a);
  }
  function Zc(a, b, c, d) {
    (a = y[a]) || (a = new Wc(document).get(b));
    return a ? Sc(a, c, d) : null;
  }
  function $c(a) {
    var b = void 0 === b ? !1 : b;
    var c = Qc(String(y.location.href)),
      d = [];
    var e = b;
    e = void 0 === e ? !1 : e;
    var f = y.__SAPISID || y.__APISID || y.__3PSAPISID || y.__OVERRIDE_SID;
    Yc(e) && (f = f || y.__1PSAPISID);
    if (f) e = !0;
    else {
      var g = new Wc(document);
      f =
        g.get("SAPISID") ||
        g.get("APISID") ||
    ...
    e &&
      ...
      (e = e ? Sc(e, c ? "SAPISIDHASH" : "APISIDHASH", a) : null) && d.push(e),
      c &&
        Yc(b) &&
        ((b = Zc("__1PSAPISID", "__Secure-1PAPISID", "SAPISID1PHASH", a)) &&
          d.push(b),
        (a = Zc("__3PSAPISID", "__Secure-3PAPISID", "SAPISID3PHASH", a)) &&
          d.push(a)));
  ...
  rd.prototype.update = function (a, b) {
    if (null != a) {
      ...
      for (var c = b - this.i, d = 0, e = this.m, f = this.j; d < b; ) {
        if (0 == f) for (; d <= c; ) sd(this, a, d), (d += this.i);
        if ("string" === typeof a)
          for (; d < b; ) {
    ...
    if (!(!c && a.lineNumber && a.fileName && a.stack && a.message && a.name)) {
      ...
      if (null == c) {
        if (a.constructor && a.constructor instanceof Function) {
          ...
          else if (((c = a.constructor), vd[c])) c = vd[c];
          else {
            c = String(c);
            if (!vd[c]) {
              var f = /function\s+([^\(]+)/m.exec(c);
              vd[c] = f ? f[1] : "[Anonymous]";
            }
            c = vd[c];
          }
  ...
  function Cd(a, b) {
    a.classList
      ...
      : ((a = a.classList ? a.classList : Ad(a).match(/\S+/g) || []),
        (b = 0 <= Wa(a, b)));
    return b;
  }
  function Dd() {
    ...
    a.classList
      ...
      : Cd(a, "inverted-hdpi") &&
        Bd(
          a,
          Xa(
            a.classList ? a.classList : Ad(a).match(/\S+/g) || [],
            function (b) {
  ...
  function Jd(a, b) {
    ...
    if (1 < c) {
      ...
      if (a instanceof Jd)
        for (c = Kd(a), d = 0; d < c.length; d++) this.set(c[d], a.get(c[d]));
  ...
  m.remove = function (a) {
    return Object.prototype.hasOwnProperty.call(this.i, a)
      ? (delete this.i[a],
        this.j--,
        this.O++,
        this.h.length > 2 * this.j && Ld(this),
        !0)
      : !1;
  };
  function Ld(a) {
  ...
  m.set = function (a, b) {
    Object.prototype.hasOwnProperty.call(this.i, a) ||
      (this.j++, this.h.push(a), this.O++);
    this.i[a] = b;
  };
  m.forEach = function (a, b) {
    for (var c = Kd(this), d = 0; d < c.length; d++) {
      var e = c[d],
        f = this.get(e);
      a.call(b, f, e, this);
    }
  ...
  var Nd = (function () {
    ...
    try {
      y.addEventListener("test", Ga, b), y.removeEventListener("test", Ga, b);
    } catch (c) {}
    return a;
  })();
  function Od(a, b) {
  ...
  D(Pd, Od);
  var Qd = { 2: "touch", 3: "pen", 4: "mouse" };
  Pd.prototype.init = function (a, b) {
    ...
    this.state = a.state;
    this.i = a;
    a.defaultPrevented && Pd.I.preventDefault.call(this);
  };
  ...
  Vd.prototype.add = function (a, b, c, d, e) {
    ...
    -1 < g
      ? ((b = a[g]), c || (b.ba = !1))
      : ((b = new Td(b, this.src, f, !!d, e)), (b.ba = c), a.push(b));
    return b;
  };
  ...
  function Xd(a, b) {
    ...
    c in a.listeners &&
      ab(a.listeners[c], b) &&
      (Ud(b), 0 == a.listeners[c].length && (delete a.listeners[c], a.h--));
  }
  function Wd(a, b, c, d) {
    for (var e = 0; e < a.length; ++e) {
      var f = a[e];
      if (!f.Y && f.listener == b && f.capture == !!c && f.da == d) return e;
    }
    return -1;
  }
  ...
  function be(a, b, c, d, e) {
    if (Array.isArray(b))
      ...
      (c = ce(c)),
        a && a[Rd]
          ? a.i.add(String(b), c, !0, Ka(d) ? !!d.capture : !!d, e)
          : ee(a, b, c, !0, d, e);
  }
  function je(a, b, c, d, e) {
    if (Array.isArray(b))
      ...
      ((d = Ka(d) ? !!d.capture : !!d), (c = ce(c)), a && a[Rd])
    ...
    if ("number" !== typeof a && a && !a.Y) {
      ...
      if (b && b[Rd]) Xd(b.i, a);
        ...
        b.removeEventListener
          ...
          : b.detachEvent
          ? b.detachEvent(he(c), d)
          : b.addListener && b.removeListener && b.removeListener(d);
        $d--;
        (c = fe(b))
          ? (Xd(c, a), 0 == c.h && ((c.src = null), (b[Yd] = null)))
          : Ud(a);
      }
    }
  }
  ...
  me.prototype.B = function () {
    ...
    if (this.i) {
      ...
      for (c in a.listeners) {
        for (var d = a.listeners[c], e = 0; e < d.length; e++) ++b, Ud(d[e]);
        ...
        if (b instanceof String || b instanceof Number || b instanceof Boolean)
          ...
          for (d in b)
            Object.prototype.hasOwnProperty.call(b, d) &&
              ((f = b[d]),
              "function" != typeof f &&
                (c.push(e), se(d, c), c.push(":"), qe(a, f, c), (e = ",")));
          c.push("}");
          return;
        }
      }
    ...
    e.h = new O(function (f, g) {
      ...
      e.onRejected = c
        ? function (h) {
            try {
              var k = c.call(d, h);
              void 0 === k && h instanceof De ? g(h) : f(k);
            } catch (l) {
              g(l);
            }
          }
    ...
    if (0 == a.h) {
      ...
      a: {
        var d = c,
          ...
          f = a.F;
        if (d instanceof O) {
          He(d, ze(e || Ga, f || null, a));
          var g = !0;
        } else if (ve(d)) d.then(e, f, a), (g = !0);
        else {
          if (Ka(d))
            try {
              var h = d.then;
  ...
  O.prototype.A = function () {
    for (var a; (a = Fe(this)); ) Ge(this, a, this.h, this.u);
    this.m = !1;
  };
  function Ge(a, b, c, d) {
    if (3 == c && b.onRejected && !b.j) for (; a && a.o; a = a.j) a.o = !1;
    if (b.h) (b.h.j = null), Le(b, c, d);
    else
      try {
        b.j ? b.i.call(b.context) : Le(b, c, d);
      } catch (e) {
        Me.call(null, e);
      }
    dd(ye, b);
  ...
  function Se(a) {
    return void 0 === a || a instanceof Re ? a : new Re(a);
  }
  Qe.prototype.set = function (a, b) {
    Qe.I.set.call(this, a, Se(b));
  };
  Qe.prototype.i = function (a) {
    a = Qe.I.get.call(this, a);
  ...
  Te.prototype.set = function (a, b, c) {
    if ((b = Se(b))) {
      if (c) {
        if (c < Date.now()) {
          Te.prototype.remove.call(this, a);
          return;
        }
        b.expiration = c;
      }
    ...
    Te.I.set.call(this, a, b);
  };
  Te.prototype.i = function (a) {
    var b = Te.I.i.call(this, a);
    if (b) {
      var c = b.creation,
        d = b.expiration;
  ...
  m.set = function (a, b) {
    this.h.setAttribute(af(a), b);
    bf(this);
  };
  m.get = function (a) {
    a = this.h.getAttribute(af(a));
    if ("string" !== typeof a && null !== a)
      throw "Storage mechanism: Invalid value was encountered";
    return a;
  };
  m.remove = function (a) {
    this.h.removeAttribute(af(a));
    bf(this);
  };
  m.M = function (a) {
    var b = 0,
  ...
  function sf(a) {
    ...
    try {
      if ((a = a || window.event)) {
        this.event = a;
        for (var b in a) b in rf || (this[b] = a[b]);
  ...
  sf.prototype.stopImmediatePropagation = function () {
    this.event &&
      ((this.event.cancelBubble = !0),
  ...
  var uf = y.ytEventsEventsCounter || { count: 0 };
  z("ytEventsEventsCounter", uf, void 0);
  function vf(a, b, c, d) {
    d = void 0 === d ? {} : d;
    a.addEventListener &&
  ...
  function Bf(a) {
    ...
    this.l = 0;
    this.J = xf(window, "mousemove", C(this.K, this));
    a = C(this.F, this);
    "function" === typeof a && (a = jf(a));
  ...
  Bf.prototype.F = function () {
    if (this.i) {
      ...
      if (0 != this.m) {
        ...
        this.j[this.l] = 0.5 < Math.abs((d - this.u) / this.u) ? 1 : 0;
  ...
  function Kf(a) {
    var b = void 0 === a ? {} : a;
    a = void 0 === b.Ka ? !0 : b.Ka;
    b = void 0 === b.Xa ? !1 : b.Xa;
    if (null == B("_lact", window)) {
      ...
      z("_fact", c, window);
      -1 == c && Lf();
      xf(document, "keydown", Lf);
      xf(document, "keyup", Lf);
      xf(document, "mousedown", Lf);
      xf(document, "mouseup", Lf);
      a &&
        (b
          ? xf(
              window,
          ...
          : (xf(window, "resize", function () {
              Mf("resize", 200);
            }),
            xf(window, "scroll", function () {
              Mf("scroll", 200);
            })));
      new Bf(function () {
        Mf("mouse", 100);
      });
      xf(document, "touchstart", Lf, { passive: !0 });
      xf(document, "touchend", Lf, { passive: !0 });
    }
  }
  function Mf(a, b) {
    Jf[a] ||
  ...
  function Lf() {
    null == B("_lact", window) && Kf();
    var a = Date.now();
    z("_lact", a, window);
    -1 == B("_fact", window) && z("_fact", a, window);
          ...
          k.args = [
            {
              ...
              value: f[1],
              query: a,
              method: Vf == n ? "unchanged" : n,
            },
          ];
          Sf.hasOwnProperty(l) || lf(k);
        }
    }
    return c;
  }
  ...
  function Zf(a) {
    ...
    c && d
      ...
      : (a = d
          ? Xb(b) == d &&
            (Number(b.match(Vb)[4] || null) || null) ==
              (Number(a.match(Vb)[4] || null) || null)
          : !0);
    return a;
  }
  function Uf(a) {
    return a && a.match(Rf) ? a : decodeURIComponent(a.replace(/\+/g, " "));
  }
  function $f(a) {
    var b = ag;
    ...
    k = [A, G, k, l, H, W, n, p, r, q];
    l = b.h.top;
    try {
      var R = (l || window).document,
        M = "CSS1Compat" == R.compatMode ? R.documentElement : R.body;
      var ja = new zc(M.clientWidth, M.clientHeight).round();
    } catch (N) {
      ja = new zc(-12245933, -12245933);
    }
    R = ja;
    ja = {};
    M = new ad();
    y.SVGElement && y.document.createElementNS && M.set(0);
    l = Lc();
    l["allow-top-navigation-by-user-activation"] && M.set(1);
    l["allow-popups-to-escape-sandbox"] && M.set(2);
    y.crypto && y.crypto.subtle && M.set(3);
    y.TextDecoder && y.TextEncoder && M.set(4);
    M = bd(M);
    ja.bc = M;
    ja.bih = R.height;
    ja.biw = R.width;
    ...
    b =
      ...
      (ja.wgl = !!K.WebGLRenderingContext),
      ja);
    c = d.call(c, e, b);
    c.ca_type = "image";
    a && (c.bid = a);
  ...
  var eg = {
    ...
    fg =
      "app debugcss debugjs expflag force_ad_params force_ad_encrypted force_viral_ad_response_params forced_experiments innertube_snapshots innertube_goldens internalcountrycode internalipoverride absolute_experiments conditional_experiments sbb sr_bns_address client_dev_root_url".split(
        " "
      ),
    gg = !1;
  function hg(a, b) {
    ...
    if (c || !Xb(a)) b["X-YouTube-Ad-Signals"] = Wf($f(void 0));
    return b;
  }
  function ig(a) {
  ...
  function jg(a, b) {
      ...
      f = mg(
        ...
        function (k) {
          if (!e) {
            ...
            if (l || p || r) n = ng(a, c, k, b.convertToSafeHtml);
            if (l)
    ...
    if (b.onTimeout && 0 < b.timeout) {
      var g = b.onTimeout;
      var h = S(function () {
        e || ((e = !0), f.abort(), Af(h), g.call(b.context || y, f));
      }, b.timeout);
    }
    return f;
  }
  function kg(a, b) {
    ...
    if ((b = b.urlParams)) b[c] && delete b[c], (a = Yf(a, b || {}, !0));
    return a;
  }
  function lg(a, b) {
    var c = F("XSRF_FIELD_NAME", void 0),
    ...
    b.excludeXsrf ||
      (Xb(a) && !b.withCredentials && Xb(a) != document.location.hostname) ||
      "POST" != b.method ||
    ...
    !gg &&
      f &&
      "POST" != b.method &&
      ((gg = !0), kf(Error("AJAX request with postData should use POST")));
    return e;
  }
  function ng(a, b, c, d) {
    var e = null;
    switch (b) {
      case "JSON":
        ...
        break;
      case "XML":
        if ((a = (a = c.responseXML) ? og(a) : null))
          (e = {}),
            E(a.getElementsByTagName("*"), function (g) {
              e[g.tagName] = pg(g);
            });
    }
    d && qg(e);
  ...
  function mg(a, b, c, d, e, f, g) {
    function h() {
      4 == (k && "readyState" in k ? k.readyState : 0) && b && jf(b)(k);
    }
    c = void 0 === c ? "GET" : c;
    d = void 0 === d ? "" : d;
    var k = cg();
    ...
    Q("debug_forward_web_query_parameters") && (a = ig(a));
    k.open(c, a, !0);
    f && (k.responseType = f);
  ...
  function vg(a, b, c, d, e) {
    ...
    if (a)
      if (c && !sg("cobalt")) {
        if (a) {
          a instanceof Db ||
            ...
            Ib.test(a)
              ...
              : ((a = String(a)),
                (a = a.replace(/(%0A|%0D)/g, "")),
                (a =
                  (b = a.match(Hb)) && Gb.test(b[1]) ? new Db(a, Eb) : null)));
          a = Fb(a || Kb);
          if ("about:invalid#zClosurez" === a || a.startsWith("data")) a = "";
            ...
            a instanceof Ob && a.constructor === Ob
              ? (a = a.h)
              : (Ia(a), (a = "type_error:SafeHtml"));
      ...
      } else if (e) mg(a, b, "POST", e, d);
      else if (F("USE_NET_AJAX_FOR_PING_TRANSPORT", !1) || d)
        mg(a, b, "GET", "", d);
      else {
        b: {
          try {
        ...
        f ? (wg(a) ? (b && b(), (f = !0)) : (f = !1)) : (f = !1);
        f || xg(a, b);
      }
  }
  function yg(a) {
    var b = void 0 === b ? "" : b;
    wg(a, b) || vg(a, void 0, void 0, void 0, b);
  }
  function wg(a, b) {
    try {
      if (
  ...
  var zg = y.ytPubsubPubsubInstance || new P(),
    Ag = y.ytPubsubPubsubSubscribedKeys || {},
    Bg = y.ytPubsubPubsubTopicToKeys || {},
    Cg = y.ytPubsubPubsubIsSynchronous || {};
  function Dg(a, b) {
    var c = Eg();
    if (c && b) {
      var d = c.subscribe(
  ...
  P.prototype.unsubscribeByKey = P.prototype.X;
  P.prototype.publish = P.prototype.P;
  P.prototype.clear = P.prototype.clear;
  z("ytPubsubPubsubInstance", zg, void 0);
  z("ytPubsubPubsubTopicToKeys", Bg, void 0);
  z("ytPubsubPubsubIsSynchronous", Cg, void 0);
  z("ytPubsubPubsubSubscribedKeys", Ag, void 0);
  var Jg = window,
    T =
      Jg.ytcsi && Jg.ytcsi.now
        ? Jg.ytcsi.now
        : Jg.performance &&
          Jg.performance.timing &&
          Jg.performance.now &&
          Jg.performance.timing.navigationStart
        ? function () {
            return Jg.performance.timing.navigationStart + Jg.performance.now();
          }
        : function () {
            return new Date().getTime();
          };
  var Kg = pf("initial_gel_batch_timeout", 1e3),
    Lg = Math.pow(2, 16) - 1,
    Mg = null,
    Ng = 0,
    Og = void 0,
    ...
    Rg = 0,
    Sg = !0,
    Tg = y.ytLoggingTransportGELQueue_ || new Map();
  z("ytLoggingTransportGELQueue_", Tg, void 0);
  var Ug = y.ytLoggingTransportTokensToCttTargetIds_ || {};
  z("ytLoggingTransportTokensToCttTargetIds_", Ug, void 0);
  function Vg(a, b) {
    if ("log_event" === a.endpoint) {
      var c = "";
      a.D && ((Ug[a.D.token] = Wg(a.D)), (c = a.D.token));
      var d = Tg.get(c) || [];
      Tg.set(c, d);
      d.push(a.payload);
      b && (Og = new b());
      a = pf("web_logging_max_batch") || 100;
      b = T();
      d.length >= a
        ? Xg({ writeThenSend: !0 })
        : 10 <= b - Rg && (Yg(), (Rg = b));
  ...
  function Zg(a, b) {
    if ("log_event" === a.endpoint) {
      ...
      return new O(function (e) {
        Og && Og.isReady() ? $g(d, e, { bypassNetworkless: !0 }) : e();
      });
    }
  }
  function Xg(a) {
    ...
    new O(function (b) {
      ...
      Af(Qg);
      Qg = 0;
      Og && Og.isReady() ? ($g(Tg, b, a), Tg.clear()) : (Yg(), b());
    });
  }
  function Yg() {
    ...
    Af(Pg);
    var a = F("LOGGING_BATCH_TIMEOUT", pf("web_gel_debounce_ms", 1e4));
    Q("shorten_initial_gel_batch_timeout") && Sg && (a = Kg);
    Pg = S(function () {
      Xg({ writeThenSend: !0 });
    }, a);
  }
  ...
  function dh(a, b) {
    ...
    if ((b = F("EVENT_ID", void 0))) {
      var c = F("BATCH_CLIENT_COUNTER", void 0) || 0;
      c || (c = Math.floor((Math.random() * Lg) / 2));
      c++;
      c > Lg && (c = 1);
      ff("BATCH_CLIENT_COUNTER", c);
      ...
      Mg &&
        ...
        Q("log_gel_rtt_web") &&
        (a.previousBatchInfo = {
          serializedClientEventId: Mg,
          roundtripMs: String(Ng),
        });
      Mg = b;
      Ng = 0;
    }
  ...
  var fh = y.ytLoggingGelSequenceIdObj_ || {};
  z("ytLoggingGelSequenceIdObj_", fh, void 0);
  function gh(a, b, c, d) {
    d = void 0 === d ? {} : d;
    var e = {};
    ...
    Q("log_sequence_info_on_gel_web") &&
      ...
      ((a = e.context),
      (b = d.N),
      (fh[b] = b in fh ? fh[b] + 1 : 0),
      (a.sequence = { index: fh[b], groupKey: b }),
      d.Ia && delete fh[d.N]);
    (d.Ik ? Zg : Vg)({ endpoint: "log_event", payload: e, D: d.D }, c);
  }
  function hh() {
  ...
  var U = B("ytglobal.prefsUserPrefsPrefs_") || {};
  z("ytglobal.prefsUserPrefsPrefs_", U, void 0);
  function jh() {
    this.h = F("ALT_PREF_COOKIE_NAME", "PREF");
    this.i = F("ALT_PREF_COOKIE_DOMAIN", "youtube.com");
    var a = Xc.get("" + this.h, void 0);
    if (a) {
      a = decodeURIComponent(a).split("&");
      for (var b = 0; b < a.length; b++) {
        var c = a[b].split("="),
          d = c[0];
        (c = c[1]) && (U[d] = c.toString());
      }
    }
  }
  jh.prototype.get = function (a, b) {
    kh(a);
    lh(a);
    a = void 0 !== U[a] ? U[a].toString() : null;
    return null != a ? a : b ? b : "";
  };
  ...
  function bh() {
    return {
      ...
      La: F("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),
      Ma: F("INNERTUBE_CONTEXT_CLIENT_NAME", "WEB"),
      innertubeContextClientVersion: F(
        "INNERTUBE_CONTEXT_CLIENT_VERSION",
        void 0
      ),
      Oa: F("INNERTUBE_CONTEXT_HL", void 0),
      Na: F("INNERTUBE_CONTEXT_GL", void 0),
      Pa: F("INNERTUBE_HOST_OVERRIDE", void 0) || "",
      Ra: !!F("INNERTUBE_USE_THIRD_PARTY_AUTH", !1),
      Qa: !!F("INNERTUBE_OMIT_API_KEY_WHEN_AUTH_HEADER_IS_PRESENT", !1),
  ...
  function ah(a) {
    ...
    if ("WEB" === f || "MWEB" === f || 1 === f || 2 === f) {
      if (!Q("web_include_display_mode_killswitch")) {
        ...
        b.client.mainAppWebInfo.webDisplayMode = hh();
      }
    } else if (
      ...
      var h;
      b.client.xa = null != (h = b.client.xa) ? h : {};
      b.client.xa.webDisplayMode = hh();
    }
    a.appInstallData &&
    ...
    a: {
      if ((h = ph())) {
        a = nh[h.type || "unknown"] || "CONN_UNKNOWN";
        h = nh[h.effectiveType || "unknown"] || "CONN_UNKNOWN";
    ...
    Q("web_log_effective_connection_type") &&
      ...
      (a =
        null !== a && void 0 !== a && a.effectiveType
          ? oh.hasOwnProperty(a.effectiveType)
            ? oh[a.effectiveType]
    ...
    g = b.client;
    f = {};
    e = u(Object.entries(Xf(F("DEVICE", ""))));
  ...
  function rh(a, b, c) {
    c = void 0 === c ? {} : c;
    var d = { "X-Goog-Visitor-Id": c.visitorData || F("VISITOR_DATA", "") };
    if (b && b.includes("www.youtube-nocookie.com")) return d;
    (b = c.zk || F("AUTHORIZATION")) ||
      (a ? (b = "Bearer " + B("gapi.auth.getToken")().yk) : (b = $c([])));
    b &&
      ((d.Authorization = b),
      (d["X-Goog-AuthUser"] = F("SESSION_INDEX", 0)),
      Q("pageid_as_header_web") &&
        (d["X-Goog-PageId"] = F("DELEGATED_SESSION_ID")));
    return d;
  }
  function sh(a) {
    a = Object.assign({}, a);
  ...
  function th(a) {
    var b = new Xe();
    (b = b.isAvailable() ? (a ? new cf(b, a) : b) : null) ||
      ((a = new Ye(a || "UserDataSharedStore")),
      (b = a.isAvailable() ? a : null));
    this.h = (a = b) ? new Te(a) : null;
  ...
  th.prototype.get = function (a, b) {
    ...
    if (d && (c = Xc.get("" + a, void 0)) && ((c = unescape(c)), b))
      try {
        c = JSON.parse(c);
      } catch (e) {
  ...
  th.prototype.remove = function (a) {
    ...
    var b = this.i;
    Xc.remove("" + a, "/", void 0 === b ? "youtube.com" : b);
  };
  var uh;
  function vh() {
    uh || (uh = new th("yt.innertube"));
    return uh;
  }
  function wh(a, b, c, d) {
    if (d) return null;
  ...
  var Bh = B("ytPubsub2Pubsub2Instance") || new P();
  P.prototype.subscribe = P.prototype.subscribe;
  P.prototype.unsubscribeByKey = P.prototype.X;
  P.prototype.publish = P.prototype.P;
  P.prototype.clear = P.prototype.clear;
  z("ytPubsub2Pubsub2Instance", Bh, void 0);
  var Ch = B("ytPubsub2Pubsub2SubscribedKeys") || {};
  z("ytPubsub2Pubsub2SubscribedKeys", Ch, void 0);
  var Dh = B("ytPubsub2Pubsub2TopicToKeys") || {};
  z("ytPubsub2Pubsub2TopicToKeys", Dh, void 0);
  var Eh = B("ytPubsub2Pubsub2IsAsync") || {};
  z("ytPubsub2Pubsub2IsAsync", Eh, void 0);
  ...
  function Hh(a) {
            ...
            try {
              if (f && b instanceof Ah && b != e)
                try {
                  ...
                  try {
                    f = Reflect.construct(h, bb(k.args));
                  } catch (p) {
                    throw (
                      ((p.message =
    ...
    Ch[d] = !0;
    Dh[b.toString()] || (Dh[b.toString()] = []);
    Dh[b.toString()].push(d);
    return d;
  }
  function Jh() {
    var a = Kh,
  ...
  function Ph(a) {
    Oh ||
      (Nh.push({ type: "ERROR", payload: a }), 10 < Nh.length && Nh.shift());
  }
  function Qh(a, b) {
    Oh ||
      (Nh.push({ type: "EVENT", eventType: a, payload: b }),
      10 < Nh.length && Nh.shift());
  }
  var Rh = (function () {
    var a;
    return function () {
  ...
  function Th(a, b, c) {
    ...
    if (Uh()) {
      var e;
      this.i.isSupported === this.h
        ? (e = Object.assign(Object.assign({}, this.i), {
      ...
      null === (d = Rh()) || void 0 === d
        ? void 0
        : d.set("LAST_RESULT_ENTRY_KEY", e, 2592e3, !0);
    }
  }
  function Vh(a, b) {
    return new Th(
  ...
  Th.prototype.isSupported = function () {
    return this.h;
  };
  Th.prototype.log = function () {
    Uh() &&
      Qh("IS_SUPPORTED_COMPLETED", {
        isSupported: this.h,
        lastIsSupported: this.i.isSupported,
        failureMessage: this.failureMessage,
        sameResultCount: this.i.resultCount,
        sameResultDurationMs: Math.floor(T() - this.i.createdTimestampMs),
  ...
  function Uh() {
    var a;
    return !!(
      Q("ytidb_analyze_is_supported") &&
      (null === (a = Rh()) || void 0 === a ? 0 : a.h)
    );
  }
  function Wh(a, b) {
  ...
  var Zh = {},
    $h =
      ((Zh.AUTH_INVALID = "No user identifier specified."),
      (Zh.EXPLICIT_ABORT = "Transaction was explicitly aborted."),
      (Zh.IDB_NOT_SUPPORTED = "IndexedDB is not supported."),
      (Zh.MISSING_OBJECT_STORE = "Object store not created."),
      (Zh.UNKNOWN_ABORT = "Transaction was aborted for unknown reasons."),
      (Zh.QUOTA_EXCEEDED =
        "The current transaction exceeded its quota limitations."),
      (Zh.QUOTA_MAYBE_EXCEEDED =
        "The current transaction may have failed because of exceeding quota limitations."),
      (Zh.EXECUTE_TRANSACTION_ON_CLOSED_DB =
        "Can't start a transaction on a closed database"),
      Zh),
    ai = {},
    bi =
      ((ai.AUTH_INVALID = "ERROR"),
      (ai.EXECUTE_TRANSACTION_ON_CLOSED_DB = "WARNING"),
      (ai.EXPLICIT_ABORT = "IGNORED"),
      (ai.IDB_NOT_SUPPORTED = "ERROR"),
      (ai.MISSING_OBJECT_STORE = "ERROR"),
      (ai.QUOTA_EXCEEDED = "WARNING"),
      (ai.QUOTA_MAYBE_EXCEEDED = "WARNING"),
      (ai.UNKNOWN_ABORT = "WARNING"),
      ai),
    ci = {},
    di =
      ((ci.AUTH_INVALID = !1),
      (ci.EXECUTE_TRANSACTION_ON_CLOSED_DB = !1),
      (ci.EXPLICIT_ABORT = !1),
      (ci.IDB_NOT_SUPPORTED = !1),
      (ci.MISSING_OBJECT_STORE = !1),
      (ci.QUOTA_EXCEEDED = !1),
      (ci.QUOTA_MAYBE_EXCEEDED = !0),
      (ci.UNKNOWN_ABORT = !0),
      ci);
  ...
  v(V, Wh);
  function ei(a) {
    V.call(this, "MISSING_OBJECT_STORE", { Dk: a }, $h.MISSING_OBJECT_STORE);
  ...
  function gi(a, b, c) {
    ...
    d.args = [{ name: "IdbError", Ek: d.name, dbName: b, objectStoreNames: c }];
    d.level = "WARNING";
    return d;
  }
  function hi(a) {
  ...
  function ki(a, b, c, d, e) {
    try {
      ...
      f instanceof X ? mi(a, b, f, d, e) : d(f);
    } catch (g) {
      e(g);
    }
  }
  ...
  m.add = function (a, b, c) {
    return si(this, [a], { mode: "readwrite", H: !0 }, function (d) {
      return ti(d, a).add(b, c);
    });
  };
  m.clear = function (a) {
    return si(this, [a], { mode: "readwrite", H: !0 }, function (b) {
      return ti(b, a).clear();
    });
  };
  m.close = function () {
  ...
  m.count = function (a, b) {
    return si(this, [a], { mode: "readonly", H: !0 }, function (c) {
      return ti(c, a).count(b);
    });
  };
  function ui(a, b, c) {
  ...
  m.delete = function (a, b) {
    return si(this, [a], { mode: "readwrite", H: !0 }, function (c) {
      return ti(c, a).delete(b);
    });
  };
  m.get = function (a, b) {
    return si(this, [a], { mode: "readonly", H: !0 }, function (c) {
  ...
  function wi(a, b, c, d) {
    return si(a, [b], { mode: "readwrite", H: !0 }, function (e) {
      e = ti(e, b);
      return Y(e.h.put(c, d));
    });
  }
  function si(a, b, c, d) {
    return J(a, function f() {
      ...
      return x(f, function (N) {
        switch (N.h) {
          case 1:
            var eb = { mode: "readonly", H: !1 };
            "string" === typeof c ? (eb.mode = c) : (eb = c);
            h = eb;
            g.transactionCount++;
            k = Q("ytidb_transaction_exponential_backoff_retries");
            l = h.H ? pf("ytidb_transaction_try_count", 1) : 1;
            n = 500;
            p = 0;
          case 2:
            if (r) {
          ...
          case 6:
            return (
              (G = N.i),
              (H = Math.round(T())),
              zi(g, q, H, p, void 0, b.join(), h),
              N.return(G)
            );
          case 4:
            W = sa(N);
            R = Math.round(T());
            M = gi(W, g.h.name, b.join());
            if ((ja = M instanceof V && !M.h) || p >= l) {
              zi(g, q, R, p, M, b.join(), h);
              r = M;
              N.h = 2;
              break;
            }
          ...
          case 9:
            ...
            break;
          case 3:
            return N.return(Promise.reject(r));
        }
      });
    });
  }
    ...
    e
      ? (e instanceof V &&
        ...
        e instanceof V &&
          ...
          (Qh("TRANSACTION_UNEXPECTEDLY_ABORTED", {
            objectStoreNames: f,
  ...
  m = vi.prototype;
  m.add = function (a, b) {
    return Y(this.h.add(a, b));
  };
  m.clear = function () {
    return Y(this.h.clear()).then(function () {});
  };
  m.count = function (a) {
    return Y(this.h.count(a));
  };
  function Bi(a, b) {
    return Ci(a, { query: b }, function (c) {
  ...
  m.delete = function (a) {
    return a instanceof IDBKeyRange ? Bi(this, a) : Y(this.h.delete(a));
  };
  m.get = function (a) {
    return Y(this.h.get(a));
  };
  m.index = function (a) {
    return new Di(this.h.index(a));
  };
  m.getName = function () {
    return this.h.name;
  };
  ...
  function ti(a, b) {
    b = a.h.objectStore(b);
    var c = a.i.get(b);
    c || ((c = new vi(b)), a.i.set(b, c));
    return c;
  }
  function Di(a) {
    this.h = a;
  }
  Di.prototype.count = function (a) {
    return Y(this.h.count(a));
  };
  Di.prototype.delete = function (a) {
    return Fi(this, { query: a }, function (b) {
  ...
  Di.prototype.getKey = function (a) {
    return Y(this.h.getKey(a));
  };
  function Fi(a, b, c) {
    a = a.h.openCursor(
  ...
  function Ei(a) {
    return Y(a).then(function (b) {
      return null === b ? null : new Gi(a, b);
    });
  }
  m = Gi.prototype;
  m.advance = function (a) {
    this.cursor.advance(a);
    return Ei(this.request);
  };
  ...
  m.delete = function () {
    return Y(this.cursor.delete()).then(function () {});
  };
  m.getKey = function () {
  ...
  m.update = function (a) {
    return Y(this.cursor.update(a));
  };
  function Hi(a, b, c) {
    return J(this, function e() {
      var f, g, h, k, l, n, p, r, q, A;
      return x(e, function (G) {
        if (1 == G.h)
          return (
            ...
            (p = g.closed),
            (q = function () {
              r || (r = new ri(f.result, { closed: p }));
              return r;
            }),
            f.addEventListener("upgradeneeded", function (H) {
              if (null === H.newVersion)
                throw Error(
              ...
              H.dataLoss &&
                "none" !== H.dataLoss &&
                Qh("IDB_DATA_CORRUPTED", {
                  reason: H.dataLossMessage || "unknown reason",
                  dbName: Yh(a),
                });
              var W = q(),
                R = new xi(f.transaction);
              n && n(W, H.oldVersion, H.newVersion, R);
            }),
            h &&
        ...
        A = G.i;
        k &&
          A.addEventListener("versionchange", function () {
            k(q());
          });
        A.addEventListener("close", function () {
          Qh("IDB_UNEXPECTEDLY_CLOSED", {
            dbName: Yh(a),
            dbVersion: A.version,
          });
          l && l();
        ...
        e = function () {
          return J(a, function g() {
            ...
            return x(g, function (p) {
              switch (p.h) {
                case 1:
                  return (p.j = 2), w(p, h.i(h.name, h.options.version, d), 4);
                case 4:
                  k = p.i;
                  a: {
                    var r = u(Object.keys(h.options.za));
  ...
  var Li = new Ki("YtIdbMeta", {
    za: { databases: !0 },
    upgrade: function (a, b) {
      1 > b && ui(a, "databases", { keyPath: "actualName" });
    },
  });
  function Mi(a) {
    return J(this, function c() {
      ...
      return x(c, function (e) {
        if (1 == e.h) return w(e, Li.open(), 2);
        d = e.i;
        return e.return(
          si(d, ["databases"], { H: !0, mode: "readwrite" }, function (f) {
            var g = ti(f, "databases");
            return g.get(a.actualName).then(function (h) {
              if (
                ...
                return Y(g.h.put(a, void 0)).then(function () {});
            });
          })
        );
      });
      ...
      return x(c, function (f) {
        return 1 == f.h
          ...
          ? ((e = f.i),
            w(
              f,
              si(e, ["databases"], { H: !0, mode: "readonly" }, function (g) {
                d.length = 0;
                return Ci(ti(g, "databases"), {}, function (h) {
    ...
    return J(this, function b() {
      ...
      return x(b, function (h) {
        switch (h.h) {
          case 1:
            if (
              Q("ytidb_is_supported_cache_success_result") &&
              ((c = Sh()), null === c || void 0 === c ? 0 : c.hasSucceededOnce)
            )
              return h.return(new Th(!0));
            var k;
            if ((k = rg))
              (k = /WebKit\/([0-9]+)/.exec(Lb)),
                (k = !!(k && 600 <= parseInt(k[1], 10)));
            k &&
              ((k = /WebKit\/([0-9]+)/.exec(Lb)),
              (k = !(k && 602 <= parseInt(k[1], 10))));
            if (k)
              return h.return(
                Vh(Error("YtIdb is not supported on iOS 8 or 9"))
              );
            if (fc)
              return h.return(Vh(Error("YtIdb is not supported on Edge")));
            try {
              if (
                ((d = self),
                !(
                ...
                return h.return(
                  Vh(Error("Non-prefixed indexedDB APIs are missing"))
                );
            } catch (l) {
              return h.return(Vh(l));
            }
            if (
              !(
              ...
              return h.return(
                Vh(
                  Error("IDBTransaction.prototype.objectStoreNames is missing")
                )
              );
            h.j = 2;
            e = {
            ...
            return w(h, Mi(e), 4);
          case 4:
            return w(h, Ni("yt-idb-test-do-not-use"), 5);
          case 5:
            return h.return(new Th(!0));
          case 2:
            f = sa(h);
            ...
            return w(h, Oi(), 9);
          case 9:
            return (g = h.i), h.return(Vh(f, g));
          case 7:
            return sa(h), h.return(Vh(f));
          case 6:
            return h.return(Vh(f));
        }
      });
    });
  }
  function Ti() {
    if (void 0 !== Ri) return Ri;
    Oh = !0;
    return (Ri = Si().then(function (a) {
      Oh = !1;
      a.log();
      ...
      return x(g, function (l) {
        switch (l.h) {
          case 1:
            return w(
              l,
              Wi({ caller: "openDbImpl", publicName: a, version: b }),
              2
            );
          case 2:
            return (
              Xh(a),
              c
                ? (h = { actualName: a, publicName: a, userIdentifier: void 0 })
                : (h = Ui()),
              (h.clearDataOnAuthChange =
          ...
          case 5:
            return w(l, Ii(h.actualName, b, d), 6);
          case 6:
            return l.return(l.i);
          case 3:
            return (k = sa(l)), (l.j = 7), w(l, Ni(h.actualName), 9);
          case 9:
            l.h = 8;
            l.j = 0;
            break;
  ...
  function Wi(a) {
    return J(this, function c() {
      var d;
      return x(c, function (e) {
        if (1 == e.h) return w(e, Ti(), 2);
        if (!e.i)
          throw ((d = new V("IDB_NOT_SUPPORTED", { context: a })), Ph(d), d);
        e.h = 0;
      });
    });
  }
  ...
  function Zi(a, b) {
    ...
    return J(this, function d() {
      ...
      return x(d, function (f) {
        if (1 == f.h) return w(f, Ti(), 2);
        if (3 != f.h) {
          if (!f.i) return f.return();
          Xh(a);
          e = Ui();
          return w(f, Ji(e.actualName, b), 3);
        }
        return w(f, Ni(e.actualName), 0);
      });
    });
  }
  function $i(a, b) {
    ...
    a = a.map(function (d) {
      return J(c, function f() {
        return x(f, function (g) {
          return 1 == g.h
            ? w(g, Ji(d.actualName, b), 2)
            : w(g, Ni(d.actualName), 0);
        });
      });
    });
  ...
  cj.prototype.delete = function (a) {
    a = void 0 === a ? {} : a;
    return (this.options.Ca ? bj : Zi)(this.name, a);
  };
  function dj(a) {
    var b;
    return function () {
      b || (b = new cj("LogsDatabaseV2", a));
      return b;
    };
  }
  function ej() {
  ...
  function gj() {
    if (!fj) {
      ...
      fj = dj({
        za:
          ((a.LogsRequestsStore = !0),
          (a.sapisid = !0),
          (a.SWHealthLog = !0),
          a),
        Ca: !Q("nwl_use_ytidb_partitioning"),
        upgrade: function (b, c) {
          2 > c &&
            (ui(b, "LogsRequestsStore", {
              keyPath: "id",
              autoIncrement: !0,
            }).h.createIndex(
              "newRequest",
        ...
        switch (k.h) {
          ...
          case 3:
            return (
              ...
              w(k, wi(f, "LogsRequestsStore", g), 4)
            );
          case 4:
            return (h = k.i), (d.kb = T()), jj(d), k.return(h);
        }
      });
    });
  }
      ...
      return x(c, function (p) {
        switch (p.h) {
          ...
          case 2:
            return (
              (e = p.i),
              (f = F("INNERTUBE_CONTEXT_CLIENT_NAME", 0)),
              (g = [a, e, f, 0]),
              (h = [a, e, f, T()]),
              (k = IDBKeyRange.bound(g, h)),
              w(p, gj(), 3)
            );
          case 3:
            return (
              ...
              w(
                ...
                si(
                  ...
                  function (r) {
                    return Fi(
                      ti(r, "LogsRequestsStore").index("newRequest"),
                      { query: k, direction: "prev" },
                      function (q) {
                        q.getValue() &&
                          ((n = q.getValue()),
                          "NEW" === a && ((n.status = "QUEUED"), q.update(n)));
                      }
                    );
                  }
                ),
      ...
      return x(c, function (e) {
        ...
        return e.return(
          si(
            ...
            { mode: "readwrite", H: !0 },
            function (f) {
              var g = ti(f, "LogsRequestsStore");
              return g.get(a).then(function (h) {
                if (h)
                  return (
                    (h.status = "QUEUED"),
                    Y(g.h.put(h, void 0)).then(function () {
                      return h;
                    })
                  );
              });
          ...
          return (
            ...
            w(
              ...
              si(
                ...
                { mode: "readwrite", H: !0 },
                function (f) {
                  return Ci(ti(f, "LogsRequestsStore"), {}, function (g) {
                    if (g.getValue().timestamp <= d)
                      return g.delete().then(function () {
                        return g.continue();
                      });
                  });
                }
        ...
        Q("web_clean_sw_logs_store")
          ? (e = w(
              ...
              si(
                ...
                { mode: "readwrite", H: !0 },
                function (f) {
                  return Ci(ti(f, "SWHealthLog"), {}, function (g) {
                    if (g.getValue().timestamp <= d)
                      return g.delete().then(function () {
                        return g.continue();
                      });
  ...
  function rj() {
    return J(this, function b() {
      return x(b, function (c) {
        return 1 == c.h ? w(c, aj(), 2) : w(c, bj("LogsDatabaseV2"), 0);
      });
    });
  }
  function ij() {
      ...
      return x(b, function (d) {
        if (1 == d.h) {
          ...
          f &&
            ...
            (f = void 0),
            void 0 === f &&
              ((f = Number(F("SESSION_INDEX", 0))), (f = isNaN(f) ? 0 : f)),
            (e["X-Goog-AuthUser"] = f),
            "INNERTUBE_HOST_OVERRIDE" in ef ||
              (e["X-Origin"] = window.location.origin),
            Q("pageid_as_header_web") &&
              "DELEGATED_SESSION_ID" in ef &&
              (e["X-Goog-PageId"] = F("DELEGATED_SESSION_ID")));
          e instanceof O || ((f = new O(Ga)), we(f, 2, e), (e = f));
          return w(d, e, 2);
        }
        c = d.i;
        e = d.return;
  ...
  function sj(a) {
    return J(this, function c() {
      ...
      return x(c, function (e) {
        if (1 == e.h) return w(e, gj(), 2);
        d = e.i;
        return w(e, wi(d, "sapisid", a, "sapisid"), 0);
      });
    });
  }
  function tj() {
  ...
  function jj(a) {
    var b = pf("nwl_latency_sampling_rate", 0.01);
    0.02 < b ||
      (Math.random() <= b && Fh("nwl_transaction_latency_payload", a));
  }
  var uj = ["__Secure-1PAPISID", "SAPISID", "__Secure-3PAPISID"];
  function vj() {
    for (var a = u(uj), b = a.next(); !b.done; b = a.next())
      if ((b = Xc.get(b.value))) return b;
    return "LOGGED_OUT";
  }
  function wj() {
    me.call(this);
  ...
  wj.prototype.verifyUser = function () {
    var a = xj(this),
      b = a.Ua;
    if (!a.ib) return zj(this), !0;
    ne(this, "ytsessionchange");
    b && ne(this, "ytuserinvalid");
    zj(this);
    return !1;
  };
  function xj(a) {
    var b = uj.map(function (e) {
        var f;
        return null !== (f = Xc.get(e)) && void 0 !== f ? f : "";
      }),
  ...
  function Ej() {
    ...
    this.j = Fj();
    this.l = Q("validate_network_status");
    Gj(this);
    Hj(this);
  }
  v(Ej, me);
    ...
    window.addEventListener("online", function () {
      return J(a, function c() {
        ...
        return x(c, function (e) {
          ...
          2 != e.h && (d.j = e.i);
          d.m && d.j && ne(d, "ytnetworkstatus-online");
          Jj(d);
          if (d.A && Q("offline_error_handling")) {
            var f = Cj().get("errors", !0);
            if (f) {
              for (var g in f)
                if (f[g]) {
                  var h = new Wh(g, "sent via offline_errors");
                  h.name = f[g].name;
                  h.stack = f[g].stack;
                  h.level = f[g].level;
                  kf(h);
                }
              Cj().set("errors", {}, 2592e3, !0);
            }
          }
          e.h = 0;
        });
    ...
    window.addEventListener("offline", function () {
      return J(a, function c() {
        ...
        return x(c, function (e) {
          ...
          2 != e.h && (d.j = e.i);
          d.m && !d.j && ne(d, "ytnetworkstatus-offline");
          Jj(d);
          e.h = 0;
        });
      });
  ...
  function Jj(a) {
    a.C &&
      (lf(new Wh("NetworkStatusManager state did not match poll", T() - 0)),
      (a.C = !1));
  }
  function Ij(a) {
    return J(a, function c() {
      ...
      return x(c, function (e) {
        switch (e.h) {
          case 1:
            return (
              (e.j = 2), w(e, fetch("/generate_204", { method: "HEAD" }), 4)
            );
          case 4:
            d = !0;
            e.h = 3;
    ...
    a.ea
      ? ((this.ea = a.ea),
        de(this.j, "ytnetworkstatus-online", function () {
          Lj(b, "publicytnetworkstatus-online");
        }),
        de(this.j, "ytnetworkstatus-offline", function () {
          Lj(b, "publicytnetworkstatus-offline");
        }))
      : (de(this.j, "ytnetworkstatus-online", function () {
  ...
  function Mj() {
    ...
    a.l ||
      a.j === Fj() ||
      lf(new Wh("NetworkStatusManager isOnline does not match window status"));
    return a.j;
  }
  function Lj(a, b) {
    a.ea
    ...
    J(this, function b() {
      ...
      return x(b, function (g) {
        switch (g.h) {
          ...
          case 2:
            (c = g.i) && (Pj = !0);
            d = Q("networkless_logging");
            if (c && d)
              return Q("nwl_use_ytidb_partitioning")
                ? w(g, bj("LogsDatabaseV2"), 8)
                : w(g, aj(), 8);
            if (!c) {
              g.h = 0;
              break;
          ...
          case 8:
            return (
              yj(),
              document.addEventListener("ytsessionchange", function () {
                Tj();
              }),
              w(g, tj(), 11)
            );
          ...
          case 12:
            if (
              !(
                Q("enable_nwl_cleaning_logic") &&
                Math.random() <= pf("nwl_cleaning_rate", 0.1)
              )
            ) {
              g.h = 14;
              break;
          ...
          case 14:
            ...
            Uj();
            Mj() && Vj();
            de(Nj(), "publicytnetworkstatus-online", Vj);
            de(Nj(), "publicytnetworkstatus-offline", Wj);
            if (!Q("networkless_immediately_drop_sw_health_store")) {
              g.h = 16;
              break;
            }
            return w(g, Xj(), 16);
          case 16:
            if (Q("networkless_immediately_drop_all_requests"))
              return w(g, rj(), 0);
            g.h = 0;
        }
      });
  ...
  function Yj(a, b) {
    function c(d) {
      var e = Mj();
      if (!Oj || !d || (e && Q("vss_networkless_bypass_write"))) jg(a, b);
      else {
        var f = {
          url: a,
          options: b,
        ...
        hj(f)
          .then(function (g) {
            f.id = g;
            (Mj() || Q("networkless_always_online")) && Zj(f);
          })
          .catch(function (g) {
            Zj(f);
            Mj() ? kf(g) : Dj(g);
    ...
    Qj ||
      (Qj = Ff(function () {
        return J(a, function c() {
          var d;
          return x(c, function (e) {
            if (1 == e.h) return w(e, kj("NEW"), 2);
            if (3 != e.h)
              return (d = e.i), d ? w(e, Zj(d), 3) : (Wj(), e.return());
            Qj = 0;
            Vj();
            e.h = 0;
          });
      ...
      return x(c, function (e) {
        switch (e.h) {
          case 1:
            ...
            return w(e, lj(a.id), 3);
          case 3:
            (d = e.i)
              ? (a = d)
              : lf(Error("The request cannot be found in the database."));
          case 2:
            if (bk(a, 2592e6)) {
              e.h = 4;
              break;
          ...
          case 4:
            ...
            if (
              ...
              f.options.postParams.requestTimeMs = Math.round(T());
            (a = f) && jg(a.url, a.options);
            e.h = 0;
        }
      });
    });
          ...
          if (1 == k.h)
            return (
              void 0 === (null === a || void 0 === a ? void 0 : a.id)
                ? ((k.h = 2), (k = void 0))
                : (k = 1 > a.sendCount ? w(k, mj(a.id), 6) : w(k, nj(a.id), 2)),
              k
            );
          2 != k.h &&
            Ff(function () {
  ...
  function dk(a) {
    var b = this;
    this.h = null;
    a ? (this.h = a) : qh() && (this.h = bh());
    Df(function () {
      yh(b);
    }, 5e3);
  }
  dk.prototype.isReady = function () {
    !this.h && qh() && (this.h = bh());
    return !!this.h;
  };
  function eh(a, b, c, d) {
    function e(r) {
      ...
      if (
        ...
        var A = g.onSuccess,
          G = g.onFetchSuccess;
        g.onSuccess = function (H, W) {
          xh(q);
          A(H, W);
        };
        c.onFetchSuccess = function (H, W) {
          xh(q);
          G(H, W);
        };
      }
      try {
        r && d.retry && !d.ya.bypassNetworkless
          ? ((g.method = "POST"),
            !d.ya.writeThenSend && Q("nwl_send_fast_on_unload")
              ? ak(p, g)
              : Yj(p, g))
          : ((g.method = "POST"),
    ...
    !F("VISITOR_DATA") &&
      ...
      0.01 > Math.random() &&
      lf(
        new Wh("Missing VISITOR_DATA when sending innertube request.", b, c, d)
      );
    if (!a.isReady()) {
      var f = new Wh("innertube xhrclient not ready", b, c, d);
      kf(f);
      throw f;
    }
    var g = {
    ...
    var n = { alt: "json" };
    (a.h.Qa && g.headers.Authorization) || (n.key = a.h.innertubeApiKey);
    var p = Yf("" + h + f, n || {}, !0);
    Oj
      ? Ti().then(function (r) {
          e(r);
  ...
  function ek(a, b, c) {
    c = void 0 === c ? {} : c;
    var d = dk;
    F("ytLoggingEventsDefaultDisabled", !1) && dk == dk && (d = null);
    gh(a, b, d, c);
  }
  var fk = [
    {
  ...
  function mk(a, b, c, d) {
    if (a)
      if (Array.isArray(a)) {
        ...
        for (
          d = 0;
          d < a.length && !(a[d] && ((e += nk(d, a[d], b, c)), 500 < e));
          d++
        );
        d = e;
          ...
          if (a[e]) {
            ...
            f =
              ...
              ("clickTrackingParams" !== f && "trackingParams" !== f)
                ? 0
                : (g = kk(atob(g.replace(/-/g, "+").replace(/_/g, "/"))))
                ? nk(f + ".ve", g, h, k)
                : 0;
            d += f;
            d += nk(e, a[e], b, c);
  ...
  var pk = new Set(),
    ...
    sk = 0,
    tk = [],
    uk = ["PhantomJS", "Googlebot", "TO STOP THIS SECURITY SCAN go/scan"];
  function vk(a) {
    wk(a, "WARNING");
  }
    ...
    if (
      ...
      if (a.hasOwnProperty("args") && a.args && a.args.length)
        for (
          var l = 0;
          l < a.args.length &&
          !((k = mk(a.args[l], "params." + l, c, k)), 500 <= k);
          l++
        );
      ...
      if (tk.length)
        for (
          l = 0;
          l < tk.length &&
          !((k = mk(tk[l], "params.context." + l, c, k)), 500 <= k);
          l++
        );
      navigator.vendor &&
      ...
      if ("IGNORED" === a.level) a = 0;
        ...
        a: {
          ...
          for (d = c.next(); !d.done; d = c.next())
            if (((d = d.value), l.message && l.message.match(d.Ck))) {
              a = d.weight;
              break a;
            }
          a = u(a.h);
          ...
          for (e = u(c.na[l.name]), d = e.next(); !d.done; d = e.next())
            if (((f = d.value), (d = l.message.match(f.regexp)))) {
              ...
              for (g = 0; g < e.length; g++)
                (f[e[g]] = d[g + 1]),
                  (l.params["params.error." + e[g]] = d[g + 1]);
              l.message = c.wa(f);
              break;
            }
      l.params || (l.params = {});
      ...
      if (0 !== l.sampleWeight && !pk.has(l.message)) {
        "ERROR" === b
          ? (jk.P("handleError", l),
            Q("record_app_crashed_web") &&
              ...
              1 === l.sampleWeight &&
              (sk++,
              ek("appCrashed", { appCrashType: "APP_CRASH_TYPE_BREAKPAD" })),
            rk++)
          : "WARNING" === b && jk.P("handleWarning", l);
        if (Q("kevlar_gel_error_routing")) {
          a = b;
          b: {
            c = u(uk);
            for (d = c.next(); !d.done; d = c.next())
              if (sg(d.value.toLowerCase())) {
                c = !0;
                break b;
              }
            c = !1;
          ...
          if (c) c = void 0;
            ...
            d = { stackTrace: l.stack };
            l.fileName && (d.filename = l.fileName);
            c =
              l.lineNumber && l.lineNumber.split ? l.lineNumber.split(":") : [];
            0 !== c.length &&
              (1 !== c.length || isNaN(Number(c[0]))
                ? 2 !== c.length ||
                  isNaN(Number(c[0])) ||
                  isNaN(Number(c[1])) ||
                  ((d.lineNumber = Number(c[0])),
                  (d.columnNumber = Number(c[1])))
                : (d.lineNumber = Number(c[0])));
            c = {
            ...
            "ERROR" === a
              ? (c.level = "ERROR_LEVEL_ERROR")
              : "WARNING" === a && (c.level = "ERROR_LEVEL_WARNNING");
            d = { isObfuscated: !0, browserStackInfo: d };
            ...
            c = { errorMetadata: e, stackTrace: d, logMessage: c };
          }
          c &&
            (ek("clientError", c),
            ("ERROR" === a || Q("errors_flush_gel_always_killswitch")) && Xg());
        }
        if (!Q("suppress_error_204_logging")) {
          ...
          if (b.postParams) {
            ...
            c = u(Object.keys(a));
            for (d = c.next(); !d.done; d = c.next())
              (d = d.value), (b.postParams["client." + d] = a[d]);
            if ((a = F("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS", void 0)))
              for (c = u(Object.keys(a)), d = c.next(); !d.done; d = c.next())
                (d = d.value), (b.postParams[d] = a[d]);
            a = F("SERVER_NAME", void 0);
            c = F("SERVER_VERSION", void 0);
            a &&
              c &&
              ((b.postParams["server.name"] = a),
              (b.postParams["server.version"] = c));
          }
          jg(F("ECATCHER_REPORT_HOST", "") + "/error_204", b);
        }
        pk.add(l.message);
        qk++;
      }
  ...
  function xk(a, b) {
    for (var c = [], d = 1; d < arguments.length; ++d) c[d - 1] = arguments[d];
    a.args || (a.args = []);
    a.args.push.apply(a.args, c instanceof Array ? c : fa(u(c)));
  }
  var yk = {
    Qb: 29434,
    Sb: 3611,
    ...
    this.A = function (e) {
      a: if (
        ...
        if (
          ...
          switch (f.event) {
            case "listening":
              "null" != e.origin && (d.l = d.C = e.origin);
              d.j = e.source;
              d.sessionId = f.id;
              d.i && (d.i(), (d.i = null));
              break;
  ...
  function Ak() {
    ...
    this.isReady = !1;
    this.o = {};
    var a = (this.i = new zk(!!F("WIDGET_ID_ENFORCE"))),
      b = this.Ya.bind(this);
    a.m = b;
    a.u = null;
  ...
  m.Ya = function (a, b, c) {
    "addEventListener" === a && b
      ? ((a = b[0]),
        this.o[a] ||
          "onReady" === a ||
          (this.addEventListener(a, Bk(this, a)), (this.o[a] = !0)))
      : this.oa(a, b, c);
  };
  m.oa = function () {};
  function Bk(a, b) {
  ...
  function Hk(a) {
    ...
    this.h = a;
    this.j = [];
    this.addEventListener("onReady", C(this.Va, this));
    this.addEventListener("onVideoProgress", C(this.fb, this));
    this.addEventListener("onVolumeChange", C(this.gb, this));
    this.addEventListener("onApiChange", C(this.Za, this));
    this.addEventListener("onPlaybackQualityChange", C(this.bb, this));
    this.addEventListener("onPlaybackRateChange", C(this.cb, this));
    this.addEventListener("onStateChange", C(this.eb, this));
    this.addEventListener("onWebglSettingsChanged", C(this.hb, this));
  }
  v(Hk, Ak);
  m = Hk.prototype;
  m.oa = function (a, b, c) {
    if (this.h.isExternalMethodAvailable(a, c)) {
      ...
      if (0 < b.length && Dk(a)) {
        var d = b;
        if (Ka(d[0]) && !Array.isArray(d[0])) d = d[0];
        else {
          var e = {};
          switch (a) {
            case "loadVideoById":
      ...
      Dk(a) && Ck(this, this.ja());
    }
  };
  m.Va = function () {
    var a = this.Ja.bind(this);
    this.i.i = a;
  };
  ...
  m.bb = function (a) {
    Ck(this, { playbackQuality: a });
  };
  m.cb = function (a) {
    Ck(this, { playbackRate: a });
  };
  m.Za = function () {
    for (
  ...
  m.gb = function () {
    Ck(this, { muted: this.h.isMuted(), volume: this.h.getVolume() });
  };
  m.fb = function (a) {
    a = {
      currentTime: a,
  ...
  m.dispose = function () {
    Ak.prototype.dispose.call(this);
    ...
    return Ce(
      new O(function (c, d) {
        ...
        a.onError = function (e) {
          d(new Kk("Unknown request error", "net.unknown", e));
        };
        a.onTimeout = function (e) {
          d(new Kk("Request timed out", "net.timeout", e));
        };
        b = jg("//googleads.g.doubleclick.net/pagead/id", a);
      }),
      function (c) {
        c instanceof De && b.abort();
        return Ae(c);
      }
    );
  }
  ...
  Lk.prototype.then = function (a, b, c) {
    return 1 === this.i && a
      ? ((a = a.call(c, this.h)), ve(a) ? a : Mk(a))
      : 2 === this.i && b
      ? ((a = b.call(c, this.h)), ve(a) ? a : Nk(a))
      : this;
  };
  Lk.prototype.getValue = function () {
    return this.h;
  };
  Lk.prototype.$goog_Thenable = !0;
  function Nk(a) {
    var b = new Lk();
    a = void 0 === a ? null : a;
    b.i = 2;
  ...
  function Ok(a) {
    ...
    this.isMissing = a instanceof Pk;
    this.isTimeout = a instanceof Kk && "net.timeout" == a.errorCode;
    this.isCanceled = a instanceof De;
  }
  v(Ok, Ta);
  Ok.prototype.name = "BiscottiError";
  function Pk() {
    Ta.call(this, "Biscotti ID is missing from server");
  }
  v(Pk, Ta);
  Pk.prototype.name = "BiscottiMissingError";
  var Jk = { format: "RAW", method: "GET", timeout: 5e3, withCredentials: !0 },
    Qk = null;
  function Pf() {
    if (Q("disable_biscotti_fetch_on_html5_clients"))
      return Ae(Error("Fetching biscotti ID is disabled."));
    if (
      Q("condition_biscotti_fetch_on_consent_cookie_html5_clients") &&
      !Xc.get("CONSENT", "").startsWith("YES+")
    )
      return Ae(Error("User has not consented - not fetching biscotti id."));
    if ("1" == jb())
      return Ae(Error("Biscotti ID is not available in private embed mode"));
    Qk ||
      (Qk = Ce(Ik().then(Rk), function (a) {
        return Sk(2, a);
      }));
    return Qk;
  }
  function Rk(a) {
    a = a.responseText;
    if (0 != a.lastIndexOf(")]}'", 0)) throw new Pk();
    a = JSON.parse(a.substr(4));
    if (1 < (a.type || 1)) throw new Pk();
    a = a.id;
    Qf(a);
    Qk = Mk(a);
    Tk(18e5, 2);
  ...
  function Xk() {
    a: {
      ...
      if (Wk)
        for (a = 1, b = 0; b < Wk.length; b++)
          (d[a % 16] = d[a % 16] ^ (d[(a - 1) % 16] / 4) ^ Wk.charCodeAt(b)),
            a++;
    }
    a = [];
  ...
  var Yk,
    Zk = y.ytLoggingDocDocumentNonce_;
  Zk || ((Zk = Xk()), Ra("ytLoggingDocDocumentNonce_", Zk));
  Yk = Zk;
  var $k = {
    Ud: 0,
    Tb: 1,
  ...
  function bl(a) {
    return new al({ trackingParams: a });
  }
  al.prototype.getAsJson = function () {
    var a = {};
  ...
  al.prototype.isClientVe = function () {
  ...
  function el(a) {
    return F(dl(void 0 === a ? 0 : a), void 0);
  }
  z("yt_logging_screen.getRootVeType", el, void 0);
  function fl(a) {
    return (a = el(void 0 === a ? 0 : a))
      ? new al({ veType: a, youtubeData: void 0 })
      : null;
  }
  function gl() {
    var a = F("csn-to-ctt-auth-info");
    a || ((a = {}), ff("csn-to-ctt-auth-info", a));
    return a;
  }
  function hl(a) {
    a = void 0 === a ? 0 : a;
  ...
  z("yt_logging_screen.getCurrentCsn", hl, void 0);
  function il(a, b, c) {
    var d = gl();
    (c = hl(c)) && delete d[c];
    b && (d[a] = b);
  ...
  z("yt_logging_screen.getCttAuthInfo", jl, void 0);
  function kl(a, b, c, d) {
    c = void 0 === c ? 0 : c;
    if (a !== F(cl(c)) || b !== F(dl(c)))
      il(a, d, c),
        ff(cl(c), a),
        ff(dl(c), b),
        (b = function () {
          setTimeout(function () {
            a &&
              gh(
                ...
                { clientDocumentNonce: Yk, clientScreenNonce: a },
                dk
              );
          }, 0);
        }),
  ...
  z("yt_logging_screen.setCurrentScreen", kl, void 0);
  function ll(a) {
    zh.call(this, 1, arguments);
    this.csn = a;
  }
  v(ll, zh);
  var Ih = new Ah("screen-created", ll),
    ml = [],
    ol = nl,
    pl = 0;
  function ql(a, b, c, d) {
    ...
    for (var e = d.next(); !e.done; e = d.next())
      (e = e.value.getAsJson()),
        (hb(e) || (!e.trackingParams && !e.veType)) &&
          vk(Error("Child VE logged with no data"));
    d = { D: jl(b), N: b };
    "UNDEFINED_CSN" == b
      ? rl("visualElementAttached", c, d)
      : a
      ? gh("visualElementAttached", c, a, d)
      : ek("visualElementAttached", c, d);
  }
  function nl() {
  ...
  function rl(a, b, c) {
    ml.push({ payloadName: a, payload: b, options: c });
    pl || (pl = Jh());
  }
  function Kh(a) {
    if (ml) {
      for (var b = u(ml), c = b.next(); !c.done; c = b.next())
        (c = c.value),
          c.payload &&
            ((c.payload.csn = a.csn),
            gh(c.payloadName, c.payload, null, c.options));
      ml.length = 0;
    }
    pl = 0;
  }
  ...
  function xl(a, b) {
    ...
    for (var c = b.next(); !c.done; c = b.next())
      (c = c.value),
        ul(c) ? a.push(vl({}, c)) : wl(c) ? a.push(xl([], c)) : a.push(c);
    return a;
  }
  function ul(a) {
  ...
  v(zl, zh);
  var Al = new Ah("aft-recorded", yl),
    Bl = new Ah("timing-sent", zl);
  var Cl = window;
  function Dl() {
    this.timing = {};
  ...
  var El =
    ...
    Cl.mozPerformance ||
    Cl.msPerformance ||
    Cl.webkitPerformance ||
    new Dl();
  var Fl = !1;
  C(
    El.clearResourceTimings ||
      El.webkitClearResourceTimings ||
      El.mozClearResourceTimings ||
      El.msClearResourceTimings ||
      El.oClearResourceTimings ||
      Ga,
    El
  );
  function Gl(a) {
  ...
  function Il(a) {
    var b;
    (b = B("ytcsi." + (a || "") + "data_")) ||
      ((b = { tick: {}, info: {} }), Ra("ytcsi." + (a || "") + "data_", b));
    return b;
  }
  function Jl(a) {
    a = Il(a);
  ...
  function Ll(a) {
    var b = Hl(a || ""),
      c = Gl(a);
    c && !Fl && (Fh(Al, new yl(Math.round(c - b._start), a)), (Fl = !0));
  }
  function Ml() {
    var a = B("ytcsi.debug");
    a ||
  ...
  var Ol = y.ytLoggingLatencyUsageStats_ || {};
  z("ytLoggingLatencyUsageStats_", Ol, void 0);
  function Pl() {
    this.h = 0;
  }
  function Ql() {
  ...
  Pl.prototype.tick = function (a, b, c) {
    Rl(this, "tick_" + a + "_" + b) ||
      ek(
        "latencyActionTicked",
  ...
  Pl.prototype.info = function (a, b) {
    var c = Object.keys(a).join("");
    Rl(this, "info_" + c + "_" + b) ||
      ((a = Object.assign({}, a)),
      (a.clientActionNonce = b),
      ek("latencyActionInfo", a));
  };
  Pl.prototype.span = function (a, b) {
    var c = Object.keys(a).join("");
    Rl(this, "span_" + c + "_" + b) ||
      ((a.clientActionNonce = b), ek("latencyActionSpan", a));
  };
  function Rl(a, b) {
    Ol[b] = Ol[b] || { count: 0 };
    var c = Ol[b];
    ...
    a.h ||
      (a.h = Df(function () {
        var d = T(),
          e;
        for (e in Ol) Ol[e] && 6e4 < d - Ol[e].time && delete Ol[e];
        a && (a.h = 0);
      }, 5e3));
    return 5 < c.count
      ? (6 === c.count &&
  ...
  var Z = {},
    Sl =
      ...
      (Z.yt_abt = "adBreakType"),
      (Z.ad_cpn = "adClientPlaybackNonce"),
      (Z.ad_docid = "adVideoId"),
      (Z.yt_ad_an = "adNetworks"),
      (Z.ad_at = "adType"),
      (Z.aida = "appInstallDataAgeMs"),
      (Z.browse_id = "browseId"),
      (Z.p = "httpProtocol"),
      (Z.t = "transportProtocol"),
      (Z.cpn = "clientPlaybackNonce"),
      (Z.ccs = "creatorInfo.creatorCanaryState"),
      (Z.csn = "clientScreenNonce"),
      (Z.docid = "videoId"),
      (Z.GetHome_rid = "requestIds"),
      (Z.GetSearch_rid = "requestIds"),
      (Z.GetPlayer_rid = "requestIds"),
      (Z.GetWatchNext_rid = "requestIds"),
      (Z.GetBrowse_rid = "requestIds"),
      (Z.GetLibrary_rid = "requestIds"),
      (Z.is_continuation = "isContinuation"),
      (Z.is_nav = "isNavigation"),
      (Z.b_p = "kabukiInfo.browseParams"),
      ...
      (Z.voz_type = "kabukiInfo.vozType"),
      (Z.yt_lt = "loadType"),
      (Z.mver = "creatorInfo.measurementVersion"),
      (Z.yt_ad = "isMonetized"),
      (Z.nr = "webInfo.navigationReason"),
      (Z.nrsu = "navigationRequestedSameUrl"),
      (Z.ncnp = "webInfo.nonPreloadedNodeCount"),
      (Z.pnt = "performanceNavigationTiming"),
      (Z.prt = "playbackRequiresTap"),
      (Z.plt = "playerInfo.playbackType"),
      (Z.pis = "playerInfo.playerInitializedState"),
      (Z.paused = "playerInfo.isPausedOnLoad"),
      (Z.yt_pt = "playerType"),
      (Z.fmt = "playerInfo.itag"),
      (Z.yt_pl = "watchInfo.isPlaylist"),
      (Z.yt_pre = "playerInfo.preloadType"),
      (Z.yt_ad_pr = "prerollAllowed"),
      (Z.pa = "previousAction"),
      (Z.yt_red = "isRedSubscriber"),
      (Z.rce = "mwebInfo.responseContentEncoding"),
      (Z.scrh = "screenHeight"),
      (Z.scrw = "screenWidth"),
      (Z.st = "serverTimeMs"),
      (Z.ssdm = "shellStartupDurationMs"),
      ...
      (Z.label = "tvInfo.label"),
      (Z.is_mdx = "tvInfo.isMdx"),
      ...
      (Z.yt_vst = "videoStreamType"),
      (Z.vph = "viewportHeight"),
      (Z.vpw = "viewportWidth"),
      (Z.yt_vis = "isVisible"),
      (Z.rcl = "mwebInfo.responseContentLength"),
      (Z.GetSettings_rid = "requestIds"),
      (Z.GetTrending_rid = "requestIds"),
      (Z.GetMusicSearchSuggestions_rid = "requestIds"),
      (Z.REQUEST_ID = "requestIds"),
      Z),
    Tl =
    ...
    Ul = {},
    Vl =
      ((Ul.ccs = "CANARY_STATE_"),
      (Ul.mver = "MEASUREMENT_VERSION_"),
      (Ul.pis = "PLAYER_INITIALIZED_STATE_"),
      (Ul.yt_pt = "LATENCY_PLAYER_"),
      (Ul.pa = "LATENCY_ACTION_"),
      (Ul.yt_vst = "VIDEO_STREAM_TYPE_"),
      Ul),
    Wl =
  ...
  function Xl(a) {
    return !!F("FORCE_CSI_ON_GEL", !1) || Q("csi_on_gel") || !!Il(a).useGel;
  }
  function Yl(a) {
    a = Il(a);
    if (a.gel) {
    ...
    if (null !== b)
      if (((Jl(c)[a] = b), Xl(c))) {
        ...
        if (a in Sl) {
          b = Sl[a];
          0 <= Wa(Tl, b) && (d = !!d);
          a in Vl && "string" === typeof d && (d = Vl[a] + d.toUpperCase());
          a = d;
          d = b.split(".");
          ...
          0 <= Wa(Wl, a) || vk(new Wh("Unknown label logged with GEL CSI", a)),
            (f = void 0);
        f &&
          Xl(c) &&
          ((b = Nl(c || "")),
  ...
  function $l(a, b, c) {
    ...
    if (!e) {
      if (
        !B("yt.timing." + (c || "") + "pingSent_") &&
        ((f = F((c || "") + "TIMING_ACTION", void 0)),
        (e = Hl(c)),
        B("ytglobal.timing" + (c || "") + "ready_") &&
          f &&
          "_start" in Hl(void 0) &&
          Gl(c))
      )
  ...
  function am(a) {
    if (!Xl(a)) {
      var b = Hl(a),
        ...
        f = { v: 2, s: e, action: F((a || "") + "TIMING_ACTION", void 0) },
        g = c.srt;
      ...
      window.navigator &&
      window.navigator.sendBeacon &&
      (b || Q("always_send_csi_204_with_beacon"))
        ? yg(f)
        : vg(f);
      z("yt.timing." + (a || "") + "pingSent_", !0, void 0);
      Fh(Bl, new zl(n.aft + (Number(g) || 0), a));
    }
  }
  var bm = window;
  bm.ytcsi && ((bm.ytcsi.info = Zl), (bm.ytcsi.tick = $l));
  function cm() {
    this.l = [];
    this.o = [];
    this.h = [];
    ...
    b.then(function (d) {
      ...
      g &&
        ...
        (null === (e = d.response) || void 0 === e ? 0 : e.trackingParams) &&
          ql(a.client, g, h, [bl(d.response.trackingParams)]),
        (null === (f = d.playerResponse) || void 0 === f
          ? 0
          : f.trackingParams) &&
          ql(a.client, g, h, [bl(d.playerResponse.trackingParams)]));
    });
  }
  function em(a, b, c, d) {
    d = void 0 === d ? 0 : d;
    if (a.i.has(d)) a.l.push([b, c]);
      ...
      var e = hl(d);
      c = c || fl(d);
      e && c && ql(a.client, e, c, [b]);
    }
  }
  cm.prototype.clickCommand = function (a, b, c) {
    c = hl(void 0 === c ? 0 : c);
    if (!a.clickTrackingParams || !c) return !1;
    var d = this.client;
    var e = "INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK";
    a = { csn: c, ve: bl(a.clickTrackingParams).getAsJson(), gestureType: e };
    b && (a.clientData = b);
    b = { D: jl(c), N: c };
    "UNDEFINED_CSN" == c
      ? rl("visualElementGestured", a, b)
      : d
      ? gh("visualElementGestured", a, d, b)
      : ek("visualElementGestured", a, b);
    return !0;
  };
  function fm(a, b, c) {
    c = void 0 === c ? {} : c;
    ...
    a.j = function () {
      ...
      if (f) {
        for (var g = u(a.l), h = g.next(); !h.done; h = g.next())
          (h = h.value), em(a, h[0], h[1] || f, c.layer);
        f = u(a.o);
        for (g = f.next(); !g.done; g = f.next()) {
          ...
          h &&
            ...
            (l = { D: jl(h), N: h }),
            "UNDEFINED_CSN" == h
              ? rl("visualElementStateChanged", k, l)
              : g
              ? gh("visualElementStateChanged", k, g, l)
              : ek("visualElementStateChanged", k, l));
        }
      }
    };
    hl(c.layer) || a.j();
    if (c.ta)
      for (var d = u(c.ta), e = d.next(); !e.done; e = d.next())
        dm(a, e.value, c.layer);
    else wk(Error("Delayed screen needs a data promise."));
  }
  function gm(a, b, c) {
    c = void 0 === c ? {} : c;
    c.layer || (c.layer = 0);
    var d = void 0 !== c.Wa ? c.Wa : c.layer;
    var e = hl(d);
    d = fl(d);
    var f;
    d &&
    ...
    try {
      var g = a.client,
        ...
        p = {
          csn: n,
          pageVe: new al({ veType: b, youtubeData: void 0 }).getAsJson(),
        };
      h && h.visualElement
        ? (p.implicitGesture = {
        ...
        : h &&
          vk(
            new Wh("newScreen() parent element does not have a VE - rootVe", b)
          );
      k && (p.cloneCsn = k);
      k = { D: l, N: n };
      g ? gh("screenCreated", p, g, k) : ek("screenCreated", p, k);
      Fh(Ih, new ll(n));
      var r = n;
    } catch (q) {
      xk(q, {
    ...
    if (
      ...
      !(b = Q("screen_manager_skip_hide_killswitch"))
    ) {
      a: {
        b = u(Object.values($k));
    ...
    b &&
      ...
      (f = { D: jl(e), N: e, Ia: f }),
      "UNDEFINED_CSN" == e
        ? rl("visualElementHidden", d, f)
        : b
        ? gh("visualElementHidden", d, b, f)
        : ek("visualElementHidden", d, f));
    a.h[a.h.length - 1] &&
      !a.h[a.h.length - 1].csn &&
      (a.h[a.h.length - 1].csn = r || "");
    Zl("csn", r);
    sl.getInstance().clear();
    d = fl(c.layer);
    e &&
      "UNDEFINED_CSN" !== e &&
      d &&
      ...
      ((e = r),
      (r = Q("use_default_events_client") ? void 0 : dk),
      (b = { csn: e, ve: d.getAsJson(), eventType: 1 }),
      (f = { D: jl(e), N: e }),
      "UNDEFINED_CSN" == e
        ? rl("visualElementShown", b, f)
        : r
        ? gh("visualElementShown", b, r, f)
        : ek("visualElementShown", b, f));
    ...
    for (r = e.next(); !r.done; r = e.next())
      (r = u(r.value)),
        (b = r.next().value),
        r.next().value.has(c.layer) && d && em(a, b, d, c.layer);
  }
  function hm(a) {
    a &&
      (a.dataset
        ? (a.dataset[im("loaded")] = "true")
  ...
  function im(a) {
    return (
      km[a] ||
      (km[a] = String(a).replace(/\-([a-z])/g, function (b, c) {
        return c.toUpperCase();
      }))
    );
  }
  var lm = /\.vflset|-vfl[a-zA-Z0-9_+=-]+/,
    mm = /-[a-zA-Z]{2,3}_[a-zA-Z]{2,3}(?=(\/|$))/;
  function nm(a, b, c) {
    c = void 0 === c ? null : c;
  ...
  function om(a, b, c) {
    ...
    f
      ? b && b()
      : (b && ((f = Dg(d, b)), (b = "" + La(b)), (qm[b] = f)),
        g ||
          (e = rm(
            a,
            d,
            function () {
              jm(e, "loaded") || (hm(e), Gg(d), S(Qa(Hg, d), 0));
            },
            c
          )));
  }
  ...
  function sm(a) {
    ...
    b && (Hg(a), b.parentNode.removeChild(b));
  }
  function tm(a, b) {
    a && b && ((a = "" + La(b)), (a = qm[a]) && Fg(a));
  }
  function pm(a) {
  ...
  function wm() {
    if (
      !Q("disable_ad_status_on_html5_clients") &&
      (!Q("condition_ad_status_fetch_on_consent_cookie_html5_clients") ||
        Xc.get("CONSENT", "").startsWith("YES+")) &&
      "1" != jb()
    ) {
      var a = function () {
        vm = !0;
        "google_ad_status" in window ? ff("DCLKSTAT", 1) : ff("DCLKSTAT", 2);
      };
      try {
        nm("//static.doubleclick.net/instream/ad_status.js", a);
      } catch (b) {}
      um.push(
        Ff(function () {
          if (!(vm || "google_ad_status" in window)) {
            try {
              tm("//static.doubleclick.net/instream/ad_status.js", a);
            } catch (b) {}
            vm = !0;
            ff("DCLKSTAT", 3);
          }
  ...
  ym.prototype.initialize = function (a, b, c, d, e, f) {
    var g = this;
    f = void 0 === f ? !1 : f;
    b
      ? ((this.i = !0),
        nm(
          ...
          function () {
            ...
            (h ? window.trayride : window.botguard)
              ? zm(g, c, !!f, h, d)
              : (sm(b), vk(new Wh("Unable to load Botguard", "from " + b)));
          },
          e
        ))
      : a &&
        ((e = Ec(document, "SCRIPT")),
        (e.textContent = a),
        (e.nonce = Ca()),
        ...
        ((a = a.includes("trayride")) ? window.trayride : window.botguard)
          ? zm(this, c, !!f, a, d)
          : vk(Error("Unable to load Botguard from JS")));
  };
  function zm(a, b, c, d, e) {
    var f, g;
    if (
      (d = d
        ? null === (f = window.trayride) || void 0 === f
          ? void 0
          : f.ad
        : null === (g = window.botguard) || void 0 === g
        ? void 0
        : g.bg)
    )
      if (c)
    ...
    else vk(Error("Failed to finish initializing VM"));
  }
  ym.prototype.invoke = function (a) {
    a = void 0 === a ? {} : a;
    return this.h
      ? this.h.hasOwnProperty("hot")
        ? this.h.hot(void 0, void 0, a)
        : this.h.invoke(void 0, void 0, a)
      : null;
  };
  ...
  function Em(a) {
    ...
    this.started = !1;
    this.connection = a;
    this.connection.subscribe("command", this.Aa, this);
  }
  v(Em, L);
  m = Em.prototype;
  m.start = function () {
    this.started ||
      this.h ||
      ((this.started = !0), this.connection.R("RECEIVING"));
  };
  m.R = function (a, b) {
  ...
  m.addListener = function (a) {
    if (!(a in this.i)) {
      var b = this.ab.bind(this, a);
      this.i[a] = b;
      this.addEventListener(a, b);
    }
  };
  m.ab = function (a, b) {
    this.started && !this.h && this.connection.R(a, this.ia(a, b));
  };
  m.ia = function (a, b) {
  ...
  m.B = function () {
    ...
    a.h || Ne(a.i, "command", this.Aa, this);
  ...
  v(Hm, Em);
  Hm.prototype.addEventListener = function (a, b) {
    this.api.addEventListener(a, b);
  };
  Hm.prototype.removeEventListener = function (a, b) {
  ...
  Hm.prototype.ia = function (a, b) {
    ...
    return Em.prototype.ia.call(this, a, b);
  };
  Hm.prototype.B = function () {
    Em.prototype.B.call(this);
    delete this.api;
  };
  function Im(a) {
    a = void 0 === a ? !1 : a;
    L.call(this);
    this.i = new P(a);
    zd(this, Qa(xd, this.i));
  }
  D(Im, L);
  Im.prototype.subscribe = function (a, b, c) {
  ...
  v(Jm, Im);
  Jm.prototype.R = function (a, b) {
    this.h || this.j.R(this.destination, this.id, a, b);
  };
  Jm.prototype.B = function () {
    this.destination = this.j = null;
    Im.prototype.B.call(this);
  };
  function Km(a, b, c) {
    L.call(this);
    this.destination = a;
    this.origin = c;
    this.i = xf(window, "message", this.j.bind(this));
    this.connection = new Jm(this, a, b);
    zd(this, Qa(xd, this.connection));
  }
  v(Km, L);
  Km.prototype.R = function (a, b, c, d) {
    this.h ||
      a !== this.destination ||
      ((a = { id: b, command: c }),
      d && (a.data = d),
      this.destination.postMessage(pe(a), this.origin));
  };
  Km.prototype.j = function (a) {
    var b;
    if ((b = !this.h))
      if ((b = a.origin === this.origin))
        a: {
          b = this.destination;
          do {
            b: {
    ...
    if (b && ((b = a.data), "string" === typeof b)) {
      ...
      b.command &&
        ((c = this.connection),
        c.h || c.l("command", b.command, b.data, a.origin));
    }
  };
  ...
  Mm.prototype.clone = function () {
    ...
    for (b in this)
      if (this.hasOwnProperty(b)) {
        var c = this[b];
        "object" == Ia(c) ? (a[b] = lb(c)) : (a[b] = c);
      }
    return a;
  };
  var Nm = /cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;
  function Om(a) {
    a = a || "";
    if (window.spf) {
      var b = a.match(Nm);
  ...
  function Pm(a) {
    ...
    d ||
      (c && !d) ||
      (c = Rm(a, b, function () {
        jm(c, "loaded") || (hm(c), Gg(b), S(Qa(Hg, b), 0));
      }));
  }
  function Rm(a, b, c) {
  ...
  function Sm(a, b, c, d) {
    ...
    this.J = new P();
    this.i = {};
    this.L = this.Z = this.elementId = this.ga = this.config = null;
    this.K = !1;
    this.l = this.A = null;
    this.aa = {};
    this.Da = ["onReady"];
    ...
    this.T = 0;
    this.j = this.u = a;
    zd(this, Qa(xd, this.J));
    Tm(this);
    Um(this);
    zd(this, Qa(xd, this.Ea));
    c
      ? (this.T = S(function () {
  ...
  m.loadNewVideoConfig = function (a) {
    if (!this.h) {
      this.T && (Af(this.T), (this.T = 0));
      var b = a || {};
      b instanceof Mm || (b = new Mm(b));
      this.config = b;
      this.setConfig(a);
      Wm(this);
      this.isReady() && Xm(this);
    }
  };
  function Vm(a) {
    var b, c;
    a.webPlayerContextConfig
      ? (c = a.webPlayerContextConfig.rootElementId)
      : (c = a.config.attrs.id);
    a.elementId = c || a.elementId;
    "video-player" === a.elementId &&
      ((a.elementId = a.F),
      a.webPlayerContextConfig
        ? (a.webPlayerContextConfig.rootElementId = a.F)
        : (a.config.attrs.id = a.F));
    (null === (b = a.j) || void 0 === b ? void 0 : b.id) === a.elementId &&
      ((a.elementId += "-player"),
      a.webPlayerContextConfig
  ...
  m.setConfig = function (a) {
    ...
    this.Z ||
      (this.Z = Zm(
        this,
        (null === (b = this.config.args) || void 0 === b
          ? void 0
          : b.jsapicallback) || "onYouTubePlayerReady"
      ));
    this.config.args
      ? (this.config.args.jsapicallback = null)
      : (this.config.args = { jsapicallback: null });
    var c;
    if (null === (c = this.config) || void 0 === c ? 0 : c.attrs)
      (a = this.config.attrs),
        (c = a.width) && this.j && (this.j.style.width = Oc(Number(c) || c)),
        (a = a.height) && this.j && (this.j.style.height = Oc(Number(a) || a));
  };
  function Xm(a) {
    var b;
    a.config &&
      ...
      ("0" !== a.config.args.autoplay &&
        ...
        ? a.api.loadVideoByPlayerVars(
            null !== (b = a.config.args) && void 0 !== b ? b : null
          )
  ...
  function $m(a) {
    var b = !0,
      c = an(a);
    c && a.config && ((a = bn(a)), (b = jm(c, "version") === a));
    return b && !!B("yt.player.Application.create");
  }
  function Wm(a) {
    if (!a.h && !a.K) {
      var b = $m(a);
      if (b && "html5" === (an(a) ? "html5" : null))
        (a.L = "html5"), a.isReady() || cn(a);
      else if ((dn(a), (a.L = "html5"), b && a.l && a.u))
        a.u.appendChild(a.l), cn(a);
      else {
        a.config && (a.config.loaded = !0);
        var c = !1;
        a.A = function () {
          c = !0;
          var d = en(a, "player_bootstrap_method")
            ? B("yt.player.Application.createAlternate") ||
              B("yt.player.Application.create")
            : B("yt.player.Application.create");
          var e = a.config ? Ym(a.config) : void 0;
        ...
        b
          ...
          : (nm(bn(a), a.A),
            (b = fn(a)) && Om(b),
            gn(a) && !c && z("yt.player.Application.create", null, void 0));
      }
    }
  }
  function an(a) {
    var b = Ac(a.elementId);
    !b &&
      a.j &&
      a.j.querySelector &&
  ...
  function cn(a) {
    ...
    if (!a.h) {
      ...
      d
        ? ((a.K = !1),
          (!en(a, "html5_remove_not_servable_check_killswitch") &&
            (null === c || void 0 === c ? 0 : c.isNotServable) &&
            a.config &&
            (null === c || void 0 === c
              ? 0
              : c.isNotServable(
                  null === (b = a.config.args) || void 0 === b
                    ? void 0
                    : b.video_id
                ))) ||
            hn(a))
  ...
  function hn(a) {
    ...
    var b = an(a);
    if (b) {
      a.m = jn(a, b, "addEventListener");
      a.U = jn(a, b, "removeEventListener");
    ...
    return function (e) {
      ...
      try {
        ...
        "sendAbandonmentPing" !== c &&
          ((h.params = c), (a.lastError = h), lf(h));
      }
    };
  }
  function Tm(a) {
    a.fa = !1;
    if (a.U) for (var b in a.i) a.i.hasOwnProperty(b) && a.U(b, a.i[b]);
    for (var c in a.C) a.C.hasOwnProperty(c) && Af(Number(c));
    a.C = {};
    a.m = null;
    a.U = null;
    b = a.api;
  ...
  function Um(a) {
    a.addEventListener("WATCH_LATER_VIDEO_ADDED", function (b) {
      Gg("WATCH_LATER_VIDEO_ADDED", b);
    });
    a.addEventListener("WATCH_LATER_VIDEO_REMOVED", function (b) {
      Gg("WATCH_LATER_VIDEO_REMOVED", b);
    });
  ...
  m.removeEventListener = function (a, b) {
    this.h || ((b = Zm(this, b)) && Ne(this.J, a, b));
  };
  function Zm(a, b) {
    var c = b;
    if ("string" === typeof b) {
  ...
  m.getPlayerType = function () {
    return this.L || (an(this) ? "html5" : null);
  };
  ...
  function dn(a) {
    ...
    if (a.u) for (a = a.u; (b = a.firstChild); ) a.removeChild(b);
  }
  m.cancel = function () {
    this.A && tm(bn(this), this.A);
    Af(this.qa);
    this.K = !1;
  };
  m.B = function () {
    ...
    this.ga = this.config = this.api = null;
    delete this.u;
    delete this.j;
    L.prototype.B.call(this);
  };
  function gn(a) {
    ...
    a =
      null ===
        (c = null === (b = a.config) || void 0 === b ? void 0 : b.args) ||
      void 0 === c
        ? void 0
        : c.fflags;
  ...
  function en(a, b) {
    ...
    if (a.webPlayerContextConfig)
      var d = a.webPlayerContextConfig.serializedExperimentFlags;
    else if (null === (c = a.config) || void 0 === c ? 0 : c.args)
      d = a.config.args.fflags;
    return "true" === Tf(d || "", "&")[b];
  }
  function Ym(a) {
    for (
      ...
      d = d.value;
      var e = a[d];
      b[d] = "object" === typeof e ? lb(e) : e;
    }
    return b;
  }
  var ln = {},
    mn = "player_uid_" + ((1e9 * Math.random()) >>> 0);
  function nn(a, b, c) {
    var d = "player";
    c = void 0 === c ? !0 : c;
    d = "string" === typeof d ? Ac(d) : d;
    var e = mn + "_" + La(d),
      f = ln[e];
    if (f && c)
      return (
  ...
  function tn(a, b, c) {
    ...
    if (b) {
      ...
      if (0 <= Wa(f, g) || (!g && 0 == d.lastIndexOf("/", 0)))
        if (
          (Q("autoescape_tempdata_url") &&
            ((f = document.createElement("a")), Rb(f, d), (d = f.href)),
          d)
        ) {
          g = d.match(Vb);
          d = g[5];
          ...
          if ((d = 0 > f ? d : d.substr(0, f)))
            if (
              ...
              isFinite(k) &&
                0 < k &&
                ((e = b),
                (b = "ST-" + Ub(d).toString(36)),
                (e = e ? Zb(e) : ""),
                ih(b, e, k || 5));
            } else
              (k = b),
                (e = "ST-" + Ub(d).toString(36)),
                (k = k ? Zb(k) : ""),
                ih(e, k, 5);
        }
    }
    ...
    if ((window.ytspf || {}).enabled) spf.navigate(a);
      ...
      c = p.location;
      a = $b(a, l) + n;
      a = a instanceof Db ? a : Jb(a);
      c.href = Fb(a);
    }
    return !0;
  }
  z("yt.setConfig", ff, void 0);
  z("yt.config.set", ff, void 0);
  z("yt.setMsg", nf, void 0);
  z("yt.msgs.set", nf, void 0);
  z("yt.logging.errors.log", wk, void 0);
  z(
    "writeEmbed",
    function () {
      ...
      window !== window.top &&
        ...
        (a.args.loaderUrl = c);
      if (
        (c = F("WEB_PLAYER_CONTEXT_CONFIGS", void 0)) &&
      ...
      pn.addEventListener("onVideoDataChange", sn);
      ...
      F("ENABLE_JS_API")
        ...
        : F("ENABLE_POST_API") &&
          "string" === typeof a &&
          "string" === typeof b &&
          ((qn = new Km(window.parent, a, b)),
          (rn = new Hm(pn, qn.connection)));
      wm();
      F("EXPERIMENT_FLAGS").networkless_logging_web_embedded && Sj();
    },
    void 0
  );
  var un = jf(function () {
      $l("ol");
      var a = jh.getInstance(),
        b = !!((mh("f" + (Math.floor(119 / 31) + 1)) || 0) & 67108864),
        c = 1 < window.devicePixelRatio;
      if (document.body && Cd(document.body, "exp-invert-logo"))
        if (c && !Cd(document.body, "inverted-hdpi")) {
          var d = document.body;
          if (d.classList) d.classList.add("inverted-hdpi");
          else if (!Cd(d, "inverted-hdpi")) {
            var e = Ad(d);
            Bd(d, e + (0 < e.length ? " inverted-hdpi" : "inverted-hdpi"));
          }
        } else !c && Cd(document.body, "inverted-hdpi") && Dd();
      if (b != c) {
        b = "f" + (Math.floor(119 / 31) + 1);
        d = mh(b) || 0;
        d = c ? d | 67108864 : d & -67108865;
        0 == d ? delete U[b] : ((c = d.toString(16)), (U[b] = c.toString()));
        c = !0;
        Q("web_secure_pref_cookie_killswitch") && (c = !1);
        b = a.h;
        d = [];
        for (var f in U) d.push(f + "=" + encodeURIComponent(String(U[f])));
        ih(b, d.join("&"), 63072e3, a.i, c);
      }
      cm.h || (cm.h = new cm());
      a = cm.h;
      f = 16623;
      var g = void 0 === g ? {} : g;
      Object.values(yk).includes(f) ||
        (vk(new Wh("createClientScreen() called with a non-page VE", f)),
        (f = 83769));
      g.isHistoryNavigation || a.h.push({ rootVe: f, key: g.key || "" });
      a.l = [];
      a.o = [];
      g.ta ? fm(a, f, g) : gm(a, f, g);
    }),
    vn = jf(function () {
      pn && pn.sendAbandonmentPing && pn.sendAbandonmentPing();
      F("PL_ATT") && Bm.dispose();
      for (var a = 0, b = um.length; a < b; a++) If(um[a]);
      um.length = 0;
      sm("//static.doubleclick.net/instream/ad_status.js");
      vm = !1;
      ff("DCLKSTAT", 0);
      yd(rn, qn);
      pn && (pn.removeEventListener("onVideoDataChange", sn), pn.destroy());
    });
  window.addEventListener
    ? (window.addEventListener("load", un),
      window.addEventListener("unload", vn))
    : window.attachEvent &&
      (window.attachEvent("onload", un), window.attachEvent("onunload", vn));
  Ra(
    "yt.abuse.player.botguardInitialized",
    B("yt.abuse.player.botguardInitialized") || Cm
  );
  Ra(
    "yt.abuse.player.invokeBotguard",
    B("yt.abuse.player.invokeBotguard") || Dm
  );
  Ra(
    "yt.abuse.dclkstatus.checkDclkStatus",
    B("yt.abuse.dclkstatus.checkDclkStatus") || xm
  );
  Ra("yt.player.exports.navigate", B("yt.player.exports.navigate") || tn);
  Ra("yt.util.activity.init", B("yt.util.activity.init") || Kf);
  Ra(
    "yt.util.activity.getTimeSinceActive",
    B("yt.util.activity.getTimeSinceActive") || Nf
  );
  Ra("yt.util.activity.setTimestamp", B("yt.util.activity.setTimestamp") || Lf);
}.call(this));
