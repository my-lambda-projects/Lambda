...
(this.wp = this.wp || {}),
  (this.wp.i18n = (function (t) {
        ...
        function u(t, e) {
          ...
          for (r = 0; r < g; r++)
            if ("string" == typeof t[r]) h += t[r];
              ...
              if (
                (i.not_type.test(u.type) &&
                  i.not_primitive.test(u.type) &&
                ...
                : (!i.number.test(u.type) || (l && !u.sign)
                  ...
                  (c = u.pad_char
                    ? "0" === u.pad_char
                      ...
                      : u.pad_char.charAt(1)
                    : " "),
                  (p = u.width - (f + n).length),
                  (s = u.width && p > 0 ? c.repeat(p) : ""),
                  (h += u.align
                    ? f + n + s
                    : "0" === c
                    ? f + s + n
              ...
              if (e[2]) {
                ...
                for (a.push(c[1]); "" !== (u = u.substring(c[0].length)); )
                  if (null !== (c = i.key_access.exec(u))) a.push(c[1]);
                    ...
                    if (null === (c = i.index_access.exec(u)))
                      throw new SyntaxError(
                        "[sprintf] failed to parse named argument key"
                      );
                    a.push(c[1]);
    ...
    456: function (t, e, n) {
      ...
      var y = { contextDelimiter: "", onMissingKey: null };
      function v(t, e) {
        var n;
        ...
        (this.options = {}),
        y))
          this.options[n] = void 0 !== e && n in e ? e[n] : y[n];
      }
      function b(t, e) {
        var n = Object.keys(t);
      ...
      var _ = {
            ...
            i = function (t) {
              var e =
                arguments.length > 1 && void 0 !== arguments[1]
                  ? arguments[1]
                  : "default";
              (r.data[e] = x(x(x({}, _), r.data[e]), t)),
                (r.data[e][""] = x(x({}, _[""]), r.data[e][""]));
            },
            o = function () {
              var t =
            ...
            u = function (t, e, r) {
              ...
              return void 0 === n
                ...
                : ((i = n.applyFilters(
                  ...
                  n.applyFilters(
                    "i18n.gettext_with_context_" + a(r),
                    i,
                    t,
                    e,
                    r
              ...
              __: function (t, e) {
                ...
                return void 0 === n
                  ...
                  : ((r = n.applyFilters("i18n.gettext", r, t, e)),
                    n.applyFilters("i18n.gettext_" + a(e), r, t, e));
              },
              _x: u,
              _n: function (t, e, r, i) {
                ...
                return void 0 === n
                  ? u
                  : ((u = n.applyFilters("i18n.ngettext", u, t, e, r, i)),
                    n.applyFilters("i18n.ngettext_" + a(i), u, t, e, r, i));
              },
              _nx: function (t, e, r, i, u) {
                ...
                return void 0 === n
                  ...
                  : ((s = n.applyFilters(
                    ...
                    n.applyFilters(
                      "i18n.ngettext_with_context_" + a(u),
                      s,
                      t,
                      e,
                      r,
        ...
        w = n(33),
        O = m(void 0, void 0, { applyFilters: w.applyFilters }),
    ...
    71: function (t, e, n) {
      t.exports = function (t, e) {
        ...
        function o() {
          ...
          return (
            (u = { args: o, val: t.apply(null, o) }),
            n ? ((n.prev = u), (u.next = n)) : (r = u),
