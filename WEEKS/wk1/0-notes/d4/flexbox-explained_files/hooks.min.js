    ...
    451: function (n, t, r) {
        ...
        return function (r, e, c) {
          ...
          if (o(r) && i(e))
            if ("function" == typeof c)
              if ("number" == typeof u) {
                var a = { callback: c, priority: u, namespace: e };
                if (s[r]) {
                  var l,
                    f = s[r].handlers;
                  for (l = f.length; l > 0 && !(u >= f[l - 1].priority); l--);
                  l === f.length ? (f[l] = a) : f.splice(l, 0, a),
                    s.__current.forEach(function (n) {
                      n.name === r && n.currentIndex >= l && n.currentIndex++;
                    });
                } else s[r] = { handlers: [a], runs: 0 };
      ...
      var u = function (n, t) {
        ...
        return function (e, c) {
          ...
          if (o(e) && (r || i(c))) {
            ...
            var s = 0;
            if (r)
              (s = u[e].handlers.length),
                (u[e] = { runs: u[e].runs, handlers: [] });
            else
              for (
                var a = u[e].handlers,
                  l = function (n) {
                    a[n].namespace === c &&
                      (a.splice(n, 1),
                      s++,
                      u.__current.forEach(function (t) {
      ...
      var a = function (n, t) {
        ...
        return function (e) {
          ...
          var o = i[e].handlers;
          for (
            var c = arguments.length, u = new Array(c > 1 ? c - 1 : 0), s = 1;
            s < c;
            s++
          )
            u[s - 1] = arguments[s];
          if (!o || !o.length) return r ? u[0] : void 0;
          var a = { name: e, currentIndex: 0 };
      ...
      var l = function (n, t) {
        return function () {
          ...
          return null !==
            (r =
              null === (e = i.__current[i.__current.length - 1]) || void 0 === e
                ? void 0
                : e.name) && void 0 !== r
            ? r
            : null;
      ...
      var d = function (n, t) {
        ...
        h = function n() {
          Object(e.a)(this, n),
            ...
            (this.removeAction = u(this, "actions")),
            (this.removeFilter = u(this, "filters")),
            (this.hasAction = s(this, "actions")),
            (this.hasFilter = s(this, "filters")),
            (this.removeAllActions = u(this, "actions", !0)),
            (this.removeAllFilters = u(this, "filters", !0)),
            (this.doAction = a(this, "actions")),
            (this.applyFilters = a(this, "filters", !0)),
            (this.currentAction = l(this, "actions")),
            (this.currentFilter = l(this, "filters")),
            (this.doingAction = f(this, "actions")),
            (this.doingFilter = f(this, "filters")),
