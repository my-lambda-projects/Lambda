  ...
  function (t, e, n) {
    ...
    function E() {
      return (
        ...
        window._tkq.a || (k(), (window._tkq = new w(window._tkq))),
        T
      );
    }
  },
    ...
    (window.wpcom = window.wpcom || {}),
      ...
      (window.wpcom.stats = (function () {
        var t,
          ...
          l = function (t, e, n) {
            ...
            (o.src =
              ...
              "string" == typeof n &&
                document.body &&
                ((o.id = n), document.body.appendChild(o));
          },
          s = function (t) {
            if (((this.a = 1), t && t.length))
              for (var e = 0; e < t.length; e++) this.push(t[e]);
        ...
        var p,
          ...
          w = function t() {
            document.hidden ||
              (document.removeEventListener("visibilitychange", t), m());
          };
        return (
          6 === d() &&
          ...
          "object" === i()(document.attachEvent)
            ...
            : ((p = "unknown"),
              ...
              v.extra({ "x_stats-initial-visibility": p }),
