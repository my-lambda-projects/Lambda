(window["canvasWebpackJsonp"] = window["canvasWebpackJsonp"] || []).push([
  [23],
  {
        ...
        while (e.length > 1) {
          ...
          if (r(t)) {
            ...
            for (var i = 0; i < t.length; ++i)
              "undefined" !== typeof t[i] && n.push(t[i]);
            a.obj[a.prop] = n;
          }
        }
      };
      var l = function (e, a) {
        var t = a && a.plainObjects ? Object.create(null) : {};
        for (var n = 0; n < e.length; ++n)
          "undefined" !== typeof e[n] && (t[n] = e[n]);
        return t;
      };
      var s = function e(a, t, i) {
        if (!t) return a;
        if ("object" !== typeof t) {
          if (r(a)) a.push(t);
          else {
            if (!a || "object" !== typeof a) return [a, t];
        ...
        if (!a || "object" !== typeof a) return [a].concat(t);
        var o = a;
        r(a) && !r(t) && (o = l(a, i));
        if (r(a) && r(t)) {
          t.forEach(function (t, r) {
            if (n.call(a, r)) {
              var o = a[r];
              o && "object" === typeof o && t && "object" === typeof t
                ? (a[r] = e(o, t, i))
                : a.push(t);
            } else a[r] = t;
          });
      ...
      var d = function (e) {
        ...
        for (var n = 0; n < a.length; ++n) {
          ...
          for (var s = 0; s < l.length; ++s) {
            var _ = l[s];
            var c = i[_];
            if ("object" === typeof c && null !== c && -1 === t.indexOf(c)) {
              a.push({ obj: i, prop: _ });
              t.push(c);
            }
          }
    ...
    "60Hp": function (e, a, t) {
      "use strict";
      t.r(a);
      t.d(a, "uploadFile", function () {
        return p;
      });
      t.d(a, "completeUpload", function () {
        return v;
      });
      t.d(a, "submissionCommentAttachmentsUpload", function () {
        return h;
      });
      t.d(a, "uploadFiles", function () {
        return m;
      });
      var n = t("VTBJ");
      var r = t("x1Tw");
      ...
      function u(e) {
        if ("Network Error" === e.message) {
          const a = new Error(_.t("Canvas failed to initiate the upload."));
          a.originalError = e;
      ...
      function f(e) {
        if ("Network Error" === e.message) {
          const a = new Error(_.t("Canvas failed to complete the upload."));
          a.originalError = e;
          return Promise.reject(a);
        }
        return Promise.reject(e);
      }
      function p(e, a, t, n = r["a"], i) {
        if (!t && !a.url)
          throw new Error(
            "expected either a file to upload or a url to clone",
            { file: t, preflightData: a }
          );
        if (t && a.url)
          throw new Error(
            "can't upload with both a file object and a url to clone",
            { file: t, preflightData: a }
          );
        a.no_redirect = true;
        ...
        return n
          .post(e, a)
          .catch(u)
          .then((e) => v(e.data, t, { ajaxLib: n, onProgress: i }));
      }
      function v(e, a, t = {}) {
        ...
        const y = i.post(
          ...
          Object(n["a"])(
            {
              responseType: g ? "document" : "json",
              onUploadProgress: t.onProgress,
              withCredentials: !g,
            },
            l
          )
        );
        return y.catch(d).then((e) => {
          if (u) return Object(c["a"])(u, { ajaxLib: i }).catch(f);
          let a,
            n = {};
          if (m) {
            const t = e.data,
              ...
              o = t.ETag;
            a = m;
            n = { bucket: r, key: i, etag: o };
          } else if (201 === e.status && !t.ignoreResult) {
            a = e.data.location;
            n = {};
          }
          if (a) {
            t.includeAvatar && (n.include = "avatar");
            n = o.a.stringify(n);
      ...
      function h(e, a, t) {
        const n = `/api/v1/courses/${a}/assignments/${t}/submissions/self/comments/files`;
        const r = e.map((e) => {
          const a = { name: e.name, content_type: e.type };
          return p(n, a, e);
        });
        ...
        const t = e.map((e) =>
          e.url
            ? p(a, {
                url: e.url,
                name: e.title,
                content_type: e.mediaType,
                submit_assignment: false,
              })
            : p(a, { name: e.name, content_type: e.type }, e)
        );
    ...
    QSc6: function (e, a, t) {
      ...
      var p = function e(a, t, r, i, o, s, c, u, p, v, h, m, g) {
        var b = a;
        "function" === typeof c
          ? (b = c(t, b))
          : b instanceof Date
          ? (b = v(b))
          : "comma" === r && l(b) && (b = b.join(","));
        if (null === b) {
          if (i) return s && !m ? s(t, d.encoder, g, "key") : t;
          b = "";
        }
        if (f(b) || n.isBuffer(b)) {
          if (s) {
            var y = m ? t : s(t, d.encoder, g, "key");
            return [h(y) + "=" + h(s(b, d.encoder, g, "value"))];
          }
    ...
    Qyje: function (e, a, t) {
      ...
      var r = t("nmq7");
      var i = t("sxOR");
      e.exports = { formats: i, parse: r, stringify: n };
    },
    jpBB: function (e, a, t) {
      "use strict";
      t.d(a, "a", function () {
      ...
      function i(e, a = {}) {
        ...
        return "completed" === l ? Promise.resolve(s) : Promise.reject(_);
      }
    },
    nmq7: function (e, a, t) {
      "use strict";
      ...
      var c = function (e, a) {
        ...
        if (a.charsetSentinel)
          for (p = 0; p < d.length; ++p)
            if (0 === d[p].indexOf("utf8=")) {
              d[p] === _ ? (v = "utf-8") : d[p] === s && (v = "iso-8859-1");
              f = p;
              p = d.length;
            }
        for (p = 0; p < d.length; ++p) {
          ...
          var b, y;
          if (-1 === g) {
            b = a.decoder(h, o.decoder, v, "key");
            y = a.strictNullHandling ? null : "";
          } else {
            b = a.decoder(h.slice(0, g), o.decoder, v, "key");
            y = a.decoder(h.slice(g + 1), o.decoder, v, "value");
          }
          y && a.interpretNumericEntities && "iso-8859-1" === v && (y = l(y));
          y &&
            "string" === typeof y &&
            a.comma &&
            y.indexOf(",") > -1 &&
          ...
          r.call(t, b) ? (t[b] = n.combine(t[b], y)) : (t[b] = y);
        }
        return t;
      };
      var u = function (e, a, t) {
      ...
      var d = function (e, a, t) {
        ...
        var c = 0;
        while (t.depth > 0 && null !== (l = o.exec(n)) && c < t.depth) {
          c += 1;
          if (
            !t.plainObjects &&
      ...
      var f = function (e) {
        ...
        return {
          allowDots:
            "undefined" === typeof e.allowDots ? o.allowDots : !!e.allowDots,
          allowPrototypes:
          ...
          delimiter:
            "string" === typeof e.delimiter || n.isRegExp(e.delimiter)
              ...
              : o.delimiter,
          depth:
            "number" === typeof e.depth || false === e.depth
              ? +e.depth
              : o.depth,
...
//# sourceMappingURL=23-c-3525285db4.js.map
