  ...
  [6],
  {
    ...
    BEYS: function (e, t, a) {
      ...
      m.prototype = {
        ...
        logger: f,
        log: h,
        registerHelper: function (e, t, a) {
          if (u.call(e) === c) {
            if (a || t) throw new r("Arg not supported with multiple helpers");
        ...
        registerPartial: function (e, t) {
          u.call(e) === c ? n.extend(this.partials, e) : (this.partials[e] = t);
        },
      };
      function l(e) {
        ...
        e.registerHelper("if", function (e, t) {
          _(e) && (e = e.call(this));
          return (!t.hash.includeZero && !e) || n.isEmpty(e)
            ? t.inverse(this)
            : t.fn(this);
        });
        ...
        e.registerHelper("log", function (t, a) {
          var n =
            a.data && null != a.data.level ? parseInt(a.data.level, 10) : 1;
          e.log(n, t);
        });
      }
      var f = {
    ...
    DfGn: function (e, t, a) {
      ...
      const o = {
        get StudentEnrollment() {
          return s.t("student", "Student");
        },
        get TeacherEnrollment() {
          return s.t("teacher", "Teacher");
        },
        get TaEnrollment() {
          return s.t("teacher_assistant", "TA");
        },
        get ObserverEnrollment() {
          return s.t("observer", "Observer");
        },
        get DesignerEnrollment() {
          return s.t("designer", "Designer");
        },
      };
      function d(e) {
        return o[e] || e;
      ...
      const g = {
        year(e, t) {
          const a = e.startYear < e.endYear ? 1 : -1;
          const n = m()("<select />", t);
          e.includeBlank && n.append("<option />");
          let r = e.startYear;
          while (r * a <= e.endYear * a) {
            r += a;
            n.append(m()(`<option value="${r}">${r}</option>`));
          }
          return n;
        },
        month(e, t, a) {
          const n = a.month_names;
          const r = m()("<select />", t);
          e.includeBlank && r.append("<option />");
          for (let e = 1; e <= 12; e++)
            r.append(
              m()(`<option value="${e}">${Object(h["a"])(n[e])}</option>`)
            );
          return r;
        },
        day(e, t) {
          ...
          for (let e = 1; e <= 31; e++)
            a.append(m()(`<option value="${e}">${e}</option>`));
          return a;
        },
      };
      function v(e, t, a = f.a.clone(t)) {
        ...
        f.a.defaults(t, {
          startYear: i - 5,
          endYear: i + 5,
          order: o.order || ["year", "month", "day"],
        });
        const d = m()("<span>");
        for (
          let n = 0, r = t.order.length, i = r >= 0;
          i ? n < r : n > r;
          i ? n++ : n--
        ) {
          const r = t.order[n];
      ...
      S = {
        t: function () {
          var e, t, a, n, i, s, o, d, _, u;
          (e =
            2 <= arguments.length
              ? T.call(arguments, 0, (t = arguments.length - 1))
              : ((t = 0), [])),
            (s = arguments[t++]);
          u = {};
          ...
          u["*"] && (s.wrapper = u);
          if (!("undefined" === typeof this || this instanceof Window)) {
            d = this;
          ...
          return new M.SafeString(
            Object(h["a"])(
              r["default"].t.apply(r["default"], T.call(e).concat([s]))
            )
          );
        },
        __i18nliner_escape: function (e) {
          return Object(h["a"])(e);
        },
        __i18nliner_safe: function (e) {
          return new h["a"].SafeString(e);
        },
        __i18nliner_concat: function () {
          var e, t;
          (e =
            2 <= arguments.length
              ? T.call(arguments, 0, (t = arguments.length - 1))
        ...
        hiddenUnless: function (e) {
          if (!e) return " display:none; ";
        },
        hiddenIfExists: function (e) {
          if (null != e) return " display:none; ";
        },
        hiddenUnlessExists: function (e) {
          if (null == e) return " display:none; ";
        },
        ifExists: function (e, t) {
          return null != e ? t.fn(this) : t.inverse(this);
        },
        semanticDateRange: function () {
          return new M.SafeString(p["a"].apply(null, arguments));
        },
        contextSensitiveDatetimeTitle: function (e, t) {
          var a, n, r, i, s, o;
          r = t.hash.justText;
          ...
          return r
            ? new M.SafeString(o)
            : new M.SafeString(
                'data-tooltip data-html-tooltip-title="' +
                  Object(h["a"])(o) +
                  '"'
              );
        },
        friendlyDatetime: function (e, t) {
          var a, r, i, s, o;
          ...
          o = "";
          o =
            a && ENV && ENV.CONTEXT_TIMEZONE
              ? M.helpers.contextSensitiveDatetimeTitle(e, {
                  hash: { justText: true },
                })
              : m.a.datetimeString(e);
          return new M.SafeString(
            "<time data-tooltip data-html-tooltip-title='" +
              Object(h["a"])(o) +
              "' datetime='" +
              e.toISOString() +
              "' " +
              m.a.raw(i ? "pubdate" : void 0) +
              ">\n  <span aria-hidden='true'>" +
              m.a.friendlyDatetime(r) +
        ...
        fudge: function (e) {
          return m.a.fudgeDateForProfileTimezone(e);
        },
        unfudge: function (e) {
          return m.a.unfudgeDateForProfileTimezone(e);
        },
        formattedDate: function (e, t, a) {
          var r;
          r = a.hash.pubdate;
          if (null == e) return;
          f.a.isDate(e) || (e = n["a"].parse(e));
          return new M.SafeString(
            "<time data-tooltip title='" +
              m.a.datetimeString(e) +
              "' datetime='" +
              e.toISOString() +
              "' " +
              m.a.raw(r ? "pubdate" : void 0) +
              ">" +
              Object(h["a"])(e.toString(t)) +
              "</time>"
          );
        },
        datetimeFormatted: function (e) {
          return m.a.datetimeString(e);
        },
        dateString: function (e) {
          if (!e) return "";
          return r["default"].l("date.formats.medium", e);
        },
        minutesToHM: function (e) {
          var t, a, n;
          t = Math.floor(e / 60);
          n = e % 60;
          a = n < 10 ? "0" + n : n;
        ...
        durationToString: function (e) {
          var t, a;
          t = Math.floor(e / 60);
          a = e % 60;
          return t > 0
            ? w.t("Duration: %{hours} hours and %{minutes} minutes", {
                hours: t,
                minutes: a,
              })
            : a > 1
            ? w.t("Duration: %{minutes} minutes", { minutes: a })
            : w.t("Duration: 1 minute");
        },
        addIcon: function (e) {
          return new M.SafeString(
            "<i role='presentation' class='icon-" + Object(h["a"])(e) + "'></i>"
          );
        },
        ...
        tDateToString: function (e, t) {
          var a;
          null == e && (e = "");
          if (!e) return "";
          f.a.isDate(e) || (e = n["a"].parse(e));
          a = m.a.fudgeDateForProfileTimezone(n["a"].parse(e));
          return r["default"].l("date.formats." + t, a);
        },
        tTimeToString: function (e, t) {
          var a;
          null == e && (e = "");
          if (!e) return "";
          f.a.isDate(e) || (e = n["a"].parse(e));
          a = m.a.fudgeDateForProfileTimezone(n["a"].parse(e));
          return r["default"].l("time.formats." + t, a);
        },
        tTimeHours: function (e) {
          null == e && (e = "");
          return 0 === e.getMinutes() && 0 === e.getSeconds()
            ? r["default"].l("time.formats.tiny_on_the_hour", e)
            : r["default"].l("time.formats.tiny", e);
        },
        tEventToString: function (e, t, a) {
          null == e && (e = "");
          null == t && (t = "short");
          null == a && (a = "tiny");
          return r["default"].t("time.event", {
            defaultValue: "%{date} at %{time}",
            date: r["default"].l("date.formats." + t, e),
            time: r["default"].l("time.formats." + a, e),
          });
        },
        strftime: function (e, t) {
          null == e && (e = "");
          return r["default"].strftime(e, t);
        },
        accessibleDateFormat: function (e) {
          null == e && (e = "datetime");
          return "date" === e
            ? w.t("#helpers.accessible_date_only_format", "YYYY-MM-DD")
            : "time" === e
            ? w.t("#helpers.accessible_time_only_format", "hh:mm")
            : w.t("#helpers.accessible_date_format", "YYYY-MM-DD hh:mm");
        },
        datepickerScreenreaderPrompt: function (e) {
          var t;
          null == e && (e = "datetime");
        ...
        mimeClass: D["a"],
        convertApiUserContent: function (e, t) {
          var a, n;
          n = t.hash;
          a = k["a"].convert(e, n);
        ...
        ifEqual: function () {
          ...
          (s = arguments[0]),
            (t =
              3 <= arguments.length
                ? T.call(arguments, 1, (a = arguments.length - 1))
                : ((a = 1), [])),
            (o = arguments[a++]),
            (A = o.fn),
            (n = o.inverse);
        ...
        ifAll: function () {
          ...
          (t =
            2 <= arguments.length
              ? T.call(arguments, 0, (a = arguments.length - 1))
              : ((a = 0), [])),
            (s = arguments[a++]),
            (A = s.fn),
            (n = s.inverse);
        ...
        toSentence: function (e, t) {
          var a;
          a = f.a.map(e, function (e) {
            return t.fn(e);
          });
          return m.a.toSentence(a);
        },
        dateSelect: function (e, t) {
          return new M.SafeString(v(e, t.hash).html());
        },
        checkbox: function (e, t) {
          var a, n, r, i, s, o, d, _, u, c, l, p, b, g;
          r = t.hash;
          p = e.split(/\./);
          l = p.join("_");
          if (r.prefix) {
          ...
          for (s = 0, _ = c.length; s < _; s++) {
            u = c[s];
            o[u] ? (o[u] = u) : delete o[u];
          }
          o.uniqid && o.id && (o.id += "-" + M.helpers.uniqid.call(this));
          delete o.uniqid;
          a = (function () {
            var e;
            e = [];
            for (d in o) {
              b = o[d];
              null != b &&
                e.push(Object(h["a"])(d) + '="' + Object(h["a"])(b) + '"');
            }
            return e;
          })();
        ...
        toPrecision: function (e, t) {
          return e ? parseFloat(e).toPrecision(t) : "";
        },
        checkedIf: function (e, t, a) {
        ...
        disabledIf: function (e, t) {
          return e ? "disabled" : "";
        },
        readonlyIf: function (e, t) {
          return e ? "readonly" : "";
        },
        checkedUnless: function (e) {
          return e ? "" : "checked";
        },
        join: function (e, t, a) {
          null == t && (t = ",");
        ...
        ifIncludes: function (e, t, a) {
          if (!e) return false;
          return P.call(e, t) >= 0 ? a.fn(this) : a.inverse(this);
        },
        disabledIfIncludes: function (e, t) {
          if (!e) return "";
          return P.call(e, t) >= 0 ? "disabled" : "";
        },
        truncate_left: function (e, t) {
          return M.Utils.escapeExpression(
            y["a"]
              .truncateText(e.split("").reverse().join(""), { max: t })
              .split("")
              .reverse()
              .join("")
          );
        ...
        truncate: function (e, t) {
          return M.Utils.escapeExpression(y["a"].truncateText(e, { max: t }));
        },
        ...
        list: function (e, t) {
          ...
          (i = t.hash),
            ...
            (a = i.end),
            (o = i.separator);
          s = f.a.map(e, function (e) {
            return r ? e[r] : e;
          });
          n && (s = s.slice(0, n));
          d = s.join(o);
          return n && e.length > n ? "" + d + a : d;
        },
        titleize: function (e) {
          var t, a;
          if (!e) return "";
          a = e.split(/[ _]+/);
          t = f()(a).map(function (e) {
        ...
        uniqid: function (e) {
          ...
          if (!e._uniqid_) {
            ...
            e._uniqid_ = (function () {
              ...
              a = [];
              for (e = 1; e <= 8; e++)
                a.push(t.charAt(Math.floor(Math.random() * t.length)));
              return a;
            })().join("");
          }
          return e._uniqid_;
        ...
        view: function (e) {
          var t, a, n;
          a = function (e) {
            return (window.requestAnimationFrame || setTimeout)(e, 0);
          };
          ...
          e.render();
          a(n);
          return new M.SafeString('<span id="' + t + '">pk</span>');
        },
        or: function () {
          var e, t, a, n, r;
          (t =
        ...
        addMasteryIcon: function (e, t) {
          var a;
          null == t && (t = {});
          a =
            { exceeds: "check-plus", mastery: "check", near: "plus" }[e] || "x";
          return new M.SafeString(
            "<i aria-hidden='true' class='icon-" + Object(h["a"])(a) + "'></i>"
          );
        },
        ifGreaterThan: function (e, t, a) {
        ...
        n: function (e, t) {
          ...
          (i = t.hash),
            (n = i.precision),
            (a = i.percentage),
            (s = i.strip_insignificant_zeros);
          return r["default"].n(e, {
            precision: n,
            percentage: a,
    ...
    g1Ui: function (e, t, a) {
      ...
      const r = {
        _format(e, t) {
          ...
          return n["default"].n(e, t);
        },
        outcomeScore: (e) =>
          r._format(e, { precision: 2, strip_insignificant_zeros: true }),
      };
      t["a"] = r;
    },
    h9kl: function (e, t, a) {
    ...
    sTlx: function (e, t, a) {
      ...
      u(/x/) &&
        (u = function (e) {
          return "function" === typeof e && "[object Function]" === _.call(e);
        });
      t.isFunction = u;
      var c =
        Array.isArray ||
        function (e) {
          return (
            !(!e || "object" !== typeof e) && "[object Array]" === _.call(e)
          );
        };
      t.isArray = c;
      function m(e) {
    ...
    sVap: function (e, t, a) {
      ...
      function o(e) {
        return o.mimeClasses[e] || "file";
      }
      o.displayName = function (e) {
        const t = s[o(e)];
      ...
      for (const e in s) {
        const t = s[e];
        t.mimeTypes.forEach((t) => (o.mimeClasses[t] = e));
      }
    },
    scbj: function (e, t, a) {
      "use strict";
    ...
    vRmd: function (e, t, a) {
      ...
      function d(e, t) {
        ...
        var a = function (e, a, n, i, s, o) {
          var d = t.VM.invokePartial.apply(this, arguments);
          if (null != d) return d;
          if (t.compile) {
            var _ = { helpers: i, partials: s, data: o };
      ...
      function c(e, t, a, n, i, s) {
        var o = { partial: true, helpers: n, partials: i, data: s };
        if (void 0 === e)
          throw new r("The partial " + t + " could not be found");
        if (e instanceof Function) return e(a, o);
      }
      t.invokePartial = c;
      function m() {
        return "";
...
//# sourceMappingURL=6-c-ddb3f25666.js.map
