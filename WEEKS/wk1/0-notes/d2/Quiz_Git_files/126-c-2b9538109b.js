(window["canvasWebpackJsonp"] = window["canvasWebpackJsonp"] || []).push([
  [126],
  {
        ...
        i(
          ...
          function (i, _) {
            ...
            if (s(i)) o(e, t, _, a, c, d, u);
              ...
              var h = d ? d(l(e, _), i, _ + "", e, t, u) : void 0;
              void 0 === h && (h = i);
              n(e, _, h);
            }
          },
    ...
    "/7Jz": function (e, t, a) {
      ...
      a.d(t, "StyleSheetServer", function () {
        return dt;
      });
      a.d(t, "StyleSheetTestUtils", function () {
        return ut;
      });
      a.d(t, "css", function () {
        return ht;
      });
      a.d(t, "minify", function () {
        return ft;
      });
      a.d(t, "flushToStyleTag", function () {
        return bt;
      });
      a.d(t, "injectAndGetClassName", function () {
        return mt;
      });
      a.d(t, "defaultSelectorHandlers", function () {
        return pt;
      });
      a.d(t, "reset", function () {
        return gt;
      });
      a.d(t, "resetInjectedStyle", function () {
        return vt;
      });
      var r = a("9kyW");
      var n = a.n(r);
      ...
      var k = function (e, t) {
        return "number" === typeof t ? (p[e] ? "" + t : t + "px") : "" + t;
      };
      var y = function (e, t) {
        return j(k(e, t));
      };
      var w = function (e, t) {
        return n()(e).toString(36);
      };
      var x = function (e) {
      ...
      var S = (function () {
        ...
        t.set = function (t, a, r) {
          if (this.elements.hasOwnProperty(t)) {
            if (r) {
              var n = this.keyOrder.indexOf(t);
              this.keyOrder.splice(n, 1);
              this.keyOrder.push(t);
            }
          ...
          if ((O && a instanceof Map) || a instanceof e) {
        ...
        function n(e, t, r) {
          if (e.hasOwnProperty(t)) {
            ...
            for (var _ = 0; _ < s.length; _++) {
              var l = s[_];
              if (l === t)
                for (var c = 0; c < i.length; c++) n[i[c] + o] = r[t];
              n[l] = r[l];
            }
            return n;
          }
            ...
            for (var _ in s) {
              ...
              if ((0, i.default)(l)) s[_] = e(l);
                ...
                for (var d = 0, u = l.length; d < u; ++d) {
                  var h = (0, r.default)(o, _, l[d], s, t);
                  (0, n.default)(c, h || l[d]);
                }
                c.length > 0 && (s[_] = c);
              } else {
                var f = (0, r.default)(o, _, l, s, t);
                f && (s[_] = f);
                s = (0, a.default)(t, _, s);
              }
            }
      ...
      var Z = C(function (e, t) {
        ...
        function r(e, t) {
          if ("display" === e && a.hasOwnProperty(t)) return a[t];
        }
      });
      var X = z(Z);
      var Y = C(function (e, t) {
        ...
        var i = /^\d+(\.\d+)?$/;
        function o(e, t, o) {
          Object.prototype.hasOwnProperty.call(r, e) && (o[r[e]] = a[t] || t);
          if ("flex" === e) {
      ...
      var J = C(function (e, t) {
        ...
        function n(e, t, n) {
          ...
          r.hasOwnProperty(e) && (n[r[e]] = a[t] || t);
        }
      });
      var $ = z(J);
      var ee = C(function (e, t) {
        ...
        function o(e, t) {
          if ("string" === typeof t && !(0, a.default)(t) && i.test(t))
            return n.map(function (e) {
      ...
      var ae = C(function (e, t) {
        ...
        var n = ["center", "end", "start", "stretch"];
        var i = {
        ...
        var o = {
          alignSelf: function (e, t) {
            n.indexOf(e) > -1 && (t.msGridRowAlign = e);
          },
          ...
          gridColumnEnd: function (e, t) {
            var a = t.msGridColumn;
            r(e) && r(a) && (t.msGridColumnSpan = e - a);
          },
          ...
          justifySelf: function (e, t) {
            n.indexOf(e) > -1 && (t.msGridColumnAlign = e);
          },
        };
        function s(e, t, a) {
      ...
      function me(e) {
        ...
        return (fe[e] = he.test(t) ? "-" + t : t);
      }
      var pe = Object.freeze({ default: me });
      var ge = A(pe);
      ...
      var ke = C(function (e, t) {
        ...
        function _(e, t) {
          ...
          for (var i = 0, o = n.length; i < o; ++i) {
            ...
            for (var c in t) {
              var d = (0, a.default)(c);
              if (_.indexOf(d) > -1 && "order" !== d) {
                var u = t[c];
                for (var h = 0, f = u.length; h < f; ++h)
                  l.unshift(_.replace(d, s[u[h]] + d));
              }
            }
            n[i] = l.join(",");
          }
      ...
      var Ce = {
        plugins: [F, D, H, K, G, X, Q, $, te, re, ie, se, le, de, ye],
        prefixMap: {
          transform: Se,
          transformOrigin: Se,
          transformOriginX: Se,
          transformOriginY: Se,
          backfaceVisibility: we,
          perspective: we,
          perspectiveOrigin: we,
          transformStyle: we,
          transformOriginZ: we,
          animation: we,
          animationDelay: we,
          animationDirection: we,
          animationFillMode: we,
          animationDuration: we,
          animationIterationCount: we,
          animationName: we,
          animationPlayState: we,
          animationTimingFunction: we,
          appearance: Oe,
          userSelect: ze,
          fontKerning: we,
          textEmphasisPosition: we,
          textEmphasis: we,
          textEmphasisStyle: we,
          textEmphasisColor: we,
          boxDecorationBreak: we,
          clipPath: we,
          maskImage: we,
          maskMode: we,
          maskRepeat: we,
          ...
          transitionProperty: we,
          transitionTimingFunction: we,
          backdropFilter: we,
          scrollSnapType: Se,
          scrollSnapPointsX: Se,
          scrollSnapPointsY: Se,
          scrollSnapDestination: Se,
          scrollSnapCoordinate: Se,
          shapeImageThreshold: we,
          shapeImageMargin: we,
          shapeImageOutside: we,
          hyphens: ze,
          flowInto: Se,
          flowFrom: Se,
          regionFragment: Se,
          ...
          textSizeAdjust: Se,
          borderImage: we,
          borderImageOutset: we,
          borderImageRepeat: we,
          borderImageSlice: we,
          borderImageSource: we,
          borderImageWidth: we,
        },
      };
      var Ae = I(Ce);
      ...
      var Le = function (e, t, a) {
        return "".concat(m(e), ":").concat(a(e, t), ";");
      };
      var Pe = function (e, t) {
        e[t] = true;
        return e;
      };
      var Re = function (e, t, a, r, n) {
        Me(t, a, n);
        ...
        if (s.length !== t.keyOrder.length)
          for (var _ = 0; _ < s.length; _++)
            if (!i[s[_]]) {
              ...
              l =
                "W" === s[_][0]
                  ? s[_][6].toLowerCase() + s[_].slice(7)
                  : "o" === s[_][1]
                  ? s[_][3].toLowerCase() + s[_].slice(4)
                  : s[_][2].toLowerCase() + s[_].slice(3);
              if (l && i[l]) {
                var c = t.keyOrder.indexOf(l);
                t.keyOrder.splice(c, 0, s[_]);
              } else t.keyOrder.unshift(s[_]);
            }
        var d = false === r ? k : y;
        var u = [];
        for (var h = 0; h < t.keyOrder.length; h++) {
          var f = t.keyOrder[h];
          var b = o[f];
          if (Array.isArray(b))
            for (var m = 0; m < b.length; m++) u.push(Le(f, b[m], d));
          else u.push(Le(f, b, d));
        }
        return u.length ? "".concat(e, "{").concat(u.join(""), "}") : "";
      };
      var Ie = null;
      var Ne = function (e) {
        if (null == Ie) {
          Ie = document.querySelector("style[data-aphrodite]");
          if (null == Ie) {
        ...
        var a = Ie.styleSheet || Ie.sheet;
        if (a.insertRule) {
          var r = a.cssRules.length;
        ...
        } else Ie.innerText = (Ie.innerText || "") + e.join("");
      };
      var Fe = {
        fontFamily: function e(t) {
          ...
          if ("object" === s(t)) {
            He(t.src, "@font-face", [t], false);
            return '"'.concat(t.fontFamily, '"');
          }
          return t;
        },
        animationName: function e(t, a) {
          if (Array.isArray(t))
            return t
              .map(function (t) {
                return e(t, a);
              ...
              .join(",");
          if ("object" === s(t)) {
            var r = "keyframe_".concat(x(t));
            var n = "@keyframes ".concat(r, "{");
            t instanceof S
              ? t.forEach(function (e, t) {
                  n += Ee(t, [e], a, Fe, false).join("");
                })
              : Object.keys(t).forEach(function (e) {
                  n += Ee(e, [t[e]], a, Fe, false).join("");
                });
            n += "}";
            We(r, [n]);
            return r;
      ...
      var We = function (e, t) {
        ...
        (a = Be).push.apply(a, c(t));
        qe[e] = true;
      };
      var He = function (e, t, a, r) {
        var n =
      ...
      var Ve = function () {
        if (De) throw new Error("Cannot buffer while already buffering");
        De = true;
      };
      var Ge = function () {
        De = false;
      ...
      var Je = function (e) {
        return "_definition" in e && "_name" in e && "_len" in e;
      };
      var $e = function e(t, a, r, n) {
        for (var i = 0; i < t.length; i += 1)
          if (t[i])
            if (Array.isArray(t[i])) n += e(t[i], a, r, n);
            else {
              if (!Je(t[i]))
                throw new Error(
                  "Invalid Style Definition: Styles should be defined using the StyleSheet.create method."
                );
              a.push(t[i]._name);
      ...
      var et = function (e, t, a) {
        ...
        o =
          1 === r.length
            ? "_".concat(r[0])
            : "_".concat(w(r.join())).concat((i % 36).toString(36));
        He(o, ".".concat(o), n, e, a);
        return o;
      };
      var tt = function (e, t) {
        return "".concat(t, "_").concat(w(e));
      };
      var at = function () {
        return w;
      };
      ...
      var nt = {
        create: function (e) {
          ...
          for (var r = 0; r < a.length; r += 1) {
            ...
            t[n] = { _len: o.length, _name: rt(o, n), _definition: i };
          }
          return t;
        },
        rehydrate: function () {
        ...
        "undefined" !== typeof window
          ...
          : {
              renderStatic: function (e) {
                ...
                return {
                  html: t,
                  css: { content: a, renderedClassNames: Ye() },
                };
              },
            };
      var ot = null;
        ...
        return {
          StyleSheet: l({}, nt, {
            extend: function (a) {
              ...
              return st(e, t.concat(r));
            },
          }),
          StyleSheetServer: it,
          StyleSheetTestUtils: ot,
          minify: function (e) {
            rt = e ? w : tt;
          },
          css: function () {
          ...
          flushToStyleTag: Xe,
          injectAndGetClassName: et,
          defaultSelectorHandlers: Te,
          reset: Ue,
          resetInjectedStyle: Ke,
        };
      }
      var _t = true;
      var lt = st(_t);
      var ct = lt.StyleSheet,
        dt = lt.StyleSheetServer,
        ut = lt.StyleSheetTestUtils,
        ht = lt.css,
        ft = lt.minify,
        bt = lt.flushToStyleTag,
        mt = lt.injectAndGetClassName,
        pt = lt.defaultSelectorHandlers,
        gt = lt.reset,
        vt = lt.resetInjectedStyle;
    },
    "/FUP": function (e, t, a) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: true });
      ...
      var m = (t.ReactCSS = function (e) {
        for (
          var t = arguments.length, a = Array(t > 1 ? t - 1 : 0), r = 1;
          r < t;
          r++
        )
          a[r - 1] = arguments[r];
    ...
    AnK5: function (e, t, a) {
      ...
      var v = (t.EditableInput = (function (e) {
        u(t, e);
        function t(e) {
          c(this, t);
          ...
          a.handleDrag = function (e) {
            if (a.props.dragLabel) {
              var t = Math.round(a.props.value + e.movementX);
              t >= 0 &&
                t <= a.props.dragMax &&
                a.props.onChange &&
                a.props.onChange(a.getValueObjectWithLabel(t), e);
            }
          };
        ...
        r(t, [
          ...
          },
          {
            key: "getArrowOffset",
            value: function () {
              return this.props.arrowOffset || h;
            },
          },
          {
            key: "setUpdatedValue",
    ...
    BKMn: function (e, t, a) {
      ...
      var _ = (t.PhotoshopPointerCircle = function (e) {
        var t = e.hsl;
        var a = (0, o.default)(
          {
            default: {
    ...
    CpOe: function (e, t, a) {
      ...
      function c(e, t) {
        var a = "plural" === t ? r : i;
        return e.replace(/'/g, s).replace(a, "'$&'");
      }
      function d(e, t) {
        if (e[0] === _) return _;
      ...
      function h(e) {
        if (!n.test(e)) return e.replace(/'/g, s);
        return o + e.replace(/'/g, s) + o;
      }
      function f(e) {
        var t = e[0];
        var a = e[1];
    ...
    DzJC: function (e, t, a) {
      ...
      function o(e, t, a) {
        ...
        return r(e, t, { leading: o, maxWait: t, trailing: s });
      }
      e.exports = o;
    },
    EwQA: function (e, t, a) {
      ...
      (function (t) {
        ...
        function s() {
          while (i < r.length) {
            ...
            r[e].call();
            if (i > o) {
              for (var t = 0, a = r.length - i; t < a; t++) r[t] = r[t + i];
              r.length -= i;
              i = 0;
            }
          }
        ...
        var _ = "undefined" !== typeof t ? t : self;
    ...
    FkO2: function (e, t, a) {
      ...
      t.batch = function (e) {
        ...
        return function (e) {
          return function (a) {
            Array.isArray(a) ? t({ type: r, payload: a }) : e(a);
          };
        };
      };
      t.batching = function (e) {
        return function t(a, n) {
          return n.type === r ? n.payload.reduce(t, a) : e(a, n);
        };
      };
    },
    GEYT: function (e, t, a) {
      ...
      function _(e, t, a) {
        var r,
          ...
          l = a && null != a.left ? a.left : 0.5,
          c = a && null != a.top ? a.top : 0.5,
          d = l,
          u = c;
        if (h(t)) {
          n =
            ...
            window.scrollX -
            window.innerWidth * d +
            Math.min(_.width, window.innerWidth) * d;
          i =
            _.top +
            window.scrollY -
            window.innerHeight * u +
            Math.min(_.height, window.innerHeight) * u;
          n = Math.max(
            Math.min(n, document.body.scrollWidth - window.innerWidth * d),
            0
          );
          i = Math.max(
            Math.min(i, document.body.scrollHeight - window.innerHeight * u),
            0
          );
          o = n - window.scrollX;
          s = i - window.scrollY;
        ...
        return { x: n, y: i, differenceX: o, differenceY: s };
      }
      function l(e) {
        r(function () {
          var t = e._scrollSettings;
          if (!t) return;
          var a = _(t.target, e, t.align),
            r = Date.now() - t.startTime,
            i = Math.min((1 / t.time) * r, 1);
          if (
            r > t.time + 20 ||
            (Math.abs(a.differenceY) <= 1 && Math.abs(a.differenceX) <= 1)
          ) {
            s(e, a.x, a.y);
      ...
      function u(e, t, a, r) {
        ...
        t._scrollSettings = {
          startTime: _ ? _.startTime : Date.now(),
          target: e,
          time: a.time + (_ ? c - _.startTime : 0),
          ease: a.ease,
          align: a.align,
          end: u,
        };
      ...
      function f(e, t, a) {
        ...
        var r = e.parentElement,
          n = { traversed: 0, validated: 0, scrolled: 0 };
        function i(e) {
          n.validated - 1 || (a && a(e));
        }
        while (r) {
          if (
            (!t.validTarget || t.validTarget(r, n)) &&
            (h(r) ||
    ...
    IDhZ: function (e, t, a) {
      ...
      var o = "function" === typeof Symbol && Symbol.for,
        ...
        _ = o ? Symbol.for("react.fragment") : 60107,
      ...
      var O = {};
      function S(e, t) {
        for (var a = 0 | e._threadCount; a <= t; a++)
          (e[a] = e._currentValue2), (e._threadCount = a + 1);
      }
      function z(e, t, a, r) {
      ...
      for (var C = new Uint16Array(16), A = 0; 15 > A; A++) C[A] = A + 1;
      C[15] = 0;
      var T =
      ...
      function I(e, t, a, r) {
        if (null === t || "undefined" === typeof t || R(e, t, a, r)) return !0;
        if (r) return !1;
        if (null !== a)
          switch (a.type) {
            case 3:
      ...
      [
        ...
        var t = e[0];
        F[t] = new N(t, 1, !1, e[1], null, !1);
      });
      ["contentEditable", "draggable", "spellCheck", "value"].forEach(function (
        e
      ) {
        F[e] = new N(e, 2, !1, e.toLowerCase(), null, !1);
      });
      [
        "autoReverse",
        ...
        F[e] = new N(e, 2, !1, e, null, !1);
      });
      "allowFullScreen async autoFocus autoPlay controls default defer disabled disablePictureInPicture formNoValidate hidden loop noModule noValidate open playsInline readOnly required reversed scoped seamless itemScope"
        .split(" ")
        .forEach(function (e) {
          F[e] = new N(e, 3, !1, e.toLowerCase(), null, !1);
        });
      ["checked", "multiple", "muted", "selected"].forEach(function (e) {
        F[e] = new N(e, 3, !0, e, null, !1);
      });
      ["capture", "download"].forEach(function (e) {
        F[e] = new N(e, 4, !1, e, null, !1);
      });
      ["cols", "rows", "size", "span"].forEach(function (e) {
        F[e] = new N(e, 6, !1, e, null, !1);
      });
      ["rowSpan", "start"].forEach(function (e) {
        F[e] = new N(e, 5, !1, e.toLowerCase(), null, !1);
      });
      var q = /[\-:]([a-z])/g;
      function B(e) {
      ...
      "xlink:actuate xlink:arcrole xlink:role xlink:show xlink:title xlink:type"
        ...
        .forEach(function (e) {
          var t = e.replace(q, B);
          F[t] = new N(t, 1, !1, e, "http://www.w3.org/1999/xlink", !1);
        });
      ["xml:base", "xml:lang", "xml:space"].forEach(function (e) {
        var t = e.replace(q, B);
        F[t] = new N(t, 1, !1, e, "http://www.w3.org/XML/1998/namespace", !1);
      });
      ["tabIndex", "crossOrigin"].forEach(function (e) {
        F[e] = new N(e, 1, !1, e.toLowerCase(), null, !1);
      });
      F.xlinkHref = new N(
        "xlinkHref",
        1,
      ...
      ["src", "href", "action", "formAction"].forEach(function (e) {
        F[e] = new N(e, 1, !1, e.toLowerCase(), null, !0);
      });
      var D = /["'&<>]/;
      function W(e) {
      ...
      var K = "function" === typeof Object.is ? Object.is : U,
        V = null,
        G = null,
        Z = null,
        X = !1,
      ...
      var be = /([A-Z])/g,
        me = /^ms-/,
        pe = n.Children.toArray,
        ge = j.ReactCurrentDispatcher,
        ...
        function o(n, o) {
          ...
          if (s) {
            if (
              ...
              var u = o.getDerivedStateFromProps.call(null, n.props, s.state);
              null != u && (s.state = r({}, s.state, u));
            }
          } else if (
            ((V = {}),
            (s = o(n.props, _, d)),
            (s = ae(o, n.props, s, _)),
            null == s || null == s.render)
          ) {
            e = s;
            Se(e, o);
            return;
          ...
          if (
            ...
            ((n = o.childContextTypes), "object" === typeof n)
          ) {
            var m = s.getChildContext();
            for (var p in m)
              if (!(p in n)) throw Error(i(108, x(o) || "Unknown", p));
          }
          m && (t = r({}, t, m));
        }
      ...
      var Ce = (function () {
            ...
            try {
              for (var r = [""], n = !1; r[0].length < e; ) {
                ...
                if (n || s.childIndex >= s.children.length) {
                  ...
                  r[this.suspenseDepth] += _;
                } else {
                  var u = s.children[s.childIndex++],
                    h = "";
                  try {
                    h += this.render(u, s.context, s.domNamespace);
                  } catch (e) {
          ...
          t.render = function (e, t, a) {
            ...
            if ("object" === typeof o && null !== o)
              switch (o.$$typeof) {
                ...
                case p:
                  return (
                    (e = [n.createElement(o.type, r({ ref: e.ref }, e.props))]),
                    this.stack.push({
                      type: null,
                      domNamespace: a,
                      children: e,
          ...
          t.renderDOM = function (e, t, a) {
            var n = e.type.toLowerCase();
            a === le.html && ce(n);
            if (!ye.hasOwnProperty(n)) {
              if (!ke.test(n)) throw Error(i(65, n));
              ye[n] = !0;
            }
            var o = e.props;
            if ("input" === n)
            ...
            for (v in s)
              if (je.call(s, v)) {
                ...
                if (null != u) {
                  ...
                  d = null;
                  e: if (((b = n), (m = s), -1 === b.indexOf("-")))
                    b = "string" === typeof m.is;
                  else
                    switch (b) {
                      case "annotation-xml":
                      case "color-profile":
    ...
    "IF+P": function (e, t, a) {
      "use strict";
      e.exports = (e, t, a, r) => {
        const n = (e + (r || "")).toString().includes("%");
        if ("string" === typeof e) {
          const n = e.match(/(0?\.?\d{1,3})%?\b/g).map(Number);
          e = n[0];
          t = n[1];
          a = n[2];
          r = n[3];
        ...
        if ("number" === typeof r) {
          if (!n && r >= 0 && r <= 1) r = Math.round(255 * r);
          else {
            if (!(n && r >= 0 && r <= 100))
              throw new TypeError(
        ...
        return (a | (t << 8) | (e << 16) | (1 << 24)).toString(16).slice(1) + r;
      };
    },
    KAy6: function (e, t, a) {
      "use strict";
    ...
    KR5x: function (e, t, a) {
      ...
      var v =
        ((b = Object(h["a"])(
          "7.0.0",
          null,
          "Use TextArea from ui-text-area instead."
        )),
        b(
          (m =
            ((g = p =
            ...
            (p.propTypes = {
              label: c.a.node.isRequired,
              id: c.a.string,
              size: c.a.oneOf(["small", "medium", "large"]),
              layout: c.a.oneOf(["stacked", "inline"]),
              autoGrow: c.a.bool,
              resize: c.a.oneOf(["none", "both", "horizontal", "vertical"]),
              width: c.a.string,
              height: c.a.string,
              maxHeight: c.a.oneOfType([c.a.number, c.a.string]),
              messages: c.a.arrayOf(u["e"].message),
              inline: c.a.bool,
              placeholder: c.a.string,
              disabled: c.a.bool,
              readOnly: c.a.bool,
              required: c.a.bool,
              textareaRef: c.a.func,
              defaultValue: c.a.string,
              value: Object(d["a"])(c.a.string),
              onChange: c.a.func,
            }),
            (p.defaultProps = {
              size: "medium",
    ...
    KfSR: function (e, t, a) {
      ...
      var _ = (t.autoprefix = function (e) {
        var t = {};
        (0, n.default)(e, function (e, a) {
          var r = {};
    ...
    Lwbf: function (e, t, a) {
      ...
      Object.defineProperty(t, "__esModule", { value: true });
      var r = {};
      var n = (t.render = function (e, t, a, r) {
      ...
      t.get = function (e, t, a, i) {
        var o = e + "-" + t + "-" + a + (i ? "-server" : "");
        if (r[o]) return r[o];
        var s = n(e, t, a, i);
        r[o] = s;
        return s;
        ...
        template: function (e) {
          return "\n\n.chpSa_byIz{position:relative}\n\n.chpSa_cPAP{border:"
            ...
            .concat(
              ...
              "*1.5);bottom:-0.25rem;box-sizing:border-box;display:block;left:-0.25rem;opacity:0;pointer-events:none;position:absolute;right:-0.25rem;top:-0.25rem;transform:scale(0.95);transition:all 0.2s}\n\n.chpSa_blLZ{-moz-appearance:none;-moz-osx-font-smoothing:grayscale;-webkit-appearance:none;-webkit-font-smoothing:antialiased;all:initial;animation:none 0s ease 0s 1 normal none running;appearance:none;backface-visibility:visible;background:transparent none repeat 0 0/auto auto padding-box border-box scroll;background:"
            )
            .concat(
              e.background || "inherit",
              ";border:medium none currentColor;border-bottom-color:"
            )
            .concat(
              e.borderBottomColor || "inherit",
              ";border-collapse:separate;border-image:none;border-left-color:"
            )
            .concat(
              e.borderLeftColor || "inherit",
              ";border-radius:0;border-radius:"
            )
            .concat(e.borderRadius || "inherit", ";border-right-color:")
            .concat(
              e.borderRightColor || "inherit",
              ";border-spacing:0;border-style:"
            )
            .concat(e.borderStyle || "inherit", ";border-top-color:")
            .concat(e.borderTopColor || "inherit", ";border-width:")
            .concat(
              e.borderWidth || "inherit",
              ";bottom:auto;box-shadow:none;box-sizing:content-box;box-sizing:border-box;caption-side:top;clear:none;clip:auto;color:#000;color:"
            )
            .concat(
              e.color || "inherit",
            ...
            T(
              (E =
                ((L = M =
                  (function (e) {
                    ...
                    function a() {
                      ...
                      Object(n["a"])(this, a);
                      e = t.call(this);
                      e._textareaResize = function (t) {
                        var a = e._textarea.style.height;
                        if (a != e._height) {
                          e._manuallyResized = true;
                          e._textarea.style.overflowY = "auto";
                          e._container.style.minHeight = a;
                        }
                      };
                      e.grow = function (t) {
                        if (!e._textarea || e._manuallyResized) return;
                        var a =
                          e._textarea.offsetHeight - e._textarea.clientHeight;
                        var r = "";
                        ...
                        var n = Object(j["a"])(
                          e.props.maxHeight,
                          Object(p["a"])(Object(o["a"])(e))
                        );
                        if (e.props.maxHeight && e._textarea.scrollHeight > n)
                          e._textarea.style.overflowY = "auto";
                        else if (e.props.height)
                          if ("" === e._textarea.value) r = e.props.height;
                          else if (
                            Object(j["a"])(
                              e.props.height,
                              Object(p["a"])(Object(o["a"])(e))
                            ) > e._textarea.scrollHeight
                          ) {
                            e._textarea.style.overflowY = "auto";
                            r = e.props.height;
                          }
                        var i = Object(j["a"])(r) > n;
                      ...
                      e.handleChange = function (t) {
                        ...
                        "undefined" === typeof n && e.autoGrow();
                        "function" === typeof r && r(t);
                      };
                      e.handleContainerRef = function (t) {
                        e._container = t;
                      };
                    ...
                    Object(i["a"])(a, [
                      ...
                      },
                      {
                        ...
                        value: function () {
                          if (this.props.autoGrow) {
                            this._debounced ||
                              (this._debounced = Object(w["a"])(
                                this.grow,
                                200,
                                { leading: false, trailing: true }
                              ));
                            this._listener ||
                              (this._listener = Object(g["a"])(
                                window,
                                "resize",
                                this._debounced
                              ));
                            this._textarea &&
                              !this._textareaResizeListener &&
                              (this._textareaResizeListener = Object(v["a"])(
                                this._textarea,
                                this._textareaResize,
                                ["height"]
                              ));
                            this._request = Object(k["a"])(this.grow);
                          }
                        },
                      },
                      {
                      ...
                      },
                      {
                        ...
                        value: function () {
                          ...
                          var w =
                            ((e = {}),
                            Object(r["a"])(e, P.textarea, true),
                            Object(r["a"])(e, P[k], true),
                            Object(r["a"])(e, P.disabled, l),
                            e);
                          var x = {
                            width: h,
                            resize: v,
                          ...
                          return c.a.createElement(
                            ...
                            Object.assign(
                              {},
                              Object(z["c"])(this.props, m["a"].propTypes),
                              {
                                vAlign: "top",
                                id: this.id,
                                ref: function (e) {
                      ...
                      },
                      {
                        key: "focused",
                        get: function () {
                          return Object(y["a"])(this._textarea);
                        },
                      },
                      {
                        key: "value",
                ...
                (M.propTypes = {
                  ...
                  autoGrow: u.a.bool,
                  resize: u.a.oneOf(["none", "both", "horizontal", "vertical"]),
                  width: u.a.string,
                  height: u.a.string,
                  maxHeight: u.a.oneOfType([u.a.number, u.a.string]),
                  messages: u.a.arrayOf(m["e"].message),
                  inline: u.a.bool,
                  placeholder: u.a.string,
                  disabled: u.a.bool,
                  readOnly: u.a.bool,
                  required: u.a.bool,
                  textareaRef: u.a.func,
                  defaultValue: u.a.string,
                  value: Object(b["a"])(u.a.string),
                  onChange: u.a.func,
                }),
                (M.defaultProps = {
                  size: "medium",
    ...
    NOPk: function (e, t, a) {
      ...
      var r = a("ZoNA");
      var n =
        "AAAAAAACEEEEIIIIDNOOOOO.OUUUUY..aaaaaaaceeeeiiiidnooooo.ouuuuy.yAaAaAaCcCcCcCcDdDdEeEeEeEeEeGgGgGgGgHhHhIiIiIiIiIiIiJjKkkLlLlLlLlJlNnNnNnnNnOoOoOoOoRrRrRrSsSsSsSsTtTtTtUuUuUuUuUuUuWwYyYZzZzZz.";
      function i(e) {
        var t = "";
        var a = e.length;
        var r = n.length;
      ...
      var u = (t.Checkboard = function (e) {
        ...
        var h = (0, s.default)({
          default: {
            grid: {
              ...
              boxShadow: d,
              absolute: "0px 0px 0px 0px",
              background: "url(" + l.get(t, a, o, _.canvas) + ") center left",
            },
          },
        });
        return (0, n.isValidElement)(u)
          ? i.default.cloneElement(
              u,
              r({}, u.props, { style: r({}, u.props.style, h.grid) })
            )
          : i.default.createElement("div", { style: h.grid });
      });
      u.defaultProps = {
        size: 8,
        white: "transparent",
    ...
    Ojt5: function (e, t, a) {
      ...
      var u = (t.Raised = function (e) {
        ...
        return n.default.createElement(
          "div",
          { style: l.wrap },
          n.default.createElement("div", { style: l.bg }),
          n.default.createElement("div", { style: l.content }, i)
        );
      });
      u.propTypes = {
    ...
    RhCJ: function (e, t, a) {
      ...
      function r(e, t, a) {
        if ("input" === e.as) {
          if (("children" === t && e.children) || void 0 == e.value)
            return new Error(
              "Prop `value` and not `children` must be supplied if `".concat(
                a,
                ' as="input"`'
              )
            );
        } else {
          if ("value" === t && void 0 != e.value)
            return new Error(
              "Prop `children` and not `value` must be supplied unless `".concat(
                a,
                ' as="input"`'
              )
            );
          if (!e.children)
            return new Error(
              "Prop `children` should be supplied unless `".concat(
                a,
                ' as="input"`.'
              )
            );
    ...
    THLb: function (e, t, a) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: true });
      t.calculateChange = function (e, t, a, r, n) {
        var i = n.clientWidth;
        ...
        if ("vertical" === a) {
          ...
          if (t.a !== d) return { h: t.h, s: t.s, l: t.l, a: d, source: "rgb" };
        } else {
          var u = void 0;
          u = l < 0 ? 0 : l > i ? 1 : Math.round((100 * l) / i) / 100;
          if (r !== u) return { h: t.h, s: t.s, l: t.l, a: u, source: "rgb" };
        }
        return null;
      };
    },
        ...
        var t = (function (t) {
          ...
          function a(e) {
            ...
            t.handleChange = function (e, a) {
              var r = c.default.simpleCheckForValidColor(e);
              if (r) {
                var n = c.default.toState(e, e.h || t.state.oldHue);
                t.setState(n);
                t.props.onChangeComplete &&
                  t.debounce(t.props.onChangeComplete, n, a);
                t.props.onChange && t.props.onChange(n, a);
              }
            };
            t.handleSwatchHover = function (e, a) {
              var r = c.default.simpleCheckForValidColor(e);
              if (r) {
                var n = c.default.toState(e, e.h || t.state.oldHue);
            ...
            t.debounce = (0, _.default)(function (e, t, a) {
              e(t, a);
            }, 100);
            return t;
          }
            ...
            [
              {
                ...
                value: function (e, t) {
                  return r({}, c.default.toState(e.color, t.oldHue));
                },
              },
            ]
          );
    ...
    VTJ5: function (e, t, a) {
      ...
      function b(e) {
        ...
        return {
          ...
          inverseTrackColor: t.textDarkest,
          inverseColor: t.textBrand,
        };
      }
      b.canvas = function (e) {
        return {
          color: e["ic-brand-primary"],
          inverseColor: e["ic-brand-primary"],
          inverseTrackColor: e["ic-brand-font-color-dark"],
        };
      };
      var m, p, g, v, k, y;
      var w =
        ((m = Object(u["a"])(
          "7.0.0",
          null,
          "Use Spinner from ui-spinner instead."
        )),
        (p = Object(f["a"])()),
        (g = Object(h["j"])(b)),
        m(
              ...
              (v =
                g(
                  (v =
                        ...
                        Object(n["a"])(a, [
                          {
                            key: "render",
                            value: function () {
                              return _.a.createElement(d["a"], this.props);
                            },
                          },
                        ]);
                    ...
                    (k.propTypes = {
                      title: c.a.string,
                      renderTitle: c.a.oneOfType([c.a.func, c.a.node]),
                      size: c.a.oneOf(["x-small", "small", "medium", "large"]),
    ...
    VVms: function (e, t, a) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: true });
      t.calculateChange = function (e, t, a) {
      ...
      var c = (t.hover = function (e) {
        ...
        return (function (a) {
          ...
          function n() {
            ...
            var o, l, c;
            s(this, n);
            for (var d = arguments.length, u = Array(d), h = 0; h < d; h++)
              u[h] = arguments[h];
            return (
              (c =
                ((o =
                  ((l = _(
                    this,
                    (a = n.__proto__ || Object.getPrototypeOf(n)).call.apply(
                      a,
                      [this].concat(u)
                    )
                  )),
                ...
                (l.handleMouseOver = function () {
                  return l.setState({ hover: true });
                }),
                (l.handleMouseOut = function () {
                  return l.setState({ hover: false });
                }),
                (l.render = function () {
                  return i.default.createElement(
                    t,
            ...
            return (
              (c =
                ...
                (l.handleMouseDown = function () {
                  return l.setState({ active: true });
                }),
                (l.handleMouseUp = function () {
                  return l.setState({ active: false });
                }),
                (l.render = function () {
                  return i.default.createElement(
                    t,
    ...
    YDsC: function (e, t) {
      var a = { r: 0, g: 0, b: 0, a: 0 };
      var r = { r: 255, g: 255, b: 255, a: 1 };
      function n(e) {
        var t = /rgba?\((\d+),\s(\d+),\s(\d+)(,\s([\d\.]+))?\)/;
        var r = t.exec(e);
        if (!r) return a;
        return {
          r: parseInt(r[1], 10),
      ...
      function o(e) {
        ...
        var a = s(e.g);
        var n = s(e.b);
        return 0.2126 * t + 0.7152 * a + 0.0722 * n;
      }
      function s(e) {
        var t = e / 255;
        if (t <= 0.03928) return t / 12.92;
      ...
      function l(e) {
        ...
        var a = e;
        while (null != a) {
          var o = n(window.getComputedStyle(a).backgroundColor);
          o.a > 0 && t.push(o);
          if (1 === o.a) break;
          a = a.parentElement;
        }
        return t.reduceRight(i, r);
      }
      function c(e) {
        var t = n(window.getComputedStyle(e).color);
        var a = l(e);
        var r = i(a, t);
        return [r, a];
      }
    ...
    ZREj: function (e, t) {
      e.exports = function (e) {
        return function (t) {
          t.preventDefault();
          return "function" === typeof e && true === e.call(this, t);
        };
      };
    },
    ZoNA: function (e, t, a) {
        ...
        function t(e) {
          ...
          a.handleChange = function (e) {
            "function" === typeof a.props.onChange &&
              a.throttle(
                a.props.onChange,
                d.calculateChange(e, a.props.hsl, a.container),
                e
              );
          };
          a.handleMouseDown = function (e) {
          ...
          a.throttle = (0, l.default)(function (e, t, a) {
            e(t, a);
          }, 50);
          return a;
        }
    ...
    itsj: function (e, t) {
      function a(e, t) {
        if ("constructor" === t && "function" === typeof e[t]) return;
            ...
            return (
              (r =
                ...
                (a.handleFocus = function () {
                  return a.setState({ focus: true });
                }),
                (a.handleBlur = function () {
                  return a.setState({ focus: false });
                }),
                t)),
              l(a, r)
            );
    ...
    "mv/X": function (e, t, a) {
      ...
      function s(e, t, a) {
        if (!o(a)) return false;
        var s = typeof t;
        if ("number" == s ? n(a) && i(t, a.length) : "string" == s && t in a)
          return r(a[t], e);
        return false;
      }
      e.exports = s;
    ...
    p8yl: function (e, t, a) {
      ...
      var _ = (t.toState = function (e, t) {
        var a = e.hex ? (0, o.default)(e.hex) : (0, o.default)(e);
        var r = a.toHsl();
        var n = a.toHsv();
        var i = a.toRgb();
        var s = a.toHex();
    ...
    sAx5: function (e, t, a) {
      ...
      function w(e) {
        ...
        return {
          ...
          errorOutlineColor: t.borderDanger,
          placeholderColor: t.textDark,
          smallFontSize: a.fontSizeSmall,
          smallHeight: i.inputHeightSmall,
          mediumFontSize: a.fontSizeMedium,
          mediumHeight: i.inputHeightMedium,
          largeFontSize: a.fontSizeLarge,
          largeHeight: i.inputHeightLarge,
        };
      }
      w.canvas = function (e) {
      ...
      var A = {
        componentId: "bwOAM",
        template: function (e) {
          return "\n\n.bwOAM_byIz{display:block;position:relative}\n\n.bwOAM_dnnz{align-items:center;display:flex;fill:"
            .concat(e.iconColor || "inherit", ";height:100%;inset-inline-end:")
            .concat(
              e.padding || "inherit",
              ";inset-inline-start:auto;pointer-events:none;position:absolute;top:0}\n\n[dir=ltr] .bwOAM_dnnz{left:auto;right:"
            )
            .concat(e.padding || "inherit", "}\n\n[dir=rtl] .bwOAM_dnnz{left:")
            .concat(
              e.padding || "inherit",
              ";right:auto}\n\n.bwOAM_cPAP{border:"
            )
            ...
            .concat(
              e.background || "inherit",
              ";border:medium none currentColor;border:"
            )
            .concat(e.borderWidth || "inherit", " ")
            .concat(e.borderStyle || "inherit", " ")
            .concat(
              e.borderColor || "inherit",
              ";border-collapse:separate;border-image:none;border-radius:0;border-radius:"
            )
            .concat(
              e.borderRadius || "inherit",
              ";border-spacing:0;bottom:auto;box-shadow:none;box-sizing:content-box;box-sizing:border-box;caption-side:top;clear:none;clip:auto;color:#000;color:"
            )
            .concat(
              e.color || "inherit",
              ";column-count:auto;column-fill:balance;column-gap:normal;column-rule:medium none currentColor;column-span:1;column-width:auto;columns:auto;content:normal;counter-increment:none;counter-reset:none;cursor:auto;direction:ltr;display:inline;display:block;empty-cells:show;float:none;font-family:serif;font-family:"
            ...
            .concat(
              e.padding || "inherit",
              ";page-break-after:auto;page-break-before:auto;page-break-inside:auto;perspective:none;perspective-origin:50% 50%;position:static;right:auto;tab-size:8;table-layout:auto;text-align:left;text-align-last:auto;text-decoration:none;text-indent:0;text-shadow:none;text-transform:none;top:auto;transform:none;transform-origin:50% 50% 0;transform-style:flat;transition:none 0s ease 0s;transition:all 0.2s;unicode-bidi:normal;vertical-align:baseline;visibility:visible;white-space:normal;widows:2;width:auto;width:100%;word-spacing:normal;z-index:auto}\n\n.bwOAM_cwos::-ms-clear,input[type].bwOAM_cwos::-ms-clear{display:none}\n\n.bwOAM_cwos:focus,input[type].bwOAM_cwos:focus{box-shadow:none}\n\n.bwOAM_cwos:focus~.bwOAM_cPAP,input[type].bwOAM_cwos:focus~.bwOAM_cPAP{opacity:1;transform:scale(1)}\n\n.bwOAM_cwos[aria-invalid],.bwOAM_cwos[aria-invalid]:focus,.bwOAM_cwos[aria-invalid]~.bwOAM_cPAP,input[type].bwOAM_cwos[aria-invalid],input[type].bwOAM_cwos[aria-invalid]:focus,input[type].bwOAM_cwos[aria-invalid]~.bwOAM_cPAP{border-color:"
            )
            .concat(
              e.errorBorderColor || "inherit",
              "}\n\n.bwOAM_cwos:-ms-input-placeholder,input[type].bwOAM_cwos:-ms-input-placeholder{color:"
            )
            .concat(
              e.placeholderColor || "inherit",
              "}\n\n.bwOAM_cwos::placeholder,input[type].bwOAM_cwos::placeholder{color:"
            )
            .concat(
              e.placeholderColor || "inherit",
              "}\n\n.bwOAM_cwos.bwOAM_ywdX,input[type].bwOAM_cwos.bwOAM_ywdX{cursor:not-allowed;opacity:0.5;pointer-events:none}\n\n.bwOAM_cwos.bwOAM_doqw,input[type].bwOAM_cwos.bwOAM_doqw{font-size:"
            )
            .concat(e.smallFontSize || "inherit", ";height:")
            .concat(
              e.smallHeight || "inherit",
              "}\n\n.bwOAM_cwos.bwOAM_ycrn,input[type].bwOAM_cwos.bwOAM_ycrn{font-size:"
            )
            .concat(e.mediumFontSize || "inherit", ";height:")
            .concat(
              e.mediumHeight || "inherit",
              "}\n\n.bwOAM_cwos.bwOAM_cMDj,input[type].bwOAM_cwos.bwOAM_cMDj{font-size:"
            )
            .concat(e.largeFontSize || "inherit", ";height:")
            .concat(
              e.largeHeight || "inherit",
              "}\n\n.bwOAM_cwos.bwOAM_Suqk,input[type].bwOAM_cwos.bwOAM_Suqk{-webkit-padding-end:calc("
            )
            .concat(e.padding || "inherit", "*2 + 1em);-webkit-padding-start:")
            .concat(e.padding || "inherit", ";padding-inline-end:calc(")
            .concat(e.padding || "inherit", "*2 + 1em);padding-inline-start:")
            .concat(
              e.padding || "inherit",
              "}\n\n[dir=ltr] .bwOAM_cwos.bwOAM_Suqk,[dir=ltr] input[type].bwOAM_cwos.bwOAM_Suqk{padding-left:"
            )
            .concat(e.padding || "inherit", ";padding-right:calc(")
            .concat(
              e.padding || "inherit",
              "*2 + 1em)}\n\n[dir=rtl] .bwOAM_cwos.bwOAM_Suqk,[dir=rtl] input[type].bwOAM_cwos.bwOAM_Suqk{padding-left:calc("
            )
            .concat(e.padding || "inherit", "*2 + 1em);padding-right:")
            .concat(
              e.padding || "inherit",
      ...
      var T =
        ((x = Object(p["a"])(
          "7.0.0",
          null,
          "Use TextInput from ui-text-input instead."
        )),
        (j = Object(y["a"])()),
        (O = Object(k["j"])(w, A)),
        x(
                ...
                O(
                  (S =
                        ...
                        Object(i["a"])(a, [
                          ...
                          },
                          {
                            ...
                            value: function () {
                              ...
                              var k =
                                ((e = {}),
                                Object(r["a"])(e, A.input, true),
                                Object(r["a"])(e, A[i], i),
                                Object(r["a"])(
                                  e,
                                  A["textAlign--".concat(o)],
                                  o
                                ),
                                Object(r["a"])(e, A.hasIcon, p),
                                Object(r["a"])(e, A.disabled, d),
                                e);
                              var y = m ? { width: m } : null;
                              var w = "";
                              v["aria-describedby"] &&
                                (w = "".concat(v["aria-describedby"]));
                              this.hasMessages && (w += this._messagesId);
                              return l.a.createElement(
                                b["a"],
                                Object.assign(
                                  {},
                                  Object(g["c"])(this.props, b["a"].propTypes),
                                  { id: this.id, messagesId: this._messagesId }
                                ),
                                l.a.createElement(
                                  "span",
                                  { className: A.layout },
                    ...
                    (z.propTypes = {
                      ...
                      label: d.a.node.isRequired,
                      id: d.a.string,
                      messages: d.a.arrayOf(b["e"].message),
                      size: d.a.oneOf(["small", "medium", "large"]),
                      layout: d.a.oneOf(["stacked", "inline"]),
                      textAlign: d.a.oneOf(["start", "center"]),
                      width: d.a.string,
                      inline: d.a.bool,
                      ...
                      required: d.a.bool,
                      inputRef: d.a.func,
                      defaultValue: d.a.string,
                      value: Object(f["a"])(d.a.string),
                      icon: d.a.func,
                    }),
                    (z.defaultProps = {
                      id: void 0,
    ...
    srvI: function (e, t, a) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: true });
      t.calculateChange = function (e, t, a, r) {
        var n = r.clientWidth;
        ...
        if ("vertical" === t) {
          ...
          if (a.h !== c) return { h: c, s: a.s, l: a.l, a: a.a, source: "hsl" };
        } else {
          var u = void 0;
          if (_ < 0) u = 0;
          else if (_ > n) u = 359;
          ...
          if (a.h !== u) return { h: u, s: a.s, l: a.l, a: a.a, source: "hsl" };
        }
        return null;
      };
    },
    ...
    t2Dn: function (e, t, a) {
      var r = a("hypo"),
        n = a("ljhN");
      function i(e, t, a) {
        ((void 0 !== a && !n(e[t], a)) || (void 0 === a && !(t in e))) &&
          r(e, t, a);
      }
      e.exports = i;
    },
    t6i0: function (e, t) {
      ...
      e.exports = function (e) {
        ...
        return {
          top: r(t.top + n.top),
          left: r(t.left + n.left),
          width: r(t.right - t.left),
          height: r(t.bottom - t.top),
        };
      };
    },
    uKUS: function (e, t, a) {
      ...
      var p = (function (e) {
        ...
        function t() {
          ...
          return (
            (n =
              ((a = ((r = b(this, e.call.apply(e, [this].concat(o)))), r)),
              (r.state = {
                assertiveMessage1: "",
                assertiveMessage2: "",
                politeMessage1: "",
              ...
              (r.setAlternatePolite = false),
              (r.setAlternateAssertive = false),
              a)),
            b(r, n)
          );
        }
        t.prototype.componentWillReceiveProps = function (e) {
          var t = this.props,
            a = t.politeMessage,
            r = t.assertiveMessage;
          var n = e.politeMessage,
            i = e.assertiveMessage;
          if (a !== n) {
            this.setState({
              politeMessage1: this.setAlternatePolite ? "" : n,
              politeMessage2: this.setAlternatePolite ? n : "",
            });
            this.setAlternatePolite = !this.setAlternatePolite;
          }
          if (r !== i) {
            this.setState({
              assertiveMessage1: this.setAlternateAssertive ? "" : i,
              assertiveMessage2: this.setAlternateAssertive ? i : "",
            });
        ...
        t.prototype.render = function () {
          ...
          return n.a.createElement(
            "div",
            null,
            n.a.createElement(h, { "aria-live": "assertive", message: t }),
            n.a.createElement(h, { "aria-live": "assertive", message: a }),
            n.a.createElement(h, { "aria-live": "polite", message: r }),
            n.a.createElement(h, { "aria-live": "polite", message: i })
          );
        };
        return t;
      })(r["Component"]);
      ...
      var j =
        ((k = v =
          (function (e) {
            ...
            t.prototype.announcePolite = function (e) {
              this.setState({ announcePoliteMessage: e });
            };
            t.prototype.announceAssertive = function (e) {
              this.setState({ announceAssertiveMessage: e });
            };
            t.prototype.render = function () {
              var e = this.state,
                t = e.announcePoliteMessage,
                a = e.announceAssertiveMessage;
              return n.a.createElement(
                "div",
                null,
                n.a.createElement(g, { assertiveMessage: a, politeMessage: t }),
                this.props.children
              );
            };
            return t;
        ...
        (v.childContextTypes = {
          announcePolite: c.a.func.isRequired,
          announceAssertive: c.a.func.isRequired,
        }),
        k);
      var O = j;
      var S, z;
        ...
        ((z = S =
          (function (e) {
            ...
            t.prototype.componentWillUnmount = function () {
              var e = this.props.clearOnUnmount;
              if (true === e || "true" === e) {
                this.context.announceAssertive("");
                this.context.announcePolite("");
              }
            };
            t.prototype.announce = function () {
              var e = this.props,
                t = e.message,
                a = e["aria-live"];
      ...
      function _e() {
        ...
        return n.a.createElement("div", { style: e });
      }
      var le = a("BKMn");
      var ce = a.n(le);
      function de(e) {
        return n.a.createElement(
          ...
          n.a.createElement(
            "div",
            { style: { position: "relative", height: 150, marginTop: 10 } },
            n.a.createElement(
              se["Saturation"],
              Object.assign({}, e, { pointer: ce.a })
            )
          ),
          n.a.createElement(
            "div",
            { style: { position: "relative", height: 10, marginTop: 10 } },
            n.a.createElement(se["Hue"], Object.assign({}, e, { pointer: _e }))
          ),
          n.a.createElement(
            "div",
            { style: { position: "relative", height: 10, marginTop: 10 } },
            n.a.createElement(
              se["Alpha"],
              Object.assign({}, e, { pointer: _e })
            )
          )
        );
      }
      var ue = Object(se["ColorWrap"])(de);
      class he extends n.a.Component {
        constructor() {
          ...
          this.handlePickerChange = (e) => {
            this.props.onChange({
              target: { name: this.props.name, value: he.stringifyRGBA(e.rgb) },
            });
          };
        }
        static stringifyRGBA(e) {
          if (1 === e.a)
        ...
        componentDidMount() {
          this.setState({ width: o.a.findDOMNode(this).offsetWidth });
        }
        render() {
          return n.a.createElement(
            F["a"],
            { as: "div" },
            n.a.createElement(V["a"], this.props),
            n.a.createElement(ue, {
              color: oe.a.parseRGBA(this.props.value),
      ...
      function fe() {
        return n.a.createElement(
          "svg",
          { viewBox: "0 0 245 310", xmlns: "http://www.w3.org/2000/svg" },
          n.a.createElement(
            "g",
      ...
      function Oe(e) {
        ...
        switch (e.tagName) {
          case "IMG":
            return ye("Image with filename {file}", { file: we(e.src) });
          case "TABLE":
            return ye("Table starting with {start}", {
              start: xe(e.textContent, je),
            });
          case "A":
            return ye("Link with text starting with {start}", {
              start: xe(e.textContent, je),
            });
          case "P":
            return ye("Paragraph starting with {start}", {
              start: xe(e.textContent, je),
            });
          case "TH":
            return ye("Table header starting with {start}", {
              start: xe(e.textContent, je),
            });
          case "H1":
          case "H2":
          ...
          case "H4":
          case "H5":
            return ye("Heading starting with {start}", {
              start: xe(e.textContent, je),
            });
          default:
            return ye("Element starting with {start}", {
              start: xe(e.textContent, je),
            });
        }
      }
      ...
      function Ae(e, t) {
        let a =
          arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : ze.a;
      ...
      function Ee(e, t) {
        ...
        n.setAttribute(
          ...
          "\n    border: 2px solid #000;\n    background-color: #008EE2;\n    position: absolute;\n    display: block;\n    borderRadius: 5px;\n    z-index: 9998;\n    left: "
            .concat(i.left - a, "px;\n    top: ")
            .concat(i.top - a, "px;\n    width: ")
            .concat(i.width + 2 * a, "px;\n    height: ")
            .concat(i.height + 2 * a, "px;\n    opacity: 0.5;\n  ")
        );
        ...
        const o = () => {
          ...
          if (e.top < 0) {
            const t = i.height + e.top;
            t < 0 && (n.style.display = "none");
            const a = i.height - t;
            n.style.height = "".concat(t, "px");
            n.style.marginTop = "".concat(a, "px");
          }
          if (e.bottom > s.height) {
            const t = i.height + (s.height - e.bottom);
            t < 0 && (n.style.display = "none");
            n.style.height = "".concat(t, "px");
          }
      ...
      function Fe(e, t) {
        const a = e.ownerDocument.createElement(t);
        while (e.firstChild) a.appendChild(e.firstChild);
        for (let t = e.attributes.length - 1; t >= 0; --t)
          a.attributes.setNamedItem(e.attributes[t].cloneNode());
      ...
      function De(e) {
        ...
        return !!t.length && t[0].textContent === e.textContent;
      }
      function We(e) {
        const t = e.split(";");
        return t.reduce((e, t) => {
      ...
      function Ue(e) {
        ...
        return t.some((e) => e.nodeType === Node.TEXT_NODE);
      }
      var Ke = {
        id: "img-alt",
        test: (e) => {
          if ("IMG" !== e.tagName) return true;
          const t = e.getAttribute("alt");
          const a = e.hasAttribute("data-decorative");
          return (t && "" !== t.replace(/\s/g, "")) || a;
        },
        data: (e) => {
          const t = e.getAttribute("alt");
          const a = e.hasAttribute("data-decorative");
          return { alt: t || "", decorative: !t && a };
        },
        form: () => [
          {
            label: ye("Add alt text for the image"),
            dataKey: "alt",
            disabledIf: (e) => e.decorative,
          },
          {
            label: ye("Decorative image"),
            dataKey: "decorative",
            checkbox: true,
          },
        ],
        update: (e, t) => {
          if (t.decorative) {
            e.setAttribute("alt", "");
            e.setAttribute("data-decorative", "true");
          } else {
            e.setAttribute("alt", t.alt);
            e.removeAttribute("data-decorative");
          }
          return e;
        },
        message: () =>
        ...
        linkText: () => ye("Learn more about using alt text for images"),
      };
      a("x1Tw");
      const Ve = /^\S+\.\S+$/;
      var Ge = {
        id: "img-alt-filename",
        test: (e) => !Ve.test(e.getAttribute("alt")),
        data: (e) => {
          const t = e.getAttribute("alt");
          return { alt: t || "" };
        },
        form: () => [{ label: ye("Change alt text"), dataKey: "alt" }],
        update: (e, t) => {
          e.setAttribute("alt", t.alt);
          return e;
        },
        ...
        linkText: () => ye("Learn more about using filenames as alt text"),
      };
      var Ze = {
        id: "table-caption",
        test: (e) => {
          if ("TABLE" !== e.tagName) return true;
          const t = e.querySelector("caption");
          return !!t && "" !== t.textContent.replace(/\s/g, "");
        },
        data: (e) => ({ caption: "" }),
        form: () => [{ label: ye("Add a caption"), dataKey: "caption" }],
        update: (e, t) => {
          let a = e.querySelector("caption");
          if (!a) {
            a = e.ownerDocument.createElement("caption");
            Ne(e, a);
          }
        ...
        linkText: () => ye("Learn more about using captions with tables"),
      };
      ...
      var Ye = {
        ...
        test: (e) => {
          if ("TABLE" !== e.tagName) return true;
          return e.querySelector("th");
        },
        data: (e) => ({ header: "none" }),
        form: () => [
          {
            label: ye("Set table header"),
            dataKey: "header",
            options: [
              ["none", ye("No headers")],
              ["row", ye("Header row")],
              ["col", ye("Header column")],
              ["both", ye("Header row and column")],
            ],
          },
        ],
        update: (e, t) => {
          Xe.call(e.querySelectorAll("th"), (e) => {
            Fe(e, "td");
          });
          ...
          for (let e = 0; e < n.length; ++e) {
            if (0 === e && a) {
              Xe.call(n[e].querySelectorAll("td"), (e) => {
                const t = Fe(e, "th");
        ...
        message: () => ye("Tables should include at least one header."),
        why: () =>
          ye(
        ...
        linkText: () => ye("Learn more about table headers"),
      };
      const Qe = ["row", "col", "rowgroup", "colgroup"];
      var Je = {
        id: "table-header-scope",
        test: (e) => {
          if ("TH" !== e.tagName) return true;
          return -1 !== Qe.indexOf(e.getAttribute("scope"));
        },
        data: (e) => ({ scope: e.getAttribute("scope") || "none" }),
        form: () => [
          {
            label: ye("Set header scope"),
            dataKey: "scope",
            options: [
              ["none", ye("None")],
              ["row", ye("Row")],
              ["col", ye("Column")],
              ["rowgroup", ye("Row group")],
              ["colgroup", ye("Column group")],
            ],
          },
        ],
        update: (e, t) => {
          "none" === t.header
            ...
            : e.setAttribute("scope", t.scope);
          return e;
        },
        message: () => ye("Tables headers should specify scope."),
        why: () =>
          ye(
        ...
        linkText: () =>
          ye("Learn more about using scope attributes with tables"),
      };
      var $e = a("IF+P");
      var et = a.n($e);
      var tt = {
        ...
        form: () => [
          { label: ye("Change text color"), dataKey: "color", color: true },
        ],
        update: (e, t) => {
          e.style.color = t.color;
          const a = We(e.getAttribute("data-mce-style") || "");
          t && t.color && t.color.indexOf("#") < 0
            ? (a.color = "#".concat(et()(t.color)))
            : (a.color = t.color);
        ...
        linkText: () => ye("Learn more about color contrast"),
      };
      var at = {
      ...
      const rt = (e, t) => {
        if (!e || !t || "A" !== e.tagName || "A" !== t.tagName) return false;
        return e.getAttribute("href") === t.getAttribute("href");
      };
      const nt = (e) =>
        e.nodeType !== Node.TEXT_NODE || e.textContent.match(/\S/);
      const it = (e) => {
      ...
      const _t = (e, t) => {
        let a = ot(e);
        let r = ot(t);
        return a && !r && st(a.getAttribute("alt")) === st(t.textContent)
          ? a
          : r && !a && st(r.getAttribute("alt")) === st(e.textContent)
          ? r
          : null;
      };
      var lt = {
        id: "adjacent-links",
        test: function (e) {
          if ("A" != e.tagName) return true;
          return !rt(e, e.nextElementSibling);
        },
        data: (e) => ({ combine: false }),
        form: () => [
          { label: ye("Merge links"), checkbox: true, dataKey: "combine" },
        ],
        update: function (e, t) {
          ...
          if (t.combine) {
            ...
            const r = _t(e, t);
            if (r) {
              r.setAttribute("data-decorative", "true");
              r.setAttribute("alt", "");
            }
            a.removeChild(t);
            e.innerHTML += " ".concat(t.innerHTML);
          }
          return e;
        },
        rootNode: function (e) {
        ...
        message: () =>
          ye("Adjacent links with the same URL should be a single link."),
        why: () =>
          ye(
        ...
        linkText: () => ye("Learn more about adjacent links"),
      };
      const ct = (e) => {
        const t = {
          H1: true,
      ...
      const dt = (e) => {
        const t = Array.prototype.slice.call(
          e.querySelectorAll("H1,H2,H3,H4,H5,H6")
        );
      ...
      var gt = {
        ...
        test: (e) => {
          const t = { H2: true, H3: true, H4: true, H5: true, H6: true };
        ...
        data: (e) => ({ action: "nothing" }),
        form: () => [
          {
            label: ye("Action to take:"),
            dataKey: "action",
            options: [
              ["nothing", ye("Leave as is")],
              ["elem", ye("Fix heading hierarchy")],
              ["modify", ye("Remove heading style")],
            ],
          },
        ],
        update: (e, t) => {
          if (!t || !t.action || "nothing" === t.action) return e;
          switch (t.action) {
            case "elem": {
              const t = mt(e);
              const a = t ? +t.tagName.substring(1) : 0;
              return Fe(e, "H".concat(a + 1));
            }
            case "modify":
              return Fe(e, "p");
          }
        },
        message: () => ye("Heading levels should not be skipped."),
        why: () =>
          ye(
        ...
        linkText: () => ye("Learn more about organizing page headings"),
      };
      const vt = 120;
      var kt = {
        "max-alt-length": vt,
        ...
        form: () => [
          { label: ye("Change alt text"), dataKey: "alt", textarea: true },
        ],
        update: (e, t) => {
          e.setAttribute("alt", t.alt);
          return e;
        ...
        message: () =>
          ye("Alt attribute text should not contain more than 120 characters."),
        why: () =>
          ye(
      ...
      var xt = {
        "max-heading-length": yt,
        id: "paragraphs-for-headings",
        test: (e) => {
          if (!wt[e.tagName]) return true;
          return e.textContent.length <= yt;
        },
        data: (e) => ({ change: false }),
        form: () => [
          {
            label: ye("Change heading tag to paragraph"),
            checkbox: true,
            dataKey: "change",
          },
        ],
        ...
        message: () =>
          ye("Headings should not contain more than 120 characters."),
        why: () =>
          ye(
      ...
      const At = (e) => {
        if (e.nodeType === Node.TEXT_NODE) {
          e.textContent = e.textContent.replace(zt, "");
          return true;
        }
      ...
      const Et = (e) => {
        ...
        while (a) {
          let e = t[t.length - 1];
          if ("BR" === a.tagName) {
            t.push(document.createElement("p"));
            a = a.nextSibling;
            continue;
          }
          e && e.appendChild(a);
      ...
      var Mt = {
        ...
        data: (e) => {
          const t = e.textContent.match(zt);
          return { orderedStart: t[1] ? t[1] : null, formatAsList: false };
        },
        form: () => [
          {
            label: ye("Format as a list"),
            checkbox: true,
        ...
        update: function (e, t) {
          const a = e.parentNode;
          if (t.formatAsList) {
            const r = Boolean(t.orderedStart);
            const n = document.createElement(r ? "ol" : "ul");
            if (r) {
              n.setAttribute("type", t.orderedStart);
              n.setAttribute("start", t.orderedStart);
            }
            let i = e;
            while (i) {
              if (!Ct(i)) break;
        ...
        message: () => ye("Lists should be formatted as lists."),
        why: () =>
          ye(
        ...
        linkText: () => ye("Learn more about using lists"),
      };
      ...
      class Rt extends n.a.Component {
        constructor() {
          ...
          this.updateFormState = (e) => {
            ...
            this.setState({
              formState: a,
              formStateValid: this.formStateValid(a),
            });
          };
        }
        componentDidMount() {
          this.props.editor.on("Remove", (e) => {
        ...
        check(e) {
          ...
          this.setState(
            { open: true, checking: true, errors: [], errorIndex: 0 },
            () => {
              "function" === typeof this.state.config.beforeCheck
                ? this.state.config.beforeCheck(this.props.editor, () => {
                    this._check(() => {
                      "function" === typeof this.state.config.afterCheck
                        ? this.state.config.afterCheck(this.props.editor, e)
                        : e();
                    });
                  })
                : "function" === typeof this.state.config.afterCheck
        ...
        _check(e) {
          const t = this.props.getBody();
          const a = [];
          t &&
            Re(
              t,
              (e) => {
                const t = Lt.concat(this.props.additionalRules);
                for (let r of t) {
                  if (e.hasAttribute("data-ignore-a11y-check")) continue;
                  Promise.resolve(r.test(e, this.state.config)).then((t) => {
                    t || a.push({ node: e, rule: r });
                  });
                }
              },
              () => {
                this.setState(
                  { errorIndex: 0, errors: a, checking: false },
                  () => {
                    this.selectCurrent();
                    e();
                  }
        ...
        firstError() {
          this.state.errors.length > 0 && this.setErrorIndex(0);
        }
        nextError() {
          const e = (this.state.errorIndex + 1) % this.state.errors.length;
          this.setErrorIndex(e);
        }
        prevError() {
          const e = this.state.errors.length;
          const t = (e + this.state.errorIndex - 1) % e;
          this.setErrorIndex(t);
        }
        setErrorIndex(e) {
          this.onLeaveError();
          e >= this.state.errors.length && (e = 0);
          this.setState({ errorIndex: e }, () => this.selectCurrent());
        }
        selectCurrent() {
          Te();
          ...
          if (e) {
            this.getFormState();
            Ie(this.props.editor, e);
          } else this.firstError();
        }
        error() {
        ...
        getFormState() {
          ...
          e &&
            t &&
            this.setState({ formState: e.data(t), formStateValid: false });
        }
        formStateValid(e) {
          e = e || this.state.formState;
        ...
        fixIssue() {
          ...
          if (e && t) {
            ...
            this.check(() => this.setErrorIndex(a));
          }
        }
        newTempRootNode(e) {
        ...
        tempNode() {
          let e =
            arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
          if (!this._tempNode || e) {
            const t = this.errorRootNode();
            if (t) {
              const a = this.newTempRootNode(t);
              if (e && this._tempNode) {
                const e = this._tempNode.parentNode;
        ...
        removeTempNode() {
          const e = this.errorRootNode();
          if (this._tempNode && e) {
            const t = this._tempNode.parentNode;
          ...
          return n.a.createElement(
            ...
            n.a.createElement(
              I["a"],
              {
                ...
                label: ye("Accessibility Checker"),
              ...
              n.a.createElement(
                P["a"],
                {
                  ...
                  buttonRef: (e) => (this._closeButtonRef = e),
                },
                ye("Close Accessibility Checker")
              ),
              n.a.createElement(
                F["a"],
                { as: "div", padding: "x-large large" },
                n.a.createElement(
                  q["a"],
                  { level: "h3", as: "h2", margin: "medium 0" },
                  " " + ye("Accessibility Checker")
                ),
                this.state.errors.length > 0 &&
                  n.a.createElement(
                    ...
                    n.a.createElement(
                      F["a"],
                      { as: "div", margin: "large 0 medium 0" },
                      n.a.createElement(
                        G["a"],
                        {
                          vAlign: "middle",
                        ...
                        n.a.createElement(
                          ...
                          n.a.createElement(
                            X["a"],
                            null,
                            n.a.createElement(B["a"], { weight: "bold" }, t)
                          ),
                          n.a.createElement(
                            X["a"],
                            { width: "auto" },
                            n.a.createElement(
                              ...
                              n.a.createElement(
                                ...
                                n.a.createElement(
                                  ...
                                  n.a.createElement(L["a"], null, ye("Why"))
                                )
                              ),
                              n.a.createElement(
                                N["a"].Content,
                                ...
                                n.a.createElement(
                                  ...
                                  n.a.createElement(
                                    B["a"],
                                    null,
                                    n.a.createElement("p", null, e.why()),
                                    n.a.createElement(
                                      "p",
                                      null,
                                      e.link &&
                    ...
                    n.a.createElement(
                      ...
                      e
                        ...
                        .map((e) =>
                          n.a.createElement(
                            F["a"],
                            { as: "div", key: e.dataKey, margin: "medium 0 0" },
                            this.renderField(e)
                          )
                        ),
                      n.a.createElement(
                        F["a"],
                        { as: "div", margin: "medium 0" },
                        n.a.createElement(
                          G["a"],
                          {
                            vAlign: "middle",
                  ...
                  n.a.createElement(
                    ...
                    n.a.createElement(
                      ...
                      n.a.createElement(
                        "p",
                        null,
                        ye("No accessibility issues were detected.")
                      )
                    ),
                ...
                this.state.checking &&
                  n.a.createElement(
                    ...
                    null,
                    n.a.createElement(M, {
                      message: ye("Checking for accessibility issues"),
                      "aria-live": "polite",
                    }),
                    n.a.createElement(W["a"], {
                      renderTitle: () =>
                        ye("Checking for accessibility issues"),
                      margin: "medium auto",
                    })
                  )
              )
        ...
        renderField(e) {
          const t = !!e.disabledIf && e.disabledIf(this.state.formState);
          switch (true) {
            case !!e.options:
              return n.a.createElement(
                H["a"],
                {
                  label: e.label,
                  selectedOption: this.state.formState[e.dataKey] && {
                    value: this.state.formState[e.dataKey],
                  },
                  onChange: (t, a) => {
                    this.updateFormState({
                      target: { name: e.dataKey, value: a.value },
                    });
                  },
                  disabled: t,
                },
                e.options.map((e) =>
                  n.a.createElement("option", { key: e[0], value: e[0] }, e[1])
                )
              );
            case e.checkbox:
              return n.a.createElement(U["a"], {
                label: e.label,
                name: e.dataKey,
                checked: this.state.formState[e.dataKey],
      ...
      Rt.defaultProps = { additionalRules: [] };
      let It;
      const Nt = [];
      ...
      tinymce.create("tinymce.plugins.AccessibilityChecker", {
        init: function (e) {
          e.addCommand("openAccessibilityChecker", function () {
            for (var t = arguments.length, a = new Array(t), r = 0; r < t; r++)
              a[r] = arguments[r];
            o.a.render(
              n.a.createElement(Rt, { getBody: e.getBody.bind(e), editor: e }),
              Ft,
              function () {
                It = this;
                Nt.forEach((e) => e(It));
          ...
          "4" === tinymce.majorVersion
            ? e.addButton("check_a11y", {
                title: ye("Check Accessibility"),
                cmd: "openAccessibilityChecker",
                icon: "a11y",
              })
            : e.ui.registry.addButton("check_a11y", {
                title: ye("Check Accessibility"),
                onAction: (t) => e.execCommand("openAccessibilityChecker"),
                icon: "a11y",
              });
        },
      });
      tinymce.PluginManager.add(
        "a11y_checker",
        tinymce.plugins.AccessibilityChecker
      );
      function qt(e) {
        if (null != It) return e(It);
        Nt.push(e);
      }
      function Bt(e) {
        const t = ye.setup();
      ...
      const Vt = () => {};
      function Gt(e = {}, t = Vt) {
        const a = Array.from(e.dom.doc.styleSheets),
          r = Kt(a),
          n = (r[0], r.slice(1));
        ...
        const _ = () => {
          o === i.length ? t() : setTimeout(_, 100);
        };
        i.forEach((t) => {
          e.dom.styleSheetLoader.load(t, s);
        });
        _();
      }
      function Zt(e = {}, t = Vt) {
        Array.from(e.dom.doc.styleSheets).forEach((e) => {
          window.ENV.url_for_high_contrast_tinymce_editor_css.includes(e.href)
            ? e.ownerNode.parentElement.removeChild(e.ownerNode)
            : (e.disabled = false);
        });
        t();
      }
      qt((e) => e.setConfig({ beforeCheck: Gt, afterCheck: Zt }));
      if (ENV && ENV.LOCALE) {
        let e = ENV.LOCALE;
        "zh-Hant" === e && (e = "zh-HK");
        Bt(e);
    ...
    xEkU: function (e, t, a) {
      (function (t) {
        var r = a("bQgK"),
          ...
          o = "AnimationFrame",
          s = n["request" + o],
          _ = n["cancel" + o] || n["cancelRequest" + o];
        for (var l = 0; !s && l < i.length; l++) {
          s = n[i[l] + "Request" + o];
          _ = n[i[l] + "Cancel" + o] || n[i[l] + "CancelRequest" + o];
        }
        if (!s || !_) {
          var c = 0,
            d = 0,
          ...
          s = function (e) {
            ...
            u.push({ handle: ++d, callback: e, cancelled: false });
            return d;
          };
          _ = function (e) {
            for (var t = 0; t < u.length; t++)
              u[t].handle === e && (u[t].cancelled = true);
          };
        }
        e.exports = function (e) {
          return s.call(n, e);
          ...
          },
          {
            ...
            value: function () {
              ...
              return o.default.createElement(
                ...
                o.default.createElement("div", { style: a.gradient }),
                o.default.createElement(
                  "div",
                  {
                    style: a.container,
                  ...
                  o.default.createElement(
                    ...
                    this.props.pointer
                      ...
                      : o.default.createElement("div", { style: a.slider })
                  )
                )
              );
            },
    ...
    zpiH: function (e, t, a) {
      ...
      var F =
        ((T = Object(v["a"])(
          "7.0.0",
          null,
          "Use Popover from ui-popover instead."
        )),
        (E = Object(y["a"])()),
        (M = Object(f["a"])()),
        T(
              ...
              (L =
                M(
                  (L =
                    ((R = P =
                      (function (e) {
                        ...
                        function a() {
                          ...
                          e.show = function (t) {
                            e._popover && e._popover.show(t);
                          };
                          e.hide = function (t, a) {
                            e._popover && e._popover.hide(t, a);
                          };
                          e.toggle = function (t) {
                            e._popover && e._popover.toggle(t);
                          };
                          return e;
                        }
                        Object(n["a"])(a, [
                          ...
                          },
                          {
                            ...
                            get: function () {
                              return (
                                this._popover &&
                                this._popover.defaultFocusElement
                              );
                            },
                          },
                        ]);
                    ...
                    (P.Content = N),
                    (P.propTypes = {
                      children: b["a"].oneOf([I, N]),
                      placement: u["a"].placement,
                      on: d.a.oneOfType([
                        d.a.oneOf(["click", "hover", "focus"]),
                        d.a.arrayOf(d.a.oneOf(["click", "hover", "focus"])),
                      ]),
                      variant: d.a.oneOf(["default", "inverse"]),
                      shadow: k["c"].shadow,
                      stacking: k["c"].stacking,
                      defaultShow: d.a.bool,
                      show: Object(m["a"])(d.a.bool, "onToggle", "defaultShow"),
                      contentRef: d.a.func,
                      onToggle: d.a.func,
                      onClick: d.a.func,
                      onFocus: d.a.func,
                      ...
                      withArrow: d.a.bool,
                      label: d.a.string,
                      defaultFocusElement: d.a.oneOfType([
                        d.a.element,
                        d.a.func,
                      ]),
                      shouldRenderOffscreen: d.a.bool,
                      shouldContainFocus: d.a.bool,
                      shouldReturnFocus: d.a.bool,
                      shouldCloseOnDocumentClick: d.a.bool,
                      shouldCloseOnEscape: d.a.bool,
                      offsetX: d.a.oneOfType([d.a.string, d.a.number]),
                      offsetY: d.a.oneOfType([d.a.string, d.a.number]),
                      onPositionChanged: d.a.func,
                      onPositioned: d.a.func,
                      trackPosition: d.a.bool,
                      constrain: u["a"].constrain,
                      mountNode: u["a"].mountNode,
                      insertAt: d.a.oneOf(["bottom", "top"]),
                      liveRegion: d.a.oneOfType([
                        d.a.arrayOf(d.a.element),
                        d.a.element,
                        d.a.func,
                      ]),
                      positionTarget: d.a.oneOfType([p["a"], d.a.func]),
                      alignArrow: d.a.bool,
                      id: d.a.string,
                      shouldFocusContentOnTriggerBlur: d.a.bool,
                    }),
                    (P.defaultProps = {
                      children: null,
                      onToggle: function (e) {},
