(window["canvasWebpackJsonp"] = window["canvasWebpackJsonp"] || []).push([
  [158],
  {
      ...
      t["a"] = p = {
        quoteClump: function (e) {
          return (
            ...
            Object(a["a"])(l.t("quoted_text_toggle", "show quoted text")) +
        ...
        formatMessage: function (e) {
          ...
          e = Object(a["a"])(e);
          e = e.replace(new RegExp(_, "g"), function (e, t) {
            return o.shift();
          });
          e = e.replace(/\n/g, "<br />\n");
          n = [];
          ...
          for (t = 0, r = d.length; t < r; t++) {
            ...
            if (s.match(/^(&gt;|>)/)) l.push(s);
              ...
              l.length && n.push(p.quoteClump(l));
              l = [];
              n.push(s);
            }
          }
    ...
    "1xB4": function (e, t, r) {
      ...
      class n {
        static fromJSON(e) {
          const t = new n(e.event_type, e.event_data);
        ...
        isPendingDelivery() {
          return this._state === s.EVT_STATE_PENDING_DELIVERY;
        }
        isBeingDelivered() {
          return this._state === s.EVT_STATE_IN_DELIVERY;
        }
        wasDelivered() {
          return this._state === s.EVT_STATE_DELIVERED;
        }
        toJSON() {
          return {
      ...
      class l {
        ...
        markPendingDelivery() {
          return this._events.forEach(
            (e) => (e._state = s.EVT_STATE_PENDING_DELIVERY)
          );
        }
        markBeingDelivered() {
          return this._events.forEach(
            (e) => (e._state = s.EVT_STATE_IN_DELIVERY)
          );
        }
        toJSON() {
      ...
      class p {
        static setStorageAdapter(e) {
          if (-1 === u.indexOf(e))
            throw new Error(
              `Unsupported storage adapter "${e}". Available adapters are:\n${u.join(
                ", "
              )}`
            );
          return (p.STORAGE_ADAPTER = e);
        }
        constructor() {
          this.useLocalStorage =
            p.STORAGE_ADAPTER === s.EVT_STORAGE_LOCAL_STORAGE;
          this._events = this._load() || [];
          _.a.debug(
            "EventBuffer: using",
            this.constructor.STORAGE_ADAPTER,
            "for storage"
          );
        }
        push(e) {
        ...
        filter(e) {
          return new l(this._events.filter(e));
        }
        discard(e) {
        ...
        _load() {
          if (this.useLocalStorage) {
            const e = JSON.parse(
              localStorage.getItem(s.EVT_STORAGE_KEY) || "[]"
            );
            return e.map((e) => n.fromJSON(e));
          }
          return;
        }
      }
      p.STORAGE_ADAPTER = s.EVT_STORAGE_MEMORY;
      var d = r("ouhR");
      var h = r.n(d);
      var c = r("w8vW");
      const g = {
      ...
      class x {
        constructor(e = {}) {
          this.options = Object(i["extend"])({}, x.options, e);
        ...
        start() {
          ...
          function s(e, t) {
            const s = new n(e.getEventType(), t);
            return r(s, e.getDeliveryPriority());
          }
        ...
        deliver() {
          ...
          const i = Object(d["ajax"])({
            url: r.deliveryUrl,
            type: "POST",
            global: false,
            headers: g,
            data: JSON.stringify({ quiz_submission_events: s.toJSON() }),
        ...
        stop(e = false) {
          ...
          if (this.isDelivering() && !e) {
            ...
            return Object(d["when"])(t.deliveries).done(
        ...
        _enqueue(e, t) {
          ...
          if (t === s.EVT_PRIORITY_HIGH)
            return this.isDelivering()
              ? Object(d["when"])(this._state.deliveries).done(
                  this.deliver.bind(this)
                )
              : this.deliver();
        }
        _stopDeliveryAgent() {
          return (this._state.deliveryAgent = clearInterval(
            this._state.deliveryAgent
          ));
        }
      }
      x.options = {
      ...
      class E {
        constructor(e = {}) {
          ...
          this.uid = `${this.eventType}_${Object(i["uniqueId"])()}`;
        }
        install(e) {
        ...
        uninstall() {
          if (this._bindings) {
            this._bindings.forEach((e) => h()(e.selector).off(e.eventName));
        ...
        bind(e, t, r, s = {}) {
          ...
          o > 0 &&
            (r = Object(i["throttle"])(r, o, {
              leading: true,
              trailing: false,
            }));
          h()(e).on(`${t}.${this.eventType}`, r);
        }
      }
      class v extends E {
        install(e) {
      ...
      v.prototype.eventType = s.EVT_PAGE_FOCUSED;
      ...
      class f extends E {
        install(e) {
          return this.bind(
            ...
            "blur",
            () => {
              if ("IFRAME" !== document.activeElement.tagName) return e();
            },
            { throttle: this.getOption("frequency") }
          );
        }
      }
      f.prototype.eventType = s.EVT_PAGE_BLURRED;
      ...
      h.a.extend(h.a.expr[":"], { in_viewport: w });
      var T = r("VTHg");
      var y = r.n(T);
      class O extends E {
        install(e, t = window) {
          ...
          return this.bind(
            ...
            "scroll",
            () => {
              const t = this.identifyVisibleQuestions().filter(
                (e) => -1 === r.indexOf(e)
              );
              if (t.length > 0) {
                r = r.concat(t);
                _.a.log(
                  `Student has just viewed the following questions: ${t}. (Questions viewed up until now are: ${r})`
                );
                return e(t);
              }
            },
        ...
        identifyVisibleQuestions() {
          return h()(".question[id]:visible")
            .filter(":in_viewport")
            .toArray()
            .map(y.a);
        }
      }
      O.prototype.eventType = s.EVT_QUESTION_VIEWED;
      O.prototype.options = { frequency: 2500 };
      class S extends E {
        install(e) {
          h()(document.body).on(
            "click." + this.uid,
            this.getOption("buttonSelector"),
            (t) => {
              const r = h()(t.target).closest(
                this.getOption("questionSelector")
              );
              const s = r.hasClass(this.getOption("questionMarkedClass"));
              const i = y()(r[0]);
              _.a.log(
                `Question ${i} ${
                  s ? "is now flagged" : "is no longer flagged"
                }.`
              );
              return e({ flagged: s, questionId: i });
            }
          );
        }
      }
      S.prototype.eventType = s.EVT_QUESTION_FLAGGED;
      S.prototype.options = {
      ...
      class q extends E {
        install(e) {
          ...
          if (
            -1 === location.href.indexOf("question") &&
            location.href.indexOf("take") > 0
          )
            return e({ user_agent: r });
        }
      }
      q.prototype.eventType = s.EVT_SESSION_STARTED;
      q.prototype.options = {};
      const A = [v, f, O, S, q];
      const m = new x();
      ...
      m.options.errorHandler = function (e) {
        console.log(e);
        (401 !== e.status && "Unauthorized" !== e.statusText) ||
    ...
    "EvX+": function (e, t, r) {
      ...
      const o = {
        getCssVariant() {
          const e = window.ENV.use_responsive_layout
            ? "responsive_layout"
            : "new_styles";
          const t = window.ENV.use_high_contrast
            ? "high_contrast"
            : "normal_contrast";
          const r = Object(s["c"])() ? "_rtl" : "";
          return `${e}_${t}${r}`;
        },
        urlFor(e, { combinedChecksum: t, includesNoVariables: r }) {
          const s = r ? "no_variables" : o.getCssVariant();
          return [
    ...
    "gl9/": function (e, t, r) {
      ...
      var s = r("1xB4");
      t["a"] = function (e) {
        e && s["a"].unregisterAllTrackers();
        s["a"].isRunning() || s["a"].start();
        if (s["a"].isDirty()) return s["a"].deliver();
      };
    },
    w8vW: function (e, t, r) {
      "use strict";
...
//# sourceMappingURL=158-c-ba6b5be820.js.map
