(window["canvasWebpackJsonp"] = window["canvasWebpackJsonp"] || []).push([
  [603, 738],
  {
    "/iD7": function (e, t, n) {
      ...
      var m = d.a.default;
      var h = m.template,
        f = (m.templates = m.templates || {});
      var g = "editor/KeyboardShortcuts";
      f[g] = h(function (e, t, n, i, o) {
        ...
        function _(e, t) {
          ...
          if ((o = n.key)) i = o.call(e, { hash: {}, data: t });
            ...
            o = e && e.key;
            i = typeof o === r ? o.call(e, { hash: {}, data: t }) : o;
          }
          a += u(i) + "</code>\n      <span>";
        ...
        s += '<ul class="tinymce-keyboard-shortcuts">\n  ';
        a = n.each.call(t, t && t.keybindings, {
          hash: {},
          inverse: l.noop,
          fn: l.program(1, _, o),
          data: o,
      ...
      c["a"].loadStylesheet(
        "jst/editor/KeyboardShortcuts",
        {
          ...
          new_styles_normal_contrast_rtl: { combinedChecksum: "9b568bbcaf" },
          new_styles_high_contrast_rtl: { combinedChecksum: "9b568bbcaf" },
          responsive_layout_normal_contrast_rtl: {
            combinedChecksum: "9b568bbcaf",
          },
      ...
      v = l.a.View.extend({
        ...
        keybindings: [
          {
            key: "ALT+F9",
            description: a.t(
              "keybindings.open_menubar",
              "Open the editor's menubar"
            ),
          },
          {
            key: "ALT+F10",
            description: a.t(
              "keybindings.open_toolbar",
              "Open the editor's toolbar"
            ),
          },
          {
            key: "ESC",
            description: a.t(
              "keybindings.close_submenu",
              "Close menu or dialog, also gets you back to editor area"
            ),
          },
          {
            key: "TAB/Arrows",
            description: a.t(
              "keybindings.navigate_toolbar",
              "Navigate left/right through menu/toolbar"
            ),
          },
          {
            key: "ALT+F8",
            description: a.t("Open this keyboard shortcuts dialog"),
          },
        ],
        template: p,
        initialize: function () {
          ...
          r()(
            '<i class="icon-keyboard-shortcuts" aria-hidden="true" />'
          ).appendTo(this.el);
          return r()('<span class="screenreader-only" />')
            .text(a.t("dialog_title", "Keyboard Shortcuts"))
            .appendTo(this.el);
        },
        render: function () {
          var e;
          e = { keybindings: this.keybindings };
          this.$dialog = r()(this.template(e)).dialog({
            title: a.t("dialog_title", "Keyboard Shortcuts"),
            width: 600,
            resizable: true,
            autoOpen: false,
          });
        ...
        bindEvents: function () {
          if (!ENV.use_rce_enhancements) {
            r()(document).on(
              "keyup.tinymce_keyboard_shortcuts",
              this.openDialogByKeybinding.bind(this)
            );
            return r()(document).on(
              "editorKeyUp",
              function (e, t) {
                return this.openDialogByKeybinding(t);
              }.bind(this)
            );
          }
        },
        remove: function () {
          r()(document).off("keyup.tinymce_keyboard_shortcuts");
        ...
        openDialogByKeybinding: function (e) {
          if (b.indexOf(e.keyCode) > -1 && e.altKey) return this.openDialog();
        },
      });
      t["a"] = v;
    },
    "86lW": function (e, t, n) {
      ...
      var h = m.template,
        f = (m.templates = m.templates || {});
      var g = "quizzes/fileUploadQuestionState";
      f[g] = h(function (e, t, n, i, o) {
        this.compilerInfo = [4, ">= 1.0.0"];
        n = this.merge(n, e.helpers);
        o = o || {};
        ...
        function d(e, t) {
          var i,
            ...
            s = "";
          s += "\n  ";
          if ((o = n.display_name)) i = o.call(e, { hash: {}, data: t });
          else {
            o = e && e.display_name;
            i = typeof o === r ? o.call(e, { hash: {}, data: t }) : o;
          }
          s +=
            u(i) +
            "<button role='button' class=\"pull-right delete-attachment\" aria-label='" +
            u(
              ((o = n.t || (e && e.t)),
              (a = {
                hash: {
              ...
              o
                ? o.call(e, "#buttons.delete_file", "Delete file %{name}", a)
                : l.call(
                    e,
                    "t",
                    "#buttons.delete_file",
        ...
        function h(e, t) {
          ...
          a +=
            ...
            u(
              ((i = n.t || (e && e.t)),
              (o = {
                hash: { scope: "quizzes.file_upload_question_state" },
                data: t,
              }),
              i
                ? i.call(e, "#buttons.choose_a_file", "Choose a File", o)
                : l.call(e, "t", "#buttons.choose_a_file", "Choose a File", o))
            ) +
            "\n    </button>\n  ";
          return a;
        }
        a = n["if"].call(t, t && t.display_name, {
          hash: {},
          inverse: _.program(3, c, o),
          fn: _.program(1, d, o),
          data: o,
        });
        (a || 0 === a) && (s += a);
      ...
      y[k] = v(function (e, t, n, i, o) {
        ...
        function _(e, t) {
          ...
          a +=
            ...
            u(
              ((i = n.t || (e && e.t)),
              (o = {
                hash: { scope: "quizzes.file_uploaded_or_removed" },
                data: t,
              }),
              i
                ? i.call(
                    e,
                    "quizzes.file_successfully_uploaded",
        ...
        a = n["if"].call(t, t && t.fileUploaded, {
          hash: {},
          inverse: l.program(3, d, o),
          fn: l.program(1, _, o),
          data: o,
        });
        (a || 0 === a) && (s += a);
      ...
      class w extends o["View"] {
        ...
        render() {
          ...
          this.$fileUploadBox.html(
            p(
              Object(i["a"])(
                Object(i["a"])({}, this.model.present()),
                {},
                { isIE: e }
              )
            )
        ...
        deleteAttachment(e) {
          ...
          this.removeFileStatusMessage();
          this.render();
          this.$fileUploadBox.parent().append(z(t));
          return this.trigger("attachmentManipulationComplete");
        }
      }
      w.initClass();
      ...
      M[O] = L(function (e, t, n, i, o) {
        ...
        r +=
          '<form id="ldb_deauthorized_dialog" class="hide">\n  <div id="unauthorized_message" class="ui-state-error">\n    <h2 class="">' +
          l(
            ((a = n.t || (t && t.t)),
            (s = { hash: { scope: "quizzes.ldb_login_popup" }, data: o }),
            a
              ? a.call(t, "titles.log_in", "Please Log In", s)
              : u.call(t, "t", "titles.log_in", "Please Log In", s))
          ) +
          "</h2>\n    <p>" +
          l(
            ((a = n.t || (t && t.t)),
          ...
          l(
            ...
            (s = { hash: { scope: "quizzes.ldb_login_popup" }, data: o }),
            a
              ? a.call(t, "email", "Email", s)
              : u.call(t, "t", "email", "Email", s))
          ) +
          ...
          l(
            ...
            (s = { hash: { scope: "quizzes.ldb_login_popup" }, data: o }),
            a
              ? a.call(t, "password", "Password", s)
              : u.call(t, "t", "password", "Password", s))
          ) +
          ...
          l(
            ...
            (s = { hash: { scope: "quizzes.ldb_login_popup" }, data: o }),
            a
              ? a.call(t, "log_in", "Log In", s)
              : u.call(t, "t", "log_in", "Log In", s))
          ) +
          "</span>\n  </div>\n</form>";
        return r;
      });
      c["a"].loadStylesheet(
        ...
        {
          new_styles_normal_contrast: { combinedChecksum: "874c7812ef" },
          new_styles_high_contrast: { combinedChecksum: "874c7812ef" },
          responsive_layout_normal_contrast: { combinedChecksum: "874c7812ef" },
          responsive_layout_high_contrast: { combinedChecksum: "874c7812ef" },
          new_styles_normal_contrast_rtl: { combinedChecksum: "e3eab73198" },
          new_styles_high_contrast_rtl: { combinedChecksum: "e3eab73198" },
          responsive_layout_normal_contrast_rtl: {
            combinedChecksum: "e3eab73198",
          },
          responsive_layout_high_contrast_rtl: {
            combinedChecksum: "e3eab73198",
          },
      ...
      class N extends a.a.View {
        static initClass() {
          this.prototype.url = "/login/canvas";
          this.prototype.template = B;
        ...
        initialize(e) {
          ...
          const i = r()(this);
          let o;
          C.a.extend(this.options, e);
          const a = C.a
            .map(this.options.window, (e, t) =>
              [t, C.a.isBoolean(e) ? (e ? "yes" : "no") : e].join("=")
            )
            .join(",");
          this.on = i.on.bind(i);
          ...
          const _ = () => o.appendTo(document.body);
          var d = () => o.detach();
          const c = (e) => {
            const n = I(e);
            const o = r()(e.target).closest("form").toJSON();
            const a = this.authenticate(o);
            a.then((e) => {
          ...
          function m() {
            ...
            const o = r()(t.document.head);
            C()(n).each((e) => {
              o.append(`<link rel="stylesheet" href="${Object(V["a"])(e)}" />`);
            });
      ...
      const G = (function () {
        ...
        return {
          ...
          timeToDueDate: o - new Date(),
          oneAtATime: r()("#submit_quiz_form").hasClass(
          ...
          updateSubmission(e, n) {
            if (G.backupsDisabled) {
              console.log(
                "[updateSubmission] Aborting because backups are disabled"
              );
              return;
            }
            if (G.submitting && !e) {
            ...
            const i = new Date();
            if (!n && i - G.lastSubmissionUpdate < 1e3) return;
            if (G.currentlyBackingUp) {
              console.log(
                "[updateSubmission] Aborting because submission is currently being backed up"
              );
              return;
            }
            G.currentlyBackingUp = true;
            G.lastSubmissionUpdate = new Date();
            const o = r()("#submit_quiz_form").getFormData();
            r()(".question_holder .question").each(function () {
              const e = r()(this).hasClass("marked") ? "1" : "";
              o[r()(this).attr("id") + "_marked"] = e;
            });
            l.text(j.t("saving", "Saving..."));
            const a = r()(".backup_quiz_submission_url").attr("href");
            (function (n) {
              const i = C.a.clone(n);
              if (!G.inBackground && e && C.a.isEqual(n, K)) {
                l.text(
                  j.t(
                    "saving_not_needed",
                    "No new data to save. Last checked at %{t}",
                    { t: r.a.friendlyDatetime(new Date()) }
                  )
                );
                G.currentlyBackingUp = false;
                setTimeout(() => {
                  G.updateSubmission(true, true);
                }, 3e4);
                return;
              }
              r.a.ajaxJSON(
                ...
                (n) => {
                  ...
                  if (n && n.end_at) {
                    const e = Date.parse(n.end_at),
                      ...
                      o = e.getTime(),
                      a = i.getTime();
                    G.timeLeft = 1e3 * n.time_left;
                    if (o !== a) {
                      o > a
                        ? r.a.flashMessage(
                            j.t(
                              "You have been given extra time on this attempt"
                            )
                          )
                        : r.a.flashMessage(
                            j.t("Your time for this quiz has been reduced.")
                          );
                      G.endAt.text(n.end_at);
                      G.endAtParsed = e;
                    }
                  }
                  n &&
                    n.end_at_without_time_limit &&
                    (G.endAtWithoutTimeLimitParsed = Date.parse(
                      n.end_at_without_time_limit
                    ));
                },
                (t, n) => {
                  ...
                  if (401 === n.status || "unauthorized" == t.status) {
                    R();
                    -1 === r.a.inArray(n, r.a.ajaxJSON.ignoredXHRs) &&
                      r.a.ajaxJSON.ignoredXHRs.push(n);
                  } else if (403 === n.status || "forbidden" == t.status)
                    ...
                    r.a.ajaxJSON(
                      location.protocol +
                        ...
                        e +
                        "&rnd=" +
                        Math.round(9999999 * Math.random()),
                      "GET",
                      {},
                      () => {},
                      () => {
          ...
          updateTime() {
            let t = (G.timeLeft -= G.clockInterval);
            let n = null;
            G.timeToDueDate > 0 && (n = G.timeToDueDate -= G.clockInterval);
            const i = new Date();
            const o = G.endAt.text();
            e = (e + 1) % 120;
            if (0 == e && !o && !G.twelveHourDeadline) {
              G.endAtParsed;
            }
            t = G.floorTimeLeft(t);
            if (G.countDown) {
              const e = new Date(G.countDown - i.getTime()).getUTCSeconds();
              i.getTime() < G.countDown && s.text(e);
              if (e <= 0 && !G.submitting && G.shouldSubmitAtEndAt()) {
                G.submitting = true;
                G.submitQuiz();
              }
            }
            if (G.isTimeUp(t) && !ENV.IS_PREVIEW) G.showTimeUpDialog(i);
            else if (null != n && t > n) {
              G.showDueDateWarnings(n);
              G.showWarnings(t);
            } else null == t ? G.showDueDateWarnings(n) : G.showWarnings(t);
            G.updateTimeDisplay(t);
            G.endAtWithoutTimeLimitParsed &&
              (G.timeToEndWithoutTimeLimit -= G.clockInterval);
            if (
              G.timerAutosubmitDisabledParsed &&
              !!G.endAtWithoutTimeLimitParsed &&
              G.endAtWithoutTimeLimitParsed.getTime() !==
                G.endAtParsed.getTime() &&
              G.timeToEndWithoutTimeLimit < 1e3 &&
              !G.submitting
            ) {
              G.submitting = true;
              G.submitQuiz();
          ...
          isTimeUp: (e) => e < 1e3 && !G.dialogged,
          showDueDateWarnings(e) {
            if (e > 3e4 && e < 6e4 && !G.oneMinuteDueDateDeadline) {
              G.oneMinuteDueDateDeadline = true;
              r.a.flashMessage(
                j.t(
            ...
            } else if (e > 25e4 && e < 3e5 && !G.fiveMinuteDueDateDeadline) {
              G.fiveMinuteDueDateDeadline = true;
              r.a.flashMessage(
                j.t(
              ...
              e > 177e4 &&
              e < 18e5 &&
              !G.thirtyMinuteDueDateDeadline
            ) {
              G.thirtyMinuteDueDateDeadline = true;
              r.a.flashMessage(
                j.t(
          ...
          showWarnings(e) {
            if (e > 3e4 && e < 6e4 && !G.oneMinuteDeadline) {
              G.oneMinuteDeadline = true;
              r.a.flashWarning(
                j.t(
            ...
            } else if (e > 25e4 && e < 3e5 && !G.fiveMinuteDeadline) {
              G.fiveMinuteDeadline = true;
              r.a.flashWarning(
                j.t(
            ...
            } else if (e > 177e4 && e < 18e5 && !G.thirtyMinuteDeadline) {
              G.thirtyMinuteDeadline = true;
              r.a.flashWarning(
                j.t(
          ...
          showTimeUpDialog(e) {
            G.dialogged = true;
            G.countDown = new Date(e.getTime() + 1e4);
            r()("#times_up_dialog")
              .show()
              .dialog({
                title: j.t("titles.times_up", "Time's Up!"),
                width: "auto",
                height: "auto",
                modal: true,
                overlay: { backgroundColor: "#000", opacity: 0.7 },
                close() {
                  if (!G.submitting && G.shouldSubmitAtEndAt()) {
                    G.submitting = true;
                    G.submitQuiz();
                  }
                },
          ...
          getTimeElapsed() {
            r()(".time_header").text(
              j.beforeLabel(j.t("labels.time_elapsed", "Time Elapsed"))
            );
            const e = new Date().getTime();
            const t = Date.parse(G.startedAt.text()).getTime();
            return e - t;
          },
          updateTimeDisplay(e) {
            G.hasTimeLimit
              ? G.updateTimeString(e)
              : G.updateTimeString(G.getTimeElapsed());
          },
          updateTimeString(e) {
            const t = new Date(Math.abs(e));
            const n = t.getUTCFullYear() - 1970;
            const i = t.getUTCMonth();
            const o = t.getUTCDate() - 1;
            ...
            const l = [];
            n && l.push(j.t("years_count", "Year", { count: n }));
            i && l.push(j.t("months_count", "Month", { count: i }));
            o && l.push(j.t("days_count", "Day", { count: o }));
            a && l.push(j.t("hours_count", "Hour", { count: a }));
            l.push(j.t("minutes_count", "Minute", { count: s }));
            l.push(j.t("seconds_count", "Second", { count: u }));
            h().text(l.join(", "));
          },
          updateFinalSubmitButtonState() {
            const e =
              0 == r()("#question_list li:not(.answered, .text_only)").length;
            const t = r()("#submit_quiz_form").hasClass("last_page");
            const n = r()("div.question.answered").length > 0;
            const i = G.oneAtATime;
            const o = (i && t && n) || e;
            G.toggleActiveButtonState("#submit_quiz_button", o);
          },
          updateQuestionIndicators(e, t) {
            ...
            if (e) {
              r()(o).addClass("answered");
              a.addClass("icon-check").removeClass("icon-question");
              a.find(".icon-text").text(j.t("question_answered", "Answered"));
            } else {
              r()(o).removeClass("answered");
              a.addClass("icon-question").removeClass("icon-check");
              a.find(".icon-text").text(
                j.t("question_unanswered", "Haven't Answered Yet")
              );
            }
          },
          updateNextButtonState(e) {
            const t = r()("#" + e);
            G.toggleActiveButtonState(
      ...
      r()(function () {
        ...
        if (0 == r()("#preview_mode_link").length) {
          ...
          window.addEventListener("beforeunload", (t) => {
            if (
              !G.navigatingToRelogin &&
              !G.submitting &&
              !G.alreadyAcceptedNavigatingAway &&
              !e
            ) {
              G.clearAccessCode = true;
              setTimeout(() => {
                e = false;
              }, 0);
              e = true;
          ...
          window.addEventListener(
            ...
            (e) => {
              ...
              t.leaving = !!G.clearAccessCode;
              r.a.flashMessage(j.t("Saving..."));
              r.a.ajax({
                url: n,
                data: t,
                type: "POST",
          ...
          r()(document).delegate("a", "click", function (e) {
            if (
              r()(this).closest(".ui-dialog,.mceToolbar,.ui-selectmenu")
                .length > 0
            )
              return;
            if (r()(this).hasClass("no-warning")) {
              G.alreadyAcceptedNavigatingAway = true;
              return;
            }
            ...
            if (!e.isDefaultPrevented()) {
              ...
              i ? (G.alreadyAcceptedNavigatingAway = true) : e.preventDefault();
            }
          });
        }
        const e = r()("#questions");
        r()("#question_list")
          .delegate(".jump_to_question_link", "click", function (e) {
            e.preventDefault();
          ...
          .bind({
            mouseenter(e) {
              ...
              if (!G.oneAtATime) {
                n.relatedQuestion ||
                  (n.relatedQuestion = r()("#" + t.attr("id").substring(5)));
        ...
        r()(".file-upload-question-holder").each((e, t) => {
          ...
          const o = new q["a"](ENV.ATTACHMENTS[i], {
            preflightUrl: ENV.UPLOAD_URL,
          });
          const a = new w({ el: t, model: o });
          i &&
            0 !== i &&
            n.find(".file-upload-box").addClass("file-upload-box-with-file");
          a.on("attachmentManipulationComplete", () => {
            G.updateSubmission();
          });
          a.render();
        });
        e.delegate(":checkbox,:radio", "change", function (e) {
          ...
          .delegate(":text,textarea,select", "change", function (e, t) {
            ...
            if (n.hasClass("numerical_question_input")) {
              var i = S["a"].parse(n.val());
              n.val(
                isNaN(i)
                  ? ""
                  : j.n(i.toFixed(4), { strip_insignificant_zeros: true })
              );
            }
            if (n.hasClass("precision_question_input")) {
              const e = S["a"].parse(n.val());
              const t = e.toString();
          ...
          .delegate(".numerical_question_input", {
            keyup(e) {
              ...
              n.match(/^$|^-$/) || S["a"].validate(n)
                ? i && t.triggerHandler("click")
                : i ||
                  t.errorBox(
                    j.t(
                      "errors.only_numerical_values",
          ...
          .delegate(".flag_question", "click", function (e) {
            ...
            let n;
            n = r()("#list_" + t.attr("id")).hasClass("marked")
              ? j.t(
          ...
          .delegate(".question_input", "change", function (e, t, n) {
            ...
            if ("TEXTAREA" == o) {
              s = W["a"].callOnRCE(i, "get_code");
              const e = i;
              i.siblings(".rce_links")
                .find(".toggle_question_content_views_link")
                .click(function (t) {
                  t.preventDefault();
                  W["a"].callOnRCE(e, "toggle");
                  r()(this)
                    .siblings(".toggle_question_content_views_link")
                    .andSelf()
                    .toggle();
                });
            } else if ("text" == i.attr("type") || "hidden" == i.attr("type"))
              s = i.val();
            else if ("SELECT" == o) {
              ...
              i.parents(".question")
                .find(".question_input")
                .each(function () {
                  (r()(this).attr("checked") || r()(this).attr("selected")) &&
                    (s = true);
                });
            G.updateQuestionIndicators(s, a);
            G.updateFinalSubmitButtonState();
            G.updateNextButtonState(a);
          });
        e.find(".question_input").trigger("change", [false, {}]);
        r()(".hide_time_link").click(function (e) {
          e.preventDefault();
          if ("hidden" != r()(".time_running").css("visibility")) {
            r()(".time_running").css("visibility", "hidden");
            r()(this).text(j.t("show_time_link", "Show"));
          } else {
            r()(".time_running").css("visibility", "visible");
            r()(this).text(j.t("hide_time_link", "Hide"));
          }
        });
        setTimeout(function () {
        ...
        r()(".quiz_submit").click((e) => {
          G.finalSubmitButtonClicked = true;
        });
        r()("#submit_quiz_form").submit(function (e) {
          ...
          if (G.finalSubmitButtonClicked) {
            G.finalSubmitButtonClicked = false;
            if (G.cantGoBack) {
              ...
              e > 0 &&
                (n = j.t(
                  "confirms.unseen_questions",
                  {
                    ...
                    other:
                      "There are still %{count} questions you haven't seen yet.  Submit anyway?",
                  },
                  { count: e }
                ));
            } else {
              t = r()(
                "#question_list .list_question:not(.answered):not(.text_only)"
              ).length;
              t > 0 &&
                (n = j.t(
        ...
        setTimeout(function () {
          r()(".question_holder textarea.question_input").each(function () {
            r()(this).attr("id", "question_input_" + G.contentBoxCounter++);
            W["a"].loadNewEditor(r()(this), { manageParent: true });
          });
        }, 2e3);
        if (P.a) {
          P.a.addEventListener("message", (e) => {
            "stopwatchTick" === e.data && G.updateTime();
          });
          P.a.postMessage({
            code: "startStopwatch",
            frequency: G.clockInterval,
          });
        } else setInterval(G.updateTime, G.clockInterval);
        setTimeout(() => {
          G.updateSubmission(true);
        }, 15e3);
      ...
      R = function () {
        r()("#deauthorized_dialog").dialog({
          ...
          buttons: [
            {
              text: j.t("#buttons.cancel", "Cancel"),
              class: "dialog_closer",
              click() {
                r()(this).dialog("close");
              },
            ...
            {
              text: j.t("#buttons.login", "Login"),
              class: "btn-primary relogin_button button_type_submit",
              click() {
                G.navigatingToRelogin = true;
      ...
      if (ENV.LOCKDOWN_BROWSER) {
        ...
        e.on("login_success.take_quiz", () => {
          r.a.flashMessage(j.t("login_successful", "Login successful."));
        }).on("login_failure.take_quiz", () => {
          r.a.flashError(j.t("login_failed", "Login failed."));
        });
        R = e.exec.bind(e);
      }
      r()(() => {
      ...
      ENV.use_rce_enhancements ||
        r()(".essay_question .answers .rce_links").append(
          new Q["a"]().render().el
        );
    },
    B1vq: function (e, t, n) {
      ...
      var o = n.n(i);
      n("s/PJ");
      o.a.fn.scrollToVisible = function (e) {
        const t = {};
        const n = o()(e);
        ...
        if ("HTML" == this[0].tagName || "BODY" == this[0].tagName) {
          m = o()(window).height();
          o()("#wizard_box:visible").length > 0 &&
            (m -= o()("#wizard_box:visible").height());
          h = o()(window).width();
          r -= d;
          l -= c;
          u -= d;
        ...
        r < 0 || (m < s && u > m)
          ? (t.scrollTop = r + d)
          : u > m && (t.scrollTop = u + d - m + 20);
        l < 0
          ? (t.scrollLeft = l + c)
          : _ > h && (t.scrollLeft = _ + c - h + 20);
    ...
    BYL3: function (e, t, n) {
      ...
      function l() {
        if (this.elements) return o.a.makeArray(this.elements);
        {
      ...
      function _() {
        return (
          this.name &&
          !this.disabled &&
          (this.checked || s.test(this.nodeName) || u.test(this.type))
        );
      }
      function d(e, t) {
      ...
      function c() {
        ...
        const t = (() => {
          if ("file" !== this.type)
            return e.hasClass("datetime_field_enabled")
              ? "" === e.val()
                ? null
                : e.data("date") || null
              : e.data("rich_text")
              ? Object(a["d"])(e, "get_code", false)
              : e.val();
          if (e.val()) return this;
        })();
        return o.a.isArray(t) ? t.map((e) => d(this.name, e)) : d(this.name, t);
      }
      o.a.fn.serializeForm = function () {
      ...
      const s = {
        ...
        parse(e) {
          ...
          let t = s._parseNumber(e.toString(), {
            thousands: a["default"].lookup("number.format.delimiter"),
            decimal: a["default"].lookup("number.format.separator"),
          });
    ...
    dfg0: function (e, t, n) {
      ...
      t["a"] = (function (e) {
        ...
        t.prototype.destinationIsSameContext = function (e) {
          var t, n, i, o, a, s, u, l;
          (u = (t = this.get("context_asset_string"))
            ? Object(r["a"])(t, false)
            : [
                null != (o = this.collection.parentFolder)
                  ? o.get("context_type")
                  : void 0,
                null != (a = this.collection.parentFolder) &&
                null != (s = a.get("context_id"))
                  ? s.toString()
                  : void 0,
              ]),
            (i = u[0]),
          ...
          return (
            i &&
            n &&
            i.toLowerCase() === e.get("context_type").toLowerCase() &&
            n === (null != (l = e.get("context_id")) ? l.toString() : void 0)
          );
        };
        t.prototype.moveTo = function (e, t) {
          null == t && (t = {});
          return this.destinationIsSameContext(e)
            ? this.moveToFolder(e, t)
            : this.copyToContext(e, t);
        };
        t.prototype.moveToFolder = function (e, t) {
          var n;
          null == t && (t = {});
          n = this.setAttributes({ parent_folder_id: e.id }, t);
          $.extend(n, { parent_folder_id: e.id });
          return this.save({}, { attrs: n }).then(
            ((i = this),
            function () {
              i.collection.remove(i);
              return i.updateCollection(i, e, t);
            })
          );
          var i;
        };
        t.prototype.copyToContext = function (e, t) {
          var n, i, o, a, r, u;
          null == t && (t = {});
          ...
          i = new this.constructor(
            s.a.omit(n, "id", "parent_folder_id", "parent_folder_path")
          );
          o = this.updateCollection(i, e, t);
          i.url = o.url;
          this.set("url", o.url);
          a = "copy_" + r;
          u = "/api/v1/folders/" + e.attributes.id + "/" + a;
          return i.save(n, { url: u });
        };
        t.prototype.setAttributes = function (e, t) {
          null == e && (e = {});
          null == t && (t = {});
          "overwrite" === t.dup
            ? $.extend(e, { on_duplicate: "overwrite" })
            : "rename" === t.dup &&
              (t.name
                ? $.extend(e, {
                    display_name: t.name,
                ...
                : $.extend(e, { on_duplicate: "rename" }));
          return e;
        };
        t.prototype.updateCollection = function (e, t, n) {
          var i, o;
          o = this.isFile ? "files" : "folders";
          i = t[o];
          "overwrite" === n.dup &&
            i.remove(i.where({ display_name: e.get("display_name") }));
          i.add(e, { merge: true });
          return i;
        };
        return t;
    ...
    jFQ7: function (e, t, n) {
      ...
      t["a"] = (function (e) {
        _(t, e);
        function t() {
          this.externalToolEnabled = l(this.externalToolEnabled, this);
          return t.__super__.constructor.apply(this, arguments);
        }
        t.prototype.url = function () {
          return this.isNew()
            ? t.__super__.url.apply(this, arguments)
            : "/api/v1/files/" + this.id;
        };
        t.prototype.initialize = function (e, n) {
          null == n && (n = {});
          this.preflightUrl = n.preflightUrl;
          return t.__super__.initialize.apply(this, arguments);
        };
        t.prototype.save = function (e, n) {
          var i, a, s, r, l, _;
          null == e && (e = {});
          null == n && (n = {});
          ...
          a = this.get("file");
          s = (a.value || a.name).split(/[\/\\]/).pop();
          a = a.files[0];
          _ = { name: s, on_duplicate: "rename" };
          Object(u["uploadFile"])(this.preflightUrl, _, a).then(l)["catch"](r);
          return i;
        };
        ...
        t.prototype.toJSON = function () {
          var e;
          if (!this.get("file"))
            return t.__super__.toJSON.apply(this, arguments);
          return s.a.pick.apply(
            s.a,
            [this.attributes, "file"].concat(
              c.call(s.a.keys(null != (e = this.uploadParams) ? e : {}))
            )
          );
        };
        t.prototype.present = function () {
          return s.a.clone(this.attributes);
        };
        t.prototype.externalToolEnabled = function (e) {
          var t;
          if (e.accept_media_types && e.accept_media_types.length > 0) {
            t = this.get("content-type");
            return s.a.find(e.accept_media_types.split(","), function (e) {
              var n;
    ...
    p6Wi: function (e, t, n) {
      ...
      r.a.fn.dim = function (e) {
        return this.animate({ opacity: 0.4 }, e);
      };
      r.a.fn.undim = function (e) {
        return this.animate({ opacity: 1 }, e);
      };
      r.a.fn.confirmDelete = function (e) {
        ...
        const o = function () {
          ...
          if (e.url) {
            ...
            r.a.ajaxJSON(
              ...
              (n, i, o, a) => {
                e.error && r.a.isFunction(e.error)
                  ? e.error.call(t, n, i, o, a)
                  : r.a.ajaxJSON.unhandledXHRs.push(i);
              }
            );
          } else {
            e.success ||
        ...
        if (e.message && !e.noMessage && !r.a.skipConfirmations) {
          if (e.dialog) {
            ...
            const s = e.url.includes("assignments")
              ? "btn-danger"
              : "btn-primary";
            n = r()(e.message).dialog(
              r.a.extend(
                {},
                {
                  modal: true,
                  ...
                  buttons: [
                    ...
                    {
                      text: a.t("#buttons.delete", "Delete"),
                      class: s,
                      click() {
                        i = true;
                        r()(this).dialog("close");
      ...
      r.a.fn.fragmentChange = function (e) {
        if (e && true !== e) {
          ...
          a || r.a._checkFragments.fragmentList.push({ doc: o, fragment: "" });
          r()(window).bind("hashchange", r.a._checkFragments);
          setTimeout(() => {
            i && i.length > 0
              ? o.triggerHandler("document_fragment_change", i)
              : o &&
                o[0] &&
                o[0].location &&
                o[0].location.hash.length > 0 &&
                o.triggerHandler(
                  "document_fragment_change",
                  o[0].location.hash
                );
          }, 500);
        } else
      ...
      r.a.fn.fillWindowWithMe = function (e) {
        const t = r.a.extend({ minHeight: 400 }, e),
          n = r()(this),
          i = r()("#wrapper"),
          o = r()("#main"),
          a = r()("#not_right_side"),
      ...
      r.a.fn.autoGrowInput = function (e) {
        e = r.a.extend({ maxWidth: 1e3, minWidth: 0, comfortZone: 70 }, e);
          ...
          let t = e.minWidth || r()(this).width(),
            ...
            a = function () {
              setTimeout(() => {
                ...
                o.text(n);
                const a = o.width(),
                  s = a + e.comfortZone >= t ? a + e.comfortZone : t,
                  r = i.width(),
    ...
    ppAs: function (e, t, n) {
      ...
      const d = {
        translateMathmlForScreenreaders(e) {
          ...
          if (
            !(
              ...
              null !== (n = t.FEATURES) &&
              void 0 !== n &&
              n.new_math_equation_handling
            )
          ) {
            const t = o()("<div/>")
              .html(e.attr("x-canvaslms-safe-mathml"))
              .html();
        ...
        toMediaCommentLink(e) {
          const t = o()(
            `<a\n        id='media_comment_${Object(r["a"])(
              o()(e).data("media_comment_id")
            )}'\n        data-media_comment_type='${Object(r["a"])(
              o()(e).data("media_comment_type")
            )}'\n        class='instructure_inline_media_comment ${Object(
              r["a"]
            )(e.nodeName.toLowerCase())}_comment'\n        data-alt='${Object(
              r["a"]
            )(o()(e).attr("data-alt"))}'\n      />`
          );
          t.html(o()(e).html());
        ...
        convert(e, t = {}) {
          ...
          n.find(
            "video.instructure_inline_media_comment,audio.instructure_inline_media_comment"
          ).replaceWith(function () {
            return d.toMediaCommentLink(this);
          });
          n.find(
            "object.instructure_user_content:not(#kaltura_player) embed"
          ).remove();
          if (!t.forEditing) {
            n.find(
              "object.instructure_user_content,embed.instructure_user_content"
            ).replaceWith(function () {
              const e = o()(this);
    ...
    qJBq: function (e, t) {
      (function () {
        ...
        i = [];
        t = {};
        e.exports = n = function (e, n, o) {
          var a, s, r, u, l, _, d, c, m;
          null == o && (o = true);
          if ("string" === typeof n) {
            if (2 !== n.length)
              throw {
            ...
            m =
              (null != n ? n.thousands : void 0) ||
              (null != n ? n.group : void 0) ||
              t.thousands;
            a = (null != n ? n.decimal : void 0) || t.decimal;
          }
          d = "" + m + a + o;
          _ = i[d];
          if (null == _) {
    ...
    "tVj+": function (e, t, n) {
      ...
      o.a.fn.toJSON = function () {
        ...
        o.a.each(o()(this).serializeForm(), function () {
          if (!a.validate.test(this.name)) return;
          let t,
            i = this.name.match(a.key),
            r = this.value,
            u = this.name;
          while (void 0 !== (t = i.pop())) {
            u = u.replace(new RegExp("\\[" + t + "\\]$"), "");
            if (t.match(a.push)) r = s([], n(u), r);
            else if (t.match(a.fixed)) {
              n(u, t);
              r = s([], t, r);
            } else t.match(a.named) && (r = s({}, t, r));
          }
          e = o.a.extend(true, e, r);
        });
        return e;
      };
    },
    vwFW: function (e, t, n) {
      ...
      var i = n("ouhR");
      var o = n.n(i);
      o()(".question select").bind("mousewheel", (e) => e.preventDefault());
    },
  },
]);

//# sourceMappingURL=take_quiz-c-f969d5d138.js.map
