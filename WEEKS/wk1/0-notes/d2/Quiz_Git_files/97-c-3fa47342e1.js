(window["canvasWebpackJsonp"] = window["canvasWebpackJsonp"] || []).push([
  [97],
  {
    "58Nq": function (t, e) {
      ...
      function s(t) {
        return h(p(a(t), 8 * t.length));
      }
      function r(t) {
        const e = i ? "0123456789ABCDEF" : "0123456789abcdef";
        let n = "";
        let s;
        for (let i = 0; i < t.length; i++) {
          s = t.charCodeAt(i);
          n += e.charAt((s >>> 4) & 15) + e.charAt(15 & s);
        }
        return n;
      }
      function o(t) {
        ...
        while (++i < t.length) {
          ...
          if (n >= 55296 && n <= 56319 && s >= 56320 && s <= 57343) {
            n = 65536 + ((1023 & n) << 10) + (1023 & s);
            i++;
          }
          n <= 127
      ...
      function u(t, e, i, n, s, r) {
        return y(v(y(y(e, t), y(n, r)), s), i);
      }
      function c(t, e, i, n, s, r, o) {
        return u((e & i) | (~e & n), t, e, s, r, o);
      }
      function d(t, e, i, n, s, r, o) {
        return u((e & n) | (i & ~n), t, e, s, r, o);
      }
      function l(t, e, i, n, s, r, o) {
        return u(e ^ i ^ n, t, e, s, r, o);
      }
      function f(t, e, i, n, s, r, o) {
        return u(i ^ (e | ~n), t, e, s, r, o);
      }
      function y(t, e) {
        const i = (65535 & t) + (65535 & e);
    ...
    VAKy: function (t, e, i) {
      "use strict";
      n.decorate = function (t) {
        t.messenger = new n();
        t.addEventListener = function (e, i) {
          t.messenger.addEventListener(e, i);
        };
        t.dispatchEvent = function (e, i, n) {
          t.messenger.dispatchEvent(e, i, n);
        };
        t.removeEventListener = function (e, i) {
          t.messenger.removeEventListener(e, i);
        };
      };
      function n() {
        this.events = {};
      }
      n.prototype.killAllListeners = function (t) {
        if (!this.events[t]) return false;
        this.events[t] = [];
      };
      ...
      var r = new s();
      function o() {}
      o.prototype.parseXML = function (t) {
        this.$xml = $(t);
        this.determineError();
        return this.$xml;
      };
      o.prototype.determineError = function () {
        this.isError = !!this.find("error").children().length;
      };
      o.prototype.find = function (t) {
        return this.$xml.find(t);
      };
      o.prototype.findRecursive = function (t) {
        t = t.split(":");
        let e = this.$xml;
        let i;
      ...
      o.prototype.nodeText = function (t, e, i) {
        let n;
        if ("" != e.find(t).text()) {
          n = e.find(t).text();
          true === i && (n = parseFloat(n));
        }
        return n;
      };
      var a = o;
      function h() {
        ...
        this.filename = "";
        this.fileId = -1;
        this.xmlParser = new a();
      }
      h.prototype.parseXML = function (t) {
        this.xmlParser.parseXML(t);
        this.isError = this.xmlParser.isError;
        this.xmlParser.isError || this.pullData();
      };
      h.prototype.pullData = function () {
        const t = this.xmlParser.find("result_ok");
      ...
      h.prototype.asEntryParams = function () {
        return {
      ...
      v.prototype.setOptions = function (t) {
        this.mergeDefaults(t);
      };
      v.prototype.mergeDefaults = function (t) {
        ...
        this.entryDefaults = {
          partnerData:
            "{'context_code': 'some_course_num', 'root_account'_id':1}",
          conversionProfile: 2,
          source: 1,
          kshow_id: -1,
          quick_edit: true,
      ...
      v.prototype.asEntryParams = function () {
        return {
      ...
      x.id = 1;
      x.prototype.createRequest = function () {
        const t = new XMLHttpRequest();
        t.open("POST", this.createUrl());
        t.responseType = "xml";
        return t;
      };
      x.prototype.createFormData = function () {
      ...
      x.prototype.createFileId = function () {
        x.id += 1;
        return Date.now().toString() + x.id.toString();
      };
      x.prototype.createUrl = function () {
        const t = this.settings.getSession();
        t.filename = this.createFileId();
        t.kalsig = this.createSignature();
        return m.uploadUrl + l(t);
      };
      x.prototype.createSignature = function () {
        return d(this.settings.getSession());
      };
      x.prototype.buildRequest = function (t, e) {
        this.settings = t;
        this.file = e;
        return this.createRequest();
      };
      x.prototype.getFile = function () {
        return this.file;
      };
      x.prototype.getSettings = function () {
        return this.settings;
      };
      var E = x;
      function g() {
        this.xhr = new XMLHttpRequest();
        this.uploadResult = new p();
      }
      g.prototype.isAvailable = function () {
        return !!this.xhr.upload;
      };
      g.prototype.send = function (t, e) {
        const i = new E();
      ...
      g.prototype.eventProxy = function (t) {
        const e = "Uploader." + t.type;
      ...
      b.prototype.setSession = function (t) {
        if (t) {
          y("ks", this, t);
          y("subp_id", this, t);
          y("partner_id", this, t);
      ...
      b.prototype.asEntryParams = function () {
        return this.getSession();
      };
      var L = b;
      function w() {
        this.sessionData = new L();
      }
      w.prototype.loadSession = function () {
        const t = new XMLHttpRequest();
      ...
      w.prototype.onSessionLoaded = function (t) {
        const e = t.target;
        if (200 == e.status) {
          this.sessionData.setSession(e.response);
          r.dispatchEvent("SessionManager.complete", this.sessionData, this);
        } else r.dispatchEvent("SessionManager.error");
      };
      w.prototype.getSession = function () {
      ...
      U.prototype.addEntry = function (t) {
        this.formData = F(t);
        this.createEntryRequest();
      };
      U.prototype.createEntryRequest = function () {
      ...
      U.prototype.onEntryRequestLoaded = function (t) {
        ...
        if (e) {
          e = {
            ...
            context_code: e.find("partnerData").text(),
            mediaType: e.find("mediatype").text(),
            entryId: e.find("id").text(),
            userTitle: void 0,
          };
          r.dispatchEvent("Entry.success", e, this);
        } else r.dispatchEvent("Entry.fail", this.xhr.response, this);
      };
      var _ = U;
      function P(t) {
        this.fileFilters = [];
        ...
        this.maxTotalSize = t.maxTotalSize;
      }
      P.prototype.addFileFilter = function (t) {
        this.fileFilters.push(t);
      };
      P.prototype.filterFor = function (t) {
        let e, i;
        const n = t.split(".").pop();
        for (let t = 0, s = this.fileFilters.length; t < s; t++) {
          i = this.fileFilters[t];
          if (i.includesExtension(n)) {
            e = i;
            break;
          }
        }
      ...
      P.prototype.asEntryParams = function (t) {
        const e = this.filterFor(t);
        return e.toParams();
      };
      P.prototype.acceptableFileSize = function (t) {
        return 1024 * this.maxFileSize * 1024 > t;
      };
      P.prototype.acceptableFileType = function (t, e) {
        const i = this.filterFor(t);
        if (!i) return false;
        return -1 !== e.indexOf(i.id);
      };
      P.prototype.acceptableFile = function (t, e) {
        const i = this.acceptableFileType(t.name, e);
        const n = this.acceptableFileSize(t.size);
        return i && n;
      };
      var T = P;
      function D(t) {
        this.extensions = this.parseExtensions(t.extensions);
        this.id = t.id;
      ...
      D.prototype.parseExtensions = function (t) {
        return t.split(";").map((t) => t.substring(2));
      };
      D.prototype.includesExtension = function (t) {
        return -1 !== this.extensions.indexOf(t.toLowerCase());
      };
      D.prototype.toParams = function () {
        const t = {
      ...
      var k = function (t) {
        return new C({
          ...
          entryType: t.getAttribute("entryType"),
          mediaType: t.getAttribute("mediaType"),
          type: t.getAttribute("type"),
          extensions: t.getAttribute("extensions"),
        });
      };
      var q = function (t) {
        const e = t.find("limits");
        const i = new T({
          maxUploads: e.attr("maxUploads"),
          maxFileSize: e.attr("maxFileSize"),
          maxTotalSize: e.attr("maxTotalSize"),
        });
      ...
      R.prototype.createUiConfig = function (t) {
        this.config = q(t);
      };
      R.prototype.onXhrLoad = function (t) {
        this.xmlParser.parseXML(this.xhr.response);
        const e = this.xmlParser
          .find("result")
          .find("ui_conf")
          .find("confFile")
          .first()
        ...
        if (e) {
          ...
          r.dispatchEvent("UiConf.complete", this.config, this);
        } else r.dispatchEvent("UiConf.error", this.xhr.response, this);
      };
      var M = R;
      function A(t) {
        s.decorate(this);
      ...
      A.prototype.buildDependencies = function () {
        this.session = new L();
        this.entryService = new _();
        this.uiconfService = new M();
      };
      A.prototype.addListeners = function () {
        r.addEventListener("UiConf.error", this.onUiConfError.bind(this));
      ...
      A.prototype.onSessionLoaded = function (t) {
        this.session = t;
        this.loadUiConf();
      };
      A.prototype.loadUiConf = function () {
        this.uiconfService.load(this.session);
      };
      A.prototype.onUiConfComplete = function (t) {
        this.uiconfig = t;
        this.dispatchEvent("K5.ready", {}, this);
      };
      A.prototype.uploadFile = function (t) {
        this.file = t;
        if (!t) return;
        if (
          this.uiconfig.acceptableFile(t, m.allowedMediaTypes) ||
          ["webm", "video/webm", "audio/webm"].includes(t.type)
        ) {
          this.uploader = new S();
          this.uploader.send(this.session, t);
        } else {
          const e = {
            maxFileSize: this.uiconfig.maxFileSize,
            file: t,
            allowedMediaTypes: m.allowedMediaTypes,
          };
          this.dispatchEvent("K5.fileError", e, this);
        }
      };
      A.prototype.onUploadSuccess = function (t) {
        const e = [
      ...
      A.prototype.onProgress = function (t) {
        this.dispatchEvent("K5.progress", t, this);
      };
      A.prototype.onUploadError = function (t) {
        this.dispatchEvent("K5.error", t, this);
      };
      A.prototype.onEntrySuccess = function (t) {
        this.dispatchEvent("K5.complete", t, this);
      };
      A.prototype.onEntryFail = function (t) {
        this.dispatchEvent("K5.error", t, this);
      };
      A.prototype.onUiConfError = function (t) {
        this.dispatchEvent("K5.uiconfError", t, this);
      };
      e["a"] = A;
    },
  },
...
//# sourceMappingURL=97-c-3fa47342e1.js.map
