  ...
  [20],
  {
    "21i1": function (e, t, i) {
      ...
      function d(e) {
        ...
        if (t.parent().attr("id") !== r)
          return t.wrap(`<div id='${r}' style='visibility: hidden'></div>`);
      }
      function u() {
    ...
    Cvk5: function (e, t, i) {
      ...
      class l {
        ...
        _addLabels() {
          ...
          s()(this.editor.getBody()).attr(
            "aria-label",
            s()(`label[for="${this.id_prepend}"]`).text()
          );
          this.$el
            .find("div[aria-label='Font Sizes']")
            .attr(
              "aria-label",
              a.t("titles.font_size", "Font Size, press down to select")
            );
          this.$el
            .find("div.mce-listbox.mce-last:not([aria-label])")
            .attr(
              "aria-label",
              a.t("titles.formatting", "Formatting, press down to select")
            );
          this.$el
            .find("div[aria-label='Text color']")
            .attr(
              "aria-label",
              a.t("accessibles.forecolor", "Text Color, press down to select")
            );
          this.$el
            ...
            .attr(
              "aria-label",
              a.t(
                "accessibles.background_color",
                "Background Color, press down to select"
              )
            );
        }
        _addTitles() {
          this.$iframe.attr(
            "title",
            a.t("titles.rte_help", "Rich Text Area. Press ALT+F8 for help")
          );
        }
    ...
    iklP: function (e, t, i) {
      ...
      function h(e, t) {
        ...
        if (!i.length) {
          ...
          i.append(
            `<form id='bookmark_search_form' style='margin-bottom: 5px;'><img src='/images/blank.png'/>&nbsp;&nbsp;<input type='text' class='query' style='width: 230px;'/><button class='btn search_button' type='submit'>${Object(
              l["a"]
            )(a.t("buttons.search", "Search"))}</button></form>`
          );
          i.append(
            "<div class='results' style='max-height: 200px; overflow: auto;'/>"
          );
          i.find("form").submit((t) => {
            ...
            i.find(".results")
              .empty()
              .append(Object(l["a"])(a.t("status.searching", "Searching...")));
            u = new Date();
              ...
              (e) => {
                ...
                e.length ||
                  i
                    ...
                    .append(
                      Object(l["a"])(
                        a.t("no_results_found", "No Results Found")
                      )
                    );
                for (const t in e) {
                  e[t].short_title = e[t].title;
                  e[t].title == e[t].description &&
                    (e[t].short_title = c["a"].truncateText(e[t].description, {
                      max: 30,
                    }));
                  s()("<div class='bookmark'/>")
                    .appendTo(i.find(".results"))
                    .append(
                      s()(
                        '<a class="bookmark_link" style="font-weight: bold;"/>'
                      )
                        .attr({ href: e[t].url, title: e[t].title })
                        .text(e[t].short_title)
                    )
                    .append(
                      s()(
                        "<div style='margin: 5px 10px; font-size: 0.8em;'/>"
                      ).text(
                        e[t].description ||
        ...
        i.find(".search_button").text(
          "delicious" == e
            ? a.t("buttons.search_by_tag", "Search by Tag")
            : a.t("buttons.search", "Search")
        );
        i.find("form img").attr("src", `/images/${e}_small_icon.png`);
        let r =
          "/search/bookmarks?q=%7B%7B+query+%7D%7D&service_type=%7B%7B+service_type+%7D%7D";
        r = s.a.replaceTags(r, "service_type", e);
        i.data("reference_url", r);
        i.find(".results").empty().end().find(".query").val("");
        i.dialog({
          title: a.t(
            "titles.bookmark_search",
    ...
    yiTI: function (e, t, i) {
      ...
      function d(e) {
        ...
        return (e) => {
          null === i &&
            (i = c["a"].post("/api/v1/jwts/refresh", { jwt: t }).then((e) => {
              i = null;
              t = e.data.token;
              return t;
            }));
      ...
      class h {
        constructor(e, t, i, r) {
          ...
          this.positionBtnGroup =
            "outdent indent superscript subscript bullist numlist";
        ...
        defaultConfig() {
          return {
            body_class: window.ENV.FEATURES.canvas_k6_theme
              ? "elementary-theme"
              : "default-theme",
            font_formats:
            ...
            external_plugins: {
              instructure_image:
                "/javascripts/tinymce_plugins/instructure_image/plugin.js",
              instructure_links:
              ...
              instructure_equation:
                "/javascripts/tinymce_plugins/instructure_equation/plugin.js",
              instructure_external_tools:
                "/javascripts/tinymce_plugins/instructure_external_tools/plugin.js",
              instructure_record:
                "/javascripts/tinymce_plugins/instructure_record/plugin.js",
            },
            language_load: false,
            convert_urls: false,
            menubar: true,
            ...
            content_css:
              window.ENV.url_to_what_gets_loaded_inside_the_tinymce_editor_css,
            browser_spellcheck: true,
            init_instance_callback: (e) => {
              $("#tinymce-parent-of-" + e.id).css("visibility", "visible");
            },
            show_media_upload:
              !!INST.kalturaSettings && !INST.kalturaSettings.hide_rte_button,
          };
        }
        external_buttons() {
          let e = "";
          for (
            let t = 0;
            this.extraButtons && t < this.extraButtons.length;
            t++
          )
            this.extraButtons.length <= this.maxButtons ||
            t < this.maxButtons - 1
              ? (e = `${e} instructure_external_button_${this.extraButtons[t].id}`)
              : e.match(/instructure_external_button_clump/) ||
                (e += " instructure_external_button_clump");
          return e;
        }
        buildInstructureButtons() {
          let e =
            " instructure_image instructure_equation" +
          ...
          this.instConfig &&
            ...
            (e += " instructure_record");
          const t =
            this.instConfig && this.instConfig.equellaEnabled
              ? " instructure_equella"
              : "";
          e += t;
          return e;
        ...
        balanceButtons(e) {
          ...
          if (this.viewportWidth < 359 && this.viewportWidth > 0) {
            ...
            i = `${this.formatBtnGroup} ${this.positionBtnGroup} ${t} ${this.fontBtnGroup}`;
          return window.ENV.use_rce_enhancements
            ? [i, r, n]
            : [i, r, n].map((e) => e.split(" ").join(","));
        }
        toolbar() {
        ...
        return {
          ...
          setup(t) {
            ...
            t.on("keyup keydown click mousedown", () => {
              n &&
                t.selection &&
                r.data("last_bookmark", t.selection.getBookmark(1));
            });
            ...
            t.on("init", () => {
              ...
              o()(t.contentDocument).bind("DOMNodeInserted", (t) => {
                ...
                1 === r.nodeType &&
                  ...
                  o()(r).attr(
                    "src",
                    e.activeEditor.documentBaseURI.toAbsolute(i)
                  );
              });
              "onfocusout" in t.contentWindow ||
                o()(t.contentWindow).blur((e) => {
      ...
      function f(e, t, i, n, a) {
        ...
        const s = void 0;
        return Object(r["a"])(
          Object(r["a"])(Object(r["a"])({}, o.defaultConfig()), _(a, s, n)),
          i.tinyOptions || {}
        );
      }
      var p = f;
      ...
      o.a.fn.dropdownList = function (e) {
        if (this.length) {
          ...
          if (!t.length) {
            ...
            o()(document)
              .mousedown((e) => {
                i.data("current_dropdown_initiator") &&
                  !o()(e.target).closest("#instructure_dropdown_list").length &&
          ...
          o.a.each(e.options, (e, i) => {
            const r = o()(
              "<div class='option minimal' style='cursor: pointer; padding: 2px 5px; overflow: hidden; white-space: nowrap;'>  <span tabindex='-1'>" +
                e +
                "</span></div>"
            ).appendTo(t);
            function n() {
            ...
            o.a.isFunction(i)
              ? r.addClass("ui-state-default").bind({
                  mouseenter() {
                    n();
          ...
          i.css({
            ...
            .hide()
            .show();
          i.offset().left + i.width() > o()(window).width() &&
            i.css({ left: "", right: 0 });
        }
        return this;
      };
      ...
      var x = {
        buttonConfig(e, t) {
          ...
          e.canvas_icon_class && "string" === typeof e.canvas_icon_class
            ? (i.icon = "hack-to-avoid-mce-prefix " + e.canvas_icon_class)
            : (i.image = e.icon_url);
          return i;
        },
        clumpedButtonMapping: (e, t, i) =>
          e.reduce((e, r) => {
            let n;
            n = r.canvas_icon_class
              ? `<i class='${Object(y["a"])(
                  r.canvas_icon_class
                )}' data-tool-id='${r.id}'></i>`
              : `<img src='${Object(y["a"])(r.icon_url)}' data-tool-id='${
                  r.id
                }'/>`;
            n += "&nbsp;" + Object(y["a"])(r.name);
            e[n] = function () {
        ...
        showHideButtons(e) {
          ...
          const r = e.$(
            e.editorContainer.querySelector(
              `.tox-tbtn--select[aria-label="${i}"]`
            )
          );
          const n = e.$(
            e.editorContainer.querySelector(`.tox-tbtn[aria-label="${i}"]`)
          );
          if (
        ...
        updateMRUList(e) {
          ...
          try {
            var i;
            t = JSON.parse(
              (null === (i = window.localStorage) || void 0 === i
                ? void 0
                : i.getItem("ltimru")) || "[]"
            );
          } catch (e) {
          ...
          try {
            if (!t.includes(e)) {
              ...
              null === (r = window.localStorage) ||
                void 0 === r ||
                r.setItem("ltimru", JSON.stringify(t));
            }
          } catch (e) {
      ...
      class A {
        fetchYouTubeTitle(e, t) {
          ...
          o.a
            .ajax({ headers: { Authorization: "Bearer " + i }, url: n })
            .success((i) => {
              i.id === e && t(i.title);
            })
            .error((e) => {
        ...
        titleYouTubeText(e) {
          ...
          this.fetchYouTubeTitle(t, (i, r) => {
            if (r) {
              console.error(
                `failed to get video title from youtube for "${t}":`,
                r.responseText
              );
      ...
      function P(e, t) {
        ...
        t.find(".auto_show_inline_content").attr("checked") &&
          (i += " auto_open");
        t.find(".disable_inline_content").attr("checked") &&
          (i += " inline_disabled");
        return i;
      }
      function N(e, t, i, r) {
      ...
      function D(e) {
        ...
        let n = "";
        r.removeClass("for_inline_content")
        ...
        if (0 == r.length) {
          ...
          r.find(".disable_inline_content").change(function () {
            ...
            r.find(".auto_show").showIf(
              !o()(this).attr("checked") &&
                r.hasClass("for_inline_content_can_auto_show")
            );
          });
          ...
          r.find("#instructure_link_prompt_form .prompt").bind(
            "change keyup",
            function () {
              ...
              if (i && t == i.url) {
                r.toggleClass("for_inline_content", i.for_inline_content)
                  .toggleClass(
                    "for_inline_content_can_auto_show",
                    i.for_inline_content_can_auto_show
                  )
                  .find(".disable_enhancement")
                  .showIf(i.for_inline_content)
                  .end()
                  .find(".auto_show")
                  .showIf(i.for_inline_content_can_auto_show);
                n = i.prior_classes;
              } else {
                r.removeClass("for_inline_content").removeClass(
                  "for_inline_content_can_auto_show"
                );
              ...
              if (t.match(/\.(gif|png|jpg|jpeg)$/)) {
                ...
                var d = function () {
                  e.complete
                    ? (e.height < 100 || (e.height > 100 && e.height < 200)) &&
                      c.height(e.height)
                    : setTimeout(d, 500);
                };
                setTimeout(d, 500);
                ...
                l.css("textAlign", "center");
                !r.find(".disable_inline_content").attr("checked") &&
                  r.hasClass("for_inline_content_can_auto_show") &&
                  r.find(".auto_show").show();
                a = false;
                ...
                c.css({
                  paddingLeft: 100,
                  background:
                    "url(/images/youtube_logo.png) no-repeat left center",
                  height: 90,
        ...
        while ("A" != l.nodeName && "BODY" != l.nodeName && l.parentNode)
          l = l.parentNode;
        ...
        if (c) {
          ...
          r.data("original_data", {
            ...
            for_inline_content_can_auto_show: r.hasClass(
              "for_inline_content_can_auto_show"
            ),
            prior_classes: n,
            preview_alt: c.data("preview-alt"),
          });
          r.find(".disable_inline_content")
            .attr("checked", c.hasClass("inline_disabled"))
            .triggerHandler("change");
          r.find(".auto_show_inline_content")
            .attr("checked", c.hasClass("auto_open"))
            .triggerHandler("change");
          ...
          : o()(e.getBody())
              ...
              .each(function () {
                ...
                if (
                  !ENV.use_rce_enhancements &&
                  t.attr("href") &&
                  !t.hasClass("inline_disabled") &&
                  t.attr("href").match(INST.youTubeRegEx)
                ) {
        ...
        e.on("PreProcess", function (e) {
          ...
          o()(e.node)
            ...
            .each(function () {
              ...
              const r = e.hasClass("fullWidth")
                ? "100%"
                : e.attr("width") || e.css("width");
              e.attr("width", r);
              e.css("width", r);
      ...
      const H = {
        get more_external_tools() {
          return Object(y["a"])(
            v.t("more_external_tools", "More External Tools")
          );
        },
      };
      const G = {
        init(e, t, r) {
          ...
          Promise.all([i.e(1), i.e(3), i.e(4), i.e(16), i.e(17), i.e(631)])
            .then(i.bind(null, "/wcz"))
            .then(({ default: t }) => {
              ...
              M.a.render(
                Object(m["a"])(t, {
                  ...
                  resourceSelectionUrl: o()(
                    "#context_external_tool_resource_selection_url"
                  ).attr("href"),
          ...
          for (let t = 0; r.editorButtons && t < r.editorButtons.length; t++) {
            ...
            if (ENV.use_rce_enhancements) {
              ...
              r.editorButtons.length > r.maxVisibleEditorButtons &&
              t >= r.maxVisibleEditorButtons - 1
            )
              a.push(i);
            else {
              e.addCommand("instructureExternalButton" + i.id, o);
              e.addButton(
                "instructure_external_button_" + i.id,
                x.buttonConfig(i, e)
              );
            }
          }
          ...
          if (a.length) {
            ...
            ENV.use_rce_enhancements
              ? e.ui.registry.addButton("instructure_external_button_clump", {
      ...
      function U(e, t) {
        t.length &&
          e.ui.registry.addNestedMenuItem("lti_tools_menuitem", {
            text: v.t("Apps"),
            icon: "lti",
      ...
      function X(e = {}) {
        ...
        document.addEventListener("tinyRCE/initEquation", ({ detail: t }) => {
          Promise.all([i.e(6), i.e(675)])
            .then(i.bind(null, "F+Bh"))
            .then(({ default: i }) => {
              const r = new i(t.ed);
              e.equationCB(r);
            });
        });
        document.addEventListener("tinyRCE/initLinks", ({ detail: t }) => {
          V.renderDialog(t.ed);
          e.linksCB();
        });
        ...
        document.addEventListener("tinyRCE/initRecord", (t) => {
          Promise.all([i.e(42), i.e(752)])
            .then(i.bind(null, "xR7n"))
            .then(({ default: i }) => {
      ...
      function oe() {
        ...
        const s =
          !ENV.use_rce_enhancements || ENV.RICH_CONTENT_CAN_UPLOAD_FILES;
        if (!s || "account" === i) {
          r = a;
          i = "user";
        }
      ...
      const le = {
        ...
        getTargetTextarea: (e) =>
          "textarea" === o()(e).get(0).type
            ? o()(e).get(0)
            : o()(e).find("textarea").get(0),
        ...
        createRCEProps(e, t) {
          ...
          o &&
            (t.tinyOptions = Object(r["a"])(
              { height: o },
              t.tinyOptions || {}
            ));
          const s = ENV.LOCALE;
          const l = Object.keys(ae["a"])
            .map((e) => ({ id: e, label: ae["a"][e] }))
            .sort((e, t) =>
              e.id === s
                ? -1
                : t.id === s
                ? 1
                : e.label.localeCompare(t.label, s)
            );
          const c = {
