(window["canvasWebpackJsonp"] = window["canvasWebpackJsonp"] || []).push([
  [47],
  {
    "7FZx": function (i, e, l) {
      ...
      l("Z+Ib");
      var o = function (i, e) {
          for (var l in e) c.call(e, l) && (i[l] = e[l]);
          function t() {
            this.constructor = i;
          }
      ...
      e["a"] = (function (i) {
        ...
        e.prototype.disabledClass = "disabled";
        ...
        e.prototype.initialize = function () {
          ...
          return null != (i = this.model)
            ? i.on(
                "change:unpublishable",
                ((l = this),
                function () {
                  if (!l.model.get("unpublishable") && l.model.get("published"))
                    return l.disable();
                })
              )
            : void 0;
        ...
        e.prototype.setElement = function () {
          e.__super__.setElement.apply(this, arguments);
          this.$el.attr("data-tooltip", "");
          if (!this.model.get("unpublishable") && this.model.get("published"))
            return this.disable();
        };
        e.prototype.hover = function (i) {
          var e;
          e = i.type;
          if ("mouseenter" === e) {
            if (this.keepState || this.isPublish() || this.isDisabled()) return;
        ...
        e.prototype.addAriaLabel = function (i) {
          var e;
          e = this.$el.find("span.screenreader-only.accessible_label");
          e.length ||
            (e = b()(
              '<span class="screenreader-only accessible_label"></span>'
            ).appendTo(this.$el));
          e.text(i);
          return this.$el.attr("aria-label", i);
        };
        e.prototype.setFocusToElement = function () {
          return this.$el.focus();
        };
        e.prototype.publish = function (i) {
        ...
        e.prototype.unpublish = function (i) {
          ...
          return this.model
            ...
            .fail(
              (function (i) {
                return function (e) {
                  403 === e.status && b.a.flashError(i.model.disabledMessage());
                  i.disable();
                  i.renderPublished();
        ...
        e.prototype.isPublish = function () {
          return this.$el.hasClass(this.publishClass);
        };
        e.prototype.isPublished = function () {
          return this.$el.hasClass(this.publishedClass);
        };
        e.prototype.isUnpublish = function () {
        ...
        e.prototype.reset = function () {
          ...
          this.$icon.removeClass(
            "icon-publish icon-unpublish icon-unpublished"
          );
          return this.$el.removeAttr("aria-label");
        };
        e.prototype.publishLabel = function () {
          if (this.publishText) return this.publishText;
          if (this.title)
            return s.t("Unpublished.  Click to publish %{title}.", {
              title: this.title,
            });
          return s.t("Unpublished.  Click to publish.");
        };
        e.prototype.unpublishLabel = function () {
          if (this.unpublishText) return this.unpublishText;
          if (this.title)
            return s.t("Published.  Click to unpublish %{title}.", {
              title: this.title,
            });
          return s.t("Published.  Click to unpublish.");
        };
        e.prototype.render = function () {
          this.$el.is("button") || this.$el.attr("role", "button");
        ...
        e.prototype.renderPublish = function () {
          return this.renderState({
            text: s.t("buttons.publish", "Publish"),
            label: this.publishLabel(),
            buttonClass: this.publishClass,
            iconClass: "icon-unpublish",
          });
        };
        e.prototype.renderPublished = function () {
          return this.renderState({
            text: s.t("buttons.published", "Published"),
            label: this.unpublishLabel(),
            buttonClass: this.publishedClass,
            iconClass: "icon-publish icon-Solid",
          });
        };
        e.prototype.renderUnpublish = function () {
          var i;
        ...
        e.prototype.renderPublishing = function () {
          var i;
          this.disable();
        ...
        e.prototype.renderUnpublishing = function () {
          var i;
          this.disable();
        ...
        e.prototype.renderState = function (i) {
          this.reset();
          ...
          if (
            null == this.model.get("unpublishable") ||
            this.model.get("unpublishable")
          ) {
            this.enable();
            this.$el.attr("title", i.text);
            if (i.label) return this.addAriaLabel(i.label);
          } else if (this.model.get("published"))
            return this.disableWithMessage(this.model.disabledMessage());
        };
        e.prototype.disableWithMessage = function (i) {
          this.disable();
    ...
    B1vq: function (i, e, l) {
      ...
      var u = l.n(t);
      l("s/PJ");
      u.a.fn.scrollToVisible = function (i) {
        const e = {};
        const l = u()(i);
        ...
        if ("HTML" == this[0].tagName || "BODY" == this[0].tagName) {
          r = u()(window).height();
          u()("#wizard_box:visible").length > 0 &&
            (r -= u()("#wizard_box:visible").height());
          _ = u()(window).width();
          b -= o;
          a -= c;
          h -= o;
        ...
        b < 0 || (r < n && h > r)
          ? (e.scrollTop = b + o)
          : h > r && (e.scrollTop = h + o - r + 20);
        a < 0
          ? (e.scrollLeft = a + c)
          : p > _ && (e.scrollLeft = p + c - _ + 20);
    ...
    p6Wi: function (i, e, l) {
      ...
      l("B1vq");
      l("s/PJ");
      b.a.fn.setOptions = function (i, e) {
        let l = i ? "<option value=''>" + Object(h["a"])(i) + "</option>" : "";
        null == e && (e = []);
        e.forEach((i) => {
          const e = Object(h["a"])(i);
          l += '<option value="' + e + '">' + e + "</option>";
        });
        return this.html(b.a.raw(l));
      };
      b.a.fn.ifExists = function (i) {
        this.length && i.call(this, this);
        return this;
      };
      b.a.fn.scrollbarWidth = function () {
        const i = b()(
      ...
      b.a.fn.dim = function (i) {
        return this.animate({ opacity: 0.4 }, i);
      };
      b.a.fn.undim = function (i) {
        return this.animate({ opacity: 1 }, i);
      };
      b.a.fn.confirmDelete = function (i) {
        i = b.a.extend({}, b.a.fn.confirmDelete.defaults, i);
        const e = this;
        let l = null;
        let t = true;
        ...
        const u = function () {
          if (!t) {
            i.cancelled && b.a.isFunction(i.cancelled) && i.cancelled.call(e);
            return;
          }
          i.confirmed ||
            (i.confirmed = function () {
              e.dim();
            });
          i.confirmed.call(e);
          if (i.url) {
            ...
            b.a.ajaxJSON(
              ...
              (l, t, u, s) => {
                i.error && b.a.isFunction(i.error)
                  ? i.error.call(e, l, t, u, s)
                  : b.a.ajaxJSON.unhandledXHRs.push(t);
              }
            );
          } else {
            i.success ||
        ...
        if (i.message && !i.noMessage && !b.a.skipConfirmations) {
          if (i.dialog) {
            t = false;
            const e = "object" === typeof i.dialog ? i.dialog : {};
            const n = i.url.includes("assignments")
              ? "btn-danger"
              : "btn-primary";
            l = b()(i.message).dialog(
              b.a.extend(
                {},
                {
                  modal: true,
                  ...
                  buttons: [
                    {
                      text: s.t("#buttons.cancel", "Cancel"),
                      click() {
                        b()(this).dialog("close");
                      },
                    },
                    {
                      text: s.t("#buttons.delete", "Delete"),
                      class: n,
                      click() {
                        t = true;
                        b()(this).dialog("close");
      ...
      b.a.fn.fragmentChange = function (i) {
        if (i && true !== i) {
          ...
          for (var e = 0; e < l.length; e++) {
            const i = l[e];
            i && 0 === i.indexOf("hash=") && (t = "#" + i.substring(5));
          }
          this.bind("document_fragment_change", i);
          const u = this;
          let s = false;
          for (e = 0; e < b.a._checkFragments.fragmentList.length; e++) {
            const i = b.a._checkFragments.fragmentList[e];
            i.doc[0] == u[0] && (s = true);
          }
          s || b.a._checkFragments.fragmentList.push({ doc: u, fragment: "" });
          b()(window).bind("hashchange", b.a._checkFragments);
          setTimeout(() => {
            t && t.length > 0
              ? u.triggerHandler("document_fragment_change", t)
              : u &&
                u[0] &&
                u[0].location &&
                u[0].location.hash.length > 0 &&
                u.triggerHandler(
      ...
      b.a._checkFragments = function () {
        const i = b.a._checkFragments.fragmentList;
        for (let e = 0; e < i.length; e++) {
          const l = i[e];
          const t = l.doc;
          if (t[0].location.hash != l.fragment) {
            t.triggerHandler("document_fragment_change", t[0].location.hash);
      ...
      b.a.fn.clickLink = function () {
        const i = this.eq(0);
        i.hasClass("disabled_link") || i.click();
      };
      b.a.fn.showIf = function (i) {
        if (b.a.isFunction(i))
          return this.each(function (e) {
            b()(this).showIf(i.call(this));
          });
        i ? this.show() : this.hide();
        return this;
      };
      b.a.fn.disableIf = function (i) {
        b.a.isFunction(i) && (i = i.call(this));
        this.prop("disabled", !!i);
        return this;
      };
      b.a.fn.indicate = function (i) {
        i = i || {};
        let e;
        if ("remove" == i) {
          e = this.data("indicator");
          e && e.remove();
          return;
        }
        b()(".indicator_box").remove();
        let l = this.offset();
      ...
      b.a.fn.hasScrollbar = function () {
        return this.length && this[0].clientHeight < this[0].scrollHeight;
      };
      b.a.fn.log = function (i) {
        console.log("%s: %o", i, this);
        return this;
      };
      b.a.fn.fillWindowWithMe = function (i) {
        const e = b.a.extend({ minHeight: 400 }, i),
          l = b()(this),
          t = b()("#wrapper"),
          u = b()("#main"),
          s = b()("#not_right_side"),
          n = b()(window),
          h = b()(this).add(e.alsoResize);
        function a() {
          h.height(0);
          const i =
              n.height() -
            ...
            a = Math.max(400, i);
          h.height(a);
          b.a.isFunction(e.onResize) && e.onResize.call(l, a);
        }
        a();
        n.unbind("resize.fillWindowWithMe").bind("resize.fillWindowWithMe", a);
        return this;
      };
      b.a.fn.autoGrowInput = function (i) {
        i = b.a.extend({ maxWidth: 1e3, minWidth: 0, comfortZone: 70 }, i);
        this.filter("input:text").each(function () {
          let e = i.minWidth || b()(this).width(),
            l = "",
            t = b()(this),
            u = b()("<tester/>").css({
              position: "absolute",
            ...
            s = function () {
              setTimeout(() => {
                ...
                u.text(l);
                const s = u.width(),
                  n = s + i.comfortZone >= e ? s + i.comfortZone : e,
                  b = t.width(),
                  h = (n < b && n >= e) || (n > e && n < i.maxWidth);
                h && t.width(n);
              });
            };
          u.insertAfter(t);
...
//# sourceMappingURL=47-c-da860a467c.js.map
