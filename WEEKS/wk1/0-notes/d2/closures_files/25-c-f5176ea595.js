    ...
    lT4e: function (t, e, n) {
      ...
      function c(t, e, n) {
        ...
        var l = {
          ...
          mixins: function (t, e) {
            if (e) for (var n = 0; n < e.length; n++) E(t, e[n]);
          },
          ...
          for (var s in n) {
            ...
            if (l.hasOwnProperty(s)) l[s](t, c);
              ...
              if (m) {
                ...
                var N = p[s];
                a(
                  E && ("DEFINE_MANY_MERGED" === N || "DEFINE_MANY" === N),
