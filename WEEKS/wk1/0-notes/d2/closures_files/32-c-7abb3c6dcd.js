      ...
      t["a"] = d = {
        quoteClump: function (e) {
          return (
            ...
            Object(a["a"])(o.t("quoted_text_toggle", "show quoted text")) +
    ...
    B1vq: function (e, t, i) {
      ...
      n.a.fn.scrollToVisible = function (e) {
        ...
        if ("HTML" == this[0].tagName || "BODY" == this[0].tagName) {
          h = n()(window).height();
          n()("#wizard_box:visible").length > 0 &&
            (h -= n()("#wizard_box:visible").height());
          p = n()(window).width();
          o -= d;
          u -= _;
          a -= d;
        ...
        o < 0 || (h < r && a > h)
          ? (t.scrollTop = o + d)
          : a > h && (t.scrollTop = a + d - h + 20);
        u < 0
          ? (t.scrollLeft = u + _)
          : c > p && (t.scrollLeft = c + _ - p + 20);
    ...
    p6Wi: function (e, t, i) {
      ...
      o.a.fn.confirmDelete = function (e) {
        ...
        const n = function () {
          ...
          if (e.url) {
            ...
            o.a.ajaxJSON(
              ...
              (i, l, n, s) => {
                e.error && o.a.isFunction(e.error)
                  ? e.error.call(t, i, l, n, s)
                  : o.a.ajaxJSON.unhandledXHRs.push(l);
              }
            );
          } else {
            e.success ||
        ...
        if (e.message && !e.noMessage && !o.a.skipConfirmations) {
          if (e.dialog) {
            ...
            const r = e.url.includes("assignments")
              ? "btn-danger"
              : "btn-primary";
            i = o()(e.message).dialog(
              o.a.extend(
                {},
                {
                  modal: true,
      ...
      o.a.fn.fragmentChange = function (e) {
        if (e && true !== e) {
          ...
          s || o.a._checkFragments.fragmentList.push({ doc: n, fragment: "" });
          o()(window).bind("hashchange", o.a._checkFragments);
          setTimeout(() => {
            l && l.length > 0
              ? n.triggerHandler("document_fragment_change", l)
              : n &&
                n[0] &&
                n[0].location &&
                n[0].location.hash.length > 0 &&
                n.triggerHandler(
      ...
      o.a.fn.fillWindowWithMe = function (e) {
        const t = o.a.extend({ minHeight: 400 }, e),
          i = o()(this),
          l = o()("#wrapper"),
          n = o()("#main"),
          s = o()("#not_right_side"),
      ...
      o.a.fn.autoGrowInput = function (e) {
        e = o.a.extend({ maxWidth: 1e3, minWidth: 0, comfortZone: 70 }, e);
