        ...
        (function () {
          ...
          function f(t, p) {
            ...
            while (n < v) {
              ...
              ++n;
              q =
                ((q & 65535) * o + ((((q >>> 16) * o) & 65535) << 16)) &
                4294967295;
              q = (q << 15) | (q >>> 17);
              q =
                ((q & 65535) * m + ((((q >>> 16) * m) & 65535) << 16)) &
                4294967295;
              r ^= q;
              r = (r << 13) | (r >>> 19);
              l =
                ((r & 65535) * 5 + ((((r >>> 16) * 5) & 65535) << 16)) &
                4294967295;
        ...
        b.getFormTrackingManager = function (m, l, o) {
          ...
          function t(u) {
            while (
              u &&
              u.nodeName &&
              u.nodeName.toUpperCase() !== "HTML" &&
              u.nodeName.toUpperCase() !== "FORM"
            ) {
              u = u.parentNode;
            }
          ...
          function n(u) {
            return function (y) {
              var v = y.target;
              var w =
                v.nodeName && v.nodeName.toUpperCase() === "INPUT"
                  ? v.type
                  : null;
          ...
          d.InQueueManager = function (j, r, q, n, s) {
              ...
              if (!y || y.length === 0) {
                ...
                for (var x = 0; x < y.length; x++) {
                  if (l.hasOwnProperty(y[x])) {
                    ...
                    g.warn(
                      'Warning: Tracker namespace "' + y[x] + '" not configured'
                    );
                  }
                }
              }
            ...
            function v() {
              ...
              for (z = 0; z < arguments.length; z += 1) {
                ...
                if (
                  (B === "setCollectorCf" || B === "setCollectorUrl") &&
                  (!C || C.length === 0)
                ) {
                  m(B, A[0], A[1]);
                  continue;
          ...
          i.detectSignature = function (t) {
            ...
            if (d.plugins) {
              for (var s = 0; s < d.plugins.length; s++) {
                ...
                o.push([
                  d.plugins[s].name + "::" + d.plugins[s].description,
                  p.join("~"),
                ]);
              }
            }
      ...
      function (b, c, a) {
        (function (d) {
          (function () {
            ...
            function S(aT) {
              return (
                typeof aT.toString != "function" && typeof (aT + "") == "string"
              );
            }
            function az(aT) {
              aT.length = 0;
            ...
            (function () {
              ...
              try {
                aG.nodeClass = !(
                  al.call(document) == av && !({ toString: 0 } + "")
                );
              } catch (aX) {
                aG.nodeClass = true;
              }
            ...
            function aB(bb, ba, a0, a7, bd, bc) {
              ...
              if (!a1) {
                ...
                if (a6 || aT) {
                  return aB(
                    a6 ? bb.__wrapped__ : bb,
                    aT ? ba.__wrapped__ : ba,
                    a0,
                    a7,
                    bd,
                    bc
              ...
              if (a1) {
                ...
                ai(ba, function (bg, bf, be) {
                  if (ad.call(be, bf)) {
                    a8++;
                    return (a5 =
                      ad.call(bb, bf) && aB(bb[bf], bg, a0, a7, bd, bc));
                  }
                });
                if (a5 && !a7) {
            ...
            var J = !aO
              ...
              : function (aT) {
                  ...
                  if (
                    (aG.enumPrototypes && typeof aT == "function") ||
                    (aG.nonEnumArgs && aT.length && g(aT))
                  ) {
                    return V(aT);
                  }
                  return aO(aT);
            ...
            function aJ(aT) {
              return (
                typeof aT == "string" ||
                (aT && typeof aT == "object" && al.call(aT) == R) ||
                false
              );
            }
            function M(aT) {
        ...
        (function () {
          ...
          i.Tracker = function m(bb, aK, Q, a2, B, av) {
            var z = o(true, function (bh) {
              ...
              x,
              aW = av.hasOwnProperty("appId") ? av.appId : "",
              aq,
              aI = am.title,
              C,
              aD = av.hasOwnProperty("pageUnloadTimer")
                ? av.pageUnloadTimer
                : 500,
              E,
              R,
              ...
              a0 = av.hasOwnProperty("respectDoNotTrack")
                ? av.respectDoNotTrack && (X === "yes" || X === "1")
                : false,
              ai,
              K = 63072000,
              O = av.hasOwnProperty("sessionCookieTimeout")
                ? av.sessionCookieTimeout
                : 1800,
              T = av.hasOwnProperty("userFingerprintSeed")
                ? av.userFingerprintSeed
                : 123412414,
              aY = am.characterSet || am.charset,
              aL = av.hasOwnProperty("forceSecureTracker")
                ? av.forceSecureTracker === true
                : false,
              ah = av.hasOwnProperty("useLocalStorage")
                ? av.useLocalStorage
                : true,
            ...
            z.setBase64Encoding(
              av.hasOwnProperty("encodeBase64") ? av.encodeBase64 : true
            );
            ...
            function au() {
              var bh =
                am.compatMode && am.compatMode != "BackCompat"
                  ? am.documentElement
                  : am.body;
              return [
                bh.scrollLeft || ac.pageXOffset,
                bh.scrollTop || ac.pageYOffset,
              ];
            }
            function ay() {
              var bi = au();
            ...
            function aR(bh) {
              if (aL) {
                ...
                return (
                  ("https:" === am.location.protocol ? "https" : "http") +
                  "://" +
                  bh
                );
              }
            ...
            function P() {
              ...
              if (bj) {
                ...
                if (
                  ac.chrome &&
                  ac.chrome.loadTimes &&
                  typeof ac.chrome.loadTimes().firstPaintTime === "number"
                ) {
                  bi.chromeFirstPaint = Math.round(
                    ac.chrome.loadTimes().firstPaintTime * 1000
                  );
                }
                return {
            ...
            function at(bh, bo, bj, bm, bl, bn, bi, bk) {
              z.trackEcommerceTransactionItem(
                bh,
                bo,
                bj,
                bm,
            ...
            return {
              ...
              trackTrans: function () {
                aM(
                  D.transaction.orderId,
                  D.transaction.affiliation,
                  D.transaction.total,
                  D.transaction.tax,
                  D.transaction.shipping,
                  D.transaction.city,
                  D.transaction.state,
                  D.transaction.country,
