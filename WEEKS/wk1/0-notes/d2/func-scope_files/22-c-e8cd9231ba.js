  ...
  [22],
  {
    Sv6n: function (t, e, i) {
      ...
      function l(t) {
        ...
        return (
          t.hash.length > 1 &&
          t.href.replace(r, "") === location.href.replace(r, "")
        );
      }
      s.a.widget("ui.tabs", {
        version: "@VERSION",
        ...
        _create: function () {
          ...
          this.element
            ...
            .toggleClass("ui-tabs-collapsible", e.collapsible)
            .delegate(
              ".ui-tabs-nav > li",
          ...
          if (false !== i) {
            i = this.tabs.eq(i).index();
            -1 === i && (i = !e.collapsible && 0);
          }
          e.active = i;
          !e.collapsible &&
            false === e.active &&
            this.anchors.length &&
            (e.active = 0);
          s.a.isArray(e.disabled) &&
            (e.disabled = s.a
              .unique(
                e.disabled.concat(
                  s.a.map(this.tabs.filter(".ui-state-disabled"), function (e) {
                    return t.tabs.index(e);
                  })
                )
              )
              .sort());
          false !== this.options.active && this.anchors.length
        ...
        _findNextTab: function (t, e) {
          ...
          while (-1 !== s.a.inArray(a(), this.options.disabled))
            t = e ? t + 1 : t - 1;
          return t;
        },
        ...
        refresh: function () {
          ...
          if (false !== t.active && this.anchors.length)
            if (
              this.active.length &&
              !s.a.contains(this.tablist[0], this.active[0])
            )
              if (this.tabs.length === t.disabled.length) {
                ...
                this._activate(
                  this._findNextTab(Math.max(0, t.active - 1), false)
                );
        ...
        _setupDisabled: function (t) {
          s.a.isArray(t) &&
            (t.length
              ? t.length === this.anchors.length && (t = true)
              : (t = false));
          for (var e, i = 0; (e = this.tabs[i]); i++)
            true === t || -1 !== s.a.inArray(i, t)
              ? s()(e)
        ...
        _setupHeightStyle: function (t) {
          ...
          if ("fill" === t) {
            ...
            this.panels
              .each(function () {
                s()(this).height(
                  Math.max(0, e - s()(this).innerHeight() + s()(this).height())
                );
              })
              .css("overflow", "auto");
          } else if ("auto" === t) {
        ...
        _eventHandler: function (t) {
          var e = this.options,
            ...
            u = { oldTab: i, oldPanel: h, newTab: o ? s()() : n, newPanel: l };
          t.preventDefault();
          if (
            ...
            this.running ||
            (r && !e.collapsible) ||
            false === this._trigger("beforeActivate", t, u)
          )
            return;
          ...
          h.length ||
            l.length ||
            s.a.error("jQuery UI Tabs: Mismatching fragment identifier.");
          ...
          this.xhr = s.a.ajax({
            ...
            beforeSend: function (t, a) {
              return i._trigger(
                "beforeLoad",
                e,
                s.a.extend({ jqXHR: t, ajaxSettings: a }, o)
              );
            },
          });
      ...
      if (false !== s.a.uiBackCompat) {
        ...
        s.a.widget("ui.tabs", s.a.ui.tabs, {
          options: { ajaxOptions: null, cache: false },
          _create: function () {
            this._super();
            var t = this;
            this._on({
        ...
        s.a.widget("ui.tabs", s.a.ui.tabs, {
          ...
          enable: function (t) {
            var e,
              i = this.options;
            ((t && true === i.disabled) ||
              (s.a.isArray(i.disabled) && -1 !== s.a.inArray(t, i.disabled))) &&
              (e = true);
            this._superApply(arguments);
            e &&
              this._trigger(
        ...
        s.a.widget("ui.tabs", s.a.ui.tabs, {
          ...
          add: function (t, e, i) {
            ...
            var a,
              ...
              r = this.options,
              o = s()(
                r.tabTemplate.replace(/#\{href\}/g, t).replace(/#\{label\}/g, e)
              ),
              l = t.indexOf("#") ? this._tabId(o) : t.replace("#", "");
            o.addClass("ui-state-default ui-corner-top").data(
              "ui-tabs-destroy",
              true
            );
            ...
            if (!n.length) {
              ...
              a
                ? i > 0
                  ? n.insertAfter(this.panels.eq(-1))
          ...
          remove: function (t) {
            ...
            e.disabled = s.a.map(
              s.a.grep(e.disabled, function (e) {
                return e !== t;
              }),
              function (e) {
                return e >= t ? --e : e;
        ...
        s.a.widget("ui.tabs", s.a.ui.tabs, {
          ...
          _tabId: function (t) {
            ...
            e = e[0];
            return (
              s()(e).closest("li").attr("aria-controls") ||
              (e.title &&
                e.title
                  .replace(/\s/g, "_")
                  .replace(/[^\w\u00c0-\uFFFF\-]/g, "")) ||
              this.options.idPrefix + o()
            );
          },
        });
        s.a.widget("ui.tabs", s.a.ui.tabs, {
          ...
          _createPanel: function (t) {
            return s()(this.options.panelTemplate)
              .attr("id", t)
              .addClass("ui-tabs-panel ui-widget-content ui-corner-bottom")
              .data("ui-tabs-destroy", true);
          },
        ...
        s.a.widget("ui.tabs", s.a.ui.tabs, {
          _create: function () {
            ...
            null === t.active &&
              void 0 !== t.selected &&
              (t.active = -1 !== t.selected && t.selected);
            this._super();
            t.selected = t.active;
        ...
        (h = 0),
          s.a.widget("ui.tabs", s.a.ui.tabs, {
            ...
            _cookie: function (t) {
              var e = [
                this.cookie ||
                  (this.cookie = this.options.cookie.name || "ui-tabs-" + ++h),
              ];
              if (arguments.length) {
                e.push(false === t ? -1 : t);
        ...
        s.a.widget("ui.tabs", s.a.ui.tabs, {
          ...
          _toggle: function (t, e) {
            ...
            function o() {
              e.newTab.closest("li").addClass("ui-tabs-active ui-state-active");
              if (a.length && n.show)
                a.animate(n.show, n.show.duration, function () {
                  r();
                });
              else {
                a.show();
            ...
            if (s.length && n.hide)
              s.animate(n.hide, n.hide.duration, function () {
                e.oldTab
                  .closest("li")
                  .removeClass("ui-tabs-active ui-state-active");
                o();
