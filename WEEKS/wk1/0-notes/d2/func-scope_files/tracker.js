  ...
  if (g.trackJs)
    ...
    q.prototype = {
      watch: function () {
        e.forEach(
          ...
          function (a) {
            e.has(g, a + ".prototype.addEventListener") &&
      ...
      wrap: function (a) {
        function b() {
          try {
            ...
            throw (
              (c.onError("catch", b, { bindTime: d, bindStack: f }),
              e.wrapError(b))
            );
          }
        }
      ...
      wrapEventTarget: function (a) {
        ...
        e.has(a, "addEventListener.call") &&
          e.has(a, "removeEventListener.call") &&
          (e.patch(a, "addEventListener", function (a) {
    ...
    u.prototype = {
      ...
      initCurrent: function (a) {
        if (this.validate(a, this.defaults, "config", {}))
          return (this.current = e.defaultsDeep({}, a, this.defaults)), !0;
      ...
      setCurrent: function (a) {
        return this.validate(a, this.defaults, "config", this.initOnly)
          ? ((this.current = e.defaultsDeep({}, a, this.current)), !0)
          : !1;
      },
        ...
        for (var h in a)
          if (a.hasOwnProperty(h))
            if (b.hasOwnProperty(h)) {
              ...
              e !== typeof a[h]
                ? (console.warn(
                    c + "." + h + ": property must be type " + e + "."
                  ),
                  (f = !1))
                : "[object Array]" !== Object.prototype.toString.call(a[h]) ||
                  this.validateArray(a[h], b[h], c + "." + h)
                ? "[object Object]" === Object.prototype.toString.call(a[h])
                  ? (f = this.validate(a[h], b[h], c + "." + h, d[h]))
                  : d.hasOwnProperty(h) &&
                    (console.warn(
                      c + "." + h + ": property cannot be set after load."
                    ),
                    (f = !1))
                : (f = !1);
            } else
              console.warn(c + "." + h + ": property not supported."), (f = !1);
        return f;
      },
      validateArray: function (a, b, c) {
        ...
        for (var f = 0; f < a.length; f++)
          e.contains(b, a[f]) ||
            (console.warn(c + "[" + f + "]: invalid value: " + a[f] + "."),
            (d = !1));
        return d;
      },
    };
    ...
    A.prototype = {
      isCompatible: function (a) {
        a = a || g;
        return (
          !e.has(a, "chrome.app.runtime") &&
          e.has(a, "addEventListener") &&
          e.has(a, "history.pushState")
        );
      },
            ...
            return m
              ...
              ["catch"](function (d) {
                ...
                f &&
                  ...
                  b.error &&
                    ((d.message = d.message + ": " + f.method + " " + f.url),
                    (d.stack = d.stack || l),
                    c("ajax", d)));
                throw d;
              });
    ...
    var e = (function () {
        function a(c, d, f, h) {
          ...
          e.forEach(d, function (d) {
            e.forEach(e.keys(d), function (e) {
              null === d[e] || d[e] === n
                ? (c[e] = d[e])
                : f && 10 > h && "[object Object]" === b(d[e])
                ? ((c[e] = c[e] || {}), a(c[e], [d[e]], f, h + 1))
                : c.hasOwnProperty(e) || (c[e] = d[e]);
            });
          });
          return c;
        }
        ...
        return {
          ...
          afterDocumentLoad: function (a) {
            ...
            "complete" === p.readyState
              ? e.defer(a)
              : (e.addEventListenerSafe(p, "readystatechange", function () {
                  "complete" !== p.readyState || b || (e.defer(a), (b = !0));
                }),
                setTimeout(function () {
                  b || (e.defer(a), (b = !0));
                }, 1e4));
          ...
          contains: function (a, b) {
            var f;
            for (f = 0; f < a.length; f++) if (a[f] === b) return !0;
            return !1;
          },
          defaults: function (c) {
          ...
          isBoolean: function (a) {
            return (
              "boolean" === typeof a ||
              (e.isObject(a) && "[object Boolean]" === b(a))
            );
          },
          ...
          isError: function (a) {
            ...
            return (
              "[object Error]" === d ||
              "[object DOMException]" === d ||
              (e.isString(a.name) && e.isString(a.message))
            );
          },
          ...
          isNumber: function (a) {
            return (
              "number" === typeof a ||
              (e.isObject(a) && "[object Number]" === b(a))
            );
          },
          isObject: function (a) {
          ...
          isString: function (a) {
            return (
              "string" === typeof a ||
              (!e.isArray(a) && e.isObject(a) && "[object String]" === b(a))
            );
          },
    ...
    C.prototype = {
      ...
      getElementAttributes: function (a) {
        for (
          var b = {}, c = Math.min(a.attributes.length, 10), d = 0;
          d < c;
          d++
        ) {
          var f = a.attributes[d];
          e.contains(["data-value", "value"], f.name.toLowerCase()) ||
            (b[f.name] = e.truncate(f.value, 100));
        }
        return b;
      },
      ...
      watchWindowErrors: function (a) {
        ...
        e.patch(a, "onerror", function (a) {
          return function (d, f, e, g, k) {
            try {
              (k = k || {}),
                (k.message = k.message || b.serialize(d)),
                (k.name = k.name || "Error"),
                (k.line = k.line || parseInt(e, 10) || null),
                (k.column = k.column || parseInt(g, 10) || null),
                "[object Event]" !== Object.prototype.toString.call(d) || f
    ...
    var E = function (a, b, c, d, f, h, g, k, m, x, n, p, q, r, u, v) {
      try {
        if (
          ...
          (this.environment = new g(this.config)),
          (this.customer = new h(
            this.config,
            this.util,
            this.log,
          ...
          this.customer.token &&
            ...
            this.config.current.enabled &&
              ((this.windowConsoleWatcher = new f(
                this.util,
                this.log,
                this.onError,
                this.onFault,
          ...
          if (e.isBrowserSupported() && this.config.current.enabled)
            try {
              if (
                ...
                (d && e.isError(d)) ||
                  (d = { name: "Error", message: this.serialize(d, f.force) }),
                ...
                if (b && -1 !== d.message.indexOf("Script error")) b = !1;
                  ...
                  (function () {
                    ...
                    for (var b = 0; a() && b < h.console.length; )
                      (h.console[b].message = e.truncate(
                        h.console[b].message,
                        1e3
                      )),
                        b++;
    ...
    q = new E(
      g._trackJs || g._trackJS || g._trackjs || {},
      function (a, b, c, d) {
        return {
