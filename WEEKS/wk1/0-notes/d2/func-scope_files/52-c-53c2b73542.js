  ...
  [52],
  {
    "13m+": function (e, t, o) {
      ...
      u.course = i({
        id: n.isRequired,
        name: n.isRequired,
        course_code: n.isRequired,
        term: u.term.isRequired,
        teachers: _(i({ display_name: n.isRequired })),
        teacher_count: n,
        sis_course_id: n,
      });
      ...
      u.courseInfo = i({
        id: n.isRequired,
        name: n.isRequired,
        enrollment_term_id: n.isRequired,
        sis_course_id: n,
      });
      u.lockableAttribute = r([
        "points",
        "content",
        "due_dates",
        "availability_dates",
      ...
      u.migrationException = i({
        course_id: n.isRequired,
        conflicting_changes: u.lockableAttributeList,
      });
      u.migrationExceptionList = _(u.migrationException);
      u.migrationChange = i({
        asset_id: n.isRequired,
        asset_type: r([
          "assignment",
          "quiz",
          "discussion_topic",
        ...
        asset_name: n.isRequired,
        change_type: r(["created", "updated", "deleted"]).isRequired,
        htnl_url: n,
        exceptions: u.migrationExceptionList,
      });
      u.migrationChangeList = _(u.migrationChange);
      u.migration = i({
        id: n.isRequired,
        workflow_state: u.migrationState.isRequired,
        comment: n,
        created_at: n.isRequired,
        exports_started_at: n,
        imports_queued_at: n,
        imports_completed_at: n,
        changes: u.migrationChangeList,
      });
      u.migrationList = _(u.migration);
      u.unsyncedChange = i({
        asset_id: n.isRequired,
        asset_type: n.isRequired,
        asset_name: n.isRequired,
        change_type: n.isRequired,
        html_url: n.isRequired,
        locked: s.isRequired,
      });
      u.unsyncedChanges = _(u.unsyncedChange);
      u.notification = i({
        id: n.isRequired,
        message: n.isRequired,
        err: k(Error),
      });
      ...
      u.itemLocks = i({
        ...
        points: s,
        due_dates: s,
        availability_dates: s,
      });
      u.itemLocksByObject = i({
        assignment: u.itemLocks,
        discussion_topic: u.itemLocks,
        wiki_page: u.itemLocks,
        quiz: u.itemLocks,
        attachment: u.itemLocks,
      });
    },
    OAMf: function (e, t, o) {
      "use strict";
      ...
      var i = o("3sT6");
      function n(e) {
        const t = e.map((e) => i["e"][e]);
        switch (t.length) {
          case 0:
            return a.t("no attributes locked");
          case 1:
            return t[0];
          default:
            return `${t.slice(0, -1).join(", ")} & ${t.slice(-1)[0]}`;
        }
      }
      function _(e) {
    ...
    kC3k: function (e, t, o) {
      ...
      u.variant = "Solid";
      u.propTypes = Object(c["a"])({}, s["a"].propTypes);
    },
    lubD: function (e, t, o) {
      "use strict";
      var c = o("x1Tw");
      ...
      var a = o("v0Tn");
      const i = {
        _depaginate(e, t = Infinity, o = []) {
          return c["a"].get(e).then((e) => {
            const c = o.concat(e.data);
            const a = t - 1;
            if (e.headers.link && a > 0) {
              const t = Object(l["a"])(e);
              if (t.next) return this._depaginate(t.next, a, c);
            }
            e.data = c;
            return e;
          });
        ...
        getCourses(
          { accountId: e },
          { search: t = "", term: o = "", subAccount: c = "" } = {}
        ) {
          const l = this._queryString([
            { per_page: "100" },
            { blueprint: "false" },
            ...
            { teacher_limit: "5" },
            { search_term: t },
            { enrollment_term_id: o },
          ]);
          return this._depaginate(`/api/v1/accounts/${c || e}/courses?${l}`, 1);
        },
        getAssociations({ masterCourse: e }) {
          const t = this._queryString([
            { per_page: "100" },
            { teacher_limit: "5" },
          ]);
          return this._depaginate(
            `/api/v1/courses/${e.id}/blueprint_templates/default/associated_courses?${t}`
          );
        },
        saveAssociations: ({
          masterCourse: e,
          addedAssociations: t,
          removedAssociations: o,
        }) =>
          c["a"].put(
            `/api/v1/courses/${e.id}/blueprint_templates/default/update_associations`,
            {
              course_ids_to_add: t.map((e) => e.id),
              course_ids_to_remove: o.map((e) => e.id),
            }
          ),
        getMigrations: ({ masterCourse: e }) =>
          c["a"].get(
            `/api/v1/courses/${e.id}/blueprint_templates/default/migrations`
          ),
        beginMigration({
          masterCourse: e,
          willSendNotification: t,
          willIncludeCustomNotificationMessage: o,
          notificationMessage: l,
          willIncludeCourseSettings: a,
          willPublishCourses: i,
        }) {
          const n = { send_notification: t };
        ...
        checkMigration(e) {
          return this.getMigrations(e).then((e) => {
            let t = a["a"].void;
        ...
        getMigration: (
          { course: e },
          {
            blueprintType: t = "blueprint_templates",
            templateId: o = "default",
            changeId: l,
          }
        ) => c["a"].get(`/api/v1/courses/${e.id}/${t}/${o}/migrations/${l}`),
        getMigrationDetails: (
          { course: e },
          {
            blueprintType: t = "blueprint_templates",
          ...
          c["a"].get(
            `/api/v1/courses/${e.id}/${t}/${o}/migrations/${l}/details`
          ),
        getFullMigration({ course: e }, t) {
          return this.getMigration({ course: e }, t).then(({ data: o }) =>
            this.getMigrationDetails({ course: e }, t).then((e) =>
              Object.assign(o, { changeId: t.changeId, changes: e.data })
            )
          );
        },
        getSyncHistory({ masterCourse: e }) {
          return this.getMigrations({ masterCourse: e }).then(({ data: t }) =>
            Promise.all(
              t
                .slice(0, 5)
                .map((t) =>
                  this.getMigrationDetails(
                    { course: e },
                    { changeId: t.id }
                  ).then((e) => Object.assign(t, { changes: e.data }))
                )
            )
          );
        },
        toggleLocked: ({ courseId: e, itemType: t, itemId: o, isLocked: l }) =>
          c["a"].put(
            `/api/v1/courses/${e}/blueprint_templates/default/restrict_item`,
            { content_type: t, content_id: o, restricted: l }
          ),
        loadUnsyncedChanges: ({ masterCourse: e }) =>
          c["a"].get(
            `/api/v1/courses/${e.id}/blueprint_templates/default/unsynced_changes`
          ),
      };
      t["a"] = i;
    },
      ...
      const k = (e) => (t) =>
        window.matchMedia
          ? Object(c["a"])(_["a"], {
              ...
              query: r,
              render: (o, c) =>
                a.a.createElement(e, Object.assign({ breakpoints: s(c) }, t)),
            })
          : a.a.createElement(e, Object.assign({ breakpoints: {} }, t));
      n.a.shape({
        miniTablet: n.a.bool,
        tablet: n.a.bool,
        desktop: n.a.bool,
        desktopNavOpen: n.a.bool,
        desktopOnly: n.a.bool,
        mobileOnly: n.a.bool,
      });
      t["a"] = k;
    },
    v0Tn: function (e, t, o) {
      ...
      const i = {
        statesList: a,
        states: a.reduce((e, t) => Object.assign(e, { [t]: t }), {}),
      };
    ...
    y8OA: function (e, t, o) {
        ...
        Object.assign(
          {
            assignment: {
              ...
              itemIdPath: { show: "ASSIGNMENT_ID", edit: "ASSIGNMENT.id" }[
                e.page
              ],
            },
            quiz: {
              ...
              toggleWrapperChildIndex: { edit: 2 }[e.page],
              itemIdPath: "QUIZ.id",
            },
            discussion_topic: {
              toggleWrapperSelector: {
            ...
            wiki_page: {
              toggleWrapperSelector: { show: ".blueprint-label" }[e.page],
      ...
      class C extends s["Component"] {
        ...
        componentDidUpdate(e) {
          this.props.isLocked &&
            !e.isLocked &&
            r.a.screenReaderFlashMessage(
              h.t("%{attributes} locked", {
                attributes: Object(v["a"])(this.props.itemLocks),
              })
            );
        }
        render() {
          if (this.props.isLocked)
            return Object(c["a"])(
              ...
              Object(c["a"])(
                ...
                { size: "small" },
                void 0,
                Object(v["a"])(this.props.itemLocks)
              )
            );
          return null;
        }
      ...
      const I = {
        ...
        TEACH_LOCKED: { label: w.t("Locked"), icon: A["a"] },
        TEACH_UNLOCKED: { label: w.t("Blueprint"), icon: S["a"] },
      };
      class M extends s["Component"] {
        static setupRootNode(e, t, o) {
        ...
        constructor(e) {
          ...
          this.onExit = () => {
            this.props.isToggleable &&
              this.setState({
                mode: this.props.isLocked ? I.ADMIN_LOCKED : I.ADMIN_UNLOCKED,
              });
          };
          this.state = {};
          this.toggleBtnRef = null;
          e.isToggleable
            ? (this.state.mode = e.isLocked ? I.ADMIN_LOCKED : I.ADMIN_UNLOCKED)
            : (this.state.mode = e.isLocked
                ? I.TEACH_LOCKED
                : I.TEACH_UNLOCKED);
        }
        componentDidMount() {
          const e = Math.max(...Object.values(I).map((e) => e.label.length));
          this.toggleBtnRef &&
            (this.toggleBtnRef.style.width = 0.845 * e + "em");
        }
        render() {
          var e, t, o, l;
          ...
          if (this.props.isToggleable) {
            const _ = this.state.mode.variant;
            const r = this.state.mode.tooltip;
            const s = this.props.isLocked
              ? w.t("Locked. Click to unlock.")
              : w.t("Unlocked. Click to lock.");
            n = Object(c["a"])(
              j["a"],
              {
                tip: r,
              ...
              this.props.breakpoints.miniTablet
                ? Object(c["a"])(
                    ...
                    {
                      id: "lock-toggle-btn",
                      elementRef: (e) => (this.toggleBtnRef = e),
                      variant: _,
                    ...
                    void 0,
                    e || (e = Object(c["a"])(a, {})),
                    t || (t = Object(c["a"])(E["a"], {}, void 0, i)),
                    o || (o = Object(c["a"])(B["a"], {}, void 0, s))
                  )
                : Object(c["a"])(
                    q["a"],
                    {
                      color: "primary" === _ ? _ : null,
                      onClick: this.props.onClick,
                      onFocus: this.onEnter,
                      onBlur: this.onExit,
                      onMouseEnter: this.onEnter,
            ...
            n = Object(c["a"])(
              ...
              Object(c["a"])(L["a"], { size: "small" }, void 0, i)
            );
          return Object(c["a"])(
            "span",
      ...
      class x {
        ...
        init(e) {
          ...
          this.props = g(e);
          this.setupState();
          void 0 !== this.state.itemId && this.render();
        }
        shouldInit() {
          return (
        ...
        setupState() {
          this.state = {
            ...
            itemId: b()(ENV, this.props.itemIdPath),
          };
        }
        setState(e) {
        ...
        getItemLocks() {
          return Object(l["a"])({}, this.state.itemLocks);
        }
        isMasterContent() {
        ...
        showToggleError() {
          r.a.flashError(n.t("There was a problem toggling the content lock."));
        }
        setupToggle(e) {
          ...
          this.setupToggle(() => {
            u.a.render(
              Object(c["a"])(y, {
                ...
                isToggleable:
                  "show" === this.props.page && this.state.isMasterContent,
        ...
        renderBanner() {
          this.bannerNode || (this.bannerNode = C.setupRootNode());
          u.a.render(
            Object(c["a"])(C, {
              isLocked: this.state.isLocked,
...
//# sourceMappingURL=52-c-53c2b73542.js.map
