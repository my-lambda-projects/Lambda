      ...
      (FreshUrl = (function () {
        function n(t) {
          ...
          if ((null == t && (t = []), window.history.replaceState)) {
            for (
              this.key = 0, this._isReady = {}, e = 0, o = t.length;
              o > e;
              e++
            )
              (i = t[e]),
                "string" == typeof i && n.libraries[i]
            ...
            0 === t.length && this.allReady() && this.allReadyCallback(),
              n.updateWistiaIframes(),
              (r = function (t) {
                return "new-wistia-iframe" === t.data
                  ? n.updateWistiaIframes()
                  : void 0;
              }),
        ...
        return (
          (n.libraries = {
            googleAnalytics: {
              ...
              ready: function (t) {
                return n
                  .waitsFor(n.libraries.googleAnalytics.present)
                  .then(function () {
                    var n;
            ...
            hubspot: {
              present: function () {
                return (
                  window._hsq ||
                  n.scriptFrom(/\/\/(js\.hubspot\.com|js.hs-analytics\.net)/)
                );
              },
              ready: function (t) {
                return n
            ...
            clicky: {
              present: function () {
                return (
                  ...
                  n.scriptFrom(/\/\/static\.getclicky\.com/)
                );
              },
              ready: function (t) {
                return n
            ...
            pardot: {
              present: function () {
                return (
                  window.piAId ||
                  window.piCId ||
                  n.scriptContains(/\.pardot\.com\/pd\.js/)
                );
              },
              ready: function (t) {
                return n
          ...
          (n.scriptFrom = function (n) {
            var t, e, r, i, o;
            for (
              r = document.getElementsByTagName("script"), t = 0, e = r.length;
              e > t;
              t++
            )
              if (
                ((o = r[t]),
                null != (i = o.getAttribute("src")) ? i.match(n) : void 0)
              )
                return !0;
            return !1;
          }),
          (n.scriptContains = function (n) {
            ...
            for (
              ...
              if (((o = r[t]), null != (i = o.innerHTML) ? i.match(n) : void 0))
                return !0;
            return !1;
          }),
          ...
          (n.wistiaIframes = function () {
            ...
            for (
              ...
              (t = r[n]), t.src.match(/\/\/.*\.wistia\..*\//) && i.push(t);
            return i;
          }),
        ...
        "undefined" != typeof _freshenUrlAfter && null !== _freshenUrlAfter
          ...
          ? dataLayer.push(function () {
              return (window.freshUrl = new FreshUrl(
                FreshUrl.librariesPresent()
              ));
            })
