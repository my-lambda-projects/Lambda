(window["canvasWebpackJsonp"] = window["canvasWebpackJsonp"] || []).push([
  [622, 98, 109, 116, 117, 142],
  {
    "0crz": function (e, t, i) {
      ...
      r = "LINK-PLACEHOLDER";
      d =
        /\b((?:https?:\/\/|www\d{0,3}[.]|[a-z0-9.\-]+[.][a-z]{2,4}\/)(?:[^\s()<>]+|\([^\s()<>]*\))+(?:\([^\s()<>]*\)|[^\s`!()\[\]{};:'".,<>?«»"”‘’]))|(LINK-PLACEHOLDER)/gi;
      t["a"] = u = {
        quoteClump: function (e) {
          return (
            "<div class='quoted_text_holder'> <a href='#' class='show_quoted_text_link'>" +
            Object(_["a"])(l.t("quoted_text_toggle", "show quoted text")) +
            "</a> <div class='quoted_text' style='display: none;'> " +
            n.a.raw(e.join("\n")) +
            " </div> </div>"
          );
        },
    ...
    "3wee": function (e, t, i) {
      ...
      class _ extends s.a.View {
        ...
        pollForChanges() {
          ...
          if (i && !t.isNew()) {
            i.on("change:revision_id", () =>
              i.fetch({ data: { summary: false } }).done(() => {
                e.render();
                e.trigger("changed");
        ...
        stopPolling() {
          return null != this.latestRevision
            ? this.latestRevision.stopPolling()
            : void 0;
        }
        reload(e) {
          ...
          this.model.set(
            n.a.pick(
              this.latestRevision.attributes,
              this.options.modelAttributes
            )
          );
          this.trigger("reload");
    ...
    "5Shj": function (e, t, i) {
      ...
      var C = {
        componentId: "eZLSb",
        template: function (e) {
          return "\n\n.eZLSb_bGBk{box-sizing:border-box;display:block;font-family:"
            .concat(e.fontFamily || "inherit", ";font-size:")
            .concat(e.fontSize || "inherit", ";font-weight:")
            .concat(e.fontWeight || "inherit", ";padding:")
            .concat(e.padding || "inherit", "}");
        },
        root: "eZLSb_bGBk",
      };
      var N =
        ((q = Object(p["a"])("8.0.0", { tip: "renderTip", variant: "color" })),
        (j = Object(g["a"])()),
        (S = Object(m["j"])(z, C)),
        q(
          (D =
                ...
                S(
                  (D =
                      ...
                      (function (e) {
                        ...
                        function i() {
                          ...
                          e.handleFocus = function (t) {
                            e.setState({ hasFocus: true });
                          };
                          e.handleBlur = function (t) {
                            e.setState({ hasFocus: false });
                          };
                          return e;
                        }
                        Object(o["a"])(i, [
                    ...
                    (E.propTypes = {
                      ...
                      as: u.a.elementType,
                      on: u.a.oneOfType([
                        u.a.oneOf(["click", "hover", "focus"]),
                        u.a.arrayOf(u.a.oneOf(["click", "hover", "focus"])),
                      ]),
      ...
      var V =
        ((M = Object(p["a"])(
          "7.0.0",
          null,
          "Use Tooltip from ui-tooltip instead."
        )),
        (I = Object(g["a"])()),
        (P = Object(m["j"])(A, L)),
        M(
    ...
    "7LJr": function (e, t, i) {
      ...
      n.a.fn.loadingImg = function (e) {
        ...
        e.image_size &&
          n.a.fn.loadingImg.image_files[e.image_size] &&
          (o = n.a.fn.loadingImg.image_files[e.image_size]);
        e.paddingTop && (e.vertical = e.paddingTop);
        let s = 0;
        if (e.vertical)
          if ("top" === e.vertical);
          else if ("bottom" === e.vertical) s = i.outerHeight();
          else if ("middle" === e.vertical)
            s = i.outerHeight() / 2 - o.height / 2;
          else {
        ...
        if (e.horizontal)
          ...
          } else if ("middle" === e.horizontal)
            l = i.outerWidth() / 2 - o.width / 2;
          else {
            l = parseInt(e.horizontal, 10);
            isNaN(l) && (l = 0);
          }
        const _ = i.zIndex() + 1;
        const r = n()(document.createElement("div")).addClass(
          "loading_image_holder"
        );
        ...
        if (i.css("position") && "static" !== i.css("position")) {
          r.css({ zIndex: _, position: "absolute", top: s, left: l });
          i.append(r);
        } else {
          const t = i.offset();
          let a = t.top,
          ...
          e.vertical && (a += s);
          e.horizontal && (o += l);
          r.css({ zIndex: _, position: "absolute", top: a, left: o });
          n()("body").append(r);
        }
        return n()(this);
      };
    ...
    BHWx: function (e, t, i) {
      ...
      l.contextFor = function (e) {
        let t;
        e.collection &&
          e.collection.parentFolder &&
          (e = e.collection.parentFolder);
        if (e instanceof n["a"]) {
          const i = e;
          t = `${i && i.get("context_type")}s_${
            i && i.get("context_id")
          }`.toLowerCase();
        } else
          e.contextType &&
            e.contextId &&
            (t = `${e.contextType}_${e.contextId}`.toLowerCase());
      ...
      l.userHasPermission = function (e, t) {
        ...
        return (
          l.contextFor(e) &&
          l.contextFor(e).permissions &&
          l.contextFor(e).permissions[t]
        );
      };
      l.baseUrl = l.showingAllContexts
        ? "/files"
        : `/${l.contextType}/${l.contextId}/files`;
      t["default"] = l;
    },
    BVrx: function (e, t, i) {
      "use strict";
      ...
      class r extends l["a"] {
        ...
        submit(e) {
          ...
          t.then(() => {
            if (n) {
              ...
              const t = "/";
              o.a.cookie("deleted_page_title", a, { expires: e, path: t });
              return (window.location.href = n);
            }
            o.a.flashMessage(
              s["a"].t(
                "notices.page_deleted",
                'The page "%{title}" has been deleted.',
                { title: a }
              )
            );
            i.resolve();
        ...
        close() {
          (null != this.dialog ? this.dialog.isOpen() : void 0) &&
            this.dialog.close();
          return "delete" === this.buttonClicked
            ? null != this.onDelete
              ? this.onDelete()
              : void 0
            : null != this.focusOnCancel
            ? this.focusOnCancel.focus()
            : void 0;
        }
        setupDialog() {
    ...
    "Ewk/": function (e, t, i) {
      ...
      var k = {
        ...
        updatePublishClassElements() {
          return this.props.togglePublishClassOn.classList[
            this.state.published ? "add" : "remove"
          ]("ig-published");
        },
        getRestrictedText() {
          if (
            this.props.model.get("unlock_at") &&
            this.props.model.get("lock_at")
          )
            return f.t("Available after %{unlock_at} until %{lock_at}", {
          ...
          if (
            ...
            return f.t("Available after %{unlock_at}", {
              unlock_at: u.a.datetimeString(this.props.model.get("unlock_at")),
            });
          if (
            !this.props.model.get("unlock_at") &&
            ...
            return f.t("Available until %{lock_at}", {
              lock_at: u.a.datetimeString(this.props.model.get("lock_at")),
            });
        },
      ...
      k.render = function () {
        const e =
          ...
          p.t("This file");
        return this.props.userCanEditFilesForContext
          ? this.state.published && this.state.restricted
            ? o.a.createElement(
                "button",
                {
                  type: "button",
                  ...
                  "aria-label": p.t(
                    "%{fileName} is %{restricted} - Click to modify",
                    { fileName: e, restricted: this.getRestrictedText() }
                  ),
                },
                v ||
                  (v = Object(a["a"])("i", {
            ...
            : this.state.published && this.state.hidden
            ? o.a.createElement(
                "button",
                {
                  type: "button",
                ...
                y ||
                  (y = Object(a["a"])("i", { className: "icon-off icon-line" }))
              )
            ...
            ? o.a.createElement(
                "button",
                {
                  ...
                  title: p.t("Published"),
                  "aria-label": p.t(
                    "%{fileName} is Published - Click to modify",
                    { fileName: e }
                  ),
                },
                w ||
            ...
            : o.a.createElement(
                ...
                x || (x = Object(a["a"])("i", { className: "icon-unpublish" }))
              )
          : this.state.published && this.state.restricted
          ? o.a.createElement(
              "div",
              ...
              z || (z = Object(a["a"])("i", { className: "icon-calendar-day" }))
            )
          : Object(a["a"])("div", { style: { width: 28, height: 36 } });
      };
      t["a"] = l()(k);
    },
    HaSH: function (e, t, i) {
    ...
    KUiY: function (e, t, i) {
      ...
      class x extends b["Model"] {
        static initClass() {
          ...
          this.prototype.urls = {
            generic() {
              return `${this.baseUrl()}/modules/${this.get(
                "module_id"
              )}/items/${this.get("module_item_id")}`;
            },
            module() {
          ...
          this.prototype.disabledMessages = {
            generic() {
              return this.get("module_item_name")
                ? w.t("Publishing %{item_name} is disabled", {
            ...
            assignment() {
              return this.get("module_item_name")
                ? w.t(
                    "Can't unpublish %{item_name} if there are student submissions",
                    { item_name: this.get("module_item_name") }
                  )
        ...
        branch(e) {
          return (this[e][this.get("module_type")] || this[e].generic).call(
            this
          );
        }
        url() {
      ...
      var V = (function (e) {
        ...
        t.prototype.success = function (e) {
          this.$context_module.data(
            "workflow-state",
            e.context_module.workflow_state
          );
          "unpublished" === e.context_module.workflow_state
        ...
        t.prototype.setRequestPublishOptions = function (e) {
          return "active" === this.workflow_state
            ? (e.data = "unpublish=1")
            : (e.data = "publish=1");
        };
        t.prototype.addUnpublishAttributes = function () {
          this.$context_module
            ...
            .text(O.t("context_modules.publish", "Publish"));
          this.$context_module
        ...
        t.prototype.addPublishAttributes = function () {
          this.$context_module
            .find(".workflow-state-action")
            .text(O.t("context_module.unpublish", "Unpublish"));
          this.$context_module
            .find(".workflow-state-icon")
        ...
        t.prototype.onDownArrowKey = function (e, t) {
          ...
          if (i.is(this.itemSelector)) {
            ...
            (this.empty(a) || this.$contextModules.data("dragModule")) &&
              (a = i.next(this.moduleSelector));
        ...
        t.prototype.onSpaceKey = function (e, t) {
          ...
          if ((i = this.$contextModules.data("dragItem"))) {
            if (!n.is(i)) {
              ...
              n.is(this.itemSelector) && !this.empty(n.parents(o))
                ? n.after(i)
                : o.find(".items").prepend(i);
              modules.updateModuleItemPositions(null, { item: i.parent() });
            }
          ...
          if ((a = this.$contextModules.data("dragModule"))) {
            n.is(this.itemSelector) &&
              (n = n.parents(this.moduleSelector).first());
            if (!n.is(a)) {
              this.empty(n) || n.is(this.$contextModules)
                ? this.$contextModules.prepend(a)
                : n.after(a);
          ...
          if (!n.is(this.$contextModules)) {
            ...
            if (n.is(this.itemSelector)) {
              ...
              this.$contextModules.data(
                "dragItemModule",
                n.parents(this.moduleSelector).first()
              );
            } else
              n.is(this.moduleSelector) &&
                this.$contextModules.data("dragModule", n);
            n.blur();
            return n.focus();
          }
        };
      ...
      W[$] = H(function (e, t, i, a, n) {
        ...
        l +=
          ...
          r(
            ((o = i.t || (t && t.t)),
            (s = { hash: { i18n_inferred_key: true }, data: n }),
            o
              ? o.call(
                  t,
                  "you_have_changed_the_progression_requirements_for__6772bc89",
      ...
      class Q extends U["a"] {
        ...
        relock() {
          ...
          return this.dialog.disableWhileLoading(
            N.a.ajaxJSON(e, "PUT", {}, () => this.close())
          );
        }
      }
      ...
      ee[te] = X(function (e, t, i, a, n) {
        ...
        function u(e, t) {
          var a,
            ...
            o = "";
          o += 'href="';
          if ((n = i.link_href)) a = n.call(e, { hash: {}, data: t });
          else {
            n = e && e.link_href;
            a = typeof n === _ ? n.call(e, { hash: {}, data: t }) : n;
          }
          o += r(a) + '"';
          return o;
        }
        function c(e, t) {
          var a,
            ...
            o = "";
          o += '\n      <div class="clearfix">\n        <dt>';
          if ((n = i.due_for)) a = n.call(e, { hash: {}, data: t });
          else {
            n = e && e.due_for;
            a = typeof n === _ ? n.call(e, { hash: {}, data: t }) : n;
          }
          o += r(a) + "</dt>\n        <dd>";
          if ((n = i.due_at)) a = n.call(e, { hash: {}, data: t });
          else {
            n = e && e.due_at;
            a = typeof n === _ ? n.call(e, { hash: {}, data: t }) : n;
          }
        ...
        function m(e, t) {
          var a,
            ...
            o = "";
          o += '\n      <div class="clearfix">\n        <dd>';
          if ((n = i.more_message)) a = n.call(e, { hash: {}, data: t });
          else {
            n = e && e.more_message;
            a = typeof n === _ ? n.call(e, { hash: {}, data: t }) : n;
          }
        ...
        if ((s = i.selector)) o = s.call(t, { hash: {}, data: n });
        else {
          s = t && t.selector;
          o = typeof s === _ ? s.call(t, { hash: {}, data: n }) : s;
        }
        l += r(o) + '"\n  ';
        ...
        (o || 0 === o) && (l += o);
        l += "\n  >";
        if ((s = i.link_text)) o = s.call(t, { hash: {}, data: n });
        else {
          s = t && t.link_text;
          o = typeof s === _ ? s.call(t, { hash: {}, data: n }) : s;
        }
      ...
      const le = (e, t) => {
        ...
        e.find('[aria-controls="context_module_content_"]').attr(
          "aria-controls",
          i
        );
      };
      ...
      function ve(e, t = 500) {
        ...
        N()("html, body").animate({ scrollTop: e.offset().top }, t);
      }
      function ye(e) {
        !ENV.DUPLICATE_ENABLED ||
        e.find(".context_module_item.quiz").length ||
        e.find(".cannot-duplicate").length
          ? e.find(".duplicate_module_menu_item").attr("hidden", true)
          : e.find(".duplicate_module_menu_item").removeAttr("hidden");
      }
      window.modules = {
        updateTaggedItems() {},
        currentIndent(e) {
        ...
        addModule() {
          const e = N()("#context_module_blank")
            .clone(true)
          ...
          N()(
            "#context_modules .context_module .context_module_items.ui-sortable"
          ).each(function () {
        ...
        updateModulePositions() {
          ...
          N.a.ajaxJSON(
            ...
            (e) => {
              ...
              for (const t in e) {
                const i = e[t];
                N()("#context_module_" + i.context_module.id).triggerHandler(
                  "update",
                  i
                );
              }
        ...
        updateModuleItemPositions(e, t) {
          ...
          const o = [];
          i.find(".context_module_items .context_module_item").each(
            function () {
              o.push(N()(this).getTemplateData({ textValues: ["id"] }).id);
            }
          );
          i.find(".context_module_items.ui-sortable").sortable("disable");
          i.disableWhileLoading(
            N.a.ajaxJSON(
              n,
              "POST",
              { order: o.join(",") },
              ...
              (e) => {
                ...
                i.find(".content").errorBox(
                  T.t("errors.reorder", "Reorder failed, please try again.")
                );
              }
            )
          );
        ...
        updateProgressions(e) {
          ...
          N()(".context_module_item.progression_requirement:visible").length >
            0 &&
            N()(".loading_module_progressions_link")
              .show()
              .attr("disabled", true);
          N.a.ajaxJSON(
            t,
            ...
            function (t) {
              ...
              const n = function () {
                N()("#context_modules").hasClass("editable") ||
                  N()("#context_modules .context_module").each(function () {
              ...
              var s = function () {
                ...
                if (t.user_id == window.ENV.current_user_id) {
                  ...
                  if (0 === e.length && i.length > 0) {
                    ...
                    e.removeClass("progression_blank").addClass(
                      "progression_" + t.context_module_id
                    );
                    i.append(e);
                  }
                  if (e.length > 0) {
            ...
            (t) => {
              N()(() => {
                N.a.each(t, (e, t) => {
                  ...
                  const a = {};
                  null != t.points_possible &&
                    (a.points_possible_display = T.t(
                      "points_possible_short",
                      "%{points} pts",
                      { points: T.n(t.points_possible) }
                    ));
                  if (null != t.todo_date)
                    a.due_date_display = N.a.dateString(t.todo_date);
                  else if (null != t.due_date) {
                    null != t.past_due && i.data("past_due", true);
                    a.due_date_display = N.a.dateString(t.due_date);
                  } else if (null != t.has_many_overrides)
                    a.due_date_display = T.t("Multiple Due Dates");
                  ...
                  null === t.points_possible &&
                    i.find(".points_possible_display").remove();
                  if (t.mc_objectives) {
        ...
        loadMasterCourseData(e) {
          ENV.MASTER_COURSE_SETTINGS &&
            N.a.ajaxJSON(
              ...
              (e) => {
                e.tag_restrictions &&
                  N.a.each(e.tag_restrictions, (e, t) => {
                    const i = N()("#context_module_item_" + e).not(
                      ".master_course_content"
                    );
        ...
        itemClass: (e) =>
          (e.content_type || "").replace(/^[A-Za-z]+::/, "") +
          "_" +
          e.content_id,
        updateAllItemInstances(e) {
          N()(".context_module_item." + modules.itemClass(e) + " .title").each(
            function () {
              const t = N()(this);
              t.text(e.title);
        ...
        editModule(e) {
          ...
          a.fillFormData(n, { object_name: "context_module" });
          let o = false;
          if ("context_module_new" == e.attr("id")) {
            ...
            a.attr("method", "PUT");
            a.find(".submit_button").text(
              T.t("buttons.update", "Update Module")
            );
          }
          a.find("#unlock_module_at").prop("checked", n.unlock_at).change();
          a.find("#require_sequential_progress").attr(
            "checked",
            "true" == n.require_sequential_progress ||
              "1" == n.require_sequential_progress
          );
          a.find("#publish_final_grade").attr(
            "checked",
            "true" == n.publish_final_grade || "1" == n.publish_final_grade
          );
          const s =
            N()("#context_modules .context_module").length > 1 &&
            N()("#context_modules .context_module:first").attr("id") !==
              e.attr("id");
          a.find(".prerequisites_entry").showIf(s);
          const l = [];
          e.find(".prerequisites .prerequisite_criterion").each(function () {
            l.push(
              N()(this).getTemplateData({ textValues: ["id", "name", "type"] })
            );
          });
          ...
          for (const e in l) {
            ...
            "context_module" == t.type &&
              a
                .find(
                  ".prerequisites_list .criteria_list .criterion:last select"
                )
                .val(t.id)
                .trigger("change");
          }
          a.find(".completion_entry .criteria_list").empty();
          e.find(".content .context_module_item .criterion.defined").each(
            function () {
              const e = N()(this)
              ...
              a.find(".criteria_list .criterion:last")
                .find(".id")
                .val(e.id || "")
                .change()
                .end()
                .find(".type")
                .val(e.criterion_type || "")
                .change()
                .end()
                .find(".min_score")
                .val(e.min_score || "");
          ...
          a.find(".prerequisites_list .criteria_list")
            .showIf(0 != l.length)
            .end()
          ...
          0 !==
          e.find(".content .context_module_item .criterion.defined").length
            ? N()(".requirement-count-radio").show()
            : N()(".requirement-count-radio").hide();
          const r = e.find(".pill li").data("requirement-count");
          1 == r
            ? N()("#context_module_requirement_count_1")
                .prop("checked", true)
                .change()
            : N()("#context_module_requirement_count_")
                .prop("checked", true)
                .change();
          e.fadeIn("fast", () => {});
          ...
          a.dialog({
            ...
            modal: true,
            title: o
              ? T.t("titles.add", "Add Module")
              : T.t("titles.edit", "Edit Module Settings"),
            width: u ? m : 600,
            height: o ? 400 : 600,
            close() {
              ...
              e.length &&
                N()("#context_modules_sortable_container").removeClass(
        ...
        hideEditModule(e) {
          ...
          e &&
            t &&
            "context_module_new" == t.attr("id") &&
            !t.hasClass("dont_remove") &&
            t.remove();
        ...
        addItemToModule(e, t) {
          ...
          let i,
            a = "new" !== t.id ? N()("#context_module_item_" + t.id) : [];
          if (a.length) {
          ...
          let n = null;
          e.find(".context_module_items")
            .children()
            .each(function () {
              const e = parseInt(
                N()(this).getTemplateData({ textValues: ["position"] })
                  .position,
                10
              );
              (!t.position && 0 !== t.position) ||
                (!e && 0 !== e) ||
                (null == n && e - t.position >= 0 && (n = N()(this)));
            });
          a.length
            ? a.replaceWith(i.show())
            : n
            ? n.before(i.show())
            : e.find(".context_module_items").append(i.show());
          ye(e);
          return i;
        },
        evaluateItemCyoe(e, t) {
          ...
          if (n.isReleased) {
            ...
            const t = N()(
              ...
              .attr("title", e)
              .append(Object(se["a"])(n.releasedLabel));
            const i = N()('<span class="screenreader-only">').append(
              Object(se["a"])(e)
            );
            a.prepend(i);
            a.prepend(t);
          ...
          if (n.isCyoeAble) {
            const e = N()('<a class="mastery_paths_link" />')
              .attr(
                "href",
              ...
              .attr(
                "title",
                T.t("Edit Mastery Paths for %{title}", { title: t.title })
              )
            ...
            a.find(".delete_link")
              .parent()
              .before(
                N()('<li role="presentation" />').append(
                  e.prepend('<i class="icon-mastery-path" /> ')
                )
              );
          }
        },
        ...
        prerequisites() {
          ...
          N()("#context_modules .context_module").each(function () {
            ...
            N()(this)
              ...
              .each(function () {
                const i = N()(this).getTemplateData({ textValues: ["id"] }).id;
        ...
        updateProgressionState(e) {
          ...
          "locked" != n &&
            "unlocked" != n &&
            e.find(".completion_status i:visible").attr("title", s);
          "completed" != n ||
            e.find(".progression_requirement").length ||
            (n = "");
          ...
          e.find(".context_module_item").each(function () {
            const e = N()(this);
            const t = parseInt(
              e.getTemplateData({ textValues: ["position"] }).position,
              10
            );
            a.current_position &&
              t &&
              a.current_position < t &&
              e.addClass("after_current_position");
            const i = e.find(".module-item-status-icon");
            const s = e.getTemplateData({ textValues: ["id"] }).id;
            const r = o.a.some(
              l,
              (t) => t.id == s && e.hasClass(t.type + "_requirement")
            );
            if (r) {
              e.addClass("completed_item");
              we(i, "icon-check", T.t("Completed"));
            } else if ("completed" == n)
              e.hasClass("progression_requirement") &&
                we(i, "no-icon", T.t("Not completed"));
            else if (null != e.data("past_due"))
              we(i, "icon-minimize", T.t("This assignment is overdue"));
            else {
              let t = null;
              ...
              t
                ? null != t.score
                  ? we(
                      i,
                      "icon-minimize",
                      T.t("You scored a %{score}.", { score: t.score }) +
                        " " +
                        xe(e) +
                        "."
                    )
                  : we(
                      i,
                      "icon-info",
                      T.t("Your submission has not been graded yet")
                    )
                : e.hasClass("progression_requirement") &&
                  we(i, "icon-mark-as-read", xe(e));
            }
          });
        ...
        initMasterCourseLockButton(e, t) {
          ...
          const a = N()(i).data() || {};
          const n = !!(
            "moduleItemId" in a && ENV.MASTER_COURSE_SETTINGS.IS_MASTER_COURSE
          );
          const o = !!(
            "moduleItemId" in a && ENV.MASTER_COURSE_SETTINGS.IS_CHILD_COURSE
          );
      ...
      var xe = function (e) {
        return e.hasClass("must_submit_requirement")
          ? T.t("Must submit the assignment")
          : e.hasClass("must_mark_done_requirement")
          ? T.t("Must mark as done")
          : e.hasClass("must_view_requirement")
          ? T.t("Must view the page")
          : e.hasClass("min_contribute_requirement")
          ? T.t("Must contribute to the page")
          : e.hasClass("min_score_requirement")
          ? T.t("Must score at least a %{score}", {
              score: e.getTemplateData({ textValues: ["min_score"] }).min_score,
            })
      ...
      const qe = function (e, t) {
        N()("div.context_module .prerequisite_criterion .id").each(function (
          i,
          a
        ) {
          const n = N()(a);
          ...
          if (o == e) {
            ...
            const a = N.a
              .makeArray(i.find(".prerequisite_criterion .name"))
              .map((e) => N()(e).text())
              .join(", ");
      ...
      var je = function (e) {
        return T.t("Prerequisites: %{list}", { list: e });
      };
      const Se = function (e, t) {
        ...
        if (0 != t) {
          ...
          const n =
            1 === t ? T.t("Complete One Item") : T.t("Complete All Items");
          a.text(n);
          a.data("requirement-count", t);
        }
      };
      modules.initModuleManagement = function () {
        new V({ el: N()("#content"), modules: modules });
        const e = new Q();
        ...
        N()(".context_module").bind("update", (e, t) => {
          t.context_module.displayed_unlock_at = N.a.datetimeString(
            t.context_module.unlock_at
          );
          t.context_module.unlock_at = N.a.datetimeString(
            t.context_module.unlock_at
          );
          ...
          i.find(".unlock_details").showIf(
            t.context_module.unlock_at &&
              Date.parse(t.context_module.unlock_at) > new Date()
          );
          ze(i, t.context_module.prerequisites);
          qe(t.context_module.id, t.context_module.name);
          0 === t.context_module.completion_requirements.length
            ? i.find(".requirements_message").empty()
            : Se(i, t.context_module.requirement_count);
          ...
          for (const e in t.context_module.completion_requirements) {
            ...
            n.addClass(a.type + "_requirement").addClass(
        ...
        N()("#add_context_module_form").formSubmit({
          ...
          processData(e) {
            ...
            const i = N()(this).find(
              ".completion_entry .criteria_list .criterion"
            );
            i.each(function () {
              const t = N()(this).find(".id").val();
              e["context_module[completion_requirements][" + t + "][type]"] =
                N()(this).find(".type").val();
              e[
                "context_module[completion_requirements][" + t + "][min_score]"
              ] = N()(this).find(".min_score").val();
            });
            const a = N()(
              'input[name="context_module[requirement_count]"]:checked'
            ).val();
          ...
          success(t, i) {
            ...
            null !== (n = window.ENV) &&
              ...
              null !== (o = n.FEATURES) &&
              void 0 !== o &&
              o.new_math_equation_handling &&
              be["a"].isMathMLOnPage() &&
              (be["a"].isMathJaxLoaded()
                ? be["a"].reloadElement("content")
                : be["a"].loadMathJax(void 0));
          },
          error(e, t) {
            t.loadingImage("remove");
          },
        });
        N()("#add_context_module_form .add_prerequisite_link").click(function (
          e
        ) {
          e.preventDefault();
          ...
          const o = [];
          N()("#context_modules .context_module").each(function () {
            (N()(this)[0] == i[0] || o.length > 0) &&
              o.push(N()(this).attr("id"));
          });
          for (const e in o) a.find("." + o[e]).hide();
          a.attr("id", "module_list_prereq");
          n.find(".option").empty().append(a.show());
          N()('<label for="module_list_prereq" class="screenreader-only" />')
            .text(T.t("Select prerequisite module"))
            .insertBefore(a);
          ...
          a.change((e) => {
            ...
            n.attr(
              "aria-label",
              T.t("Delete prerequisite %{title}", { title: i })
            );
          });
          a.focus();
        });
        N()("#add_context_module_form .add_completion_criterion_link").click(
          function (e) {
            e.preventDefault();
            const t = N()(this).parents("#add_context_module_form");
            const i = t.data("current_module");
            const a = N()("#completion_criterion_option")
              .clone(true)
              .removeAttr("id");
            ...
            const s = {};
            i.find(".content .context_module_item")
              ...
              .each(function () {
                ...
                "assignment" == t.type
                  ? (e = T.t("optgroup.assignments", "Assignments"))
                  : "attachment" == t.type
                  ? (e = T.t("optgroup.files", "Files"))
                  : "quiz" == t.type
                  ? (e = T.t("optgroup.quizzes", "Quizzes"))
                  : "external_url" == t.type
                  ? (e = T.t("optgroup.external_urls", "External URLs"))
                  : "context_external_tool" == t.type
                  ? (e = T.t("optgroup.external_tools", "External Tools"))
                  : "discussion_topic" == t.type
                  ? (e = T.t("optgroup.discussion_topics", "Discussions"))
                  : "wiki_page" == t.type && (e = T.t("Pages"));
                let i = s[e];
                if (!i) {
        ...
        N()("#completion_criterion_option .id").change(function () {
          ...
          const t = N()(
            "#context_module_item_" + N()(this).val()
          ).getTemplateData({ textValues: ["type", "graded"] });
          e.find(".type option")
            .hide()
            .attr("disabled", true)
            .end()
            ...
            .attr("disabled", false)
            .end()
            .find(".type option." + t.type)
            .show()
            .attr("disabled", false);
          "1" == t.graded &&
            e.find(".type option.graded").show().attr("disabled", false);
          e.find(".type").val(
            e.find(".type option." + t.criterion_type + ":first").val()
          );
          e.find(".type").change();
        });
        N()("#completion_criterion_option .type").change(function () {
          ...
          const i = N.a.trim(
            N()("#context_module_item_" + t + " .points_possible_display")
              .text()
              .split(" ")[0]
          );
          ...
          e.closest(".criterion")
            ...
            .attr(
              "aria-label",
              T.t("Delete requirement %{item} (%{type})", { item: a, type: n })
            );
        });
        N()(
          "#add_context_module_form .requirement-count-radio .ic-Radio input"
        ).change(() => {
          if (N()("#context_module_requirement_count_").prop("checked"))
            N()(".require-sequential").show();
          else {
            N()(".require-sequential").hide();
            N()("#require_sequential_progress").prop("checked", false);
          }
        });
        N()("#add_context_module_form .delete_criterion_link").click(function (
          e
        ) {
          e.preventDefault();
          ...
          const n = a.prev();
          const o = n.length
            ? N()(".delete_criterion_link", n)
            : N()(
                ".add_prerequisite_or_requirement_link",
                N()(this).closest(".form-section")
              );
          a.slideUp(function () {
            N()(this).remove();
            0 === t.html().length &&
              0 !== i.length &&
              N()(".requirement-count-radio").fadeOut("fast");
            o.focus();
          });
        });
        N()(".duplicate_module_link").live("click", function (e) {
          ...
          const o = N()(
            '<div id="temporary-spinner" class="item-group-condensed"></div>'
          );
          o.insertAfter(i);
          h.a.render(n, N()("#temporary-spinner")[0]);
          N.a.screenReaderFlashMessage(
            T.t("Duplicating Module, this may take some time")
          );
          const s = function (e) {
            ...
            pe["a"]
              ...
              .then((e) => {
                ...
                N()(
                  "#add_context_module_form .add_completion_criterion_link"
                ).off();
                N()(".context_module")
                  .find(".expand_module_link,.collapse_module_link")
                  .bind("click keyclick", Ce);
          ...
          pe["a"]
            .post(t, {})
            .then(s)
            .catch(Object(ge["b"])(T.t("Error duplicating module")));
        });
          ...
          N()(this)
            ...
            .confirmDelete({
              ...
              success(e) {
                ...
                N()(".context_module .prerequisites .criterion").each(
                  function () {
                    const e = N()(this).getTemplateData({
                      textValues: ["id", "type"],
                    });
                    "context_module" == e.type &&
                      e.id == t &&
                      N()(this).remove();
                  }
                );
                ...
                N.a.flashMessage(
                  T.t("Module %{module_name} was successfully deleted.", {
        ...
        N()(".outdent_item_link,.indent_item_link").live(
          "click",
          function (e, t, i) {
            e.preventDefault();
            const a = N()(t);
            ...
            N.a
              .ajaxJSON(
                ...
                (e) => {
                  ...
                  const t = N()(
                    "#context_module_" + e.content_tag.context_module_id
                  );
                  modules.addItemToModule(t, e.content_tag);
                  t.find(".context_module_items.ui-sortable").sortable(
                    "refresh"
                  );
                  modules.updateAssignmentData();
                },
        ...
        N()(".edit_item_link").live("click", function (e) {
          ...
          N()("#edit_item_form")
            .find(".external")
            .showIf(
              i.hasClass("external_url") || i.hasClass("context_external_tool")
            );
          ...
          const s =
            !me()(ENV, "MASTER_COURSE_SETTINGS.IS_MASTER_COURSE") &&
            !!me()(o, "content");
          n.attr("disabled", s);
          N()("#edit_item_form")
            .dialog({
        ...
        N()("#edit_item_form").formSubmit({
          ...
          success(e) {
            ...
            0 != e.content_tag.content_id &&
              "ContextExternalTool" != e.content_tag.content_type &&
              modules.updateAllItemInstances(e.content_tag);
            modules.updateAssignmentData();
            N()(this).dialog("close");
          },
          error(e) {
        ...
        N()(".delete_item_link").live("click", function (e) {
          ...
          if (o >= 0) {
            const e = i[o];
            s = N()(e).hasClass("context_module_sub_header")
              ? N()(e).find(".cog-menu-container .al-trigger")
              : N()(e).find(".item_link");
          ...
          N()(this)
            ...
            .confirmDelete({
              ...
              success(e) {
                ...
                N.a.flashMessage(
                  T.t(
                    "Module item %{module_item_name} was successfully deleted.",
        ...
        N()(".move_module_item_link").on("click keyclick", function (e) {
          ...
          const a = Array.prototype.map.call(i, (e) => {
            ...
            const i = e.querySelector(
              ".header > .collapse_module_link > .name"
            ).textContent;
            ...
            items: [
              {
                id: t
                  .getAttribute("id")
                  .substring("context_module_item_".length),
                title: t.querySelector(".title").textContent.trim(),
              },
            ],
            moveOptions: { groupsLabel: T.t("Modules"), groups: a },
            formatSaveUrl: ({ groupId: e }) =>
              `${ENV.CONTEXT_URL_ROOT}/modules/${e}/reorder`,
            onMoveSuccess: ({ data: e, itemIds: t, groupId: i }) => {
              const a = t[0];
              const n = N()(`#context_module_${i} .ui-sortable`);
              n.sortable("disable");
              const o = document.querySelector("#context_module_item_" + a);
              n[0].appendChild(o);
              const s = e.context_module.content_tags.map(
                (e) => e.content_tag.id
              );
        ...
        N()(".move_module_contents_link").on("click keyclick", function (e) {
          ...
          const s = {
            ...
            onMoveSuccess: ({ data: e, itemIds: t, groupId: i }) => {
              ...
              const n = e.context_module.content_tags.map(
                (e) => e.content_tag.id
              );
        ...
        N()(".add_module_item_link").on("click", function (e) {
          ...
          if (E["a"] && E["a"].selectContentDialog) {
            ...
            const i = N()(this)
              ...
              .find(".name")
              .attr("title");
            const s = { for_modules: true, context_module_id: e };
            const l = !!(
              null !== (a = window.ENV) &&
              void 0 !== a &&
              null !== (o = a.FEATURES) &&
        ...
        function n(e, t = true) {
          return (i) => {
            ...
            a.find(".context_module_items.ui-sortable")
              .sortable("refresh")
              .sortable("disable");
            const l = a.find(".add_module_item_link").attr("rel");
            a.disableWhileLoading(
              N.a.ajaxJSON(l, "POST", i, (e) => {
                s.remove();
        ...
        N()(".duplicate_item_link").live("click", function (e) {
          ...
          pe["a"]
            ...
            .then(({ data: e }) => {
              ...
              e.new_positions.forEach(({ content_tag: e }) => {
                t.find("#context_module_item_" + e.id).fillTemplateData({
                  data: { position: e.position },
                });
              });
              N()(
                `#context_module_item_${e.content_tag.id} .item_link`
              ).focus();
              t.find(".context_module_items.ui-sortable")
                .sortable("enable")
                .sortable("refresh");
            })
        ...
        N()(".delete_prerequisite_link").live("click", function (e) {
          ...
          N.a.ajaxJSON(a, "PUT", n, (e) => {
            N()("#context_module_" + e.context_module.id).triggerHandler(
              "update",
              e
            );
          });
        });
        N()("#add_module_prerequisite_dialog .submit_button").click(
          function () {
            const e = N()(
              "#add_module_prerequisite_dialog .prerequisite_module_select select"
            ).val();
            if (!e) return;
            ...
            const i = N()(
              "#context_module_" +
                N()("#add_module_prerequisite_dialog").getTemplateData({
        ...
        N()(".context_module .add_prerequisite_link").live(
          "click",
          function (e) {
            e.preventDefault();
            const t = N()(this)
            ...
            const n = [];
            N()("#context_modules .context_module").each(function () {
              (N()(this)[0] == i[0] || n.length > 0) &&
                n.push(N()(this).getTemplateData({ textValues: ["id"] }).id);
            });
            for (const e in n) a.find(".context_module_" + n[e]).hide();
            N()("#add_module_prerequisite_dialog")
              .find(".prerequisite_module_select")
              .empty()
              .append(a.show());
            N()("#add_module_prerequisite_dialog").dialog({
              title: T.t(
                "titles.add_prerequisite",
        ...
        var _ = function (e, t) {
          ...
          if ("attachment" == t.moduleType) {
            ...
            const n = {
              ...
              userCanEditFilesForContext:
                ENV.MODULE_FILE_PERMISSIONS.manage_files_edit,
              usageRightsRequiredForContext:
                ENV.MODULE_FILE_PERMISSIONS.usage_rights_required,
          ...
          const a = { model: i, title: t.publishTitle, el: e[0] };
          const n = new z["a"](a);
        ...
        const c = function (e, t) {
          ...
          if (a)
            for (i = 0; i < a.length; i++) {
              n = a[i];
              o = n.model.parse(e);
              if ("File" == o.type) n.model.set({ locked: !o.published });
              else {
                n.model.set({ published: o.published });
                n.model.view.render();
              }
            }
        };
        const m = function (t) {
          ...
          t.publish = function () {
            return i.apply(t, arguments).done((i) => {
              i.publish_warning &&
                N.a.flashWarning(
                  T.t("Some module items could not be published")
                );
              e.renderIfNeeded(i);
              t.fetch({ data: { include: "items" } }).done((e) => {
        ...
        const g = function (e) {
          ...
          e.publish = function () {
            return t.apply(e, arguments).done((t) => {
              c(N.a.extend({ published: true }, t), e);
            });
          };
          e.unpublish = function () {
            return i.apply(e, arguments).done((t) => {
              c(N.a.extend({ published: false }, t), e);
            });
          };
        };
        var b = function (e, t) {
        ...
        N()(".module-publish-link").each((e, t) => {
          const i = N()(t);
          const a = new ne(
            { published: i.hasClass("published"), id: i.attr("data-id") },
            { url: i.attr("data-url"), root: "module" }
          );
          const n = new oe["a"]({ model: a, el: i });
          n.render();
        });
      };
      const De = {
      ...
      function Ee(e) {
        ...
        if (i && "module" !== i) {
          if ("wiki_page" == i) {
            ...
            ("context_module_sub_header" !== i &&
              "external_url" !== i &&
              "context_external_tool" != i) ||
              (a = t.id);
          return i + "_" + a;
        }
        return null;
      ...
      const Te = function () {
        ...
        N()("#expand_collapse_all").text(
          e ? T.t("Collapse All") : T.t("Expand All")
        );
      ...
      var Ce = function (e) {
        ...
        const a = N()(this).parents(".context_module");
        const n =
          0 === a.find(".content .context_module_items").children().length;
        const o = function (e) {
          const i = function () {
            a.find(".collapse_module_link").css(
              "display",
              a.find(".content:visible").length > 0 ? "inline-block" : "none"
            );
            a.find(".expand_module_link").css(
              "display",
              0 === a.find(".content:visible").length ? "inline-block" : "none"
            );
      ...
      function Ne(e) {
        return (
          ...
          e.parentElement.classList.contains("collapsed_module")
        );
      }
      modules.updateAssignmentData(() => {
        modules.updateProgressions(function () {
          if (window.location.hash && !window.location.hash.startsWith("#!"))
            ...
            var e;
            const t =
              null === (e = document.querySelector(".context_module")) ||
              void 0 === e
                ? void 0
                : e.querySelector(".content");
            if (!t || Ne(t)) {
              const e = [
      ...
      N()(document).ready(function () {
        ...
        N()(".context_module_item").live("mouseover focus", function () {
          N()(".context_module_item_hover").removeClass(
        ...
        const i = function (i) {
          ...
          if (e) {
            if (e && e.hasClass("context_module")) {
              ...
              a = a.length
                ? a
                : i.selectWhenModuleFocused &&
                  i.selectWhenModuleFocused.fallbackModule;
            } else if (e && e.hasClass("context_module_item")) {
              a =
                i.selectWhenModuleItemFocused &&
                i.selectWhenModuleItemFocused.item;
              a = a.length
                ? a
                : i.selectWhenModuleItemFocused &&
                  i.selectWhenModuleItemFocused.fallbackModule;
            }
        ...
        const n = function (e) {
          const t =
            e && e.closest(".context_module_item_hover").length
              ? ".context_module_item_hover"
        ...
        if (!ENV.disable_keyboard_shortcuts) {
            ...
            const a = {
              selectWhenModuleFocused: {
                item:
                  ...
                  e
                    .prev(".context_module")
                    .find(".context_module_item:visible:last"),
          ...
          t.keycodes("j down", (t) => {
            const a = {
              ...
              selectWhenModuleItemFocused: {
                ...
                fallbackModule:
                  e && e.parents(".context_module").next(".context_module"),
              },
            };
            const n = i(a);
            n.length && (e = n);
          ...
          t.keycodes("e d space", (t) => {
            ...
            if ("e" == t.keyString)
              a
                ? e.find(".edit_item_link:first").click()
                : e.find(".edit_module_link:first").click();
              ...
              "space" == t.keyString &&
                (a
                  ? e.find(".move_module_item_link:first").click()
                  : e.find(".move_module_link:first").click());
            t.preventDefault();
          });
          t.keycodes("n", (e) => {
          ...
          t.keycodes("i o", (i) => {
            ...
            "i" == i.keyString
              ? e
                  ...
                  .trigger("click", [e, document.activeElement])
              : "o" == i.keyString &&
                e
        ...
        N()(document).fragmentChange((e, t) => {
          if ("#student_progressions" == t)
            N()(".module_progressions_link").trigger("click");
          else if (!t.startsWith("#!")) {
            const e = N()(t.replace(/module/, "context_module"));
            e.hasClass("collapsed_module") &&
              e.find(".expand_module_link").triggerHandler("click");
          }
        });
        const o = ENV.COLLAPSED_MODULES;
        for (const e in o)
          N()("#context_module_" + o[e]).addClass("collapsed_module");
        const s = N()("#context_modules .context_module");
        if (!s.length) {
          N()("#no_context_modules_message").show();
          N()("#expand_collapse_all").hide();
          N()("#context_modules_sortable_container").addClass(
            "item-group-container--is-empty"
          );
        }
        s.each(function () {
        ...
        N()("#expand_collapse_all").click(function () {
          ...
          N()(".context_module").each(function () {
            const t = N()(this);
            if (
              (e && 0 === t.find(".content:visible").length) ||
              (!e && t.find(".content:visible").length > 0)
            ) {
              const i = function () {
                t.find(".collapse_module_link").css(
                  "display",
                  e ? "inline-block" : "none"
                );
                t.find(".expand_module_link").css(
                  "display",
                  e ? "none" : "inline-block"
                );
          ...
          const i = e ? "0" : "1";
          N.a.ajaxJSON(t, "POST", { collapse: i });
        });
        function l(e, t, i, n) {
          const o = () => {
            var e;
        ...
        function _(e) {
          ...
          const i = (ENV.MODULE_TRAY_TOOLS[t] || []).find(
            (t) => t.id === e.target.dataset.toolId
          );
          const a = [];
          if ("module_index_menu" == t)
            a.push({ course_id: ENV.COURSE_ID, type: "module" });
        ...
        N()(".module_item_send_to").live("click", (e) => {
          ...
          const a = { content_id: t, content_type: i };
          const n = N()(e.target).closest("ul").prev(".al-trigger");
          d(true, a, n);
        });
      });
    ...
    KuME: function (e, t, i) {
      ...
      l[_] = s(function (e, t, i, a, n) {
        ...
        function d(e, t) {
          ...
          if ((n = i.url)) a = n.call(e, { hash: {}, data: t });
          else {
            n = e && e.url;
            a = typeof n === l ? n.call(e, { hash: {}, data: t }) : n;
          }
          o += _(a) + '" data-tool-id="';
          if ((n = i.id)) a = n.call(e, { hash: {}, data: t });
          else {
            n = e && e.id;
            a = typeof n === l ? n.call(e, { hash: {}, data: t }) : n;
          }
          ...
          (a || 0 === a) && (o += a);
          o += "\n    ";
          if ((n = i.title)) a = n.call(e, { hash: {}, data: t });
          else {
            n = e && e.title;
            a = typeof n === l ? n.call(e, { hash: {}, data: t }) : n;
          }
        ...
        function u(e, t) {
          var a,
            ...
            o = "";
          o += '\n      <i class="';
          if ((n = i.canvas_icon_class)) a = n.call(e, { hash: {}, data: t });
          else {
        ...
        function m(e, t) {
          ...
          if ((n = i.icon_url)) a = n.call(e, { hash: {}, data: t });
          else {
            n = e && e.icon_url;
            a = typeof n === l ? n.call(e, { hash: {}, data: t }) : n;
          }
      ...
      o.registerPartial(
        "ExternalTools/external_tool_menuitem",
        l["ExternalTools/-external-tool-menuitem"]
      );
      l[_];
      var r = n.a.default;
      var d = r.template,
      ...
      u[c] = d(function (e, t, i, a, n) {
        ...
        function r(e, t) {
          ...
          n = l.invokePartial(
            a["ExternalTools/external_tool_menuitem"],
            "ExternalTools/external_tool_menuitem",
            e,
            i,
            a,
      ...
      r.registerPartial(
        "ExternalTools/external_tools_menu",
        u["ExternalTools/-external-tools-menu"]
      );
      u[c];
    },
    L3pr: function (e, t, i) {
      ...
      s["a"].lockExplanation = function (e, t) {
        if (e.lock_at) {
          ...
          switch (t) {
            case "quiz":
              return l["a"].t(
                "messages.quiz_locked_at",
                "This quiz was locked %{at}.",
                { at: i }
              );
            case "assignment":
              return l["a"].t(
                "messages.assignment_locked_at",
                "This assignment was locked %{at}.",
                { at: i }
              );
            case "topic":
              return l["a"].t(
                "messages.topic_locked_at",
                "This topic was locked %{at}.",
                { at: i }
              );
            case "file":
              return l["a"].t(
                "messages.file_locked_at",
                "This file was locked %{at}.",
                { at: i }
              );
            case "page":
              return l["a"].t(
                "messages.page_locked_at",
                "This page was locked %{at}.",
                { at: i }
              );
            default:
              return l["a"].t(
                "messages.content_locked_at",
                "This content was locked %{at}.",
                { at: i }
              );
          }
        } else if (e.unlock_at) {
          ...
          switch (t) {
            case "quiz":
              return l["a"].t(
                "messages.quiz_locked_until",
                "This quiz is locked until %{date}.",
                { date: i }
              );
            case "assignment":
              return l["a"].t(
            ...
            case "topic":
              return l["a"].t(
                "messages.topic_locked_until",
                "This topic is locked until %{date}.",
                { date: i }
              );
            case "file":
              return l["a"].t(
                "messages.file_locked_until",
                "This file is locked until %{date}.",
                { date: i }
              );
            case "page":
              return l["a"].t(
                "messages.page_locked_until",
                "This page is locked until %{date}.",
                { date: i }
              );
            default:
              return l["a"].t(
                "messages.content_locked_until",
                "This content is locked until %{date}.",
                { date: i }
              );
          }
        } else {
          if (e.context_module) {
            ...
            switch (t) {
              case "quiz":
                i += l["a"].t(
                  ...
                  { module: e.context_module.name, wrapper: "<b>$1</b>" }
                );
                break;
              case "assignment":
                i += l["a"].t(
            ...
            if (n()("#context_modules_url").length > 0) {
              ...
              i +=
                "<a href='" +
                Object(o["a"])(n()("#context_modules_url").attr("href")) +
                "'>";
              i += Object(o["a"])(
                l["a"].t(
      ...
      t["a"] = (function (e) {
        ...
        t.prototype.pollForChanges = function (e) {
          ...
          if (!this._poller) {
            ...
            (t = window.ENV.WIKI_PAGE_PANDAPUB) &&
              this._poller.setToken(t.CHANNEL, t.TOKEN);
        ...
        t.prototype.restore = function () {
          ...
          e = n.a.ajaxJSON(this.url(), "POST").fail(function () {
            return n.a.flashError(
              r["a"].t("restore_failed", "Failed to restore page revision")
            );
          });
    ...
    OShF: function (e, t, i) {
        ...
        if (this.length && e) {
            ...
            this.find("*")
              ...
              .each(function () {
                ...
                n.a.each(["name", "id", "class"], (i, a) => {
                  t.attr(a) &&
                    t.attr(a, t.attr(a).replace(/-iterator-/, e.iterator));
                });
              });
          ...
          if (e.data)
            for (var t in e.data) {
              ...
              e.data[t] &&
                e.dataValues &&
                -1 != n.a.inArray(t, e.dataValues) &&
                this.data(t, e.data[t].toString());
              const s = this.find("." + t);
              var i = e.avoid || "";
              s.each(function () {
                const s = n()(this);
                if (s.length > 0 && 0 === s.closest(i).length) {
                  ("undefined" !== typeof e.data[t] && null !== e.data[t]) ||
                    (e.data[t] = "");
                  ...
                  } else if ("INPUT" == s[0].tagName.toUpperCase())
                    s.val(e.data[t]);
                  else
                    try {
          ...
          e.hrefValues &&
            ...
            this.find("a,span[rel]").each(function () {
              ...
              for (const s in e.hrefValues) {
                ...
                if ((t = o.attr("href"))) {
                  const i = n.a.replaceTags(
                    t,
                    l,
                    encodeURIComponent(e.data[l])
                  );
                ...
                (i = o.attr("rel")) &&
                  o.attr("rel", n.a.replaceTags(i, l, e.data[l]));
                (a = o.attr("name")) &&
                  o.attr("name", n.a.replaceTags(a, l, e.data[l]));
              }
            });
      ...
      n.a.fn.getTemplateData = function (e) {
        ...
        if (e.htmlValues)
          for (t in e.htmlValues) {
            const o = this.find(
              "." +
                e.htmlValues[t].replace(/\[/g, "\\[").replace(/\]/g, "\\]") +
                ":first"
            );
            a = null;
            a =
              o.hasClass("user_content") && o.data("unenhanced_content_html")
                ? o.data("unenhanced_content_html")
                : n.a.trim(o.html());
            i[e.htmlValues[t]] = a;
          }
        return i;
      ...
      n.a.fn.getTemplateValue = function (e, t) {
        const i = n.a.extend({}, t, { textValues: [e] });
      ...
      var F = {
        ...
        template: function (e) {
          return "\n\n.emSEn_blJt,.emSEn_bGBk{position:relative}\n\n.emSEn_blJt{box-sizing:border-box;display:block}\n\n.emSEn_blJt.emSEn_JSXc{height:100%}\n\n.emSEn_cwos{border:0;clip:rect(0 0 0 0);height:0.0625rem;margin:-0.0625rem;overflow:hidden;padding:0;position:absolute;width:0.0625rem}\n\n.emSEn_QUBp{border:"
            .concat(e.borderWidth || "inherit", " ")
            .concat(e.borderStyle || "inherit", " ")
            .concat(e.borderColor || "inherit", ";border-radius:")
            .concat(
              e.borderRadius || "inherit",
              ";box-sizing:border-box;cursor:pointer;display:block;text-align:center;z-index:1}\n\n[dir=ltr] .emSEn_QUBp,[dir=rtl] .emSEn_QUBp{text-align:center}\n\n.emSEn_QUBp:hover{border-color:"
            )
            .concat(
              e.hoverBorderColor || "inherit",
              "}\n\n.emSEn_QUBp.emSEn_JSXc{height:100%}\n\n.emSEn_byIz{border-radius:"
            )
            .concat(
              e.borderRadius || "inherit",
              ";display:block;overflow:hidden}\n\n.emSEn_byIz.emSEn_JSXc{height:100%}\n\n.emSEn_cbYS .emSEn_QUBp{border-color:"
            )
            .concat(
              e.acceptedColor || "inherit",
              "}\n\n.emSEn_cvQK .emSEn_QUBp{border-color:"
            )
            .concat(
              e.rejectedColor || "inherit",
              ...
              (I =
                M(
                  (I =
                      ...
                      (function (e) {
                        ...
                        function i(e) {
                          ...
                          a.handleDragEnter = function (e) {
                            ...
                            var t = a.allFilesAccepted(
                              a.getDataTransferItems(e)
                            );
                            a.setState({
                              isDragAccepted: t,
                              isDragRejected: !t,
                          ...
                          a.handleChange = function (e) {
                            var t = a.props,
                              ...
                              n = t.onDropAccepted,
                              s = t.onDropRejected;
                            var l = a.getDataTransferItems(
                              e,
                              a.shouldEnablePreview
                            );
                          ...
                          a.handleClick = function (e) {
                            a.fileInputEl.value &&
                              a.shouldAllowRepeats &&
                              (a.fileInputEl.value = null);
                            a.fileInputEl.focus();
                            a.props.onClick(e);
                          ...
                          a.handleKeyUp = function (e) {
                            if (
                              e.keyCode === f.a.codes.esc &&
                              a.state.isFileBrowserDisplayed
                            ) {
                              e.stopPropagation();
                        ...
                        Object(l["a"])(i, [
                          {
                            ...
                            value: function (e, t) {
                              ...
                              i.length > 1 &&
                                (i = this.shouldAllowMultiple ? i : [i[0]]);
                              if (t)
                          ...
                          },
                          {
                            ...
                            value: function (e) {
                              ...
                              e.forEach(function (e) {
                                t.fileAccepted(e) && t.fileMatchSize(e)
                                  ? i.push(e)
                                  : a.push(e);
                              });
                              return [i, a];
                          ...
                          },
                          {
                            ...
                            value: function (e) {
                              return (
                                e.size <= this.props.maxSize &&
                                e.size >= this.props.minSize
                              );
                            },
                          },
                          {
                          ...
                          },
                          {
                            ...
                            value: function () {
                              ...
                              var h =
                                "disabled" === this.interaction ||
                                "readonly" === this.interaction;
                              var f =
                                this.state.isDragRejected || this.invalid
                                  ? "danger"
                                  : void 0;
                              var v =
                                ((e = {}),
                                Object(a["a"])(e, F.label, true),
                                Object(a["a"])(e, F.functionallyDisabled, h),
                                Object(a["a"])(
                                  e,
                                  F.visuallyDisabled,
                                  "disabled" === this.interaction
                                ...
                                Object(a["a"])(
                                  e,
                                  F.dragAccepted,
                                  this.state.isDragAccepted
                                ),
                                Object(a["a"])(e, F.withHeight, l),
                                e);
                                    ...
                                    u.a.createElement(
                                      ...
                                      u.a.createElement(
                                        "span",
                                        {
                                          className: g()(
                                            ((i = {}),
                                            Object(a["a"])(i, F.layout, true),
                                            Object(a["a"])(i, F.withHeight, l),
                                            i)
                                          ),
                                        },
                                        u.a.createElement(
                          ...
                          },
                          {
                            key: "interaction",
                            get: function () {
                              return Object(j["a"])({ props: this.props });
                            },
                          },
                          {
                            ...
                            get: function () {
                              return (
                                ...
                                this.props.shouldEnablePreview
                              );
                            },
                          },
                          {
                            ...
                            get: function () {
                              return (
                                this.props.allowRepeatFileSelection ||
                                this.props.shouldAllowRepeats
                              );
                            },
                          },
                          {
                            ...
                            get: function () {
                              return (
                                ...
                                this.props.shouldAllowMultiple
                              );
                            },
                          },
                          {
                            ...
                            get: function () {
                              return (
                                this.hasMessages &&
                                this.props.messages.findIndex(function (e) {
                                  return "error" === e.type;
                                }) >= 0
                              );
                            },
                    ...
                    (P.propTypes = {
                      id: m.a.string,
                      renderLabel: m.a.oneOfType([m.a.func, m.a.node])
                        .isRequired,
                      accept: m.a.oneOfType([
                        m.a.string,
    ...
    XpJL: function (e, t, i) {
      ...
      w[x] = y(function (e, t, i, a, n) {
        ...
        function c(e, t) {
          ...
          a = i["if"].call(
            e,
            ((a = e && e.CAN),
            null == a || false === a ? a : a.ACCESS_GEAR_MENU),
            { hash: {}, inverse: d.noop, fn: d.program(27, E, t), data: t }
          );
          (a || 0 === a) && (n += a);
          n +=
        ...
        function p(e, t) {
          ...
          if ((n = i.course_title)) a = n.call(e, { hash: {}, data: t });
          else {
            n = e && e.course_title;
            a = typeof n === _ ? n.call(e, { hash: {}, data: t }) : n;
          }
        ...
        function g(e, t) {
          ...
          a = i["if"].call(
            e,
            ((a = e && e.CAN), null == a || false === a ? a : a.VIEW_ALL_PAGES),
            { hash: {}, inverse: d.noop, fn: d.program(7, h, t), data: t }
          );
          (a || 0 === a) && (n += a);
          n += "\n          ";
          return n;
        ...
        function h(e, t) {
          ...
          if ((n = i.wiki_pages_path)) a = n.call(e, { hash: {}, data: t });
          else {
          ...
          s +=
            ...
            r(
              ((n = i.t || (e && e.t)),
              (o = { hash: { scope: "wiki.wiki_page" }, data: t }),
              n
                ? n.call(e, "buttons.view_all_pages", "View All Pages", o)
                : u.call(e, "t", "buttons.view_all_pages", "View All Pages", o))
            ) +
            "</a>\n            ";
          return s;
        }
        ...
        function k(e, t) {
          ...
          o +=
            ...
            r(
              ((a = i.t || (e && e.t)),
              (n = { hash: { scope: "wiki.wiki_page" }, data: t }),
              a
                ? a.call(e, "labels.front_page", "Front Page", n)
                : u.call(e, "t", "labels.front_page", "Front Page", n))
            ) +
            "</span>\n            </div>\n          ";
          return o;
        }
        function v(e, t) {
          ...
          a = i["if"].call(
            e,
            ((a = e && e.CAN), null == a || false === a ? a : a.PUBLISH),
            {
              hash: {},
        ...
        function w(e, t) {
          ...
          a = i["if"].call(
            e,
            ((a = e && e.CAN),
            null == a || false === a ? a : a.VIEW_UNPUBLISHED),
            { hash: {}, inverse: d.noop, fn: d.program(17, x, t), data: t }
          );
          (a || 0 === a) && (n += a);
          n += "\n              ";
          return n;
        ...
        function z(e, t) {
          ...
          o +=
            ...
            r(
              ...
              (n = { hash: { scope: "wiki.wiki_page" }, data: t }),
              a
                ? a.call(e, "published_indicator", "Published", n)
                : u.call(e, "t", "published_indicator", "Published", n))
            ) +
            "</span>\n                    </span>\n                  ";
          return o;
        }
        function q(e, t) {
          ...
          o +=
            ...
            r(
              ...
              (n = { hash: { scope: "wiki.wiki_page" }, data: t }),
              a
                ? a.call(e, "unpublished_indicator", "Not Published", n)
                : u.call(e, "t", "unpublished_indicator", "Not Published", n))
            ) +
            "</span>\n                    </span>\n                  ";
          return o;
        }
        function j(e, t) {
          ...
          a = i["if"].call(
            e,
            ((a = e && e.CAN), null == a || false === a ? a : a.UPDATE_CONTENT),
            { hash: {}, inverse: d.noop, fn: d.program(23, S, t), data: t }
          );
          (a || 0 === a) && (n += a);
          n += "\n            ";
          return n;
        ...
        function S(e, t) {
          var a,
            ...
            s = "";
          s += '\n                <a href="';
          if ((n = i.wiki_page_edit_path)) a = n.call(e, { hash: {}, data: t });
          else {
          ...
          s +=
            ...
            r(
              ...
              (o = { hash: { scope: "wiki.wiki_page" }, data: t }),
              n
                ? n.call(e, "buttons.edit", "Edit", o)
                : u.call(e, "t", "buttons.edit", "Edit", o))
            ) +
            "</span></a>\n              ";
          return s;
        }
        ...
        function E(e, t) {
          ...
          l +=
            ...
            r(
              ((o = i.t || (e && e.t)),
              (s = { hash: { scope: "wiki.wiki_page" }, data: t }),
              o
                ? o.call(e, "toolbar_menu.settings", "Settings", s)
                : u.call(e, "t", "toolbar_menu.settings", "Settings", s))
            ) +
            '</span>\n                </a>\n                <ul class="al-options">\n                  ';
          ...
          n = i["if"].call(
            e,
            ((n = e && e.CAN), null == n || false === n ? n : n.READ_REVISIONS),
            { hash: {}, inverse: d.noop, fn: d.program(34, M, t), data: t }
          );
          (n || 0 === n) && (l += n);
          l += "\n                  ";
          ...
          n = i["if"].call(
            e,
            ((n = e && e.CAN), null == n || false === n ? n : n.DIRECT_SHARE),
            { hash: {}, inverse: d.noop, fn: d.program(39, O, t), data: t }
          );
          (n || 0 === n) && (l += n);
          l += "\n                  ";
          n = d.invokePartial(
            a["ExternalTools/external_tools_menu"],
            "ExternalTools/external_tools_menu",
            e && e.wiki_page_menu_tools,
            i,
            a,
            t
          );
        ...
        function T(e, t) {
          ...
          a = i["if"].call(
            e,
            ((a = e && e.CAN), null == a || false === a ? a : a.DELETE),
            { hash: {}, inverse: d.noop, fn: d.program(29, C, t), data: t }
          );
          (a || 0 === a) && (n += a);
          n += "\n                  ";
          return n;
        ...
        function C(e, t) {
          ...
          s +=
            ...
            r(
              ...
              (o = { hash: { scope: "wiki.wiki_page" }, data: t }),
              n
                ? n.call(e, "delete_wiki", "Delete", o)
                : u.call(e, "t", "delete_wiki", "Delete", o))
            ) +
            "</a></li>\n                    ";
          return s;
        }
        ...
        function M(e, t) {
          var a,
            ...
            s = "";
          s += '\n                    <li><a href="';
          if ((n = i.wiki_page_history_path))
            a = n.call(e, { hash: {}, data: t });
          else {
          ...
          s +=
            ...
            r(
              ...
              (o = { hash: { scope: "wiki.wiki_page" }, data: t }),
              n
                ? n.call(e, "view_page_history_wiki", "View Page History", o)
                : u.call(
                    e,
                    "t",
                    "view_page_history_wiki",
                    "View Page History",
                    o
                  ))
            ) +
        ...
        function I(e, t) {
          ...
          a = i["if"].call(
            e,
            ((a = e && e.CAN), null == a || false === a ? a : a.UPDATE_CONTENT),
            { hash: {}, inverse: d.noop, fn: d.program(37, P, t), data: t }
          );
          (a || 0 === a) && (n += a);
          n += "\n                  ";
          return n;
        ...
        function P(e, t) {
          ...
          s +=
            ...
            r(
              ...
              (o = { hash: { scope: "wiki.wiki_page" }, data: t }),
              n
                ? n.call(e, "menu.use_front_page", "Use as Front Page", o)
                : u.call(e, "t", "menu.use_front_page", "Use as Front Page", o))
            ) +
            '" ';
          a = i.unless.call(e, e && e.published, {
            hash: {},
        ...
        function O(e, t) {
          ...
          o +=
            ...
            r(
              ((a = i.t || (e && e.t)),
              (n = { hash: { i18n_inferred_key: true }, data: t }),
              a
                ? a.call(e, "send_to_b940900a", "Send To...", n)
                : u.call(e, "t", "send_to_b940900a", "Send To...", n))
            ) +
            ...
            r(
              ...
              (n = { hash: { i18n_inferred_key: true }, data: t }),
              a
                ? a.call(e, "copy_to_64f8456b", "Copy To...", n)
                : u.call(e, "t", "copy_to_64f8456b", "Copy To...", n))
            ) +
            "</a></li>\n                  ";
          return o;
        }
        function F(e, t) {
          ...
          o +=
            ...
            r(
              ...
              (n = { hash: { scope: "wiki.wiki_page" }, data: t }),
              a
                ? a.call(e, "wiki.todo_date", "To-Do Date:", n)
                : u.call(e, "t", "wiki.todo_date", "To-Do Date:", n))
            ) +
            " " +
            r(
              ((a = i.tDateToString || (e && e.tDateToString)),
              (n = { hash: {}, data: t }),
              a
                ? a.call(e, e && e.todo_date, "date_at_time", n)
                : u.call(
                    e,
                    "tDateToString",
                    e && e.todo_date,
        ...
        function L(e, t) {
          ...
          o +=
            "\n    " +
            r(
              ((a = i.convertApiUserContent || (e && e.convertApiUserContent)),
              (n = { hash: {}, data: t }),
              a
                ? a.call(e, e && e.body, n)
                : u.call(e, "convertApiUserContent", e && e.body, n))
            ) +
            "\n  ";
          return o;
        }
        o = i["if"].call(
          t,
          ((o = t && t.CAN), null == o || false === o ? o : o.VIEW_TOOLBAR),
          { hash: {}, inverse: d.noop, fn: d.program(1, c, n), data: n }
        );
        (o || 0 === o) && (l += o);
        l +=
          '\n\n<div class="show-content user_content clearfix">\n  <h1 class="page-title">';
        if ((s = i.title)) o = s.call(t, { hash: {}, data: n });
        else {
          s = t && t.title;
          o = typeof s === _ ? s.call(t, { hash: {}, data: n }) : s;
        }
          ...
          if (n()(this).data("lock_reason")) {
            ...
            if (0 === o.length) {
              ...
              const e =
                ...
                Object(T["a"])(A["a"].t("buttons.ok_thanks", "Ok, Thanks")) +
                "</button></div>";
              o.append(e);
      ...
      class P extends g.a.View {
        ...
        render() {
          ...
          if (this.$sequenceFooter || this.course_home || !this.course_id)
            null != this.$sequenceFooter &&
              this.$sequenceFooter.msfAnimation(false);
          else {
            this.$sequenceFooter ||
              (this.$sequenceFooter = n()("<div></div>").hide());
          ...
          if (this.$sequenceFooter)
            return this.$sequenceFooter.appendTo(
              n()("#module_navigation_target")
            );
        }
        navigateToLinkAnchor() {
          ...
          if (e.length) {
            ...
            t.length ||
              (t = n()(`#wiki_page_show .user_content a[name='${e}']`));
            t.length && n()("html, body").scrollToVisible(t);
          }
        }
        afterRender() {
          super.afterRender(...arguments);
          n()(".page-toolbar .page-toolbar-end .buttons").append(
            n()("#mark-as-done-checkbox")
          );
        ...
        unsetAsFrontPage(e) {
          ...
          return this.model.unsetFrontPage(() =>
            n()("#wiki_page_show .page-toolbar .buttons .al-trigger").focus()
          );
        }
        useAsFrontPage(e) {
          null != e && e.preventDefault();
        ...
        toJSON() {
          ...
          e.CAN = {
            VIEW_ALL_PAGES:
              !!this.display_show_all_pages || !!this.WIKI_RIGHTS.manage,
            VIEW_PAGES: !!this.WIKI_RIGHTS.read,
            PUBLISH: !!this.WIKI_RIGHTS.publish_page,
            VIEW_UNPUBLISHED:
              !!this.WIKI_RIGHTS.manage ||
              !!this.WIKI_RIGHTS.view_unpublished_items,
            UPDATE_CONTENT:
              !!this.PAGE_RIGHTS.update || !!this.PAGE_RIGHTS.update_content,
          ...
          e.CAN.ACCESS_GEAR_MENU =
            e.CAN.DELETE || e.CAN.READ_REVISIONS || e.CAN.DIRECT_SHARE;
          e.CAN.VIEW_TOOLBAR =
            e.CAN.VIEW_PAGES ||
            e.CAN.PUBLISH ||
            e.CAN.UPDATE_CONTENT ||
            e.CAN.ACCESS_GEAR_MENU;
          e.lock_info && (e.lock_info = m.a.clone(e.lock_info));
          (null != e.lock_info ? e.lock_info.unlock_at : void 0) &&
            (e.lock_info.unlock_at =
              u["a"].parse(e.lock_info.unlock_at) < new Date()
                ? null
                : n.a.datetimeString(e.lock_info.unlock_at));
          if (
            e.is_master_course_child_content &&
            e.restricted_by_master_course
          ) {
            e.cannot_delete_by_master_course = true;
            e.cannot_edit_by_master_course =
              e.master_course_restrictions.content;
          }
      ...
      L.init({ itemType: "wiki_page", page: "show" });
      n()(() =>
        n()("#content").on("click", "#mark-as-done-checkbox", function () {
          O["a"].toggle(this);
        })
      );
      ...
      class l extends a["a"] {
        ...
        fetch(e = {}) {
          e.data = o.a.extend(
            {
              content_types:
                null != this.parentFolder
                  ? this.parentFolder.contentTypes
                  : void 0,
            },
            e.data || {}
          );
          (null != this.parentFolder
            ? this.parentFolder.useVerifiers
            : void 0) && (e.data.use_verifiers = 1);
    ...
    agq5: function (e, t, i) {
      ...
      var j = {
        componentId: "ftPBL",
        template: function (e) {
          return "\n\n.ftPBL_bGBk{box-sizing:border-box;display:block;font-family:"
            .concat(
              e.fontFamily || "inherit",
              ";margin-left:auto;margin-right:auto;position:relative;text-align:center}\n\n[dir=ltr] .ftPBL_bGBk,[dir=rtl] .ftPBL_bGBk{text-align:center}\n\n.ftPBL_bGBk:not(.ftPBL_bGiS){background-color:"
            )
            .concat(
              e.backgroundColor || "inherit",
              "}\n\n.ftPBL_bGBk.ftPBL_ywdX{cursor:not-allowed;opacity:0.5;pointer-events:none}\n\n.ftPBL_EwaR,.ftPBL_caGd,.ftPBL_eDnN,.ftPBL_cuDj,.ftPBL_elxg{display:block}\n\n.ftPBL_cuDj+.ftPBL_eDnN{margin:"
            )
            .concat(
              e.largeMargin || "inherit",
              " 0 0}\n\n.ftPBL_eDnN+.ftPBL_elxg,.ftPBL_cuDj+.ftPBL_elxg,.ftPBL_doqw .ftPBL_cuDj+.ftPBL_eDnN{margin:"
            )
            .concat(
              e.mediumMargin || "inherit",
              " 0 0}\n\n.ftPBL_doqw{padding:"
            )
            .concat(
              e.paddingSmall || "inherit",
              "}\n\n.ftPBL_doqw .ftPBL_cuDj{font-size:3rem}\n\n.ftPBL_doqw .ftPBL_elxg{font-size:"
            )
            .concat(
              e.messageFontSizeSmall || "inherit",
              "}\n\n.ftPBL_ycrn{padding:"
            )
            .concat(
              e.paddingMedium || "inherit",
              "}\n\n.ftPBL_ycrn .ftPBL_cuDj{font-size:5rem}\n\n.ftPBL_ycrn .ftPBL_elxg{font-size:"
            )
            .concat(
              e.messageFontSizeMedium || "inherit",
              "}\n\n.ftPBL_cMDj{padding:"
            )
            .concat(
              e.paddingLarge || "inherit",
              "}\n\n.ftPBL_cMDj .ftPBL_cuDj{font-size:10rem}\n\n.ftPBL_cMDj .ftPBL_elxg{font-size:"
            )
            .concat(
              e.messageFontSizeLarge || "inherit",
              "}\n\n.ftPBL_elxg{color:"
            )
            .concat(e.messageColor || "inherit", "}\n\n.ftPBL_cuDj{color:")
            .concat(
              e.iconColor || "inherit",
              "}\n\n.ftPBL_cuDj>img,.ftPBL_cuDj>svg{display:block;margin:0 auto;max-width:100%}\n\n.ftPBL_cuDj>img{height:auto}\n\n.ftPBL_bGiS{-moz-appearance:none;-ms-user-select:none;-webkit-appearance:none;-webkit-user-select:none;appearance:none;background:"
            )
            .concat(e.backgroundColor || "inherit", ";border:")
            .concat(e.buttonBorderWidth || "inherit", " ")
            .concat(
              e.buttonBorderStyle || "inherit",
              " transparent;border-radius:"
            )
            .concat(
              e.buttonBorderRadius || "inherit",
              ";box-sizing:border-box;cursor:pointer;margin:0;text-decoration:none;touch-action:manipulation;user-select:none;width:100%}\n\n.ftPBL_bGiS:hover{border-style:"
            )
            .concat(
              e.buttonHoverBorderStyle || "inherit",
              "}\n\n.ftPBL_bGiS:focus,.ftPBL_bGiS:hover{border-color:"
            )
            .concat(
              e.iconHoverColor || "inherit",
              ";outline:none;text-decoration:none}\n\n.ftPBL_bGiS:focus .ftPBL_cuDj,.ftPBL_bGiS:hover .ftPBL_cuDj{color:"
            )
            .concat(
              e.iconHoverColor || "inherit",
              "}\n\n.ftPBL_bGiS:active{background:"
            )
            .concat(e.clickableActiveBg || "inherit", ";border-color:")
            .concat(
              e.iconHoverColor || "inherit",
              "}\n\n.ftPBL_bGiS:active .ftPBL_cuDj,.ftPBL_bGiS:active .ftPBL_elxg{color:"
            )
            .concat(
              e.clickableActiveText || "inherit",
              "}\n\n.ftPBL_bGiS .ftPBL_elxg{color:"
            )
            .concat(e.messageColorClickable || "inherit", "}");
        },
        root: "ftPBL_bGBk",
              ...
              (function (e) {
                ...
                Object(s["a"])(i, [
                  ...
                  },
                  {
                    key: "renderHero",
                    value: function () {
                      return this.heroIsFunction
                        ? this.props.hero(this.SVGIconSize)
                        : this.props.hero;
                    },
                  },
                  {
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      var m =
                        ((e = {}),
                        Object(n["a"])(e, j.root, true),
                        Object(n["a"])(e, j[r], true),
                        Object(n["a"])(e, j.clickable, o || _),
                        Object(n["a"])(e, j.disabled, s),
                        e);
    ...
    btHx: function (e, t, i) {
      ...
      t["a"] = (function (e) {
        ...
        t.prototype.fetch = function (e) {
          ...
          s = t.__super__.fetch.call(this, e).done(
            (function (t) {
              return function (a, n, o) {
                var s;
                t.trigger("fetch", t, a, e);
                null != e.page && t.trigger("fetch:" + e.page, t, a, e);
                (null != (s = t.urls) ? s.next : void 0) ||
                  t.trigger.apply(
                    t,
                    ["fetched:last"].concat(m.call(arguments))
                  );
                return t.loadAll && null != t.urls.next
                  ? setTimeout(function () {
                      return t.fetch({ page: "next", dfd: i });
                    })
                  : i.resolve(a, n, o);
              };
            })(this)
        ...
        t.prototype._setStateAfterFetch = function (e, t) {
          ...
          c && null != this.urls.next
            ? (this.urls.bottom = this.urls.next)
            : this.urls.next
            ? (this.urls.bottom = o.bottom)
            : delete this.urls.bottom;
          m && null != this.urls.prev
          ...
          if (null != g) {
            ...
            (null !=
            (i = null != this.options ? this.options : (this.options = {}))
              .params
              ? i.params
              : (i.params = {})
            ).per_page = s;
          ...
          this.urls.last &&
            (n = this.urls.last.match(this.pageRegex)) &&
            (this.totalPages = parseInt(n[1], 10));
          (null != (u = this.urls) ? u.next : void 0) ||
            (this.loadedAll = true);
    ...
    "gSD+": function (e, t, i) {
      ...
      var D = {
        componentId: "emyav",
        template: function (e) {
          return "\n\n.emyav_bGBk{-moz-osx-font-smoothing:grayscale;-webkit-font-smoothing:antialiased;font-family:"
            .concat(e.fontFamily || "inherit", ";line-height:")
            .concat(
              e.lineHeight || "inherit",
              ";margin:0;text-rendering:optimizeLegibility}\n\ninput.emyav_bGBk[type]{-moz-appearance:none;-webkit-appearance:none;appearance:none;background:none;border:none;border-radius:0;box-shadow:none;box-sizing:border-box;color:inherit;display:block;height:auto;line-height:inherit;margin:-6px 0 0 0;outline:0;padding:0;text-align:start;width:100%}\n\n[dir=ltr] input.emyav_bGBk[type]{text-align:left}\n\n[dir=rtl] input.emyav_bGBk[type]{text-align:right}\n\ninput.emyav_bGBk[type]:focus{outline:none}\n\n.emyav_fIqS{font-size:"
            )
            .concat(e.h1FontSize || "inherit", ";font-weight:")
            .concat(e.h1FontWeight || "inherit", "}\n\n.emyav_eABG{font-size:")
            .concat(e.h2FontSize || "inherit", ";font-weight:")
            .concat(e.h2FontWeight || "inherit", "}\n\n.emyav_dlZd{font-size:")
            .concat(e.h3FontSize || "inherit", ";font-weight:")
            .concat(e.h3FontWeight || "inherit", "}\n\n.emyav_bAmB{font-size:")
            .concat(e.h4FontSize || "inherit", ";font-weight:")
            .concat(e.h4FontWeight || "inherit", "}\n\n.emyav_eRZv{font-size:")
            .concat(e.h5FontSize || "inherit", ";font-weight:")
            .concat(e.h5FontWeight || "inherit", "}\n\n.emyav_dTMd{border-top:")
            .concat(e.borderWidth || "inherit", " ")
            .concat(e.borderStyle || "inherit", " ")
            .concat(e.borderColor || "inherit", ";padding-top:")
            .concat(
              e.borderPadding || "inherit",
              "}\n\n.emyav_evMo{border-bottom:"
            )
            .concat(e.borderWidth || "inherit", " ")
            .concat(e.borderStyle || "inherit", " ")
            .concat(e.borderColor || "inherit", ";padding-bottom:")
            .concat(
              e.borderPadding || "inherit",
              "}\n\n.emyav_fAVi{color:inherit}\n\n.emyav_qFsi{color:"
            )
            .concat(e.primaryColor || "inherit", "}\n\n.emyav_bLsb{color:")
            .concat(e.secondaryColor || "inherit", "}\n\n.emyav_ezBQ{color:")
            .concat(
              e.primaryInverseColor || "inherit",
              "}\n\n.emyav_dlnd{color:"
            )
            .concat(
              e.secondaryInverseColor || "inherit",
      ...
      var E =
        ((w = Object(f["a"])(
          "7.0.0",
          null,
          "Use Heading from ui-heading instead."
        )),
        (x = Object(v["a"])()),
        (z = Object(g["j"])(y, D)),
        w(
                        ...
                        Object(o["a"])(i, [
                          {
                            ...
                            value: function () {
                              ...
                              var g = p["a"].omitViewProps(
                                Object(k["a"])(this.props, i.propTypes),
                                i
                              );
                              return r.a.createElement(
                                p["a"],
                                Object.assign({}, g, {
                                  className: m()(
                                    ((e = {}),
                                    Object(a["a"])(e, D.root, true),
                                    Object(a["a"])(e, D[l], true),
                                    Object(a["a"])(e, D["color-".concat(s)], s),
                                    Object(a["a"])(
                                      e,
                                      D["border-".concat(n)],
                                      "none" !== n
                                    ),
                                    Object(a["a"])(e, D.ellipsis, _),
                                    e)
                                  ),
                                  as: c,
                                  margin: d,
    ...
    kX4z: function (e, t, i) {
      ...
      t["a"] = (function (e) {
        ...
        t.prototype.initialize = function () {
          t.__super__.initialize.apply(this, arguments);
          return (this.events = o.a.extend(
            {},
            a["a"].prototype.events,
            this.events
          ));
        };
    ...
    lHb5: function (e, t, i) {
      ...
      function c(e) {
        return l["a"].get(e).then((e) => {
          ...
          const a =
            null ===
              (t = Object(_["a"])(
                null === (i = e.headers) || void 0 === i ? void 0 : i.link
              )) || void 0 === t
              ? void 0
              : t.next;
      ...
      function p(e) {
        return l["a"]
          .get(`/api/v1/courses/${e}/folders/root`)
          .then(({ data: e }) => e);
      }
      var g = i("dqQ7");
      var h = i("UT5+");
      ...
      class z extends o.a.Component {
        constructor(e) {
          ...
          this.handleDrop = (e) => {
            ...
            this.setState(
              { hightlightUpload: false, isUploading: true },
              () => {
                w["a"].setFolder(n);
          ...
          this.renameFileMessage = (e) =>
            s["a"].t(
              'A file named "%{name}" already exists. Do you want to replace the existing file?',
              { name: e }
            );
          this.lockFileMessage = (e) =>
            s["a"].t(
              'A locked file named "%{name}" already exists. Please enter a new name.',
              { name: e }
            );
        ...
        componentDidMount() {
          Object.keys(z.folderState).length > 0 &&
            this.setFolderState(z.folderState);
          0 === z.activeDrops.size && this.fetchRootFolder();
          z.activeDrops.add(this);
        }
        fetchRootFolder() {
          return p(this.props.courseId)
            .then((e) =>
              m(e.id)
                .then((t) => {
                  e.files = t;
        ...
        renderBillboard() {
          ...
          return Object(a["a"])(f["a"], {
            heading: e
              ? s["a"].t("Drop files here to add to module")
              : s["a"].t("Loading..."),
            headingLevel: "h4",
        ...
        renderUploading() {
          ...
          return o.a.createElement(
            ...
            Object(a["a"])(y["a"], { onUploadChange: this.handleUploadChange })
          );
        }
        render() {
      ...
      z.defaultProps = { contextModules: null };
      z.folderState = {};
    ...
    mNVu: function (e, t, i) {
      ...
      var l = function (e) {
        ...
        var i = o.a.extend(function (i, a) {
          ...
          var r = n();
          r.on(
            "change:" + e.prototype.idAttribute,
            function (e, i) {
              s[t + ":" + i] = r;
      ...
      var c = {
        ...
        decodeSpecialChars: (e) =>
          e
            .split("/")
            .map((e) =>
              encodeURIComponent(decodeURIComponent(e).replace(/&#37;/, "%"))
            )
            .join("/"),
      };
      const m = /^[^\/]+\/?/;
      let p = null;
      function g(e, t) {
        return "name" !== t || e instanceof f
          ? "user" === t
            ? k(e.get("user"), (e) => e.display_name) || ""
            : "usage_rights" === t
            ? k(e.get("usage_rights"), (e) => e.license_name) || ""
            : e.get(t)
          : e.get("display_name");
      }
      class h extends a["a"] {
        initialize(e) {
          this.contentTypes ||
            (this.contentTypes = null != e ? e.contentTypes : void 0);
          this.useVerifiers ||
            (this.useVerifiers = null != e ? e.useVerifiers : void 0);
        ...
        setUpFilesAndFoldersIfNeeded() {
          this.folders || (this.folders = new b([], { parentFolder: this }));
          if (!this.files)
            return (this.files = new d["a"]([], { parentFolder: this }));
        }
        getSubtrees() {
          return this.folders;
        }
        ...
        previewUrl() {
          let e;
          if (((e = this.get("context_type")), ["Course", "Group"].includes(e)))
        ...
        isEmpty() {
          return (
            !!(this.files.loadedAll && 0 === this.files.length) &&
            this.folders.loadedAll &&
            0 === this.folders.length
          );
        }
        urlPath() {
          ...
          if (p.showingAllContexts) {
            const t = `${k(this.get("context_type"), (e) =>
              e.toLowerCase()
            )}s_${this.get("context_id")}`;
            e = `${t}/${e}`;
          }
          return e;
        }
    ...
    miTl: function (e, t, i) {
      ...
      t["a"] = (function (e) {
        ...
        t.prototype.initialize = function (e, i) {
          ...
          this.contextAssetString &&
            ((a = Object(d["a"])(this.contextAssetString)),
            (this.contextName = a[0]),
            (this.contextId = a[1]));
        ...
        t.prototype.setPublishable = function () {
          ...
          return i
            ? this.unset("publishableMessage")
            : this.set(
                "publishableMessage",
                u["a"].t(
                  "cannot_unpublish_front_page",
                  "Cannot unpublish the front page"
                )
              );
        };
        ...
        t.prototype.url = function () {
          return this.get("url")
            ? this.urlRoot() + "/" + this.get("url")
            : this.urlRoot();
        };
        t.prototype.latestRevision = function (e) {
          var t;
          if (
            !this._latestRevision &&
            this.get("url") &&
            !this._latestRevision
          ) {
            t = Object.assign(
        ...
        t.prototype.parse = function (e, t) {
          var i;
          e.wiki_page &&
            (e = n.a.extend(n.a.omit(e, "wiki_page"), e.wiki_page));
          e.set_assignment =
            null != e.assignment && e.assignment.only_visible_to_overrides;
          i = e.assignment || {};
        ...
        t.prototype.duplicate = function (e, t) {
          return $.ajaxJSON(
            "/api/v1/courses/" + e + "/pages/" + this.id + "/duplicate",
            "POST",
            {},
            t
          );
    ...
    teYS: function (e, t, i) {
      ...
      e.exports = { subscribe: n, unsubscribe: o, publish: s };
    },
    wPjB: function (e, t, i) {
      "use strict";
      var a = i("pQTu");
      ...
      INST.lookupPrerequisites = function () {
        ...
        l.a.ajaxJSON(
          ...
          function (t) {
            ...
            e.after(a);
            const n = o.t(
              "headers.completion_prerequisites",
              "Completion Prerequisites"
            );
            const s = o.beforeLabel(
              o.t(
    ...
    ysUD: function (e, t, i) {
      ...
      v.canvas = function (e) {
        return { focusBorderColor: e["ic-brand-primary"] };
      };
      var y, w, x, z;
      var q = {
        componentId: "fvvQs",
        template: function (e) {
          return "\n\n.fvvQs_bGBk{background:"
            .concat(e.background || "inherit", ";border:")
            .concat(e.borderWidth || "inherit", " solid ")
            .concat(e.borderColor || "inherit", ";border-radius:")
            .concat(
              e.borderRadius || "inherit",
              ";bottom:0;box-sizing:border-box;display:flex;justify-content:center;left:0;outline:none;overflow:auto;position:absolute;right:0;top:0;z-index:"
            )
            .concat(
              e.zIndex || "inherit",
              "}\n\n.fvvQs_bGBk:focus{border-color:"
            )
            .concat(
              e.focusBorderColor || "inherit",
                ...
                Object(s["a"])(i, [
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      var o = p()(
                        ((e = {}),
                        Object(n["a"])(e, q.root, true),
                        Object(n["a"])(e, q[this.props.placement], true),
                        Object(n["a"])(e, q.fullscreen, this.props.fullscreen),
                        e)
                      );
                      var s = Object(a["a"])(
                        {},
                        Object(k["a"])(this.props, i.propTypes),
                        { className: o, ref: this.handleElementRef }
                      );
