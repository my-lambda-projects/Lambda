  ...
  [0],
  {
      ...
      o.a.widget("ui.draggable", o.a.ui.mouse, {
        ...
        _mouseCapture: function (t) {
          ...
          if (
            this.helper ||
            e.disabled ||
            o()(t.target).is(".ui-resizable-handle")
          )
            return false;
        ...
        _mouseStart: function (t) {
          ...
          o.a.ui.ddmanager &&
            !e.dropBehaviour &&
            o.a.ui.ddmanager.prepareOffsets(this, t);
        ...
        _mouseStop: function (t) {
          ...
          o.a.ui.ddmanager &&
            ...
            (e = o.a.ui.ddmanager.drop(this, t));
          if (this.dropped) {
            e = this.dropped;
            this.dropped = false;
          }
          ...
          if (
            ...
            (o.a.isFunction(this.options.revert) &&
              this.options.revert.call(this.element, e))
          ) {
            var n = this;
            o()(this.helper).animate(
        ...
        _mouseUp: function (t) {
          true === this.options.iframeFix &&
            o()("div.ui-draggable-iframeFix").each(function () {
        ...
        _getHandle: function (t) {
          var e =
            !this.options.handle ||
            !o()(this.options.handle, this.element).length;
          o()(this.options.handle, this.element)
            .find("*")
            .andSelf()
            .each(function () {
        ...
        _createHelper: function (t) {
          var e = this.options;
          var i = o.a.isFunction(e.helper)
            ? o()(e.helper.apply(this.element[0], [t]))
            : "clone" == e.helper
        ...
        _getParentOffset: function () {
          ...
          if (
            ...
            o.a.contains(this.scrollParent[0], this.offsetParent[0])
          ) {
        ...
        _setContainment: function () {
          ...
          ("document" != t.containment && "window" != t.containment) ||
            (this.containment = [
              ...
              ("document" == t.containment ? 0 : o()(window).scrollLeft()) +
                o()("document" == t.containment ? document : window).width() -
                this.helperProportions.width -
                this.margins.left,
              ("document" == t.containment ? 0 : o()(window).scrollTop()) +
                (o()(
          ...
          if (
            ...
            this.containment = [
              (parseInt(o()(i).css("borderLeftWidth"), 10) || 0) +
                (parseInt(o()(i).css("paddingLeft"), 10) || 0),
              (parseInt(o()(i).css("borderTopWidth"), 10) || 0) +
                (parseInt(o()(i).css("paddingTop"), 10) || 0),
              (s ? Math.max(i.scrollWidth, i.offsetWidth) : i.offsetWidth) -
                (parseInt(o()(i).css("borderLeftWidth"), 10) || 0) -
                (parseInt(o()(i).css("paddingRight"), 10) || 0) -
                this.helperProportions.width -
                this.margins.left -
                this.margins.right,
              (s ? Math.max(i.scrollHeight, i.offsetHeight) : i.offsetHeight) -
                (parseInt(o()(i).css("borderTopWidth"), 10) || 0) -
                (parseInt(o()(i).css("paddingBottom"), 10) || 0) -
                this.helperProportions.height -
                this.margins.top -
                this.margins.bottom,
            ];
        ...
        _generatePosition: function (t) {
          ...
          if (this.originalPosition) {
            ...
            if (e.grid) {
              var h = e.grid[1]
                ? this.originalPageY +
                  Math.round((a - this.originalPageY) / e.grid[1]) * e.grid[1]
                : this.originalPageY;
              a =
                r &&
      ...
      o.a.ui.plugin.add("draggable", "connectToSortable", {
        start: function (t, e) {
          var i = o()(this).data("draggable"),
            s = i.options,
            n = o.a.extend({}, e, { item: i.element });
          i.sortables = [];
          o()(s.connectToSortable).each(function () {
            var e = o.a.data(this, "sortable");
            if (e && !e.options.disabled) {
              i.sortables.push({ instance: e, shouldRevert: e.options.revert });
              e.refreshPositions();
      ...
      o.a.ui.plugin.add("draggable", "scroll", {
        ...
        drag: function (t, e) {
          ...
          if (
            ...
            (s.axis && "x" == s.axis) ||
              (t.pageY - o()(document).scrollTop() < s.scrollSensitivity
                ? (n = o()(document).scrollTop(
                    o()(document).scrollTop() - s.scrollSpeed
                  ))
                : o()(window).height() - (t.pageY - o()(document).scrollTop()) <
                    s.scrollSensitivity &&
                  (n = o()(document).scrollTop(
                    o()(document).scrollTop() + s.scrollSpeed
                  )));
            (s.axis && "y" == s.axis) ||
              (t.pageX - o()(document).scrollLeft() < s.scrollSensitivity
                ? (n = o()(document).scrollLeft(
                    o()(document).scrollLeft() - s.scrollSpeed
                  ))
                : o()(window).width() - (t.pageX - o()(document).scrollLeft()) <
                    s.scrollSensitivity &&
                  (n = o()(document).scrollLeft(
                    o()(document).scrollLeft() + s.scrollSpeed
                  )));
          ...
          false !== n &&
            o.a.ui.ddmanager &&
            !s.dropBehaviour &&
            o.a.ui.ddmanager.prepareOffsets(i, t);
        },
      });
      o.a.ui.plugin.add("draggable", "snap", {
        ...
        drag: function (t, e) {
          ...
          for (var u = i.snapElements.length - 1; u >= 0; u--) {
            ...
            if (
              !(
                (p - n < a && a < d + n && c - n < l && l < f + n) ||
                (p - n < a && a < d + n && c - n < h && h < f + n) ||
                (p - n < r && r < d + n && c - n < l && l < f + n) ||
                (p - n < r && r < d + n && c - n < h && h < f + n)
              )
            ) {
              i.snapElements[u].snapping &&
                ...
                i.options.snap.release.call(
                  i.element,
                  t,
                  o.a.extend(i._uiHash(), { snapItem: i.snapElements[u].item })
                );
            ...
            if ("inner" != s.snapMode) {
              ...
              m &&
                (e.position.top =
                  i._convertPositionTo("relative", { top: f, left: 0 }).top -
                  i.margins.top);
              v &&
                (e.position.left =
                  i._convertPositionTo("relative", {
              ...
              b &&
                (e.position.left =
                  i._convertPositionTo("relative", { top: 0, left: d }).left -
                  i.margins.left);
            }
            var _ = g || m || v || b;
            if ("outer" != s.snapMode) {
              ...
              g &&
                (e.position.top =
                  i._convertPositionTo("relative", { top: c, left: 0 }).top -
                  i.margins.top);
              m &&
                (e.position.top =
                  i._convertPositionTo("relative", {
              ...
              v &&
                (e.position.left =
                  i._convertPositionTo("relative", { top: 0, left: p }).left -
                  i.margins.left);
              b &&
                (e.position.left =
                  i._convertPositionTo("relative", {
      ...
      o.a.ui.plugin.add("draggable", "stack", {
        start: function (t, e) {
          ...
          var s = o.a.makeArray(o()(i.stack)).sort(function (t, e) {
            return (
              (parseInt(o()(t).css("zIndex"), 10) || 0) -
              (parseInt(o()(e).css("zIndex"), 10) || 0)
            );
          });
          if (!s.length) return;
    ...
    YGE8: function (t, e, i) {
      ...
      o.a.widget("ui.dialog", {
        ...
        _create: function () {
          ...
          var t = this,
            e = this.options,
            i = e.title || "&#160;",
            s = (this.uiDialog = o()("<div>"))
              .addClass(a + e.dialogClass)
              .css({ display: "none", outline: 0, zIndex: e.zIndex })
              .attr("tabIndex", -1)
              .keydown(function (i) {
                if (
                  e.closeOnEscape &&
                  ...
                  i.keyCode &&
                  i.keyCode === o.a.ui.keyCode.ESCAPE
                ) {
                  t.close(i);
                  i.preventDefault();
                }
            ...
            l = o()("<button></button>")
              ...
              .appendTo(r),
            h =
              ((this.uiDialogTitlebarCloseText = o()("<span>"))
        ...
        open: function () {
          ...
          if (e.modal) {
            ...
            o()(
              ":not(.ui-dialog-focus-bumper):tabbable:first",
              this.uiDialog
            ).focus();
            this._on(i, {
              keydown: function (t) {
        ...
        _createButtons: function (t) {
          ...
          if (i) {
            o.a.each(t, function (t, i) {
              i = o.a.isFunction(i) ? { click: i, text: t } : i;
              var s = o()("<button type='button'>")
                .attr(i, true)
                .unbind("click")
                .click(function () {
            ...
            this.options.modal
              ? this.uiDialogButtonPane.insertBefore(
                  this.uiDialog.find(".ui-dialog-focus-bumper-bottom")
                )
        ...
        _setOption: function (t, e) {
          ...
          switch (t) {
            ...
            case "resizable":
              ...
              break;
            case "title":
              o()(".ui-dialog-title", this.uiDialogTitlebar).html(
                "" + (e || "&#160;")
              );
          }
          this._super(t, e);
      ...
      o.a.extend(o.a.ui.dialog.overlay, {
        ...
        create: function (t) {
          if (0 === this.instances.length) {
            setTimeout(function () {
              o.a.ui.dialog.overlay.instances.length &&
                o()(document).bind(o.a.ui.dialog.overlay.events, function (e) {
                  if (
                    o()(e.target).zIndex() < o.a.ui.dialog.overlay.maxZ &&
          ...
          var e =
            ...
            o()("<div>").addClass("ui-widget-overlay");
        ...
        destroy: function (t) {
          ...
          0 === this.instances.length &&
            o()([document, window]).unbind(".dialog-overlay");
      ...
      function h(t) {
        if (!t) return t;
        return t.jquery
          ? o()("<div />").append(t.eq(0).clone()).html()
          : Object(n["a"])("" + t);
      }
    ...
    Yf8v: function (t, e, i) {
      ...
      o.a.widget("ui.resizable", o.a.ui.mouse, {
        ...
        _create: function () {
          ...
          this.handles =
            e.handles ||
            (o()(".ui-resizable-handle", this.element).length
              ? {
                  n: ".ui-resizable-n",
                  e: ".ui-resizable-e",
                  s: ".ui-resizable-s",
          ...
          this._renderAxis = function (t) {
            ...
            for (var e in this.handles) {
              this.handles[e].constructor == String &&
                (this.handles[e] = o()(this.handles[e], this.element).show());
              if (
        ...
        _mouseCapture: function (t) {
          ...
          for (var i in this.handles)
            o()(this.handles[i])[0] == t.target && (e = true);
        ...
        _updateRatio: function (t, e) {
          ...
          a(t.height)
            ...
            : a(t.width) && (t.height = t.width / this.aspectRatio);
          if ("sw" == o) {
        ...
        _renderProxy: function () {
          ...
          if (this._helper) {
            this.helper =
              this.helper || o()('<div style="overflow:hidden;"></div>');
        ...
        _change: {
          ...
          w: function (t, e, i) {
            ...
            return { left: o.left + e, width: s.width - e };
          },
          n: function (t, e, i) {
            this.options;
            var s = this.originalSize,
      ...
      o.a.ui.plugin.add("resizable", "alsoResize", {
        start: function (t, e) {
          ...
          if ("object" != typeof s.alsoResize || s.alsoResize.parentNode)
            n(s.alsoResize);
          else if (s.alsoResize.length) {
            s.alsoResize = s.alsoResize[0];
            n(s.alsoResize);
          } else
            o.a.each(s.alsoResize, function (t) {
              n(t);
            });
        },
        resize: function (t, e) {
              ...
              o()(t).each(function () {
                var t = o()(this),
                  ...
                  a =
                    i && i.length
                      ? i
                      : t.parents(e.originalElement[0]).length
                      ? ["width", "height"]
          ...
          "object" != typeof s.alsoResize || s.alsoResize.nodeType
            ? l(s.alsoResize)
            : o.a.each(s.alsoResize, function (t, e) {
                l(t, e);
              });
        },
        stop: function (t, e) {
      ...
      o.a.ui.plugin.add("resizable", "animate", {
        stop: function (t, e) {
          ...
          var h = { width: i.size.width - l, height: i.size.height - r },
            u =
              parseInt(i.element.css("left"), 10) +
                (i.position.left - i.originalPosition.left) || null,
            p =
              parseInt(i.element.css("top"), 10) +
                (i.position.top - i.originalPosition.top) || null;
          i.element.animate(o.a.extend(h, p && u ? { top: p, left: u } : {}), {
            ...
            step: function () {
              ...
              n &&
                n.length &&
                o()(n[0]).css({ width: e.width, height: e.height });
              i._updateCache(e);
      ...
      o.a.ui.plugin.add("resizable", "containment", {
        start: function (t, e) {
          ...
          if (/document/.test(r) || r == document) {
            ...
            i.parentData = {
              ...
              height:
                o()(document).height() || document.body.parentNode.scrollHeight,
            };
          } else {
            var h = o()(l),
              u = [];
        ...
        resize: function (t, e) {
          ...
          if (a.left < (i._helper ? n.left : 0)) {
            i.size.width =
              i.size.width +
              (i._helper ? i.position.left - n.left : i.position.left - l.left);
          ...
          var u = Math.abs(
              (i._helper, i.offset.left - l.left) + i.sizeDiff.width
            ),
            p = Math.abs(
              (i._helper ? i.offset.top - l.top : i.offset.top - n.top) +
                i.sizeDiff.height
            );
    ...
    ZV2x: function (t, e, i) {
      ...
      o.a.widget("ui.mouse", {
        ...
        _mouseInit: function () {
          ...
          this.element
            ...
            .bind("click." + this.widgetName, function (e) {
              if (
                true === o.a.data(e.target, t.widgetName + ".preventClickEvent")
              ) {
        ...
        _mouseDown: function (t) {
          ...
          true === o.a.data(t.target, this.widgetName + ".preventClickEvent") &&
            o.a.removeData(t.target, this.widgetName + ".preventClickEvent");
        ...
        _mouseMove: function (t) {
          if (o.a.browser.msie && !(document.documentMode >= 9) && !t.button)
        ...
        _mouseUp: function (t) {
          ...
          if (this._mouseStarted) {
            ...
            t.target === this._mouseDownEvent.target &&
              o.a.data(t.target, this.widgetName + ".preventClickEvent", true);
            this._mouseStop(t);
          }
          return false;
        },
          ...
          if ("checkbox" === this.type)
            ...
            this.buttonElement
              ...
              .bind("keydown" + this.eventNamespace, function (t) {
                if (e.disabled) return false;
                (t.keyCode !== o.a.ui.keyCode.SPACE &&
                  t.keyCode !== o.a.ui.keyCode.ENTER) ||
                  o()(this).addClass("ui-state-active");
              })
