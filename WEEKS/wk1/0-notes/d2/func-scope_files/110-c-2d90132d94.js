  ...
  [110],
  {
      ...
      n.a.fn.loadingImg = function (e) {
        ...
        if (e.horizontal)
          if ("left" === e.horizontal);
            ...
            r = i.outerWidth() / 2 - o.width / 2;
          else {
            r = parseInt(e.horizontal, 10);
            isNaN(r) && (r = 0);
          }
        const l = i.zIndex() + 1;
        const u = n()(document.createElement("div")).addClass(
        ...
        if (i.css("position") && "static" !== i.css("position")) {
          u.css({ zIndex: l, position: "absolute", top: s, left: r });
          i.append(u);
        } else {
          const t = i.offset();
          let a = t.top,
          ...
          e.vertical && (a += s);
          e.horizontal && (o += r);
          u.css({ zIndex: l, position: "absolute", top: a, left: o });
          n()("body").append(u);
        }
        return n()(this);
      };
    ...
    "7WS/": function (e, t, i) {
      ...
      function c(e, t, i) {
        ...
        const u =
          s.data("media_comment_id") ||
          d.a.trim(s.find(".media_comment_id:first").text()) ||
          ((a = s.attr("id")) &&
            a.match(/^media_comment_/) &&
            a.substring(14)) ||
          d.a.trim(s.parent().find(".media_comment_id:first").text());
        const c = s.data("author");
        const g = s.data("created_at");
        let h;
        h =
          c && g
            ? o.t("Play media comment by %{name} from %{createdAt}.", {
                name: c,
                createdAt: g,
              })
        ...
        if (u) {
          ...
          const n = d()(
            `<span\n        style='background-image: url(${Object(l["a"])(
              a
            )});'\n        class='media_comment_thumbnail media_comment_thumbnail-${Object(
              l["a"]
            )(
              t
          ...
          e.hrefValues &&
            ...
            this.find("a,span[rel]").each(function () {
              ...
              for (const s in e.hrefValues) {
                ...
                (i = o.attr("rel")) &&
                  o.attr("rel", n.a.replaceTags(i, r, e.data[r]));
                (a = o.attr("name")) &&
                  o.attr("name", n.a.replaceTags(a, r, e.data[r]));
              }
            });
            ...
            let i = n.a.map(t.toArray(), (t) => {
              ...
              if (i.is(".dialog_closer")) {
                ...
                i.on(
                  ...
                  Object(r["a"])(() => e.dialog("close"))
                );
              }
              "submit" === i.prop("type") &&
                i[0].form &&
                (a += " button_type_submit");
              return {
                text: i.text(),
    ...
    VNfg: function (e, t, i) {
      ...
      l()(document)
        .bind("equella_ready", function (e, t) {
      ...
      function b() {
        ...
        if (i && !e.hasClass("inline_disabled")) {
          ...
          a.click(
            Object(c["a"])(function () {
              const e = l()(
                `\n        <span class='youtube_holder' style='display: block;'>\n          <iframe\n            src='//www.youtube.com/embed/${Object(
                  m["a"]
                )(
                  i
                )}?autoplay=1&rel=0&hl=en_US&fs=1'\n            frameborder='0'\n            width='425'\n            height='344'\n            allowfullscreen\n          ></iframe>\n          <br/>\n          <a\n            href='#'\n            style='font-size: 0.8em;'\n            class='hide_youtube_embed_link'\n          >\n            ${Object(
                  m["a"]
                )(
                  s.t("links.minimize_youtube_video", "Minimize Video")
                )}\n          </a>\n        </span>\n      `
              );
              e.find(".hide_youtube_embed_link").click(
                Object(c["a"])(() => {
                  e.remove();
                  a.show();
      ...
      Object(v["a"])(
        "Route",
        window.location.pathname.replace(/\/$/, "").replace(/\d+/g, "--") || "/"
      );
        ...
        l()(".user_content.unenhanced:visible")
          .each(function () {
            ...
            t.find("img").each((i, a) => {
              ...
              /hidden=1$/.test(a.getAttribute("src")) &&
                a.setAttribute(
                  "alt",
                  s.t("This image is currently unavailable")
                );
            });
          ...
          .each(function () {
            const e = Object(m["a"])(
              s.t("titles.external_link", "Links to an external site.")
            );
            l()(this)
              .not(":has(img)")
              .addClass("external")
              .html("<span>" + l()(this).html() + "</span>")
              .attr("target", "_blank")
          ...
          .end();
        l()("a.instructure_file_link, a.instructure_scribd_file").each(
          function () {
            const e = l()(this);
            l()(".user_content.unenhanced:visible");
            ...
            if (l.a.trim(e.text())) {
              var r;
              const t = l()(
                "<span class='instructure_file_holder link_holder'/>"
              );
              const i = w();
              o = l()('<div role="region" />')
                .attr("id", i)
              ...
              if (
                null !== (r = ENV.FEATURES) &&
                void 0 !== r &&
                r.rce_better_file_downloading
              ) {
                const t = new URL(e[0].href);
                const i = t.searchParams;
                i.delete("wrap");
                i.append("download_frd", "1");
                const n = `${t.origin}${t.pathname.replace(
                  /(?:\/(download|preview))?$/,
                  "/download"
                )}?${i}`;
                a = l()(
                  `<a class="file_download_btn" role="button" download style="margin-inline-start: 5px;" href="${Object(
                    m["a"]
                  )(
                    n
              ...
              if (
                l.a.filePreviewsEnabled() &&
                e.hasClass("instructure_scribd_file")
              ) {
                var u;
                if (
                  null !== (u = ENV.FEATURES) &&
                  void 0 !== u &&
                  u.rce_better_file_previewing
                )
                  if (e.hasClass("inline_disabled"))
                    e.addClass("preview_in_overlay");
                  else {
                  ...
                  e.hasClass("inline_disabled") ||
                    (n = l()(
                      "<a class='file_preview_link' aria-hidden='true' href='" +
                        Object(m["a"])(e.attr("href")) +
                        "' title='" +
                        Object(m["a"])(
                          s.t("titles.preview_document", "Preview the document")
                        ) +
              ...
              if (e.hasClass("auto_open")) {
                ...
                n
                  ...
                  : null !== (d = ENV.FEATURES) &&
                    void 0 !== d &&
                    d.rce_better_file_previewing &&
                    e.click();
              }
            }
          }
        );
        l()(".user_content.unenhanced a,.user_content.unenhanced+div.answers a")
          ...
          .not(".youtubed")
          .each(b);
        l()(".user_content.unenhanced")
          .removeClass("unenhanced")
          .addClass("enhanced");
        setTimeout(() => {
          l()(".user_content form.user_content_post_form:not(.submitted)")
            .submit()
            .addClass("submitted");
        }, 10);
        document
      ...
      l()(function () {
        ...
        l()("#switched_role_type").ifExists(function () {
          ...
          t.attr("src", "/images/warning.png")
            .attr("title", i)
            .css({ paddingRight: 2, width: 12, height: 12 });
          l()("#crumb_" + e)
            .find("a")
            .prepend(t);
        });
          ...
          if (!t.length) {
            ...
            t.html(
              "<h2/><iframe style='background: url(/images/ajax-loader-medium-444.gif) no-repeat left top; width: 800px; height: 350px; border: 0;' src='about:blank' borderstyle='0'/><div style='text-align: right;'><a href='#' class='original_link external external_link' target='_blank'>" +
                Object(m["a"])(
                  s.t(
                    "links.view_equella_content_in_new_window",
                    "view the content in a new window"
                  )
                ) +
                "</a>"
            );
            t.find("h2").text(
              l()(this).attr("title") ||
                l()(this).text() ||
                s.t("titles.equella_content_preview", "Equella Content Preview")
            );
            ...
            t.dialog({
              ...
              resizable: false,
              title: s.t(
                "titles.equella_content_preview",
                "Equella Content Preview"
              ),
              close() {
        ...
        l()(".dialog_opener[aria-controls]:not(.user_content *)").live(
          "click",
          function (e) {
            const t = this;
        ...
        l.a.filePreviewsEnabled()
          ? l()("a.file_preview_link").live("click", function (e) {
              var t;
              ...
              i.loadingImage({ image_size: "small", horizontal: "right!" });
              null !== (t = ENV.FEATURES) &&
              void 0 !== t &&
              t.rce_better_file_previewing
              ...
              l.a.ajaxJSON(
                ...
                (t) => {
                  ...
                  if (
                    a &&
                    (l.a.isPreviewable(a.content_type, "google") ||
                      a.canvadoc_session_url)
                  ) {
                    var n;
                    const t =
                      null !== (n = window.ENV) &&
                      void 0 !== n &&
                      n.FEATURES.rce_better_file_previewing
                        ? l()(`[id="${i.attr("aria-controls")}"]`)
                        : i.parent().find('[role="region"][id^="preview_"]');
                    t.css("display", "block").loadDocPreview({
                      canvadoc_session_url: a.canvadoc_session_url,
                      mimeType: a.content_type,
                      public_url: a.public_url,
                      attachment_preview_processing:
                        "pending_upload" === a.workflow_state ||
                        "processing" === a.workflow_state,
                    });
                    const o = l()(
                      '<a href="#" style="font-size: 0.8em;" class="hide_file_preview_link">' +
                        Object(m["a"])(
                          s.t(
                            "links.minimize_file_preview",
                      ...
                      Object(v["a"])(
                        "hide_embedded_content",
                        "hide_file_preview"
                      );
                    });
                    t.prepend(o);
                    Object.prototype.hasOwnProperty.call(e, "originalEvent") &&
                      o.focus();
                    Object(v["a"])(
        ...
        null !== (e = ENV.FEATURES) &&
          void 0 !== e &&
          e.rce_better_file_previewing &&
          l()("a.preview_in_overlay").live("click", (e) => {
            ...
            if (t) {
              ...
              Promise.all([
                ...
                .then(i.bind(null, "1yb/"))
                .then((e) => {
                  e.showFilePreview(a);
                })
                .catch((e) => {
                  l.a.flashError(
                    s.t("Someting went wrong loading the file previewer.")
                  );
                });
            }
          });
        ...
        l()(".communication_message .message_short .read_more_link").click(
          function (e) {
            e.preventDefault();
            l()(this)
        ...
        l()(".communication_message .close_notification_link").live(
          "click",
          function (e) {
            e.preventDefault();
        ...
        l()(document)
          .bind("richTextStart", (e, t) => {
            ...
            g["a"].loadNewEditor(t, { focus: true });
          })
        ...
        l()(
          ".communication_sub_message .add_conversation_message_form"
        ).formSubmit({
          beforeSubmit(e) {
            l()(this).find("button").attr("disabled", true);
            l()(this)
              .find(".submit_button")
              .text(s.t("status.posting_message", "Posting Message..."));
            l()(this).loadingImage();
          },
          success(e) {
            ...
            "/" === window.location.pathname &&
              Object(v["a"])("dashboard_comment", "create");
          },
          error(e) {
            l()(this).loadingImage("remove");
        ...
        l()(".communication_sub_message .add_sub_message_form").formSubmit({
          ...
          error(e) {
            ...
            l()(this)
              .find(".submit_button")
              .text(
                s.t("errors.posting_message_failed", "Post Failed, Try Again")
              );
            l()(this).formErrors(e);
          },
        });
        l()(".communication_sub_message form .cancel_button").click(
          function () {
            const e = l()(this).parents(".communication_sub_message");
            const t = l()(this).parents(".communication_message");
            l()(document).triggerHandler(
              "richTextEnd",
              e.find("textarea.rich_text")
            );
            e.remove();
            t.find(".reply_message").show();
          }
        );
        l()(".communication_message,.communication_sub_message")
        ...
        l()(".communication_sub_message .more_options_reply_link").click(
          function (e) {
            e.preventDefault();
            ...
            window.location.href =
              l()(this).attr("href") +
              "?message=" +
              encodeURIComponent(i.message);
          }
        );
        l()(".communication_message.new_activity_message").ifExists(
          function () {
            ...
            this.find("form.message_form").formSubmit({
              beforeSubmit(e) {
                ...
                l()("button.submit_button").text(
                  s.t("status.posting_message", "Posting Message...")
                );
              },
              success(e) {
                ...
                if (l()(this).hasClass("discussion_topic_form")) {
                  ...
                  o.find(
                    ".header .title,.behavior_content .less_important a"
                  ).attr("href", n.find("." + t + "_topic_url").attr("href"));
                  o.find(".add_entry_link").attr(
                    "href",
                    n.find("." + t + "_topics_url").attr("href")
                  );
                  o.find(".user_name").attr(
                    "href",
                    n.find("." + t + "_user_url").attr("href")
                  );
                  o.find(".topic_assignment_link,.topic_assignment_url").attr(
                    "href",
                    n.find("." + t + "_assignment_url").attr("href")
                  );
                  o.find(".attachment_name,.topic_attachment_url").attr(
                    "href",
                    n.find("." + t + "_attachment_url").attr("href")
                  );
                  ...
                  o.find(".subcontent form").attr(
                    "action",
                    n.find("." + t + "_entries_url").attr("href")
                  );
                  ...
                  l()(this).hasClass("announcement_form") ||
        ...
        l()("#topic_list .show_all_messages_link")
          .show()
          .click(function (e) {
            e.preventDefault();
        ...
        let o = [];
        function r() {
          o = [...document.querySelectorAll(".time_ago_date")].filter(
            l.a.expr.filters.visible
          );
          u();
        }
        function u() {
          ...
          if (e) {
            const t = l()(e),
              i =
                t.data("parsed_date") || Date.parse(t.data("timestamp") || "");
            if (i) {
        ...
        setTimeout(r, 100);
        const c = l()("#sequence_footer .sequence_details_url")
          .filter(":last")
          .attr("href");
        if (c)
          l.a.ajaxJSON(c, "GET", {}, (e) => {
            const t = l()("#sequence_footer");
            if (e.current_item) {
              l()("#sequence_details .current").fillTemplateData({
                data: e.current_item.content_tag,
              });
              l.a.each({ previous: ".prev", next: ".next" }, (i, a) => {
                const n = t.find(a);
                if (e[i + "_item"] || e[i + "_module"]) {
                  const a =
                    (e[i + "_item"] && e[i + "_item"].content_tag) ||
                    (e[i + "_module"] && e[i + "_module"].context_module);
                  if (!e[i + "_item"]) {
                    a.title = a.title || a.name;
                    "unpublished" === a.workflow_state &&
                      (a.title += " (" + s.t("draft", "Draft") + ")");
                    a.text =
                      "previous" === i
                        ? s.t("buttons.previous_module", "Previous Module")
                        : s.t("buttons.next_module", "Next Module");
                  ...
                  e[i + "_item"]
                    ? n.attr(
                        "href",
                        l.a.replaceTags(
                          t.find(".module_item_url").attr("href"),
                          "id",
                          a.id
                        )
                      )
                    : n.attr(
                        "href",
                        l.a.replaceTags(
                          t.find(".module_url").attr("href"),
                          "id",
                          a.id
                        ) +
                          "/items/" +
                          ("previous" === i ? "last" : "first")
                      );
                } else n.hide();
              });
              t.show();
          ...
          if (e.length) {
            const t = l()(e[0]);
            Promise.all([i.e(6), i.e(59), i.e(738)])
              .then(i.bind(null, "/j35"))
              .then(() => {
        ...
        l()("#right-side").on("click", ".disable-todo-item-link", function (e) {
          ...
          const a =
            (i.find(".disable-todo-item-link").length &&
              i.find(".disable-todo-item-link")) ||
            l()(".todo-list-header");
        ...
        setTimeout(function () {
          ...
          for (let e = 0; e < t.length; e++) {
            ...
            if (a.length) {
              const e = s.t(
                "titles.external_link",
                "Links to an external site."
              );
              const t = l()(
                '<span class="ui-icon ui-icon-extlink ui-icon-inline"/>'
              ).attr("title", e);
    ...
    fy7k: function (e, t, i) {
      ...
      l.a.filePreviewsEnabled = function () {
        return !(
          a["a"].disableCrocodocPreviews && a["a"].disableGooglePreviews
        );
      };
      l.a.isPreviewable = function (e, t) {
        return (
          ...
          m[e] &&
          (!t ||
            (!a["a"]["disable" + l.a.capitalize(t) + "Previews"] &&
              m[e][{ scribd: 0, google: 1 }[t]]))
        );
      };
      l.a.fn.loadDocPreview = function (e) {
        return this.each(function () {
          const t = l()(this),
            i = l.a.extend({ width: "100%", height: "400px" }, t.data(), e);
          function n(e) {
            if (i.attachment_view_inline_ping_url) {
              l.a.ajaxJSON(
                i.attachment_view_inline_ping_url,
                "POST",
                {},
                () => {},
                () => {}
          ...
          if (!a["a"].disableCrocodocPreviews && i.crocodoc_session_url) {
            ...
            e.appendTo(t);
            const a =
              void 0 !== i.iframe_min_height ? i.iframe_min_height : "800px";
            ...
            (!a["a"].disableGooglePreviews &&
              (!i.mimetype || l.a.isPreviewable(i.mimetype, "google")) &&
              i.attachment_id) ||
            i.public_url
          ) {
            const e = function () {
              const e =
                ...
                l.a.param({ embedded: true, url: i.public_url });
              (i.ajax_valid && !i.ajax_valid()) ||
                l()(
                  '<iframe src="' +
                    Object(u["a"])(e) +
                    '" height="' +
            ...
            if (i.public_url) e();
              ...
              i.submission_id &&
                (a += "?" + l.a.param({ submission_id: i.submission_id }));
              if (i.verifier)
                a += `${i.submission_id ? "&" : "?"}verifier=${i.verifier}`;
              else {
                const e = window.location.search.match(
                  /verifier=([^&]+)(?:&|$)/
                );
                const t = e && e[1];
            ...
            l.a.filePreviewsEnabled() &&
              (i.attachment_preview_processing
                ? t.html(
                    "<p>" +
                      Object(u["a"])(
                        s.t(
