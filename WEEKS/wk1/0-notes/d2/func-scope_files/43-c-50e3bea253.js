  ...
  [43, 667, 738],
  {
    "2BSC": function (e, t, a) {
      ...
      var f = function (e, t) {
        ...
        _ = function (e, t) {
          for (var a in t) v.call(t, a) && (e[a] = t[a]);
          function n() {
            this.constructor = e;
          }
      ...
      t["a"] = (function (e) {
        _(t, e);
        function t() {
          this.checkUnload = f(this.checkUnload, this);
        ...
        t.prototype.submit = function (e, t) {
          ...
          d.length > 0 &&
            ...
            (c = d
              .map(function (e) {
                return t(o()(e), "checkReadyToGetCode", window.confirm);
              })
              .every(function (e) {
                return e;
              }));
          ...
          if (0 === u.a.keys(s).length) {
            ...
            d.length > 0 &&
              d.forEach(function (e) {
                return t(o()(e), "RCEClosed");
              });
            this.trigger("submit");
            return h;
          }
          r = u.a.map(o()("[data-error-type]"), function (e) {
            return o()(e).attr("data-error-type");
          });
          a = u.a
            .chain(u.a.keys(s))
            .reject(function (e) {
              return u.a.includes(r, e);
            })
            .value();
          l = a[0] || r[0];
        ...
        t.prototype.cancel = function () {
          ...
          return e.forEach(function (e) {
            return Object(g["d"])(o()(e), "RCEClosed");
          });
        };
        t.prototype.getFormData = function () {
          return this.$el.toJSON();
        };
        t.prototype.saveFormData = function (e) {
          var t, a;
          null == e && (e = null);
          t = this.model;
        ...
        t.prototype.validateFormData = function (e) {
          return {};
        };
        t.prototype.validateBeforeSave = function (e) {
          return this.validateFormData(e);
        };
        t.prototype.hideErrors = function () {
          return this.$el.hideErrors();
        };
        t.prototype.onSaveSuccess = function (e) {
          return this.trigger.apply(
            this,
            ["success", e].concat(m.call(arguments))
          );
        };
        t.prototype.onSaveFail = function (e) {
          var t;
          ...
          return this.trigger.apply(
            this,
            ["fail", t].concat(m.call(arguments))
          );
        };
        t.prototype.parseErrorResponse = function (e) {
          if (422 === e.status) return { authenticity_token: "invalid" };
          try {
            return o.a.parseJSON(e.responseText).errors;
          } catch (e) {
            e;
            return {};
          }
        };
        t.prototype.translations = Object(p["b"])(
          {},
          {
            required: function () {
              return h.t("required", "Required");
            },
            blank: function () {
              return h.t("blank", "Required");
            },
            unsaved: function () {
              return h.t("unsaved_changes", "You have unsaved changes.");
            },
          }
        );
        t.prototype.fieldSelectors = null;
        t.prototype.findField = function (e) {
          var t, a, n;
          n =
            (null != (a = this.fieldSelectors) ? a[e] : void 0) ||
            "[name='" + e + "']";
          t = this.$(n);
        ...
        t.prototype.castJSON = function (e) {
          var t;
        ...
        t.prototype.watchUnload = function () {
          this.original = this.castJSON(this.getFormData());
          this.unwatchUnload();
          return o()(window).on("beforeunload", this.checkUnload);
        };
        t.prototype.unwatchUnload = function () {
          return o()(window).off("beforeunload", this.checkUnload);
        };
        t.prototype.checkUnload = function () {
          var e;
    ...
    BYL3: function (e, t, a) {
      ...
      function u() {
        if (this.elements) return r.a.makeArray(this.elements);
        {
      ...
      function c() {
        return (
          this.name &&
          !this.disabled &&
          (this.checked || s.test(this.nodeName) || l.test(this.type))
        );
      }
      function d(e, t) {
        "string" === typeof t && (t = t.replace(o, "\r\n"));
          ...
          if ("file" !== this.type)
            return e.hasClass("datetime_field_enabled")
              ? "" === e.val()
                ...
                : e.data("date") || null
              : e.data("rich_text")
              ? Object(i["d"])(e, "get_code", false)
              : e.val();
          if (e.val()) return this;
        })();
        return r.a.isArray(t) ? t.map((e) => d(this.name, e)) : d(this.name, t);
      }
      r.a.fn.serializeForm = function () {
        return this.map(u).filter(c).map(h).get();
      };
    },
    TBRb: function (e, t, a) {
      "use strict";
      ...
      var o = a("Nxtp");
      a("YGE8");
      r.a.fn.fixDialogButtons = function () {
        return this.each(function () {
          const e = r()(this);
          const t = e.find(".button-container:last .btn, button[type=submit]");
          if (t.length) {
            e.find(".button-container:last, button[type=submit]").hide();
            let a = r.a.map(t.toArray(), (t) => {
              const a = r()(t);
              let n = a.attr("class") || "";
              const i = a.attr("id");
              if (a.is(".dialog_closer")) {
                a.off(".fixdialogbuttons");
                a.on(
                  "click.fixdialogbuttons",
                  Object(o["a"])(() => e.dialog("close"))
                );
              }
              "submit" === a.prop("type") &&
                a[0].form &&
                (n += " button_type_submit");
              return {
                text: a.text(),
                "data-text-while-loading": a.data("textWhileLoading"),
                click: () => a.click(),
                class: n,
                id: i,
              };
    ...
    fQ4S: function (e, t, a) {
      ...
      t["a"] = {
        fieldSelectors: null,
        findSiblingTinymce: function (e) {
          return e.siblings(".mce-tinymce").find(".mce-edit-area");
        },
        findField: function (e, t) {
          var a, n, i;
          null == t && (t = false);
          i =
            (null != (n = this.fieldSelectors) ? n[e] : void 0) ||
            "[name='" + e + "']";
          a = t ? r()(i) : this.$(i);
            ...
            s =
              ...
              function () {
                ...
                for (e = 0, t = n.length; e < t; e++) {
                  ...
                  r.push(
                    Object(o["a"])(
                      (null != (a = this.translations) ? a[l] : void 0) || l
                    )
                  );
                }
                return r;
                ...
                .call(this)
                .join("</p><p>");
            null != (u = a.errorBox(r.a.raw("" + s))) &&
              null != (c = u.css("z-index", "1100")) &&
              c.attr("role", "alert");
            this.attachErrorDescription(a, s);
            n.$input = a;
            d.push((n.$errorBox = a.data("associated_error_box")));
          }
          return d;
        },
        attachErrorDescription: function (e, t) {
          var a;
          a = this.findOrCreateDescriptionField(e);
          a["description"].text(r.a.raw("" + t));
          return e.attr(
            "aria-describedby",
            a["description"].attr("id") + " " + a["originalDescriptionIds"]
          );
        },
        findOrCreateDescriptionField: function (e) {
          var t, a, n;
          a = e.attr("id");
          r()("#" + a + "_sr_description").length > 0 ||
            r()("<div>")
              .attr({ id: a + "_sr_description", class: "screenreader-only" })
              .insertBefore(e);
          t = r()("#" + a + "_sr_description");
          n = this.getExistingDescriptionIds(e, a);
          return { description: t, originalDescriptionIds: n };
        },
        getExistingDescriptionIds: function (e, t) {
          var a, n;
          a = e.attr("aria-describedby");
          n = a ? a.split(" ") : [];
          return s.a.without(n, t + "_sr_description");
        },
      };
    },
    faZh: function (e, t, a) {
      ...
      var d = l.a.default;
      var h = d.template,
        g = (d.templates = d.templates || {});
      var p = "DialogFormWrapper";
      g[p] = h(function (e, t, a, n, r) {
        ...
        o +=
          ...
          u(
            ((i = a.t || (t && t.t)),
            (s = { hash: { scope: "dialog_form_wrapper" }, data: r }),
            i
              ? i.call(t, "cancel", "Cancel", s)
              : l.call(t, "t", "cancel", "Cancel", s))
          ) +
          ...
          u(
            ...
            (s = { hash: { scope: "dialog_form_wrapper" }, data: r }),
            i
              ? i.call(t, "saving", "Saving...", s)
              : l.call(t, "t", "saving", "Saving...", s))
          ) +
          '\'\n    type="submit"\n  >' +
          u(
            ((i = a.t || (t && t.t)),
            (s = { hash: { scope: "dialog_form_wrapper" }, data: r }),
            i
              ? i.call(t, "save_settings", "Save Settings", s)
              : l.call(t, "t", "save_settings", "Save Settings", s))
          ) +
          "</button>\n\n";
        return o;
      });
      ...
      var _,
        ...
        y = function (e, t) {
          for (var a in t) k.call(t, a) && (e[a] = t[a]);
          function n() {
            this.constructor = e;
          }
          n.prototype = t.prototype;
        ...
        k = {}.hasOwnProperty;
      m = !!(null != (_ = window.ENV) && null != (v = _.FEATURES)
        ? v.responsive_awareness
        : void 0);
      ...
      t["a"] = (function (e) {
        ...
        t.prototype.close = function () {
          var e, t;
          (null != (e = this.dialog) ? e.isOpen() : void 0) &&
            this.dialog.close();
          return null != (t = this.focusReturnsTo()) ? t.focus() : void 0;
        };
        t.prototype.toggle = function () {
          var e;
          return (null != (e = this.dialog) ? e.isOpen() : void 0)
            ? this.close()
            : this.open();
        };
        ...
        t.prototype.firstOpen = function () {
          this.insert();
          this.render();
          this.setupDialog();
          this.openAgain();
        ...
        t.prototype.openAgain = function () {
          this.dialog.open();
        ...
        t.prototype.setTrigger = function (e) {
          e && (this.options.trigger = e);
          if (!this.options.trigger) return;
          this.$trigger = r()(this.options.trigger);
          return this.attachTrigger();
        };
        t.prototype.attachTrigger = function () {
          var e;
          return null != (e = this.$trigger)
            ? e.on("click.dialogFormView", Object(s["a"])(this.toggle))
            : void 0;
        };
        t.prototype.renderEl = null;
        t.prototype.firstRenderEl = function () {
          this.$el.html(this.wrapperTemplate(this.toJSON()));
          this.renderElAgain();
          return (this.renderEl = this.renderElAgain);
        };
        t.prototype.renderElAgain = function () {
          var e;
          e = this.template(this.toJSON());
          return this.$el.find(".outlet").html(e);
        };
        t.prototype.getDialogTitle = function () {
          var e;
          return (
            this.options.title ||
            (null != (e = this.$trigger) ? e.attr("title") : void 0) ||
            this.getAriaTitle()
          );
        };
        t.prototype.getAriaTitle = function () {
          var e, t;
          e = null != (t = this.$trigger) ? t.attr("aria-describedby") : void 0;
          return r()("#" + e).text();
        };
        t.prototype.setupDialog = function () {
          var e;
          e = {
            autoOpen: false,
        ...
        t.prototype.onSaveSuccess = function () {
          t.__super__.onSaveSuccess.apply(this, arguments);
          return this.close();
        };
        t.prototype.focusReturnsTo = function () {
          var e;
          if (!this.$trigger) return null;
          return (e = this.$trigger.data("focusReturnsTo"))
            ? r()("#" + e)
            : this.$trigger;
        };
        return t;
    ...
    ppAs: function (e, t, a) {
      ...
      const d = {
        ...
        toMediaCommentLink(e) {
          const t = r()(
            `<a\n        id='media_comment_${Object(o["a"])(
              r()(e).data("media_comment_id")
            )}'\n        data-media_comment_type='${Object(o["a"])(
              r()(e).data("media_comment_type")
        ...
        convert(e, t = {}) {
          ...
          if (!t.forEditing) {
            ...
            a.find("img.equation_image").each((e, t) => {
              const a = r()(t);
    ...
    "tVj+": function (e, t, a) {
      ...
      r.a.fn.toJSON = function () {
        ...
        r.a.each(r()(this).serializeForm(), function () {
          if (!i.validate.test(this.name)) return;
          let t,
            n = this.name.match(i.key),
            o = this.value,
            l = this.name;
          while (void 0 !== (t = n.pop())) {
            l = l.replace(new RegExp("\\[" + t + "\\]$"), "");
            if (t.match(i.push)) o = s([], a(l), o);
            else if (t.match(i.fixed)) {
              a(l, t);
              o = s([], t, o);
            } else t.match(i.named) && (o = s({}, t, o));
          }
          e = r.a.extend(true, e, o);
        });
        return e;
      };
    },
...
//# sourceMappingURL=43-c-50e3bea253.js.map
