    ...
    wGhc: function (n, e, a) {
      ...
      _()(document).ready(function () {
        ...
        _()(".hide_reminders_link").click(function (n) {
          ...
          a.animate(
            { width: 20, height: 20, left: i.left, top: i.top - t, opacity: 0 },
            "slow",
            function () {
              _()(this).remove();
            }
        ...
        _()(".drop_held_context_link").click(function (n) {
          ...
          e.confirmDelete({
            ...
            message:
              ...
              e.find(".item_type").text() +
              "?",
            success(n) {
              _()(this).fadeOut("fast", function () {
                _()(this).remove();
                0 === _()("#floating_reminders .reminder").length &&
                  _()("#floating_reminders").fadeOut("fast", function () {
                    _()(this).remove();
      ...
      function v(n) {
        ...
        const t = _()(
          `<form method="post" action="${Object(l["a"])(e)}"></form>`
        );
        const o = `\n    <input name="_method" value="${Object(l["a"])(
          a
      ...
      _()(document).delegate(
        "a[data-confirm], a[data-method], a[data-remove]",
        "click",
        function (n) {
          const e = _()(this);
      ...
      function w(n, e, a) {
        let i;
        null == e &&
          (e = n.is(":ui-dialog:hidden") || "true" !== n.attr("aria-expanded"));
      ...
      const p = {
        bind() {
          _()(document).on(
            "click change keyclick",
            ".element_toggler[aria-controls]",
            function (n) {
              let e;
              const a = _()(this);
              ...
              const t = i.find(
                "#" + a.attr("aria-controls").replace(/\s/g, ", #")
              );
              t.length && w(t, e, a);
      ...
      const N = {
        buildMinimizerLink: () =>
          _()(
            `<a href="#" style="font-size: 0.8em;">\n      ${Object(l["a"])(
              M.t(
                "links.minimize_embedded_kaltura_content",
                "Minimize embedded content"
              )
            )}\n    </a>`
          ),
        buildCommentHolder: (n) =>
          _()(
        ...
        getMediaCommentId(n) {
          let e;
          let a =
            n.data("media_comment_id") ||
            n.find(".media_comment_id:first").text();
          a || (e = n.attr("id"));
      ...
      _()(document).on(
        ...
        Object(g["a"])(function () {
          if (!INST.kalturaSettings) {
            alert(
              M.t(
                "alerts.kaltura_disabled",
                "Kaltura has been disabled for this Canvas site"
              )
            );
            return;
          }
          ...
          n.after(i);
          n.hide();
          ("audio" === n.data("media_comment_type") ||
            n.is(".audio_playback, .audio_comment, .instructure_audio_link")) &&
            (e = "audio");
          i.children("div").mediaComment(
            "show_inline",
            a,
            e,
            n.data("download") || n.attr("href")
          );
      ...
      Object(u["a"])(
        JSON.parse(
          '{"ar":{"locked_image_24f37a16":"صورة مؤمّنة"},"ca":{"locked_image_24f37a16":"Imatge bloquejada"},"cy":{"locked_image_24f37a16":"Delwedd wedi’i chloi"},"da":{"locked_image_24f37a16":"Låst billede"},"da-x-k12":{"locked_image_24f37a16":"Låst billede"},"de":{"locked_image_24f37a16":"Gesperrtes Bild"},"en-AU":{"locked_image_24f37a16":"Locked image"},"en-AU-x-unimelb":{"locked_image_24f37a16":"Locked image"},"en-CA":{"locked_image_24f37a16":"Locked image"},"en-GB":{"locked_image_24f37a16":"Locked image"},"en-GB-x-lbs":{"locked_image_24f37a16":"Locked image"},"en-GB-x-ukhe":{"locked_image_24f37a16":"Locked image"},"es":{"locked_image_24f37a16":"Imagen bloqueada"},"fa":{"locked_image_24f37a16":"تصویر قفل شده"},"fi":{"locked_image_24f37a16":"Lukittu kuva"},"fr":{"locked_image_24f37a16":"Image verrouillée"},"fr-CA":{"locked_image_24f37a16":"Image verrouillée"},"ht":{"locked_image_24f37a16":"Imaj Bloke"},"is":{"locked_image_24f37a16":"Læst mynd"},"it":{"locked_image_24f37a16":"Immagine bloccata"},"ja":{"locked_image_24f37a16":"ロックされた画像"},"mi":{"locked_image_24f37a16":"Āhua kua rakaina"},"nb":{"locked_image_24f37a16":"Låst bilde"},"nb-x-k12":{"locked_image_24f37a16":"Låst bilde"},"nl":{"locked_image_24f37a16":"Vergrendelde afbeelding"},"nn":{"locked_image_24f37a16":"Låst bilde"},"pl":{"locked_image_24f37a16":"Zablokowany obraz"},"pt":{"locked_image_24f37a16":"Imagem bloqueada"},"pt-BR":{"locked_image_24f37a16":"Imagem bloqueada"},"ru":{"locked_image_24f37a16":"Заблокированное изображение"},"sl":{"locked_image_24f37a16":"Zaklenjena slika"},"sv":{"locked_image_24f37a16":"Låst bild"},"sv-x-k12":{"locked_image_24f37a16":"Låst bild"},"zh-Hans":{"locked_image_24f37a16":"锁定图片"},"zh-Hant":{"locked_image_24f37a16":"鎖定圖像"}}'
        )
      );
      ...
      function O(n) {
        _()(n).on("error", (n) => {
          n.currentTarget.src
            ? _.a.get(n.currentTarget.src).fail((e) => {
                403 === e.status
                  ? _()(n.currentTarget).attr({
      ...
      var I = a.n(B);
      function q() {
        document.querySelectorAll(".user_content").forEach((n) =>
      ...
      U && P.observe(U, { childList: true, subtree: true });
      I()(() => {
        q();
      });
      ENV.page_view_update_url && a.e(750).then(a.bind(null, "MOpQ"));
      _()("#skip_navigation_link").on(
        "click",
        Object(g["a"])(function () {
      ...
      function J() {
        ...
        if (n.length) {
          const e =
            _()("body").hasClass("course-menu-expanded") ||
            _()(document).width() >= R - 15
              ? 0
              : -1;
          n.attr("tabIndex", e);
        }
      ...
      _()("body").on("click", "#courseMenuToggle", () => {
        ...
        c();
        _()("#left-side").css({
          display: _()("body").hasClass("course-menu-expanded")
            ? "block"
            : "none",
        });
        J();
