(window["canvasWebpackJsonp"] = window["canvasWebpackJsonp"] || []).push([
  [68],
  {
    "+dCS": function (e, o, c) {
      ...
      class r {
        constructor(e) {
          this.minToolHeight = e || 450;
        }
        tool_content_wrapper(e) {
          let o = l()(`div[data-tool-wrapper-id*='${e}']`);
          o.length <= 0 &&
            1 === l()(".tool_content_wrapper").length &&
            (o = l()(".tool_content_wrapper"));
          return o;
        }
        resize_tool_content_wrapper(e, o) {
          let c = e;
          "number" !== typeof c && (c = this.minToolHeight);
          const t = o || this.tool_content_wrapper();
          t.height(!e || this.minToolHeight > c ? this.minToolHeight : c);
        }
      }
    },
    "0YqI": function (e, o, c) {
      "use strict";
      c.r(o);
      c.d(o, "whitelist", function () {
        return t;
      });
      c.d(o, "ignorelist", function () {
        return l;
      });
      const t = ["requestFullWindowLaunch", "lti.resourceImported"];
      const l = ["LtiDeepLinkingResponse"];
    },
    "4bdt": function (e, o, c) {
      "use strict";
      var t = c("pQTu");
      ...
      c("Z+Ib");
      var d = function (e, o) {
          for (var c in o) u.call(o, c) && (e[c] = o[c]);
          function t() {
            this.constructor = e;
          }
      ...
      var p = (function (e) {
        ...
        o.prototype.initialize = function () {
          ...
          return (this.unlockedText =
            this.unlockedText || r.t("Unlocked. Click to lock."));
        };
        o.prototype.setElement = function () {
          o.__super__.setElement.apply(this, arguments);
          return this.$el.attr("data-tooltip", "");
        };
        o.prototype.hover = function (e) {
          var o;
          o = e.type;
          if (this.disabled) return;
          if ("mouseenter" === o)
            return this.isLocked()
              ? this.renderWillUnlock()
              : this.renderWillLock();
          if ("mouseleave" === o)
            return this.isLocked()
              ? this.renderLocked()
        ...
        o.prototype.focusblur = function () {
          if (this.disabled) return;
        ...
        o.prototype.setFocusToElement = function () {
          return this.$el.focus();
        };
        o.prototype.lock = function (e) {
          this.renderLocking();
          return this.setLockState(true);
        };
        o.prototype.unlock = function (e) {
          this.renderUnlocking();
          return this.setLockState(false);
        };
        o.prototype.setLockState = function (e) {
          return a.a.ajaxJSON(
            "/api/v1/courses/" +
              this.course_id +
            ...
            ((o = this),
            function (c) {
              o.model.set("restricted_by_master_course", e);
        ...
        o.prototype.isMasterCourseMasterContent = function () {
          return !!this.model.get("is_master_course_master_content");
        };
        o.prototype.isMasterCourseChildContent = function () {
          return !!this.model.get("is_master_course_child_content");
        };
        o.prototype.isMasterCourseContent = function () {
          return (
            this.isMasterCourseMasterContent() ||
            this.isMasterCourseChildContent()
          );
        };
        ...
        o.prototype.closeTooltip = function () {
          return a()(".ui-tooltip").remove();
        };
        o.prototype.render = function () {
          if (!this.isMasterCourseContent()) return;
          this.$el.attr("role", "button");
          this.disabled || this.$el.attr("tabindex", "0");
          this.$el.html(
            '<i></i><span class="lock-text screenreader-only"></span>'
          );
          this.cacheEls();
          return this.isLocked() ? this.renderLocked() : this.renderUnlocked();
        };
        o.prototype.renderLocked = function () {
        ...
        o.prototype.renderWillUnlock = function () {
          return this.renderState({
            hint: r.t("Unlock"),
            label: this.lockedText,
        ...
        o.prototype.renderUnlocking = function () {
          return this.renderState({
            hint: r.t("Unlocking..."),
            buttonClass: this.lockedClass + " " + this.disabledClass,
            iconClass: "icon-blueprint-lock",
        ...
        o.prototype.renderUnlocked = function () {
          return this.renderState({
            hint: r.t("Unlocked"),
        ...
        o.prototype.renderWillLock = function () {
          return this.renderState({
            hint: r.t("Lock"),
            label: this.unlockedText,
            buttonClass: this.lockedClass + " " + this.disabledClass,
        ...
        o.prototype.renderLocking = function () {
          return this.renderState({
            hint: r.t("Locking..."),
            buttonClass: this.unlockedClass + " " + this.disabledClass,
            iconClass: "icon-blueprint",
        ...
        o.prototype.renderState = function (e) {
          ...
          this.disabled
            ...
            : this.$el.attr("aria-pressed", e.buttonClass === this.lockedClass);
      ...
      var k = function (e, o) {
          for (var c in o) b.call(o, c) && (e[c] = o[c]);
          function t() {
            this.constructor = e;
          }
          t.prototype = o.prototype;
      ...
      o["a"] = (function (e) {
        ...
        o.prototype.lockClass = "lock-icon-lock";
        ...
        o.prototype.initialize = function () {
          o.__super__.initialize.apply(this, arguments);
          return (this.events = Object.assign(
            {},
            p.prototype.events,
            this.events
          ));
    ...
    "9cv0": function (e, o, c) {
      var t = {
        "./__tests__/handleLtiPostMessages.test.js": ["Af1U", 747],
        "./__tests__/lti.resourceImported.test.js": ["yySz", 688],
        "./__tests__/requestFullWindowLaunch.test.js": ["w8Zi", 689],
        "./handleLtiPostMessage.js": ["y+46"],
        "./lti.resourceImported.js": ["75OS", 748],
        "./messageTypes.js": ["0YqI"],
        "./requestFullWindowLaunch.js": ["S3m7", 749],
      };
      function l(e) {
        if (!c.o(t, e))
        ...
        var o = t[e],
          l = o[0];
        return Promise.all(o.slice(1).map(c.e)).then(function () {
          return c(l);
        });
      }
      l.keys = function () {
    ...
    Doqt: function (e, o, c) {
      ...
      function a({
        tool: e,
        placement: o,
        acceptedResourceTypes: c,
        targetResourceType: r,
        allowItemSelection: a,
        selectableItems: _,
        onDismiss: s,
        open: i,
      }) {
        const d = {
          com_instructure_course_accept_canvas_resource_types: c,
          com_instructure_course_canvas_resource_type: r,
          com_instructure_course_allow_canvas_resource_selection: a,
          com_instructure_course_available_canvas_resources: _,
          display: "borderless",
          placement: o,
        };
        const u =
          -1 === (null === e || void 0 === e ? void 0 : e.base_url.indexOf("?"))
            ? "?"
            : "&";
        const p = `${
          null === e || void 0 === e ? void 0 : e.base_url
        }${u}${n.a.param(d)}`;
        const k = e ? e.title : "";
        return Object(t["a"])(
          l["a"],
    ...
    MdYG: function (e, o, c) {
      ...
      const n = {
        ...
        letter_grade: {
          get label() {
            return r.t("letter grade");
          },
          key: "letter_grade",
        },
        gpa_scale: {
          get label() {
            return r.t("GPA scale");
          },
          key: "gpa_scale",
        },
        other: {
      ...
      const u = (e) => {
        const o = e ? e.grading_type : a.percent.key;
        if ((o === a.letter_grade.key || o === a.gpa_scale.key) && !d(e))
          return a.percent.key;
        return o;
      };
      const p = (e, o) => {
        const c = u(o);
        return c === a.points.key
          ? f(e, o)
          : c === a.letter_grade.key || c === a.gpa_scale.key
          ? g(e, o)
          : h(e);
      };
      const k = (e, o, c) => {
      ...
      const b = (e, o) => {
        ...
        return c === a.points.key
          ? _.t("%{score} pts", {
              score: _.n(e, { precision: 2, strip_insignificant_zeros: true }),
            })
          : c === a.letter_grade.key || c === a.gpa_scale.key
          ? e
          : _.n(e, {
      ...
      const g = (e, o) => {
        ...
        for (const e in o.grading_scheme) {
          const l = s["a"].parse(o.grading_scheme[e]);
          if ((l <= c && l > t.score) || (0 === l && l > c)) {
            t.score = l;
            t.letter = e;
          }
        }
        return t.letter ? t.letter : c;
      };
      const h = (e) => {
        if (!i(e)) return e;
      ...
      const m = (e, o) => {
        if (
          "string" === typeof e &&
          o.grading_type !== a.letter_grade.key &&
          o.grading_type !== a.gpa_scale.key
        ) {
          const c = s["a"].parse(e.replace(/%$/, ""));
          if (!isNaN(c)) return b(c, o);
        }
        return e;
      };
    },
    uErj: function (e, o, c) {
      ...
      function d(e) {
        const o = document.getElementsByTagName("IFRAME");
        for (let c = 0; c < o.length; c += 1)
          if (o[c].contentWindow === e) return o[c];
        return null;
      }
      function u(e) {
        if (e.data.source && "react-devtools-bridge" === e.data.source) return;
        ...
        try {
          switch (o.subject) {
            case "lti.frameResize":
              ...
              c <= 0 && (c = 1);
              const a = t
                .tool_content_wrapper(o.token || e.origin)
            ...
            case "lti.fetchWindowSize": {
              ...
              if (c) {
                ...
                c.contentWindow.postMessage(e, "*");
              }
              break;
            }
            case "lti.showModuleNavigation":
              (true !== o.show && false !== o.show) ||
                l()(".module-sequence-footer").toggle(o.show);
              break;
            case "lti.scrollToTop":
              l()("html,body").animate(
                { scrollTop: l()(".tool_content_wrapper").offset().top },
                "fast"
              );
              break;
            case "lti.setUnloadMessage":
              s(Object(r["a"])(o.message));
              break;
            case "lti.removeUnloadMessage":
              i();
              break;
            case "lti.screenReaderAlert":
              l.a.screenReaderFlashMessageExclusive(
    ...
    veHt: function (e, o, c) {
      ...
      const _ = () => {
        const e =
          (ENV.CONDITIONAL_RELEASE_ENV &&
            ENV.CONDITIONAL_RELEASE_ENV.active_rules) ||
          [];
        return {
          triggerAssignments: e.reduce((e, o) => {
            e[o.trigger_assignment_id] = o;
            return e;
          }, {}),
          releasedAssignments: e.reduce((e, o) => {
            o.scoring_ranges.forEach((c) => {
              c.assignment_sets.forEach((t) => {
                t.assignment_set_associations.forEach((t) => {
                  const l = t.assignment_id;
                  e[l] = e[l] || [];
                  e[l].push({
                    assignment_id: o.trigger_assignment_id,
                    assignment: o.trigger_assignment_model,
      ...
      const u = (e) => {
        const o = s.releasedAssignments[e] || [];
        if (o.length > 1) return r.t("Multiple");
        if (o.length > 0) {
          const e = o[0];
          return r.t("%{upper} - %{lower}", {
            upper: Object(n["b"])(e.upper_bound, e.assignment, true),
            lower: Object(n["b"])(e.lower_bound, e.assignment, false),
          });
        }
        return null;
      };
    ...
    "y+46": function (e, o, c) {
      ...
      const r = async (e) => {
        ...
        if (!t["whitelist"].includes(l)) {
          console.error("invalid messageType: " + l);
          return false;
        }
        try {
          const e = await c("9cv0")(`./${l}.js`);
          n = e.default;
          n(r);
          return true;
        } catch (e) {
          console.error(
            `Error loading or executing message handler for "${l}"`,
            e
          );
        }
      };
...
//# sourceMappingURL=68-c-d7067aa4c8.js.map
