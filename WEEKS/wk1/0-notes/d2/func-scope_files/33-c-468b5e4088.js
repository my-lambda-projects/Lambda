    ...
    fuo4: function (t, e, i) {
      ...
      r.a.widget("ui.sortable", r.a.ui.mouse, {
        ...
        _mouseCapture: function (t, e) {
          ...
          r.a.data(t.target, i.widgetName + "-item") == i &&
            (s = r()(t.target));
          if (!s) return false;
          if (this.options.handle && !e) {
            var o = false;
            r()(this.options.handle, s)
              .find("*")
              .andSelf()
              .each(function () {
        ...
        _mouseStart: function (t, e, i) {
          ...
          if (s.cursor) {
            r()("body").css("cursor") &&
              (this._storedCursor = r()("body").css("cursor"));
          ...
          r.a.ui.ddmanager &&
            !s.dropBehaviour &&
            r.a.ui.ddmanager.prepareOffsets(this, t);
          this.dragging = true;
        ...
        _mouseDrag: function (t) {
          ...
          if (this.options.scroll) {
            ...
            if (
              ...
              t.pageY - r()(document).scrollTop() < e.scrollSensitivity
                ? (i = r()(document).scrollTop(
                    r()(document).scrollTop() - e.scrollSpeed
                  ))
                : r()(window).height() - (t.pageY - r()(document).scrollTop()) <
                    e.scrollSensitivity &&
                  (i = r()(document).scrollTop(
                    r()(document).scrollTop() + e.scrollSpeed
                  ));
              t.pageX - r()(document).scrollLeft() < e.scrollSensitivity
                ? (i = r()(document).scrollLeft(
                    r()(document).scrollLeft() - e.scrollSpeed
                  ))
                : r()(window).width() - (t.pageX - r()(document).scrollLeft()) <
                    e.scrollSensitivity &&
                  (i = r()(document).scrollLeft(
                    r()(document).scrollLeft() + e.scrollSpeed
                  ));
          ...
          for (var s = this.items.length - 1; s >= 0; s--) {
            ...
            if (
              ...
              this.placeholder[1 == h ? "next" : "prev"]()[0] != n &&
              !r.a.contains(this.placeholder[0], n) &&
              ("semi-dynamic" != this.options.type ||
                !r.a.contains(this.element[0], n))
            ) {
        ...
        cancel: function () {
          ...
          if (this.placeholder) {
            ...
            this.domPosition.prev
              ? r()(this.domPosition.prev).after(this.currentItem)
              : r()(this.domPosition.parent).prepend(this.currentItem);
          }
          return this;
        },
        serialize: function (t) {
          ...
          t = t || {};
          r()(e).each(function () {
            var e = (r()(t.item || this).attr(t.attribute || "id") || "").match(
              t.expression || /(.+)[-=_](.+)/
            );
            e &&
              i.push(
        ...
        _intersectsWith: function (t) {
          ...
          return "pointer" == this.options.tolerance ||
            ...
            : o < e + this.helperProportions.width / 2 &&
                ...
                r - this.helperProportions.height / 2 < a;
        },
        ...
        _getItemsAsjQuery: function (t) {
            ...
            for (var o = s.length - 1; o >= 0; o--) {
              ...
              for (var h = n.length - 1; h >= 0; h--) {
                ...
                a &&
                  ...
                  !a.options.disabled &&
                  i.push([
                    r.a.isFunction(a.options.items)
                      ? a.options.items.call(a.element)
                      : r()(a.options.items, a.element)
          ...
          i.push([
            r.a.isFunction(this.options.items)
              ? this.options.items.call(this.element, null, {
                  options: this.options,
                  item: this.currentItem,
                })
              : r()(this.options.items, this.element)
                  .not(".ui-sortable-helper")
                  .not(".ui-sortable-placeholder"),
            this,
          ]);
        ...
        refreshPositions: function (t) {
          ...
          for (var e = this.items.length - 1; e >= 0; e--) {
            ...
            var s = this.options.toleranceElement
              ? r()(this.options.toleranceElement, i.item)
              : i.item;
            if (!t) {
        ...
        _createPlaceholder: function (t) {
          ...
          if (!e.placeholder || e.placeholder.constructor == String) {
            ...
            e.placeholder = {
              element: function () {
                var e = r()(document.createElement(t.currentItem[0].nodeName))
                  .addClass(
          ...
          t.placeholder = r()(
            e.placeholder.element.call(t.element, t.currentItem)
          );
        ...
        _contactContainers: function (t) {
          ...
          for (var s = this.containers.length - 1; s >= 0; s--) {
            if (
              r.a.contains(this.currentItem[0], this.containers[s].element[0])
            )
              continue;
            if (this._intersectsWith(this.containers[s].containerCache)) {
              if (
                e &&
                r.a.contains(this.containers[s].element[0], e.element[0])
              )
                continue;
              e = this.containers[s];
              i = s;
          ...
          if (1 === this.containers.length) {
            ...
            n
              ? this._rearrange(t, n, null, true)
              : this._rearrange(t, null, this.containers[i].element, true);
            this._trigger("change", t, this._uiHash());
        ...
        _createHelper: function (t) {
          var e = this.options;
          var i = r.a.isFunction(e.helper)
            ? r()(e.helper.apply(this.element[0], [t, this.currentItem]))
            : "clone" == e.helper
        ...
        _getParentOffset: function () {
          ...
          if (
            ...
            this.scrollParent[0] != document &&
            r.a.contains(this.scrollParent[0], this.offsetParent[0])
          ) {
        ...
        _setContainment: function () {
          ...
          ("document" != t.containment && "window" != t.containment) ||
            (this.containment = [
              ...
              r()("document" == t.containment ? document : window).width() -
                this.helperProportions.width -
                this.margins.left,
              (r()("document" == t.containment ? document : window).height() ||
          ...
          if (!/^(document|window|parent)$/.test(t.containment)) {
            ...
            this.containment = [
              i.left +
                (parseInt(r()(e).css("borderLeftWidth"), 10) || 0) +
                (parseInt(r()(e).css("paddingLeft"), 10) || 0) -
                this.margins.left,
              i.top +
                (parseInt(r()(e).css("borderTopWidth"), 10) || 0) +
                (parseInt(r()(e).css("paddingTop"), 10) || 0) -
                this.margins.top,
              i.left +
                (s ? Math.max(e.scrollWidth, e.offsetWidth) : e.offsetWidth) -
                (parseInt(r()(e).css("borderLeftWidth"), 10) || 0) -
                (parseInt(r()(e).css("paddingRight"), 10) || 0) -
                this.helperProportions.width -
                this.margins.left,
              i.top +
                (s
                  ...
                  : e.offsetHeight) -
                (parseInt(r()(e).css("borderTopWidth"), 10) || 0) -
                (parseInt(r()(e).css("paddingBottom"), 10) || 0) -
                this.helperProportions.height -
                this.margins.top,
            ];
          }
        ...
        _generatePosition: function (t) {
          ...
          if (this.originalPosition) {
            ...
            if (e.grid) {
              var h =
                this.originalPageY +
                Math.round((n - this.originalPageY) / e.grid[1]) * e.grid[1];
              n =
                this.containment &&
              ...
              var a =
                this.originalPageX +
                Math.round((o - this.originalPageX) / e.grid[0]) * e.grid[0];
              o =
                this.containment &&
        ...
        _trigger: function () {
          false === r.a.Widget.prototype._trigger.apply(this, arguments) &&
            this.cancel();
        },
        _uiHash: function (t) {
          var e = t || this;
