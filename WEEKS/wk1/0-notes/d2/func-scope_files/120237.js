...
!(function (e) {
  ...
  i.p = "//static.hsappstatic.net/cookie-banner/static-1.943/";
  i((i.s = 3));
})([
  function (e, t) {
    e.exports =
  ...
  function (e, t, i) {
    ...
    var ee,
      ...
      se = 2,
      ce = 3,
      de = ($((ee = {}), re, "analytics"), $(ee, se, oe), $(ee, ce, ae), ee),
      le = (function () {
        function e(t, i, n) {
          I(this, e);
          this.allowed = t;
      ...
      he = "hs-modal-accept-all",
      ge = "hs-modal-save-settings",
      pe = "hs-modal",
      ue = "hs-modal-close-button",
      me = "hs-modal-introduction",
      ye = "hs-category-necessary",
      ve = "hs-category-analytics",
      fe = "hs-category-toggle-analytics",
      be = "hs-category-advertisement",
      ke = "hs-category-toggle-advertisement",
      xe = "hs-category-functionality",
      we = "hs-category-toggle-functionality",
      Ce = function (e, t) {
    ...
    function Ee(e, t) {
      ...
      e.stagedAnalytics && e.stagedAdvertisement && e.stagedFunctionality
        ? b(i, De)
        : k(i, De);
    }
    function ze(e, t) {
    ...
    function Be(e) {
      ...
      if (e.privacySettings.testing) {
        ...
        e.cookie.set(F, t.toCookieString(), { daysToExpire: V, path: "/" });
    ...
    function Pe(e, t, i) {
      ...
      for (var a = [], r = 0; r < n.length; r++) a.push(n[r].id);
      ...
      function g(e, t, n) {
        1 === n && e === t - 1
          ? i.getElementById(a[0]).click()
          : -1 === n && 0 === e
          ? i.getElementById(a[t - 1]).click()
          : i.getElementById(a[e + n]).click();
      }
      function p(e) {
        var t = e.keyCode,
    ...
    var We = (function () {
        ...
        D(e, [
          {
            ...
            value: function () {
              return (
                null !== this.banner.context.getDocument().getElementById(pe)
              );
            },
          },
          {
            ...
            value: function (e) {
              if (e && e.categories) {
                ...
                this.stagedCategories.stagedAdvertisement =
                  e.categories.advertisement;
                this.stagedCategories.stagedFunctionality =
              ...
              if ("isDisabled" !== a.className) {
                ...
                if (!e.testing) {
                  if (e.mode === E)
                    ...
                    i.cookie.set(R, "no", { daysToExpire: X, path: "/" });
                    i.cookie.set(W, "true", { daysToExpire: J, path: "/" });
                  }
            ...
            ? l(a, "click", function (t) {
                ...
                if (!e.testing) {
                  if (e.mode === E)
                    ...
                    i.cookie.set(R, "yes", { daysToExpire: X, path: "/" });
                    i.cookie.remove(W);
                  }
        ...
        D(e, [
          {
            ...
            value: function () {
              return (
                null !==
                this.privacyBanner.context.getDocument().getElementById(Re)
              );
            },
          },
          {
            ...
            value: function () {
              ...
              if (!Je(e) && !this.hasRendered()) {
                var a = "",
                  r = G.a;
                if (i && n) {
                  r = /^#[0-9A-Fa-f]{3,6}$/.test(i)
                    ? P.a.replace(/#425b76/g, i)
                    : P.a;
          ...
          },
          {
            ...
            value: function () {
              ...
              if (!i || t) {
                ...
                this.privacyBanner.setPrivacyConsent(
                  le.buildFromCookieString(i)
                );
            },
          },
        ]);
        ...
        D(e, null, [
          {
            ...
            value: function (e, t) {
              if (t.active) {
                var i = e.get(_).split(".");
                if (
                  !(1 === i.length && i[0].length > 0) &&
                  !(6 !== i.length || !i[1].length > 0)
                ) {
                  var n = i[2];
                  if (!(n < et || n > tt)) {
                    e.remove(_);
        ...
        if (n) {
          ...
          o.onreadystatechange = function () {
            if (this.readyState === XMLHttpRequest.DONE)
              if (200 !== o.status) {
                u(
                  "Geolocation request failed, status - " +
                    o.status +
                    ", response - " +
                    o.response
                );
          ...
          u(
            "Missing apiBaseUrl from the banner. Failed to request for geolocation."
          );
      },
      at = {
        DomainPathGeo: 6,
      ...
      rt = function (e, t, i, n) {
        if (!(e.enabled || t)) return at.noMatch;
        var o =
            e.targetedCountries &&
                  ...
                  if (this.privacySettings.testing) {
                    ...
                    switch (i) {
                      ...
                      default:
                        u(
                          new Error(
                            "Unsupported policy mode passed to the opt-in handler."
                          )
                        );
                        return;
                    }
      ...
      yt = function (e, t) {
        if (e) {
          ...
          i.onreadystatechange = function () {
            i.readyState === XMLHttpRequest.DONE &&
              (200 === i.status || 204 === i.status
                ? m("successfully sent reporting activity")
                : u(
                    "error sending reporting activity request status: " +
                      i.status
                  ));
          };
          ...
          u(
            "Missing apiBaseUrl from the banner. Failed to send activity event."
          );
      },
      vt = function (e, t) {
        yt(e ? "" + e + ut : null, t);
        ...
        D(e, [
          {
            ...
            value: function (e, t) {
              ...
              t && !n && this.hasEnabledFeatureGate(gt)
                ? ot(
                    this.apiBaseUrl,
                    function (e) {
                      i.visitorCountry = e;
                ...
                if (0 !== e.length) {
                  for (
                    var t,
                      i,
                      n =
                        this.context.getLocation().hash.indexOf(s) > -1 ||
                        this.context.getLocation().search.indexOf(s) > -1,
                      o = at.noMatch,
                      a = 0;
                    a < e.length;
                    a++
                    ...
                    var r = e[a],
                      c = r.enabled || n;
                    if (r.privacyDefault && c) t = new lt(r, n);
                    else {
                      var d = new lt(r, n),
                  ...
                  if (h) {
                    ...
                    switch (h.mode) {
                      ...
                      case N:
                        ...
                        return;
                      case E:
                        this.cookiesByCategoryHandler = new $e(
                          this,
                          this.privacySettings
                        );
          ...
          },
          {
            ...
            value: function () {
              if (
                this.privacySettings &&
                "DISABLED" !== this.privacySettings.mode
              )
                try {
          ...
          },
          {
            ...
            value: function (e) {
              this.privacySettings &&
                this.safeCallListener(e, this.privacySettings);
          ...
          },
          {
            ...
            value: function (e) {
              ...
              this.privacyConsent =
                e instanceof le ? e.getSafeCopy() : new le(e);
          ...
          },
          {
            key: "getHsq",
            value: function () {
              return (this.context.getWindow()[r] =
          ...
          },
          {
            ...
            value: function () {
              for (var e = 0; e < K.length; e++) this.cookie.remove(K[e]);
              this.setPrivacyConsent(!1);
            ...
            value: function () {
              if (this.hasEnabledFeatureGate(ht)) {
                var e = this.privacyConsent && this.privacyConsent.allowed,
                  t =
                    this.privacyConsent &&
                    this.privacyConsent.categories.analytics,
                  i =
                    this.privacyConsent &&
                    this.privacyConsent.categories.advertisement,
                  n =
                    this.privacyConsent &&
                    this.privacyConsent.categories.functionality,
                ...
                if (
                  ...
                  m(
                    "The banner is in test mode, no reporting event will be sent."
                  );
                  m("We would have sent the following click activity");
                  m(o);
                } else vt(this.apiBaseUrl, o);
              } else
        ...
        D(e, [
          ...
          },
          {
            ...
            value: function (e, t, i) {
              ...
              (i = i || {}).minsToExpire
                ? (n = new Date()).setTime(
                    n.getTime() + 1e3 * i.minsToExpire * 60
                  )
                : i.daysToExpire
                ? (n = new Date()).setTime(
