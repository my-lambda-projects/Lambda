!(function (t) {
  ...
  1036: function (t, e) {
    t.exports = (function () {
      ...
      function e(t) {
        ...
        null == t && (t = {}),
          (this.displayStatus =
            ((e = this.displayStatus),
            (n = this),
            function () {
              return e.apply(n, arguments);
            })),
          (this.config = t),
          t.urls && (this.statusUrl = t.urls.status),
          (this.status = t.status),
          (this.progress = Math.round(100 * t.progress)),
          (this.poller = null);
      }
      return (
        5e3,
        (t = { FAILED: -1, QUEUED: 0, PROCESSING: 1, READY: 2 }),
        ...
        (e.prototype.run = function () {
          return (
            this.displayStatus(this.status, this.progress),
        ...
        (e.prototype.onQueued = function (t) {
          var e;
          return "function" == typeof (e = this.config).onQueued
            ? e.onQueued()
            : void 0;
        }),
        (e.prototype.onProcessing = function (t) {
          var e;
          return "function" == typeof (e = this.config).onProcessing
            ? e.onProcessing(t)
            : void 0;
        }),
        (e.prototype.onReady = function () {
          var t;
          return "function" == typeof (t = this.config).onReady
            ? t.onReady()
            : void 0;
        }),
        (e.prototype.onFailed = function () {
          var t;
          return "function" == typeof (t = this.config).onFailed
            ? t.onFailed()
            : void 0;
        }),
          ...
          return $.ajax({
            ...
            success:
              ...
              function (e) {
                return (
                  (t.status = e.status),
                  (t.progress = Math.round(100 * e.progress)),
                  t.displayStatus(t.status, t.progress)
                );
              }),
            error: (function (t) {
              return function (e) {
  ...
  1158: function (t, e) {
    window.NameAndDescription = Backbone.Model.extend({
      defaults: { name: "", description: "", canUpdate: !1 },
      sync: function (t, e, n) {
  ...
  1159: function (t, e) {
    window.NameAndDescriptionView = Backbone.View.extend({
      initialize: function () {
        return (
          (this.$editHint = this.$(".edit-hint")),
          (this.$title = this.$("#title")),
          (this.$titleText = this.$("#title h1")),
          (this.$titleEditor = this.$("#title .editor")),
          (this.$showMoreButton = this.$(".show_more_button")),
          (this.$editor = this.$("textarea.editor")),
          (this.$descriptionBody = this.$(".body")),
          (this.$contents = this.$(".body .description_wrapper")),
          (this.$formatLink = this.$(".format-link")),
          (this.$arrow = this.$(".options .arrow")),
          (this.$formatHelp = this.$(".how_to_format")),
          (this.$footer = this.$(".description-footer")),
          (this.$controls = this.$(".controls")),
          (this.$save = this.$(".controls .save")),
          (this.$cancel = this.$(".controls .reset")),
          (this.mode = this.options.mode || "display"),
          this.setPlaceholder(),
          this.render()
        );
      },
      render: function () {
        return this.model.canUpdate
          ? ("editable" === this.mode
              ? this.showEditable()
              : "display" === this.mode
              ? (this.showNonEditable(), this.hideEditHint())
              : this.showNonEditable(),
            this.shouldTruncate()
              ? void 0
              : this.$contents.removeClass("is-truncated"))
          : this.shouldTruncate()
          ? (this.$showMoreButton
              .text("Show more")
              .removeClass("is-inverted")
              .show(),
            this.$contents.addClass("is-truncated"))
      ...
      showEditHint: function () {
        if ("display" === this.mode)
          return this.$contents.addClass("hover"), this.$editHint.show();
      },
      hideEditHintOnChannelActionHover: function () {
        var t;
        return (t = $("#channel_action")).length && t.is(":hover")
          ? this.hideEditHint()
          : this.showEditHint();
      },
      toggleDescription: function () {
        return this.$contents.hasClass("is-truncated")
          ? (this.$contents.removeClass("is-truncated"),
            this.$showMoreButton.text("Show less").addClass("is-inverted"))
          : (this.$contents.addClass("is-truncated"),
            this.$showMoreButton.text("Show more").removeClass("is-inverted"));
      },
      hideEditHint: function () {
        if ("display" === this.mode)
          return this.$contents.removeClass("hover"), this.$editHint.hide();
      },
      toggleTopCTAs: function () {
        var t, e, n;
        if (
          ((n = $(".se-upload-media")) && n.toggle(),
          (t = $("#channel_action")) && t.toggle(),
          (e = $(".se-embed-share")))
        )
          return e.toggle();
      },
      ...
      showEditable: function () {
        return (
          ...
          (this.mode = "editable"),
          (this.$beforeEditVal = this.$editor.val()),
          (this.$beforeTitleEditVal = this.$titleEditor.val()),
      ...
      showNonEditable: function () {
        return (
          (this.mode = "display"),
          this.unHighlightSave(),
          this.$descriptionBody.show(),
          this.$titleText.show(),
          this.$controls.show(),
          this.shouldTruncate()
            ? (this.$showMoreButton
          ...
          this.$cancel.show(),
          this.$save.hide(),
          this.emptyDescription() && this.$contents.html(""),
          this.showEditHint(),
          !1
        );
      },
      ...
      toggleEditable: function () {
        return this.$footer.is(":hidden")
          ? this.showEditable()
          : this.showNonEditable();
      },
      setPlaceholder: function () {
        return (
          this.$editor.attr("placeholder", "Add a description"),
          this.$titleEditor.attr("placeholder", "Add a title")
        );
      },
      save: function () {
        var t;
          ...
          this.model.save(
            ...
            },
            {
              ...
              success:
                ...
                function (e) {
                  return (
                    e.attributes.markdown_description
                      ? (t.$contents.html(e.attributes.description),
                        t.$editor.val(e.attributes.markdown_description))
                      : (t.$contents.html(""), t.$editor.val("")),
                    e.attributes.name
                      ? t.$titleText.html(e.attributes.name)
                      : t.$titleText.html(""),
                    t.showNonEditable(),
                    t.model.save({ description: e.attributes.description }),
                    t.$el.trigger("saved"),
                    t.toggleTopCTAs(),
                    t.toggleProjectLabels()
                  );
                }),
              error: (function (t) {
                return function () {
                  return (
                    statusBar.error(
                      "Failed to save the title and description."
                    ),
                    t.toggleTopCTAs(),
                    t.toggleProjectLabels()
                  );
      ...
      cancel: function () {
        return (
          this.$editor.val(this.$beforeEditVal),
          this.$titleEditor.val(this.$beforeTitleEditVal),
          this.showNonEditable(),
          this.toggleTopCTAs(),
          this.toggleProjectLabels(),
          !1
      ...
      hideFormatHelp: function () {
        return (
          this.$footer.animate({ backgroundColor: "transparent" }, 100),
          this.$save.removeClass("dark"),
          this.$cancel.removeClass("dark"),
          this.$formatHelp.slideUp(
            200,
            "easeInSine",
            ((t = this),
            function () {
      ...
      showFormatHelp: function () {
        return (
          this.$formatHelp.slideDown(400, "easeOutSine"),
          this.$footer.css("background-color", "#f1efeb"),
          this.$save.addClass("dark"),
          this.$cancel.addClass("dark"),
  ...
  1160: function (t, e) {
    ...
    Wistia,
      (t.exports = window.ReplaceVideoStatusBar =
        (function (t) {
          function e(t) {
            var n;
              ...
              this.$messagesEl.on(
                ...
                function (t) {
                  ...
                  return (
                    ...
                    t.stopPropagation(),
                    null != n.options.onCancel
                      ? "function" == typeof (e = n.options).onCancel
                        ? e.onCancel()
                        : void 0
                      : "function" == typeof n.onCancel
                      ? n.onCancel()
                      : void 0
                  );
                })
          ...
          return (
                ...
                this._add(
                  $(
                    "<div class='status-bar__message'>" +
                      t +
                      "<div class='status-bar__remove-button'></div></div>"
                  ),
                  e
                ),
                this
            ...
            (e.prototype.progressing = function (t, e) {
              ...
              if (
                (null == e && (e = {}),
                !(this.$messagesEl.find("#replace-media-progress").length > 0))
              )
                return (
                  (e = _.extend(e, {
                    life: 0,
                  ...
                  (n =
                    "<div id='replace-media-progress'> <div class='progress__bar progress__bar--replace-video-status'> <div class='progress__text'></div> </div> </div> <div class='status-bar__message'> <div  class='progress progress--replace-video-status'> <div class='progress__static-message'>" +
                    t +
                    "</div> <div class='status-bar__cancel-button'>Cancel</div> </div> </div>"),
                  this._add($(n), e),
                  (this.progress = new ProgressBar("replace-media-progress", {
                    percent: e.percent,
                  }))
                );
            }),
            (e.prototype.update_progress = function (t, e) {
              return (
                void 0 !== this.progress && this.progress.update(t),
                this.$messagesEl.find(".progress__static-message").text(e)
              );
            }),
            (e.prototype.showRemoveButton = function () {
              var t;
              if ((t = this.$messagesEl.find("status-bar__cancel-button")))
                return t
                  .addClass(".status-bar__remove-button")
                  .removeClass("status-bar__cancel-button")
                  .text("");
            }),
            e
          );
  ...
  1676: function (t, e, n) {
    n(1158),
      ...
      n(1677),
      n(1678),
      (window.MediaStatusPoller = n(1036)),
      (window.ReplaceVideoStatusBar = n(1160)),
      (window.ReplaceVideoStatusPoller = n(1679)),
      (window.ReplaceVideoUploader = n(1680)),
      (window.Cookies = n(879));
  },
  1677: function (t, e) {
    window.Prompt = (function () {
      function t(t, e, n, r) {
        (this.promptClass = t),
          (this.promptFlag = n),
          (this.extraoverlayClass = r),
          (this.$prompt = $(this.promptClass)),
          0 !== this.$prompt.length &&
            ((this.reportClosePath =
              "/medias/" +
              WistiaContext.media.hashedId +
              "/customizations/save_prompt_flag"),
            this.createOverlay(),
            this.buildPrompt(e),
            this.setupBindings(),
            this.animateOpen());
      ...
      return (
        (t.prototype.createOverlay = function () {
          if (0 === $(".prompt__overlay").length)
            return $("body").append(
              "<div class='prompt__overlay " +
                this.extraoverlayClass +
                "'></div>"
            );
        }),
        ...
        (t.prototype.setupBindings = function () {
          return (
            $("body").on(
              "click",
              this.promptClass + " .prompt__overlay",
              function () {
                return !1;
              }
            ),
            $("body").on(
              "click",
              this.promptClass + " .prompt__close",
              ((t = this),
              function () {
                return (
                  t.close(),
                  $.post(t.reportClosePath, { prompt_flag: t.promptFlag })
                );
              })
            )
          );
        ...
        (t.prototype.animateOpen = function () {
          return (
            $(".prompt__overlay").height($(document).height()),
            $(".prompt__overlay").fadeIn(
              150,
              ((t = this),
              function () {
        ...
        (t.prototype.close = function () {
          return (
            this.$prompt.hide().remove(),
            $(".prompt__overlay").remove().fadeOut("slow")
          );
        }),
        t
      );
  ...
  1678: function (t, e) {
    ...
    (n = NameAndDescription.extend({
      ...
      canUpdateMedia &&
        ...
        theMediaEmbed.bind("play", r),
        theMediaEmbed.bind("pause", o).bind("end", o)),
      $("#media_controls a.comment").click(function () {
        return (
          $.scrollTo(ta, 500, function () {
      ...
      Wistia,
      $.getJSON(
        "/medias/" + WistiaContext.media.hashedId + "/previous.json",
        function (t) {
          var e;
          if (null != t && null != (e = t.media) ? e.hashed_id : void 0)
            return $.hotkey("k", function () {
              return (location.href = "/medias/" + t.media.hashed_id);
            });
        }
      ),
      $.getJSON(
        "/medias/" + WistiaContext.media.hashedId + "/next.json",
        function (t) {
          var e;
          if (null != t && null != (e = t.media) ? e.hashed_id : void 0)
            return $.hotkey("j", function () {
              return (location.href = "/medias/" + t.media.hashed_id);
            });
        }
      ),
      ...
      _wq.push({
        ...
        onEmbedded: function (t) {
          var e;
          if ("notplayable" === t.playerType)
            return (
              "function" == typeof (e = t._impl).allFailed
                ? e.allFailed(t._mediaData)
                : void 0
            )
              ? statusBar.error(
                  "Encoding failed. Before trying again, check out our Help Center for <a href='https://wistia.com/support/troubleshooting/video-encoding-troubleshooting#unable-to-process' style='color:#fff;' target='_blank'>troubleshooting encoding failures</a>.",
                  { life: -1 }
                )
              : t.bind("processingcomplete", function () {
                  return (
                    setTimeout(function () {
                      return (
                        t.ready(function () {
                          return t.addPlugin("encodingProgress", { on: !0 });
                        }),
                        t.unbind
                      );
                    }, 3e3),
        ...
        onHasData: function (t) {
          ...
          return (
            ...
            $(document).on(
              "click",
              ".rebuild-with-encoding-progress",
              function (e) {
                var n;
                return (
                  e.preventDefault(),
                  (null != (n = t.plugin.encodingProgress)
                    ? n.totalProgress
                    : void 0) >= 1
                    ? t._impl._refreshDataFromServer(function () {
                        return t.fullRebuild();
                      })
                    : t.fullRebuild({
                        plugin: { encodingProgress: { on: !0 } },
                      })
                );
              }
            ),
            (n = function () {
              return (
                0 === statusBar.liveMessageCount() &&
                  statusBar.info("", { id: "encoding-progress", life: -1 }),
                i.eventLoop.add("update-encoding-progress", 2e3, function () {
                  return t.plugin("encodingProgress", function (t) {
                    if (
                      (statusBar.replaceContents(
                        "encoding-progress",
                        "Encoding: " +
                          t.progressSummaryString() +
                          '. <a href="#" class="rebuild-with-encoding-progress" style="color:#fff;">Refresh the video</a>.'
                      ),
                      t.totalProgress() >= 1)
                    )
                      return (
                        statusBar.replaceContents(
                          "encoding-progress",
                          'The video has finished encoding. <a href="#"  class="rebuild-with-encoding-progress" style="color:#fff;">Reload to see the latest</a>.'
                        ),
                        t.stopPolling(),
                        i.eventLoop.remove("update-encoding-progress")
                      );
                  });
                })
              );
  ...
  1679: function (t, e) {
    t.exports = (function () {
      ...
      return (
        (t = wJQuery),
        (n.instance = null),
        "This media is currently queued for replacement.",
        "This media is being replaced (#{}% encoded). The old version will continue to display until this is complete.",
        "Encoding failed. Before trying again, check out our Help Center for <a href='https://wistia.com/support/troubleshooting/upload-troubleshooting'>upload troubleshooting</a>.",
        "Success! All embedded instances now reflect this new version.",
        "Success! All embedded instances now reflect this new version and a copy of the old version has been saved in this project.",
        null,
        (e = null),
        (n.start = function (t) {
          var n;
          null == t && (t = {}),
            null == this.instance && (this.instance = new MediaStatusPoller(t)),
            (this.instance.onQueued =
              ((n = this),
              function (t) {
            ...
            (this.instance.onReady = (function (t) {
              return function () {
                return t._showReady();
              };
            })(this)),
            (this.instance.onFailed = (function (t) {
              return function () {
                return t._showFailed();
              };
            })(this)),
            (this.cancel_url = t.urls.cancel),
            this._initStatusBar(),
            (e = t.replacementMethod);
          try {
            this.instance.start();
          } catch (t) {
        ...
        (n.cancelReplacement = function () {
          return (
            n.instance.stop(),
            statusBar.update_progress(0, "Cancelling replacement..."),
            t.ajax({
              url: n.cancel_url,
              success: function (t) {
                return (
                  statusBar.update_progress(0, t.message),
                  statusBar.showRemoveButton(),
                  n.instance.stop(),
                  setTimeout(function () {
          ...
          return this.instance.isReady()
            ? ((t =
                "swap" === e
                  ? "Success! All embedded instances now reflect this new version and a copy of the old version has been saved in this project."
                  : "Success! All embedded instances now reflect this new version."),
              Cookies.set("replacement_message", t),
              location.href.indexOf("media_finished") > -1
                ? void 0
                : location.replace(location.href + "?media_finished"))
            : console.log("Replacement media not ready");
        }),
        (n._getProcessingMessage = function (t) {
          return (
            null == t && (t = 0),
            "This media is being replaced (#{}% encoded). The old version will continue to display until this is complete.".replace(
              "#{}",
              t.toString()
            )
          );
        ...
        (n._showQueued = function () {
          return this.statusBar.progressing(
            "This media is currently queued for replacement."
          );
        }),
        (n._showProcessing = function (t) {
          ...
          return (
            (e = t),
            100 === t && ((e = 99), n.statusBar.showRemoveButton()),
            n.statusBar.progressing(n._getProcessingMessage(e), { percent: e }),
    ...
    (r = n(1681).default),
      ...
      (t.exports = (function () {
        ...
        return (
          ...
          "replace_video_upload_button",
          (e = (function () {
            function e() {}
            return (
              (e.prototype.start = function () {
                return (
                  (this.$form = t("#upload_form")),
                  (this.uploader = this._makeUploader()),
                  (this.progressBar = new ProgressBar("replacement_progress")),
              ...
              (e.prototype._attachEventHandlers = function () {
                var e;
                return (
                  t("#replacement_cancel button").on(
                    "click",
                    ((e = this),
                    function () {
              ...
              (e.prototype._makeUploader = function () {
                return this._fetchUploaderJs().then(
                  ((t = this),
                  function () {
                    return (
                      (t.uploader = new r("replace_video_upload_button")),
                      (t.embeddableUploader = t.uploader.uploader),
                      t.embeddableUploader.bind("uploadstart", function (e) {
                        if ((t._showUploadProgress(), t._swapIsSelected))
                          return t._showSwapInfo;
                      }),
                      t.embeddableUploader.bind(
                        "uploadprogress",
                        function (e, n) {
                          var r;
                          return (
                            (r = Math.round(100 * n)),
                            t.progressBar.update(r, r + "%")
                          );
                        }
                      ),
                      t.embeddableUploader.bind(
              ...
              (e.prototype._wapiqIsActive = function () {
                return new Promise(function (t) {
                  return (
                    (window._wapiq = window._wapiq || []), window._wapiq.push(t)
                  );
                });
              }),
              (e.prototype._fetchUploaderJs = function () {
                return Wistia.Uploader
                  ...
                  : Promise.all([
                      this._wapiqIsActive(),
                      o.runScript(
                        "https://fast.wistia.net/assets/external/api.js"
                      ),
                    ]);
              }),
              (e.prototype._cancelUpload = function () {
                return (
                  this.embeddableUploader.cancel(),
              ...
              (e.prototype._replaceVideo = function (e) {
                ...
                return (
                  ...
                  (n =
                    (n = this._swapIsSelected()
                      ? this._swapRedirectUrl()
                      : this._overwriteRedirectUrl()) +
                    "&media[bakery_hashed_id]=" +
                    e),
                  this._oldInternetExplorerDetected() &&
                    (n += "&is_simple_upload=true"),
                  t.ajax({
                    url: n,
                    method: "get",
                    success: function (e) {
                      return (
                        Cookies.set("queued_for_replacement", i),
                        t.facebox.close(),
                    ...
                    error: function (e) {
                      return (
                        statusBar.error("An error occurred after uploading."),
                        t.facebox.close()
                      );
                    },
                  })
              ...
              (e.prototype._hideAllElements = function () {
                return (
                  t(".close").hide(),
                  t("#replace-video > div").each(function (e, n) {
                    return t(n).hide();
                  })
                );
              }),
              (e.prototype._showUploadForm = function () {
                return (
                  ...
                  t(".close").show(),
                  t("#modal_title").text("Replace Media"),
                  this.$form[0].reset(),
                  t("#replace-video > #upload").show()
                );
              }),
              (e.prototype._showUploadProgress = function () {
                return (
                  this._hideAllElements(),
                  t("#modal_title").text("Uploading replacement..."),
                  this._oldInternetExplorerDetected() &&
                    t("#replacement_progress").hide(),
                  t("#uploading_replacement").show()
                );
              }),
              (e.prototype._showUploadFailed = function () {
                return (
                  this._hideAllElements(),
                  t("#modal_title").text("Upload failed"),
                  t("#upload_failed").show()
                );
              }),
              ...
              (e.prototype._replacementMethod = function () {
                var t;
                return null != (t = this._swapIsSelected)
                  ? t
                  : { swap: "overwrite" };
              }),
  ...
  1681: function (t, e, n) {
    ...
    e.default = function t(e) {
      ...
      o()(this, t),
        (this.elem = e),
        (this.options = n),
        (this.uploader = new Wistia.Uploader(
          i.assign(
            {
              button: this.elem,
              customButton: !0,
              ...
              projectId:
                WistiaContext.granary.creds.additional_auth_params.project_id,
            },
            n
          )
        ));
  ...
  277: function (t, e, n) {
    ...
    t.exports = function (t, e, n, d, h, v) {
      ...
      if (x && !m)
        return (
          v || (v = new r()),
          g || l(t) ? o(t, e, n, d, h, v) : i(t, e, b, n, d, h, v)
        );
      if (!(1 & n)) {
  ...
  324: function (t, e, n) {
    ...
    t.exports = function (t, e, n) {
      ...
      return f || ++c != l
        ? f
        : !!(l = null == t ? 0 : t.length) && u(l) && s(p, l) && (i(t) || o(t));
    };
  },
  325: function (t, e, n) {
    var r = n(369),
    ...
    var r = n(3),
        ...
        if (A(n)) {
          for (var a in n)
            if (n.hasOwnProperty(a) && (e.hasOwnProperty(a) || null == e[a])) {
              var f = n[a];
              P(f)
                ? (P(e[a]) || (e[a] = []), t(e[a], f, r), (e[a] = r(e[a])))
                : A(f)
                ? (A(e[a]) || (e[a] = {}), t(e[a], f, r), (e[a] = r(e[a])))
                : null == e
                ? ((e = {}), o(n, a, f) || (e[a] = r(f)))
                : o(n, a, f)
                ? delete e[a]
      ...
      p = function (t, e, n) {
        ...
        for (var r, o = t; null != t && e.length; ) {
          var i = e.shift();
          (void 0 !== t[i] && (A(t[i]) || P(t[i]))) ||
            !n ||
            (0 === i ? ((t = o[r] = [])[i] = {}) : (t[i] = {})),
            (o = t),
            (r = i),
            (t = t.hasOwnProperty(i) ? t[i] : void 0);
        }
        return t;
      },
      d = function (t, e, n) {
      ...
      x = function (t, e) {
        for (
          var n = [], r = "function" == typeof e, o = r ? e : null, i = 0;
          i < t.length;
          i++
        ) {
          var s = t[i];
    ...
    t.exports = function (t, e, n) {
      ...
      t: for (; ++c < f; ) {
        ...
        if (((g = n || 0 !== g ? g : 0), p && _ == _)) {
          for (var b = h.length; b--; ) if (h[b] === _) continue t;
          e && h.push(_), d.push(g);
  ...
  417: function (t, e, n) {
    ...
    t.exports = function (t, e) {
      return function (n, o) {
        ...
        if (!r(n)) return t(n, o);
        for (
          var i = n.length, s = e ? i : -1, u = Object(n);
          (e ? s-- : ++s < i) && !1 !== o(u[s], s, u);
          ...
          return (function e(n) {
            function r(e, o, i) {
              ...
              if (arguments.length > 1) {
                ...
                return (
                  (o = (o = encodeURIComponent(String(o))).replace(
              ...
              for (
                ...
                if (
                  ...
                  (d = (n && n(d, p)) || d.replace(c, decodeURIComponent)),
                  this.json)
                )
                  try {
                    d = JSON.parse(d);
