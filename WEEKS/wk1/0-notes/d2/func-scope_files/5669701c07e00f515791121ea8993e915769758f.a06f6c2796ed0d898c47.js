  ...
  [29],
  {
    ...
    "3TIX": function (t, e, n) {
      ...
      var r = "FLUSH_FILE_WRITES",
        ...
        I = "LANGUAGE_SERVER_DIED",
        N = "REGISTER_MONACO_EDITOR_HANDLE",
        T = "REGISTER_ACE_EDITOR_HANDLE",
        A = "SELECT_EDITOR_RANGE",
        P = "INSTALL_PACKAGES",
        R = "@@INIT",
        M = "RUN_REPL",
        D = function (t) {
    ...
    "8axe": function (t, e, n) {
      ...
      function S(t, e, n) {
        if (/\n\s*$/.test(e)) n(!1);
          ...
          switch (p.a.get(t).key.toLowerCase()) {
            case "html":
              n(j(e));
              break;
            case "haskell":
      ...
      function C(t) {
        ...
        var h = Object(y.b)(e, r, "console"),
          ...
          T = c.useCallback(
            function () {
              d(Object(u.I)({ wid: e, pud: r }));
            },
            [d, e, r]
          ),
          A = c.useCallback(
            function (t) {
              d({ type: "SET_PROMPT_VALUE", wid: e, pud: r, promptValue: t });
            },
            [d, e, r]
          ),
          P = c.useCallback(
    ...
    Zma6: function (t, e, n) {
      ...
      function g(t) {
        ...
        p.useEffect(
          function () {
            if (i.getConnectionState() !== v.a.CONNECTED)
              return i.onConnectionStateChanged(function (t) {
                t === v.a.CONNECTED && M(i.getVncUrl());
              });
            M(i.getVncUrl());
          },
          [i]
        );
        var D = p.useState(null),
          V = Object(s.a)(D, 2),
          W = V[0],
          U = V[1],
          F = p.useRef(function () {
            ...
            function () {
              if (R && N && O) {
                ...
                return (
                  ...
                  u.addEventListener("disconnect", p),
                  u.addEventListener("securityfailure", f),
                  (F.current = function () {
                  ...
                  function () {
                    (t = !0),
                      ...
                      u.disconnect(),
                      u.removeEventListener("securityfailure", f),
                      u.removeEventListener("connect", l),
                      u.removeEventListener("disconnect", p);
                  }
                );
              }
            },
