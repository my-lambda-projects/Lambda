(window["canvasWebpackJsonp"] = window["canvasWebpackJsonp"] || []).push([
  [388],
  {
    vwFW: function (e, t, i) {
      ...
      var n = i("ouhR");
      var s = i.n(n);
      s()(".question select").bind("mousewheel", (e) => e.preventDefault());
    },
    vzpB: function (e, t, i) {
      "use strict";
      i.r(t);
      ...
      r()(document).ready(() => {
        ...
        r()(".quiz_response_text img").each(function () {
          r()(this)
            .css({
              borderColor: "#f44",
              borderStyle: "solid",
        ...
        r()(".quiz_response_text iframe").each(function () {
          r()(this)
            .css({
              borderColor: "#f44",
              borderStyle: "solid",
        ...
        const e = r()("nothing");
        r()(".quiz_response_text")
          .find("object,embed")
          .each(function () {
            return e.add(r()(this).parents("object,embed:first"));
          });
        return e.each(function () {
          const e = r()("<span/>").css("display", "inline-block");
          e.before(r()(this));
          e.append(r()(this));
          return e
            .css({
...
//# sourceMappingURL=quiz_submission-c-fd65fad7ca.js.map
