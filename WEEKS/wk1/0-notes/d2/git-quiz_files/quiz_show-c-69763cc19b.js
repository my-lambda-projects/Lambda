  ...
  [574],
  {
    "1Lgu": function (e, s, n) {
      ...
      function u() {
        const e = l();
        g(
          0 == e.find("#body").val().length ||
            0 == e.find(".student:not(.blank):visible").length
        );
      }
      window.messageStudents = function (e) {
        const s = l();
        c = e;
        s.find(".message_types").empty();
        for (let n = 0, t = e.options.length; n < t; n++) {
          const t = d()("<option/>");
          const a = e.options[n];
          t.val(n).text(a.text);
          s.find(".message_types").append(t);
        }
        const n = e.title,
          t = s.find("ul li.blank:first"),
          a = s.find("ul"),
          i = {};
        s.find("ul li:not(.blank)").remove();
        const o = e.students.slice();
        o.sort(r["a"].byKey("sortableName"));
        for (let e = 0; e < o.length; e++) {
          const s = o[e];
          const n = t.clone(true).removeClass("blank");
          n.find(".name").text(s.name);
          n.find(".score").text(s.score);
          const r = _.t("Remove %{student} from recipients", {
            student: s.name,
          });
          const c = n.find(".remove-button");
          c.attr("title", r).append(
            d()("<span class='screenreader-only'></span>").text(r)
          );
          c.click(function (e) {
            e.preventDefault();
            ...
            n.length
              ? d()("button", n).focus()
              : d()("#message_assignment_recipients #subject").focus();
          });
          n.data("id", s.id);
          n.user_data = s;
          a.append(n.show());
        ...
        a.show();
        const m = _.t("Message Students for %{course_name}", {
          course_name: n,
        });
        ...
        s.dialog({
          ...
          close: (e, n) => {
            s.closest(".ui-dialog").removeAttr("role").removeAttr("aria-label");
          },
        })
          .dialog("open")
          .dialog("option", "title", m)
          .on("dialogclose", e.onClose);
      };
      d()(document).ready(() => {
        const e = l();
        e.find("button").click((e) => {
          const s = d()(e.target);
        ...
        d()("#message_assignment_recipients").formSubmit({
          processData(e) {
            const s = [];
            d()(this)
              .find(".student:visible")
              .each(function () {
                s.push(d()(this).data("id"));
              });
          ...
          beforeSubmit(e) {
            m(true);
            d()(this).find(".send_button").text(_.t("Sending Message..."));
          },
          success(e) {
            d.a.flashMessage(_.t("Message sent!"));
            m(false);
            d()(this).find(".send_button").text(_.t("Send Message"));
            d()("#message_students_dialog").dialog("close");
          },
          error(e) {
            m(false);
            d()(this)
              .find(".send_button")
              .text(_.t("Sending Message Failed, please try again"));
          },
        });
        const s = function () {
          const s = parseInt(e.find("select").val(), 10) || 0;
          const n = c.options[s];
          const t = e.data("students_hash");
          let a = o["a"].parse(e.find(".cutoff_score").val());
          isNaN(a) && (a = null);
          const _ = Object.values(t);
          let i = [];
          t &&
            (n && n.callback
              ? (i = n.callback.call(window.messageStudents, a, _))
              : c.callback &&
                (i = c.callback.call(window.messageStudents, n.text, a, _)));
          c.subjectCallback &&
            e.find("[name=subject]").val(c.subjectCallback(n.text, a));
          e.find(".cutoff_holder").showIf(n.cutoff);
          e.find(".student_list").toggleClass(
            "show_score",
            !!(n.cutoff || n.score)
          );
          m(0 === i.length);
        ...
        e.find(".cutoff_score")
          .bind("change blur keyup", s)
          .bind("change blur keyup", u);
        e.find("#body").bind("change blur keyup", u);
      });

      function m(e, s) {
        null == s && (s = l().find("button"));
        s.toggleClass("disabled", e).attr("aria-disabled", e);
      }

      function g(e) {
        m(e, l().find(".send_button"));
      }

      function l() {
        return d()("#message_students_dialog");
      }
      s["a"] = messageStudents;
    },
    lkPJ: function (e, s, n) {
      ...
      const _ = {
        ...
        setWidths(e) {
          a()(e || ".answer input[type=text]").each(function () {
            a()(this).width(9.5 * a()(this).val().length);
          });
        },
      };
      s["a"] = _;
    ...
    wWL5: function (e, s, n) {
      ...
      a()(document).ready(function () {
        ENV.QUIZ_SUBMISSION_EVENTS_URL && Object(l["a"])(true);
        a()("#preview_quiz_button").click((e) => {
          a()("#js-sequential-warning-dialogue div a").attr(
            "href",
            a()("#preview_quiz_button").attr("href")
          );
        });

        function e(e) {
          return a()("#quiz_details").length
            ? e()
            : a.a.get(ENV.QUIZ_DETAILS_URL, (s) => {
                a()("#quiz_details_wrapper").html(s);
                e();
              });
        }
        const s = new u["a"]();
        s.applyArrows();
        if (!a()(".allow-inputs").length) {
          _["a"].disableInputs("[type=radio], [type=checkbox]");
          _["a"].setWidths();
        }
        a()("form.edit_quizzes_quiz").on("submit", function (e) {
          e.preventDefault();
          ...
          a.a.ajax({
            ...
            type: "POST",
            success() {
              a()(".edit_quizzes_quiz").parents(".alert").hide();
            },
          });
        });
        a()(".delete_quiz_link").click(function (e) {
          e.preventDefault();
          let s = d["a"].t(
          ...
          const n = parseInt(
            a()("#quiz_details_wrapper").data("submitted-count")
          );
          n > 0 &&
            (s +=
              "\n\n" +
        ...
        let n = false;
        a()(".quiz_details_link").click((s) => {
          s.preventDefault();
          a()("#quiz_details_wrapper").disableWhileLoading(
            e(() => {
              const e = a()("#quiz_details_text");
              a()("#quiz_details").slideToggle();
              n
                ? ENV.IS_SURVEY
                  ? e.text(
                      d["a"].t(
                        "links.show_student_survey_results",
                        "Show Student Survey Results"
                      )
                    )
                  : e.text(
                      d["a"].t(
                        "links.show_student_quiz_results",
                ...
                ? e.text(
                    d["a"].t(
                      "links.hide_student_survey_results",
                      "Hide Student Survey Results"
                    )
                  )
                : e.text(
                    d["a"].t(
                      "links.hide_student_quiz_results",
        ...
        a()(".message_students_link").click((s) => {
          s.preventDefault();
          e(() => {
            const e = ENV.QUIZ_SUBMISSION_LIST;
        ...
        a()(".direct-share-send-to-menu-item").click(t);
        ...
        a()(".direct-share-copy-to-menu-item").click(r);
        a()("#let_students_take_this_quiz_button").ifExists(function (e) {
          const s = a()("#unlock_for_how_long_dialog");
          e.click(() => {
            s.dialog("open");
            return false;
          });
        ...
        a()("#lock_this_quiz_now_link").ifExists((e) => {
          e.click((e) => {
            e.preventDefault();
            a()("#quiz_lock_form").submit();
          });
        });
        a()("ul.page-action-list").find("li").length > 0 &&
          a()("ul.page-action-list").show();
        a()("#publish_quiz_form").formSubmit({
          beforeSubmit(e) {
            a()(this)
              .find("button")
              .attr("disabled", true)
              .text(d["a"].t("buttons.publishing", "Publishing..."));
          },
          success(e) {
            a()(this)
              .find("button")
              .text(d["a"].t("buttons.already_published", "Published!"));
            location.reload();
          },
        });
        const h = a()("#quiz-publish-link");
        const k = new m["a"](
          a.a.extend(ENV.QUIZ, {
            unpublishable: !h.hasClass("disabled"),
          })
        );
        const y = new g["a"]({
          model: k,
        ...
        const j = document.getElementById("not_right_side");
        f["default"].init(w, j);
        a()("#assignment_external_tools").length &&
          p["a"].attach(
            a()("#assignment_external_tools")[0],
            "assignment_view",
      ...
      a()(() => {
        _["a"].setWidths();
        a()(".answer input[type=text]").each(function () {
          a()(this).width(9.5 * (a()(this).val().length || 11));
        });
        a()(".download_submissions_link").click(function (e) {
          e.preventDefault();
          INST.downloadSubmissions(a()(this).attr("href"));
        });
        if (ENV.SUBMISSION_VERSIONS_URL && !ENV.IS_SURVEY) {
          const e = a()("#quiz-submission-version-table");
          e.css({
            height: "100px",
          });
          const s = a.a.get(ENV.SUBMISSION_VERSIONS_URL, (s) => {
            e.html(s);
            e.css({
              height: "auto",
            });
          });
          e.disableWhileLoading(s);
        }
        a()("#module_sequence_footer").moduleSequenceFooter({
    ...
    ysUD: function (e, s, n) {
      ...
      function k(e) {
        ...
        return {
          ...
          focusBorderColor: s.borderBrand,
      ...
      var z =
        ...
        y(
          (S =
              ...
              (function (e) {
                ...
                function n() {
                  ...
                  for (
                    ...
                    a[i] = arguments[i];
                  e = s.call.apply(s, [this].concat(a));
                  e.handleElementRef = function (s) {
                    e.props.elementRef(s);
                  };
                  e.contentRef = function (s) {
                    e._content = s;
                  };
                  return e;
                }
                Object(i["a"])(n, [
                  {
                    ...
                    value: function () {
                      this.props.fullscreen && p.a.on();
                    },
                  },
                  {
                    key: "componentWillUnmount",
                    value: function () {
                      this.props.fullscreen && p.a.off();
                    },
                  },
                  {
                    key: "render",
                    value: function () {
                      var e;
                      var s = Object(v["a"])(this.props.children, {
                        ref: this.contentRef,
                      });
                      var _ = l()(
                        ((e = {}),
                        Object(a["a"])(e, E.root, true),
                        Object(a["a"])(e, E[this.props.placement], true),
                        Object(a["a"])(e, E.fullscreen, this.props.fullscreen),
                        e)
                      );
                      var i = Object(t["a"])(
                        {},
                        Object(h["a"])(this.props, n.propTypes),
                        {
                          className: _,
                      ...
                      return c.a.createElement("span", i, s);
                    },
                  },
                ]);
                n.displayName = "Mask";
            ...
            (w.propTypes = {
              onDismiss: m.a.func,
              placement: m.a.oneOf(["top", "center", "bottom", "stretch"]),
              fullscreen: m.a.bool,
              children: m.a.node,
              onClick: m.a.func,
              elementRef: m.a.func,
...
//# sourceMappingURL=quiz_show-c-69763cc19b.js.map
