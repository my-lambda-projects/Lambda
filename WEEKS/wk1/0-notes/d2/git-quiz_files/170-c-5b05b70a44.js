(window["canvasWebpackJsonp"] = window["canvasWebpackJsonp"] || []).push([
  [170],
  {
    RMh6: function (e, n, s) {
      ...
      var o = a.a.default;
      var i = o.template,
        _ = (o.templates = o.templates || {});
      var r = "EmptyDialogFormWrapper";
      _[r] = i(function (e, n, s, t, a) {
    ...
    VS9R: function (e, n, s) {
      ...
      var p = d.a.default;
      var g = p.template,
        l = (p.templates = p.templates || {});
      var u = "-messageStudentsWhoRecipientList";
      l[u] = g(function (e, n, s, t, a) {
        this.compilerInfo = [4, ">= 1.0.0"];
        s = this.merge(s, e.helpers);
        a = a || {};
        var o,
        ...
        o = s.each.call(n, n && n.recipients, {
          hash: {},
          inverse: c.noop,
          fn: c.program(1, d, a),
          data: a,
      ...
      var h = d.a.default;
      var b = h.template,
        v = (h.templates = h.templates || {});
      var y = "messageStudentsDialog";
      v[y] = b(function (e, n, s, t, a) {
        this.compilerInfo = [4, ">= 1.0.0"];
        s = this.merge(s, e.helpers);
        ...
        function l(e, n) {
          ...
          t +=
            ...
            d(
              ((s =
                ((s =
                  ((s = e && e.recipientGroups),
                  null == s || false === s ? s : s[0])),
                null == s || false === s ? s : s.name)),
              typeof s === c ? s.apply(e) : s)
            ) +
        ...
        function u(e, n) {
          ...
          t = s.each.call(e, e && e.recipientGroups, {
            hash: {},
            inverse: p.noop,
            fn: p.program(4, m, n),
            data: n,
        ...
        r +=
          ...
          d(
            ...
            i
              ? i.call(n, "recipients_a69b5e55", "Recipients:", _)
              : g.call(n, "t", "recipients_a69b5e55", "Recipients:", _))
          ) +
          "\n    </label>\n\n    ";
        o =
          ((i = s.ifEqual || (n && n.ifEqual)),
          (_ = {
            hash: {},
            inverse: p.program(3, u, a),
            fn: p.program(1, l, a),
            data: a,
          }),
          i
            ? i.call(
                n,
                ((o = n && n.recipientGroups),
                null == o || false === o ? o : o.length),
                1,
                _
              )
            : g.call(
        ...
        o = p.invokePartial(
          t.messageStudentsWhoRecipientList,
          "messageStudentsWhoRecipientList",
          n,
          s,
          t,
        ...
        r +=
          ...
          d(
            ...
            i
              ? i.call(n, "sending_bf324366", "Sending...", _)
              : g.call(n, "t", "sending_bf324366", "Sending...", _))
          ) +
          "'>\n    " +
          d(
            ((i = s.t || (n && n.t)),
            ...
            i
              ? i.call(n, "cancel_caeb1e68", "Cancel", _)
              : g.call(n, "t", "cancel_caeb1e68", "Cancel", _))
          ) +
          ...
          d(
            ...
            i
              ? i.call(n, "sent_f4ee89ec", "Sent!", _)
              : g.call(n, "t", "sent_f4ee89ec", "Sent!", _))
          ) +
          "'>\n    " +
          d(
            ((i = s.t || (n && n.t)),
            ...
            i
              ? i.call(n, "send_message_6ccc90e8", "Send Message", _)
              : g.call(n, "t", "send_message_6ccc90e8", "Send Message", _))
          ) +
          "\n  </button>\n\n</div>\n";
        return r;
      });
      f["a"].loadStylesheet("jst/messageStudentsDialog", {
        combinedChecksum: "71cf06c9a8",
      ...
      var j = (function (e) {
        ...
        t.prototype.url = "/api/v1/conversations";
        n = E.t("cannot_be_empty", "Message cannot be blank");
        s = E.t(
        ...
        t.prototype.validate = function (e, t) {
          var a;
          a = {};
          (e.body && _.a.trim(e.body.toString())) ||
            (a.body = [
              {
                message: n,
              },
            ]);
          (e.recipients && e.recipients.length) ||
            (a.recipients = [
              {
                message: s,
              },
      ...
      var A = (function () {
        ...
        e.prototype.save = function (e, n) {
          ...
          s = M.a.chunk(e.recipients, this.chunkSize).map(function (s) {
            var t;
            t = Object.assign({}, e, {
              recipients: s,
            });
            return new j().save(t, n);
          });
          return _.a.when.apply(_.a, s);
        };
        e.prototype.validate = function (e, n) {
          return new j().validate(e, n);
        };
        return e;
      })();
      var z = s("GLiE");
      ...
      var B = function (e, n) {
        ...
        D = function (e, n) {
          for (var s in n) V.call(n, s) && (e[s] = n[s]);
      ...
      n["a"] = (function (e) {
        ...
        function n() {
          this.updateListOfRecipients = B(this.updateListOfRecipients, this);
          this.getFormData = B(this.getFormData, this);
          this._findRecipientGroupByName = B(
            this._findRecipientGroupByName,
            this
          );
          this.validateBeforeSave = B(this.validateBeforeSave, this);
          this.toJSON = B(this.toJSON, this);
          return n.__super__.constructor.apply(this, arguments);
        }
        n.optionProperty("recipientGroups");
        ...
        n.prototype.events = R.a.extend({}, r["a"].prototype.events, {
        ...
        n.prototype.initialize = function (e) {
          ...
          this.options.title = this.context
            ? o.t("Message students for %{context}", {
                context: this.context,
              })
            : o.t("Message students");
        ...
        n.prototype.validateBeforeSave = function (e, n) {
          var s;
          s = this.model.validate(e);
          if (s) {
            s.body && (n.body = s.body);
            s.recipients && (n.recipientGroupName = s.recipients);
          }
          return n;
        };
        n.prototype._findRecipientGroupByName = function (e) {
          return R.a.detect(this.recipientGroups, function (n) {
            return n.name === e;
          });
        };
        n.prototype.getFormData = function () {
          ...
          return {
            body: e,
            recipients: R.a.pluck(s, "id"),
          };
        };
        n.prototype.updateListOfRecipients = function () {
          var e, n;
        ...
        n.prototype.onSaveSuccess = function () {
          this.close();
          return _.a.flashMessage(o.t("Message Sent!"));
        };
        n.prototype.close = function () {
          n.__super__.close.apply(this, arguments);
          this.hideErrors();
          return this.remove();
        };
        return n;
    ...
    yE80: function (e, n, s) {
      ...
      n["a"] = {
        strings(e, n) {
          let s = t["default"].locale || "en-US";
          const a = {
            zh_Hant: "zh-Hant",
          };
          s = a[s] || s;
          return e.localeCompare(n, s, {
            sensitivity: "variant",
        ...
        by(e) {
          return (n, s) => this.strings(e(n), e(s));
        },
        byKey(e) {
          return this.by((n) => n[e]);
        },
        byGet(e) {
          return this.by((n) => n.get(e));
        },
      };
    },
  },
...
//# sourceMappingURL=170-c-5b05b70a44.js.map
