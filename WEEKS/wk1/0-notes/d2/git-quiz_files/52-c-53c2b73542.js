  ...
  [ 52 ], {
    "13m+": function ( e, t, o ) {
      ...
      u.migrationChange = i( {
        ...
        asset_type: r( [ "assignment", "quiz", "discussion_topic", "wiki_page", "attachment", "context_module", "learning_outcome", "learning_outcome_group", "announcement", "rubric", "syllabus" ] ).isRequired,
    ...
    lubD: function ( e, t, o ) {
      ...
      const i = {
        ...
        getAssociations( {
          ...
          return this._depaginate( `/api/v1/courses/${e.id}/blueprint_templates/default/associated_courses?${t}` )
        },
        saveAssociations: ( {
          masterCourse: e,
          addedAssociations: t,
          removedAssociations: o
        } ) => c[ "a" ].put( `/api/v1/courses/${e.id}/blueprint_templates/default/update_associations`, {
          course_ids_to_add: t.map( e => e.id ),
          course_ids_to_remove: o.map( e => e.id )
        } ),
        getMigrations: ( {
          masterCourse: e
        } ) => c[ "a" ].get( `/api/v1/courses/${e.id}/blueprint_templates/default/migrations` ),
        beginMigration( {
          masterCourse: e,
          ...
          return c[ "a" ].post( `/api/v1/courses/${e.id}/blueprint_templates/default/migrations`, n )
        },
        checkMigration( e ) {
        ...
        getMigrationDetails: ( {
          ...
          templateId: o = "default",
          changeId: l
        } ) => c[ "a" ].get( `/api/v1/courses/${e.id}/${t}/${o}/migrations/${l}/details` ),
        getFullMigration( {
          course: e
        }, t ) {
        ...
        getSyncHistory( {
          ...
          return this.getMigrations( {
            ...
            data: t
          } ) => Promise.all( t.slice( 0, 5 ).map( t => this.getMigrationDetails( {
            course: e
          }, {
            changeId: t.id
        ...
        toggleLocked: ( {
          ...
          itemId: o,
          isLocked: l
        } ) => c[ "a" ].put( `/api/v1/courses/${e}/blueprint_templates/default/restrict_item`, {
          content_type: t,
          content_id: o,
          restricted: l
        } ),
        loadUnsyncedChanges: ( {
          masterCourse: e
        } ) => c[ "a" ].get( `/api/v1/courses/${e.id}/blueprint_templates/default/unsynced_changes` )
      }
      t[ "a" ] = i
    },
    pREb: function ( e, t, o ) {
    ...
    tsv7: function ( e, t, o ) {
      ...
      const k = e => t => window.matchMedia ? Object( c[ "a" ] )( _[ "a" ], {
        match: "media",
        query: r,
        render: ( o, c ) => a.a.createElement( e, Object.assign( {
          breakpoints: s( c )
        }, t ) )
    ...
    v0Tn: function ( e, t, o ) {
      ...
      const i = {
        statesList: a,
        states: a.reduce( ( e, t ) => Object.assign( e, {
          [ t ]: t
        } ), {} )
      }
    ...
    y8OA: function ( e, t, o ) {
      ...
      class C extends s[ "Component" ] {
        ...
        componentDidUpdate( e ) {
          this.props.isLocked && !e.isLocked && r.a.screenReaderFlashMessage( h.t( "%{attributes} locked", {
            attributes: Object( v[ "a" ] )( this.props.itemLocks )
          } ) )
        }
        render() {
          if ( this.props.isLocked ) return Object( c[ "a" ] )( m[ "a" ], {}, void 0, Object( c[ "a" ] )( L[ "a" ], {
            weight: "bold",
            size: "small"
          }, void 0, h.t( "Locked:" ), " " ), Object( c[ "a" ] )( L[ "a" ], {
            size: "small"
          }, void 0, Object( v[ "a" ] )( this.props.itemLocks ) ) )
          return null
        }
      }
      C.defaultProps = {
      ...
      class M extends s[ "Component" ] {
        ...
        constructor( e ) {
          super( e )
          this.onEnter = () => {
            this.props.isToggleable && this.setState( {
              mode: this.props.isLocked ? I.ADMIN_WILLUNLOCK : I.ADMIN_WILLLOCK
            } )
          }
          this.onExit = () => {
            this.props.isToggleable && this.setState( {
          ...
          e.isToggleable ? this.state.mode = e.isLocked ? I.ADMIN_LOCKED : I.ADMIN_UNLOCKED : this.state.mode = e.isLocked ? I.TEACH_LOCKED : I.TEACH_UNLOCKED
        }
        componentDidMount() {
          const e = Math.max( ...Object.values( I ).map( e => e.label.length ) )
          this.toggleBtnRef && ( this.toggleBtnRef.style.width = .845 * e + "em" )
        }
        render() {
          var e, t, o, l
          const a = this.state.mode.icon
          const i = Object( c[ "a" ] )( "span", {
            className: "bpc-lock-toggle__label"
          }, void 0, this.state.mode.label || "-" )
          let n = null
          if ( this.props.isToggleable ) {
            ...
            n = Object( c[ "a" ] )( j[ "a" ], {
              ...
              variant: "inverse",
              on: [ "hover", "focus" ]
            }, void 0, this.props.breakpoints.miniTablet ? Object( c[ "a" ] )( O[ "a" ], {
              id: "lock-toggle-btn",
            ...
            }, void 0, e || ( e = Object( c[ "a" ] )( a, {} ) ), t || ( t = Object( c[ "a" ] )( E[ "a" ], {}, void 0, i ) ), o || ( o = Object( c[ "a" ] )( B[ "a" ], {}, void 0, s ) ) ) : Object( c[ "a" ] )( q[ "a" ], {
              ...
              "aria-pressed": this.props.isLocked,
              screenReaderLabel: s
            }, void 0, l || ( l = Object( c[ "a" ] )( a, {} ) ) ) )
          } else n = Object( c[ "a" ] )( "span", {
            className: "bpc__lock-no__toggle"
          }, void 0, Object( c[ "a" ] )( "span", {
            className: "bpc__lock-no__toggle-icon"
          }, void 0, Object( c[ "a" ] )( a, {} ) ), Object( c[ "a" ] )( L[ "a" ], {
            size: "small"
          }, void 0, i ) )
          return Object( c[ "a" ] )( "span", {
      ...
      class x {
        ...
        setupToggle( e ) {
          ...
          this.toggleNode ? e() : y.setupRootNode( this.props.toggleWrapperSelector, this.props.toggleWrapperChildIndex || 0, t => {
            this.toggleNode = t
            e()
          } )
        }
        renderLockToggle() {
          if ( !this.props.toggleWrapperSelector ) return
          this.setupToggle( () => {
            u.a.render( Object( c[ "a" ] )( y, {
              isLocked: this.state.isLocked,
              isToggleable: "show" === this.props.page && this.state.isMasterContent,
