                ...
                T(
                  (C =
                    ...
                    (N.propTypes = {
                      ...
                      as: c.a.elementType,
                      on: c.a.oneOfType([
                        c.a.oneOf(["click", "hover", "focus"]),
                        c.a.arrayOf(c.a.oneOf(["click", "hover", "focus"])),
                      ]),
      ...
      class f extends _.a.Component {
        constructor(e) {
          ...
          this.handleAlertFocus = (e) => {
            ...
            e.target.className.search("before") > -1
              ? (t.beforeExternalContentAlertClass = "")
              : e.target.className.search("after") > -1 &&
                (t.afterExternalContentAlertClass = "");
            this.setState(t);
          };
          this.handleAlertBlur = (e) => {
            ...
            e.target.className.search("before") > -1
              ? (t.beforeExternalContentAlertClass = "screenreader-only")
              : e.target.className.search("after") > -1 &&
                (t.afterExternalContentAlertClass = "screenreader-only");
            this.setState(t);
          };
          this.state = {
            tools: [],
        ...
        componentDidMount() {
          if (this.state.tools)
            for (let e = 0; e < this.state.tools.length; e++) {
              ...
              this["tool_iframe_" + t.definition_id].setAttribute(
                "allow",
                Object(c["a"])()
              );
            }
        ...
        async getTools() {
          const e = encodeURI(
            `${this.getDefinitionsUrl()}?placements[]=${this.props.placement}`
          );
          try {
            ...
            i.a.flashError(
              s["a"].t("Error retrieving assignment external tools")
            );
          }
        }
        getDefinitionsUrl() {
        ...
        getLaunch(e) {
          ...
          let r = `?borderless=true&url=${encodeURIComponent(t)}&placement=${
            this.props.placement
          }`;
          this.props.assignmentId &&
            (r += "&assignment_id=" + this.props.assignmentId);
        ...
        renderTool(e) {
          ...
          e.placements[this.props.placement].launch_width &&
            (t.width = e.placements[this.props.placement].launch_width);
        ...
        renderToolsContainer() {
          ...
          return Object(n["a"])(
            "div",
            {
              style: {
                display:
                  "about:blank" === this.state.toolLaunchUrl ? "none" : "block",
              },
            },
            void 0,
            Object(n["a"])(
              ...
              Object(n["a"])(
                ...
                s["a"].t("The following content is partner provided")
              )
            ),
            this.state.tools.map((e) => this.renderTool(e)),
            Object(n["a"])(
              "div",
              {
                onFocus: this.handleAlertFocus,
        ...
        render() {
          if (0 === this.state.tools.length)
            return h || (h = Object(n["a"])("div", {}));
          return Object(n["a"])(
            "div",
            {},
            void 0,
