  ...
  [106],
  {
    ...
    GXQz: function (e, t, a) {
      ...
      class h extends i.a.Component {
        ...
        renderInnerBar() {
          const e = Math.min(
            (this.props.rangeStudents / this.props.totalStudents) * 100,
            100
          );
          const t = {
            width: e + "%",
          ...
          return Object(s["a"])(
            ...
            Object(s["a"])(
              ...
              Object(s["a"])(
                ...
                void 0,
                m.t("%{rangeStudents} out of %{totalStudents} students", {
                  rangeStudents: t,
                  totalStudents: a,
                })
              )
      ...
      class k extends i.a.Component {
        renderContent() {
          return this.props.isLoading
            ? Object(s["a"])(
                ...
                Object(s["a"])("p", {}, void 0, p.t("Loading Data.."))
              )
            : this.renderBars();
        }
        renderBars() {
          const e = this.props,
            ...
            d = e.openSidebar,
            i = e.selectRange;
          return t.map(({ size: e, scoring_range: t }, r) =>
            Object(s["a"])(
              w,
              {
                rangeIndex: r,
        ...
        render() {
          return Object(s["a"])(
            ...
            void 0,
            Object(s["a"])("h2", {}, void 0, p.t("Mastery Paths Breakdown")),
            this.renderContent()
          );
        }
      }
      ...
      class F extends i.a.Component {
        ...
        render() {
          const e =
            this.props.student.user.avatar_image_url ||
      ...
      class H extends i.a.Component {
        render() {
          ...
          return Object(s["a"])(
            ...
            void 0,
            this.props.range.students.map((e, t) =>
              Object(s["a"])(
                F,
                {
                  student: e,
      ...
      class Q extends i.a.Component {
        ...
        renderTabs() {
          return this.props.ranges.map((e, t) => {
            ...
            const n = Object(g["b"])(
              e.scoring_range.lower_bound,
              this.props.assignment,
              false
            );
            const d = Object(g["b"])(
              e.scoring_range.upper_bound,
              this.props.assignment,
              true
            );
            const i = `> ${n} - ${d}`;
        ...
        render() {
          ...
          return Object(s["a"])(
            ...
            Object(s["a"])(
              ...
              void 0,
              Object(s["a"])("h4", {}, void 0, N.t("Mastery Paths Breakdown"))
            ),
            this.renderTabs()
          );
        }
      ...
      class ae extends i.a.Component {
        ...
        renderStudentProfile() {
          ...
          return Object(s["a"])(
            ...
            Object(s["a"])(
              ...
              {
                className:
                  "Button Button--icon-action student-details__prev-student",
            ...
            Object(s["a"])(
              ...
              {
                className:
                  "Button Button--icon-action student-details__next-student",
        ...
        renderTriggerAssignment() {
          ...
          o = i
            ? i.submitted_at
              ? K.l("date.formats.long", new Date(i.submitted_at))
              : null
            : K.t("Not Submitted");
          return Object(s["a"])(
            "section",
      ...
      class ne extends i.a.Component {
        ...
        render() {
          const e = this.props,
            ...
            n = e.students;
          const d =
            null !== t.student ? a[t.range].students[t.student].user : null;
      ...
      ye.selectStudent = (e) => (t, a) => {
        ...
        r &&
          !s[r.user.id.toString()] &&
          t(ye.loadStudent(r.user.id.toString()));
      };
      const je = le(
        {
      ...
      const Je = {
        init: (e, t) => {
          ...
          if (
            null != e &&
            a.CONDITIONAL_RELEASE_SERVICE_ENABLED &&
            null != a.CONDITIONAL_RELEASE_ENV.rule
          ) {
            ...
            t.appendChild(r);
            d.submission_types = Array.isArray(d.submission_types)
              ? d.submission_types
              : [d.submission_types];
            const o = {
              assignment: d,
    ...
    KIj7: function (e, t, a) {
      ...
      var D = {
        componentId: "MlJlv",
        template: function (e) {
          return "\n\n.MlJlv_bGBk{font-family:"
            .concat(e.fontFamily || "inherit", ";font-weight:")
            .concat(e.fontWeight || "inherit", ";line-height:")
            .concat(
              e.lineHeight || "inherit",
              "}\n\n.MlJlv_doqw .MlJlv_ebWM,.MlJlv_doqw .MlJlv_cjSw{font-size:"
            )
            .concat(
              e.fontSizeSmall || "inherit",
              "}\n\n.MlJlv_doqw .MlJlv_dnnz{font-size:"
            )
            .concat(
              e.smallIconSize || "inherit",
              "}\n\n.MlJlv_doqw .MlJlv_dUEG{-webkit-padding-end:0;-webkit-padding-start:calc("
            )
            .concat(e.smallIconSize || "inherit", " + ")
            .concat(
              e.togglePadding || "inherit",
              ");padding-inline-end:0;padding-inline-start:calc("
            )
            .concat(e.smallIconSize || "inherit", " + ")
            .concat(
              e.togglePadding || "inherit",
              ")}\n\n[dir=ltr] .MlJlv_doqw .MlJlv_dUEG{padding-left:calc("
            )
            .concat(e.smallIconSize || "inherit", " + ")
            .concat(
              e.togglePadding || "inherit",
              ");padding-right:0}\n\n[dir=rtl] .MlJlv_doqw .MlJlv_dUEG{padding-left:0;padding-right:calc("
            )
            .concat(e.smallIconSize || "inherit", " + ")
            .concat(
              e.togglePadding || "inherit",
              ")}\n\n.MlJlv_ycrn .MlJlv_ebWM,.MlJlv_ycrn .MlJlv_cjSw{font-size:"
            )
            .concat(
              e.fontSizeMedium || "inherit",
              "}\n\n.MlJlv_ycrn .MlJlv_dnnz{font-size:"
            )
            .concat(
              e.mediumIconSize || "inherit",
              "}\n\n.MlJlv_ycrn .MlJlv_dUEG{-webkit-padding-end:0;-webkit-padding-start:calc("
            )
            .concat(e.mediumIconSize || "inherit", " + ")
            .concat(
              e.togglePadding || "inherit",
              ");padding-inline-end:0;padding-inline-start:calc("
            )
            ...
            .concat(
              e.togglePadding || "inherit",
              ")}\n\n[dir=ltr] .MlJlv_ycrn .MlJlv_dUEG{padding-left:calc("
            )
            .concat(e.mediumIconSize || "inherit", " + ")
            .concat(
              e.togglePadding || "inherit",
              ");padding-right:0}\n\n[dir=rtl] .MlJlv_ycrn .MlJlv_dUEG{padding-left:0;padding-right:calc("
            )
            .concat(e.mediumIconSize || "inherit", " + ")
            .concat(
              e.togglePadding || "inherit",
              ")}\n\n.MlJlv_cMDj .MlJlv_ebWM,.MlJlv_cMDj .MlJlv_cjSw{font-size:"
            )
            .concat(
              e.fontSizeLarge || "inherit",
              "}\n\n.MlJlv_cMDj .MlJlv_dnnz{font-size:"
            )
            .concat(
              e.largeIconSize || "inherit",
              "}\n\n.MlJlv_cMDj .MlJlv_dUEG{-webkit-padding-end:0;-webkit-padding-start:calc("
            )
            .concat(e.largeIconSize || "inherit", " + ")
            .concat(
              e.togglePadding || "inherit",
              ");padding-inline-end:0;padding-inline-start:calc("
            )
            ...
            .concat(
              e.togglePadding || "inherit",
              ")}\n\n[dir=ltr] .MlJlv_cMDj .MlJlv_dUEG{padding-left:calc("
            )
            .concat(e.largeIconSize || "inherit", " + ")
            .concat(
              e.togglePadding || "inherit",
              ");padding-right:0}\n\n[dir=rtl] .MlJlv_cMDj .MlJlv_dUEG{padding-left:0;padding-right:calc("
            )
            .concat(e.largeIconSize || "inherit", " + ")
            .concat(
              e.togglePadding || "inherit",
              ")}\n\n.MlJlv_cjSw{-moz-appearance:none;-ms-user-select:none;-webkit-appearance:none;-webkit-user-select:none;appearance:none;background:transparent;border:none;box-sizing:border-box;color:"
            )
            .concat(e.textColor || "inherit", ";cursor:pointer;font-family:")
            .concat(
              e.fontFamily || "inherit",
              ";margin:0;outline:none;overflow:visible;padding:0;position:relative;text-decoration:none;touch-action:manipulation;user-select:none}\n\n.MlJlv_cjSw::-moz-focus-inner{margin:0;padding:0}\n\n.MlJlv_cjSw:before{border:"
            )
            .concat(e.toggleBorderWidth || "inherit", " ")
            .concat(e.toggleBorderStyle || "inherit", " ")
            .concat(
              e.toggleFocusBorderColor || "inherit",
              ";border-radius:calc("
            )
            .concat(
              e.toggleBorderRadius || "inherit",
              '*1.5);bottom:-0.375rem;content:"";left:-0.375rem;opacity:0;pointer-events:none;position:absolute;right:-0.375rem;top:-0.375rem}\n\n.MlJlv_cjSw:focus:before{opacity:1}\n\n.MlJlv_cjSw:active,.MlJlv_cjSw:focus,.MlJlv_cjSw:hover{color:'
            )
            .concat(
              e.textColor || "inherit",
            ...
            .concat(
              e.iconMargin || "inherit",
              ";margin-inline-start:0}\n\n[dir=ltr] .MlJlv_fuNk{margin-left:0;margin-right:"
            )
            .concat(
              e.iconMargin || "inherit",
              "}\n\n[dir=rtl] .MlJlv_fuNk{margin-left:"
            )
            .concat(
              e.iconMargin || "inherit",
              ";margin-right:0}\n\n.MlJlv_fhZl{-webkit-margin-end:0;-webkit-margin-start:"
            )
            .concat(
              e.iconMargin || "inherit",
            ...
            .concat(
              e.iconMargin || "inherit",
              "}\n\n[dir=ltr] .MlJlv_fhZl{margin-left:"
            )
            .concat(
              e.iconMargin || "inherit",
              ";margin-right:0}\n\n[dir=rtl] .MlJlv_fhZl{margin-left:0;margin-right:"
            )
            .concat(
              e.iconMargin || "inherit",
              "}\n\n.MlJlv_btWg{flex-grow:1;min-width:0.0625rem}\n\n.MlJlv_fFWz .MlJlv_btWg{flex:1}\n\n.MlJlv_ebWM{box-sizing:border-box;color:"
            )
            .concat(e.textColor || "inherit", ";padding-top:")
            .concat(
              e.togglePadding || "inherit",
                    ...
                    Object(i["a"])(a, [
                      ...
                      },
                      {
                        ...
                        value: function (e, t) {
                          ...
                          var o = Object(s["a"])(
                            {},
                            Object(k["a"])(this.props, a.propTypes),
                            {},
                            e,
                            {
                          ...
                          return c.a.createElement(
                            ...
                            Object.assign({}, t, {
                              className: f()(
                                ...
                                ((a = {}),
                                Object(n["a"])(a, D[i], i),
                                Object(n["a"])(a, D.hiddenDetails, !e),
                                Object(n["a"])(a, D.expandedDetails, e),
                                Object(n["a"])(
                                  a,
                                  D.indentDetails,
                                  "start" === r && !o
                      ...
                      },
                      {
                        ...
                        value: function () {
                          ...
                          var o =
                            ((e = {}),
                            Object(n["a"])(e, D.root, true),
                            Object(n["a"])(e, D[this.props.size], true),
                            Object(n["a"])(e, D.positionIconAtEnd, r),
                            e);
                          return c.a.createElement(
                            v["a"],
                            Object(k["c"])(this.props, v["a"].propTypes),
                            function (e) {
                              var a = e.expanded,
                                n = e.getToggleProps,
                                s = e.getDetailsProps;
    ...
    MdYG: function (e, t, a) {
      ...
      const u = (e) => {
        ...
        if ((t === r.letter_grade.key || t === r.gpa_scale.key) && !l(e))
          return r.percent.key;
        return t;
      };
      const b = (e, t) => {
        const a = u(t);
        return a === r.points.key
          ? g(e, t)
          : a === r.letter_grade.key || a === r.gpa_scale.key
          ? m(e, t)
          : v(e);
      };
      const f = (e, t, a) => {
      ...
      const h = (e, t) => {
        if (
          "string" === typeof e &&
          t.grading_type !== r.letter_grade.key &&
          t.grading_type !== r.gpa_scale.key
        ) {
    ...
    "Pm+R": function (e, t, a) {
      ...
      _.getCategory = (e) => {
        const t = s.a.find(
          _.list,
          (t) =>
            e.submission_types.length &&
            s.a.find(
              e.submission_types,
              (e) => -1 !== t.submissionTypes.indexOf(e)
            )
        );
        return t || o;
      };
