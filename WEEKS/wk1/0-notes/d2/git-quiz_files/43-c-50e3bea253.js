( window[ "canvasWebpackJsonp" ] = window[ "canvasWebpackJsonp" ] || [] ).push( [
  [ 43, 667, 738 ], {
    "2BSC": function ( e, t, a ) {
      ...
      t[ "a" ] = function ( e ) {
        ...
        t.prototype.submit = function ( e, t ) {
          ...
          c = true
          d.length > 0 && window.ENV.use_rce_enhancements && ( c = d.map( ( function ( e ) {
          ...
          if ( 0 === u.a.keys( s ).length ) {
            ...
            h.fail( ( p = this, function () {
              i.reject()
              if ( p.setFocusAfterError ) return p.setFocusAfterError()
            } ) )
            this.dontRenableAfterSaveSuccess || h.done( ( function () {
              return i.resolve()
            } ) )
          ...
          a = u.a.chain( u.a.keys( s ) ).reject( ( function ( e ) {
        ...
        t.prototype.onSaveSuccess = function ( e ) {
          return this.trigger.apply( this, [ "success", e ].concat( m.call( arguments ) ) )
        }
        ...
        t.prototype.castJSON = function ( e ) {
          ...
          t = u.a.clone( e )
          u.a.each( t, ( a = this, function ( e, n ) {
    ...
    BYL3: function ( e, t, a ) {
      ...
      function c() {
        return this.name && !this.disabled && ( this.checked || s.test( this.nodeName ) || l.test( this.type ) )
      }
      ...
      function h() {
        const e = r()( this )
        const t = ( () => {
          if ( "file" !== this.type ) return e.hasClass( "datetime_field_enabled" ) ? "" === e.val() ? null : e.data( "date" ) || null : e.data( "rich_text" ) ? Object( i[ "d" ] )( e, "get_code", false ) : e.val()
          ...
          if ( t.length ) {
            ...
            let a = r.a.map( t.toArray(), t => {
              ...
              if ( a.is( ".dialog_closer" ) ) {
                ...
                a.on( "click.fixdialogbuttons", Object( o[ "a" ] )( () => e.dialog( "close" ) ) )
              }
              "submit" === a.prop( "type" ) && a[ 0 ].form && ( n += " button_type_submit" )
              return {
                text: a.text(),
      ...
      t[ "a" ] = {
        ...
        showErrors: function ( e, t ) {
          ...
          for ( i in e ) {
            ...
            s = n.message || function () {
              var e, t, a, r
              r = []
              for ( e = 0, t = n.length; e < t; e++ ) {
                l = n[ e ].message
                r.push( Object( o[ "a" ] )( ( null != ( a = this.translations ) ? a[ l ] : void 0 ) || l ) )
              }
              return r
            }.call( this ).join( "</p><p>" )
        ...
        attachErrorDescription: function ( e, t ) {
          ...
          return e.attr( "aria-describedby", a[ "description" ].attr( "id" ) + " " + a[ "originalDescriptionIds" ] )
        },
        findOrCreateDescriptionField: function ( e ) {
          var t, a, n
          a = e.attr( "id" )
          r()( "#" + a + "_sr_description" ).length > 0 || r()( "<div>" ).attr( {
            id: a + "_sr_description",
    ...
    faZh: function ( e, t, a ) {
      ...
      g[ p ] = h( ( function ( e, t, a, n, r ) {
        ...
        o += '<div class="outlet"></div>\n\n<div class="button-container">\n  <button class="btn dialog_closer">' + u( ( i = a.t || t && t.t, s = {
          hash: {
            scope: "dialog_form_wrapper"
          },
          data: r
        }, i ? i.call( t, "cancel", "Cancel", s ) : l.call( t, "t", "cancel", "Cancel", s ) ) ) + '</button>\n  <button\n    class="btn btn-primary"\n    data-text-while-loading=\'' + u( ( i = a.t || t && t.t, s = {
          hash: {
            scope: "dialog_form_wrapper"
          },
          data: r
        }, i ? i.call( t, "saving", "Saving...", s ) : l.call( t, "t", "saving", "Saving...", s ) ) ) + '\'\n    type="submit"\n  >' + u( ( i = a.t || t && t.t, s = {
          hash: {
            scope: "dialog_form_wrapper"
          },
          data: r
        }, i ? i.call( t, "save_settings", "Save Settings", s ) : l.call( t, "t", "save_settings", "Save Settings", s ) ) ) + "</button>\n\n"
        return o
      } ) )
      var f = g[ p ]
      a( "YGE8" )
      a( "TBRb" )
      var _, v, m, b = function ( e, t ) {
          return function () {
            return e.apply( t, arguments )
          }
        },
      ...
      t[ "a" ] = function ( e ) {
        ...
        t.prototype.close = function () {
          var e, t;
          ( null != ( e = this.dialog ) ? e.isOpen() : void 0 ) && this.dialog.close()
    ...
    ppAs: function ( e, t, a ) {
      ...
      const d = {
        translateMathmlForScreenreaders( e ) {
          var t, a
          if ( !( null !== ( t = ENV ) && void 0 !== t && null !== ( a = t.FEATURES ) && void 0 !== a && a.new_math_equation_handling ) ) {
            const t = r()( "<div/>" ).html( e.attr( "x-canvaslms-safe-mathml" ) ).html()
        ...
        convert( e, t = {} ) {
          ...
          a.find( "video.instructure_inline_media_comment,audio.instructure_inline_media_comment" ).replaceWith( ( function () {
            return d.toMediaCommentLink( this )
          } ) )
          a.find( "object.instructure_user_content:not(#kaltura_player) embed" ).remove()
          if ( !t.forEditing ) {
            a.find( "object.instructure_user_content,embed.instructure_user_content" ).replaceWith( ( function () {
              const e = r()( this )
              ...
              n.append( r()( "<input type='hidden'/>" ).attr( {
                name: "object_data",
