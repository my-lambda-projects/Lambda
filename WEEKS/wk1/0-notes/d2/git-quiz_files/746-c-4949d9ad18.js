  ...
  [ 746 ], {
    wGhc: function ( n, e, a ) {
      ...
      const r = {
        hide: {
          get default() {
            return s.t( "Hide Navigation Menu" )
          },
          get account() {
            return s.t( "Hide Account Navigation Menu" )
          },
          get admin() {
            return s.t( "Hide Admin Navigation Menu" )
          },
          get courses() {
            return s.t( "Hide Courses Navigation Menu" )
          },
          get groups() {
            return s.t( "Hide Groups Navigation Menu" )
          }
        },
        show: {
          get default() {
            return s.t( "Show Navigation Menu" )
          },
          get account() {
            return s.t( "Show Account Navigation Menu" )
          },
          get admin() {
            return s.t( "Show Admin Navigation Menu" )
          },
          get courses() {
            return s.t( "Show Courses Navigation Menu" )
          },
          get groups() {
            return s.t( "Show Groups Navigation Menu" )
          }
        }
      }
      const m = function ( n = window.location.pathname ) {
      ...
      _()( document ).ready( ( function () {
        _()( "#floating_reminders" ).draggable()
        _()( ".show_reminders_link" ).click( ( function ( n ) {
          n.preventDefault()
          _()( this ).blur()
        ...
        _()( ".hide_reminders_link" ).click( ( function ( n ) {
          n.preventDefault()
        ...
        _()( ".drop_held_context_link" ).click( ( function ( n ) {
          n.preventDefault()
          const e = _()( this ).parents( ".reminder" )
          e.confirmDelete( {
            url: _()( this ).attr( "href" ),
            message: "Are you sure you want to drop this " + e.find( ".item_type" ).text() + "?",
            success( n ) {
              _()( this ).fadeOut( "fast", ( function () {
                _()( this ).remove()
                0 === _()( "#floating_reminders .reminder" ).length && _()( "#floating_reminders" ).fadeOut( "fast", ( function () {
                  _()( this ).remove()
      ...
      function v( n ) {
        ...
        i && t.attr( "target", i )
        t.hide().append( o ).appendTo( "body" ).submit()
      }

      function h( n ) {
        const e = n.data( "confirm" )
        if ( !e ) return true
        return confirm( e )
      }
      _()( document ).delegate( "a[data-confirm], a[data-method], a[data-remove]", "click", ( function ( n ) {
        const e = _()( this )
      ...
      function f( n ) {
        ...
        const u = () => o.show()
        i ? _.a.ajaxJSON( i, "DELETE", {}, d, u ) : d()
      }
      var b = a( "lVr/" )
      _()( document ).on( "mousedown click keydown", ".al-trigger", ( function ( n ) {
        const e = _()( this )
        if ( e.data( "kyleMenu" ) ) return
        let a = _.a.extend( {
          noButton: true
        }, e.data( "kyleMenuOptions" ) )
      ...
      function w( n, e, a ) {
        ...
        t.filter( ( function () {
          return _()( this ).data( "hideWhileTargetShown" )
        } ) ).toggle( !e )
        if ( a && void 0 !== a.attr( "aria-expanded" ) ) {
          a.attr( "aria-expanded", !( "true" === a.attr( "aria-expanded" ) ) )
          n.toggle( "true" === a.attr( "aria-expanded" ) )
        } else n.attr( "aria-expanded", "" + e ).toggle( e )
        if ( n.is( ":ui-dialog" ) || ( i = n.data( "turnIntoDialog" ) ) ) {
          if ( i && e ) {
            i = _.a.extend( {
              autoOpen: false,
              close() {
            ...
            n.dialog( i ).fixDialogButtons()
          }
          if ( e ) {
            var o, d
            if ( !!( null !== ( o = window.ENV ) && void 0 !== o && null !== ( d = o.FEATURES ) && void 0 !== d && d.responsive_misc ) && n.dialog( "option" ).responsive ) {
              const e = n.dialog( "option" ).width
              if ( e && e > 320 && !window.matchMedia( `(min-width: ${e}px)` ).matches ) {
                n.dialog( "option", "width", 320 )
                n.removeClass( "form-horizontal" )
              }
            }
            n.dialog( "open" )
            n.data( "read-on-open" ) && n.dialog( "widget" ).attr( "aria-live", "assertive" ).attr( "aria-atomic", "true" )
          } else n.dialog( "isOpen" ) && n.dialog( "close" )
        }
        t.each( k( e ? "Shown" : "Hidden" ) )
      }
      const p = {
        bind() {
          _()( document ).on( "click change keyclick", ".element_toggler[aria-controls]", ( function ( n ) {
            let e
            const a = _()( this )
            if ( a.is( 'input[type="checkbox"]' ) ) {
              if ( "click" === n.type ) return
              e = a.prop( "checked" )
            }
            "click" === n.type && n.preventDefault()
            ...
            if ( o.length ) {
              o.toggleClass( "icon-mini-arrow-down" )
      ...
      p.bind()
      const y = 13
      _()( document ).on( "keydown", ".ic-Super-toggle__input", n => {
        n.which === y && _()( n.target ).click()
      } )
      ...
      a( "f3bb" )
      const N = {
        buildMinimizerLink: () => _()( `<a href="#" style="font-size: 0.8em;">\n      ${Object(l["a"])(M.t("links.minimize_embedded_kaltura_content","Minimize embedded content"))}\n    </a>` ),
        buildCommentHolder: n => _()( '<div><div class="innerholder" tabindex="-1" style="margin-bottom: 15px;"></div></div>' ),
        getMediaCommentId( n ) {
          let e
        ...
        collapseComment( n ) {
          x( n.find( "video,audio" ).data( "mediaelementplayer" ), n => n.pause() )
          n.remove()
          Object( j[ "a" ] )( "hide_embedded_content", "hide_media" )
        }
      }
      const S = n => {
        _()( n.target ).find( "div.mejs-audio" ).focus()
      }
      const C = 300
      const z = n => {
        const e = n.closest( "td" )
        return e.length > 0
      }
      const A = n => {
        const e = n.closest( "td" ).css( "width" ).replace( "px", "" )
        return e < C
      }
      const K = n => z( n ) && A( n )
      const H = n => {
      ...
      _()( document ).on( "click", "a.instructure_inline_media_comment", Object( g[ "a" ] )( ( function () {
        if ( !INST.kalturaSettings ) {
          alert( M.t( "alerts.kaltura_disabled", "Kaltura has been disabled for this Canvas site" ) )
          return
        }
        const n = _()( this )
        let e = "video"
        ...
        n.after( i )
        n.hide();
        ( "audio" === n.data( "media_comment_type" ) || n.is( ".audio_playback, .audio_comment, .instructure_audio_link" ) ) && ( e = "audio" )
        i.children( "div" ).mediaComment( "show_inline", a, e, n.data( "download" ) || n.attr( "href" ) )
        const t = N.buildMinimizerLink()
        t.appendTo( i ).click( Object( g[ "a" ] )( () => {
          const e = n.closest( "td" )
          n.show().focus()
      ...
      function x( n, e ) {
        return "undefined" !== typeof n && null !== n ? e( n ) : void 0
      }
      if ( ENV.ping_url ) {
        const n = setInterval( () => {
          document.hidden || _.a.post( ENV.ping_url ).fail( e => {
            401 === e.status && clearInterval( n )
          } )
        }, 18e4 )
      }
      Object( u[ "a" ] )( JSON.parse( '{"ar":{"locked_image_24f37a16":"صورة مؤمّنة"},"ca":{"locked_image_24f37a16":"Imatge bloquejada"},"cy":{"locked_image_24f37a16":"Delwedd wedi’i chloi"},"da":{"locked_image_24f37a16":"Låst billede"},"da-x-k12":{"locked_image_24f37a16":"Låst billede"},"de":{"locked_image_24f37a16":"Gesperrtes Bild"},"en-AU":{"locked_image_24f37a16":"Locked image"},"en-AU-x-unimelb":{"locked_image_24f37a16":"Locked image"},"en-CA":{"locked_image_24f37a16":"Locked image"},"en-GB":{"locked_image_24f37a16":"Locked image"},"en-GB-x-lbs":{"locked_image_24f37a16":"Locked image"},"en-GB-x-ukhe":{"locked_image_24f37a16":"Locked image"},"es":{"locked_image_24f37a16":"Imagen bloqueada"},"fa":{"locked_image_24f37a16":"تصویر قفل شده"},"fi":{"locked_image_24f37a16":"Lukittu kuva"},"fr":{"locked_image_24f37a16":"Image verrouillée"},"fr-CA":{"locked_image_24f37a16":"Image verrouillée"},"ht":{"locked_image_24f37a16":"Imaj Bloke"},"is":{"locked_image_24f37a16":"Læst mynd"},"it":{"locked_image_24f37a16":"Immagine bloccata"},"ja":{"locked_image_24f37a16":"ロックされた画像"},"mi":{"locked_image_24f37a16":"Āhua kua rakaina"},"nb":{"locked_image_24f37a16":"Låst bilde"},"nb-x-k12":{"locked_image_24f37a16":"Låst bilde"},"nl":{"locked_image_24f37a16":"Vergrendelde afbeelding"},"nn":{"locked_image_24f37a16":"Låst bilde"},"pl":{"locked_image_24f37a16":"Zablokowany obraz"},"pt":{"locked_image_24f37a16":"Imagem bloqueada"},"pt-BR":{"locked_image_24f37a16":"Imagem bloqueada"},"ru":{"locked_image_24f37a16":"Заблокированное изображение"},"sl":{"locked_image_24f37a16":"Zaklenjena slika"},"sv":{"locked_image_24f37a16":"Låst bild"},"sv-x-k12":{"locked_image_24f37a16":"Låst bild"},"zh-Hans":{"locked_image_24f37a16":"锁定图片"},"zh-Hant":{"locked_image_24f37a16":"鎖定圖像"}}' ) )
      var V = d[ "default" ].scoped( "broken_images" )

      function O( n ) {
        _()( n ).on( "error", n => {
          n.currentTarget.src ? _.a.get( n.currentTarget.src ).fail( e => {
            403 === e.status ? _()( n.currentTarget ).attr( {
              src: "/images/svg-icons/icon_lock.svg",
              alt: V.t( "Locked image" ),
              width: 100,
              height: 100
            } ) : _()( n.currentTarget ).addClass( "broken-image" )
          } ) : _()( n.currentTarget ).addClass( "broken-image" )
        } )
      }

      function D() {
        Array.from( document.querySelectorAll( 'img:not([src=""])' ) ).forEach( O )
      }
      _()( document ).ready( () => D() )
      ...
      function T( n ) {
        n.preventDefault()
        L.launch( _()( n.target ).closest( G ) )
      }
      class W {
        constructor() {
          _()( document.body ).delegate( G, "click", T )
        }
        launch( n ) {
          const e = JSON.parse( n.attr( "target" ) )
          const a = _()( "<iframe/>", {
            src: n.attr( "href" ),
            allowfullscreen: "",
            width: e.displayWidth || 500,
            height: e.displayHeight || 500
          } )
          n.replaceWith( a )
        }
      }
      ...
      function q() {
        document.querySelectorAll( ".user_content" ).forEach( n => n.querySelectorAll( "*" ).forEach( n => {
          const e = getComputedStyle( n )
          "fixed" === e.position && ( n.style.position = "relative" )
        } ) )
      }
      const P = new MutationObserver( ( function ( n ) {
        n.find( n => n.addedNodes.length > 0 ) && q()
      } ) )
      ...
      const U = document.getElementById( "right-side" )
      U && P.observe( U, {
        childList: true,
        subtree: true
      } )
      ...
      ENV.page_view_update_url && a.e( 750 ).then( a.bind( null, "MOpQ" ) )
      _()( "#skip_navigation_link" ).on( "click", Object( g[ "a" ] )( ( function () {
        _()( _()( this ).attr( "href" ) ).attr( "tabindex", -1 ).focus()
      } ) ) )
      const R = 1200

      function J() {
        const n = _()( "#section-tabs li a" )
        if ( n.length ) {
          const e = _()( "body" ).hasClass( "course-menu-expanded" ) || _()( document ).width() >= R - 15 ? 0 : -1
          n.attr( "tabIndex", e )
        }
      }
      _()( J )
      _()( window ).on( "resize", t.a.debounce( J, 50 ) )
      _()( "body" ).on( "click", "#courseMenuToggle", () => {
        _()( "body" ).toggleClass( "course-menu-expanded" )
        c()
        _()( "#left-side" ).css( {
          display: _()( "body" ).hasClass( "course-menu-expanded" ) ? "block" : "none"
        } )
        J()
      } )
    }
...
//# sourceMappingURL=746-c-4949d9ad18.js.map
