...
If you find an Issue that addresses the problem you're having, please add your own reproduction information to the existing issue rather than creating a new one. Adding a [reaction](https://github.com/bgoonz/Lambda/issues) can also help be indicating to our maintainers that a particular problem is affecting more than just the reporter.
...
In general, we follow the ["fork-and-pull" Git workflow](https://github.com/bgoonz/Lambda)
...
Join us in the [Lambda](https://github.com/bgoonz/Lambda) and post your question there in the correct category with a descriptive tag.
