...
if (searchFormula.length > 0) {
  ...
  console.log(
    searchString,
    "Sorry, but the author name you requested does not match any results."
  );
}
...
console
  .log("Group newsFeedArray By Sections", groupBySections())

  [("red", "red", "blue", "green", "yellow", "green")].reduce(
    ...
    []
  ); // returns [red: Array(2), blue: Array(1), green: Array(2), yellow: Array(1)]
