(window.webpackJsonp_N_E = window.webpackJsonp_N_E || []).push([
  [18],
  {
    ...
    "4A0d": function (e, t, n) {
      ...
      const s = n("koLh");
      function c() {
        const e = o.useState(null);
        const t = Object(r.a)(e, 2);
        const n = t[0];
        const c = t[1];
        const u = o.useState(null);
        const l = Object(r.a)(u, 2);
        const A = l[0];
        const h = l[1];
        o.useEffect(() => {
          let e = !1;
          return (
            Promise.all([Object(a.a)(), Object(i.a)()]).then((t) => {
              const n = Object(r.a)(t, 1)[0];
              e || c(n);
            }),
            () => {
              e = !0;
        ...
        const p = o.useState(null);
        const f = Object(r.a)(p, 2);
        const d = f[0];
        const b = f[1];
      ...
      const l = (() => {
        ...
        return (
          ...
          (e.prototype.send = function (e) {
            const t = new ArrayBuffer(4 + e.byteLength);
    ...
    P2Oe(e, t, n) {
      ...
      (({ env }, r) => {
        ...
        const u = n("dI/k");
        const l = n("5/z4");
        const A = env.VNC_PROXY_SUFFIX || "repl.co";
        function h(e) {
          const t = e.split(".");
          if (4 !== t.length)
            ...
            typeof (o = () => {
              ...
              function l(e) {
                ...
                return function (...args) {
                  ...
                  const r = i(e);
                  if (t) {
                    const o = i(this).constructor;
                    n = Reflect.construct(r, args, o);
      ...
      function r(e) {
        ...
        function r(...args) {
          if (r.enabled) {
            ...
            const u = r.log || t.log || console.log.bind(console);
            u.apply(e, a);
          }
        }
        return (
