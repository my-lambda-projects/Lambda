                  ...
                  f = ((e) => {
                    function t(t, r) {
                      ...
                      return (
                        ...
                        i.register(
                          c.addDisposableDomListener(window, "resize", () => {
                            return i._refreshRowsDimensions();
                          })
                        ),
                        i
                  ...
                  M = ((e) => {
                    function t(t) {
                      ...
                      return (
                        ...
                        r.register(
                          r._inputHandler.onRequestWindowsOptionsReport((e) => {
                    ...
                    return (
                      ...
                      (t.prototype.open = function (e) {
                        ...
                        (this._renderService = this.register(
                          ...
                          this.register(
                            this._renderService.onRenderedBufferChange((e) => {
                      ...
                      (t.prototype.bindMouse = function () {
                        ...
                        this.register(
                          ...
                          (this._coreMouseService.activeProtocol =
                            this._coreMouseService.activeProtocol),
                          this.register(
                            d.addDisposableDomListener(r, "mousedown", (t) => {
                              if (
                                (t.preventDefault(),
                                e.focus(),
                  ...
                  w = ((e) => {
                    function t(t, r, i, n, o, l, h, d, v) {
                      ...
                      (y._bufferService = t),
                        ...
                        y._parser.registerCsiHandler({ final: "@" }, (e) => {
                        ...
                        y._parser.registerCsiHandler({ final: "A" }, (e) => {
                          return y.cursorUp(e);
                        }),
                        y._parser.registerCsiHandler(
                        ...
                        y._parser.registerCsiHandler({ final: "B" }, (e) => {
                          return y.cursorDown(e);
                        }),
                        y._parser.registerCsiHandler({ final: "C" }, (e) => {
                          return y.cursorForward(e);
                        }),
                        y._parser.registerCsiHandler({ final: "D" }, (e) => {
                          return y.cursorBackward(e);
                        }),
                        y._parser.registerCsiHandler({ final: "E" }, (e) => {
                          return y.cursorNextLine(e);
                        }),
                        y._parser.registerCsiHandler({ final: "F" }, (e) => {
                          return y.cursorPrecedingLine(e);
                        }),
                        y._parser.registerCsiHandler({ final: "G" }, (e) => {
                          return y.cursorCharAbsolute(e);
                        }),
                        y._parser.registerCsiHandler({ final: "H" }, (e) => {
                          return y.cursorPosition(e);
                        }),
                        y._parser.registerCsiHandler({ final: "I" }, (e) => {
                          return y.cursorForwardTab(e);
                        }),
                        y._parser.registerCsiHandler({ final: "J" }, (e) => {
                        ...
                        y._parser.registerCsiHandler({ final: "K" }, (e) => {
                        ...
                        y._parser.registerCsiHandler({ final: "L" }, (e) => {
                          return y.insertLines(e);
                        }),
                        y._parser.registerCsiHandler({ final: "M" }, (e) => {
                          return y.deleteLines(e);
                        }),
                        y._parser.registerCsiHandler({ final: "P" }, (e) => {
                          return y.deleteChars(e);
                        }),
                        y._parser.registerCsiHandler({ final: "S" }, (e) => {
                          return y.scrollUp(e);
                        }),
                        y._parser.registerCsiHandler({ final: "T" }, (e) => {
                          return y.scrollDown(e);
                        }),
                        y._parser.registerCsiHandler({ final: "X" }, (e) => {
                          return y.eraseChars(e);
                        }),
                        y._parser.registerCsiHandler({ final: "Z" }, (e) => {
                        ...
                        y._parser.registerCsiHandler({ final: "n" }, (e) => {
                        ...
                        y._parser.registerCsiHandler({ final: "r" }, (e) => {
                        ...
                        y._parser.registerCsiHandler({ final: "u" }, (e) => {
                        ...
                        y._parser.registerEscHandler({ final: "7" }, () => {
                          return y.saveCursor();
                        }),
                        y._parser.registerEscHandler({ final: "8" }, () => {
                          return y.restoreCursor();
                        }),
                        y._parser.registerEscHandler({ final: "D" }, () => {
                          return y.index();
                        }),
                        y._parser.registerEscHandler({ final: "E" }, () => {
                          return y.nextLine();
                        }),
                        y._parser.registerEscHandler({ final: "H" }, () => {
                          return y.tabSet();
                        }),
                        y._parser.registerEscHandler({ final: "M" }, () => {
                          return y.reverseIndex();
                        }),
                        y._parser.registerEscHandler({ final: "=" }, () => {
                          return y.keypadApplicationMode();
                        }),
                        y._parser.registerEscHandler({ final: ">" }, () => {
                          return y.keypadNumericMode();
                        }),
                        y._parser.registerEscHandler({ final: "c" }, () => {
                          return y.fullReset();
                        }),
                        y._parser.registerEscHandler({ final: "n" }, () => {
                          return y.setgLevel(2);
                        }),
                        y._parser.registerEscHandler({ final: "o" }, () => {
                  ...
                  return (
                    ...
                    (e.prototype.createInstance = function (e) {
                      for (var t = [], r = 1; r < arguments.length; r++)
                        t[r - 1] = arguments[r];
                      for (
                        var n = o.getServiceDependencies(e).sort((e, t) => {
