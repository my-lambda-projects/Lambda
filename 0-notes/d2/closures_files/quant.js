/* Copyright (c) 2008-2020, Quantcast Corp. */ ! function ( window ) {
  ...
  with( available( array, map ) || ( array[ map ] = function ( n, e ) {
    ...
    return function ( n ) {
      for ( var e = n.domain || "", t = new Date( 0 ).toUTCString(), r = e.split( "." ), a = 1; a <= r.length; a++ ) {
        var i = r.slice( -a ).join( "." ),
          o = "_dlt=1; domain=" + i;
        if ( n.cookie = o, /_dlt=1/.test( n.cookie ) ) return n.cookie = o + "; expires=" + t, i
      }
      return e
    }
    ...
    return n.resolve = i, n.reject = o, n.all = function ( n ) {
    ...
    function t( t, r ) {
      ...
      var u = function ( n, e, t ) {
        ...
        return a.onload = i, a.onreadystatechange = function () {
          a.readyState in {
            loaded: 1,
            complete: 1
          } && i()
    ...
    return void 0 !== localJSON.stringify && '{"test":["1"]}' === localJSON.stringify( {
      ...
      for ( t in n ) r = n[ t ], "function" !== ( e = typeof r ) && ( "string" === e ? r = '"' + r + '"' : "object" === e && null !== r && ( r = localJSON.stringify( r ) ), a.push( ( i ? "" : '"' + t + '":' ) + String( r ) ) );
      return ( i ? "[" : "{" ) + String( a ) + ( i ? "]" : "}" )
    ...
    return function ( a, i, o, u, c, s, f, l ) {
      ...
      "object" == typeof u && "function" == typeof u.callApi ? ( !0, d = function ( n, t, r, a ) {
        ...
        return a.depth > 0 && ( t.add( i, "message", function ( e ) {
          var t = e.data;
    ...
    return function ( a, i, o, u ) {
      var c;
      if ( "function" == typeof i.__uspapi ) c = function ( e, t ) {
        return new n( function ( n, e ) {
    ...
    return function ( a, i, o, u ) {
      var c, s;
      if ( "function" == typeof i.__cmp ) s = function ( e, t ) {
        return new n( function ( n, r ) {
        ...
        t.add( i, "message", function ( n ) {
          var t = n.data;
          if ( void 0 === t ) return void o.error( "[TCF]: Recieved undefined message" );
          if ( "string" == typeof t && "{" == t[ 0 ] ) try {
            t = e.parse( t )
          } catch ( n ) {
            return
          ...
          var o = a.locate( u );
          if ( void 0 === o ) return n.resolve( {
            gdprApplies: !1
          } );
          var c = r();
          return new n( function ( n, r ) {
            f[ c ] = [ n, r ], o.postMessage( e.stringify( {
              __cmpCall: {
                command: t,
                parameter: i,
                callId: c
      ...
      this.consent = function ( n ) {
        return void 0 === c && ( c = s( "getVendorConsents", [ 11 ] ).then( function ( e ) {
          return e.gdprApplies && "false" != e.gdprApplies ? ( n.gdpr = 1, s( "getConsentData", null ).then( function ( t ) {
    ...
    function a( n, e ) {
      ...
      return !t || n.map( function ( n ) {
        var e = !!r.consents && r.consents[ n ],
          ...
          a = u && u[ n ] ? u[ n ][ s ] : null;
        return 0 !== a && ( !( !i || !e || 2 === a || -1 == l.indexOf( n ) && 1 !== a ) || !( 1 === a || !o || !t || -1 != d.indexOf( n ) || -1 != l.indexOf( n ) && 2 !== a ) )
      } ).reduce( function ( n, e ) {
        return n && e
      }, !0 )
    }
    ...
    function i( i, s, l, d ) {
      var q, m;
      if ( "function" == typeof s.__tcfapi ) m = function ( e, t ) {
        return new n( function ( n, r ) {
          s.__tcfapi( e, p, function ( t, a ) {
            if ( a ) {
              var i = t.eventStatus;
        ...
        t.add( s, "message", function ( n ) {
          var t = n.data;
          if ( void 0 === t ) return void l.error( o + "Recieved undefined message" );
          if ( "string" == typeof t && "{" == t[ 0 ] ) try {
            t = e.parse( t )
          } catch ( n ) {
            return
          ...
          if ( t.hasOwnProperty( v ) ) {
            ...
            if ( void 0 === i ) return;
            var s = r.returnValue;
            r.success ? w[ a ] === h && s.gdprApplies && "useractioncomplete" !== s.eventStatus && "tcloaded" !== s.eventStatus || i[ u ]( s ) : i[ c ]( s )
          }
        } ), m = function ( t, a ) {
          var o = i.locate( d );
          if ( void 0 === o ) return n.resolve( {
      ...
      this.consent = function ( n ) {
        return void 0 === q && ( q = m( h ).then( function ( e ) {
          return e.gdprApplies && "false" != e.gdprApplies ? ( n.gdpr = 1, n.gdpr_consent = e.tcString ) : n.gdpr = n.gdpr || 0, a( f, e )
        } ).catch( function ( e ) {
    ...
    var r, a, i = [ "PageView", "ViewContent", "Search", "AddToWishlist", "AddToCart", "InitiateCheckout", "AddPaymentInfo", "Purchase", "Lead", "Register", "StartTrial", "Subscribe", "SubmitApplication" ],
      o = "init",
      u = "track",
      c = "trackCustom",
      s = {
    ...
    function n() {
      this.FNV = function ( e ) {
        var t, r, a, i;
        return t = 2166136261, r = 3386659096, a = n( t, e ), i = n( r, e ), Math.round( Math.abs( a * i ) / 65536 ).toString( 16 )
      };
      var n = function ( n, e ) {
        var t;
    ...
    return function ( e, t, r, a, i, o ) {
      var u, c = {},
        ...
        d = 2,
        p = {};
      for ( u in t ) p[ u ] = void 0 !== t[ u ], t.hasOwnProperty( u ) && "string" == typeof t[ u ] && ( "uid" !== u && "uh" !== u ? "qacct" !== u && ( t[ u ].length > 0 ? c[ u + e ] = encodeURIComponent( t[ u ] ) : p[ u ] = !1 ) : ( o || ( t[ u ].match( l ) && ( d = 1 ), t[ u ].match( f ) && ( d = 0 ), s = n.FNV( t[ u ] ) ), delete t[ u ] ) );
      for ( u in r ) r.hasOwnProperty( u ) && "string" == typeof r[ u ] && !p[ u ] && ( c[ u + e ] = encodeURIComponent( r[ u ] ) );
      return c[ "rf" + e ] = "" + i, "string" == typeof s && ( t.uh = s, c[ "uh" + e ] = encodeURIComponent( s ) ), c[ "uht" + e ] = "" + d, c[ "a" + e ] = a, c
    }
  } ), define( "quant.js", [ "quant/origin", "quant/windows", "quant/log", "quant/loader", "quant/consent/truste", "quant/consent/uspapi", "quant/consent/tcf1.1", "quant/consent-manager", "quant/consent/tcf2.0", "quant/qtrack", "quant/normalize", "quant/hashing" ], function ( n, e, t, r, a, i, o, u, c, s, f, l ) {
    return void 0 === window.__qc && ( window.__qc = function ( s, d, p ) {
      if ( s.__qc ) return s.__qc;
      var h, v, g, q, m, y, w, _, b, E, O, S, j, P, C, I, k, R, x, A, D, N, T, M, z, L, U, V, J, F, B, Q, G, $, W, Z, H, K, X, Y, nn, en, tn, rn, an, on, un, cn, sn = n( d ),
        fn = new e( s, s.top ),
        ln = new r( s, d ),
        dn = new t( ln, "quantcount.com" ),
        pn = new u( [ new a( fn, s, s.top, s.PrivacyManagerAPI, "truste.com", "advertising", "quantserve.com", sn ), new i( fn, s, dn, "__uspapiLocator" ), new o( fn, s, dn, "__cmpLocator" ), new c( fn, s, dn, "__tcfapiLocator" ) ] ),
        hn = [ "a", "ce", "cm", "dst", "enc", "fpa", "fpan", "je", "ns", "ogl", "rf", "tzo", "sr" ],
        vn = [ "4dcfa7079941", "127fdf7967f31", "588ab9292a3f", "32f92b0727e5", "22f9aa38dfd3", "a4abfe8f3e04", "18b66bc1325c", "958e70ea2f28", "bdbf0cb4bbb", "65118a0d557", "40a1d9db1864", "18ae3d985046", "3b26460f55d" ],
        gn = !1,
        qn = !1,
        mn = 0,
        yn = [],
      ...
      ! function () {
        var n;
        n = d.createElement( "script" ), h = "async" in n ? 1 : n.readyState ? 2 : 3, n = null
      }();
      var kn = function ( n ) {
        try {
          return {
      ...
      return kn.evts = 0, kn.v = 2, kn.SD = vn, kn.qpixelsent = [], G = function ( n ) {
        ...
        var t;
        n && ( t = jn[ n ], t && ( e = T( e, t ) ), e.qacct && delete e.qacct, jn[ n ] = e )
      }, nn = function ( n ) {
        var e, t, r, a, i, o;
        if ( m( n ) ) {
          i = n;
          for ( a in i ) {
            if ( "string" == typeof i[ a ] ) {
              e = n.event || "load", t = n.media || "webpage", "rule" !== e && "load" !== e || "webpage" !== t && "ad" !== t ? C( n ) : ( o = n.qacct || s._qacct, n.qacct = o, r = Pn[ o ], r = r ? T( r, n ) : n, Pn[ o ] = r ), X( n.qacct );
              break
            }
        ...
        var r, a, i, o, u, c;
        for ( r in e ) e.hasOwnProperty( r ) && !n.hasOwnProperty( r ) && ( a = e[ r ], i = t[ r ], o = "", u = !!a && "string" == typeof a, c = !!i && "string" == typeof i, u && ( o = a ), u && c && ( o += "," ), c && ( o += i ), n[ r ] = o )
      }, en = function () {
        var n, e, t = [];
        if ( !( On > 0 ) ) {
          U();
          for ( n in Pn ) Pn.hasOwnProperty( n ) && Pn[ n ] && ( e = Pn[ n ], t.push( e ), delete Pn[ n ] );
        ...
        var a;
        if ( n = s.location.protocol + "//" + n, Sn = Sn || d.scripts[ 0 ], a = d.createElement( "script" ), 1 === h ) a.src = n, a.async = !0, a.onload = e, t && ( a.onerror = function ( n ) {
          a.onerror = null, t( n )
        } ), Sn.parentNode.insertBefore( a, Sn );
        else if ( 2 === h ) {
          var i = !1;
          a.onload = a.onreadystatechange = function () {
            i || "loaded" != a.readyState && "complete" != a.readyState || ( i = !0, a.onreadystatechange = null, e() )
        ...
        if ( ( r = In.call( arguments, 2 ) ) && r.length ) {
          for ( a = r[ 0 ] || G, i = r[ 1 ], o = r[ 2 ], t = o.length, u = 0; u < t; u++ ) s.push( !1 ), f.push( null );
          c = {
            p: n,
            f: s,
            r: a,
        ...
        var t, r, a, i, o, u, c, s = n.a,
          f = n.f,
          l = n.v,
          d = n.r || G;
        if ( t = G( f ), t && ( t = t && d( l ) ), t )
          for ( o = 0; o < s.length; o++ ) try {
            r = s[ o ][ 0 ], a = s[ o ].length > 1 ? s[ o ].slice( 1 ) : [], a = a.concat( n.v ), i = r.apply( null, a ), u = {
              qacct: n.p,
              event: "rule"
            };
            for ( c in i ) i.hasOwnProperty( c ) && "qacct" !== c && ( u[ c ] = i[ c ] );
            e( u )
          } catch ( n ) {
            continue
          }
        ...
        var e, t, r, a = "",
          i = d.cookie;
        return i ? ( e = i.indexOf( n + "=" ), t = e + n.length + 1, e > -1 && ( r = i.indexOf( ";", t ), r < 0 && ( r = i.length ), a = i.substring( t, r ) ), a ) : a
      }, P = function ( n ) {
        ...
        return e = new Date, t = w( "__qca" ), t.length > 0 || Cn ? ( 0 === t.length && ( t = Cn, a[ 1 ] = j( Cn, new Date( e.getTime() + 338688e5 ), sn ) ), a[ 0 ] = ";fpan=0;fpa=" + t ) : ( Cn = P( e ), a[ 1 ] = j( Cn, new Date( e.getTime() + 338688e5 ), sn ), a[ 0 ] = ";fpan=1;fpa=" + Cn ), a
      }, _ = function () {
        var n = S()[ 1 ];
        n && ( d.cookie = n )
      }, b = function ( n ) {
        ...
        var e, t;
        if ( n && "object" === V( n ) )
          for ( t = 0; t < hn.length; t++ ) e = hn[ t ], n.hasOwnProperty( e ) && n[ e ] && delete n[ e ]
      }, x = function ( n, e, t ) {
        var r, a, i;
        return e && "string" == typeof e.qacct ? r = e.qacct : "string" == typeof s._qacct && ( r = s._qacct ), r && 0 !== r.length ? ( e = F( r, e ), delete Pn[ r ], i = jn[ r ], a = En[ r ], m( a ) || ( a = 3 ), cn( e, i, t, r ) ? null : f( n, e, i, r, a, Q() ) ) : null
      }, R = function ( n ) {
        var e, t = [],
          r = [],
          a = [];
        for ( e in n ) n[ e ] && n.hasOwnProperty( e ) && ( "uh" === e || "uht" === e ? r.push( ";" + e + "=" + n[ e ] ) : t.push( e + "=" + n[ e ] ) );
        return a.push( t.join( ";" ) ), a.push( r.join( "" ) ), a
      }, A = function () {
        var n, e, t, r, a, i = d.getElementsByTagName( "meta" ),
          o = "";
        for ( n = 0; n < i.length; n++ ) {
          if ( a = i[ n ], o.length >= 1e3 ) return o;
          m( a ) && m( a.attributes ) && m( a.attributes.property ) && m( a.attributes.property.value ) && m( a.content ) && ( e = a.attributes.property.value, t = a.content, e.length > 3 && "og:" === e.substring( 0, 3 ) && ( o.length > 0 && ( o += "," ), r = t.length > 80 ? 80 : t.length, o += q( e.substring( 3, e.length ) ) + "." + q( t.substring( 0, r ) ) ) )
        }
        return encodeURIComponent( o )
      }, Q = function () {
        var n, e = !1;
        return m( s.external ) && ( n = s.external, e = "function" == typeof n.InPrivateFilteringEnabled && !0 === n.InPrivateFilteringEnabled() ), e || "1" == p.doNotTrack || "yes" === p.doNotTrack || "1" == p.msDoNotTrack
      }, C = function ( n, e ) {
        var t, r, a, i, o, u, c, f, l, h, g = y(),
          q = "",
          w = "",
          _ = "",
          b = "",
          ...
          j = "1",
          P = [];
        if ( mn = 0, m( kn.qpixelsent ) || ( kn.qpixelsent = [] ), m( n ) ) {
          if ( "object" === ( l = V( n ) ) ) a = x( "", n, e );
          else if ( "array" === l )
            for ( o = 0; o < n.length; o++ ) h = x( "." + ( o + 1 ), n[ o ], e ), a = 0 === o ? h : T( a, h )
        } else "string" == typeof _qacct && ( a = x( "", null, e ) );
        a && ( t = p.cookieEnabled ? "1" : "0", void 0 !== p.javaEnabled && ( O = p.javaEnabled() ? "1" : "0" ), m( s._qmeta ) && ( w = ";m=" + encodeURIComponent( s._qmeta ), s._qmeta = null ), self.screen && ( q = screen.width + "x" + screen.height + "x" + screen.colorDepth ), u = new Date, c = v(), f = S()[ 0 ], s.location && s.location.href && ( _ = encodeURIComponent( s.location.href ) ), d && d.referrer && ( E = encodeURIComponent( d.referrer ) ), s.self === s.top && ( j = "0" ), a.url ? b = _ : a.url = _, a.ref || ( a.ref = E || "" ), r = A(), i = R( a ), P.push( "/pixel;r=" + g + ";" + i[ 0 ] ), P.push( i[ 1 ] ), P.push( f ), P.push( ";ns=" + j + ";ce=" + t + ";qjs=1;qv=e576aef5-20210317211205" ), P.push( ( a.ref ? "" : ";ref=" ) + ";d=" + sn + ";je=" + O + ";sr=" + q + ";dst=" + c + ";et=" + u.getTime() + ";tzo=" + u.getTimezoneOffset() + ( b ? ";ourl=" + b : "" ) + w + ";ogl=" + r ), yn.push( P ), k() )
      }, I = function ( n ) {
        pn.consent( function () {
          return !0
        } ).then( function ( n ) {
          return n || b( "__qca" ), n ? "quantserve.com" : "quantcount.com"
        } ).then( function ( e ) {
          var t = pn.parameters,
            r = function () {
              return function () {
                return "quantserve.com" === e ? [ n[ 1 ], n[ 2 ] ].join( "" ) : ";uh=u;uht=u"
              }
            }();
          return ln.image( [ "//pixel.", e, n[ 0 ], r(), n[ 3 ], ";cm=", t.cm, 1 === t.gdpr ? ";gdpr=1;gdpr_consent=" + t.gdpr_consent : ";gdpr=0", t.us_privacy ? ";us_privacy=" + t.us_privacy : "", n[ 4 ] ].join( "" ) ).then( function ( n ) {
            n && "number" == typeof n.width && 3 === n.width ? b( "__qca" ) : "quantserve.com" === e && _()
          } )
        } )
      }, k = function () {
        ...
        m( s._qevents ) || ( s._qevents = [] ), m( s.ezt ) || ( s.ezt = [] ), un( s._qoptions ), un( s.qcdata ), un( s.smarttagdata ), kn.evts || ( on( s._qevents ), on( s.ezt ) ), L( s.ezt ), L( s._qevents ), L( {
          qacct: s._qacct
