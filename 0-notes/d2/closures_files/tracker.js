...
( function ( g, p, n ) {
  "use awesome";
  if ( g.trackJs ) g.console && g.console.warn && g.console.warn( "TrackJS global conflict" );
  else {
    var q = function ( a, b ) {
      this.config = a;
      this.onError = b;
    ...
    q.prototype = {
      ...
      wrap: function ( a ) {
        ...
        var c = this;
        try {
          if ( !e.isFunction( a ) || e.hasOwn( a, "__trackjs__" ) ) return a;
          if ( e.hasOwn( a, "__trackjs_state__" ) ) return a.__trackjs_state__
        } catch ( l ) {
          return a
        }
        var d, f;
        if ( c.config.bindStack ) try {
          throw Error();
        } catch ( l ) {
          f = l.stack, d = e.isoNow()
        }
        for ( var h in a ) e.hasOwn( a, h ) && ( b[ h ] = a[ h ] );
      ...
      wrapEventTarget: function ( a ) {
        ...
        e.has( a, "addEventListener.call" ) &&
          e.has( a, "removeEventListener.call" ) && ( e.patch( a, "addEventListener", function ( a ) {
            return function ( d, f, h, l ) {
              try {
                e.has( f, "handleEvent" ) && ( f.handleEvent = b.wrap( f.handleEvent ) )
              } catch ( k ) {}
              return a.call( this, d, b.wrap( f ), h, l )
            }
    ...
    u.prototype = {
      ...
      defaults: {
        ...
        serialize: function ( a ) {
          function b( a ) {
            ...
            a = a.attributes || [];
            for ( var b = 0; b < a.length; b++ ) c += " " + a[ b ].name + '="' + a[ b ].value + '"';
            return c + ">"
          }
          if ( "" === a ) return "Empty String";
          if ( a === n ) return "undefined";
          if ( e.isString( a ) || e.isNumber( a ) || e.isBoolean( a ) || e.isFunction( a ) ) return "" + a;
          if ( e.isElement( a ) ) return b( a );
          var c;
          try {
            c = JSON.stringify( a, function ( a, c ) {
              return c === n ? "undefined" : e.isNumber( c ) && isNaN( c ) ? "NaN" : e.isError( c ) ? {
                name: c.name,
                message: c.message,
                stack: c.stack
              } : e.isElement( c ) ? b( c ) : c
          ...
          return c.replace( /"undefined"/g, "undefined" ).replace( /"NaN"/g, "NaN" )
        },
        sessionId: "",
        token: "",
        userId: "",
      ...
      initCurrent: function ( a ) {
        if ( this.validate( a, this.defaults, "config", {} ) ) return this.current = e.defaultsDeep( {}, a, this.defaults ), !0;
        this.current = e.defaultsDeep( {}, this.defaults );
        console.log( "init current config", this.current );
        return !1
      },
      setCurrent: function ( a ) {
        return this.validate( a, this.defaults, "config", this.initOnly ) ? ( this.current = e.defaultsDeep( {}, a, this.current ), !0 ) : !1
      },
        ...
        for ( var h in a )
          if ( a.hasOwnProperty( h ) )
            if ( b.hasOwnProperty( h ) ) {
              var e =
                typeof b[ h ];
              e !== typeof a[ h ] ? ( console.warn( c + "." + h + ": property must be type " + e + "." ), f = !1 ) : "[object Array]" !== Object.prototype.toString.call( a[ h ] ) || this.validateArray( a[ h ], b[ h ], c + "." + h ) ? "[object Object]" === Object.prototype.toString.call( a[ h ] ) ? f = this.validate( a[ h ], b[ h ], c + "." + h, d[ h ] ) : d.hasOwnProperty( h ) && ( console.warn( c + "." + h + ": property cannot be set after load." ), f = !1 ) : f = !1
            } else console.warn( c + "." + h + ": property not supported." ), f = !1;
        return f
      },
      validateArray: function ( a, b, c ) {
        ...
        c = c || "";
        for ( var f =
            0; f < a.length; f++ ) e.contains( b, a[ f ] ) || ( console.warn( c + "[" + f + "]: invalid value: " + a[ f ] + "." ), d = !1 );
        return d
      }
    };
    var v = function ( a, b, c, d, f, e, l ) {
      this.util = a;
      this.log = b;
      this.onError = c;
      this.onFault = d;
      this.serialize = f;
      l.enabled && ( e.console = this.wrapConsoleObject( e.console, l ) )
    };
    v.prototype = {
      wrapConsoleObject: function ( a, b ) {
        ...
        var c = a.log || function () {},
          d = this,
          f;
        for ( f = 0; f < b.watch.length; f++ )( function ( f ) {
          var l = a[ f ] || c;
          a[ f ] = function () {
            try {
              ...
              if ( b[ f ] )
                if ( e.isError( a[ 0 ] ) && 1 === a.length ) d.onError( "console", a[ 0 ] );
                else try {
                  throw Error( d.serialize( 1 === a.length ? a[ 0 ] : a ) );
                } catch ( c ) {
                  d.onError( "console", c )
                }
              b.display && ( d.util.hasFunction( l, "apply" ) ? l.apply( this, a ) : l( a[ 0 ] ) )
            } catch ( c ) {
              d.onFault( c )
            }
          }
    ...
    w.prototype = {
      ...
      getCorrelationId: function () {
        ...
        try {
          a = this.document.cookie.replace( /(?:(?:^|.*;\s*)TrackJS\s*\=\s*([^;]*).*$)|^.*$/, "$1" ), a || ( a = this.util.uuid(),
    ...
    y.prototype = {
      discoverDependencies: function () {
        ...
        for ( var b in g )
          if ( "_trackJs" !== b && "_trackJS" !== b && "_trackjs" !== b && "webkitStorageInfo" !== b && "webkitIndexedDB" !== b && "top" !== b && "parent" !== b && "frameElement" !== b ) try {
            if ( g[ b ] ) {
    ...
    z.prototype = {
      ...
      get: function ( a, b ) {
        ...
        for ( d = 0; d < this.appender.length; d++ )
          if ( c = this.appender[ d ], c.category === a && c.key === b ) return c.value;
        return !1
      }
    };
    var A = function ( a, b ) {
      ...
      watch: function () {
        if ( this.isCompatible() ) {
          ...
          g.addEventListener( "popstate", function () {
            var c = e.getLocationURL().relative;
            a.record( "popState",
              b, c );
            b = c
          }, !0 );
          e.forEach( [ "pushState", "replaceState" ], function ( c ) {
            e.patch( history, c, function ( d ) {
              return function () {
                b = e.getLocationURL().relative;
    ...
    B.prototype = {
      ...
      watchFetch: function () {
        ...
        e.patch( g, "fetch", function ( d ) {
          return function ( f, h ) {
            ...
            return m.then( function ( d ) {
              var f = a.get( "n", m.__trackjs_state__ );
              f && ( e.defaults( f, {
                completedOn: e.isoNow(),
                statusCode: d.status,
                statusText: d.statusText
              } ), b.error && 400 <= d.status && ( f = Error( f.statusCode + " " + f.statusText + ": " + f.method + " " + f.url ), f.stack = l, c( "ajax", f ) ) );
              return d
            } )[ "catch" ]( function ( d ) {
              d = d || {};
              var f = a.get( "n", m.__trackjs_state__ );
              ...
              } ), b.error && ( d.message = d.message + ": " + f.method + " " + f.url,
                d.stack = d.stack || l, c( "ajax", d ) ) );
              throw d;
            } )
          }
        } )
      ...
      watchNetworkObject: function ( a ) {
        ...
        a.prototype.open = function ( a, b ) {
          var d = ( b || "" ).toString();
          0 > d.indexOf( "localhost:0" ) && ( this._trackJs = {
            method: a,
            url: d
          } );
    ...
    r.prototype = {
      ...
      getCORSRequest: function ( a, b ) {
        var c;
        this.util.testCrossdomainXhr() ? ( c = new g.XMLHttpRequest, c.open( a, b ), c.setRequestHeader( "Content-Type", "text/plain" ) ) : "undefined" !==
          typeof g.XDomainRequest ? ( c = new g.XDomainRequest, c.open( a, b ) ) : c = null;
        return c
      },
    ...
    var e = function () {
        function a( c, d, f, h ) {
          ...
          e.forEach( d, function ( d ) {
            e.forEach( e.keys( d ),
              function ( e ) {
                null === d[ e ] || d[ e ] === n ? c[ e ] = d[ e ] : f && 10 > h && "[object Object]" === b( d[ e ] ) ? ( c[ e ] = c[ e ] || {}, a( c[ e ], [ d[ e ] ], f, h + 1 ) ) : c.hasOwnProperty( e ) || ( c[ e ] = d[ e ] )
              } )
          } );
          return c
        }
        ...
        return {
          ...
          isError: function ( a ) {
            ...
            var d = b( a );
            return "[object Error]" === d || "[object DOMException]" === d || e.isString( a.name ) && e.isString( a.message )
          },
    ...
    C.prototype = {
      initialize: function ( a ) {
        var b =
          this.util.bind( this.onDocumentClicked, this ),
      ...
      onDocumentClicked: function ( a ) {
        try {
          ...
          b && b.tagName && ( this.isDescribedElement( b, "a" ) || this.isDescribedElement( b, "button" ) || this.isDescribedElement( b, "input", [ "button", "submit" ] ) ? this.writeVisitorEvent( b, "click" ) : this.isDescribedElement( b,
            "input", [ "checkbox", "radio" ] ) && this.writeVisitorEvent( b, "input", b.value, b.checked ) )
        } catch ( c ) {
          this.onFault( c )
        }
      },
      onInputChanged: function ( a ) {
        try {
          ...
          else this.isDescribedElement( b, "input" ) && !this.isDescribedElement( b, "input", [ "button", "submit", "hidden", "checkbox", "radio" ] ) &&
      ...
      writeVisitorEvent: function ( a, b, c, d ) {
        "password" === this.getElementType( a ) && ( c = n );
        this.log.add( "v", {
      ...
      getElementAttributes: function ( a ) {
        for ( var b = {}, c = Math.min( a.attributes.length, 10 ),
            d = 0; d < c; d++ ) {
          var f = a.attributes[ d ];
          e.contains( [ "data-value", "value" ], f.name.toLowerCase() ) || ( b[ f.name ] = e.truncate( f.value, 100 ) )
        }
        return b
      },
    ...
    var D = function ( a, b, c, d, f ) {
      ...
      this.onFault = b;
      this.serialize = c;
      f.enabled && this.watchWindowErrors( d );
      f.promise && this.watchPromiseErrors( d )
    };
    D.prototype = {
      ...
      watchWindowErrors: function ( a ) {
        ...
        e.patch( a, "onerror", function ( a ) {
          return function ( d, f, e, g, k ) {
            try {
              k = k || {}, k.message = k.message || b.serialize( d ), k.name = k.name || "Error", k.line = k.line || parseInt( e, 10 ) || null, k.column = k.column || parseInt( g, 10 ) || null, "[object Event]" !== Object.prototype.toString.call( d ) || f ? k.file = k.file || b.serialize( f ) : k.file = ( d.target || {} ).src, b.onError( "window", k )
            } catch ( m ) {
              b.onFault( m )
            }
    ...
    var E = function ( a, b, c, d, f, h, g, k, m, x, n, p, q, r, u, v ) {
      try {
        if ( this.window = r,
    ...
    E.prototype = {
      reveal: function () {
        if ( this.customer.token ) return this.api.addMetadata = this.metadata.addMetadata, this.api.removeMetadata = this.metadata.removeMetadata, this.api;
      ...
      onError: function () {
        ...
        return function ( c, d, f ) {
          if ( e.isBrowserSupported() && this.config.current.enabled ) try {
            if ( f = f || {
                bindStack: null,
                bindTime: null,
                force: !1
                ...
                name: "Error",
                message: this.serialize( d, f.force )
              } ), -1 === d.message.indexOf( "TrackJS Caught" ) )
              if ( b && -1 !== d.message.indexOf( "Script error" ) ) b = !1;
              else {
                ...
                if ( !f.force ) try {
                  if ( !this.config.current.onError( h, d ) ) return
                } catch ( m ) {
                  h.console.push( {
                    timestamp: this.util.isoNow(),
                    severity: "error",
                ...
                if ( this.config.current.dedupe ) {
                  ...
                  for ( var b = 0; a() && b < h.console.length; ) h.console[ b ].message = e.truncate( h.console[ b ].message, 1E3 ), b++
                } )();
                this.log.clear();
                setTimeout( function () {
                  b = !1
      ...
      onFault: function ( a ) {
        ...
        a = {
          ...
          v: "2.13.0",
          h: "cf5eb1dd03481f71da0c2bb4dc6e302cb0e969d1",
          x: this.util.uuid()
        };
        b.sendTrackerFault( a )
      },
      serialize: function ( a, b ) {
        if ( this.config.current.serialize && !b ) try {
    ...
    q = new E( g._trackJs || g._trackJS || g._trackjs || {}, function ( a, b, c, d ) {
      return {
        ...
        watchAll: function ( a ) {
          var d = Array.prototype.slice.call( arguments, 1 ),
            e;
          for ( e in a ) "function" === typeof a[ e ] && ( b.contains( d, e ) || function () {
            var d = a[ e ];
            a[ e ] = function () {
              try {
        ...
        hash: "cf5eb1dd03481f71da0c2bb4dc6e302cb0e969d1",
        version: "2.13.0"
      }
      ...
      return {
        ...
        report: function () {
          var c = [],
            d;
          for ( d in b ) b.hasOwnProperty( d ) && c.push( {
            key: d,
            value: a( b[ d ] )
          } );
          return c
