window.__adroll || ( function () {
  function f() {
    ...
    this._has_global( "adroll_adv_id" ) && ( this.load_experiment_js(),
      this.init_pixchk(), this._load_precheck_js(), this.trigger_gtm_consent_event(), this.load_pixel_assistant(), [ "adroll_adv_id", "adroll_pix_id" ].forEach( function ( a ) {
  ...
  f.prototype.save_first_party_consent = function ( a ) {
    var b = ( a || {} ).euconsent;
    ( ( a = ( a || {} ).arconsent ) || b ) && window.localStorage.setItem( "__adroll_consent_data", this.jsonStringify( {
      arconsent: a,
      euconsent: b
    } ) )
  };
  f.prototype.get_first_party_consent = function () {
    ...
    try {
      ...
      if ( a ) return this._set_global( "__adroll_consent_data", this.jsonParse( a ) ), this._global( "__adroll_consent_data" )
    } catch ( b ) {}
    return null
  };
  ...
  f.prototype.set_consent = function ( a, b, c, d, e, m ) {
    ...
    c && ( "adroll" ===
      ( m || {} ).banner || b ) && this.load_consent_banner();
    ...
    null === a ? this.handle_null_consent( b ) : ( this.save_first_party_consent( m ), b || this.clear_consent_params(), this._trigger_consent_event && this._trigger_consent_event(), !1 !== a && !1 !== ( a || {} ).a && ( this.set_first_party_cookie(), this.trigger_gtm_consent_event( p ), this.call_next_tpc() ) )
  };
  f.prototype._load_precheck_js = function () {
    return this.add_script_element( "https://s.adroll.com/j/pre/" + window.adroll_adv_id + "/" + window.adroll_pix_id + "/index.js" )
  };
    ...
    this.jsonStringifyFunc = a || a.stringify && "function" === typeof a.stringify ? a.stringify : function () {
      ...
      return function r( k ) {
        ...
        if ( "object" === typeof k ) {
          ...
          if ( d( k ) ) {
            for ( var g = "[", h = 0; h < k.length; h++ ) g += ( h ? ", " : "" ) + r( k[ h ] );
            return g + "]"
          }
          if ( "[object Object]" === c.call( k ) ) {
            g = [];
            for ( h in k ) k.hasOwnProperty( h ) && g.push( r( h ) + ": " + r( k[ h ] ) );
            return "{" + g.join( ", " ) + "}"
          }
        }
  ...
  f.prototype.maybe_apply_click_macro = function ( a ) {
    ...
    if ( b ) {
      ...
      if ( this.endswith( c.path, ".re" ) || this.endswith( c.path, ".dy" ) || this.endswith( c.path, ".tp" ) ) return this.apply_exchange_macro( a, b )
    }
    return a
  };
  f.prototype.macro_url_params = function ( a, b, c, d, e ) {
    ...
    !h && e && g.push( [ "desturl", "" ] );
    k && 0 === k.indexOf( "http" ) ? ( e = m, "g" === this._global( "adroll_ext_network" ) && ( e = d ? function ( a ) {
      return a
    } : window.unescape ), g.push( [ "clickurl", e( k ) ] ) ) : h && e && g.push( [ "clickurl", "" ] );
    ...
    r && ( a = this.parseUri( window.unescape( r ) ), g.push( [ "site_url", m( "http://" + a.host ) ] ), c && ( g.push( [ "adroll_width", m( this._global( "adroll_width" ) ) ] ), g.push( [ "adroll_height", m( this._global( "adroll_height" ) ) ] ) ) );
  ...
  f.prototype.md5 = function () {
    ...
    return function ( a ) {
      ...
      for ( d = 64; d <= b.length; d += 64 ) {
        for ( var e = b.substring( d - 64, d ), l = [], q = void 0, q = 0; 64 > q; q += 4 ) l[ q >> 2 ] = e.charCodeAt( q ) + ( e.charCodeAt( q + 1 ) << 8 ) + ( e.charCodeAt( q + 2 ) << 16 ) + ( e.charCodeAt( q + 3 ) << 24 );
        m( a, l )
      }
      b = b.substring( d - 64 );
      ...
      for ( b = 0; b < a.length; b++ ) {
        ...
        e = a[ b ];
        l = "";
        for ( q = 0; 4 > q; q++ ) l += p[ e >> 8 * q + 4 & 15 ] + p[ e >> 8 * q & 15 ];
        c[ d ] = l
      }
      return a.join( "" )
    }
  ...
  f.prototype.extract_pid = function ( a, b, c ) {
    ...
    g && ( m = g.product_id, e = g.product_group, p = g.product_action, r = g.adroll_product_category_id );
  ...
  f.prototype.render_pixel_code_exec = function ( a, b ) {
    ...
    this.addLoadEvent( function ( m ) {
      return function () {
        ...
        try {
          m._has_global( "adroll_shop_id" ) && ( r = {}, m._has_global( "adroll_custom_data" ) ? r = m._global( "adroll_custom_data" ) : m._set_global( "adroll_custom_data", r ), "undefined" === typeof r.adroll_shop_id && ( r.adroll_shop_id = m._global( "adroll_shop_id" ) ) );
  ...
  f.prototype.get_base_url = function ( a, b, c, d, e, m ) {
    ...
    var p = r + "no-cookies=1&pv=",
      k = "";
    this.cookieEnabled( !1 ) ? ( k = window.escape( this.get_eids() ), a += r + "pv=" + this.pv + "&cookie=" + k ) : a += p + this.pv;
    m && ( a += "&" + m.join( "&" ) );
  ...
  f.prototype._send_plain_text_identifiers = function ( a, b, c ) {
    ( a || b ) && c && ( c = "/id/" + this._global( "adroll_adv_id" ) + "/?idsource=" + c, a && ( a = a.replace( /^\s+|\s+$/g, "" ).toLowerCase(), c += "&email=" + window.encodeURIComponent( a ) + "&hashed_email=" + this.md5( a ), a = a.split( "@" )[ 1 ], c += "&email_domain=" + window.encodeURIComponent( a ) ), b && ( c += "&user_identifier=" + window.encodeURIComponent( b ) ), this.imgRequest( this._srv( c ) ) )
  };
  ...
  f.prototype._get_arrfrr = function ( a ) {
    ...
    if ( 1 < b.length ) {
      var d = b[ 1 ].replace( /([^&=]+)=([^&]+)/g, function ( a, b, d ) {
        return b.match( /cc_number|credit_card|card_number|cv[cv]_code/ ) || c.is_luhn( unescape( d ) ) ? b + "=NR_REDACT" : b + "=" + d
      } );
      b[ 1 ] !== d && ( a = b[ 0 ] + "?" + d )
    }
    return a
  ...
  f.prototype.b64toint = function ( a ) {
    ...
    for ( var e = 0; e < a.length; e++ ) d = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf( a[ e ] ).toString( 2 ), c = c + b( "0", 6 - d.length ) + d;
    return parseInt( c, 2 )
  };
  ...
  f.prototype.add_tpc_to_url = function ( a ) {
    ...
    0 < ( this._global( "__adroll_xid_ch" ) || 0 ) && ( b = b + "&xid_src=" + ( 1 === this._global( "__adroll_xid_ch" ) ? "cache" : "srv" ) );
  ...
  f.prototype.add_consent_to_url = function ( a ) {
    ...
    var c = a.match( /^\w+:\/\/([^/]+)/ );
    if ( c && "d.adroll.com" !== c[ 1 ] && "d.adroll.mgr.consensu.org" !== c[ 1 ] ) return a;
    c = -1 === a.indexOf( "?" ) ? "?" : "&";
  ...
  f.prototype.call_consent_check = function () {
    ...
    a = this.add_consent_to_url( "https://d.adroll.mgr.consensu.org/consent/iabcheck/" + this._global( "adroll_adv_id" ) + "?" + a.join( "&" ) );
      ...
      if ( d )
        if ( window.RetrieveAdID ) {
          ...
          window.RetrieveAdID( function ( a ) {
            a && ( c._set_global( "__adroll_xid_ch", 1 ), window.clearTimeout( e ), c.set_tpc( "xavier", a ) )
          }, function ( a ) {
...
( function ( a ) {
  a.adroll_optout = !1;
  "2.0" === a.adroll_version ? a.console && a.console.debug && a.console.debug( "Both the NextRoll v1 and v2 pixel detected?" ) : ( a.adroll_ext_network = null, a.adroll_callbacks = "undefined" === typeof a.adroll_callbacks ? [] : a.adroll_callbacks, a.__adroll.render_pixel_code( a.adroll_adv_id, a.adroll_pix_id ) )
} )( window );
