( window[ "canvasWebpackJsonp" ] = window[ "canvasWebpackJsonp" ] || [] ).push( [
  [ 22 ], {
    Sv6n: function ( t, e, i ) {
      ...
      function l( t ) {
        t = t.cloneNode( false )
        return t.hash.length > 1 && t.href.replace( r, "" ) === location.href.replace( r, "" )
      }
      s.a.widget( "ui.tabs", {
        version: "@VERSION",
        delay: 300,
        ...
        _create: function () {
          var t = this,
            ...
            i = e.active
          this.running = false
          this.element.addClass( "ui-tabs ui-widget ui-widget-content ui-corner-all" ).toggleClass( "ui-tabs-collapsible", e.collapsible ).delegate( ".ui-tabs-nav > li", "mousedown" + this.eventNamespace, ( function ( t ) {
            s()( this ).is( ".ui-state-disabled" ) && t.preventDefault()
          } ) ).delegate( ".ui-tabs-anchor", "focus" + this.eventNamespace, ( function () {
            s()( this ).closest( "li" ).is( ".ui-state-disabled" ) && this.blur()
          } ) ).delegate( ".ui-tabs-nav > li", "click" + this.eventNamespace, ( function ( t ) {
            var e = s()( this )
            if ( e.is( t.target ) ) {
              var i = e.find( ".ui-tabs-anchor:visible" ).first()
          ...
          this._processTabs()
          if ( null === i ) {
            location.hash && this.anchors.each( ( function ( t, e ) {
          ...
          if ( false !== i ) {
            i = this.tabs.eq( i ).index(); - 1 === i && ( i = !e.collapsible && 0 )
          }
          e.active = i!e.collapsible && false === e.active && this.anchors.length && ( e.active = 0 )
          s.a.isArray( e.disabled ) && ( e.disabled = s.a.unique( e.disabled.concat( s.a.map( this.tabs.filter( ".ui-state-disabled" ), ( function ( e ) {
        ...
        _tabKeydown: function ( t ) {
          var e = s()( this.document[ 0 ].activeElement ).closest( "li" ),
            i = this.tabs.index( e ),
            a = true
        ...
        _panelKeydown: function ( t ) {
          if ( this._handlePageNav( t ) ) return
          if ( t.ctrlKey && t.keyCode === s.a.ui.keyCode.UP ) {
            t.preventDefault()
            this.active.focus()
          }
        },
        _handlePageNav: function ( t ) {
          if ( t.altKey && t.keyCode === s.a.ui.keyCode.PAGE_UP ) {
            this._activate( this._focusNextTab( this.options.active - 1, false ) )
            return true
          }
          if ( t.altKey && t.keyCode === s.a.ui.keyCode.PAGE_DOWN ) {
        ...
        _findNextTab: function ( t, e ) {
          ...
          while ( -1 !== s.a.inArray( a(), this.options.disabled ) ) t = e ? t + 1 : t - 1
          return t
        },
        ...
        refresh: function () {
          ...
          t.disabled = s.a.map( e.filter( ".ui-state-disabled" ), ( function ( t ) {
            return e.index( t )
          } ) )
          this._processTabs()
          if ( false !== t.active && this.anchors.length )
            if ( this.active.length && !s.a.contains( this.tablist[ 0 ], this.active[ 0 ] ) )
              if ( this.tabs.length === t.disabled.length ) {
                t.active = false
                this.active = s()()
              } else this._activate( this._findNextTab( Math.max( 0, t.active - 1 ), false ) )
        ...
        _processTabs: function () {
          ...
          this.anchors.each( ( function ( e, i ) {
            var a, n, r, o = s()( i ).uniqueId().attr( "id" ),
              h = s()( i ).closest( "li" ),
            ...
            if ( l( i ) ) {
              ...
              if ( !n.length ) {
                n = t._createPanel( r )
                n.insertAfter( t.panels[ e - 1 ] || t.tablist )
              }
        ...
        _createPanel: function ( t ) {
          return s()( "<div>" ).attr( "id", t ).addClass( "ui-tabs-panel ui-widget-content ui-corner-bottom" ).data( "ui-tabs-destroy", true )
        },
        _setupDisabled: function ( t ) {
          s.a.isArray( t ) && ( t.length ? t.length === this.anchors.length && ( t = true ) : t = false )
        ...
        _setupEvents: function ( t ) {
          ...
          t && s.a.each( t.split( " " ), ( function ( t, i ) {
            e[ i ] = "_eventHandler"
          } ) )
        ...
        _setupHeightStyle: function ( t ) {
          var e, i, a = this.element.parent()
          if ( "fill" === t ) {
            if ( !s.a.support.minHeight ) {
              i = a.css( "overflow" )
            ...
            this.element.children().not( this.panels ).each( ( function () {
              e -= s()( this ).outerHeight( true )
            } ) )
            this.panels.each( ( function () {
              s()( this ).height( Math.max( 0, e - s()( this ).innerHeight() + s()( this ).height() ) )
            } ) ).css( "overflow", "auto" )
          } else if ( "auto" === t ) {
            e = 0
            this.panels.each( ( function () {
              e = Math.max( e, s()( this ).height( "" ).height() )
            } ) ).height( e )
          }
        },
        _eventHandler: function ( t ) {
          var e = this.options,
            ...
            r = n[ 0 ] === i[ 0 ],
            o = r && e.collapsible,
            l = o ? s()() : this._getPanelForTab( n ),
            h = i.length ? this._getPanelForTab( i ) : s()(),
            u = {
              oldTab: i,
              oldPanel: h,
              newTab: o ? s()() : n,
        ...
        _toggle: function ( t, e ) {
          ...
          if ( n.length && this.options.hide ) this._hide( n, this.options.hide, ( function () {
          ...
          a.length && n.length ? e.oldTab.attr( "tabIndex", -1 ) : a.length && this.tabs.filter( ( function () {
        ...
        _activate: function ( t ) {
          ...
          this._eventHandler( {
            target: e,
            currentTarget: e,
            preventDefault: s.a.noop
          } )
        },
        _findActive: function ( t ) {
          return false === t ? s()() : this.tabs.eq( t )
        },
        ...
        _destroy: function () {
          ...
          this.tabs.add( this.panels ).each( ( function () {
            s.a.data( this, "ui-tabs-destroy" ) ? s()( this ).remove() : s()( this ).removeClass( "ui-state-default ui-state-active ui-state-disabled ui-corner-top ui-corner-bottom ui-widget-content ui-tabs-active ui-tabs-panel" ).removeAttr( "tabIndex" ).removeAttr( "aria-live" ).removeAttr( "aria-busy" ).removeAttr( "aria-selected" ).removeAttr( "aria-labelledby" ).removeAttr( "aria-hidden" ).removeAttr( "aria-expanded" ).removeAttr( "role" )
          } ) )
        ...
        enable: function ( t ) {
          ...
          if ( void 0 === t ) e = false
            ...
            t = this._getIndex( t )
            e = s.a.isArray( e ) ? s.a.map( e, ( function ( e ) {
              return e !== t ? e : null
            } ) ) : s.a.map( this.tabs, ( function ( e, i ) {
              return i !== t ? i : null
            } ) )
          }
          this._setupDisabled( e )
        ...
        disable: function ( t ) {
          ...
          if ( void 0 === t ) e = true
            ...
            e = s.a.isArray( e ) ? s.a.merge( [ t ], e ).sort() : [ t ]
          }
          this._setupDisabled( e )
        },
        load: function ( t, e ) {
          ...
          this.xhr = s.a.ajax( {
            ...
            beforeSend: function ( t, a ) {
              return i._trigger( "beforeLoad", e, s.a.extend( {
                jqXHR: t,
                ajaxSettings: a
              }, o ) )
            }
      ...
      if ( false !== s.a.uiBackCompat ) {
        s.a.ui.tabs.prototype._ui = function ( t, e ) {
          return {
            tab: t,
            panel: e,
        ...
        s.a.widget( "ui.tabs", s.a.ui.tabs, {
          url: function ( t, e ) {
        ...
        s.a.widget( "ui.tabs", s.a.ui.tabs, {
          ...
          _create: function () {
            ...
            var t = this
            this._on( {
              tabsbeforeload: function ( e, i ) {
                if ( s.a.data( i.tab[ 0 ], "cache.tabs" ) ) {
                  e.preventDefault()
                  return
                }
                s.a.extend( i.ajaxSettings, t.options.ajaxOptions, {
                  error: function ( e, a, s ) {
                    try {
                      t.options.ajaxOptions.error( e, a, i.tab.closest( "li" ).index(), i.tab[ 0 ] )
                    } catch ( s ) {}
                  }
                } )
                i.jqXHR.success( ( function () {
                  t.options.cache && s.a.data( i.tab[ 0 ], "cache.tabs", true )
                } ) )
              }
            } )
          },
          _setOption: function ( t, e ) {
            "cache" === t && false === e && this.anchors.removeData( "cache.tabs" )
            this._super( t, e )
          },
          _destroy: function () {
        ...
        s.a.widget( "ui.tabs", s.a.ui.tabs, {
          ...
          enable: function ( t ) {
            ...
            ( t && true === i.disabled || s.a.isArray( i.disabled ) && -1 !== s.a.inArray( t, i.disabled ) ) && ( e = true )
            this._superApply( arguments )
            e && this._trigger( "enable", null, this._ui( this.anchors[ t ], this.panels[ t ] ) )
          },
          disable: function ( t ) {
            var e, i = this.options;
            ( t && false === i.disabled || s.a.isArray( i.disabled ) && -1 === s.a.inArray( t, i.disabled ) ) && ( e = true )
            this._superApply( arguments )
        ...
        s.a.widget( "ui.tabs", s.a.ui.tabs, {
          ...
          add: function ( t, e, i ) {
            ...
            var a, n, r = this.options,
              o = s()( r.tabTemplate.replace( /#\{href\}/g, t ).replace( /#\{label\}/g, e ) ),
              l = t.indexOf( "#" ) ? this._tabId( o ) : t.replace( "#", "" )
            ...
            if ( !n.length ) {
              n = this._createPanel( l )
              a ? i > 0 ? n.insertAfter( this.panels.eq( -1 ) ) : n.appendTo( this.element ) : n.insertBefore( this.panels[ i ] )
            }
            n.addClass( "ui-tabs-panel ui-widget-content ui-corner-bottom" ).hide()
            a ? o.appendTo( this.tablist ) : o.insertBefore( this.tabs[ i ] )
            r.disabled = s.a.map( r.disabled, ( function ( t ) {
              return t >= i ? ++t : t
            } ) )
            this.refresh()
        ...
        s.a.widget( "ui.tabs", s.a.ui.tabs, {
          ...
          _createPanel: function ( t ) {
            return s()( this.options.panelTemplate ).attr( "id", t ).addClass( "ui-tabs-panel ui-widget-content ui-corner-bottom" ).data( "ui-tabs-destroy", true )
          }
        } )
        s.a.widget( "ui.tabs", s.a.ui.tabs, {
          _create: function () {
        ...
        s.a.widget( "ui.tabs", s.a.ui.tabs, {
          ...
          _create: function () {
            this._super()
            false !== this.options.active && this._trigger( "show", null, this._ui( this.active.find( ".ui-tabs-anchor" )[ 0 ], this._getPanelForTab( this.active )[ 0 ] ) )
          },
          _trigger: function ( t, e, i ) {
            var a = this._superApply( arguments )
            if ( !a ) return false "beforeActivate" === t && i.newTab.length ? a = this._super( "select", e, {
        ...
        h = 0, s.a.widget( "ui.tabs", s.a.ui.tabs, {
          options: {
            cookie: null
          },
          _create: function () {
            var t, e = this.options
            if ( null == e.active && e.cookie ) {
              t = parseInt( this._cookie(), 10 ); - 1 === t && ( t = false )
              e.active = t
            }
            this._super()
          },
          _cookie: function ( t ) {
            var e = [ this.cookie || ( this.cookie = this.options.cookie.name || "ui-tabs-" + ++h ) ]
            if ( arguments.length ) {
              e.push( false === t ? -1 : t )
              e.push( this.options.cookie )
            }
            return s.a.cookie.apply( null, e )
          },
          _refresh: function () {
            this._super()
        ...
        s.a.widget( "ui.tabs", s.a.ui.tabs, {
          _trigger: function ( t, e, i ) {
            ...
            if ( "load" === t ) {
              a.panel = a.panel[ 0 ]
              a.tab = a.tab.find( ".ui-tabs-anchor" )[ 0 ]
            }
        ...
        s.a.widget( "ui.tabs", s.a.ui.tabs, {
          ...
          _toggle: function ( t, e ) {
            ...
            function o() {
              e.newTab.closest( "li" ).addClass( "ui-tabs-active ui-state-active" )
              if ( a.length && n.show ) a.animate( n.show, n.show.duration, ( function () {
                r()
              } ) )
              else {
                a.show()
            ...
            if ( s.length && n.hide ) s.animate( n.hide, n.hide.duration, ( function () {
              e.oldTab.closest( "li" ).removeClass( "ui-tabs-active ui-state-active" )
              o()
            } ) )
            else {
...
//# sourceMappingURL=22-c-e8cd9231ba.js.map
