( window[ "canvasWebpackJsonp" ] = window[ "canvasWebpackJsonp" ] || [] ).push( [
  [ 0 ], {
    ...
    VHne: function ( t, e, i ) {
      ...
      i( "ZV2x" )
      i( "vTtS" )
      o.a.widget( "ui.draggable", o.a.ui.mouse, {
        version: "@VERSION",
        ...
        _mouseCapture: function ( t ) {
          ...
          o()( true === e.iframeFix ? "iframe" : e.iframeFix ).each( ( function () {
            o()( '<div class="ui-draggable-iframeFix" style="background: #fff;"></div>' ).css( {
              width: this.offsetWidth + "px",
              height: this.offsetHeight + "px",
              position: "absolute",
              opacity: "0.001",
              zIndex: 1e3
            } ).css( o()( this ).offset() ).appendTo( "body" )
          } ) )
          return true
        },
        _mouseStart: function ( t ) {
          ...
          if ( false === this._trigger( "start", t ) ) {
            this._clear()
            return false
          }
          this._cacheHelperProportions()
        ...
        _mouseDrag: function ( t, e ) {
          ...
          if ( !e ) {
            var i = this._uiHash()
            if ( false === this._trigger( "drag", t, i ) ) {
              this._mouseUp( {} )
              return false
            }
        ...
        _mouseStop: function ( t ) {
          ...
          if ( "invalid" == this.options.revert && !e || "valid" == this.options.revert && e || true === this.options.revert || o.a.isFunction( this.options.revert ) && this.options.revert.call( this.element, e ) ) {
            var n = this
            o()( this.helper ).animate( this.originalPosition, parseInt( this.options.revertDuration, 10 ), ( function () {
              false !== n._trigger( "stop", t ) && n._clear()
            } ) )
          } else false !== this._trigger( "stop", t ) && this._clear()
          return false
        },
        _mouseUp: function ( t ) {
          true === this.options.iframeFix && o()( "div.ui-draggable-iframeFix" ).each( ( function () {
            this.parentNode.removeChild( this )
          } ) )
          o.a.ui.ddmanager && o.a.ui.ddmanager.dragStop( this, t )
          return o.a.ui.mouse.prototype._mouseUp.call( this, t )
        },
        cancel: function () {
        ...
        _getHandle: function ( t ) {
          var e = !this.options.handle || !o()( this.options.handle, this.element ).length
          o()( this.options.handle, this.element ).find( "*" ).andSelf().each( ( function () {
            this == t.target && ( e = true )
          } ) )
          return e
        },
        ...
        _getParentOffset: function () {
          ...
          if ( "absolute" == this.cssPosition && this.scrollParent[ 0 ] != document && o.a.contains( this.scrollParent[ 0 ], this.offsetParent[ 0 ] ) ) {
            t.left += this.scrollParent.scrollLeft()
            t.top += this.scrollParent.scrollTop()
          }( this.offsetParent[ 0 ] == document.body || this.offsetParent[ 0 ].tagName && "html" == this.offsetParent[ 0 ].tagName.toLowerCase() && o.a.browser.msie ) && ( t = {
            top: 0,
            left: 0
          } )
          return {
        ...
        _setContainment: function () {
          var t = this.options "parent" == t.containment && ( t.containment = this.helper[ 0 ].parentNode )
        ...
        _convertPositionTo: function ( t, e ) {
          ...
          this.options
          var s = "absolute" != this.cssPosition || this.scrollParent[ 0 ] != document && o.a.contains( this.scrollParent[ 0 ], this.offsetParent[ 0 ] ) ? this.scrollParent : this.offsetParent,
        ...
        _generatePosition: function ( t ) {
          var e = this.options,
            i = "absolute" != this.cssPosition || this.scrollParent[ 0 ] != document && o.a.contains( this.scrollParent[ 0 ], this.offsetParent[ 0 ] ) ? this.scrollParent : this.offsetParent,
          ...
          if ( this.originalPosition ) {
            ...
            if ( this.containment ) {
              ...
              t.pageY - this.offset.click.top > r[ 3 ] && ( a = r[ 3 ] + this.offset.click.top )
            }
            if ( e.grid ) {
              var h = e.grid[ 1 ] ? this.originalPageY + Math.round( ( a - this.originalPageY ) / e.grid[ 1 ] ) * e.grid[ 1 ] : this.originalPageY
              ...
              n = r && ( u - this.offset.click.left < r[ 0 ] || u - this.offset.click.left > r[ 2 ] ) ? u - this.offset.click.left < r[ 0 ] ? u + e.grid[ 0 ] : u - e.grid[ 0 ] : u
            }
          }
          return {
            top: a - this.offset.click.top - this.offset.relative.top - this.offset.parent.top + ( "fixed" == this.cssPosition ? -this.scrollParent.scrollTop() : s ? 0 : i.scrollTop() ),
        ...
        _trigger: function ( t, e, i ) {
          ...
          return o.a.Widget.prototype._trigger.call( this, t, e, i )
        },
        plugins: {},
        _uiHash: function ( t ) {
          return {
      ...
      o.a.ui.plugin.add( "draggable", "connectToSortable", {
        start: function ( t, e ) {
          var i = o()( this ).data( "draggable" ),
            s = i.options,
            n = o.a.extend( {}, e, {
              item: i.element
            } )
          i.sortables = []
          o()( s.connectToSortable ).each( ( function () {
            var e = o.a.data( this, "sortable" )
        ...
        drag: function ( t, e ) {
          var i = o()( this ).data( "draggable" ),
            s = this
          o.a.each( i.sortables, ( function ( n ) {
      ...
      o.a.ui.plugin.add( "draggable", "cursor", {
        start: function ( t, e ) {
          var i = o()( "body" ),
            s = o()( this ).data( "draggable" ).options
          i.css( "cursor" ) && ( s._cursor = i.css( "cursor" ) )
          i.css( "cursor", s.cursor )
        },
        stop: function ( t, e ) {
          var i = o()( this ).data( "draggable" ).options
          i._cursor && o()( "body" ).css( "cursor", i._cursor )
        }
      } )
      o.a.ui.plugin.add( "draggable", "opacity", {
        start: function ( t, e ) {
          var i = o()( e.helper ),
            s = o()( this ).data( "draggable" ).options
      ...
      o.a.ui.plugin.add( "draggable", "scroll", {
        start: function ( t, e ) {
          var i = o()( this ).data( "draggable" )
        ...
        drag: function ( t, e ) {
          ...
          if ( i.scrollParent[ 0 ] != document && "HTML" != i.scrollParent[ 0 ].tagName ) {
            s.axis && "x" == s.axis || ( i.overflowOffset.top + i.scrollParent[ 0 ].offsetHeight - t.pageY < s.scrollSensitivity ? i.scrollParent[ 0 ].scrollTop = n = i.scrollParent[ 0 ].scrollTop + s.scrollSpeed : t.pageY - i.overflowOffset.top < s.scrollSensitivity && ( i.scrollParent[ 0 ].scrollTop = n = i.scrollParent[ 0 ].scrollTop - s.scrollSpeed ) )
            s.axis && "y" == s.axis || ( i.overflowOffset.left + i.scrollParent[ 0 ].offsetWidth - t.pageX < s.scrollSensitivity ? i.scrollParent[ 0 ].scrollLeft = n = i.scrollParent[ 0 ].scrollLeft + s.scrollSpeed : t.pageX - i.overflowOffset.left < s.scrollSensitivity && ( i.scrollParent[ 0 ].scrollLeft = n = i.scrollParent[ 0 ].scrollLeft - s.scrollSpeed ) )
          } else {
            s.axis && "x" == s.axis || ( t.pageY - o()( document ).scrollTop() < s.scrollSensitivity ? n = o()( document ).scrollTop( o()( document ).scrollTop() - s.scrollSpeed ) : o()( window ).height() - ( t.pageY - o()( document ).scrollTop() ) < s.scrollSensitivity && ( n = o()( document ).scrollTop( o()( document ).scrollTop() + s.scrollSpeed ) ) )
            s.axis && "y" == s.axis || ( t.pageX - o()( document ).scrollLeft() < s.scrollSensitivity ? n = o()( document ).scrollLeft( o()( document ).scrollLeft() - s.scrollSpeed ) : o()( window ).width() - ( t.pageX - o()( document ).scrollLeft() ) < s.scrollSensitivity && ( n = o()( document ).scrollLeft( o()( document ).scrollLeft() + s.scrollSpeed ) ) )
          }
          false !== n && o.a.ui.ddmanager && !s.dropBehaviour && o.a.ui.ddmanager.prepareOffsets( i, t )
        }
      } )
      o.a.ui.plugin.add( "draggable", "snap", {
        start: function ( t, e ) {
          var i = o()( this ).data( "draggable" ),
            s = i.options
          i.snapElements = []
          o()( s.snap.constructor != String ? s.snap.items || ":data(draggable)" : s.snap ).each( ( function () {
            var t = o()( this )
            var e = t.offset()
        ...
        drag: function ( t, e ) {
          ...
          var a = e.offset.left,
            r = a + i.helperProportions.width,
            l = e.offset.top,
            h = l + i.helperProportions.height
          for ( var u = i.snapElements.length - 1; u >= 0; u-- ) {
            var p = i.snapElements[ u ].left,
              d = p + i.snapElements[ u ].width,
              c = i.snapElements[ u ].top,
              f = c + i.snapElements[ u ].height
            if ( !( p - n < a && a < d + n && c - n < l && l < f + n || p - n < a && a < d + n && c - n < h && h < f + n || p - n < r && r < d + n && c - n < l && l < f + n || p - n < r && r < d + n && c - n < h && h < f + n ) ) {
              i.snapElements[ u ].snapping && i.options.snap.release && i.options.snap.release.call( i.element, t, o.a.extend( i._uiHash(), {
            ...
            if ( "inner" != s.snapMode ) {
              var g = Math.abs( c - h ) <= n
              var m = Math.abs( f - l ) <= n
              var v = Math.abs( p - r ) <= n
              var b = Math.abs( d - a ) <= n
              g && ( e.position.top = i._convertPositionTo( "relative", {
                top: c - i.helperProportions.height,
                left: 0
              } ).top - i.margins.top )
              m && ( e.position.top = i._convertPositionTo( "relative", {
                top: f,
                left: 0
              } ).top - i.margins.top )
              v && ( e.position.left = i._convertPositionTo( "relative", {
                top: 0,
                left: p - i.helperProportions.width
              } ).left - i.margins.left )
              b && ( e.position.left = i._convertPositionTo( "relative", {
                top: 0,
                left: d
              } ).left - i.margins.left )
            }
            ...
            }!i.snapElements[ u ].snapping && ( g || m || v || b || _ ) && i.options.snap.snap && i.options.snap.snap.call( i.element, t, o.a.extend( i._uiHash(), {
              snapItem: i.snapElements[ u ].item
            } ) )
      ...
      o.a.ui.plugin.add( "draggable", "stack", {
        start: function ( t, e ) {
          var i = o()( this ).data( "draggable" ).options
          var s = o.a.makeArray( o()( i.stack ) ).sort( ( function ( t, e ) {
            return ( parseInt( o()( t ).css( "zIndex" ), 10 ) || 0 ) - ( parseInt( o()( e ).css( "zIndex" ), 10 ) || 0 )
          } ) )
          if ( !s.length ) return
      ...
      o.a.ui.plugin.add( "draggable", "zIndex", {
        start: function ( t, e ) {
          var i = o()( e.helper ),
            s = o()( this ).data( "draggable" ).options
    ...
    YGE8: function ( t, e, i ) {
      ...
      o.a.widget( "ui.dialog", {
        ...
        options: {
          ...
          position: {
            ...
            collision: "fit",
            using: function ( t ) {
              var e = o()( this ).css( t ).offset().top
              e < 0 && o()( this ).css( "top", t.top - e )
            }
          },
          resizable: true,
          show: null,
        ...
        _create: function () {
          ...
          var t = this,
            e = this.options,
            i = e.title || "&#160;",
            s = ( this.uiDialog = o()( "<div>" ) ).addClass( a + e.dialogClass ).css( {
              display: "none",
              outline: 0,
              zIndex: e.zIndex
            } ).attr( "tabIndex", -1 ).keydown( ( function ( i ) {
              if ( e.closeOnEscape && !i.isDefaultPrevented() && i.keyCode && i.keyCode === o.a.ui.keyCode.ESCAPE ) {
                t.close( i )
                i.preventDefault()
              }
            ...
            n = this.element.show().removeAttr( "title" ).addClass( "ui-dialog-content ui-widget-content" ).appendTo( s ),
            r = ( this.uiDialogTitlebar = o()( "<div>" ) ).addClass( "ui-dialog-titlebar  ui-widget-header  ui-corner-all  ui-helper-clearfix" ).prependTo( s ),
            l = o()( "<button></button>" ).addClass( "ui-dialog-titlebar-close  ui-corner-all" ).click( ( function ( e ) {
              e.preventDefault()
              t.close( e )
            } ) ).appendTo( r ),
            h = ( ( this.uiDialogTitlebarCloseText = o()( "<span>" ) ).addClass( "ui-icon ui-icon-closethick" ).text( e.closeText ).appendTo( l ), o()( "<span>" ).uniqueId().addClass( "ui-dialog-title" ).html( i ).attr( "role", "heading" ).attr( "aria-level", "2" ).prependTo( r ), ( this.uiDialogButtonPane = o()( "<div>" ) ).addClass( "ui-dialog-buttonpane ui-widget-content ui-helper-clearfix" ) );
          ( this.uiButtonSet = o()( "<div>" ) ).addClass( "ui-dialog-buttonset" ).appendTo( h )
        ...
        _destroy: function () {
          ...
          t.length ? t.before( this.element ) : e.parent.append( this.element )
        },
        widget: function () {
        ...
        close: function ( t ) {
          ...
          if ( this.options.hide ) this.uiDialog.hide( this.options.hide, ( function () {
            s._trigger( "close", t )
          } ) )
          else {
            this.uiDialog.hide()
          ...
          o.a.ui.dialog.overlay.resize()
          if ( this.options.modal ) {
            e = 0
            o()( ".ui-dialog" ).each( ( function () {
              if ( this !== s.uiDialog[ 0 ] ) {
                i = o()( this ).css( "z-index" )
                isNaN( i ) || ( e = Math.max( e, i ) )
              }
            } ) )
            o.a.ui.dialog.maxZ = e
            this.oldFocus && o()( this.oldFocus ).is( ":visible" ) && this.oldFocus.focus()
          }
          return this
        },
        isOpen: function () {
        ...
        moveToTop: function ( t, e ) {
          ...
          if ( this.overlay ) {
            ...
            this.overlay.$el.css( "z-index", o.a.ui.dialog.overlay.maxZ )
          }
          i = {
        ...
        open: function () {
          ...
          if ( e.modal ) {
            ...
            this._on( i, {
              keydown: function ( t ) {
                if ( t.keyCode !== o.a.ui.keyCode.TAB ) return
          ...
          if ( o.a.browser && o.a.browser.safari ) {
            var s = this.uiDialog.find( ".ui-dialog-titlebar-close" )
            s.length ? s.focus() : t.eq( 0 ).focus()
          }
          this._isOpen = true
          this._trigger( "open" )
          return this
        },
        _bumperFocus: function ( t, e ) {
          var i = o()( ":tabbable", this.uiDialog )
        ...
        _createButtons: function ( t ) {
          ...
          "object" === typeof t && null !== t && o.a.each( t, ( function () {
            return !( i = true )
          } ) )
          if ( i ) {
            o.a.each( t, ( function ( t, i ) {
              i = o.a.isFunction( i ) ? {
                click: i,
                text: t
              } : i
              var s = o()( "<button type='button'>" ).attr( i, true ).unbind( "click" ).click( ( function () {
                i.click.apply( e.element[ 0 ], arguments )
              } ) ).appendTo( e.uiButtonSet )
              o.a.fn.button && s.button()
            } ) )
            this.uiDialog.addClass( "ui-dialog-buttons" )
            this.options.modal ? this.uiDialogButtonPane.insertBefore( this.uiDialog.find( ".ui-dialog-focus-bumper-bottom" ) ) : this.uiDialogButtonPane.append( this.uiDialog )
        ...
        _makeDraggable: function () {
          ...
          this.uiDialog.draggable( {
            ...
            start: function ( e, s ) {
              o()( this ).addClass( "ui-dialog-dragging" )
              t._trigger( "dragStart", e, i( s ) )
            },
            drag: function ( e, s ) {
              t._trigger( "drag", e, i( s ) )
            },
            stop: function ( s, n ) {
              e.position = [ n.position.left - t.document.scrollLeft(), n.position.top - t.document.scrollTop() ]
        ...
        _makeResizable: function ( t ) {
          ...
          this.uiDialog.resizable( {
            ...
            handles: n,
            start: function ( t, i ) {
              o()( this ).addClass( "ui-dialog-resizing" )
              e._trigger( "resizeStart", t, a( i ) )
            },
            resize: function ( t, i ) {
              e._trigger( "resize", t, a( i ) )
            },
            stop: function ( t, s ) {
              o()( this ).removeClass( "ui-dialog-resizing" )
        ...
        _position: function ( t ) {
          var e, i = [],
            s = [ 0, 0 ]
          if ( t ) {
            if ( "string" === typeof t || "object" === typeof t && "0" in t ) {
              i = t.split ? t.split( " " ) : [ t[ 0 ], t[ 1 ] ]
              1 === i.length && ( i[ 1 ] = i[ 0 ] )
              o.a.each( [ "left", "top" ], ( function ( t, e ) {
                if ( +i[ t ] === i[ t ] ) {
                  s[ t ] = i[ t ]
                  i[ t ] = e
                }
            ...
            t = o.a.extend( {}, o.a.ui.dialog.prototype.options.position, t )
          } else t = o.a.ui.dialog.prototype.options.position
        ...
        _setOption: function ( t, e ) {
          ...
          switch ( t ) {
            ...
            case "closeText":
              ...
              break
            case "dialogClass":
              n.removeClass( this.options.dialogClass ).addClass( a + e )
              break
            case "disabled":
              e ? n.addClass( "ui-dialog-disabled" ) : n.removeClass( "ui-dialog-disabled" )
              break
            case "draggable":
              i = n.is( ":data(draggable)" )
              i && !e && n.draggable( "destroy" ) !i && e && this._makeDraggable()
              break
            case "position":
              this._position( e )
              break
            case "resizable":
              s = n.is( ":data(resizable)" )
              s && !e && n.resizable( "destroy" )
              s && "string" === typeof e && n.resizable( "option", "handles", e )
              s || false === e || this._makeResizable( e )
              break
            case "title":
              o()( ".ui-dialog-title", this.uiDialogTitlebar ).html( "" + ( e || "&#160;" ) )
          }
          this._super( t, e )
        },
        _size: function () {
          ...
          if ( "auto" === s.height )
            if ( o.a.support.minHeight ) this.element.css( {
              minHeight: e,
              height: "auto"
            } )
          else {
            ...
            this.element.height( Math.max( i, e ) )
          } else this.element.height( Math.max( s.height - t, 0 ) )
          this.uiDialog.is( ":data(resizable)" ) && this.uiDialog.resizable( "option", "minHeight", this._minHeight() )
        }
      } )
      o.a.extend( o.a.ui.dialog, {
        uuid: 0,
        maxZ: 0,
        ...
        overlay: function ( t ) {
          this.$el = o.a.ui.dialog.overlay.create( t )
        }
      } )
      o.a.extend( o.a.ui.dialog.overlay, {
        instances: [],
        oldInstances: [],
        maxZ: 0,
        events: o.a.map( "focus,mousedown,mouseup,keydown,keypress,click".split( "," ), ( function ( t ) {
          return t + ".dialog-overlay"
        } ) ).join( " " ),
        create: function ( t ) {
          if ( 0 === this.instances.length ) {
            setTimeout( ( function () {
              o.a.ui.dialog.overlay.instances.length && o()( document ).bind( o.a.ui.dialog.overlay.events, ( function ( e ) {
                if ( o()( e.target ).zIndex() < o.a.ui.dialog.overlay.maxZ && !t.element.has( e.target ).length ) return false
              } ) )
            } ), 1 )
            o()( window ).bind( "resize.dialog-overlay", o.a.ui.dialog.overlay.resize )
          }
          var e = this.oldInstances.pop() || o()( "<div>" ).addClass( "ui-widget-overlay" )
          o()( document ).bind( "keydown.dialog-overlay", ( function ( i ) {
            var s = o.a.ui.dialog.overlay.instances
            if ( 0 !== s.length && s[ s.length - 1 ] === e && t.options.closeOnEscape && !i.isDefaultPrevented() && i.keyCode && i.keyCode === o.a.ui.keyCode.ESCAPE ) {
              t.close( i )
              i.preventDefault()
            }
          } ) )
          e.appendTo( document.body ).css( {
            width: this.width(),
            height: this.height()
          } )
        ...
        destroy: function ( t ) {
          var e = o.a.inArray( t, this.instances ),
            i = 0; - 1 !== e && this.oldInstances.push( this.instances.splice( e, 1 )[ 0 ] )
          0 === this.instances.length && o()( [ document, window ] ).unbind( ".dialog-overlay" )
          t.height( 0 ).width( 0 ).remove()
          o.a.each( this.instances, ( function () {
        ...
        height: function () {
          ...
          if ( o.a.browser.msie ) {
            ...
            return t < e ? o()( window ).height() + "px" : t + "px"
          }
          return o()( document ).height() + "px"
        },
        width: function () {
          var t, e
          if ( o.a.browser.msie ) {
            ...
            return t < e ? o()( window ).width() + "px" : t + "px"
          }
          return o()( document ).width() + "px"
        },
        resize: function () {
          var t = o()( [] )
          o.a.each( o.a.ui.dialog.overlay.instances, ( function () {
            t = t.add( this )
          } ) )
          t.css( {
            width: 0,
            ...
            width: o.a.ui.dialog.overlay.width(),
            height: o.a.ui.dialog.overlay.height()
          } )
        }
      } )
      o.a.extend( o.a.ui.dialog.overlay.prototype, {
        destroy: function () {
          o.a.ui.dialog.overlay.destroy( this.$el )
        }
      } )
      ...
      function h( t ) {
        if ( !t ) return t
        return t.jquery ? o()( "<div />" ).append( t.eq( 0 ).clone() ).html() : Object( n[ "a" ] )( "" + t )
      }
      var u = o.a.ui.dialog.prototype._create,
        p = o.a.ui.dialog.prototype._setOption
      o.a.extend( o.a.ui.dialog.prototype, {
        _create: function () {
          if ( !this.options.title ) {
            this.options.title = this.element.attr( "title" )
            "string" !== typeof this.options.title && ( this.options.title = "" )
          }
          this.options.title = h( this.options.title )
          this._on( {
            dialogopen: function () {
              o()( "#application" ).attr( "aria-hidden", "true" )
            },
            dialogclose: function () {
              o()( "#application" ).attr( "aria-hidden", "false" )
            }
          } )
    ...
    Yf8v: function ( t, e, i ) {
      ...
      i( "ZV2x" )
      i( "vTtS" )
      o.a.widget( "ui.resizable", o.a.ui.mouse, {
        version: "@VERSION",
        ...
        _create: function () {
          ...
          if ( this.element[ 0 ].nodeName.match( /canvas|textarea|input|select|button|img/i ) ) {
            this.element.wrap( o()( '<div class="ui-wrapper" style="overflow: hidden;"></div>' ).css( {
          ...
          this.handles = e.handles || ( o()( ".ui-resizable-handle", this.element ).length ? {
            n: ".ui-resizable-n",
            e: ".ui-resizable-e",
            s: ".ui-resizable-s",
            w: ".ui-resizable-w",
          ...
          this._renderAxis = function ( t ) {
            ...
            for ( var e in this.handles ) {
              this.handles[ e ].constructor == String && ( this.handles[ e ] = o()( this.handles[ e ], this.element ).show() )
              if ( this.elementIsWrapper && this.originalElement[ 0 ].nodeName.match( /textarea|input|select|button/i ) ) {
                var i = o()( this.handles[ e ], this.element ),
                  s = 0
              ...
              if ( !o()( this.handles[ e ] ).length ) continue
            }
          }
          ...
          if ( e.autoHide ) {
            this._handles.hide()
            o()( this.element ).addClass( "ui-resizable-autohide" ).mouseenter( ( function () {
              ...
              if ( e.disabled ) return
              if ( !t.resizing ) {
                o()( this ).addClass( "ui-resizable-autohide" )
                t._handles.hide()
              }
            } ) )
          }
        ...
        _destroy: function () {
          this._mouseDestroy()
          var t = function ( t ) {
            o()( t ).removeClass( "ui-resizable ui-resizable-disabled ui-resizable-resizing" ).removeData( "resizable" ).removeData( "ui-resizable" ).unbind( ".resizable" ).find( ".ui-resizable-handle" ).remove()
          }
        ...
        _mouseStart: function ( t ) {
          ...
          this._renderProxy()
          var a = n( this.helper.css( "left" ) ),
            r = n( this.helper.css( "top" ) )
          if ( e.containment ) {
            a += o()( e.containment ).scrollLeft() || 0
            r += o()( e.containment ).scrollTop() || 0
          }
        ...
        _mouseStop: function ( t ) {
          ...
          if ( this._helper ) {
            var s = this._proportionallyResizeElements,
              ...
              a = n && o.a.ui.hasScroll( s[ 0 ], "left" ) ? 0 : i.sizeDiff.height,
            ...
            e.animate || this.element.css( o.a.extend( l, {
              top: u,
              left: h
            } ) )
        ...
        _updateVirtualBoundaries: function ( t ) {
          ...
          n = {
            minWidth: a( r.minWidth ) ? r.minWidth : 0,
            maxWidth: a( r.maxWidth ) ? r.maxWidth : Infinity,
            minHeight: a( r.minHeight ) ? r.minHeight : 0,
            maxHeight: a( r.maxHeight ) ? r.maxHeight : Infinity
          }
        ...
        _updateCache: function ( t ) {
          ...
          a( t.width ) && ( this.size.width = t.width )
        },
        ...
        _respectSize: function ( t, e ) {
          ...
          var i = this._vBoundaries,
            ...
            o = a( t.width ) && i.maxWidth && i.maxWidth < t.width,
            n = a( t.height ) && i.maxHeight && i.maxHeight < t.height,
            r = a( t.width ) && i.minWidth && i.minWidth > t.width,
            l = a( t.height ) && i.minHeight && i.minHeight > t.height
        ...
        _proportionallyResize: function () {
          ...
          for ( var e = 0; e < this._proportionallyResizeElements.length; e++ ) {
            ...
            if ( !this.borderDif ) {
              ...
              this.borderDif = o.a.map( s, ( function ( t, e ) {
        ...
        _renderProxy: function () {
          ...
          if ( this._helper ) {
            this.helper = this.helper || o()( '<div style="overflow:hidden;"></div>' )
        ...
        _change: {
          ...
          se: function ( t, e, i ) {
            return o.a.extend( this._change.s.apply( this, arguments ), this._change.e.apply( this, [ t, e, i ] ) )
          },
          sw: function ( t, e, i ) {
            return o.a.extend( this._change.s.apply( this, arguments ), this._change.w.apply( this, [ t, e, i ] ) )
          },
          ne: function ( t, e, i ) {
            return o.a.extend( this._change.n.apply( this, arguments ), this._change.e.apply( this, [ t, e, i ] ) )
          },
          nw: function ( t, e, i ) {
            return o.a.extend( this._change.n.apply( this, arguments ), this._change.w.apply( this, [ t, e, i ] ) )
          }
        },
        _propagate: function ( t, e ) {
          o.a.ui.plugin.call( this, t, [ e, this.ui() ] )
      ...
      o.a.ui.plugin.add( "resizable", "alsoResize", {
        start: function ( t, e ) {
          var i = o()( this ).data( "resizable" ),
            s = i.options
          var n = function ( t ) {
            o()( t ).each( ( function () {
              var t = o()( this )
          ...
          else if ( s.alsoResize.length ) {
            s.alsoResize = s.alsoResize[ 0 ]
            n( s.alsoResize )
          } else o.a.each( s.alsoResize, ( function ( t ) {
            n( t )
          } ) )
        },
        resize: function ( t, e ) {
          ...
          var r = {
            ...
            l = function ( t, i ) {
              o()( t ).each( ( function () {
                var t = o()( this ),
                  s = o()( this ).data( "resizable-alsoresize" ),
                  n = {},
                  a = i && i.length ? i : t.parents( e.originalElement[ 0 ] ).length ? [ "width", "height" ] : [ "width", "height", "top", "left" ]
                o.a.each( a, ( function ( t, e ) {
                  var i = ( s[ e ] || 0 ) + ( r[ e ] || 0 )
                  i && i >= 0 && ( n[ e ] = i || null )
                } ) )
                t.css( n )
          ...
          "object" != typeof s.alsoResize || s.alsoResize.nodeType ? l( s.alsoResize ) : o.a.each( s.alsoResize, ( function ( t, e ) {
            l( t, e )
          } ) )
        },
        stop: function ( t, e ) {
          o()( this ).removeData( "resizable-alsoresize" )
        }
      } )
      o.a.ui.plugin.add( "resizable", "animate", {
        stop: function ( t, e ) {
          var i = o()( this ).data( "resizable" ),
            s = i.options
          var n = i._proportionallyResizeElements,
            a = n.length && /textarea/i.test( n[ 0 ].nodeName ),
            r = a && o.a.ui.hasScroll( n[ 0 ], "left" ) ? 0 : i.sizeDiff.height,
            l = a ? 0 : i.sizeDiff.width
          var h = {
          ...
          i.element.animate( o.a.extend( h, p && u ? {
            top: p,
            left: u
          } : {} ), {
      ...
      o.a.ui.plugin.add( "resizable", "containment", {
        start: function ( t, e ) {
          var i = o()( this ).data( "resizable" ),
            s = i.options,
            a = i.element
          var r = s.containment,
            l = r instanceof o.a ? r.get( 0 ) : /parent/.test( r ) ? a.parent().get( 0 ) : r
          if ( !l ) return
          ...
          if ( /document/.test( r ) || r == document ) {
            ...
            var h = o()( l ),
              u = []
            o()( [ "Top", "Right", "Left", "Bottom" ] ).each( ( function ( t, e ) {
              u[ t ] = n( h.css( "padding" + e ) )
            } ) )
            i.containerOffset = h.offset()
            i.containerPosition = h.position()
            i.containerSize = {
              height: h.innerHeight() - u[ 3 ],
              width: h.innerWidth() - u[ 1 ]
            }
            var p = i.containerOffset,
              d = i.containerSize.height,
              c = i.containerSize.width,
              f = o.a.ui.hasScroll( l, "left" ) ? l.scrollWidth : c,
              g = o.a.ui.hasScroll( l ) ? l.scrollHeight : d
            i.parentData = {
              element: l,
              left: p.left,
              top: p.top,
        ...
        resize: function ( t, e ) {
          ...
          if ( a.left < ( i._helper ? n.left : 0 ) ) {
            i.size.width = i.size.width + ( i._helper ? i.position.left - n.left : i.position.left - l.left )
            r && ( i.size.height = i.size.width / i.aspectRatio )
            i.position.left = s.helper ? n.left : 0
          }
          if ( a.top < ( i._helper ? n.top : 0 ) ) {
            i.size.height = i.size.height + ( i._helper ? i.position.top - n.top : i.position.top )
          ...
          var u = Math.abs( ( i._helper, i.offset.left - l.left ) + i.sizeDiff.width ),
            p = Math.abs( ( i._helper ? i.offset.top - l.top : i.offset.top - n.top ) + i.sizeDiff.height )
          var d = i.containerElement.get( 0 ) == i.element.parent().get( 0 ),
            c = /relative|absolute/.test( i.containerElement.css( "position" ) )
          d && c && ( u -= i.parentData.left )
          if ( u + i.size.width >= i.parentData.width ) {
            i.size.width = i.parentData.width - u
            r && ( i.size.height = i.size.width / i.aspectRatio )
          }
          if ( p + i.size.height >= i.parentData.height ) {
            i.size.height = i.parentData.height - p
            r && ( i.size.width = i.size.height * i.aspectRatio )
          }
        },
        stop: function ( t, e ) {
          ...
          var l = o()( i.helper ),
            ...
            p = l.outerHeight() - i.sizeDiff.height
          i._helper && !s.animate && /relative/.test( r.css( "position" ) ) && o()( this ).css( {
            left: h.left - a.left - n.left,
            width: u,
            height: p
          } )
          i._helper && !s.animate && /static/.test( r.css( "position" ) ) && o()( this ).css( {
            left: h.left - a.left - n.left,
            width: u,
            height: p
          } )
      ...
      o.a.ui.plugin.add( "resizable", "ghost", {
        start: function ( t, e ) {
          var i = o()( this ).data( "resizable" ),
            s = i.options,
            n = i.size
          ...
          i.ghost.css( {
            ...
            left: 0,
            top: 0
          } ).addClass( "ui-resizable-ghost" ).addClass( "string" == typeof s.ghost ? s.ghost : "" )
      ...
      o.a.ui.plugin.add( "resizable", "grid", {
        resize: function ( t, e ) {
          var i = o()( this ).data( "resizable" ),
            s = i.options,
            n = i.size,
          ...
          var h = Math.round( ( n.width - a.width ) / ( s.grid[ 0 ] || 1 ) ) * ( s.grid[ 0 ] || 1 ),
            u = Math.round( ( n.height - a.height ) / ( s.grid[ 1 ] || 1 ) ) * ( s.grid[ 1 ] || 1 )
          if ( /^(se|s|e)$/.test( l ) ) {
      ...
      o.a.widget( "ui.mouse", {
        ...
        _mouseInit: function () {
          ...
          this.element.bind( "mousedown." + this.widgetName, ( function ( e ) {
            ...
            if ( true === o.a.data( e.target, t.widgetName + ".preventClickEvent" ) ) {
              o.a.removeData( e.target, t.widgetName + ".preventClickEvent" )
        ...
        _mouseDestroy: function () {
          ...
          o()( document ).unbind( "mousemove." + this.widgetName, this._mouseMoveDelegate ).unbind( "mouseup." + this.widgetName, this._mouseUpDelegate )
        },
        _mouseDown: function ( t ) {
          ...
          if ( this._mouseDistanceMet( t ) && this._mouseDelayMet( t ) ) {
            this._mouseStarted = false !== this._mouseStart( t )
            if ( !this._mouseStarted ) {
              t.preventDefault()
              return true
            }
          }
          true === o.a.data( t.target, this.widgetName + ".preventClickEvent" ) && o.a.removeData( t.target, this.widgetName + ".preventClickEvent" )
        ...
        _mouseMove: function ( t ) {
          if ( o.a.browser.msie && !( document.documentMode >= 9 ) && !t.button ) return this._mouseUp( t )
          if ( this._mouseStarted ) {
            this._mouseDrag( t )
    ...
    yP0d: function ( t, e, i ) {
      ...
      i( "9Duh" )
      i( "vTtS" )
      var n, a, r, l, h = "ui-button ui-widget ui-state-default ui-corner-all",
        ...
        c = function ( t ) {
          var e = t.name,
            i = t.form,
            s = o()( [] )
          e && ( s = i ? o()( i ).find( "[name='" + e + "']" ) : o()( "[name='" + e + "']", t.ownerDocument ).filter( ( function () {
            return !this.form
          } ) ) )
          return s
        }
      o.a.widget( "ui.button", {
        version: "@VERSION",
        ...
        _create: function () {
          ...
          var t = this,
            ...
            s = "ui-state-hover" + ( i ? "" : " ui-state-active" ),
            u = "ui-state-focus"
          null === e.label && ( e.label = "input" === this.type ? this.buttonElement.val() : this.buttonElement.html() )
          this.buttonElement.addClass( h ).not( ".no-button-role" ).attr( "role", "button" ).end().bind( "mouseenter" + this.eventNamespace, ( function () {
            if ( e.disabled ) return
            o()( this ).addClass( "ui-state-hover" )
            this === n && o()( this ).addClass( "ui-state-active" )
          } ) ).bind( "mouseleave" + this.eventNamespace, ( function () {
            if ( e.disabled ) return
            o()( this ).removeClass( s )
          ...
          if ( "checkbox" === this.type ) this.buttonElement.bind( "click" + this.eventNamespace, ( function () {
            ...
            this.buttonElement.bind( "mousedown" + this.eventNamespace, ( function () {
              ...
              if ( e.disabled ) return false
              t.keyCode !== o.a.ui.keyCode.SPACE && t.keyCode !== o.a.ui.keyCode.ENTER || o()( this ).addClass( "ui-state-active" )
            } ) ).bind( "keyup" + this.eventNamespace, ( function () {
              o()( this ).removeClass( "ui-state-active" )
            } ) )
            this.buttonElement.is( "a" ) && this.buttonElement.keyup( ( function ( t ) {
              t.keyCode === o.a.ui.keyCode.SPACE && o()( this ).click()
            } ) )
          }
        ...
        _setOption: function ( t, e ) {
          this._super( t, e )
          if ( "disabled" === t ) {
            e ? this.element.prop( "disabled", true ) : this.element.prop( "disabled", false )
            return
          }
          this._resetButton()
        },
        ...
        _resetButton: function () {
          ...
          if ( i.primary || i.secondary ) {
            ...
            if ( !this.options.text ) {
              ...
              this.hasTitle || t.attr( "title", o.a.trim( e ) )
            }
          } else n.push( "ui-button-text-only" )
          t.addClass( n.join( " " ) )
        }
      } )
      o.a.widget( "ui.buttonset", {
        version: "@VERSION",
        options: {
...
//# sourceMappingURL=0-c-de89641551.js.map
