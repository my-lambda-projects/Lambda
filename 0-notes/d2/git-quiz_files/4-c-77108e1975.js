  ...
  [ 4 ], {
    sTNg: function ( e, n, t ) {
      ...
      var u = {
        message: d.a.shape( {
          text: d.a.string,
          type: d.a.oneOf( [ "error", "hint", "success", "screenreader-only" ] )
        } )
      }
      var m = t( "VTBJ" )
      var b = t( "rePB" )
      ...
      var E = ( C = Object( O[ "j" ] )( w, I ), C( x = ( A = _ = function ( e ) {
        Object( i[ "a" ] )( t, e )
        var n = Object( o[ "a" ] )( t )
        ...
        Object( a[ "a" ] )( t, [ {
          ...
          value: function () {
            ...
            return l.a.createElement( n, Object.assign( {}, Object( p[ "a" ] )( this.props, t.propTypes ), {
              className: f()( r )
            } ), this.props.children )
          }
        } ] )
      ...
      function S( e ) {
        var n = e.colors,
          t = e.typography
        return {
          colorHint: n.textDarkest,
          colorError: n.textDanger,
          colorSuccess: n.textSuccess,
          fontFamily: t.fontFamily,
      ...
      S.canvas = function ( e ) {
        return {
          colorHint: e[ "ic-brand-font-color-dark" ]
        }
      }
      var T, B, L, N
      var R = {
      ...
      var V = ( T = Object( O[ "j" ] )( S, R ), T( B = ( N = L = function ( e ) {
        Object( i[ "a" ] )( t, e )
        var n = Object( o[ "a" ] )( t )
        ...
        Object( a[ "a" ] )( t, [ {
          ...
          value: function () {
            ...
            return "screenreader-only" !== this.props.variant ? l.a.createElement( "span", {
              className: f()( n )
            }, this.props.children ) : l.a.createElement( v[ "a" ], null, this.props.children )
          }
        } ] )
        t.displayName = "FormFieldMessage"
        return t
      }( s[ "Component" ] ), L.propTypes = {
        variant: d.a.oneOf( [ "error", "hint", "success", "screenreader-only" ] ),
        children: d.a.node
      }, L.defaultProps = {
        variant: "hint",
        children: null
      ...
      var J = ( z = Object( O[ "j" ] )( F, M ), z( W = ( D = G = function ( e ) {
        Object( i[ "a" ] )( t, e )
        var n = Object( o[ "a" ] )( t )
        ...
        Object( a[ "a" ] )( t, [ {
          ...
          value: function () {
            ...
            return e && e.length > 0 ? l.a.createElement( "span", Object.assign( {
              className: M.root
            }, Object( p[ "a" ] )( this.props, t.propTypes ) ), e.map( ( function ( e, n ) {
        ...
        messages: d.a.arrayOf( u.message )
      }, G.defaultProps = {
        messages: void 0
      }, D ) ) || W )
      var X = function () {
      ...
      var K = ( H = Object( O[ "j" ] )( X, Y ), H( P = ( q = U = function ( e ) {
        Object( i[ "a" ] )( t, e )
        var n = Object( o[ "a" ] )( t )
        ...
        function t( e ) {
          ...
          Object( r[ "a" ] )( this, t )
          a = n.call( this )
          a.handleInputContainerRef = function ( e ) {
            a.props.inputContainerRef && a.props.inputContainerRef( e )
          }
        ...
        Object( a[ "a" ] )( t, [ {
          key: "renderLabel",
          value: function () {
            return this.hasVisibleLabel ? l.a.createElement( y[ "a" ].Col, {
              textAlign: this.props.labelAlign,
              width: this.inlineContainerAndLabel ? "auto" : 3
            }, l.a.createElement( E, {
              "aria-hidden": "fieldset" === this.elementType ? "true" : null
            }, this.props.label ) ) : "fieldset" !== this.elementType ? this.props.label : null
          }
        }, {
          key: "renderLegend",
          value: function () {
            return l.a.createElement( v[ "a" ], {
              as: "legend"
            }, this.props.label, this.hasMessages && l.a.createElement( J, {
          ...
          value: function () {
            return this.hasMessages ? l.a.createElement( y[ "a" ].Row, null, l.a.createElement( y[ "a" ].Col, {
          ...
          value: function () {
            ...
            return l.a.createElement( n, Object.assign( {}, Object( p[ "a" ] )( this.props, Object( m[ "a" ] )( {}, t.propTypes, {}, y[ "a" ].propTypes ) ), {
              className: f()( r ),
              style: {
                width: this.props.width
              },
              "aria-describedby": this.hasMessages ? this._messagesId : null
            } ), "fieldset" === this.elementType && this.renderLegend(), l.a.createElement( y[ "a" ], Object.assign( {
              rowSpacing: "small",
              colSpacing: "small",
              startAt: "inline" === this.props.layout && this.hasVisibleLabel ? "medium" : null
            }, Object( p[ "c" ] )( this.props, y[ "a" ].propTypes ) ), l.a.createElement( y[ "a" ].Row, null, this.renderLabel(), l.a.createElement( y[ "a" ].Col, {
          ...
          key: "hasVisibleLabel",
          get: function () {
            return this.props.label && Object( g[ "a" ] )( this.props.label )
          }
        }, {
          key: "hasMessages",
          get: function () {
          ...
          key: "elementType",
          get: function () {
            return Object( j[ "a" ] )( t, this.props )
          }
        }, {
          key: "inlineContainerAndLabel",
          get: function () {
            return this.props.inline && "inline" === this.props.layout
          }
        } ] )
        ...
        as: d.a.elementType,
        messages: d.a.arrayOf( u.message ),
        messagesId: d.a.string,
        children: d.a.node,
        inline: d.a.bool,
        layout: d.a.oneOf( [ "stacked", "inline" ] ),
        labelAlign: d.a.oneOf( [ "start", "end" ] ),
        width: d.a.string,
      ...
      var Q = function ( e ) {
        ...
        Object( a[ "a" ] )( t, [ {
          key: "render",
          value: function () {
            return l.a.createElement( K, Object.assign( {}, Object( p[ "a" ] )( this.props, t.propTypes ), Object( p[ "c" ] )( this.props, K.propTypes ), {
      ...
      Q.propTypes = {
        ...
        layout: d.a.oneOf( [ "stacked", "inline" ] ),
        labelAlign: d.a.oneOf( [ "start", "end" ] ),
        vAlign: d.a.oneOf( [ "top", "middle", "bottom" ] ),
        width: d.a.string,
        inputContainerRef: d.a.func
      }
      Q.defaultProps = {
      ...
      var ae = ( $ = Object( O[ "j" ] )( Z, re ), $( ee = ( te = ne = function ( e ) {
        Object( i[ "a" ] )( t, e )
        var n = Object( o[ "a" ] )( t )
        ...
        Object( a[ "a" ] )( t, [ {
          key: "renderColumns",
          value: function () {
            return s[ "Children" ].map( this.props.children, ( function ( e, n ) {
              return e ? l.a.createElement( y[ "a" ].Col, {
                width: e.props && e.props.width ? "auto" : null,
                key: n
              }, e ) : null
            } ) )
          }
          ...
          value: function () {
            return l.a.createElement( y[ "a" ], {
              ...
              vAlign: this.props.vAlign,
              startAt: this.props.startAt || ( "columns" === this.props.layout ? "medium" : null )
            }, l.a.createElement( y[ "a" ].Row, null, this.renderColumns() ) )
          }
        }, {
          key: "renderFields",
          value: function () {
            ...
            return l.a.createElement( "span", {
              key: "fields",
              className: f()( ( e = {}, Object( b[ "a" ] )( e, re.fields, true ), Object( b[ "a" ] )( e, re.invalid, this.invalid ), Object( b[ "a" ] )( e, re.disabled, this.props.disabled ), e ) )
            }, this.renderChildren() )
          }
        }, {
          key: "render",
          value: function () {
            return l.a.createElement( K, Object.assign( {}, Object( p[ "a" ] )( this.props, t.propTypes ), Object( p[ "c" ] )( this.props, K.propTypes ), {
              vAlign: this.props.vAlign,
              layout: "inline" === this.props.layout ? "inline" : "stacked",
          ...
          key: "invalid",
          get: function () {
            return this.props.messages && this.props.messages.findIndex( ( function ( e ) {
              return "error" === e.type
            } ) ) >= 0
          }
        } ] )
        ...
        return t
      }( s[ "Component" ] ), ne.propTypes = {
        description: d.a.node.isRequired,
        as: d.a.elementType,
        messages: d.a.arrayOf( u.message ),
        messagesId: d.a.string,
        disabled: d.a.bool,
        children: d.a.node,
        layout: d.a.oneOf( [ "stacked", "columns", "inline" ] ),
        rowSpacing: d.a.oneOf( [ "none", "small", "medium", "large" ] ),
        colSpacing: d.a.oneOf( [ "none", "small", "medium", "large" ] ),
        vAlign: d.a.oneOf( [ "top", "middle", "bottom" ] ),
        startAt: d.a.oneOf( [ "small", "medium", "large", "x-large", null ] )
      }, ne.defaultProps = {
        children: null,
        layout: void 0,
        startAt: void 0,
...
//# sourceMappingURL=4-c-77108e1975.js.map
