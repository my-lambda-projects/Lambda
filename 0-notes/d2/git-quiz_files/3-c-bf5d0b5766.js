( window[ "canvasWebpackJsonp" ] = window[ "canvasWebpackJsonp" ] || [] ).push( [
  [ 3 ], {
      ...
      var b = {
        oneOf: function ( r ) {
          function e( e, i, n ) {
            ...
            for ( var g = 0; g < a.length; g++ ) {
              ...
              if ( s && s.type ) {
                var c = l( s.type )
                if ( b.indexOf( c ) < 0 ) return new Error( "Expected one of ".concat( b.join( ", " ), " in " ).concat( n, " but found '" ).concat( c, "'" ) )
              } else if ( s ) return new Error( "Expected one of ".concat( b.join( ", " ), " in " ).concat( n, " but found an element with unknown type: " ).concat( s ) )
            }
          }
          ...
          return function ( e, i, n ) {
            ...
            for ( var s = 0; s < a.length; s++ ) {
              ...
              if ( c && c.type ) {
                ...
                b[ f ] = ( b[ f ] || 0 ) + 1
              } else if ( c ) return new Error( "Expected one of ".concat( g.join( ", " ), " in " ).concat( n, " but found an element of unknown type: " ).concat( c ) )
            }
            var m = []
            Object.keys( b ).forEach( ( function ( r ) {
              b[ r ] > 1 && m.push( "".concat( b[ r ], " children of type " ).concat( r ) )
        ...
        enforceOrder: function () {
          ...
          function s( r, i, a ) {
            ...
            return new Error( "Expected children of ".concat( a, " in one of the following formats:\n  " ).concat( b( a, e ), "\n\n\n  Instead of:\n  " ).concat( g( a, s ) ) )
          }
    ...
    pZ4s: function ( r, e, i ) {
      ...
      var T = ( I = Object( _[ "j" ] )( j, y ), I( k = ( v = O = function ( r ) {
        Object( l[ "a" ] )( i, r )
        var e = Object( g[ "a" ] )( i )
        ...
        Object( b[ "a" ] )( i, [ {
          key: "startAtClass",
          value: function () {
            return !!this.props.startAt && "startAt".concat( Object( N[ "a" ] )( this.props.startAt ) )
          }
        }, {
          key: "colSpacingClass",
          value: function () {
            return "colSpacing".concat( Object( N[ "a" ] )( this.props.colSpacing ) )
          }
        }, {
          key: "rowSpacingClass",
          value: function () {
            return "rowSpacing".concat( Object( N[ "a" ] )( this.props.rowSpacing ) )
          }
        }, {
          key: "breakpointClass",
          value: function ( r ) {
          ...
          value: function () {
            ...
            return c.a.createElement( "span", Object.assign( {}, l, {
        ...
        hAlign: m.a.oneOf( [ "start", "center", "end", "space-around", "space-between" ] ),
        vAlign: m.a.oneOf( [ "top", "middle", "bottom" ] ),
        startAt: m.a.oneOf( [ "small", "medium", "large", "x-large", null ] ),
        visualDebug: m.a.bool,
        width: m.a.oneOfType( [ m.a.oneOf( S ), m.a.shape( {
          small: m.a.oneOf( S ),
          medium: m.a.oneOf( S ),
          large: m.a.oneOf( S ),
          xLarge: m.a.oneOf( S )
        } ) ] ),
        offset: m.a.oneOfType( [ m.a.oneOf( S ), m.a.shape( {
          small: m.a.oneOf( S ),
          medium: m.a.oneOf( S ),
          large: m.a.oneOf( S ),
          xLarge: m.a.oneOf( S )
      ...
      var G = ( C = Object( _[ "j" ] )( Q, B ), C( L = ( E = M = function ( r ) {
        Object( l[ "a" ] )( i, r )
        var e = Object( g[ "a" ] )( i )
        ...
        Object( b[ "a" ] )( i, [ {
          ...
          value: function () {
            ...
            return s[ "Children" ].map( n, ( function ( e, b ) {
              return Object( x[ "a" ] )( e, [ T ] ) ? Object( p[ "a" ] )( e, Object( t[ "a" ] )( {}, Object( u[ "c" ] )( r.props, i.propTypes ), {}, e.props, {
          ...
          value: function () {
            ...
            return c.a.createElement( "span", Object.assign( {}, t, {
              className: o()( e )
            } ), this.renderChildren() )
          }
        } ] )
      ...
      var Y = ( J = Object( _[ "j" ] )( W, Z ), J( R = ( q = D = function ( r ) {
        Object( l[ "a" ] )( i, r )
        var e = Object( g[ "a" ] )( i )
        ...
        Object( b[ "a" ] )( i, [ {
          ...
          value: function () {
            ...
            return e.map( ( function ( n, a ) {
              return Object( x[ "a" ] )( n, [ G ] ) ? Object( p[ "a" ] )( n, Object( t[ "a" ] )( {}, Object( u[ "c" ] )( r.props, i.propTypes ), {}, n.props, {
