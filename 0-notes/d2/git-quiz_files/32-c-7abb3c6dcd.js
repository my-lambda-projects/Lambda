( window[ "canvasWebpackJsonp" ] = window[ "canvasWebpackJsonp" ] || [] ).push( [
  [ 32, 678 ], {
    "0crz": function ( e, t, i ) {
      ...
      t[ "a" ] = d = {
        quoteClump: function ( e ) {
          return "<div class='quoted_text_holder'> <a href='#' class='show_quoted_text_link'>" + Object( a[ "a" ] )( o.t( "quoted_text_toggle", "show quoted text" ) ) + "</a> <div class='quoted_text' style='display: none;'> " + n.a.raw( e.join( "\n" ) ) + " </div> </div>"
        },
        formatMessage: function ( e ) {
          ...
          e = Object( a[ "a" ] )( e )
          e = e.replace( new RegExp( u, "g" ), ( function ( e, t ) {
            return s.shift()
          } ) )
          e = e.replace( /\n/g, "<br />\n" )
          r = []
          ...
          for ( t = 0, i = _.length; t < i; t++ ) {
            ...
            if ( l.match( /^(&gt;|>)/ ) ) o.push( l )
              ...
              o.length && r.push( d.quoteClump( o ) )
              o = []
              r.push( l )
            }
          }
    ...
    B1vq: function ( e, t, i ) {
      ...
      var n = i.n( l )
      i( "s/PJ" )
      n.a.fn.scrollToVisible = function ( e ) {
        const t = {}
        const i = n()( e )
        ...
        let l = i.offset(),
          ...
          u = l.left,
          c = u + s,
          d = "html,body" == this.selector ? n.a.windowScrollTop() : this.scrollTop(),
          _ = this.scrollLeft(),
          h = this.outerHeight(),
          p = this.outerWidth()
        ...
        o < 0 || h < r && a > h ? t.scrollTop = o + d : a > h && ( t.scrollTop = a + d - h + 20 )
    ...
    cuKi: function ( e, t, i ) {
      ...
      function s( e ) {
        return n()( e ).reduce( ( e, t, i ) => {
          let l = i.split( "][" )
          let s = l.length - 1
          if ( /\[/.test( l[ 0 ] ) && /\]$/.test( l[ s ] ) ) {
            l[ s ] = l[ s ].replace( /\]$/, "" )
          ...
          } else n.a.isArray( e[ i ] ) ? e[ i ].push( t ) : null != e[ i ] ? e[ i ] = [ e[ i ], t ] : e[ i ] = t
          return e
        }, Object.create( null ) )
      }
    },
    ...
    p6Wi: function ( e, t, i ) {
      ...
      i( "B1vq" )
      i( "s/PJ" )
      o.a.fn.setOptions = function ( e, t ) {
        let i = e ? "<option value=''>" + Object( a[ "a" ] )( e ) + "</option>" : ""
        null == t && ( t = [] )
        t.forEach( e => {
      ...
      o.a.fn.ifExists = function ( e ) {
        this.length && e.call( this, this )
        return this
      }
      o.a.fn.scrollbarWidth = function () {
        const e = o()( '<div style="width:50px;height:50px;overflow:hidden;position:absolute;top:-200px;left:-200px;"><div style="height:100px;"></div>' ).appendTo( this ),
          t = e.find( "div" )
      ...
      o.a.fn.dim = function ( e ) {
        return this.animate( {
          opacity: .4
        }, e )
      }
      o.a.fn.undim = function ( e ) {
        return this.animate( {
          opacity: 1
        }, e )
      }
      o.a.fn.confirmDelete = function ( e ) {
        e = o.a.extend( {}, o.a.fn.confirmDelete.defaults, e )
        const t = this
        let i = null
        let l = true
        ...
        const n = function () {
          if ( !l ) {
            e.cancelled && o.a.isFunction( e.cancelled ) && e.cancelled.call( t )
            return
          }
          ...
          if ( e.url ) {
            ...
            o.a.ajaxJSON( e.url, "DELETE", l, i => {
              e.success.call( t, i )
            }, ( i, l, n, s ) => {
              e.error && o.a.isFunction( e.error ) ? e.error.call( t, i, l, n, s ) : o.a.ajaxJSON.unhandledXHRs.push( l )
            } )
          } else {
      ...
      o.a.fn.confirmDelete.defaults = {
        get message() {
          return s.t( "confirms.default_delete_thing", "Are you sure you want to delete this?" )
        }
      }
      o.a.fn.fragmentChange = function ( e ) {
        if ( e && true !== e ) {
          const i = ( window.location.search || "" ).replace( /^\?/, "" ).split( "&" )
          let l = null
          for ( var t = 0; t < i.length; t++ ) {
            const e = i[ t ]
            e && 0 === e.indexOf( "hash=" ) && ( l = "#" + e.substring( 5 ) )
          }
          this.bind( "document_fragment_change", e )
          const n = this
          let s = false
          for ( t = 0; t < o.a._checkFragments.fragmentList.length; t++ ) {
            const e = o.a._checkFragments.fragmentList[ t ]
            e.doc[ 0 ] == n[ 0 ] && ( s = true )
          }
          s || o.a._checkFragments.fragmentList.push( {
            doc: n,
            fragment: ""
          } )
          o()( window ).bind( "hashchange", o.a._checkFragments )
          setTimeout( () => {
            l && l.length > 0 ? n.triggerHandler( "document_fragment_change", l ) : n && n[ 0 ] && n[ 0 ].location && n[ 0 ].location.hash.length > 0 && n.triggerHandler( "document_fragment_change", n[ 0 ].location.hash )
          }, 500 )
        } else this.triggerHandler( "document_fragment_change", this[ 0 ].location.hash )
        return this
      }
      o.a._checkFragments = function () {
        const e = o.a._checkFragments.fragmentList
        for ( let t = 0; t < e.length; t++ ) {
          const i = e[ t ]
          const l = i.doc
          if ( l[ 0 ].location.hash != i.fragment ) {
            l.triggerHandler( "document_fragment_change", l[ 0 ].location.hash )
      ...
      o.a.fn.clickLink = function () {
        const e = this.eq( 0 )
        e.hasClass( "disabled_link" ) || e.click()
      }
      o.a.fn.showIf = function ( e ) {
        if ( o.a.isFunction( e ) ) return this.each( ( function ( t ) {
          o()( this ).showIf( e.call( this ) )
        } ) )
        e ? this.show() : this.hide()
        return this
      }
      o.a.fn.disableIf = function ( e ) {
        o.a.isFunction( e ) && ( e = e.call( this ) )
        this.prop( "disabled", !!e )
        return this
      }
      o.a.fn.indicate = function ( e ) {
        e = e || {}
        let t
        if ( "remove" == e ) {
        ...
        t.mouseover( ( function () {
          o()( this ).stop().fadeOut( "fast", ( function () {
            o()( this ).remove()
          } ) )
        } ) )
      ...
      o.a.fn.hasScrollbar = function () {
        return this.length && this[ 0 ].clientHeight < this[ 0 ].scrollHeight
      }
      o.a.fn.log = function ( e ) {
        console.log( "%s: %o", e, this )
        return this
      }
      o.a.fn.fillWindowWithMe = function ( e ) {
        const t = o.a.extend( {
            minHeight: 400
          }, e ),
          i = o()( this ),
          ...
          s = o()( "#not_right_side" ),
          r = o()( window ),
          a = o()( this ).add( t.alsoResize )

        function u() {
          a.height( 0 )
          const e = r.height() - ( l.offset().top + l.outerHeight() ) + ( n.height() - s.height() ),
            u = Math.max( 400, e )
          a.height( u )
          o.a.isFunction( t.onResize ) && t.onResize.call( i, u )
        }
        u()
        r.unbind( "resize.fillWindowWithMe" ).bind( "resize.fillWindowWithMe", u )
        return this
      }
      o.a.fn.autoGrowInput = function ( e ) {
        e = o.a.extend( {
          maxWidth: 1e3,
          minWidth: 0,
          comfortZone: 70
        ...
        this.filter( "input:text" ).each( ( function () {
          let t = e.minWidth || o()( this ).width(),
            ...
            n = o()( "<tester/>" ).css( {
              ...
              left: -9999,
              width: "auto",
              fontSize: l.css( "fontSize" ),
              fontFamily: l.css( "fontFamily" ),
              fontWeight: l.css( "fontWeight" ),
              letterSpacing: l.css( "letterSpacing" ),
              whiteSpace: "nowrap"
            } ),
            s = function () {
              setTimeout( () => {
                ...
                n.text( i )
                const s = n.width(),
                  r = s + e.comfortZone >= t ? s + e.comfortZone : t,
                  o = l.width(),
                  a = r < o && r >= t || r > t && r < e.maxWidth
                a && l.width( r )
              } )
            }
          n.insertAfter( l )
...
//# sourceMappingURL=32-c-7abb3c6dcd.js.map
