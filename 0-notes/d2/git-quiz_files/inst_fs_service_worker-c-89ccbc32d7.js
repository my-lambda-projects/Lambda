( window[ "canvasWebpackJsonp" ] = window[ "canvasWebpackJsonp" ] || [] ).push( [
  [ 368 ], {
    "+rbw": function ( e, r, n ) {
      ...
      var a = n.n( i )
      a()( () => {
        const e = Object( t[ "getBrowser" ] )(),
          r = e.name,
          n = e.version "Safari" === r && parseFloat( n ) >= 13 && "serviceWorker" in navigator && navigator.serviceWorker.register( "/inst-fs-sw.js" ).then( () => {
            console.log( "Registration succeeded. Refresh page to proxy Inst-FS requests through ServiceWorker." )
          } ).catch( ( function ( e ) {
            console.log( "Inst-FS ServiceWorker registration failed. :(", e )
          } ) )
      } )
    },
    agZB: function ( e, r, n ) {
...
//# sourceMappingURL=inst_fs_service_worker-c-89ccbc32d7.js.map
