    ...
    "Xx/m": function ( e, t, i ) {
      ...
      function q() {
        ...
        return Object( d[ "a" ] )( {
          ...
          lightActiveBoxShadow: "".concat( V, " " ).concat( Object( O[ "a" ] )( i.borderLightest, 25 ) ),
          ...
          ghostActiveBoxShadow: "inset 0 0 1px 1px ".concat( Object( j[ "a" ] )( i.borderBrand, 20 ) ),
          ...
          ghostInverseHoverBackground: Object( j[ "a" ] )( i.backgroundLightest, 10 ),
          ghostInverseActiveBackground: "transparent",
          ghostInverseActiveBoxShadow: "inset 0 0 1px 1px ".concat( Object( j[ "a" ] )( i.borderLightest, 20 ) ),
          ...
          iconInverseFocusBoxShadow: "".concat( P, " " ).concat( i.borderLightest ),
          fluidWidthLineHeight: X.lineHeightFit
        }, N( "default", i.backgroundLight, i.textDarkest ), {}, N( "primary", i.backgroundBrand, i.textLightest ), {}, N( "success", i.backgroundSuccess, i.textLightest ), {}, N( "danger", i.backgroundDanger, i.textLightest ), {}, N( "circleDefault", i.backgroundLight, i.textDarkest ), {}, N( "circlePrimary", i.backgroundBrand, i.textLightest ), {}, N( "circleDanger", i.backgroundDanger, i.textLightest ) )
      }
      q[ "canvas" ] = function () {
        var e = arguments.length > 0 && void 0 !== arguments[ 0 ] ? arguments[ 0 ] : {}
        return Object( d[ "a" ] )( {
          ...
          ghostHoverBackground: Object( j[ "a" ] )( e[ "ic-brand-button--primary-bgd" ], 10 ),
          ghostActiveBoxShadow: "inset 0 0 1px 1px ".concat( Object( j[ "a" ] )( e[ "ic-brand-button--primary-bgd" ], 20 ) ),
        ...
        }, N( "primary", e[ "ic-brand-button--primary-bgd" ], e[ "ic-brand-button--primary-text" ] ), {}, N( "circlePrimary", e[ "ic-brand-button--primary-bgd" ], e[ "ic-brand-button--primary-text" ] ) )
      }
      ...
      var I = ( x = Object( h[ "a" ] )( "8.0.0", null, "Use Button from ui-buttons instead. See the upgrade guide for detailed instructions on updating https://instructure.design/#button-upgrade-guide" ), T = Object( l[ "a" ] )(), Y = Object( p[ "j" ] )( q, R ), x( A = T( A = Y( A = ( W = J = function ( e ) {
        Object( a[ "a" ] )( i, e )
        var t = Object( X[ "a" ] )( i )
        ...
        function i() {
          ...
          e.handleKeyDown = function ( t ) {
            var i = e.props,
              ...
              d = i.onClick,
              r = i.href
            if ( "button" !== e.elementType && ( t.keyCode === S.a.codes.space || t.keyCode === S.a.codes.enter ) ) {
              t.preventDefault()
              t.stopPropagation()
        ...
        Object( b[ "a" ] )( i, [ {
          ...
          value: function () {
            ...
            return "function" === typeof this.props.icon ? _.a.createElement( "span", {
              className: R.iconSVG
            }, _.a.createElement( e, {
              inline: false
            } ) ) : e ? _.a.createElement( "span", {
              className: R.iconSVG
            }, e ) : null
          }
        }, {
          ...
          value: function () {
            return M.includes( this.props.variant ) ? "circle" : "rounded"
          }
        }, {
          key: "buttonWidth",
          value: function ( e ) {
            var t = this.props,
              i = t.variant,
              o = t.fluidWidth
            return e || K.includes( i ) ? "icon" : o ? "fluid" : "auto"
          }
        }, {
          key: "render",
          value: function () {
            ...
            return _.a.createElement( C[ "a" ], Object.assign( {}, S, {
              className: G()( ( e = {}, Object( n[ "a" ] )( e, R.root, true ), Object( n[ "a" ] )( e, R[ h ], true ), Object( n[ "a" ] )( e, R[ l ], l ), Object( n[ "a" ] )( e, R[ "width--".concat( this.buttonWidth( k ) ) ], true ), Object( n[ "a" ] )( e, R[ "borderRadius--".concat( this.buttonBorderRadius() ) ], true ), Object( n[ "a" ] )( e, R.disabled, u ), Object( n[ "a" ] )( e, R[ "has-icon" ], X ), e ) ),
              disabled: u || y,
              ...
              elementRef: function ( e ) {
                t._button = e "function" === typeof r && r( e )
              },
              display: null,
              as: this.elementType,
              margin: H,
              cursor: u ? "not-allowed" : b
            } ), f ? _.a.createElement( E[ "a" ], {
              height: "100%",
              width: "100%"
            }, _.a.createElement( E[ "a" ].Item, {
              padding: "0 x-small 0 0"
            }, this.renderIcon() ), _.a.createElement( E[ "a" ].Item, {
              shouldGrow: true,
              shouldShrink: true
            }, _.a.createElement( "span", {
              className: R.content
            }, c ) ) ) : _.a.createElement( "span", {
              className: R.content
            }, X && this.renderIcon(), c ) )
          }
        }, {
        ...
        return i
      }( H[ "Component" ] ), J.propTypes = {
        children: y.a.node.isRequired,
        type: y.a.oneOf( [ "button", "submit", "reset" ] ),
        variant: y.a.oneOf( [ "default", "primary", "success", "danger", "light", "ghost", "ghost-inverse", "link", "link-inverse", "circle-default", "circle-primary", "circle-danger", "icon", "icon-inverse" ] ),
        buttonRef: y.a.func,
        as: y.a.elementType,
      ...
      Q[ "canvas-ams" ] = function ( e ) {
        var t = e.colors
        return Object( d[ "a" ] )( {}, Object( U[ "c" ] )( {
          style: "secondary",
          borderColor: t.borderBrand,
          backgroundColor: "transparent",
          textColor: t.fullyAccessibleBrand
        } ), {
          secondaryHoverBackground: Object( j[ "a" ] )( t.fullyAccessibleBrand, 10 ),
          secondaryActiveBackground: "transparent",
          secondaryActiveBoxShadow: "".concat( U[ "a" ], " " ).concat( Object( j[ "a" ] )( t.fullyAccessibleBrand, 28 ) ),
          ...
          primaryGhostActiveBoxShadow: "".concat( U[ "a" ], " " ).concat( Object( j[ "a" ] )( t.textDarkest, 28 ) )
        } )
      }
      var Z, $, ee, te, ie, oe
      var ne = ( Z = Object( h[ "a" ] )( "8.0.0", {
        buttonRef: "elementRef",
        fluidWidth: "display",
        icon: "renderIcon",
        variant: null
      }, "See the following upgrade guide for more help updating https://instructure.design/#button-upgrade-guide" ), $ = Object( l[ "a" ] )(), ee = Object( p[ "j" ] )( Q, null, F ), Z( te = $( te = ee( te = ( oe = ie = function ( e ) {
        Object( a[ "a" ] )( i, e )
        var t = Object( X[ "a" ] )( i )
        ...
        Object( b[ "a" ] )( i, [ {
          ...
          value: function () {
            var e = this.props,
              ...
              h = e.variant,
              f = e.fluidWidth,
              G = Object( o[ "a" ] )( e, [ "children", "type", "size", "as", "color", "focusColor", "display", "textAlign", "withBackground", "margin", "cursor", "href", "icon", "renderIcon", "variant", "fluidWidth" ] )
            var k = Object( v[ "a" ] )( {
              props: G
            } )
            var S = this.theme,
              w = void 0 === S ? {} : S
            if ( h ) return _.a.createElement( I, Object.assign( {}, Object( g[ "b" ] )( G ), {
              type: i,
              size: n,
              as: r,
              disabled: "disabled" === k,
        ...
        return i
      }( H[ "Component" ] ), ie.propTypes = {
        children: y.a.node,
        type: y.a.oneOf( [ "button", "submit", "reset" ] ),
        size: y.a.oneOf( [ "small", "medium", "large" ] ),
        elementRef: y.a.func,
        as: y.a.elementType,
        interaction: y.a.oneOf( [ "enabled", "disabled", "readonly" ] ),
        color: y.a.oneOf( [ "primary", "primary-inverse", "secondary", "success", "danger" ] ),
