  ...
  [ 41 ], {
    ...
    "4Ogu": function ( e, n, t ) {
      ...
      async function l( {
        ...
        const u = await fetch( b, Object( a[ "a" ] )( {
          body: s,
          method: n
        }, l ) )
        if ( !u.ok ) {
          const e = new Error( `doFetchApi received a bad response: ${u.status} ${u.statusText}` )
          e.response = u
          throw e
        }
    ...
    "6V2X": function ( e, n, t ) {
      ...
      var i = t.n( c )
      var _ = t( "xGaD" )
      const l = Object( c[ "lazy" ] )( () => Promise.all( [ t.e( 7 ), t.e( 9 ), t.e( 11 ), t.e( 29 ), t.e( 135 ), t.e( 685 ) ] ).then( t.bind( null, "mftS" ) ) )

      function b( e ) {
        let n = e.sourceCourseId,
          t = e.contentSelection,
          s = e.onDismiss,
          o = Object( r[ "a" ] )( e, [ "sourceCourseId", "contentSelection", "onDismiss" ] )
        return i.a.createElement( _[ "a" ], Object.assign( {
          label: d.t( "Copy To..." ),
          placement: "end",
          onDismiss: s,
          padding: "medium"
    ...
    BxIY: function ( e, n, t ) {
      ...
      function m( e ) {
        let n = e.padding,
          ...
          y = e.footer,
          j = e.closeButtonSize,
          k = Object( r[ "a" ] )( e, [ "padding", "errorSubject", "errorCategory", "errorImageUrl", "label", "title", "onDismiss", "children", "footer", "closeButtonSize" ] )
        null == p && ( p = c )
        return i.a.createElement( g[ "a" ], Object.assign( {
          label: c,
          onDismiss: v
        }, k ), Object( a[ "a" ] )( g[ "a" ].Header, {}, void 0, Object( a[ "a" ] )( b[ "a" ], {}, void 0, Object( a[ "a" ] )( b[ "a" ].Item, {
          grow: true
        }, void 0, Object( a[ "a" ] )( u[ "a" ], {}, void 0, p ) ), Object( a[ "a" ] )( b[ "a" ].Item, {}, void 0, Object( a[ "a" ] )( _[ "a" ], {
          onClick: v,
          size: j
        }, void 0, d.t( "Close" ) ) ) ) ), Object( a[ "a" ] )( g[ "a" ].Body, {
          padding: n
        }, void 0, Object( a[ "a" ] )( l[ "a" ], {
          as: "div",
          height: "100%"
        }, void 0, Object( a[ "a" ] )( h[ "a" ], {
          errorComponent: Object( a[ "a" ] )( f[ "a" ], {
            imageUrl: o,
            errorSubject: t,
            errorCategory: s
          } )
        }, void 0, m ) ) ), y && Object( a[ "a" ] )( g[ "a" ].Footer, {}, void 0, "function" === typeof y ? y() : y ) )
      }
    },
    EUQ6: function ( e, n, t ) {
      "use strict"
    ...
    eCn1: function ( e, n, t ) {
      ...
      function m( e ) {
        ...
        let o = e.padding,
          ...
          C = e.onDismiss,
          S = e.children,
          O = Object( r[ "a" ] )( e, [ "padding", "headerPadding", "contentPadding", "errorSubject", "errorCategory", "errorImageUrl", "label", "title", "onDismiss", "children" ] )
        null == c && ( c = `0 0 ${o} 0` )
        null == k && ( k = j )
        ...
        function x() {
          return Object( a[ "a" ] )( b[ "a" ], {
            as: "div",
            padding: c
          }, void 0, n || ( n = Object( a[ "a" ] )( b[ "a" ].Item, {
            grow: true
          }, void 0, Object( a[ "a" ] )( u[ "a" ], {
            ellipsis: true
          }, void 0, k ) ) ), Object( a[ "a" ] )( b[ "a" ].Item, {}, void 0, Object( a[ "a" ] )( _[ "a" ], {
            onClick: C,
            size: "small"
          }, void 0, d.t( "Close" ) ) ) )
        }
        ...
        function A() {
          return Object( a[ "a" ] )( h[ "a" ], {
            errorComponent: t || ( t = Object( a[ "a" ] )( f[ "a" ], {
              imageUrl: y,
              errorSubject: v,
              errorCategory: m
            } ) )
          }, void 0, s || ( s = Object( a[ "a" ] )( l[ "a" ], {
            as: "div",
            padding: p,
            width: "100%",
            height: "100%"
    ...
    "p9+C": function ( e, n, t ) {
      ...
      class s extends r.a.Component {
        ...
        render() {
          if ( this.state.hasError ) return r.a.cloneElement( this.props.errorComponent, {
    ...
    ppA4: function ( e, n, t ) {
      ...
      var p = t( "dqQ7" )
      var v = t( "4Ogu" )
      const m = Object( _[ "lazy" ] )( () => Promise.all( [ t.e( 7 ), t.e( 9 ), t.e( 11 ), t.e( 653 ) ] ).then( t.bind( null, "FB/m" ) ) )
      ...
      function y( e ) {
        ...
        function R() {
          return l.a.createElement( l.a.Fragment, null, Object( a[ "a" ] )( u[ "a" ], {
            onClick: d.onDismiss
          }, void 0, i.t( "Cancel" ) ), Object( a[ "a" ] )( u[ "a" ], {
        ...
        const w = Object( a[ "a" ] )( h[ "a" ], {
          as: "div",
          textAlign: "center"
        }, void 0, Object( a[ "a" ] )( g[ "a" ], {
          renderTitle: i.t( "Loading" )
        } ) )
        if ( d.open !== A.current ) {
          A.current = d.open
          E()
        ...
        const K = F ? Object( a[ "a" ] )( b[ "a" ], {
          variant: O
        }, void 0, Object( a[ "a" ] )( "div", {
          role: "alert",
          "aria-live": "assertive",
          "aria-atomic": true
        }, void 0, F ), "info" === O ? Object( a[ "a" ] )( g[ "a" ], {
          renderTitle: F,
          size: "x-small"
        } ) : null ) : null
        return l.a.createElement( f[ "a" ], Object.assign( {
          label: i.t( "Send To..." ),
          size: "medium"
        }, d, {
          footer: Object( a[ "a" ] )( R, {} )
        } ), Object( a[ "a" ] )( _[ "Suspense" ], {
          fallback: w
        }, void 0, K, Object( a[ "a" ] )( m, {
          courseId: t,
          selectedUsers: j,
          onUserSelected: z,
          onUserRemoved: L
    ...
    qBwj: function ( e, n, t ) {
      ...
      const d = Object( a[ "shape" ] )( {
        ...
        user_id: a[ "string" ],
        workflow_state: Object( a[ "oneOf" ] )( [ "created", "exporting", "exported", "failed" ] ),
        attachment: o
      } )
      var c = d
    ...
    xGaD: function ( e, n, t ) {
      ...
      function u( e ) {
        ...
        const s = Object( a[ "a" ] )( b[ "a" ], {
          as: "div",
          textAlign: "center"
        }, void 0, Object( a[ "a" ] )( l[ "a" ], {
          renderTitle: d.t( "Loading..." )
        } ) )
        return i.a.createElement( _[ "a" ], t, Object( a[ "a" ] )( c[ "Suspense" ], {
          fallback: s
        }, void 0, n ) )
      }
    }
