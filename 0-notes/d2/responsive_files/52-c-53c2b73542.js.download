...
return Object(c["a"])("span",{className:"bpc-lock-toggle"},void 0,n)}}M.defaultProps={isToggleable:false,onClick:()=>{},breakpoints:{}}
...
this.setupToggle(()=>{u.a.render(Object(c["a"])(y,{isLocked:this.state.isLocked,isToggleable:"show"===this.props.page&&this.state.isMasterContent,onClick:this.toggleLocked}),this.toggleNode)})}renderBanner(){this.bannerNode||(this.bannerNode=C.setupRootNode())
