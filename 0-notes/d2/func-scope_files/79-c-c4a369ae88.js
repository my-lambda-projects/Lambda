(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[79],{"lVr/":function(e,t,i){"use strict"
i.d(t,"a",(function(){return c}))
var s=i("ouhR")
var n=i.n(s)
i("rySQ")
const o=n.a.ui.menu.prototype,a=o.refresh
n.a.extend(o,{refresh(){a.call(this)
const e=this
...
t.length&&t[0].blur()}))
t.children("a").each((function(e,t){const s=n()(t),o=s.parent()
...
o.attr({role:"menuitemcheckbox","aria-checked":"true"})}else if(s.children("input[type='radio']").is(":checked")){s.prepend('<span class="ui-icon ui-icon-radio-on"></span>')
o.attr({role:"menuitemradio","aria-checked":"true"})}else if(s.children("input[type='radio']").length){s.prepend('<span class="ui-icon ui-icon-radio-off"></span>')
...
i("PwBw")
var r=0,u=false
n.a.widget("ui.popup",{version:"@VERSION",options:{position:{my:"left top",at:"left bottom"},managed:false,expandOnFocus:false,show:{effect:"slideDown",duration:0},hide:{effect:"fadeOut",duration:0}},_create:function(){this.options.trigger||(this.options.trigger=this.element.prev())
...
this._on(this.options.trigger,{keydown:function(e){switch(e.keyCode){case n.a.ui.keyCode.TAB:this.element.hide()
this.close(e)
break
...
this.options.managed||this._on({keydown:function(e){if(e.keyCode!==n.a.ui.keyCode.TAB)return
var t=n()(":tabbable",this.element),i=t.first(),s=t.last()
...
this._on({keyup:function(e){if(e.keyCode===n.a.ui.keyCode.ESCAPE&&this.element.is(":visible")){this.close(e)
this.focusTrigger()}}})
this._on(this.document,{click:function(e){this.isOpen&&!n()(e.target).closest(this.element.add(this.options.trigger)).length&&this.close(e)}})},_destroy:function(){this.element.show().removeClass("ui-popup").removeAttr("aria-hidden").removeAttr("aria-expanded").unbind("keypress.ui-popup")
this.options.trigger.removeAttr("aria-haspopup").removeAttr("aria-owns")
this.generatedId&&this.element.removeAttr("id")
this.generatedRole&&this.element.removeAttr("role")},open:function(e){var t=n.a.extend({},{of:this.options.trigger},this.options.position)
...
n.a.fn.kyleMenu=function(e){return this.each((function(){n()(this).data().kyleMenu||new c(this,e)}))}},rySQ:function(e,t,i){"use strict"
var s=i("ouhR")
var n=i.n(s)
i("9Duh")
i("vTtS")
function o(){return[].some.call(n()(this).parents().andSelf(),(function(e){return"none"==n.a.css(e,"display")}))}var a=false
...
this.element.find(".ui-menu-divider").removeClass("ui-menu-divider ui-widget-content")},_keydown:function(e){var t,i,s,a,r,u=true
function c(e){return e.replace(/[\-\[\]{}()*+?.,\\\^$|#\s]/g,"\\$&")}switch(e.keyCode){case n.a.ui.keyCode.PAGE_UP:this.previousPage(e)
break
...
s===i?a=true:s=i+s
r=new RegExp("^"+c(s),"i")
t=this.activeMenu.children(".ui-menu-item").filter((function(){return r.test(n()(this).children("a").not(o).text())}))
t=a&&-1!==t.index(this.active.next())?this.active.nextAll(".ui-menu-item"):t
if(!t.length){s=String.fromCharCode(e.keyCode)
r=new RegExp("^"+c(s),"i")
t=this.activeMenu.children(".ui-menu-item").filter((function(){return r.test(n()(this).children("a").not(o).text())}))}if(t.length){this.focus(e,t)
...
this._trigger("focus",e,{item:t})},_scrollIntoView:function(e){var t,i,s,o,a,r
...
r=e.height()
s<0?this.activeMenu.scrollTop(o+s):s+r>a&&this.activeMenu.scrollTop(o+s-a+r)}},blur:function(e,t){t||clearTimeout(this.timer)
...
this.active.nextAll(".ui-menu-item").not(o).each((function(){t=n()(this)
return t.offset().top-i-s<0}))
this.focus(e,t)}else this.focus(e,this.activeMenu.children(".ui-menu-item").not(o)[this.active?"last":"first"]())},previousPage:function(e){var t,i,s
if(!this.active){this.next(e)
return}if(this.isFirstItem())return
if(this._hasScroll()){i=this.active.offset().top
s=this.element.height()
this.active.prevAll(".ui-menu-item").not(o).each((function(){t=n()(this)
return t.offset().top-i+s>0}))
this.focus(e,t)}else this.focus(e,this.activeMenu.children(".ui-menu-item").not(o).first())},_hasScroll:function(){return this.element.outerHeight()<this.element.prop("scrollHeight")},select:function(e){var t={item:this.active||n()(e.target).closest(".ui-menu-item")}
