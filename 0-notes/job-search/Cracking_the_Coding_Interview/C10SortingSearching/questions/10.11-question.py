...
# the adjacent integers and a "valley" is an element which is less than or equal
# to the adjacent integers.

# For example, in the array [], [8, 6] are peaks and [5, 2] are valleys.
